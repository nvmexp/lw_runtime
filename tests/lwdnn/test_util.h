...
#ifndef LWIDIA_LIBS_TEST_TEST_UTIL_H_
#define LWIDIA_LIBS_TEST_TEST_UTIL_H_
...
// Compares conselwtive elements in first and second point to device memory, and
...
// Colwerts a Status into an AssertionResult.
::testing::AssertionResult IsOk(const Status& status);

// Colwerts a StatusOr<T> into an AssertionResult.
template <typename T>
...
#endif  // LWIDIA_LIBS_TEST_TEST_UTIL_H_
