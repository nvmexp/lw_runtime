...
#ifndef LWIDIA_LIBS_TEST_LWDNN_TEST_H_
#define LWIDIA_LIBS_TEST_LWDNN_TEST_H_
...
// Helper functions that are common to all lwDNN colwolution tests.
...
typename std::enable_if<
    std::is_colwertible<T*, ::google::protobuf::Message*>::value,
    ::std::ostream&>::type
...
#endif  // LWIDIA_LIBS_TEST_LWDNN_TEST_H_
