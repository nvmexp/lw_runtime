...
#ifndef LWIDIA_LIBS_TEST_KERNEL_TIMER_H_
#define LWIDIA_LIBS_TEST_KERNEL_TIMER_H_

#include <memory>

// Timers measuring GPU kernel runtimes using LWPTI.
...
#endif  // LWIDIA_LIBS_TEST_KERNEL_TIMER_H_
