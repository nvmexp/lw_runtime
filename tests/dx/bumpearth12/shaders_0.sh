...
RWBuffer<uint> uav0   : register(u1, space6);
...
VS_OUTPUT_GEO GeometryVS0( VS_INPUT_GEO input )
{
...
float4 GeometryPS0( VS_OUTPUT_GEO input ) : SV_Target
{
...
VS_OUTPUT_ELW ElwVS0( VS_INPUT_ELW input )
{
...
float4 ElwPS0( VS_OUTPUT_ELW input ) : SV_Target
{
