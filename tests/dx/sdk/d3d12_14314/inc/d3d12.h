...
enum D3D12_LWLL_MODE
    {
        D3D12_LWLL_MODE_NONE	= 1,
        D3D12_LWLL_MODE_FRONT	= 2,
        D3D12_LWLL_MODE_BACK	= 3
    } 	D3D12_LWLL_MODE;
...
typedef 
enum D3D12_INDEX_BUFFER_STRIP_LWT_VALUE
    {
    ...
    } 	D3D12_INDEX_BUFFER_STRIP_LWT_VALUE;
...
typedef struct D3D12_GRAPHICS_PIPELINE_STATE_DESC
    ...
    D3D12_INDEX_BUFFER_STRIP_LWT_VALUE IBStripLwtValue;
...
enum D3D12_DESCRIPTOR_RANGE_FLAGS
    {
        ...
        D3D12_DESCRIPTOR_RANGE_FLAG_DATA_STATIC_WHILE_SET_AT_EXELWTE	= 0x4,
...
enum D3D12_ROOT_DESCRIPTOR_FLAGS
    {
        ...
        D3D12_ROOT_DESCRIPTOR_FLAG_DATA_STATIC_WHILE_SET_AT_EXELWTE	= 0x4,
...
EXTERN_C const IID IID_ID3D12VersionedRootSignatureDeserializer;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetRootSignatureDescAtVersion( 
            D3D_ROOT_SIGNATURE_VERSION colwertToVersion,
            _Out_  const D3D12_VERSIONED_ROOT_SIGNATURE_DESC **ppDesc) = 0;
        
        virtual const D3D12_VERSIONED_ROOT_SIGNATURE_DESC *STDMETHODCALLTYPE GetUncolwertedRootSignatureDesc( void) = 0;
    ...
    typedef struct ID3D12VersionedRootSignatureDeserializerVtbl
    {
        ...
        const D3D12_VERSIONED_ROOT_SIGNATURE_DESC *( STDMETHODCALLTYPE *GetUncolwertedRootSignatureDesc )( 
            ID3D12VersionedRootSignatureDeserializer * This);
...
#define ID3D12VersionedRootSignatureDeserializer_GetRootSignatureDescAtVersion(This,colwertToVersion,ppDesc)	\
    ( (This)->lpVtbl -> GetRootSignatureDescAtVersion(This,colwertToVersion,ppDesc) ) 

#define ID3D12VersionedRootSignatureDeserializer_GetUncolwertedRootSignatureDesc(This)	\
    ( (This)->lpVtbl -> GetUncolwertedRootSignatureDesc(This) ) 
...
#define ID3D12GraphicsCommandList_ClearUnorderedAccessViewUint(This,ViewGPUHandleInLwrrentHeap,ViewCPUHandle,pResource,Values,NumRects,pRects)	\
    ( (This)->lpVtbl -> ClearUnorderedAccessViewUint(This,ViewGPUHandleInLwrrentHeap,ViewCPUHandle,pResource,Values,NumRects,pRects) ) 

#define ID3D12GraphicsCommandList_ClearUnorderedAccessViewFloat(This,ViewGPUHandleInLwrrentHeap,ViewCPUHandle,pResource,Values,NumRects,pRects)	\
    ( (This)->lpVtbl -> ClearUnorderedAccessViewFloat(This,ViewGPUHandleInLwrrentHeap,ViewCPUHandle,pResource,Values,NumRects,pRects) ) 
...
#define ID3D12CommandQueue_ExelwteCommandLists(This,NumCommandLists,ppCommandLists)	\
    ( (This)->lpVtbl -> ExelwteCommandLists(This,NumCommandLists,ppCommandLists) ) 
...
#define ID3D12Device_GetLwstomHeapProperties(This,nodeMask,heapType)	\
    ( (This)->lpVtbl -> GetLwstomHeapProperties(This,nodeMask,heapType) ) 
...
#define ID3D12Device1_GetLwstomHeapProperties(This,nodeMask,heapType)	\
    ( (This)->lpVtbl -> GetLwstomHeapProperties(This,nodeMask,heapType) ) 
