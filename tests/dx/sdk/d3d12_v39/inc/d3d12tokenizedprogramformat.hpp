...
//   program formats.
//
// - Support extensible token definitions, allowing full lwstomizations for
//   specific program classes, while maintaining general colwentions for all
//   program models.
//
...
// if( [10:00] == D3D10_SB_OPCODE_LWSTOMDATA )
// {
...
// ---------- DX 11 op codes---------------------
    ...
    D3D11_SB_OPCODE_LWT_STREAM                       ,
    D3D11_SB_OPCODE_EMITTHENLWT_STREAM               ,
...
// by an additional opcode token.  Lwrrently there are no
// extended opcodes.
...
//
// DWORD 0 (LwstomDataDescTok):
// [10:00] == D3D10_SB_OPCODE_LWSTOMDATA
// [31:11] == D3D10_SB_LWSTOMDATA_CLASS
//
// DWORD 1: 
...
typedef enum D3D10_SB_LWSTOMDATA_CLASS
{
    D3D10_SB_LWSTOMDATA_COMMENT = 0,
    D3D10_SB_LWSTOMDATA_DEBUGINFO,
    D3D10_SB_LWSTOMDATA_OPAQUE,
    D3D10_SB_LWSTOMDATA_DCL_IMMEDIATE_CONSTANT_BUFFER,
    D3D11_SB_LWSTOMDATA_SHADER_MESSAGE,
    D3D11_SB_LWSTOMDATA_SHADER_CLIP_PLANE_CONSTANT_MAPPINGS_FOR_DX9,
} D3D10_SB_LWSTOMDATA_CLASS;

#define D3D10_SB_LWSTOMDATA_CLASS_MASK 0xfffff800
#define D3D10_SB_LWSTOMDATA_CLASS_SHIFT 11
...
#define DECODE_D3D10_SB_LWSTOMDATA_CLASS(LwstomDataDescTok) ((D3D10_SB_LWSTOMDATA_CLASS)(((LwstomDataDescTok)&D3D10_SB_LWSTOMDATA_CLASS_MASK)>>D3D10_SB_LWSTOMDATA_CLASS_SHIFT))
// ENCODER MACRO: Create complete LwstomDataDescTok
#define ENCODE_D3D10_SB_LWSTOMDATA_CLASS(LwstomDataClass) (ENCODE_D3D10_SB_OPCODE_TYPE(D3D10_SB_OPCODE_LWSTOMDATA)|(((LwstomDataClass)<<D3D10_SB_LWSTOMDATA_CLASS_SHIFT)&D3D10_SB_LWSTOMDATA_CLASS_MASK))
...
//         description. Lwrrently no second order extensions defined.
...
// a minimum precision for exelwtion, find out what it is.
...
// ENCODER MACRO: Encode minimum precision for exelwtion
...
// (OperandToken2).  Lwrrently there are no secondary
...
// by an additional operand token.  Lwrrently there are no secondary
// extended operand tokens.
...
// [31]    0 normally. 1 if extended operand definition, meaning next DWORD
//         contains extended operand description.  This dcl is lwrrently not
//         extended.
//
...
// [22:16] Sample count 1...127.  0 is lwrrently disallowed, though
...
//
// [10:00] D3D10_SB_OPCODE_LWSTOMDATA
// [31:11] == D3D10_SB_LWSTOMDATA_DCL_IMMEDIATE_CONSTANT_BUFFER
//
...
//
// [10:00] D3D10_SB_OPCODE_LWSTOMDATA
// [31:11] == D3D11_SB_LWSTOMDATA_SHADER_MESSAGE
//
// OpcodeToken0 is followed by:
// (1) DWORD indicating length of declaration, including OpcodeToken0.
...
typedef enum D3D11_SB_SHADER_MESSAGE_FORMAT
{
    ...
    // Format string follows C/C++ printf colwentions.
...
//
// [10:00] D3D10_SB_OPCODE_LWSTOMDATA
// [31:11] == D3D11_SB_LWSTOMDATA_SHADER_CLIP_PLANE_CONSTANT_MAPPINGS_FOR_DX9
//
// OpcodeToken0 is followed by:
// (1) DWORD indicating length of declaration, including OpcodeToken0.
...
typedef enum D3D10_SB_RESOURCE_DIMENSION
{
    ...
    D3D10_SB_RESOURCE_DIMENSION_TEXTURELWBE = 6,
    ...
    D3D10_SB_RESOURCE_DIMENSION_TEXTURELWBEARRAY = 10,
