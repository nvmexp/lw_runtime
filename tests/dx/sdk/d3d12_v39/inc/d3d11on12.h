...
struct CD3DX11ON12_HEAP_PROPERTIES_FROM11 : public CD3DX12_HEAP_PROPERTIES
{
    ...
    static CD3DX12_HEAP_PROPERTIES ColwertD3D11Usage( D3D11_USAGE Usage, UINT CPUAccessFlags )
    {
        switch (Usage)
        {
    ...
    {
        *static_cast<CD3DX12_HEAP_PROPERTIES*>(this) = ColwertD3D11Usage( o.Usage, o.CPUAccessFlags );
    }
...
struct CD3DX11ON12_HEAP_DESC_FROM11 : public CD3DX12_HEAP_DESC
{
    ...
    static D3D12_HEAP_FLAGS ColwertD3D11MiscFlags(UINT miscFlags)
    {
        ...
        {
            MiscFlags |= D3D12_HEAP_FLAG_SHARED;
        }
        return MiscFlags;
    }
    explicit CD3DX11ON12_HEAP_DESC_FROM11( const D3D11_BUFFER_DESC& o )
    {
        *static_cast<CD3DX12_HEAP_DESC*>(this) = CD3DX12_HEAP_DESC( 0, CD3DX11ON12_HEAP_PROPERTIES_FROM11( o ), 0, ColwertD3D11MiscFlags( o.MiscFlags ) );
...
struct CD3DX11ON12_RESOURCE_DESC_FROM11 : public CD3DX12_RESOURCE_DESC
{
    ...
    static D3D12_RESOURCE_FLAGS ColwertD3D11Flags( UINT bindFlags )
    {
        D3D12_RESOURCE_FLAGS MiscFlags = D3D12_RESOURCE_FLAG_NONE;
        if (!(bindFlags & D3D11_BIND_SHADER_RESOURCE) && (bindFlags & D3D11_BIND_DEPTH_STENCIL)) MiscFlags |= D3D12_RESOURCE_FLAG_DENY_SHADER_RESOURCE;
        if (bindFlags & D3D11_BIND_RENDER_TARGET) MiscFlags |= D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET;
        if (bindFlags & D3D11_BIND_DEPTH_STENCIL) MiscFlags |= D3D12_RESOURCE_FLAG_ALLOW_DEPTH_STENCIL;
        if (bindFlags & D3D11_BIND_UNORDERED_ACCESS) MiscFlags |= D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
        return MiscFlags;
    }
    explicit CD3DX11ON12_RESOURCE_DESC_FROM11( const D3D11_BUFFER_DESC& o )
    {
        *static_cast<CD3DX12_RESOURCE_DESC*>(this) = Buffer(o.ByteWidth, D3D12_RESOURCE_FLAG_NONE);
        Flags |= ColwertD3D11Flags( o.BindFlags );
    }
