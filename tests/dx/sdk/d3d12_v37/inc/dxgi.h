...
#if !defined(HMONITOR_DECLARED) && !defined(HMONITOR) && (WILWER < 0x0500)
...
EXTERN_C const IID IID_IDXGISwapChain;
    ...
    typedef struct IDXGISwapChailwtbl
    {
        BEGIN_INTERFACE
    ...
    interface IDXGISwapChain
    {
        CONST_VTBL struct IDXGISwapChailwtbl *lpVtbl;
    };
...
EXTERN_C const IID IID_IDXGIFactory1;
    ...
    public:
        ...
        virtual BOOL STDMETHODCALLTYPE IsLwrrent( void) = 0;
...
#define IDXGIFactory1_IsLwrrent(This)	\
