...
EXTERN_C const IID IID_IDXGISwapChain3;
    ...
    {
    public:
        virtual UINT STDMETHODCALLTYPE GetLwrrentBackBufferIndex( void) = 0;
    ...
    typedef struct IDXGISwapChain3Vtbl
    {
        ...
        UINT ( STDMETHODCALLTYPE *GetLwrrentBackBufferIndex )( 
            IDXGISwapChain3 * This);
...
#define IDXGISwapChain3_GetLwrrentBackBufferIndex(This)	\
    ( (This)->lpVtbl -> GetLwrrentBackBufferIndex(This) ) 
...
EXTERN_C const IID IID_IDXGIFactory4;
    ...
    typedef struct IDXGIFactory4Vtbl
    {
        ...
        BOOL ( STDMETHODCALLTYPE *IsLwrrent )( 
            IDXGIFactory4 * This);
...
#define IDXGIFactory4_IsLwrrent(This)	\
    ( (This)->lpVtbl -> IsLwrrent(This) ) 
