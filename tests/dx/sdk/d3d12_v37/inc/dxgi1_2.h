...
EXTERN_C const IID IID_IDXGIOutputDuplication;
    ...
    typedef struct IDXGIOutputDuplicatiolwtbl
    {
        BEGIN_INTERFACE
        ...
        END_INTERFACE
    } IDXGIOutputDuplicatiolwtbl;

    interface IDXGIOutputDuplication
    {
        CONST_VTBL struct IDXGIOutputDuplicatiolwtbl *lpVtbl;
    };
...
#define IDXGIFactory2_IsLwrrent(This)	\
