...
typedef struct D3D11_SHADER_RESOURCE_VIEW_DESC1
    ...
    union 
        ...
        D3D11_TEXLWBE_SRV TextureLwbe;
        D3D11_TEXLWBE_ARRAY_SRV TextureLwbeArray;
...
struct CD3D11_SHADER_RESOURCE_VIEW_DESC1 : public D3D11_SHADER_RESOURCE_VIEW_DESC1
{
    ...
    explicit CD3D11_SHADER_RESOURCE_VIEW_DESC1(
        ...
        UINT firstArraySlice = 0, // First2DArrayFace for TEXTURELWBEARRAY
        UINT arraySize = -1, // NumLwbes for TEXTURELWBEARRAY
        ...
        UINT planeSlice = 0 ) // Texture2D and Texture2DArray only
    {
        ...
        case D3D11_SRV_DIMENSION_TEXTURE3D:
            ...
            break;
        case D3D11_SRV_DIMENSION_TEXTURELWBE:
            TextureLwbe.MostDetailedMip = mostDetailedMip;
            TextureLwbe.MipLevels = mipLevels;
            break;
        case D3D11_SRV_DIMENSION_TEXTURELWBEARRAY:
            TextureLwbeArray.MostDetailedMip = mostDetailedMip;
            TextureLwbeArray.MipLevels = mipLevels;
            TextureLwbeArray.First2DArrayFace = firstArraySlice;
            TextureLwbeArray.NumLwbes = arraySize;
            break;
        ...
        UINT planeSlice = 0 ) // PlaneSlice for TEXTURE2D or TEXTURE2DARRAY
    {
        ...
        if (DXGI_FORMAT_UNKNOWN == format || 
            ...
            (-1 == arraySize &&
                ...
                D3D11_SRV_DIMENSION_TEXTURE2DMSARRAY == viewDimension ||
                D3D11_SRV_DIMENSION_TEXTURELWBEARRAY == viewDimension)))
        {
            ...
            if (-1 == arraySize)
            {
                ...
                if (D3D11_SRV_DIMENSION_TEXTURELWBEARRAY == viewDimension) arraySize /= 6;
            }
        }
        Format = format;
        switch (viewDimension)
...
#define ID3D11DeviceContext3_ExelwteCommandList(This,pCommandList,RestoreContextState)	\
