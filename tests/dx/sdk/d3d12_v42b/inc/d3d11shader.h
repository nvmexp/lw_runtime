...
typedef struct _D3D11_SHADER_DESC
{
    ...
    UINT                    LwtInstructionCount;         // Number of cut instructions used
...
typedef struct _D3D11_FUNCTION_DESC
{
    ...
    UINT                    ColwersionInstructionCount;  // Number of type colwersion instructions used
...
typedef interface ID3D11ShaderReflectiolwariable ID3D11ShaderReflectiolwariable;
typedef interface ID3D11ShaderReflectiolwariable *LPD3D11SHADERREFLECTIOLWARIABLE;
...
interface DECLSPEC_UUID("51F23923-F3E5-4BD1-91CB-606177D8DB4C") ID3D11ShaderReflectiolwariable;
DEFINE_GUID(IID_ID3D11ShaderReflectiolwariable, 
0x51f23923, 0xf3e5, 0x4bd1, 0x91, 0xcb, 0x60, 0x61, 0x77, 0xd8, 0xdb, 0x4c);

#undef INTERFACE
#define INTERFACE ID3D11ShaderReflectiolwariable

DECLARE_INTERFACE(ID3D11ShaderReflectiolwariable)
{
...
DECLARE_INTERFACE(ID3D11ShaderReflectionConstantBuffer)
{
    ...
    STDMETHOD_(ID3D11ShaderReflectiolwariable*, GetVariableByIndex)(THIS_ _In_ UINT Index) PURE;
    STDMETHOD_(ID3D11ShaderReflectiolwariable*, GetVariableByName)(THIS_ _In_ LPCSTR Name) PURE;
};
...
DECLARE_INTERFACE_(ID3D11ShaderReflection, IUnknown)
{
    ...
    STDMETHOD_(UINT, GetColwersionInstructionCount)(THIS) PURE;
