...
typedef 
enum D3D12TEST_SWIZZLE_PATTERN_FLAGS
    {
        D3D12TEST_SWIZZLE_PATTERN_FLAGS_NONE	= 0,
        D3D12TEST_SWIZZLE_PATTERN_FLAGS_STACK_DEPTH_SLICES	= 1
    } 	D3D12TEST_SWIZZLE_PATTERN_FLAGS;
...
typedef struct D3D12TEST_SWIZZLE_PATTERN_DESC
    ...
    D3D12TEST_SWIZZLE_PATTERN_FLAGS Flags;
...
typedef struct D3D12TEST_SWIZZLE_PATTERN_LAYOUT
    {
    D3D12TEST_SWIZZLE_PATTERN_ORDINAL Patterns[ 6 ];
...
EXTERN_C const IID IID_ID3D12DeviceTest;
    ...
    public:
        ...
        virtual ID3D12Resource *STDMETHODCALLTYPE GetImplicitBuffer( 
            /* [annotation] */ 
            _In_  ID3D12Heap *pHeap) = 0;
    ...
    typedef struct ID3D12DeviceTestVtbl
    {
        ...
        ID3D12Resource *( STDMETHODCALLTYPE *GetImplicitBuffer )( 
            ID3D12DeviceTest * This,
            /* [annotation] */ 
            _In_  ID3D12Heap *pHeap);
...
#define ID3D12DeviceTest_GetMipLevelSwizzleTransition(This,pResource,transitionIndex)	\
    ( (This)->lpVtbl -> GetMipLevelSwizzleTransition(This,pResource,transitionIndex) ) 
...
#define ID3D12DeviceTest_GetImplicitBuffer(This,pHeap)	\
    ( (This)->lpVtbl -> GetImplicitBuffer(This,pHeap) ) 
