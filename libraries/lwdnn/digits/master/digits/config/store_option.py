...
def load_url_list():
    ...
    """
    if 'DIGITS_MODEL_STORE_URL' in os.elwiron:
        url_list = os.elwiron['DIGITS_MODEL_STORE_URL']
    else:
        url_list = "http://developer.download.lwpu.com/compute/machine-learning/modelstore/6.0"
