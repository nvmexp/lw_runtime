...
app.jinja_elw.globals['server_name'] = config_value('server_name')
app.jinja_elw.globals['server_version'] = digits.__version__
app.jinja_elw.globals['caffe_version'] = config_value('caffe')['version']
app.jinja_elw.globals['caffe_flavor'] = config_value('caffe')['flavor']
app.jinja_elw.globals['dir_hash'] = fs.dir_hash(
    os.path.join(os.path.dirname(digits.__file__), 'static'))
app.jinja_elw.filters['print_time'] = utils.time_filters.print_time
app.jinja_elw.filters['print_time_diff'] = utils.time_filters.print_time_diff
app.jinja_elw.filters['print_time_since'] = utils.time_filters.print_time_since
app.jinja_elw.filters['sizeof_fmt'] = utils.sizeof_fmt
app.jinja_elw.filters['has_permission'] = utils.auth.has_permission
app.jinja_elw.trim_blocks = True
app.jinja_elw.lstrip_blocks = True
...
def username_decorator(f):
    ...
    def decorated(*args, **kwargs):
        ...
        app.jinja_elw.globals['username'] = this_username
