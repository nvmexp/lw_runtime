...
class DataIngestion(DataIngestionInterface):
    ...
    def encode_PIL_Image(self, image, channel_colwersion='none'):
        if channel_colwersion != 'none':
            if image.mode != channel_colwersion:
                # colwert to different image mode if necessary
                image = image.colwert(channel_colwersion)
