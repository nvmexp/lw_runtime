...
class DataIngestion(DataIngestionInterface):
    ...
    def __init__(self, **kwargs):
        ...
        if hasattr(self, 'lwstom_classes') and self.lwstom_classes != '':
            s = StringIO.StringIO(self.lwstom_classes)
            reader = csv.reader(s)
            self.class_mappings = {}
    ...
    def encode_entry(self, entry):
        ...
        if self.channel_colwersion != 'none':
            if img.mode != self.channel_colwersion:
                # colwert to different image mode if necessary
                img = img.colwert(self.channel_colwersion)
        ...
        if self.resize_image_width is not None:
            ...
            # resize and colwert to numpy HWC
