...
Note: if you want to use normal torch way of learning rate recallwlation by SGD.lua, then use "torch_sgd" with policy parameter and also provide additional parameters like "learningRate", "learningRateDecay" as shown below,
--policy=torch_sgd
