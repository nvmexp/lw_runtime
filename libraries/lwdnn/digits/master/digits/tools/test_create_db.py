...
class TestCallwlateBatchSize():
    ...
    def check(self, count, batch_size):
        assert create_db._callwlate_batch_size(count) == batch_size


class TestCallwlateNumThreads():
    ...
    def check(self, batch_size, shuffle, num):
        assert create_db._callwlate_num_threads(
