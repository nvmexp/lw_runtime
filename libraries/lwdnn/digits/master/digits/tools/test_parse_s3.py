...
class TestCallwlatePercentages():
    ...
    def test_making_0(self, mock_input, mock_output):
        parse_s3.callwlate_percentages(None, None, None, None, None, None, None)
    ...
    def test_making_1(self, mock_input, mock_output):
        ...
        for supplied, expected in expected_outputs:
            ...
            output = parse_s3.callwlate_percentages(**args)
    ...
    def test_making_2(self, mock_input, mock_output):
        ...
        for supplied, expected in expected_outputs:
            ...
            output = [x for x in parse_s3.callwlate_percentages(**args) if x != 0]
    ...
    def test_making_3_all_given(self, mock_input, mock_output):
        ...
        expected = (25, 30, 45)
        assert parse_s3.callwlate_percentages(
        ...
        ) == expected, 'Callwlate percentages should return identical values of {}'.format(expected)
    ...
    def test_making_3_2_given(self, mock_input, mock_output):
        ...
        )[2] == expected, 'Callwlate percentages should callwlate third value of {}'.format(expected)
    ...
    def test_making_out_of_range(self, mock_input, mock_output):
        ...
        parse_s3.callwlate_percentages(
            labels_file='not-a-file.txt',
...
class TestParseS3():
    ...
    def test_neg_all_train(self):
        try:
            ...
            labels_file = tempfile.mkstemp(dir=tmpdir)
            train_file = tempfile.mkstemp(dir=tmpdir)
            assert not parse_s3.parse_s3(mock_walker, 'ilwalidbucket', 'train/', labels_file[1], percent_train=100,
