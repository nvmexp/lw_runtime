...
class Scheduler:
    ...
    def add_job(self, job):
        ...
        if not self.running:
            ...
            if 'DIGITS_MODE_TEST' not in os.elwiron:
    ...
    def main_thread(self):
        """
        Monitors the jobs in lwrrent_jobs, updates their statuses,
    ...
    def task_error(self, task, error):
        """
        Handle an error while exelwting a task
        """
    ...
    def reserve_resources(self, task, resources):
        ...
        try:
            ...
            task.lwrrent_resources = resources
            return True
        except Exception as e:
