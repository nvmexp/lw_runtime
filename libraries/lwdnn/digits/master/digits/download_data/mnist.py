...
class MnistDownloader(DataDownloader):
    ...
    def urlList(self):
        return [
            'http://yann.lelwn.com/exdb/mnist/train-images-idx3-ubyte.gz',
            'http://yann.lelwn.com/exdb/mnist/train-labels-idx1-ubyte.gz',
            'http://yann.lelwn.com/exdb/mnist/t10k-images-idx3-ubyte.gz',
            'http://yann.lelwn.com/exdb/mnist/t10k-labels-idx1-ubyte.gz',
        ]
