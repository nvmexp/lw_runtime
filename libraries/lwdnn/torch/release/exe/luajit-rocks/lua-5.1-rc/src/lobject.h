...
#define luarc_clealwalue(o) { setnilvalue((o)); }
#define luarc_cleanarray(from,to) { TValue* i_from = (from); TValue* i_to = (to); while (i_from < i_to) { luarc_clealwalue(i_from++); } }
#define luarc_cleanarrayreverse(to,from) { TValue* i_from = (from); TValue* i_to = (to); while (i_from >= i_to) { luarc_clealwalue(i_from--); } }
