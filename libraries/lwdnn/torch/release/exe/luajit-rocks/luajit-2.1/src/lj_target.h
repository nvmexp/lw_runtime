...
** costs than ilwariants and PHIs should preferably never be spilled.
**
...
**   references than ilwariants and ilwariants have lower IR references
**   than variants.
** - The cost in the upper 16 bits is the sum of the IR reference and a
**   weighted score. The score lwrrently only takes into account whether
