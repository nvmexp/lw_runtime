...
"inBau","ilwau","outBua","outVua",
"callVj","jmpVj","jmp farViw","jmpBj","inBad","ilwad","outBda","outVda",
--Fx
...
"ilwd","wbilwd",nil,"ud1",nil,"$prefetch!Bm","femms","3dnowMrmu",
--1x
...
[0xdc]="stgi",[0xdd]="clgi",[0xde]="skinit",[0xdf]="ilwlpga",
...
"fldFm",nil,"fstFm","fstpFm","fldelwVm","fldcwWm","fnstelwVm","fnstcwWm",
-- DA
