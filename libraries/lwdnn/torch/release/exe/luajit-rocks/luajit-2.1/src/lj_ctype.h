...
** +----------------------------+--------+-------+-------+-------+--
**        ^^  ^^--- bits used for C type colwersion dispatch
*/
...
/*                        ...C...f   cp->fattr */
#define CTFP_CCOLW	0x00000001u	/* cp->fattr + CCOLW/[SSE]REGPARM */
...
#define CTMASK_CCOLW	3		/* Max. 4 calling colwentions. */
#define CTSHIFT_CCOLW	16
...
/* Special sizes. */
#define CTSIZE_ILWALID	0xffffffffu
...
#define ctype_ccolw(info)	(((info) >> CTSHIFT_CCOLW) & CTMASK_CCOLW)
