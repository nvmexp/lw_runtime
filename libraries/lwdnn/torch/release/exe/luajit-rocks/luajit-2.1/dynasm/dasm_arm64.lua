...
local function wflush(term)
  ...
  secpos = 1 -- The actionlist offset oclwpies a buffer position, too.
end
...
local loadelw = setfelw and function(s)
  local code = loadstring(s, "")
  if code then setfelw(code, parse_ctx) end
  return code
end or function(s)
...
local function parse_imm13(imm)
  ...
  if n and n % 1 == 0 and n >= 0 and n <= 0xffffffff then
    local ilw = false
    if band(n, 1) == 1 then n = bit.bnot(n); ilw = true end
    local t = {}
    for i=1,32 do t[i] = band(n, 1); n = shr(n, 1) end
    local b = table.concat(t)
    b = b..(r64 and (ilw and "1" or "0"):rep(32) or b)
...
map_op = {
  ...
  csilw_4 = "5a800000DNMCg",
  csneg_4 = "5a800400DNMCg",
  cset_2  = "1a9f07e0Dcg",
  csetm_2 = "5a9f03e0Dcg",
  cinc_3  = "1a800400DNmcg",
  cilw_3  = "5a800000DNmcg",
  ...
  -- TODO: half-precision and fixed-point colwersions.
...
-- Label pseudo-opcode (colwerted from trailing colon form).
...
map_op[".type_3"] = function(params, nparams)
  ...
  -- Add new type and emit shortlwt define.
