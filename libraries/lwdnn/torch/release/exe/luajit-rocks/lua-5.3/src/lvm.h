...
#else
#define cvt2str(o)	0	/* no colwersion from numbers to strings */
#endif
...
#else
#define cvt2num(o)	0	/* no colwersion from strings to numbers */
#endif


/*
** You can define LUA_FLOORN2I if you want to colwert floats to integers
...
** returns true, there is no need to 'ilwalidateTMcache', because the
...
LUAI_FUNC void luaV_exelwte (lua_State *L);
