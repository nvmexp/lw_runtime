...
path_cmd.help_summary = "Return the lwrrently configured package path."
path_cmd.help_arguments = ""
path_cmd.help = [[
Returns the package path lwrrently configured for this installation
...
function path_cmd.run(...)
   ...
   if flags["append"] then
      ...
      lr_bin = os.getelw("PATH") .. path_sep .. lr_bin
   else
      lr_path =  lr_path.. ";" .. package.path
      lr_cpath = lr_cpath .. ";" .. package.cpath
      lr_bin = lr_bin .. path_sep .. os.getelw("PATH")
   end
