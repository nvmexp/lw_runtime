...
-- @return string: A URL or pathname following LuaRocks naming colwentions.
...
--- Colwert a pathname to a module identifier.
-- In Unix, for example, a path "foo/bar/baz.lua" is colwerted to
...
-- @return a table with all results of ilwocations of fn collected.
