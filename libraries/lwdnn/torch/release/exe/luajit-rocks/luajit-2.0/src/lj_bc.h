...
#define BCDEF(_) \
  ...
  \
  _(ADDLW,	dst,	var,	num,	add) \
  _(SUBLW,	dst,	var,	num,	sub) \
  _(MULLW,	dst,	var,	num,	mul) \
  _(DIVLW,	dst,	var,	num,	div) \
  _(MODLW,	dst,	var,	num,	mod) \
  \
...
/* This solves a cirlwlar dependency problem, change as needed. */
#define FF_next_N	4
