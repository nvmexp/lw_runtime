...
#define CPARSE_MAX_DECLDEPTH	20	/* Max. relwrsive declaration depth. */
...
typedef struct CPState {
  ...
  int depth;		/* Relwrsive declaration depth. */
  ...
  uint8_t lwrpack;	/* Current position in pack pragma stack. */
} CPState;
