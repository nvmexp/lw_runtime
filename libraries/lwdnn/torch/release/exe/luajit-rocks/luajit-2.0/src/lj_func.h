...
LJ_FUNC void LJ_FASTCALL lj_func_freeuv(global_State *g, GLwpval *uv);

/* Functions (closures). */
LJ_FUNC GCfunc *lj_func_newC(lua_State *L, MSize nelems, GCtab *elw);
LJ_FUNC GCfunc *lj_func_newL_empty(lua_State *L, GCproto *pt, GCtab *elw);
