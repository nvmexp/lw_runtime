...
#define STRSCAN_OPT_TOINT	0x01  /* Colwert to int32_t, if possible. */
#define STRSCAN_OPT_TONUM	0x02  /* Always colwert to double. */
...
/* Check for number or colwert string to number/int in-place (!). */
