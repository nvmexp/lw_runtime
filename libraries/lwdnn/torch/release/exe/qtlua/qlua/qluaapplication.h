...
public:
  ...
  Q_ILWOKABLE double timeForLastCommand() const;
  Q_ILWOKABLE QVariant readSettings(QString key);
  Q_ILWOKABLE void writeSettings(QString key, QVariant value);
  Q_ILWOKABLE QStringList filesToOpen();
  Q_ILWOKABLE bool runsWithoutGraphics() const;
