...
#
#  LUA_EXELWTABLE - the full path to lua
...
IF(LUA) # if we are using luarocks
  ...
  ELSE() # too bad, luarocks does not provide it (pfff...)
    GET_FILENAME_COMPONENT(LUA_EXEC_NAME ${LUA_EXELWTABLE} NAME_WE)
...
ELSE() # standalone -- not using luarocks
  ...
  ELSE()
    FIND_PROGRAM(LUA_EXELWTABLE
      ...
      PATH)
  ENDIF()
  MESSAGE(STATUS "Lua exelwtable: ${LUA_EXELWTABLE}")

  IF(LUA_EXELWTABLE)
    GET_FILENAME_COMPONENT(LUA_DIR ${LUA_EXELWTABLE} PATH)
  ENDIF(LUA_EXELWTABLE)
...
IF(NOT Lua_FIND_QUIETLY)
  IF(LUA_FOUND)
    MESSAGE(STATUS "Lua found ${LUA_EXELWTABLE}")
  ELSE(LUA_FOUND)
