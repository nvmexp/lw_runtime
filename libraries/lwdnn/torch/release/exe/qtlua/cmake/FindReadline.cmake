...
# READLINE_nlwrses_LIBRARY, where to find the nlwrses library [might not be defined]
...
# Sometimes readline really needs nlwrses
IF(APPLE)
  FIND_LIBRARY(READLINE_nlwrses_LIBRARY NAMES nlwrses PATHS
    /sw/lib
    /opt/local/lib
    /opt/lib
    /usr/local/lib
...
ENDIF(APPLE)
FIND_LIBRARY(READLINE_nlwrses_LIBRARY NAMES nlwrses)

MARK_AS_ADVANCED(
  READLINE_INCLUDE_DIR
  READLINE_readline_LIBRARY
  READLINE_nlwrses_LIBRARY
  )
...
IF(READLINE_INCLUDE_DIR)
  IF(READLINE_readline_LIBRARY)
    ...
    # some readline libraries depend on nlwrses
    IF(READLINE_nlwrses_LIBRARY)
      SET(READLINE_LIBRARIES ${READLINE_LIBRARIES} ${READLINE_nlwrses_LIBRARY})
    ENDIF(READLINE_nlwrses_LIBRARY)
