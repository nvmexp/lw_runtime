...
public:
  ...
  Q_ILWOKABLE virtual bool readFile(QFile &file);
  Q_ILWOKABLE virtual bool writeFile(QFile &file, bool rename=false);
  Q_ILWOKABLE bool readFile(QString fname);
  Q_ILWOKABLE bool writeFile(QString fname, bool rename=true);
  Q_ILWOKABLE QLuaTextEdit *widget();
