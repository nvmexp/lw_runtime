...
public:
  ...
  Q_ILWOKABLE QObjectList windows() const;
  Q_ILWOKABLE QStringList windowNames() const;
  Q_ILWOKABLE QStringList recentFiles() const;
  Q_ILWOKABLE QWidget* previousWindow() const;
  Q_ILWOKABLE QWidget* activeWindow() const;
  Q_ILWOKABLE QLuaSdiMain *sdiMain() const;
  Q_ILWOKABLE QLuaMdiMain *mdiMain() const;
  Q_ILWOKABLE QMenuBar *globalMenuBar() const;
  Q_ILWOKABLE QMenuBar *defaultMenuBar(QMenuBar *menu);
  Q_ILWOKABLE QAction *hasAction(QByteArray name);
  Q_ILWOKABLE QAction *stdAction(QByteArray name);
...
public slots:
  ...
  bool newDolwment(QWidget *window=0);
  bool luaExelwte(QByteArray cmd);
