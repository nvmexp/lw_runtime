...
public:
  ...
  Q_ILWOKABLE QLuaTextEditMode *editorMode() const;
  Q_ILWOKABLE virtual QDialog *makeFindDialog();
  Q_ILWOKABLE virtual QDialog *makeReplaceDialog();
  Q_ILWOKABLE virtual QDialog *makeGotoDialog();
  Q_ILWOKABLE virtual void prepareDialog(QDialog *dialog);
