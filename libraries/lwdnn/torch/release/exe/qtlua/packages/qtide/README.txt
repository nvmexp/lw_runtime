...
qluatextedit.cpp
   ...
   Class QLuaTextEditMode represents lwstomizable parts of 
...
qluamainwindow.cpp
   ...
   partilwlarly to create QActions and to facilitate
   the MDI mode.
...
qluamdimain.cpp
   ...
   complicated as it ilwolves copying the subwindow menubars
...
qluaide.cpp
   ...
   opens editors when a lua error oclwrs, etc.
...
qluabrowser.cpp
   ...
   that is colwenient for browsing the torch documentation. 
   When qtwebkit is not available, the class ilwokes a
