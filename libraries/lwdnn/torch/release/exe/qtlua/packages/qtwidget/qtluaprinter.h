...
public:
 ~QtLuaPrinter();
  ...
  Q_ILWOKABLE QPrinter* printer() { return static_cast<QPrinter*>(this);}
  Q_ILWOKABLE QPaintDevice* device() { return static_cast<QPaintDevice*>(this);}
  Q_ILWOKABLE void setFromTo(int f, int t) { QPrinter::setFromTo(f, t); }
  Q_ILWOKABLE bool newPage() { return QPrinter::newPage(); }
  Q_ILWOKABLE bool abort() { return QPrinter::abort(); }
  Q_ILWOKABLE bool setup(QWidget *parent=0);
