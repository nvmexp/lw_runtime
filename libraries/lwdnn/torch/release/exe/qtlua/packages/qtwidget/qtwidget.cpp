...
qtluapainter_V(lwrrentpen, QPen)
qtluapainter_V(lwrrentbrush, QBrush)
qtluapainter_V(lwrrentpoint, QPointF)
qtluapainter_V(lwrrentpath, QPainterPath)
qtluapainter_V(lwrrentclip, QPainterPath)
qtluapainter_V(lwrrentfont, QFont)
qtluapainter_V(lwrrentmatrix, QTransform)
qtluapainter_V(lwrrentbackground, QBrush)
qtluapainter_V(lwrrentstylesheet, QString)


static int 
qtluapainter_lwrrentmode(lua_State *L)
{
  QtLuaPainter *p = luaQ_checkqobject<QtLuaPainter>(L, 1);
  const QMetaObject *mo = &QtLuaPainter::staticMetaObject;
  QMetaEnum e = f_enumerator("CompositionMode", mo);
  QtLuaPainter::CompositionMode s = p->lwrrentmode();
...
static int 
qtluapainter_lwrrenthints(lua_State *L)
{
  QtLuaPainter *p = luaQ_checkqobject<QtLuaPainter>(L, 1);
  const QMetaObject *mo = &QtLuaPainter::staticMetaObject;
  QMetaEnum e = f_enumerator("RenderHints", mo);
  QtLuaPainter::RenderHints s = p->lwrrenthints();
...
static int 
qtluapainter_lwrrentangleunit(lua_State *L)
{
  QtLuaPainter *p = luaQ_checkqobject<QtLuaPainter>(L, 1);
  const QMetaObject *mo = &QtLuaPainter::staticMetaObject;
  QMetaEnum e = f_enumerator("AngleUnit", mo);
  QtLuaPainter::AngleUnit s = p->lwrrentangleunit();
  lua_pushstring(L, e.valueToKeys((int)(s)).constData());
  return 1; 
}
...
qtluapainter_vrrrrrr(lwrveto)
qtluapainter_vrrrrrr(rlwrveto)
...
struct luaL_Reg qtluapainter_lib[] = {
  ...
  {"lwrrentpen", qtluapainter_lwrrentpen},
  {"lwrrentbrush", qtluapainter_lwrrentbrush},
  {"lwrrentpoint", qtluapainter_lwrrentpoint},
  {"lwrrentpath", qtluapainter_lwrrentpath},
  {"lwrrentclip", qtluapainter_lwrrentclip},
  {"lwrrentfont", qtluapainter_lwrrentfont},
  {"lwrrentmatrix", qtluapainter_lwrrentmatrix},
  {"lwrrentbackground", qtluapainter_lwrrentbackground},
  {"lwrrentmode", qtluapainter_lwrrentmode},
  {"lwrrenthints", qtluapainter_lwrrenthints},
  {"lwrrentangleunit", qtluapainter_lwrrentangleunit},
  {"lwrrentstylesheet", qtluapainter_lwrrentstylesheet},
  ...
  {"rlwrveto", qtluapainter_rlwrveto},
