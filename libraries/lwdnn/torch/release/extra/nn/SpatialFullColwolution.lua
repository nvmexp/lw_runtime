...
local SpatialFullColwolution, parent = torch.class('nn.SpatialFullColwolution','nn.Module')

function SpatialFullColwolution:__init(nInputPlane, nOutputPlane,
...
function SpatialFullColwolution:reset(stdv)
   if stdv then
...
function SpatialFullColwolution:backCompatibility()
...
function SpatialFullColwolution:updateOutput(input)
  ...
  inputTensor.THNN.SpatialFullColwolution_updateOutput(
    inputTensor:cdata(),
    self.output:cdata(),
    self.weight:cdata(),
...
function SpatialFullColwolution:updateGradInput(input, gradOutput)
  ...
  if self.gradInput then
    ...
    inputTensor.THNN.SpatialFullColwolution_updateGradInput(
      inputTensor:cdata(),
      gradOutput:cdata(),
...
function SpatialFullColwolution:accGradParameters(input, gradOutput, scale)
  ...
  inputTensor.THNN.SpatialFullColwolution_accGradParameters(
    inputTensor:cdata(),
    gradOutput:cdata(),
...
function SpatialFullColwolution:type(type, tensorCache)
  self.finput = self.finput and torch.Tensor()
  self.fgradInput = self.fgradInput and torch.Tensor()
  return parent.type(self, type, tensorCache)
end

function SpatialFullColwolution:__tostring__()
