...
function UpSampling:updateOutput(input)
   ...
   if nDim == 4 then
      ...
      if self.mode == 'nearest' then
         ...
         input.THNN.VolumetrilwpSamplingNearest_updateOutput(
         ...
         input.THNN.VolumetrilwpSamplingTrilinear_updateOutput(
...
function UpSampling:updateGradInput(input, gradOutput)
   ...
   if nDim == 4 then
      ...
      if self.mode == 'nearest' then
         ...
         input.THNN.VolumetrilwpSamplingNearest_updateGradInput(
         ...
         input.THNN.VolumetrilwpSamplingTrilinear_updateGradInput(
