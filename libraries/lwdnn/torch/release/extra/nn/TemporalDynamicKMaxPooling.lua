--[[
   ...
   "A Colwolutional Neural Network for Modelling Sentences"
   ...
   k can be a callwlated value or pre-defined
   ...
   Where:
      k_top is the desired sequence length at the end of the colwolution part,
