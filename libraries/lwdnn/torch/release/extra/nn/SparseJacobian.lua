...
function nn.SparseJacobian.testJacobian (module, input, milwal, maxval)
   milwal = milwal or -2
   maxval = maxval or 2
   local inrange = maxval - milwal
   input:select(2,2):copy(torch.rand(input:size(1)):mul(inrange):add(milwal))
...
function nn.SparseJacobian.testJacobianParameters (module, input, param, dparam, milwal, maxval)
   milwal = milwal or -2
   maxval = maxval or 2
   local inrange = maxval - milwal
   input:select(2,2):copy(torch.rand(input:size(1)):mul(inrange):add(milwal))
...
function nn.SparseJacobian.testJacobianUpdateParameters (module, input, param, milwal, maxval)
   milwal = milwal or -2
   maxval = maxval or 2
   local inrange = maxval - milwal
   input:select(2,2):copy(torch.rand(input:size(1)):mul(inrange):add(milwal))
...
function nn.SparseJacobian.testIO(module,input, milwal, maxval)
   milwal = milwal or -2
   maxval = maxval or 2
   local inrange = maxval - milwal
