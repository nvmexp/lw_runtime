local SpatialFullColwolutionMap, parent = torch.class('nn.SpatialFullColwolutionMap', 'nn.Module')

function SpatialFullColwolutionMap:__init(conMatrix, kW, kH, dW, dH)
   parent.__init(self)
...
function SpatialFullColwolutionMap:reset(stdv)
   if stdv then
...
function SpatialFullColwolutionMap:updateOutput(input)
   input.THNN.SpatialFullColwolutionMap_updateOutput(
      input:cdata(),
      self.output:cdata(),
      self.weight:cdata(),
      self.bias:cdata(),
...
function SpatialFullColwolutionMap:updateGradInput(input, gradOutput)
   input.THNN.SpatialFullColwolutionMap_updateGradInput(
      input:cdata(),
      gradOutput:cdata(),
...
function SpatialFullColwolutionMap:accGradParameters(input, gradOutput, scale)
   input.THNN.SpatialFullColwolutionMap_accGradParameters(
      input:cdata(),
      gradOutput:cdata(),
