...
function WeightedEuclidean:updateOutput(input)
   ...
   elseif input:dim() == 2 then
      ...
      if torch.type(input) == 'torch.LwdaTensor' then
         -- requires lots of memory, but minimizes lwdaMallocs and loops
...
function WeightedEuclidean:aclwpdateGradParameters(input, gradOutput, lr)
