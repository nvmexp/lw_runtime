...
#define TH_GENERIC_FILE "generic/VolumetricColwolutionMM.c"
#else

static void inline THNN_(VolumetricColwolutionMM_shapeCheck)(
                         THNNState *state,
                         THTensor *input,
                         THTensor *gradOutput,
                         THTensor *weight,
...
static void THNN_(VolumetricColwolutionMM_updateOutput_frame)(
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          THTensor *bias,
...
void THNN_(VolumetricColwolutionMM_updateOutput)(
          THNNState *state,
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          ...
          int pH)
{
  ...
  THNN_(VolumetricColwolutionMM_shapeCheck)(
  ...
  if (input->nDimension == 4)
  {
    ...
    THNN_(VolumetricColwolutionMM_updateOutput_frame)(
...
static void THNN_(VolumetricColwolutionMM_updateGradInput_frame)(
          THTensor *gradInput,
          THTensor *gradOutput,
          THTensor *weight,
          THTensor *fgradInput,
...
void THNN_(VolumetricColwolutionMM_updateGradInput)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradInput,
          ...
          int pH)
{
  ...
  if (input->nDimension == 4)
  {
    THNN_(VolumetricColwolutionMM_updateGradInput_frame)(
...
static void THNN_(VolumetricColwolutionMM_accGradParameters_frame)(
          THTensor *gradOutput,
          THTensor *gradWeight,
          THTensor *gradBias,
          THTensor *finput,
...
void THNN_(VolumetricColwolutionMM_accGradParameters)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradWeight,
          ...
          accreal scale_)
{
  ...
  {
    THNN_(VolumetricColwolutionMM_accGradParameters_frame)(gradOutput, gradWeight, gradBias, finput, scale);
  }
  else  // batch mode
  {
    long T = input->size[0];
    ...
    for (t = 0; t < T; t++)
    {
      ...
      THNN_(VolumetricColwolutionMM_accGradParameters_frame)(gradOutput_t, gradWeight, gradBias, finput_t, scale);
