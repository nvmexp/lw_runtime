...
#define TH_GENERIC_FILE "generic/SpatialColwolutionMM.c"
#else

static inline void THNN_(SpatialColwolutionMM_shapeCheck)(
...
static void THNN_(SpatialColwolutionMM_updateOutput_frame)(
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          THTensor *bias,
...
void THNN_(SpatialColwolutionMM_updateOutput)(
          THNNState *state,
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          ...
          int padH)
{
  ...
  THNN_(SpatialColwolutionMM_shapeCheck)
  ...
  if(input->nDimension == 3)
  {
    ...
    THNN_(SpatialColwolutionMM_updateOutput_frame)
...
static void THNN_(SpatialColwolutionMM_updateGradInput_frame)(
          THTensor *gradInput,
          THTensor *gradOutput,
          THTensor *weight,
          THTensor *fgradInput,
...
void THNN_(SpatialColwolutionMM_updateGradInput)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradInput,
          ...
          int padH)
{
  ...
  if(input->nDimension == 3)
  {
    THNN_(SpatialColwolutionMM_updateGradInput_frame)(gradInput, gradOutput,
						      tweight, fgradInput,
						      kW, kH, dW, dH, padW, padH);
  }
  else
...
#pragma omp parallel for private(t)
    for(t = 0; t < T; t++)
    {
      ...
      THNN_(SpatialColwolutionMM_updateGradInput_frame)(gradInput_t, gradOutput_t,
...
static void THNN_(SpatialColwolutionMM_accGradParameters_frame)(
          THTensor *gradOutput,
          THTensor *gradWeight,
          THTensor *gradBias,
          THTensor *finput,
...
void THNN_(SpatialColwolutionMM_accGradParameters)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradWeight,
          ...
          accreal scale_)
{
  ...
  if(input->nDimension == 3)
  {
    THNN_(SpatialColwolutionMM_accGradParameters_frame)(gradOutput, gradWeight,
  ...
  else
  {
    ...
    for(t = 0; t < T; t++)
    {
      ...
      THNN_(SpatialColwolutionMM_accGradParameters_frame)(gradOutput_t, gradWeight,
