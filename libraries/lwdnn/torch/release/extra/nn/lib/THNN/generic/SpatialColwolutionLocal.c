...
#define TH_GENERIC_FILE "generic/SpatialColwolutionLocal.c"
#else
...
static void THNN_(SpatialColwolutionLocal_updateOutput_frame)
     (
    ...
    long outputWidth, long outputHeight)
{
  ...
  if(input->nDimension == 3)
  {
    ...
    THNN_(SpatialColwolutionLocal_updateOutput_frame)
...
static void THNN_(SpatialColwolutionLocal_updateGradInput_frame)
    ...
    long outputWidth, long outputHeight)
{
  ...
  if(input->nDimension == 3)
  {
    THNN_(SpatialColwolutionLocal_updateGradInput_frame)
...
static void THNN_(SpatialColwolutionLocal_accGradParameters_frame)
    ...
    accreal scale_)
{
  ...
  if(input->nDimension == 3)
  {
    THNN_(SpatialColwolutionLocal_accGradParameters_frame)
