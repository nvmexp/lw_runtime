...
#define TH_GENERIC_FILE "generic/SpatialFullDilatedColwolution.c"
#else
...
static inline void THNN_(SpatialFullDilatedColwolution_shapeCheck)(
...
void THNN_(SpatialFullDilatedColwolution_updateOutput)(
    THNNState *state,
    THTensor *input,
    THTensor *output,
    THTensor *weight,
    ...
    int adjW, int adjH)
{
  THNN_(SpatialFullDilatedColwolution_shapeCheck)
...
void THNN_(SpatialFullDilatedColwolution_updateGradInput)(
    THNNState *state,
    THTensor *input,
    THTensor *gradOutput,
    THTensor *gradInput,
...
void THNN_(SpatialFullDilatedColwolution_accGradParameters)(
    THNNState *state,
    THTensor *input,
    THTensor *gradOutput,
    THTensor *gradWeight,
