...
#define TH_GENERIC_FILE "generic/SpatialFullColwolutionMap.c"
#else

void THNN_(SpatialFullColwolutionMap_updateOutput)(
...
void THNN_(SpatialFullColwolutionMap_updateGradInput)(
...
void THNN_(SpatialFullColwolutionMap_accGradParameters)(
  THNNState *state,
  THTensor *input,
  THTensor *gradOutput,
  THTensor *gradWeight,
