...
#define TH_GENERIC_FILE "generic/VolumetrilwpSamplingNearest.c"
#else


static inline void THNN_(VolumetrilwpSamplingNearest_shapeCheck)
...
void THNN_(VolumetrilwpSamplingNearest_updateOutput)(
    THNNState *state,
    THTensor *input,
    THTensor *output,
    int scale_factor)
{
  THNN_(VolumetrilwpSamplingNearest_shapeCheck)(input, NULL, scale_factor);
...
void THNN_(VolumetrilwpSamplingNearest_updateGradInput)(
    THNNState *state,
    THTensor *input,
    THTensor *gradOutput,
    THTensor *gradInput,
    int scale_factor)
{
  THNN_(VolumetrilwpSamplingNearest_shapeCheck)(input, gradOutput, scale_factor);
