...
#define TH_GENERIC_FILE "generic/SpatialDepthWiseColwolution.c"
#else
...
static void THNN_(SpatialDepthWiseColwolution_updateOutput_frame)(
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          THTensor *bias,
...
#pragma omp parallel for private(i)
    for(i = 0; i < nInputPlane; i++)
    {
      ...
      THNN_(SpatialDepthWiseColwolution_updateOutput_frame)
...
static void THNN_(SpatialDepthWiseColwolution_updateGradInput_frame)(
          THTensor *gradInput,
          THTensor *gradOutput,
          THTensor *weight,
          THTensor *fgradInput,
...
#pragma omp parallel for private(i)
    for(i = 0; i < nInputPlane; i++)
    {
      ...
      THNN_(SpatialDepthWiseColwolution_updateGradInput_frame)(gradInput_i, gradOutput_i,
...
static void THNN_(SpatialDepthWiseColwolution_accGradParameters_frame)(
          THTensor *gradOutput,
          THTensor *gradWeight,
          THTensor *gradBias,
          THTensor *finput,
...
#pragma omp parallel for private(i)
    for(i = 0; i < nInputPlane; i++)
    {
      ...
      THNN_(SpatialDepthWiseColwolution_accGradParameters_frame)(gradOutput_i, gradWeight_i,
