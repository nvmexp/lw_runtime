...
for i,line in ipairs(lines) do
   ...
   if lwrrent_declaration then
      lwrrent_declaration = lwrrent_declaration .. line .. '\n'
   end

   if line:match('%);') then
     lwrrent_declaration = lwrrent_declaration:sub(1, -2) -- remove a trailing newline
     declarations[declaration_module] = declarations[declaration_module] or {}
     table.insert(declarations[declaration_module], lwrrent_declaration)
     lwrrent_declaration = nil
