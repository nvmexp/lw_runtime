...
#define TH_GENERIC_FILE "generic/TemporalColwolution.c"
#else

static inline void THNN_(TemporalColwolution_shapeCheck)(
                         THNNState *state,
                         THTensor *input,
                         int kW,
                         int dW,
...
void THNN_(TemporalColwolution_updateOutput)(
          THNNState *state,
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          ...
          int outputFrameSize)
{
  ...
  THNN_(TemporalColwolution_shapeCheck)
...
void THNN_(TemporalColwolution_updateGradInput)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradInput,
...
void THNN_(TemporalColwolution_accGradParameters)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradWeight,
