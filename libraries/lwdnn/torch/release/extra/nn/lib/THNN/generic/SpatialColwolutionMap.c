...
#define TH_GENERIC_FILE "generic/SpatialColwolutionMap.c"
#else

void THNN_(SpatialColwolutionMap_updateOutput)(
...
void THNN_(SpatialColwolutionMap_updateGradInput)(
...
void THNN_(SpatialColwolutionMap_accGradParameters)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradWeight,
