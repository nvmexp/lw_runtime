...
#define TH_GENERIC_FILE "generic/TemporalRowColwolution.c"
#else

static inline void THNN_(TemporalRowColwolution_shapeCheck)(
	THNNState *state,
	THTensor *input,
	THTensor *gradOutput,
	THTensor *weight,
	...
	if (nOutputFrame < 1) {
		THError("Given input size: (%d x %d). "
		        "Callwlated output size: (%d x %d). Output size is too small",
...
static void THNN_(TemporalRowColwolution_updateOutput_frame)(
	THTensor *input,
	THTensor *output,
	THTensor *weight,
	THTensor *bias,
...
void THNN_(TemporalRowColwolution_updateOutput)(
	THNNState *state,
	THTensor *input,
	THTensor *output,
	THTensor *weight,
	THTensor *bias,
	THTensor *finput,
	THTensor *fgradInput,     // unused here but needed for Lwca
	int kW,
	int dW,
	int padW,
	bool featFirst) {
	...
	THNN_(TemporalRowColwolution_shapeCheck)(
	...
	if (ndim == 2) { /* non-batch mode */
		...
		THNN_(TemporalRowColwolution_updateOutput_frame)
...
static void THNN_(TemporalRowColwolution_updateGradInput_frame)(
	THTensor *gradInput,
	THTensor *gradOutput,
	THTensor *weight,
	THTensor *fgradInput,
...
void THNN_(TemporalRowColwolution_updateGradInput)(
	THNNState *state,
	THTensor *input,
	THTensor *gradOutput,
	THTensor *gradInput,
	...
	THNN_(TemporalRowColwolution_shapeCheck)(state, input, gradOutput, weight,
	                                         NULL, kW, dW, padW);
	...
	if (ndim == 2) {
		THNN_(TemporalRowColwolution_updateGradInput_frame)
...
static void THNN_(TemporalRowColwolution_accGradParameters_frame)(
...
void THNN_(TemporalRowColwolution_accGradParameters)(
	THNNState *state,
	THTensor *input,
	THTensor *gradOutput,
	THTensor *gradWeight,
    ...
    real scale = TH_COLWERT_ACCREAL_TO_REAL(scale_);
	int ndim = input->nDimension;
	...
	if (ndim == 2) {
		THNN_(TemporalRowColwolution_accGradParameters_frame)(
