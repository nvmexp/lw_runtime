local SpatialColwolutionMap, parent = torch.class('nn.SpatialColwolutionMap', 'nn.Module')
...
function SpatialColwolutionMap:__init(conMatrix, kW, kH, dW, dH)
   parent.__init(self)
...
function SpatialColwolutionMap:reset(stdv)
   if stdv then
...
function SpatialColwolutionMap:updateOutput(input)
   input.THNN.SpatialColwolutionMap_updateOutput(
      input:cdata(),
      self.output:cdata(),
      self.weight:cdata(),
      self.bias:cdata(),
...
function SpatialColwolutionMap:updateGradInput(input, gradOutput)
   input.THNN.SpatialColwolutionMap_updateGradInput(
      input:cdata(),
      gradOutput:cdata(),
...
function SpatialColwolutionMap:accGradParameters(input, gradOutput, scale)
   input.THNN.SpatialColwolutionMap_accGradParameters(
      input:cdata(),
      gradOutput:cdata(),
...
function SpatialColwolutionMap:decayParameters(decay)
