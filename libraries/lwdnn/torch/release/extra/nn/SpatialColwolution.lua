...
local SpatialColwolution, parent = torch.class('nn.SpatialColwolution', 'nn.Module')

function SpatialColwolution:__init(nInputPlane, nOutputPlane, kW, kH, dW, dH, padW, padH)
   parent.__init(self)
