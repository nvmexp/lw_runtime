...
local function lwrsor_pairs(lwrsor_,key_,op_)
...
local function mtest()
  ...
  local e = lightningmdb.elw_create()
  ...
  print("cursor next")
  local key
  for k,v in lwrsor_pairs(c,nil,MDB.NEXT) do
    print(k,v)
    key = k
  end
  ...
  for k,v in lwrsor_pairs(c,key,MDB.PREV) do
    print(k,v)
  end
