...
-- The findLwrrentNode() depends on the names of the
-- local variables in the nngraph.gModule source code.
local function findLwrrentNode()
...
local function lwstomToDot(graph, title, failedNode)
...
local function onError(failedNode, gmodule)
   ...
   local dotStr = lwstomToDot(gmodule.fg, svgPathPrefix, failedNode)
...
-- if an exception oclwrs in a graph exelwtion.
