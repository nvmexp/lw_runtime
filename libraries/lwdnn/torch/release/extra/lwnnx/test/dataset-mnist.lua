...
function mnist.loadTrainSet(maxLoad, geometry)
   return mnist.loadColwDataset(mnist.path_trainset, maxLoad, geometry)
end

function mnist.loadTestSet(maxLoad, geometry)
   return mnist.loadColwDataset(mnist.path_testset, maxLoad, geometry)
end
...
function mnist.loadColwDataset(fileName, maxLoad, geometry)
