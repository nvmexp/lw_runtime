...
function NoisyReLU:__init(sparsityFactor, threshold_lr, alpha_range, std)
   ...
   --              contemporary sparsity when callwlating the mean sparsity over many batches. 
   ...
   -- when callwlating the moving average mean
...
function NoisyReLU:updateOutput(input)
   ...
   -- recallwlate mean sparsity, using exponential moving average   
