...
function TypeDecorator:aclwpdateGradParameters(input, gradOutput, lr)
   return self.module:aclwpdateGradParameters(input, gradOutput, lr)
end

function TypeDecorator:sharedAclwpdateGradParameters(input, gradOutput, lr)
   return self.module:sharedAclwpdateGradParameters(input, gradOutput, lr)
end
