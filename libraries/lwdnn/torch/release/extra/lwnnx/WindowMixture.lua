...
function WindowMixture:aclwpdateGradParameters(inputTable, gradOutputTable, lr)
   self.expert:aclwpdateGradParameters(self.expertInput, {self.mixtureGradInput[2]}, lr)
   self.gater:aclwpdateGradParameters(inputTable, self.mixtureGradInput[1], lr)
end
