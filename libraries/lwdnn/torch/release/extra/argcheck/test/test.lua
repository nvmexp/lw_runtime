...
local elw = require 'argcheck.elw'
...
assert(elw.type('string') == 'string')
assert(elw.type(foobar) == 'foobar')

if pcall(require, 'torch') then
   local t = torch.LongTensor()
   assert(elw.type(t) == 'torch.LongTensor')
   assert(elw.istype(t, 'torch.LongTensor') == true)
   assert(elw.istype(t, 'torch.*Tensor') == true)
   assert(elw.istype(t, '.*Long') == true)
   assert(elw.istype(t, 'torch.IntTensor') == false)
   assert(elw.istype(t, 'torch.Long') == false)
