...
THC_API void THCTensor_(btrifact)(THCState *state, THCTensor *ra_, THLwdaIntTensor *rpivots_, THLwdaIntTensor *rinfo_, int pivot, THCTensor *a);
THC_API void THCTensor_(btrisolve)(THCState *state, THCTensor *rb_, THCTensor *b, THCTensor *atf, THLwdaIntTensor *pivots);
