...
THC_API void THCTensor_(ltValue)(THCState *state, THLwdaByteTensor *self_, THCTensor *src, real value);
THC_API void THCTensor_(gtValue)(THCState *state, THLwdaByteTensor *self_, THCTensor *src, real value);
THC_API void THCTensor_(leValue)(THCState *state, THLwdaByteTensor *self_, THCTensor *src, real value);
THC_API void THCTensor_(geValue)(THCState *state, THLwdaByteTensor *self_, THCTensor *src, real value);
THC_API void THCTensor_(eqValue)(THCState *state, THLwdaByteTensor *self_, THCTensor *src, real value);
THC_API void THCTensor_(neValue)(THCState *state, THLwdaByteTensor *self_, THCTensor *src, real value);
