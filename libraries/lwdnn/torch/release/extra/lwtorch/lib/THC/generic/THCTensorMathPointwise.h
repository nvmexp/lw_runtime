...
THC_API void THCTensor_(cilw)(THCState *state, THCTensor *self, THCTensor *src);
...
THC_API void THCTensor_(cmilwalue)(THCState *state, THCTensor *self, THCTensor *src, real value);
