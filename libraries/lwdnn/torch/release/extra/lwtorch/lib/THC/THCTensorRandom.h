#ifndef TH_LWDA_TENSOR_RANDOM_INC
#define TH_LWDA_TENSOR_RANDOM_INC
...
typedef struct _Generator {
  struct lwrandStateMtgp32* gen_states;
...
THC_API void THCRandom_init(struct THCState *state, int num_devices, int lwrrent_device);
...
THC_API struct lwrandStateMtgp32* THCRandom_generatorStates(struct THCState* state);
