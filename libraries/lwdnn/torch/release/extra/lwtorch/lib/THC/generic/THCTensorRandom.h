...
THC_API void THCTensor_(multinomial)(struct THCState *state, THLwdaLongTensor *self, THCTensor *prob_dist, int n_sample, int with_replacement);
THC_API void THCTensor_(multinomialAliasSetup)(struct THCState *state, THCTensor *probs, THLwdaLongTensor *J, THCTensor *q);
...
THC_API void THCTensor_(bernoulli_FloatTensor)(struct THCState *state, THCTensor *self, THLwdaTensor *p);
THC_API void THCTensor_(bernoulli_DoubleTensor)(struct THCState *state, THCTensor *self, THLwdaDoubleTensor *p);
