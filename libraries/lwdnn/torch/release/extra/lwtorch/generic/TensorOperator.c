...
static int lwtorch_TensorOperator_(__add__)(lua_State *L)
{
...
static int lwtorch_TensorOperator_(__sub__)(lua_State *L)
{
  THCTensor *tensor1 = luaT_toudata(L, 1, torch_Tensor);
  THCTensor *tensor2 = luaT_toudata(L, 2, torch_Tensor);
  THCTensor *r;
...
static int lwtorch_TensorOperator_(__unm__)(lua_State *L)
{
...
static int lwtorch_TensorOperator_(__mul__)(lua_State *L)
{
...
static int lwtorch_TensorOperator_(__div__)(lua_State *L)
{
  THCTensor *tensor = luaT_checkudata(L, 1, torch_Tensor);
  THCTensor *r;
  THCState *state = lwtorch_getstate(L);
...
static const struct luaL_Reg lwtorch_TensorOperator_(_) [] = {
  {"__add__", lwtorch_TensorOperator_(__add__)},
  {"__sub__", lwtorch_TensorOperator_(__sub__)},
  {"__unm__", lwtorch_TensorOperator_(__unm__)},
  {"__mul__", lwtorch_TensorOperator_(__mul__)},
  {"__div__", lwtorch_TensorOperator_(__div__)},
  {NULL, NULL}
};

void lwtorch_TensorOperator_(init)(lua_State *L)
{
  luaT_pushmetatable(L, torch_Tensor);
  luaT_setfuncs(L, lwtorch_TensorOperator_(_), 0);
  lua_pop(L, 1);
}
