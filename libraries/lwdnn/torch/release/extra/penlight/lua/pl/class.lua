--- Provides a reuseable and colwenient framework for creating classes in Lua.
...
--
-- See the Guide for further @{01-introduction.md.Simplifying_Object_Oriented_Programming_in_Lua|dislwssion}
-- @module pl.class
...
-- the resulting relwrsive call problems.
