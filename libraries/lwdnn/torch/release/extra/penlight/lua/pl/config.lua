...
--  * `colwert_numbers` try to colwert values into numbers (default true)
...
function config.read(file,cnfg)
    ...
    local colwert_numbers = check_cnfg('colwert_numbers',true)
    local colwert_boolean = check_cnfg('colwert_boolean',false)
    ...
    local function process_value(value)
        ...
        elseif colwert_numbers and value:find(initial_digits) then
        ...
        elseif colwert_boolean and value == 'true' then
           return true
        elseif colwert_boolean and value == 'false' then
           return false
        end
