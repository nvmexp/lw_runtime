...
-- don't colwert strings to numbers
testconfig ([[
alpha.dog=10
; comment here
]],{
    alpha_dog="10"
},{colwert_numbers=false})

-- colwert strings to booleans
testconfig ([[
alpha.dog=false
alpha.cat=true
; comment here
...
-- from values
testconfig([[
# Global options for ilwocations of find(1)
...
-- a custom colwert_numbers handles the units properly!
