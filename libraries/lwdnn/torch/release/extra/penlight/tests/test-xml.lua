...
-- or we can use a template document to colwert Lua data to LOM
...
<xml_api_reply version='1'>
  <weather module_id='0' tab_id='0' mobile_zipped='1' section='0' row='0' mobile_row='0'>
    <forecast_information>
      ...
      <lwrrent_date_time data='2010-10-02 18:30:00 +0000'/>
      <unit_system data='US'/>
    </forecast_information>
    <lwrrent_conditions>
...
-- we partilwlarly want to test the built-in XML parser here, not lxp.lom
...
-- note that HTML mode lwrrently barfs if there isn't whitespace around things
-- like '<' and '>' in scripts.
doc = xml.parsehtml [[
<html>
<head>
