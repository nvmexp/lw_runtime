...
for _, typename in ipairs{
   ...
   'torch.HalfStorage',
   'torch.LwdaStorage',
   'torch.LwdaByteStorage',
   'torch.LwdaCharStorage',
   'torch.LwdaShortStorage',
   'torch.LwdaIntStorage',
   'torch.LwdaLongStorage',
   'torch.LwdaDoubleStorage',
   'torch.LwdaHalfStorage',
   'torch.Allocator'} do
