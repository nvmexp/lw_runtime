...
function SoftMaxForest:__init(inputSize, trees, rootIds, gaterSize, gaterAct, aclwpdate)
   ...
   for i,tree in ipairs(trees) do
      local smt = nn.SoftMaxTree(inputSize, tree, rootIds[i], aclwpdate)
...
function SoftMaxForest:aclwpdateGradParameters(input, gradOutput, lr)
   self.module:aclwpdateGradParameters(input, gradOutput, lr)
end
