...
-- Colwerts a [batch x channel x m x p] tensor to [batch x channel*r^2 x m/r x p/r]

-- tensor, where r is the downscaling factor.

-- Useful as an alternative to pooling & strided colwolutions, as it doesn't discard information

-- if used with bottleneck colwolution, you can discard half of the information, as opposed to 3/4 in pooling

-- also avoids the 'checkerboard' sampling issues found with strided colwolutions.
...
-- Computes the forward pass of the layer i.e. Colwerts a
