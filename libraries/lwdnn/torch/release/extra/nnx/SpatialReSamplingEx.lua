...
function SpatialReSamplingEx:updateOutput(input)
   ...
   self.oheightLwrrent = self.oheight or round(self.rheight*self.iheight)
   self.owidthLwrrent = self.owidth or round(self.rwidth*self.iwidth)
   if not ((self.oheightLwrrent>=self.iheight) == (self.owidthLwrrent>=self.iwidth)) then
   ...
   self.outputSize[2] = self.oheightLwrrent
   self.outputSize[3] = self.owidthLwrrent
   ...
   outputSize2[self.yDim] = self.oheightLwrrent
   outputSize2[self.xDim] = self.owidthLwrrent
