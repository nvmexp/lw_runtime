local VolumetricCrossEntropyCriterion, parent = torch.class('lwdnn.VolumetricCrossEntropyCriterion', 'nn.Criterion')
...
function VolumetricCrossEntropyCriterion:__init(weights)
    parent.__init(self)
    self.scec = lwdnn.SpatialCrossEntropyCriterion(weights)
end
