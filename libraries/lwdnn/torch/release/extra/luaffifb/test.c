...
EXPORT int print_blwp(size_t* sz, size_t* align, char* buf, struct blwp* s);
int print_blwp(size_t* sz, size_t* align, char* buf, struct blwp* s) {
    *sz = sizeof(struct blwp);
    *align = alignof(struct blwp);
