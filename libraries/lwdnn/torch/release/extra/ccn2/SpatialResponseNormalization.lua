...
function SpatialResponseNormalization:updateOutput(input)
  ...
  C['colwResponseNorm'](lwtorch.getState(), inputC:cdata(), self.denoms:cdata(), self.output:cdata(),
...
function SpatialResponseNormalization:updateGradInput(input, gradOutput)
  ...
  C['colwResponseNormUndo'](lwtorch.getState(), gradOutputC:cdata(), self.denoms:cdata(), inputC:cdata(), outputC:cdata(),
