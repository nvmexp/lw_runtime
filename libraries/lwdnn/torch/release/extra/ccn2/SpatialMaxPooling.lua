...
function SpatialMaxPooling:updateOutput(input)
  ...
  C['colwLocalMaxPool'](lwtorch.getState(), inputC:cdata(), self.output:cdata(), input:size(1), self.kW, 0, self.dW, outputX)
...
function SpatialMaxPooling:updateGradInput(input, gradOutput)
  ...
  C['colwLocalMaxUndo'](lwtorch.getState(), inputC:cdata(), gradOutputC:cdata(), outputC:cdata(), self.gradInput:cdata(), self.kW, 0, self.dW, outputX)
