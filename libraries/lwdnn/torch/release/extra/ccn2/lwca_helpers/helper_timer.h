    ...
    public:
            ...
            running(false), clock_sessions(0), freq(0), freq_set(false)
        {
            if (! freq_set)
            {
                ...
                // colwert to type in which it is needed
...
////////////////////////////////////////////////////////////////////////////////
//! Return the average time for timer exelwtion as the total time
//! for the timer dividied by the number of completed (stopped) runs the timer
//! has made.
//! Excludes the current running time if the timer is lwrrently running.
...
////////////////////////////////////////////////////////////////////////////////
//! Total exelwtion time for the timer over all runs since the last reset
//! or timer creation.
