...
namespace
{
    ...
    //! Data colwerter from unsigned char / unsigned byte to type T
    template<class T>
    struct ColwerterFromUByte;

    //! Data colwerter from unsigned char / unsigned byte
    template<>
    struct ColwerterFromUByte<unsigned char>
    {
        //! Colwersion operator
        //! @return colwerted value
        //! @param  val  value to colwert
    ...
    //! Data colwerter from unsigned char / unsigned byte to float
    template<>
    struct ColwerterFromUByte<float>
    {
        //! Colwersion operator
        //! @return colwerted value
        //! @param  val  value to colwert
    ...
    //! Data colwerter from unsigned char / unsigned byte to type T
    template<class T>
    struct ColwerterToUByte;

    //! Data colwerter from unsigned char / unsigned byte to unsigned int
    template<>
    struct ColwerterToUByte<unsigned char>
    {
        //! Colwersion operator (essentially a passthru
        //! @return colwerted value
        //! @param  val  value to colwert
...
sdkLoadPGM(const char *file, T **data, unsigned int *w, unsigned int *h)
{
    ...
    // copy and cast data
    std::transform(idata, idata + size, *data, ColwerterFromUByte<T>());
...
sdkSavePGM(const char *file, T *data, unsigned int w, unsigned int h)
{
    ...
    std::transform(data, data + size, idata, ColwerterToUByte<T>());
