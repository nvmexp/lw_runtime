...
function SpatialCrossResponseNormalization:updateOutput(input)
  ...
  C['colwResponseNormCrossMap'](lwtorch.getState(), inputC:cdata(), self.output:cdata(),
...
function SpatialCrossResponseNormalization:updateGradInput(input, gradOutput)
  ...
  C['colwResponseNormCrossMapUndo'](lwtorch.getState(), gradOutputC:cdata(), inputC:cdata(), outputC:cdata(),
