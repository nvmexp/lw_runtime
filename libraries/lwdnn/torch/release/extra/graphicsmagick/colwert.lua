...
local found = sys.fexelwte(findgm):find('gm')
if not found then
   print 'gm (GraphicsMagick) binary not found, please install (see www.graphicsmagick.org)'
end

-- Command line colwert:
local function colwert(...)
   -- args
   local args = dok.unpack(
      {...}, 
      'gm.colwert',
      'Colwerts an image into another.',
