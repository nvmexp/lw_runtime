...
local cjson_tests = {
    ...
    { "Set decode_ilwalid_numbers(true)",
      json.decode_ilwalid_numbers, { true }, true, { true } },
    { "Decode hexadecimal",
    ...
    { "Set decode_ilwalid_numbers(false)",
      json.decode_ilwalid_numbers, { false }, true, { false } },
    ...
    { "Decode +-NaN [throw error]",
      ...
      false, { "Expected value but found invalid token at character 3" } },
    { 'Set decode_ilwalid_numbers("on")',
      json.decode_ilwalid_numbers, { "on" }, true, { true } },

    -- Test encoding invalid numbers
    { "Set encode_ilwalid_numbers(false)",
      json.encode_ilwalid_numbers, { false }, true, { false } },
    ...
    { "Encode Infinity [throw error]",
      json.encode, { Inf },
      false, { "Cannot serialise number: must not be NaN or Infinity" } },
    { "Set encode_ilwalid_numbers(\"null\")",
      json.encode_ilwalid_numbers, { "null" }, true, { "null" } },
    { "Encode NaN as null",
      json.encode, { NaN }, true, { "null" } },
    { "Encode Infinity as null",
      json.encode, { Inf }, true, { "null" } },
    { "Set encode_ilwalid_numbers(true)",
      json.encode_ilwalid_numbers, { true }, true, { true } },
    { "Encode NaN",
    ...
    { "Encode -Infinity",
      json.encode, { -Inf }, true, { "-Infinity" } },
    { 'Set encode_ilwalid_numbers("off")',
      json.encode_ilwalid_numbers, { "off" }, true, { false } },
    ...
    { "Set encode_ilwalid_numbers(-2) [throw error]",
      json.encode_ilwalid_numbers, { -2 },
      false, { "bad argument #1 to '?' (invalid option '-2')" } },
    { "Set decode_ilwalid_numbers(true, false) [throw error]",
      json.decode_ilwalid_numbers, { true, false },
      false, { "bad argument #2 to '?' (found too many arguments)" } },
