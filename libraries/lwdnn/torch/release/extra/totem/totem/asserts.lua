...
* `tolerance` (optional number, default 0) maximum elementwise difference
    between `ta` and `tb`.
* `negate` (optional boolean, default false) if `negate` is true, we ilwert
    success and failure.
...
function totem.areStoragesEq(sa, sb, tolerance, negate)
  -- If negate is true, we ilwert success and failure
  negate = negate or false
  tolerance = tolerance or 0
...
Tables are compared relwrsively. If any of their key or associated value type
