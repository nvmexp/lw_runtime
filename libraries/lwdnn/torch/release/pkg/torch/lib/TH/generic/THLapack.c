...
/* Solve overdetermined or underdetermined real linear systems ilwolving an
...
/* Compute all eigelwalues and, optionally, eigelwectors of a real symmetric
matrix A */
...
/* Compute for an N-by-N real nonsymmetric matrix A, the eigelwalues and,
optionally, the left and/or right eigelwectors */
...
/* Cholesky factorization based Matrix Ilwerse */
