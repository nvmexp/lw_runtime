 ...
 * control is returned to the library's caller when a fatal error oclwrs,
...
static int libjpeg_(Main_size)(lua_State *L)
{
   ...
   * warnings oclwrred (test whether jerr.pub.num_warnings is nonzero).
   */
...
static int libjpeg_(Main_load)(lua_State *L)
{
  ...
  while (cinfo.output_scanline < height) {
     ...
     * more than one scanline at a time if that's more colwenient.
     */
