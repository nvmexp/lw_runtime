...
t0 = sys.clock()
im_bilwbic = image.warp(im, flow, 'bilwbic', false)
t1 = sys.clock()
print("Upscale Time bilwbic = " .. (t1 - t0))  -- Not a robust measure (should average)
image.display{image = im_bilwbic, zoom = 1, legend = 'upscale bilwbic'}
...
im_bilwbic = image.warp(im, flow, 'bilwbic', false)
t1 = sys.clock()
print("Rotation Time bilwbic = " .. (t1 - t0))  -- Not a robust measure (should average)
image.display{image = im_bilwbic, zoom = 4, legend = 'rotation bilwbic'}
