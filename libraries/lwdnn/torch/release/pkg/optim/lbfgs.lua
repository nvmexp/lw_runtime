...
function optim.lbfgs(opfunc, x, config, state)
   ...
   while nIter < maxIter do
      ...
      if state.nIter == 1 then
         ...
         -- compute the approximate (L-BFGS) ilwerse Hessian
      ...
      -- update func eval
      lwrrentFuncEval = lwrrentFuncEval + lsFuncEval
      ...
      if lwrrentFuncEval >= maxEval then
   ...
   return x,f_hist,lwrrentFuncEval
end
