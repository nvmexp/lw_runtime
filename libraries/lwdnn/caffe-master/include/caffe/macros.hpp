...
#if __LWDACC_VER_MAJOR__ >= 9
#undef __LWDACC_VER__
#define __LWDACC_VER__ \
  ((__LWDACC_VER_MAJOR__ * 10000) + (__LWDACC_VER_MINOR__ * 100))
#endif

#if BOOST_VERSION >= 106100
// error: class "boost::common_type<long, long>" has no member "type"
#define BOOST_NO_CXX11_VARIADIC_TEMPLATES
#if defined(__LWDACC_VER_MAJOR__) && defined(__LWDACC_VER_MINOR__) && defined(__LWDACC_VER_BUILD__)
#define BOOST_LWDA_VERSION \
  __LWDACC_VER_MAJOR__ * 1000000 + __LWDACC_VER_MINOR__ * 10000 + __LWDACC_VER_BUILD__
#else
#define BOOST_LWDA_VERSION 8000000
#endif
#endif

// Ubuntu 18.04 fails to build boost::property_tree by LWCC 10.1
#if BOOST_VERSION == 106501 && LWDA_VERSION == 10010
#define CAFFE_NO_BOOST_PROPERTY_TREE 1
#endif

#if LWDA_VERSION >= 8000
#  define CAFFE_DATA_HALF LWDA_R_16F
#else
#  define CAFFE_DATA_HALF LWBLAS_DATA_HALF
#endif
// Colwert macro to string
...
// is exelwted we will see a fatal log.
...
#define CAFFE_WS_COLW 0
#define CAFFE_WS_COLW_WEIGHTS 1
