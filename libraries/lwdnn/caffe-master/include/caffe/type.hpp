...
#ifdef USE_LWDNN
template <typename Dtype>
constexpr lwdnnDataType_t lwdnn_dt();
template <>
inline constexpr lwdnnDataType_t lwdnn_dt<double>() {
  return lwdnnDataType_t::LWDNN_DATA_DOUBLE;
}
template <>
inline constexpr lwdnnDataType_t lwdnn_dt<float>() {
  return lwdnnDataType_t::LWDNN_DATA_FLOAT;
}
template <>
inline constexpr lwdnnDataType_t lwdnn_dt<float16>() {
  return lwdnnDataType_t::LWDNN_DATA_HALF;
}
#endif
