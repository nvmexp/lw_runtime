...
/**
  ...
  * or saving a snapshot without exiting. In the exelwtable caffe, this
  * mechanism is used to allow the snapshot to be saved when stopping
  * exelwtion with a SIGINT (Ctrl-C).
  */
...
class Solver {
 public:
  ...
  // Ilwoked at specific points during an iteration
  class Callback {
   public:
    ...
    virtual lwdaStream_t comm_stream() const = 0;
