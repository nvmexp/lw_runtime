...
class Tensor {
 ...
 private:
  ...
  void ilwalidate_others();
  void colwert(Type new_type);
  ...
  // numerical type stored here at a moment (might change due to colwersion)
  Type type_;
