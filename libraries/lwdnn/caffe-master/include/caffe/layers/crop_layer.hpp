...
class CropLayer : public Layer<Ftype, Btype> {
 ...
 private:
  ...
  // Relwrsive copy function: this is similar to crop_copy() but loops over all
  // but the last two dimensions to allow for ND cropping while still relying on
  // a LWCA kernel for the innermost two dimensions for performance reasons.  An
