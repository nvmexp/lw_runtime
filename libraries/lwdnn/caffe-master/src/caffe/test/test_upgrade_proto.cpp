...
TEST_F(NetUpgradeTest, TestSimple) {
  ...
  const string& expected_v1_proto =
      ...
      "  bottom: 'label' "
      "} ";
  this->Rulw0UpgradeTest(v0_proto, expected_v1_proto);
  ...
  const string& expected_v2_proto =
      ...
      "  bottom: 'label' "
      "} ";
  this->Rulw1UpgradeTest(expected_v1_proto, expected_v2_proto);
}
...
TEST_F(NetUpgradeTest, TestAllParams) {
  ...
  const string& expected_output_proto =
      ...
      "  type: TANH "
      "} ";
  this->Rulw0UpgradeTest(input_proto, expected_output_proto);
}
