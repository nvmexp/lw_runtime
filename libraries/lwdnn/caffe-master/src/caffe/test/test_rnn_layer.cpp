...
class RNNLayerTest : public MultiDeviceTest<TypeParam> {
 ...
 protected:
  RNNLayerTest() : num_output_(7) {
    ...
    layer_param_.mutable_relwrrent_param()->set_num_output(num_output_);
    FillerParameter* weight_filler =
        layer_param_.mutable_relwrrent_param()->mutable_weight_filler();
    weight_filler->set_type("gaussian");
    weight_filler->set_std(0.2);
    FillerParameter* bias_filler =
        layer_param_.mutable_relwrrent_param()->mutable_bias_filler();
