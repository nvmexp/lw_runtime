...
void ColwolutionLayer<Ftype, Btype>::compute_output_shape() {
...
template <typename Ftype, typename Btype>
void ColwolutionLayer<Ftype, Btype>::Forward_cpu(const vector<Blob*>& bottom,
...
template <typename Ftype, typename Btype>
void ColwolutionLayer<Ftype, Btype>::Backward_cpu(const vector<Blob*>& top,
...
INSTANTIATE_CLASS_FB(ColwolutionLayer);
