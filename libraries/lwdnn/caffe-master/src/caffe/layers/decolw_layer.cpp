...
void DecolwolutionLayer<Ftype, Btype>::compute_output_shape() {
...
template <typename Ftype, typename Btype>
void DecolwolutionLayer<Ftype, Btype>::Forward_cpu(const vector<Blob*>& bottom,
...
template <typename Ftype, typename Btype>
void DecolwolutionLayer<Ftype, Btype>::Backward_cpu(const vector<Blob*>& top,
...
INSTANTIATE_CLASS_FB(DecolwolutionLayer);
REGISTER_LAYER_CLASS(Decolwolution);
