...
void RNNLayer<Ftype, Btype>::RelwrrentInputBlobNames(vector<string>* names) const {
  names->resize(1);
  (*names)[0] = "h_0";
}

template<typename Ftype, typename Btype>
void RNNLayer<Ftype, Btype>::RelwrrentOutputBlobNames(vector<string>* names) const {
  names->resize(1);
  (*names)[0] = "h_" + format_int(this->T_);
}

template<typename Ftype, typename Btype>
void RNNLayer<Ftype, Btype>::RelwrrentInputShapes(vector<BlobShape>* shapes) const {
