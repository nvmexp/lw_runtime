...
if (NOT __GLOG_INCLUDED)
  ...
  if (GLOG_FOUND)
    ...
    ExternalProject_Add(glog
      ...
      CONFIGURE_COMMAND elw "CFLAGS=${GLOG_C_FLAGS}" "CXXFLAGS=${GLOG_CXX_FLAGS}" ${glog_PREFIX}/src/glog/configure --prefix=${glog_INSTALL} --enable-shared=no --enable-static=yes --with-gflags=${GFLAGS_LIBRARY_DIRS}/..
      LOG_DOWNLOAD 1
      LOG_CONFIGURE 1
      LOG_INSTALL 1
      )
