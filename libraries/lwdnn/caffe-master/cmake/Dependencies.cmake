...
# ---[ LWCA
include(cmake/Lwca.cmake)
if(NOT HAVE_LWDA)
  message(SEND_ERROR "-- LWCA is not detected by cmake. Building without it...")
endif()
...
if(LWML_FOUND)
  include_directories(SYSTEM ${LWML_INCLUDE})
  list(APPEND Caffe_LINKER_LIBS ${LWML_LIBRARY})
endif()

if(NO_LWML)
  add_definitions(-DNO_LWML=1)
endif()
