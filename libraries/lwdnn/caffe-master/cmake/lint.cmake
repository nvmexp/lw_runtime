...
set(SRC_FILE_EXTENSIONS h hpp hu c cpp lw cc lwh)
...
foreach(ext ${SRC_FILE_EXTENSIONS})
    foreach(dir ${LINT_DIRS})
        file(GLOB_RELWRSE FOUND_FILES ${CMAKE_SOURCE_DIR}/${dir}/*.${ext})
...
foreach(ext ${EXCLUDE_FILE_EXTENSTIONS})
    file(GLOB_RELWRSE FOUND_FILES ${CMAKE_SOURCE_DIR}/*.${ext})
