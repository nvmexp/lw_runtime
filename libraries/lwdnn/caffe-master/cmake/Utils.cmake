...
################################################################################################
# Colwerts all paths in list to absolute
# Usage:
#   caffe_colwert_absolute_paths(<list_variable>)
function(caffe_colwert_absolute_paths variable)
  set(__dlist "")
...
# Usage:
#   caffe_get_lwrrent_definitions(<definitions_variable>)
function(caffe_get_lwrrent_definitions definitions_var)
  get_property(lwrrent_definitions DIRECTORY PROPERTY COMPILE_DEFINITIONS)
  set(result "")

  foreach(d ${lwrrent_definitions})
...
# Usage:
#   caffe_get_lwrrent_cflags(<cflagslist_variable>)
function(caffe_get_lwrrent_cflags cflags_var)
  get_property(lwrrent_includes DIRECTORY PROPERTY INCLUDE_DIRECTORIES)
  caffe_colwert_absolute_paths(lwrrent_includes)
  caffe_get_lwrrent_definitions(cflags)

  foreach(i ${lwrrent_includes})
...
function(caffe_parse_linker_libs Caffe_LINKER_LIBS_variable folders_var flags_var frameworks_var)
  ...
  # colwert linker libraries list to link flags
  foreach(lib ${__libs})
    if(TARGET ${lib})
...
function(caffe_detect_darwin_version output_var)
  if(APPLE)
    exelwte_process(COMMAND /usr/bin/sw_vers -productVersion
