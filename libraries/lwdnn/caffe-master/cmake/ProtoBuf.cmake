...
if(EXISTS ${PROTOBUF_PROTOC_EXELWTABLE})
  message(STATUS "Found PROTOBUF Compiler: ${PROTOBUF_PROTOC_EXELWTABLE}")
else()
...
function(caffe_protobuf_generate_cpp_py output_dir srcs_var hdrs_var python_var)
  ...
  if(PROTOBUF_GENERATE_CPP_APPEND_PATH)
    ...
    set(_protoc_include -I ${CMAKE_LWRRENT_SOURCE_DIR})
  endif()
  ...
  foreach(fil ${ARGN})
    ...
    add_lwstom_command(
      ...
      COMMAND ${PROTOBUF_PROTOC_EXELWTABLE} --cpp_out    ${output_dir} ${_protoc_include} ${abs_fil}
      COMMAND ${PROTOBUF_PROTOC_EXELWTABLE} --python_out ${output_dir} ${_protoc_include} ${abs_fil}
      DEPENDS ${abs_fil}
