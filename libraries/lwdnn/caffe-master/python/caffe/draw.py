...
def get_edge_label(layer):
    ...
    elif layer.type == 'Colwolution' or layer.type == 'Decolwolution':
        edge_label = str(layer.colwolution_param.num_output)
...
def get_layer_label(layer, rankdir):
    ...
    if layer.type == 'Colwolution' or layer.type == 'Decolwolution':
        ...
        node_label = '"%s%s(%s)%skernel size: %d%sstride: %d%spad: %d"' %\
                     (layer.name,
                      ...
                      layer.type,
                      separator,
                      layer.colwolution_param.kernel_size[0] if len(layer.colwolution_param.kernel_size) else 1,
                      separator,
                      layer.colwolution_param.stride[0] if len(layer.colwolution_param.stride) else 1,
                      separator,
                      layer.colwolution_param.pad[0] if len(layer.colwolution_param.pad) else 0)
...
def choose_color_by_layertype(layertype):
    ...
    if layertype == 'Colwolution' or layertype == 'Decolwolution':
        color = '#FF5050'
