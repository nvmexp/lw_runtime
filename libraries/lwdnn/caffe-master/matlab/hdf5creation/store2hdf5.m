function [lwrr_dat_sz, lwrr_lab_sz] = store2hdf5(filename, data, labels, create, startloc, chunksz)  
  ...
  if nargout
    info=h5info(filename);
    lwrr_dat_sz=info.Datasets(1).Dataspace.Size;
    lwrr_lab_sz=info.Datasets(2).Dataspace.Size;
  end
end
