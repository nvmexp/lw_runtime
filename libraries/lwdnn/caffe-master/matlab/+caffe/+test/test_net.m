classdef test_net < matlab.unittest.TestCase
  ...
  methods (Test)
    ...
    function self = test_layer(self)
      self.verifyEqual(self.net.params('colw', 1).shape, [2 2 2 11]);
      self.verifyEqual(self.net.layers('colw').params(2).shape, 11);
      self.verifyEqual(self.net.layers('colw').type(), 'Colwolution');
    end
