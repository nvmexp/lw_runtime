...
1. Download and install TensorRT from https://developer.lwpu.com/tensorrt
2. Download and unzip https://github.com/LWPU/caffe/blob/models/RN50-FP16-20180201/weights.tar.gz into examples/TensorRT/
...
4. Build Caffe with the following keys:
   cmake .. -DUSE_TRT=ON -DUSE_LWDNN=ON -DUSE_NCCL=ON
