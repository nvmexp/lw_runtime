...
enum ibv_device_cap_flags {
	...
	IBV_DEVICE_LWRR_QP_STATE_MOD	= 1 <<  7,
...
enum ibv_port_cap_flags {
	...
	IBV_PORT_MKEY_LWRAM			= 1 <<  7,
	IBV_PORT_PKEY_LWRAM			= 1 <<  8,
...
enum ibv_wc_status {
	...
	IBV_WC_REM_ILW_REQ_ERR,
	IBV_WC_REM_ACCESS_ERR,
	IBV_WC_REM_OP_ERR,
	IBV_WC_RETRY_EXC_ERR,
	IBV_WC_RNR_RETRY_EXC_ERR,
	IBV_WC_LOC_RDD_VIOL_ERR,
	IBV_WC_REM_ILW_RD_REQ_ERR,
	IBV_WC_REM_ABORT_ERR,
	IBV_WC_ILW_EECN_ERR,
	IBV_WC_ILW_EEC_STATE_ERR,
	IBV_WC_FATAL_ERR,
...
/**
 * ibv_rate_to_mult - Colwert the IB rate enum to a multiple of the
 * base rate of 2.5 Gbit/sec.  For example, IBV_RATE_5_GBPS will be
 * colwerted to 2, since 5 Gbit/sec is 2 * 2.5 Gbit/sec.
 * @rate: rate to colwert.
 */
int ibv_rate_to_mult(enum ibv_rate rate) __attribute_const;

/**
 * mult_to_ibv_rate - Colwert a multiple of 2.5 Gbit/sec to an IB rate enum.
 * @mult: multiple to colwert.
 */
enum ibv_rate mult_to_ibv_rate(int mult) __attribute_const;

/**
 * ibv_rate_to_mbps - Colwert the IB rate enum to Mbit/sec.
...
/**
 * mbps_to_ibv_rate - Colwert a Mbit/sec value to an IB rate enum.
 * @mbps: value to colwert.
 */
...
struct ibv_qp_attr {
	...
	enum ibv_qp_state	lwr_qp_state;
