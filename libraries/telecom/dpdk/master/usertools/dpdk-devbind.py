...
# list of lwrrently loaded kernel modules
loaded_modules = None
...
def unbind_one(dev_id, force):
    ...
    if not has_driver(dev_id):
        print("Notice: %s %s %s is not lwrrently managed by any driver" %
    ...
    if driver in dpdk_drivers:
        ...
        # For kernels < 3.15 use new_id to add PCI id's to the driver
            ...
            try:
                ...
                return
            try:
                # Colwert Device and Vendor Id to int to write to new_id
