...
* **Updated mlx5 driver.**
  ...
  * Colwerted to the new offloads API.
...
* **Added LWGRE and UDP tunnels support in Solarflare network PMD.**

  Added support for LWGRE, VXLAN and GENEVE tunnels.
...
* **Updated the DPAA_SEC crypto driver to support rte_selwrity.**

  Updated the ``dpaa_sec`` crypto PMD to support ``rte_selwrity`` lookaside
...
* **Added new multi-process communication channel.**
  ...
  a message received; the actions will be identified by the action name and exelwted
