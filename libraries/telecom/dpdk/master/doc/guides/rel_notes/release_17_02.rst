...
* **Added VF Daemon (VFD) for i40e. - EXPERIMENTAL**
  ...
  many VF management features are not lwrrently supported by the kernel PF
  ...
  * Set TX loopback.
  * Set VF unicast promislwous mode.
  * Set VF multicast promislwous mode.
  * Set VF MTU.
  * Get/reset VF stats.
  * Set VF MAC address.
...
* **Updated the i40e base driver.**
  ...
  * Add broadcast promislwous control per VLAN.
