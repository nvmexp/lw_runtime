...
* **Added DOCSIS protocol to rte_selwrity.**
...
* **Updated the QuickAssist Technology (QAT) PMD.**
  ...
  * Added support for lookaside protocol offload in QAT crypto PMD
    for DOCSIS through the ``rte_selwrity`` API.
...
* **Updated the OCTEON TX2 crypto PMD.**
  ...
  * Updated the OCTEON TX2 crypto PMD to support ``rte_selwrity`` lookaside
...
* **Added support for BPF_ABS/BPF_IND load instructions.**
  ...
  which are used to access packet data in a safe manner. Lwrrently JIT support
