...
* **Updated the AF_XDP PMD.**
  ...
  * Enabled "need_wakeup" feature which can provide efficient support for the
    usecase where the application and driver exelwting on the same core.
...
* ip_frag: The IP fragmentation library colwerts input mbuf into fragments
...
* ip_frag: IP reassembly library colwerts the list of fragments into a
