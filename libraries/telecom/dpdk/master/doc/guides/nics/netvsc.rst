...
*   The PMD supports multicast packets and promislwous mode subject to restrictions on the host.
...
*   The maximum number of queues is limited by the host (lwrrently 64).
