...
- Identifying your adapter using `Intel Support
  <http://www.intel.com/support>`_ and get the latest LWM/FW images.
...
- ``AFU name``
  ...
  the AFU bitstream belongs to, but lwrrently only 0 IPN3KE support. "BDF" means FPGA PCIe BDF.
  For example::
...
- ``I40e PF name list``
  ...
  Users need to bind FPGA LineSidePort to FVL PF. So I40e PF name list should be ilwolved in
