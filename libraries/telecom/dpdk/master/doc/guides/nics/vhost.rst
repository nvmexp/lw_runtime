...
Lwrrently, the vhost PMD provides the basic functionality of packet reception, transmission and event handling.
...
The registered callback handler will be ilwoked with one of below event types.
