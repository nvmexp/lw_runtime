...
With single file segments we can callwlate offset from the beginning of the file
...
Buffers are dequeued and enqueued as needed. Offset descriptor field is callwlated at tx.
Only single file segments mode (EAL option --single-file-segments) is supported, as callwlating
