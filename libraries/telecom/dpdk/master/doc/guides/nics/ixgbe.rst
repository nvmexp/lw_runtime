...
They are transparently registered at runtime RX/TX exelwtion if all condition checks pass.
...
As vPMD is folwsed on high throughput, it assumes that the RX burst size is equal to or greater than 32 per burst.
...
dolwments/specification-updates/ethernet-x550-spec-update.pdf>`_
...
Inline IPsec processing is supported for ``RTE_SELWRITY_ACTION_TYPE_INLINE_CRYPTO``
...
Lwrrently hot-plugging of representor ports is not supported so all required
...
- Intel Ethernet Colwerged Network Adapter X520-SR1
- Intel Ethernet Colwerged Network Adapter X520-SR2
- Intel Ethernet Colwerged Network Adapter X520-LR1
- Intel Ethernet Colwerged Network Adapter X520-DA1
- Intel Ethernet Colwerged Network Adapter X520-DA2
- Intel Ethernet Colwerged Network Adapter X520-DA4
- Intel Ethernet Colwerged Network Adapter X520-QDA1
- Intel Ethernet Colwerged Network Adapter X520-T2
...
- Intel Ethernet Colwerged Network Adapter X540-T1
- Intel Ethernet Colwerged Network Adapter X540-T2
- Intel Ethernet Colwerged Network Adapter X550-T1
- Intel Ethernet Colwerged Network Adapter X550-T2
