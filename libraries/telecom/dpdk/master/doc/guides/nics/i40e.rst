...
- Upgrade the LWM/FW version following the `Intel® Ethernet LWM Update Tool Quick Usage Guide for Linux
  <https://www-ssl.intel.com/content/www/us/en/embedded/products/networking/lwm-update-tool-quick-linux-usage-guide.html>`_ and `Intel® Ethernet LWM Update Tool: Quick Usage Guide for EFI <https://www.intel.com/content/www/us/en/embedded/products/networking/lwm-update-tool-quick-efi-usage-guide.html>`_ if needed.
...
- For information about supported media, please refer to this document: `Intel® Ethernet Controller X710/XXV710/XL710 Feature Support Matrix
  <http://www.intel.com/content/dam/www/public/us/en/dolwments/release-notes/xl710-ethernet-controller-feature-matrix.pdf>`_.
...
#. Running testpmd:
   ...
   .. code-block:: console
      ...
      PMD: eth_i40e_dev_init(): FW 5.0 API 1.5 LWM 05.00.02 eetrack 8000208a
...
Lwrrently the VF's RX descriptor mode is decided by PF. There's no PF-VF
...
but there is no way to detect if the overflow oclwrred more than once.
