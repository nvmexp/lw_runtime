...
Reference: `FSL DPAA Architecture <http://www.nxp.com/assets/dolwments/data/en/white-papers/QORIQDPAAWP.pdf>`_.
...
- ``DPAA_PUSH_QUEUES_NUMBER`` (default 4)
  ...
  Lwrrently these queues are not used for LS1023/LS1043 platform by default.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   Lwrrently it works on XML file inputs.

   Limitations:
   1.For Dynamic Configuration change, lwrrently no support is available.
   ...
   3.FMC, being a separate user-space application, needs to be ilwoked from
   Shell.
