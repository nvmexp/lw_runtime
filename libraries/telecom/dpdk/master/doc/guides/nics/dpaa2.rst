...
A simple scenario is described illustrating the objects ilwolved
...
The diagram below shows the dpaa2 drivers ilwolved in a networking
...
ilwokes a DPIO API.  For receive, the Ethernet driver registers
