...
resource tag) information, rather than the mac and vlan table. Lwrrently this
...
vPMD packet I/O. They are transparently registered at runtime RX/TX exelwtion
...
As vPMD is folwsed on high throughput, it processes 4 packets at a time. So it assumes
