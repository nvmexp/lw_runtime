...
for **QLogic FastLinQ QL4xxxx 10G/25G/40G/50G/100G Intelligent Ethernet Adapters (IEA) and Colwerged Network Adapters (CNA)** family of adapters as well as SR-IOV virtual functions (VF). It is supported on
...
- QLogic FastLinQ QL4xxxx 10G/25G/40G/50G/100G Intelligent Ethernet Adapters (IEA) and Colwerged Network Adapters (CNA)
