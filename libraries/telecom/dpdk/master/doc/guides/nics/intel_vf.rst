...
*   **SR-IOV mode**: Ilwolves direct assignment of part of the port resources to different guest operating systems
...
*   **VMDq mode**: Ilwolves central management of the networking resources by an IO Virtual Machine (IOVM) or
...
For more detail on SR-IOV, please refer to the following dolwments:
...
*   `Intel® IAVF HAS <https://www.intel.com/content/dam/www/public/us/en/dolwments/product-specifications/ethernet-adaptive-virtual-function-hardware-spec.pdf>`_
