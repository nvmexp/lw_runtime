...
cross-compiled on an x86 platform. For example, below commands can be exelwted
...
To get BCMFS PMD exelwting, device node must be owned by VFIO platform module only.
