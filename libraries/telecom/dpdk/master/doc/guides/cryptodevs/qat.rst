...
.. Note::
	...
	This is not possible if any checksum callwlation was requested - in such
...
These MMIO write oclwrrences can be optimised by setting any of the following parameters:
...
by comma. When the same parameter is used more than once first oclwrrence of the parameter
is used.
...
.. Note::
   ...
   Colwersely one DPDK process can use one or more QAT VFs and can expose both
...
Check that the QAT driver is loaded on your system, by exelwting::
...
.. Note::
   ...
   .. code-block:: diff
      ...
      + #define STR_TO_64(str, base, num, endPtr) {endPtr=NULL; if (kstrtoul((str), (base), (num))) printk("Error strtoull colwert %s\n", str); }
      + #else
      #if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,38)
      #define STR_TO_64(str, base, num, endPtr) {endPtr=NULL; if (strict_strtoull((str), (base), (num))) printk("Error strtoull colwert %s\n", str); }
      #else
