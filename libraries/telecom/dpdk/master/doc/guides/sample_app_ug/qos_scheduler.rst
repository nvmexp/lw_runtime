...
There are two flavors of the runtime exelwtion for this application,
...
These are the commands that are lwrrently working under the command line interface:
...
*   General Statistics
    ...
    *   stats app: Shows a table with in-app callwlated statistics.
...
Two parameters can be configured for this prior to calling any of these commands:
    ...
    *   qavg n X: n is the number of times that the callwlation will take place.
        Bigger numbers provide higher accuracy. The default value is 10.

    *   qavg period X: period is the number of microseconds that will be allowed between each callwlation.
