...
which lwrrently can be RTE_ETH_EVENT_INTR_LSC only, but other types can be added in the future.
...
.. note::
    ...
    In the following code, the two lines for callwlating the output port require some explanation.
