...
prior to transmission to callwlate the elapsed time, in CPU cycles.
...
exelwtion threads for each lcore. This function is effectively identical to
...
The ``calc_latency()`` function aclwmulates the total number of packets and
