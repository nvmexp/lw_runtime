...
L2 Forwarding Sample Application (in Real and Virtualized Elwironments)
=======================================================================
...
.. note::
    ...
    Please note that previously a separate L2 Forwarding in Virtualized Elwironments sample application was used,
...
or in a virtualized environment as shown in :numref:`figure_l2_fwd_virtelw_benchmark_setup`.
...
.. _figure_l2_fwd_virtelw_benchmark_setup:
