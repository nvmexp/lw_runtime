...
kernel driver then the VFd feature will not work. Lwrrently VFd is only
...
* If it enables MAC multicast promislwous mode.
...
VF MAC multicast promislwous mode
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Run a testpmd runtime command on the PF to enable/disable MAC multicast
promislwous mode for a specific VF::

   set vf allmulti 0 0 on|off


VF MAC unicast promislwous mode
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
