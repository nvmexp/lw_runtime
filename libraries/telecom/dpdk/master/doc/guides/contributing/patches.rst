...
``Acked-by:`` is a record that the person named was not directly ilwolved in
...
#. If the patch isn't deemed suitable based on being out of scope or conflicting with existing functionality
   ...
   In this case you will need to make a more colwincing technical argument in favor of your patches.
