...
.. note::
   ...
   Please note that this policy does not lwrrently apply to the
...
The following are examples of allowable ABI changes oclwrring between
 ...
 * Finally, the *ABI breakage window* is *not* permission to cirlwmvent
...
This check can be cirlwmvented by defining ``ALLOW_EXPERIMENTAL_API``
