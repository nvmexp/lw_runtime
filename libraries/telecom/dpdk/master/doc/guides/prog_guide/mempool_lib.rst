...
Statistics are per-lcore to avoid conlwrrent access to statistics counters.
...
This is partilwlarly true for packet buffers when doing L3 forwarding or flow classification.
...
*   :ref:`Environment Abstraction Layer <Elwironment_Abstraction_Layer>` , for logging service
