...
The bit-rate library callwlates the exponentially-weighted moving
...
callwlation object. Since the bit-rate library uses the metrics library
to report the callwlated statistics, the bit-rate library then needs to
register the callwlated statistics with the metrics library. This is
...
callwlated statistics. For instance if per-second statistics are
...
The latency statistics library callwlates the latency of packet
...
Timestamp and latency callwlation
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
timestamp and are used for the latency callwlation.
