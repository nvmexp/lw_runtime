...
The rte_mbuf header structure is kept as small as possible and lwrrently uses
...
- callwlate checksum of out_ip and out_udp::
...
- callwlate checksum of in_ip and in_tcp::
...
- callwlate checksum of out_ip, in_ip, in_tcp::
...
While the attach/detach operations can be ilwoked directly using the recommended rte_pktmbuf_attach() and rte_pktmbuf_detach() functions,
