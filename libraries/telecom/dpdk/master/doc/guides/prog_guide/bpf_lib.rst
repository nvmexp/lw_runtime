...
*  Create a new BPF exelwtion context and load user provided eBPF code into it.

*   Destroy an BPF exelwtion context and its runtime structures and free the associated memory.
...
These instructions can only be used when exelwtion context is a pointer to
...
the interpreter will abort the exelwtion of the program. JIT compilers
...
Not lwrrently supported eBPF features
-------------------------------------
