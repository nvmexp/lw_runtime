...
The framework creates a set of libraries for specific elwironments
...
These elwironments are created through the use of meson files and configuration files.
...
running as exelwtion units on logical processing cores.
...
*   Support for multi-process and multi-thread exelwtion types
...
The EAL is fully described in :ref:`Environment Abstraction Layer <Elwironment_Abstraction_Layer>`.
...
and/or exelwtion blocks connected together on a logical core.
...
This library provides a timer service to DPDK exelwtion units,
...
The librte_net library is a collection of IP protocol definitions and colwenience macros.
