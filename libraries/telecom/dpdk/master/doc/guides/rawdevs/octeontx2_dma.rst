...
#. Inbound  - Host DRAM to OCTEON TX2 DRAM without host/OCTEON TX2 cores ilwolvement

#. Outbound - OCTEON TX2 DRAM to Host DRAM without host/OCTEON TX2 cores ilwolvement
...
* Ilwoke ``rte_rawdev_get_dev_id("DPI:x")`` from the application
