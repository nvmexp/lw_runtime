...
/**
 * Return the number of schedulers lwrrently running
 * @return
 *  the number of schedulers in the system
 */
...
/**
  ...
  *	 EILWAL  NULL thread or function pointer, or lcore_id out of range
  */
int
...
0  * @return
  *  0    success
  *  EILWAL lthread could not be joined.
  */
...
/**
  ...
  *
  * Exelwtion will switch to the next lthread that is ready to run
  *
  * @param nsecs
...
/**
  ...
  *
  *  The current thread will yield and exelwtion will switch to the
...
/**
  ...
  *  Exelwtion will switch to the next lthread that is ready to run on the
  ...
  *  EILWAL the destination lcore was not valid
  */
...
/**
  ...
  *  It returns the value lwrrently bound to the specified key on behalf of the
...
/**
  ...
  *   preemptive multitasking elwironments such as pthreads.
  *
  ...
  *  use and are lwrrently ignored.
  *
  *  If a thread calls lthread_mutex_lock() on the mutex, then if the mutex
  *  is lwrrently unlocked,  it  becomes  locked  and  owned  by  the calling
  ...
  * @return
  *  0 success
  *  EILWAL mutex was not a valid pointer
...
/**
  ...
  * @return
  *  0 success
  *  EILWAL mutex was not an initialized mutex
...
/**
  ...
  * @param attr
  *  Pointer to optional attribute reserved for future use, lwrrently ignored
  *
  * @return
  *  0 success
  *  EILWAL cond was not a valid pointer
  *  EAGAIN insufficient resources
  */
int
...
/**
  ...
  *  EILWAL was not an initialised condition variable
  */
...
/**
  ...
  *  EILWAL was not a an initialised condition variable
  */
