...
void _lthread_free(struct lthread *lt)
{
	...
	/* ilwoke any user TLS destructor functions */
...
/*
 * Execute a ctx by ilwoking the start function
 ...
 */
struct lthread *lthread_lwrrent(void)
{
	struct lthread_sched *sched = THIS_SCHED;

	if (sched)
		return sched->lwrrent_lthread;
	return NULL;
}
