 ...
 * be overridden.
 *
 * For each function there is a stub provided that will ilwoke either
 ...
 *
 * The decision whether to ilwoke the real library function or the lthread
 ...
 *
 * N.B In general it would be poor practice to revert to ilwoke a real
