...
static int32_t test_create_ilwalid(void);
static int32_t test_find_existing(void);
static int32_t test_multiple_create(void);
static int32_t test_add_ilwalid(void);
static int32_t test_delete_ilwalid(void);
static int32_t test_lookup_ilwalid(void);
...
static int32_t
__test_add_ilwalid(int ipv6, union rte_ipsec_sad_key *tuple)
{
	int status;
	struct rte_ipsec_sad *sad = NULL;
	struct rte_ipsec_sad_conf config;
 ...
 */
int32_t
test_add_ilwalid(void)
{
	int status;
	struct rte_ipsec_sadv4_key tuple_v4 = {10, 20, 30};
	struct rte_ipsec_sadv6_key tuple_v6 = {10, {20, }, {30, } };

	status = __test_add_ilwalid(0, (union rte_ipsec_sad_key *)&tuple_v4);
	if (status != TEST_SUCCESS)
		return status;

	status = __test_add_ilwalid(1, (union rte_ipsec_sad_key *)&tuple_v6);
...
static int32_t
__test_delete_ilwalid(int ipv6, union rte_ipsec_sad_key *tuple)
{
	int status;
	struct rte_ipsec_sad *sad = NULL;
	struct rte_ipsec_sad_conf config;
...
test_delete_ilwalid(void)
{
	...
	status = __test_delete_ilwalid(0, (union rte_ipsec_sad_key *)&tuple_v4);
	if (status != TEST_SUCCESS)
		return status;

	status = __test_delete_ilwalid(1, (union rte_ipsec_sad_key *)&tuple_v6);

	return status;
}

static int32_t
__test_lookup_ilwalid(int ipv6, union rte_ipsec_sad_key *tuple)
{
	int status;
	struct rte_ipsec_sad *sad = NULL;
	struct rte_ipsec_sad_conf config;
 ...
 */
int32_t
test_lookup_ilwalid(void)
{
	int status;
	struct rte_ipsec_sadv4_key tuple_v4 = {10, 20, 30};
	struct rte_ipsec_sadv6_key tuple_v6 = {10, {20, }, {30, } };

	status = __test_lookup_ilwalid(0,
			(union rte_ipsec_sad_key *)&tuple_v4);
	if (status != TEST_SUCCESS)
		return status;

	status = __test_lookup_ilwalid(1,
...
static struct unit_test_suite ipsec_sad_tests = {
	...
	.teardown = NULL,
	.unit_test_cases = {
		TEST_CASE(test_create_ilwalid),
		TEST_CASE(test_find_existing),
		TEST_CASE(test_multiple_create),
		TEST_CASE(test_add_ilwalid),
		TEST_CASE(test_delete_ilwalid),
		TEST_CASE(test_lookup_ilwalid),
