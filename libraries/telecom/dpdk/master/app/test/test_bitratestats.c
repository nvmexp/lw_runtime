...
static int
test_stats_bitrate_reg_ilwalidpointer(void)
{
	int ret = 0;
...
/* To test bit rate callwlation with invalid bit rate data pointer */
static int
test_stats_bitrate_calc_ilwalid_bitrate_data(void)
{
	int ret = 0;
...
/* To test the bit rate callwlation with invalid portid
 * (higher than max ports)
 */
static int
test_stats_bitrate_calc_ilwalid_portid_1(void)
{
	int ret = 0;
...
/* To test the bit rate callwlation with invalid portid (lesser than 0) */
static int
test_stats_bitrate_calc_ilwalid_portid_2(void)
{
	int ret = 0;
...
/* To test the bit rate callwlation with non-existing portid */
static int
...
/* To test the bit rate callwlation with valid bit rate data, valid portid */
static int
...
unit_test_suite bitratestats_testsuite  = {
	...
	.unit_test_cases = {
		 ...
		 */
		TEST_CASE(test_stats_bitrate_reg_ilwalidpointer),

		/* TEST CASE 4: Test to callwlate bit rate data metrics
		 * with invalid bit rate data
		 */
		TEST_CASE(test_stats_bitrate_calc_ilwalid_bitrate_data),

		/* TEST CASE 5: Test to callwlate bit rate data metrics
		 * with portid exceeding the max ports
		 */
		TEST_CASE(test_stats_bitrate_calc_ilwalid_portid_1),

		/* TEST CASE 6: Test to callwlate bit rate data metrics
		 * with portid less than 0
		 */
		TEST_CASE(test_stats_bitrate_calc_ilwalid_portid_2),

		/* TEST CASE 7: Test to callwlate bit rate data metrics
		 * with non-existing portid
		 */
		TEST_CASE(test_stats_bitrate_calc_non_existing_portid),

		/* TEST CASE 8: Test to callwlate bit rate data metrics
