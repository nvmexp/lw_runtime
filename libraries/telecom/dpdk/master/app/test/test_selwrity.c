 ...
 * =======
 *
 * Basic unit tests of the librte_selwrity API.
 *
 * Structure of the file:
 * - macros for making tests more readable;
 * - mockup structures and functions for rte_selwrity_ops;
 ...
 * and check if there were any fails during exelwtion.
...
#define TEST_ASSERT_SESSION_COUNT(expected_sessions_count) do {		\
	struct selwrity_unittest_params *ut_params = &unittest_params;	\
...
#define TEST_ASSERT_MEMPOOL_USAGE(expected_mempool_usage) do {		\
	struct selwrity_testsuite_params *ts_params = &testsuite_params;\
...
static int
mock_session_destroy(void *device, struct rte_selwrity_session *sess)
{
...
static struct mock_capabilities_get_data {
	...
	struct rte_selwrity_capability *ret;

	int called;
	int failed;
} mock_capabilities_get_exp = {NULL, NULL, 0, 0};

static const struct rte_selwrity_capability *
 ...
 */
struct rte_selwrity_ops empty_ops = { NULL };
 ...
 */
struct rte_selwrity_ops mock_ops = {
...
/**
 * struct selwrity_testsuite_params defines parameters initialized once
 * for whole tests suite.
 * Lwrrently the only stored parameter is session_mpool a mempool created
 ...
 */
static struct selwrity_testsuite_params {
	struct rte_mempool *session_mpool;
	struct rte_mempool *session_priv_mpool;
} testsuite_params = { NULL };

/**
 * struct selwrity_unittest_params defines parameters initialized
 ...
 */
static struct selwrity_unittest_params {
	struct rte_selwrity_ctx ctx;
	struct rte_selwrity_session_conf conf;
	struct rte_selwrity_session *sess;
} unittest_params = {
	.ctx = {
...
#define SELWRITY_TEST_MEMPOOL_NAME "SelwrityTestMp"
#define SELWRITY_TEST_PRIV_MEMPOOL_NAME "SelwrityTestPrivMp"
#define SELWRITY_TEST_MEMPOOL_SIZE 15
#define SELWRITY_TEST_SESSION_OBJ_SZ sizeof(struct rte_selwrity_session)
#define SELWRITY_TEST_SESSION_PRIV_OBJ_SZ 64
...
testsuite_setup(void)
{
	...
	ts_params->session_mpool = rte_mempool_create(
			SELWRITY_TEST_MEMPOOL_NAME,
			SELWRITY_TEST_MEMPOOL_SIZE,
			SELWRITY_TEST_SESSION_OBJ_SZ,
	...
	ts_params->session_priv_mpool = rte_mempool_create(
			SELWRITY_TEST_PRIV_MEMPOOL_NAME,
			SELWRITY_TEST_MEMPOOL_SIZE,
			SELWRITY_TEST_SESSION_PRIV_OBJ_SZ,
			0, 0, NULL, NULL, NULL, NULL,
			SOCKET_ID_ANY, 0);
 ...
 * created with rte_selwrity_session_create and stored in test case parameters.
...
destroy_session_with_check(void)
{
	...
	if (ut_params->sess != NULL) {
		...
		int ret = rte_selwrity_session_destroy(&ut_params->ctx,
				ut_params->sess);
		TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_destroy,
				ret, 0, "%d");
...
ut_setup_with_session(void)
{
	...
	sess = rte_selwrity_session_create(&ut_params->ctx, &ut_params->conf,
			ts_params->session_mpool,
			ts_params->session_priv_mpool);
	TEST_ASSERT_MOCK_FUNCTION_CALL_NOT_NULL(rte_selwrity_session_create,
			sess);
 ...
 * They are arranged by tested rte_selwrity API function
 * and by rte_selwrity exelwtion paths sequence in code.
 */

/**
 * rte_selwrity_session_create tests
 */

/**
 * Test exelwtion of rte_selwrity_session_create with NULL instance
 */
static int
test_session_create_ilw_context(void)
{
	struct selwrity_testsuite_params *ts_params = &testsuite_params;
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_session *sess;

	sess = rte_selwrity_session_create(NULL, &ut_params->conf,
			ts_params->session_mpool,
			ts_params->session_priv_mpool);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_create,
			sess, NULL, "%p");
...
/**
 * Test exelwtion of rte_selwrity_session_create with invalid
 * security operations structure (NULL)
 */
static int
test_session_create_ilw_context_ops(void)
{
	struct selwrity_testsuite_params *ts_params = &testsuite_params;
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_session *sess;
...
/**
 * Test exelwtion of rte_selwrity_session_create with empty
 * security operations
 */
static int
test_session_create_ilw_context_ops_fun(void)
{
	struct selwrity_testsuite_params *ts_params = &testsuite_params;
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_session *sess;
...
/**
 * Test exelwtion of rte_selwrity_session_create with NULL conf parameter
 */
static int
test_session_create_ilw_configuration(void)
{
	struct selwrity_testsuite_params *ts_params = &testsuite_params;
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_session *sess;

	sess = rte_selwrity_session_create(&ut_params->ctx, NULL,
			ts_params->session_mpool,
			ts_params->session_priv_mpool);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_create,
			sess, NULL, "%p");
...
/**
 * Test exelwtion of rte_selwrity_session_create with NULL session
 * mempool
 */
static int
test_session_create_ilw_mempool(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct selwrity_testsuite_params *ts_params = &testsuite_params;
	struct rte_selwrity_session *sess;
 ...
 */
static int
test_session_create_ilw_sess_priv_mempool(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct selwrity_testsuite_params *ts_params = &testsuite_params;
	struct rte_selwrity_session *sess;
...
/**
 * Test exelwtion of rte_selwrity_session_create in case when mempool
...
test_session_create_mempool_empty(void)
{
	struct selwrity_testsuite_params *ts_params = &testsuite_params;
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_session *tmp[SELWRITY_TEST_MEMPOOL_SIZE];
	void *tmp1[SELWRITY_TEST_MEMPOOL_SIZE];
	struct rte_selwrity_session *sess;

	/* Get all available objects from mempool. */
	int i, ret;
	for (i = 0; i < SELWRITY_TEST_MEMPOOL_SIZE; ++i) {
	...
	TEST_ASSERT_MEMPOOL_USAGE(SELWRITY_TEST_MEMPOOL_SIZE);
	TEST_ASSERT_PRIV_MP_USAGE(SELWRITY_TEST_MEMPOOL_SIZE);
...
/**
 * Test exelwtion of rte_selwrity_session_create when session_create
...
/**
 * Test exelwtion of rte_selwrity_session_create in successful exelwtion path
 */
static int
...
/**
 * rte_selwrity_session_update tests
 */

/**
 * Test exelwtion of rte_selwrity_session_update with NULL instance
 */
static int
test_session_update_ilw_context(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;

	int ret = rte_selwrity_session_update(NULL, ut_params->sess,
			&ut_params->conf);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_update,
			ret, -EILWAL, "%d");
...
/**
 * Test exelwtion of rte_selwrity_session_update with invalid
 * security operations structure (NULL)
 */
static int
test_session_update_ilw_context_ops(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	ut_params->ctx.ops = NULL;

	int ret = rte_selwrity_session_update(&ut_params->ctx, ut_params->sess,
			&ut_params->conf);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_update,
			ret, -EILWAL, "%d");
	TEST_ASSERT_MOCK_CALLS(mock_session_update_exp, 0);
...
/**
 * Test exelwtion of rte_selwrity_session_update with empty
 * security operations
 */
static int
test_session_update_ilw_context_ops_fun(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	ut_params->ctx.ops = &empty_ops;
...
/**
 * Test exelwtion of rte_selwrity_session_update with NULL conf parameter
 */
static int
test_session_update_ilw_configuration(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
...
/**
 * Test exelwtion of rte_selwrity_session_update with NULL sess parameter
 */
static int
test_session_update_ilw_session(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;

	int ret = rte_selwrity_session_update(&ut_params->ctx, NULL,
			&ut_params->conf);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_update,
			ret, -EILWAL, "%d");
	TEST_ASSERT_MOCK_CALLS(mock_session_update_exp, 0);
...
/**
 * Test exelwtion of rte_selwrity_session_update when session_update
 * security operation fails
 */
static int
...
/**
 * Test exelwtion of rte_selwrity_session_update in successful exelwtion path
 */
static int
...
/**
 * rte_selwrity_session_get_size tests
 */

/**
 * Test exelwtion of rte_selwrity_session_get_size with NULL instance
 */
static int
test_session_get_size_ilw_context(void)
{
	unsigned int ret = rte_selwrity_session_get_size(NULL);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_get_size,
			ret, 0, "%u");
...
/**
 * Test exelwtion of rte_selwrity_session_get_size with invalid
 * security operations structure (NULL)
 */
static int
test_session_get_size_ilw_context_ops(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	ut_params->ctx.ops = NULL;

	unsigned int ret = rte_selwrity_session_get_size(&ut_params->ctx);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_get_size,
			ret, 0, "%u");
	TEST_ASSERT_MOCK_CALLS(mock_session_get_size_exp, 0);
...
/**
 * Test exelwtion of rte_selwrity_session_get_size with empty
 * security operations
 */
static int
test_session_get_size_ilw_context_ops_fun(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	ut_params->ctx.ops = &empty_ops;
...
/**
 * Test exelwtion of rte_selwrity_session_get_size when session_get_size
 * security operation fails
 */
static int
...
/**
 * Test exelwtion of rte_selwrity_session_get_size in successful exelwtion path
 */
static int
...
/**
 * rte_selwrity_session_stats_get tests
 */

/**
 * Test exelwtion of rte_selwrity_session_stats_get with NULL instance
 */
static int
test_session_stats_get_ilw_context(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_stats stats;

	int ret = rte_selwrity_session_stats_get(NULL, ut_params->sess, &stats);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_stats_get,
			ret, -EILWAL, "%d");
...
/**
 * Test exelwtion of rte_selwrity_session_stats_get with invalid
 * security operations structure (NULL)
 */
static int
test_session_stats_get_ilw_context_ops(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_stats stats;
	ut_params->ctx.ops = NULL;

	int ret = rte_selwrity_session_stats_get(&ut_params->ctx,
...
/**
 * Test exelwtion of rte_selwrity_session_stats_get with empty
 * security operations
 */
static int
test_session_stats_get_ilw_context_ops_fun(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_stats stats;
	ut_params->ctx.ops = &empty_ops;
...
/**
 * Test exelwtion of rte_selwrity_session_stats_get with NULL stats parameter
 */
static int
test_session_stats_get_ilw_stats(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
...
/**
 * Test exelwtion of rte_selwrity_session_stats_get when session_stats_get
 * security operation fails
 */
static int
...
/**
 * Test exelwtion of rte_selwrity_session_stats_get in successful exelwtion
 * path
 */
static int
...
/**
 * rte_selwrity_session_destroy tests
 */

/**
 * Test exelwtion of rte_selwrity_session_destroy with NULL instance
 */
static int
test_session_destroy_ilw_context(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	...
	int ret = rte_selwrity_session_destroy(NULL, ut_params->sess);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_destroy,
			ret, -EILWAL, "%d");
...
/**
 * Test exelwtion of rte_selwrity_session_destroy with invalid
 * security operations structure (NULL)
 */
static int
test_session_destroy_ilw_context_ops(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	ut_params->ctx.ops = NULL;
...
/**
 * Test exelwtion of rte_selwrity_session_destroy with empty
 * security operations
 */
static int
test_session_destroy_ilw_context_ops_fun(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	ut_params->ctx.ops = &empty_ops;
...
/**
 * Test exelwtion of rte_selwrity_session_destroy with NULL sess parameter
 */
static int
test_session_destroy_ilw_session(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	...
	int ret = rte_selwrity_session_destroy(&ut_params->ctx, NULL);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_session_destroy,
			ret, -EILWAL, "%d");
	TEST_ASSERT_MOCK_CALLS(mock_session_destroy_exp, 0);
	TEST_ASSERT_MEMPOOL_USAGE(1);
...
/**
 * Test exelwtion of rte_selwrity_session_destroy when session_destroy
 * security operation fails
 */
static int
...
/**
 * Test exelwtion of rte_selwrity_session_destroy in successful exelwtion path
 */
static int
...
/**
 * rte_selwrity_set_pkt_metadata tests
 */

/**
 * Test exelwtion of rte_selwrity_set_pkt_metadata with NULL instance
 */
static int
test_set_pkt_metadata_ilw_context(void)
{
#ifdef RTE_DEBUG
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_mbuf m;
	...
	int ret = rte_selwrity_set_pkt_metadata(NULL, ut_params->sess, &m,
			&params);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_set_pkt_metadata,
			ret, -EILWAL, "%d");
...
/**
 * Test exelwtion of rte_selwrity_set_pkt_metadata with invalid
 * security operations structure (NULL)
 */
static int
test_set_pkt_metadata_ilw_context_ops(void)
{
#ifdef RTE_DEBUG
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_mbuf m;
	...
	int ret = rte_selwrity_set_pkt_metadata(&ut_params->ctx,
...
/**
 * Test exelwtion of rte_selwrity_set_pkt_metadata with empty
 * security operations
 */
static int
test_set_pkt_metadata_ilw_context_ops_fun(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_mbuf m;
	int params;
...
/**
 * Test exelwtion of rte_selwrity_set_pkt_metadata with NULL sess parameter
 */
static int
test_set_pkt_metadata_ilw_session(void)
{
#ifdef RTE_DEBUG
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_mbuf m;
	...
	int ret = rte_selwrity_set_pkt_metadata(&ut_params->ctx, NULL,
			&m, &params);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_set_pkt_metadata,
			ret, -EILWAL, "%d");
	TEST_ASSERT_MOCK_CALLS(mock_set_pkt_metadata_exp, 0);
...
/**
 * Test exelwtion of rte_selwrity_set_pkt_metadata when set_pkt_metadata
 * security operation fails
 */
static int
...
/**
 * Test exelwtion of rte_selwrity_set_pkt_metadata in successful exelwtion path
 */
static int
...
/**
 * rte_selwrity_get_userdata tests
 */

/**
 * Test exelwtion of rte_selwrity_get_userdata with NULL instance
 */
static int
test_get_userdata_ilw_context(void)
{
#ifdef RTE_DEBUG
	uint64_t md = 0xDEADBEEF;

	void *ret = rte_selwrity_get_userdata(NULL, md);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_get_userdata,
			ret, NULL, "%p");
...
/**
 * Test exelwtion of rte_selwrity_get_userdata with invalid
 * security operations structure (NULL)
 */
static int
test_get_userdata_ilw_context_ops(void)
{
#ifdef RTE_DEBUG
	struct selwrity_unittest_params *ut_params = &unittest_params;
	uint64_t md = 0xDEADBEEF;
	...
	void *ret = rte_selwrity_get_userdata(&ut_params->ctx, md);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_get_userdata,
			ret, NULL, "%p");
	TEST_ASSERT_MOCK_CALLS(mock_get_userdata_exp, 0);
...
/**
 * Test exelwtion of rte_selwrity_get_userdata with empty
 * security operations
 */
static int
test_get_userdata_ilw_context_ops_fun(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	uint64_t md = 0xDEADBEEF;
	ut_params->ctx.ops = &empty_ops;
...
/**
 * Test exelwtion of rte_selwrity_get_userdata when get_userdata
 * security operation fails
 */
static int
...
/**
 * Test exelwtion of rte_selwrity_get_userdata in successful exelwtion path
 */
static int
...
/**
 * rte_selwrity_capabilities_get tests
 */

/**
 * Test exelwtion of rte_selwrity_capabilities_get with NULL instance
 */
static int
test_capabilities_get_ilw_context(void)
{
	const struct rte_selwrity_capability *ret;
	ret = rte_selwrity_capabilities_get(NULL);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_capabilities_get,
			ret, NULL, "%p");
...
/**
 * Test exelwtion of rte_selwrity_capabilities_get with invalid
 * security operations structure (NULL)
 */
static int
test_capabilities_get_ilw_context_ops(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	ut_params->ctx.ops = NULL;

	const struct rte_selwrity_capability *ret;
	ret = rte_selwrity_capabilities_get(&ut_params->ctx);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_capabilities_get,
			ret, NULL, "%p");
	TEST_ASSERT_MOCK_CALLS(mock_capabilities_get_exp, 0);
...
/**
 * Test exelwtion of rte_selwrity_capabilities_get with empty
 * security operations
 */
static int
test_capabilities_get_ilw_context_ops_fun(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	ut_params->ctx.ops = &empty_ops;
...
/**
 * Test exelwtion of rte_selwrity_capabilities_get when capabilities_get
 * security operation fails
 */
static int
...
/**
 * Test exelwtion of rte_selwrity_capabilities_get in successful exelwtion path
 */
static int
test_capabilities_get_success(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_capability capabilities;
...
/**
 * rte_selwrity_capability_get tests
 */

/**
 * Test exelwtion of rte_selwrity_capability_get with NULL instance
 */
static int
test_capability_get_ilw_context(void)
{
	struct rte_selwrity_capability_idx idx;

	const struct rte_selwrity_capability *ret;
	ret = rte_selwrity_capability_get(NULL, &idx);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_capability_get,
			ret, NULL, "%p");
	TEST_ASSERT_MOCK_CALLS(mock_capabilities_get_exp, 0);
...
/**
 * Test exelwtion of rte_selwrity_capability_get with invalid
 * security operations structure (NULL)
 */
static int
test_capability_get_ilw_context_ops(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_capability_idx idx;
	ut_params->ctx.ops = NULL;
	...
	const struct rte_selwrity_capability *ret;
	ret = rte_selwrity_capability_get(&ut_params->ctx, &idx);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_capability_get,
			ret, NULL, "%p");
	TEST_ASSERT_MOCK_CALLS(mock_capabilities_get_exp, 0);
...
/**
 * Test exelwtion of rte_selwrity_capability_get with empty
 * security operations
 */
static int
test_capability_get_ilw_context_ops_fun(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;
	struct rte_selwrity_capability_idx idx;
	ut_params->ctx.ops = &empty_ops;
...
/**
 * Test exelwtion of rte_selwrity_capability_get with NULL idx parameter
 */
static int
test_capability_get_ilw_idx(void)
{
	struct selwrity_unittest_params *ut_params = &unittest_params;

	const struct rte_selwrity_capability *ret;
	ret = rte_selwrity_capability_get(&ut_params->ctx, NULL);
	TEST_ASSERT_MOCK_FUNCTION_CALL_RET(rte_selwrity_capability_get,
			ret, NULL, "%p");
	TEST_ASSERT_MOCK_CALLS(mock_capabilities_get_exp, 0);
...
/**
 * Test exelwtion of rte_selwrity_capability_get when capabilities_get
 * security operation fails
 */
static int
...
/**
 * Test exelwtion of rte_selwrity_capability_get when capabilities table
 * is empty (contains only RTE_SELWRITY_ACTION_TYPE_NONE ending entry)
 */
static int
...
test_capability_get_no_matching_action(void)
{
	...
	struct rte_selwrity_capability capabilities[] = {
		{
			.action = RTE_SELWRITY_ACTION_TYPE_INLINE_CRYPTO,
		},
		{
			.action = RTE_SELWRITY_ACTION_TYPE_INLINE_PROTOCOL,
		},
		{
			.action = RTE_SELWRITY_ACTION_TYPE_NONE,
		},
...
test_capability_get_no_matching_protocol(void)
{
	...
	struct rte_selwrity_capability capabilities[] = {
		{
			.action = RTE_SELWRITY_ACTION_TYPE_LOOKASIDE_PROTOCOL,
			.protocol = RTE_SELWRITY_PROTOCOL_MACSEC,
		},
		{
			.action = RTE_SELWRITY_ACTION_TYPE_LOOKASIDE_PROTOCOL,
...
/**
 * Test exelwtion of rte_selwrity_capability_get when macsec protocol
 * is searched and capabilities table contain proper entry.
 * However macsec records search is not supported in rte_selwrity.
 */
static int
	...
	struct rte_selwrity_capability capabilities[] = {
		{
			...
			.protocol = RTE_SELWRITY_PROTOCOL_IPSEC,
			.ipsec = {
				.proto = RTE_SELWRITY_IPSEC_SA_PROTO_AH,
			},
		},
		{
			.action = RTE_SELWRITY_ACTION_TYPE_NONE,
...
test_capability_get_ipsec_mismatch_mode(void)
{
	...
	struct rte_selwrity_capability_idx idx = {
		...
		.ipsec = {
			.proto = RTE_SELWRITY_IPSEC_SA_PROTO_ESP,
			.mode = RTE_SELWRITY_IPSEC_SA_MODE_TRANSPORT,
		},
	};
	struct rte_selwrity_capability capabilities[] = {
		{
 ...
 * Declaration of testcases
 */
static struct unit_test_suite selwrity_testsuite  = {
	.suite_name = "generic security",
	.setup = testsuite_setup,
	.teardown = testsuite_teardown,
	.unit_test_cases = {
		TEST_CASE_ST(ut_setup, ut_teardown,
				test_session_create_ilw_context),
		TEST_CASE_ST(ut_setup, ut_teardown,
				test_session_create_ilw_context_ops),
		TEST_CASE_ST(ut_setup, ut_teardown,
				test_session_create_ilw_context_ops_fun),
		TEST_CASE_ST(ut_setup, ut_teardown,
				test_session_create_ilw_configuration),
		TEST_CASE_ST(ut_setup, ut_teardown,
				test_session_create_ilw_mempool),
		TEST_CASE_ST(ut_setup, ut_teardown,
				test_session_create_ilw_sess_priv_mempool),
		TEST_CASE_ST(ut_setup, ut_teardown,
		...
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_update_ilw_context),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_update_ilw_context_ops),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_update_ilw_context_ops_fun),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_update_ilw_configuration),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_update_ilw_session),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
		...
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_get_size_ilw_context),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_get_size_ilw_context_ops),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_get_size_ilw_context_ops_fun),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
		...
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_stats_get_ilw_context),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_stats_get_ilw_context_ops),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_stats_get_ilw_context_ops_fun),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_stats_get_ilw_stats),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
		...
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_destroy_ilw_context),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_destroy_ilw_context_ops),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_destroy_ilw_context_ops_fun),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_session_destroy_ilw_session),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
		...
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_set_pkt_metadata_ilw_context),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_set_pkt_metadata_ilw_context_ops),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_set_pkt_metadata_ilw_context_ops_fun),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_set_pkt_metadata_ilw_session),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
		...
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_get_userdata_ilw_context),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_get_userdata_ilw_context_ops),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_get_userdata_ilw_context_ops_fun),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
		...
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_capabilities_get_ilw_context),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_capabilities_get_ilw_context_ops),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_capabilities_get_ilw_context_ops_fun),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
		...
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_capability_get_ilw_context),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_capability_get_ilw_context_ops),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_capability_get_ilw_context_ops_fun),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
				test_capability_get_ilw_idx),
		TEST_CASE_ST(ut_setup_with_session, ut_teardown,
...
test_selwrity(void)
{
	...
	return unit_test_suite_runner(&selwrity_testsuite);
}

REGISTER_TEST_COMMAND(selwrity_autotest, test_selwrity);
