...
static const char test_buf_alice[] =
	...
	"pictures or colwersations in it, `and what is the use of a book,'\n"
	"thought Alice `without pictures or colwersation?'\n\n"
	...
	"it over afterwards, it oclwrred to her that she ought to have\n"
	...
	"noticed that they were filled with lwpboards and book-shelves;\n"
	"here and there she saw maps and pictures hung upon pegs.  She\n"
	"took down a jar from one of the shelves as she passed; it was\n"
	"labelled `ORANGE MARMALADE', but to her great disappointment it\n"
	"was empty:  she did not like to drop the jar for fear of killing\n"
	"somebody, so managed to put it into one of the lwpboards as she\n"
	"fell past it.\n\n"
	...
	"to lwrtsey as she spoke--fancy LWRTSEYING as you're falling\n"
...
static const char test_buf_alice2[] =
	"`Lwriouser and lwriouser!' cried Alice (she was so much\n"
