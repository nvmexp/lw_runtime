...
int test_parse_num_ilwalid_data(void);
int test_parse_num_ilwalid_param(void);

/* cmdline_parse_etheraddr tests */
int test_parse_etheraddr_valid(void);
int test_parse_etheraddr_ilwalid_data(void);
int test_parse_etheraddr_ilwalid_param(void);

/* cmdline_parse_portlist tests */
int test_parse_portlist_valid(void);
int test_parse_portlist_ilwalid_data(void);
int test_parse_portlist_ilwalid_param(void);

/* cmdline_parse_ipaddr tests */
int test_parse_ipaddr_valid(void);
int test_parse_ipaddr_ilwalid_data(void);
int test_parse_ipaddr_ilwalid_param(void);

/* cmdline_parse_string tests */
int test_parse_string_valid(void);
int test_parse_string_ilwalid_data(void);
int test_parse_string_ilwalid_param(void);

/* cmdline_cirbuf tests */
int test_cirbuf_ilwalid_param(void);
