...
static int
virtual_ethdev_promislwous_mode_enable(struct rte_eth_dev *dev __rte_unused)
{
	return 0;
}

static int
virtual_ethdev_promislwous_mode_disable(struct rte_eth_dev *dev __rte_unused)
{
	return 0;
}
...
static const struct eth_dev_ops virtual_ethdev_default_dev_ops = {
	...
	.promislwous_enable = virtual_ethdev_promislwous_mode_enable,
	.promislwous_disable = virtual_ethdev_promislwous_mode_disable
};
