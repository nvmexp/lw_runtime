...
class AutotestRunner:
    ...
    def __process_result(self, result):
        ...
        # get total run time
        lwr_time = time.time()
        total_time = int(lwr_time - self.start)
    ...
    def __run_test_group(self, test_group, worker_cmdlines):
        ...
        # iterate while we have group exelwtion results to get
        while len(results) > 0:
    ...
    def run_all_tests(self):
        ...
        try:
            ...
            print("Exception oclwrred")
            print(sys.exc_info())
            self.fails = 1

        # drop logs from all exelwtions to a logfile
