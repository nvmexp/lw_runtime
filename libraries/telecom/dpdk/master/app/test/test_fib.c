...
static int32_t test_add_del_ilwalid(void);
static int32_t test_get_ilwalid(void);
...
static struct unit_test_suite fib_fast_tests = {
	...
	TEST_CASE(test_add_del_ilwalid),
	TEST_CASE(test_get_ilwalid),
