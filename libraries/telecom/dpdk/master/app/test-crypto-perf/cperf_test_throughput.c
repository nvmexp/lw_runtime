...
cperf_throughput_test_runner(void *test_ctx)
{
	...
	while (test_burst_size <= ctx->options->max_burst_size) {
		...
		while (ops_enqd_total < ctx->options->total_ops) {
			...
			/**
			 * Callwlate number of ops not enqueued (mainly for hw
