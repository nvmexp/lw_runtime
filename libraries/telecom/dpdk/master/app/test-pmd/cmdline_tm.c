...
cmdline_parse_token_num_t cmd_add_port_tm_node_wred_profile_max_th_g =
	TOKEN_NUM_INITIALIZER(
		struct cmd_add_port_tm_node_wred_profile_result,
			max_th_g, RTE_UINT64);
cmdline_parse_token_num_t cmd_add_port_tm_node_wred_profile_maxp_ilw_g =
	TOKEN_NUM_INITIALIZER(
		struct cmd_add_port_tm_node_wred_profile_result,
			maxp_ilw_g, RTE_UINT16);
...
cmdline_parse_token_num_t cmd_add_port_tm_node_wred_profile_max_th_y =
	TOKEN_NUM_INITIALIZER(
		struct cmd_add_port_tm_node_wred_profile_result,
			max_th_y, RTE_UINT64);
cmdline_parse_token_num_t cmd_add_port_tm_node_wred_profile_maxp_ilw_y =
	TOKEN_NUM_INITIALIZER(
		struct cmd_add_port_tm_node_wred_profile_result,
			maxp_ilw_y, RTE_UINT16);
...
cmdline_parse_token_num_t cmd_add_port_tm_node_wred_profile_max_th_r =
	TOKEN_NUM_INITIALIZER(
		struct cmd_add_port_tm_node_wred_profile_result,
			max_th_r, RTE_UINT64);
cmdline_parse_token_num_t cmd_add_port_tm_node_wred_profile_maxp_ilw_r =
	TOKEN_NUM_INITIALIZER(
		struct cmd_add_port_tm_node_wred_profile_result,
			maxp_ilw_r, RTE_UINT16);
	...
	__rte_unused void *data)
{
	...
	wp.red_params[color].maxp_ilw = res->maxp_ilw_g;
	...
	wp.red_params[color].maxp_ilw = res->maxp_ilw_y;
	...
	wp.red_params[color].maxp_ilw = res->maxp_ilw_r;
...
cmdline_parse_inst_t cmd_add_port_tm_node_wred_profile = {
	...
	.tokens = {
		...
		(void *)&cmd_add_port_tm_node_wred_profile_maxp_ilw_g,
		...
		(void *)&cmd_add_port_tm_node_wred_profile_maxp_ilw_y,
		...
		(void *)&cmd_add_port_tm_node_wred_profile_maxp_ilw_r,
