...
#ifdef RTE_LIB_SELWRITY
int
qat_selwrity_session_create(void *dev, struct rte_selwrity_session_conf *conf,
		struct rte_selwrity_session *sess, struct rte_mempool *mempool);
int
qat_selwrity_session_destroy(void *dev, struct rte_selwrity_session *sess);
#endif
