...
enum sec_return_code_e {
	SEC_SUCCESS = 0,	       /* Operation exelwted successfully.*/
	SEC_ILWALID_INPUT_PARAM,       /* API received an invalid input
					* parameter
					*/
	...
	SEC_PROCESSING_ERROR,	       /* Indicates a SEC processing error
					* oclwrred on a Job Ring which requires
	...
	SEC_DESC_PROCESSING_ERROR,     /* Indicates a SEC descriptor processing
					* error oclwrred on a Job Ring. Can be
...
/* Virtual to physical address colwersion */
