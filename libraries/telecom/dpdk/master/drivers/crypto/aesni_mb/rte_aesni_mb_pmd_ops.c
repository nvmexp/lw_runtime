...
static const struct rte_cryptodev_capabilities
					aesni_mb_pmd_selwrity_crypto_cap[] = {
	{	/* AES DOCSIS BPI */
		.op = RTE_CRYPTO_OP_TYPE_SYMMETRIC,
		{.sym = {
			.xform_type = RTE_CRYPTO_SYM_XFORM_CIPHER,
...
static const struct rte_selwrity_capability aesni_mb_pmd_selwrity_cap[] = {
	{	/* DOCSIS Uplink */
		...
		.crypto_capabilities = aesni_mb_pmd_selwrity_crypto_cap
	},
	{	/* DOCSIS Downlink */
		.action = RTE_SELWRITY_ACTION_TYPE_LOOKASIDE_PROTOCOL,
		.protocol = RTE_SELWRITY_PROTOCOL_DOCSIS,
 ...
 */
static int
aesni_mb_pmd_sec_sess_create(void *dev, struct rte_selwrity_session_conf *conf,
...
{
	return aesni_mb_pmd_selwrity_cap;
}

static struct rte_selwrity_ops aesni_mb_pmd_sec_ops = {
...
struct rte_selwrity_ops *rte_aesni_mb_pmd_sec_ops = &aesni_mb_pmd_sec_ops;
#endif
