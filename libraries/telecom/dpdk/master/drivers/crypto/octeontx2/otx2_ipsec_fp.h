...
static inline int
ipsec_fp_xform_aead_verify(struct rte_selwrity_ipsec_xform *ipsec,
...
static inline int
ipsec_fp_xform_verify(struct rte_selwrity_ipsec_xform *ipsec,
		      struct rte_crypto_sym_xform *xform)
{
...
static inline int
ipsec_fp_sa_ctl_set(struct rte_selwrity_ipsec_xform *ipsec,
		    struct rte_crypto_sym_xform *xform,
		    struct otx2_ipsec_fp_sa_ctl *ctl)
{
