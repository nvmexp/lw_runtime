...
static int
ipsec_lp_len_precalc(struct rte_selwrity_ipsec_xform *ipsec,
		...
		struct otx2_sec_session_ipsec_lp *lp)
{
	...
	else if (ipsec->tunnel.type == RTE_SELWRITY_IPSEC_TUNNEL_IPV6)
...
static struct rte_selwrity_ops otx2_crypto_sec_ops = {
