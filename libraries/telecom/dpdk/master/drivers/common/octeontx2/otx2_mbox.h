...
#define MBOX_MSG_ILWALID			0xFFFE
...
M(SSO_GRP_GET_PRIORITY,	0x606, sso_grp_get_priority, sso_info_req,	\
				sso_grp_priority)			\
M(SSO_WS_CACHE_ILW,	0x607, sso_ws_cache_ilw, msg_req, msg_rsp)	\
...
#define OTX2_PRIV_FLAGS_LWSTOM   BIT_ULL(63)
...
#define MSIX_VECTOR_ILWALID	0xFFFF
...
enum nix_af_status {
	...
	NIX_AF_ERR_AF_LF_ILWALID    = -404,
	NIX_AF_ERR_AF_LF_ALLOC      = -405,
	NIX_AF_ERR_TLX_ALLOC_FAIL   = -406,
	NIX_AF_ERR_TLX_ILWALID      = -407,
	NIX_AF_ERR_RSS_SIZE_ILWALID = -408,
	NIX_AF_ERR_RSS_GRPS_ILWALID = -409,
	NIX_AF_ERR_FRS_ILWALID      = -410,
	NIX_AF_ERR_RX_LINK_ILWALID  = -411,
	NIX_AF_ILWAL_TXSCHQ_CFG     = -412,
	...
	NIX_AF_ILWAL_NPA_PF_FUNC    = -419,
	NIX_AF_ILWAL_SSO_PF_FUNC    = -420,
...
#define FLOW_KEY_TYPE_LWGRE    BIT(6)
...
#define FLOW_KEY_TYPE_LWSTOM0		BIT(19)
...
enum sso_af_status {
	...
	SSO_AF_ERR_LF_ILWALID	= -502,
	SSO_AF_ERR_AF_LF_ALLOC	= -503,
	SSO_AF_ERR_GRP_EBUSY	= -504,
	SSO_AF_ILWAL_NPA_PF_FUNC = -505,
};
...
enum cpt_af_status {
	...
	CPT_AF_ERR_GRP_ILWALID		= -902,
	CPT_AF_ERR_LF_ILWALID		= -903,
	CPT_AF_ERR_ACCESS_DENIED	= -904,
	CPT_AF_ERR_SSO_PF_FUNC_ILWALID	= -905,
	CPT_AF_ERR_NIX_PF_FUNC_ILWALID	= -906,
...
#define NPC_MCAM_ENTRY_ILWALID	0xFFFF
#define NPC_MCAM_ILWALID_MAP	0xFFFF

/* NPC mailbox error codes
 * Range 701 - 800.
 */
enum npc_af_status {
	NPC_MCAM_ILWALID_REQ	= -701,
...
#define NPC_MCAM_MAX_SHIFTS	64
	uint16_t __otx2_io lwrr_entry[NPC_MCAM_MAX_SHIFTS];
...
struct npc_mcam_shift_entry_rsp {
	struct mbox_msghdr hdr;
	/* Index in 'lwrr_entry', not entry itself */
...
enum tim_af_status {
	...
	TIM_AF_ILWALID_NPA_PF_FUNC		= -802,
	TIM_AF_ILWALID_SSO_PF_FUNC		= -803,
	TIM_AF_RING_STILL_RUNNING		= -804,
	TIM_AF_LF_ILWALID			= -805,
	TIM_AF_CSIZE_NOT_ALIGNED		= -806,
	TIM_AF_CSIZE_TOO_SMALL			= -807,
	TIM_AF_CSIZE_TOO_BIG			= -808,
	TIM_AF_INTERVAL_TOO_SMALL		= -809,
	TIM_AF_ILWALID_BIG_ENDIAN_VALUE		= -810,
	TIM_AF_ILWALID_CLOCK_SOURCE		= -811,
	TIM_AF_GPIO_CLK_SRC_NOT_ENABLED		= -812,
	TIM_AF_ILWALID_BSIZE			= -813,
	TIM_AF_ILWALID_ENABLE_PERIODIC		= -814,
	TIM_AF_ILWALID_ENABLE_DONTFREE		= -815,
...
struct tim_enable_rsp {
	...
	uint32_t __otx2_io lwrrentbucket;
};
...
int otx2_reply_ilwalid_msg(struct otx2_mbox *mbox, int devid, uint16_t pf_func,
			uint16_t id);
