 ...
 *      this ilwokes the common macro which may be used by either the request
 *      or the response.
 *
 ...
 *      ilwokes the common macro which may be used by either the request
 *      or the response.
 *
 ...
 *      this ilwokes the common macro which may be used by either the
