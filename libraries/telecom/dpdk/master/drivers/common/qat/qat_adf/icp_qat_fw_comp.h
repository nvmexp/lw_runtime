...
#define ICP_QAT_FW_COMP_DISABLE_SELWRE_RAM_USED_AS_INTMD_BUF 1
/**< @ingroup icp_qat_fw_comp
 * Flag representing secure RAM from being used as
 * an intermediate buffer is DISABLED.
 */

#define ICP_QAT_FW_COMP_ENABLE_SELWRE_RAM_USED_AS_INTMD_BUF 0
/**< @ingroup icp_qat_fw_comp
 * Flag representing secure RAM from being used as
...
#define ICP_QAT_FW_COMP_DISABLE_SELWRE_RAM_AS_INTMD_BUF_BITPOS 7
/**< @ingroup icp_qat_fw_comp
 * Starting bit position for flag used to disable secure ram from
 *  being used as an intermediate buffer.
 */

#define ICP_QAT_FW_COMP_DISABLE_SELWRE_RAM_AS_INTMD_BUF_MASK 0x1
/**< @ingroup icp_qat_fw_comp
...
#define ICP_QAT_FW_COMP_FLAGS_BUILD(sesstype, autoselect, enhanced_asb,        \
	...
	((((sesstype)&ICP_QAT_FW_COMP_SESSION_TYPE_MASK)                       \
	 ...
	 (((selwre_ram)&ICP_QAT_FW_COMP_DISABLE_SELWRE_RAM_AS_INTMD_BUF_MASK)  \
	  << ICP_QAT_FW_COMP_DISABLE_SELWRE_RAM_AS_INTMD_BUF_BITPOS))
...
#define ICP_QAT_FW_COMP_REQ_PARAM_FLAGS_BUILD(sop, eop, bfinal, clw, clwnr)    \
	((((sop)&ICP_QAT_FW_COMP_SOP_MASK) << ICP_QAT_FW_COMP_SOP_BITPOS) |    \
	 ...
	 ((clw & ICP_QAT_FW_COMP_CLW_MASK) << ICP_QAT_FW_COMP_CLW_BITPOS) |    \
	 ((clwnr & ICP_QAT_FW_COMP_CLW_RECOVERY_MASK)                          \
	  << ICP_QAT_FW_COMP_CLW_RECOVERY_BITPOS))
...
#define ICP_QAT_FW_COMP_NO_CLW 0
/**< @ingroup icp_qat_fw_comp
 * Flag indicating that NO clw check is to be performed on the request
 */

#define ICP_QAT_FW_COMP_CLW 1
/**< @ingroup icp_qat_fw_comp
 * Flag indicating that a clw check IS to be performed on the request
 */

#define ICP_QAT_FW_COMP_NO_CLW_RECOVERY 0
/**< @ingroup icp_qat_fw_comp
 * Flag indicating that NO clw recovery is to be performed on the request
 */

#define ICP_QAT_FW_COMP_CLW_RECOVERY 1
/**< @ingroup icp_qat_fw_comp
 * Flag indicating that a clw recovery is to be performed on the request
 */
...
#define ICP_QAT_FW_COMP_CLW_MASK 0x1
/**< @ingroup icp_qat_fw_comp
 * One bit mask for the CLW bit
 */

#define ICP_QAT_FW_COMP_CLW_BITPOS 16
/**< @ingroup icp_qat_fw_comp
 * Starting bit position for the CLW bit
 */

#define ICP_QAT_FW_COMP_CLW_RECOVERY_MASK 0x1
/**< @ingroup icp_qat_fw_comp
 * One bit mask for the CLW Recovery bit
 */

#define ICP_QAT_FW_COMP_CLW_RECOVERY_BITPOS 17
/**< @ingroup icp_qat_fw_comp
 * Starting bit position for the CLW Recovery bit
 */
...
struct icp_qat_fw_resp_comp_pars {
	...
	/**< LW 6 & 7*/
	union {
		uint64_t lwrr_chksum;
		struct {
			/**< LW 6 */
			uint32_t lwrr_crc32;
			/**< LW 7 */
			uint32_t lwrr_adler_32;
		};
	};
};
