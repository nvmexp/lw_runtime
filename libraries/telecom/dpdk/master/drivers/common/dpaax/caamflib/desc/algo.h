...
/**
 * colw_to_zuc_eia_iv - ZUCA IV 16-byte to 8-byte colwert
 * function for 3G.
...
static inline uint8_t *colw_to_zuc_eia_iv(uint8_t *iv)
{
...
/**
 * colw_to_snow_f9_iv - SNOW/f9 (UIA2) IV 16 byte to 12 byte colwert
 * function for 3G.
...
static inline uint8_t *colw_to_snow_f9_iv(uint8_t *iv)
{
