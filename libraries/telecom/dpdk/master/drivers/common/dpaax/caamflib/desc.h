...
/*
 * Do Not Run - marks a descriptor not exelwtable if there was
...
/*
 * Reverse Exelwtion Order - execute JobDesc first, then
...
#define OP_ALG_AAI_LWST_POLY	(0x04 << OP_ALG_AAI_SHIFT)
...
#define OP_ALG_PKMODE_MOD_ILW	     0x008
...
#define OP_ALG_PKMODE_F2M_ILW	     (0x008 | OP_ALG_PKMODE_MOD_F2M)
...
#define JUMP_TEST_ILWALL	(0x01 << JUMP_TEST_SHIFT)
#define JUMP_TEST_ANY		(0x02 << JUMP_TEST_SHIFT)
#define JUMP_TEST_ILWANY	(0x03 << JUMP_TEST_SHIFT)
...
#define JUMP_COND_MATH_LW	BIT(8)
