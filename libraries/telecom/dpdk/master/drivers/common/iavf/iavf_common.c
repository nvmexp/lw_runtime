...
/**
 * iavf_aq_str - colwert AQ err code to a string
 * @hw: pointer to the HW structure
...
const char *iavf_aq_str(struct iavf_hw *hw, enum iavf_admin_queue_err aq_err)
{
	...
	case IAVF_AQ_RC_EILWAL:
		return "IAVF_AQ_RC_EILWAL";
...
/**
 * iavf_stat_str - colwert status err code to a string
 * @hw: pointer to the HW structure
...
const char *iavf_stat_str(struct iavf_hw *hw, enum iavf_status stat_err)
{
	...
	case IAVF_ERR_LWM:
		return "IAVF_ERR_LWM";
	case IAVF_ERR_LWM_CHECKSUM:
		return "IAVF_ERR_LWM_CHECKSUM";
	case IAVF_ERR_PHY:
		return "IAVF_ERR_PHY";
	...
	case IAVF_ERR_ILWALID_MAC_ADDR:
		return "IAVF_ERR_ILWALID_MAC_ADDR";
	case IAVF_ERR_DEVICE_NOT_SUPPORTED:
		return "IAVF_ERR_DEVICE_NOT_SUPPORTED";
	case IAVF_ERR_MASTER_REQUESTS_PENDING:
		return "IAVF_ERR_MASTER_REQUESTS_PENDING";
	case IAVF_ERR_ILWALID_LINK_SETTINGS:
		return "IAVF_ERR_ILWALID_LINK_SETTINGS";
	...
	case IAVF_ERR_ILWALID_PD_ID:
		return "IAVF_ERR_ILWALID_PD_ID";
	case IAVF_ERR_ILWALID_QP_ID:
		return "IAVF_ERR_ILWALID_QP_ID";
	case IAVF_ERR_ILWALID_CQ_ID:
		return "IAVF_ERR_ILWALID_CQ_ID";
	case IAVF_ERR_ILWALID_CEQ_ID:
		return "IAVF_ERR_ILWALID_CEQ_ID";
	case IAVF_ERR_ILWALID_AEQ_ID:
		return "IAVF_ERR_ILWALID_AEQ_ID";
	case IAVF_ERR_ILWALID_SIZE:
		return "IAVF_ERR_ILWALID_SIZE";
	case IAVF_ERR_ILWALID_ARP_INDEX:
		return "IAVF_ERR_ILWALID_ARP_INDEX";
	case IAVF_ERR_ILWALID_FPM_FUNC_ID:
		return "IAVF_ERR_ILWALID_FPM_FUNC_ID";
	case IAVF_ERR_QP_ILWALID_MSG_SIZE:
		return "IAVF_ERR_QP_ILWALID_MSG_SIZE";
	case IAVF_ERR_QP_TOOMANY_WRS_POSTED:
		return "IAVF_ERR_QP_TOOMANY_WRS_POSTED";
	case IAVF_ERR_ILWALID_FRAG_COUNT:
		return "IAVF_ERR_ILWALID_FRAG_COUNT";
	case IAVF_ERR_QUEUE_EMPTY:
		return "IAVF_ERR_QUEUE_EMPTY";
	case IAVF_ERR_ILWALID_ALIGNMENT:
		return "IAVF_ERR_ILWALID_ALIGNMENT";
	case IAVF_ERR_FLUSHED_QUEUE:
		return "IAVF_ERR_FLUSHED_QUEUE";
	case IAVF_ERR_ILWALID_PUSH_PAGE_INDEX:
		return "IAVF_ERR_ILWALID_PUSH_PAGE_INDEX";
	case IAVF_ERR_ILWALID_IMM_DATA_SIZE:
		return "IAVF_ERR_ILWALID_IMM_DATA_SIZE";
	...
	case IAVF_ERR_ILWALID_VF_ID:
		return "IAVF_ERR_ILWALID_VF_ID";
	case IAVF_ERR_ILWALID_HMCFN_ID:
		return "IAVF_ERR_ILWALID_HMCFN_ID";
	case IAVF_ERR_BACKING_PAGE_ERROR:
		return "IAVF_ERR_BACKING_PAGE_ERROR";
	case IAVF_ERR_NO_PBLCHUNKS_AVAILABLE:
		return "IAVF_ERR_NO_PBLCHUNKS_AVAILABLE";
	case IAVF_ERR_ILWALID_PBLE_INDEX:
		return "IAVF_ERR_ILWALID_PBLE_INDEX";
	case IAVF_ERR_ILWALID_SD_INDEX:
		return "IAVF_ERR_ILWALID_SD_INDEX";
	case IAVF_ERR_ILWALID_PAGE_DESC_INDEX:
		return "IAVF_ERR_ILWALID_PAGE_DESC_INDEX";
	case IAVF_ERR_ILWALID_SD_TYPE:
		return "IAVF_ERR_ILWALID_SD_TYPE";
	case IAVF_ERR_MEMCPY_FAILED:
		return "IAVF_ERR_MEMCPY_FAILED";
	case IAVF_ERR_ILWALID_HMC_OBJ_INDEX:
		return "IAVF_ERR_ILWALID_HMC_OBJ_INDEX";
	case IAVF_ERR_ILWALID_HMC_OBJ_COUNT:
		return "IAVF_ERR_ILWALID_HMC_OBJ_COUNT";
	case IAVF_ERR_ILWALID_SRQ_ARM_LIMIT:
		return "IAVF_ERR_ILWALID_SRQ_ARM_LIMIT";
	...
	case IAVF_ERR_LWM_BLANK_MODE:
		return "IAVF_ERR_LWM_BLANK_MODE";
...
/* The iavf_ptype_lookup table is used to colwert from the 8-bit ptype in the
...
enum iavf_status iavf_validate_mac_addr(u8 *mac_addr)
{
	...
	if (IAVF_IS_MULTICAST(mac_addr) ||
		...
		status = IAVF_ERR_ILWALID_MAC_ADDR;
