...
enum iavf_admin_queue_err {
	...
	IAVF_AQ_RC_EILWAL	= 14, /* Invalid argument */
...
enum iavf_admin_queue_opc {
	...
	iavf_aqc_opc_set_vsi_promislwous_modes	= 0x0254,
	...
	/* LWM commands */
	iavf_aqc_opc_lwm_read			= 0x0701,
	iavf_aqc_opc_lwm_erase			= 0x0702,
	iavf_aqc_opc_lwm_update			= 0x0703,
	iavf_aqc_opc_lwm_config_read		= 0x0704,
	iavf_aqc_opc_lwm_config_write		= 0x0705,
	iavf_aqc_opc_lwm_progress		= 0x0706,
...
#define IAVF_AQ_VSI_PROP_SELWRITY_VALID		0x0002
...
#define IAVF_AQ_VSI_QUE_OPT_RSS_LUT_VSI	0x40
	...
	__le16	qs_handle[8];
#define IAVF_AQ_VSI_QS_HANDLE_ILWALID	0xFFFF
