...
#define IAVF_LWM_EXEC_GET_AQ_RESULT		0x0
#define IAVF_LWM_EXEC_FEATURES			0xe
#define IAVF_LWM_EXEC_STATUS			0xf

/* LWMUpdate features API */
#define IAVF_LWMUPD_FEATURES_API_VER_MAJOR		0
#define IAVF_LWMUPD_FEATURES_API_VER_MINOR		14
#define IAVF_LWMUPD_FEATURES_API_FEATURES_ARRAY_LEN	12

#define IAVF_LWMUPD_FEATURE_FLAT_LWM_SUPPORT		BIT(0)

struct iavf_lwmupd_features {
	u8 major;
	u8 minor;
	u16 size;
	u8 features[IAVF_LWMUPD_FEATURES_API_FEATURES_ARRAY_LEN];
};
...
#define IAVF_HW_FLAG_LWM_READ_REQUIRES_LOCK BIT_ULL(3)
#define IAVF_HW_FLAG_FW_LLDP_STOPPABLE	    BIT_ULL(4)
	u64 flags;

	/* LWMUpdate features */
	struct iavf_lwmupd_features lwmupd_features;
...
enum iavf_rx_desc_status_bits {
	...
	IAVF_RX_DESC_STATUS_TSYLWALID_SHIFT	= 7,
...
#define IAVF_RXD_QW1_STATUS_TSYLWALID_SHIFT IAVF_RX_DESC_STATUS_TSYLWALID_SHIFT
#define IAVF_RXD_QW1_STATUS_TSYLWALID_MASK   BIT_ULL(IAVF_RXD_QW1_STATUS_TSYLWALID_SHIFT)
...
enum iavf_rx_prog_status_desc_prog_id_masks {
	...
	IAVF_RX_PROG_STATUS_DESC_FCOE_CTXT_ILWL_STATUS	= 4,
};
...
#define IAVF_SR_LWM_MAP_VERSION			0x29
#define IAVF_SR_LWM_IMAGE_VERSION		0x2A
#define IAVF_SR_LWM_STRUCTURE_VERSION		0x2B
#define IAVF_SR_PXE_SETUP_PTR			0x30
#define IAVF_SR_PXE_CONFIG_LWST_OPTIONS_PTR	0x31
#define IAVF_SR_LWM_ORIGINAL_EETRACK_LO		0x34
#define IAVF_SR_LWM_ORIGINAL_EETRACK_HI		0x35
...
#define IAVF_DDP_TRACKID_ILWALID	0xFFFFFFFF
