 ...
 * dynamic configuration partitions in LWRAM for EF10 (Huntington etc.).
 *
...
#define TLV_TAG_ILWALID                 (0xFFFFFFFF)
 ...
 * the LWRAM.  For example, this may be used to allow a generic firmware update
 ...
 * MC_CMD_LWRAM_METADATA response if present.
 */
 ...
 * the LWRAM.  This provides a standard way of tracking the lwrrently stored
