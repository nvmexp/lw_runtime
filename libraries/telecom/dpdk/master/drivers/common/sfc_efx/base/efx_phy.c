	...
	__out		efx_phy_media_type_t *typep)
{
	...
	if (epp->ep_module_type != EFX_PHY_MEDIA_ILWALID)
	...
	__in			efx_bist_type_t type)
{
	...
	EFSYS_ASSERT3U(epp->ep_lwrrent_bist, ==, EFX_BIST_TYPE_UNKNOWN);
	...
	__in			size_t count)
{
	...
	EFSYS_ASSERT3U(type, !=, EFX_BIST_TYPE_UNKNOWN);
	EFSYS_ASSERT3U(type, <, EFX_BIST_TYPE_NTYPES);
	EFSYS_ASSERT3U(epp->ep_lwrrent_bist, ==, type);
	...
	__in		efx_bist_type_t type)
{
	...
	epp->ep_lwrrent_bist = EFX_BIST_TYPE_UNKNOWN;
}
