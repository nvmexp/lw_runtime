 ...
 * section if required by driver development framework and colwentions.
 */
...
/* Support LWRAM based boot config */
# if !EFSYS_OPT_LWRAM
#  error "BOOTCFG requires LWRAM"
# endif
...
# if !(EFX_OPTS_EF10() || EFSYS_OPT_SIENA)
#  error "LWRAM requires EF10 arch or SIENA"
# endif
...
#ifdef EFSYS_OPT_LWRAM_FALCON_BOOTROM
# error "LWRAM_FALCON_BOOTROM is obsolete and is not supported."
#endif

#ifdef EFSYS_OPT_LWRAM_SFT9001
# error "LWRAM_SFT9001 is obsolete and is not supported."
#endif

#ifdef EFSYS_OPT_LWRAM_SFX7101
# error "LWRAM_SFX7101 is obsolete and is not supported."
#endif
