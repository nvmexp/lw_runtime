	...
	__in_opt	void *arg)
{
	...
	default:
		/* Omit lwrrently unused reserved bits from the probe. */
	...
	__in_opt	void *arg)
{
	 ...
	 * oclwpied by each received packet (based on the Rx buffer size
	...
	__in_opt	void *arg)
{
	...
	/*
	 * NOTE: This is the raw descriptor data, and has not been colwerted
