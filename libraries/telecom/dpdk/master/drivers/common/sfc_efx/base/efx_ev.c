 ...
 * is ilwoked after queue creation. The callback will be ilwoked
 ...
 * eec_initialized callback is ilwoked within the same locking context.
 */
			void
	...
	__out		unsigned int *ticksp)
{
	...
	/* Colwert microseconds to a timer tick count */
	if (us == 0)
		ticks = 0;
