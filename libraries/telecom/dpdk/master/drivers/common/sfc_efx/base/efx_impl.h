...
#define	EFX_MOD_LWRAM		0x00000004
...
#if EFSYS_OPT_BIST
	efx_bist_type_t		ep_lwrrent_bist;
#endif
...
/* Invalid partition ID for en_lwram_partn_locked field of efx_nc_t */
#define	EFX_LWRAM_PARTN_ILWALID		(0xffffffffu)

typedef struct efx_lwram_ops_s {
#if EFSYS_OPT_DIAG
	efx_rc_t	(*elwo_test)(efx_nic_t *);
#endif	/* EFSYS_OPT_DIAG */
	efx_rc_t	(*elwo_type_to_partn)(efx_nic_t *, efx_lwram_type_t,
					    uint32_t *);
	efx_rc_t	(*elwo_partn_info)(efx_nic_t *, uint32_t,
					    efx_lwram_info_t *);
	efx_rc_t	(*elwo_partn_rw_start)(efx_nic_t *, uint32_t, size_t *);
	efx_rc_t	(*elwo_partn_read)(efx_nic_t *, uint32_t,
					    unsigned int, caddr_t, size_t);
	efx_rc_t	(*elwo_partn_read_backup)(efx_nic_t *, uint32_t,
					    unsigned int, caddr_t, size_t);
	efx_rc_t	(*elwo_partn_erase)(efx_nic_t *, uint32_t,
					    unsigned int, size_t);
	efx_rc_t	(*elwo_partn_write)(efx_nic_t *, uint32_t,
					    unsigned int, caddr_t, size_t);
	efx_rc_t	(*elwo_partn_rw_finish)(efx_nic_t *, uint32_t,
					    uint32_t *);
	efx_rc_t	(*elwo_partn_get_version)(efx_nic_t *, uint32_t,
					    uint32_t *, uint16_t *);
	efx_rc_t	(*elwo_partn_set_version)(efx_nic_t *, uint32_t,
					    uint16_t *);
	efx_rc_t	(*elwo_buffer_validate)(uint32_t,
					    caddr_t, size_t);
} efx_lwram_ops_t;
...
#define	EFX_LWRAM_UPDATE_FLAGS_BACKGROUND	0x00000001
#define	EFX_LWRAM_UPDATE_FLAGS_POLL		0x00000002
...
#endif	/* EFSYS_OPT_MCDI */
#if EFSYS_OPT_LWRAM
	uint32_t		en_lwram_partn_locked;
	const efx_lwram_ops_t	*en_elwop;
#endif	/* EFSYS_OPT_LWRAM */
#if EFSYS_OPT_VPD
