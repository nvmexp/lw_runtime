 ...
 * Coordinate Offset depends on elliptic lwrve as mentioned below,
 ...
 * for NIST lwrves P-192, P-256, P-384, P-521, P-224.
 */
...
int cpt_fpm_init(uint64_t *fpm_table_iova)
{
	...
	/* Compute FPM table size for all supported lwrves */
	...
	for (i = CPT_EC_ID_P192; i < CPT_EC_ID_PMAX; i++) {
		...
		/* Colwert iova address to big endian to be used by cpt */
