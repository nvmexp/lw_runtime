...
typedef enum {
	...
	/* SE GC */
	ERR_GC_LENGTH_ILWALID = 0x41,
	ERR_GC_RANDOM_LEN_ILWALID = 0x42,
	ERR_GC_DATA_LEN_ILWALID = 0x43,
	ERR_GC_DRBG_TYPE_ILWALID = 0x44,
	ERR_GC_CTX_LEN_ILWALID = 0x45,
	ERR_GC_CIPHER_UNSUPPORTED = 0x46,
	ERR_GC_AUTH_UNSUPPORTED = 0x47,
	ERR_GC_OFFSET_ILWALID = 0x48,
	ERR_GC_HASH_MODE_UNSUPPORTED = 0x49,
	ERR_GC_DRBG_ENTROPY_LEN_ILWALID = 0x4a,
	ERR_GC_DRBG_ADDNL_LEN_ILWALID = 0x4b,
 ...
 *
 * Enumerates supported elliptic lwrves
 */
typedef enum {
	CPT_EC_ID_P192 = 0,
	CPT_EC_ID_P224 = 1,
...
/* Prime and order fields of built-in elliptic lwrves */
struct cpt_ec_group {
	struct {
		/* P521 maximum length */
		uint8_t data[66];
