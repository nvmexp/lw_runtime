...
ptype_table[PTYPE_SIZE][PTYPE_SIZE][PTYPE_SIZE] = {
	...
	[LC_NONE][LE_NONE][LF_LWGRE] = RTE_PTYPE_TUNNEL_LWGRE,
	...
	[LC_IPV4][LE_NONE][LF_LWGRE] =
				RTE_PTYPE_L3_IPV4 | RTE_PTYPE_TUNNEL_LWGRE,
	...
	[LC_IPV4_OPT][LE_NONE][LF_LWGRE] =
				RTE_PTYPE_L3_IPV4_EXT | RTE_PTYPE_TUNNEL_LWGRE,
	...
	[LC_IPV6_OPT][LE_NONE][LF_LWGRE] =
				RTE_PTYPE_L3_IPV6_EXT | RTE_PTYPE_TUNNEL_LWGRE,
			     ...
			     struct rte_mbuf *m)
{
	...
	if ((flags & OCCTX_TX_OFFLOAD_OL3_OL4_CSUM_F) &&
		...
		if (is_tunnel_parsed) {
			...
			/* Set clk3 for PKO to callwlate IPV4 header checksum */
			...
			/* Set clke for PKO to callwlate inner IPV4 header
			 * checksum.
			 */
