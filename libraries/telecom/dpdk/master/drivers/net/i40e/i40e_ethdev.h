...
#define I40E_RSS_TYPE_ILWALID        1ULL
...
struct i40e_fdir_flow_ext {
	...
	bool lwstomized_pctype; /* If lwstomized pctype is used */
...
#define I40E_FILTER_PCTYPE_ILWALID 0
...
struct i40e_fdir_info {
	...
	/*
	 * Priority ordering at filter ilwalidation(destroying a flow) between
	 * "best effort" space and "guaranteed" space.
	 *
	 * 0 = At filter ilwalidation, the hardware first tries to increment the
...
struct i40e_lwstomized_pctype {
	enum i40e_new_pctype index;  /* Indicate which lwstomized pctype */
...
struct i40e_pf {
	...
	/* customer lwstomized pctype */
	struct i40e_lwstomized_pctype lwstomized_pctype[I40E_LWSTOMIZED_MAX];
	/* Switch Domain Id */
...
struct i40e_vf {
	...
	uint16_t promisc_flags; /* Promislwous setting */
...
/**
 * Strulwte to store private data for each VF representor instance
 */
...
void i40e_update_lwstomized_info(struct rte_eth_dev *dev, uint8_t *pkg,
				 uint32_t pkg_size,
...
i40e_calc_itr_interval(bool is_pf, bool is_multi_drv)
{
	...
	/* Colwert to hardware count, as writing each 1 represents 2 us */
	return interval / 2;
}
...
#define I40E_PHY_TYPE_SUPPORT_40G(phy_type) \
	...
	((phy_type) & I40E_CAP_PHY_TYPE_40GBASE_CR4_LW) || \
