...
/**
 * Enable/Disable VF unicast promislwous mode.
 *
 * @param port
 *    The port identifier of the Ethernet device.
 * @param vf_id
...
/**
 * Enable/Disable VF multicast promislwous mode.
 *
 * @param port
 *    The port identifier of the Ethernet device.
 * @param vf_id
 ...
 *	set other PCTYPEs maps to PCTYPE_ILWALID.
 */
 ...
 *    -EILWAL: vf mac address does not exist for this port
