...
enum i40e_status_code i40e_diag_eeprom_test(struct i40e_hw *hw)
{
	...
	/* read LWM control word and if LWM valid, validate EEPROM checksum*/
	ret_code = i40e_read_lwm_word(hw, I40E_SR_LWM_CONTROL_WORD, &reg_val);
	if ((ret_code == I40E_SUCCESS) &&
	    ((reg_val & I40E_SR_CONTROL_WORD_1_MASK) ==
	     BIT(I40E_SR_CONTROL_WORD_1_SHIFT)))
		return i40e_validate_lwm_checksum(hw, NULL);
	else
		return I40E_ERR_DIAG_TEST_FAILED;
}
