...
enum i40e_admin_queue_err {
	...
	I40E_AQ_RC_EILWAL	= 14, /* Invalid argument */
...
enum i40e_admin_queue_opc {
	...
	i40e_aqc_opc_set_vsi_promislwous_modes	= 0x0254,
	...
	/* LWM commands */
	i40e_aqc_opc_lwm_read			= 0x0701,
	i40e_aqc_opc_lwm_erase			= 0x0702,
	i40e_aqc_opc_lwm_update			= 0x0703,
	i40e_aqc_opc_lwm_config_read		= 0x0704,
	i40e_aqc_opc_lwm_config_write		= 0x0705,
	i40e_aqc_opc_lwm_update_in_process	= 0x0706,
 ...
 */
#define I40E_AQ_RESOURCE_LWM			1
#define I40E_AQ_RESOURCE_SDP			2
#define I40E_AQ_RESOURCE_ACCESS_READ		1
#define I40E_AQ_RESOURCE_ACCESS_WRITE		2
#define I40E_AQ_RESOURCE_LWM_READ_TIMEOUT	3000
#define I40E_AQ_RESOURCE_LWM_WRITE_TIMEOUT	180000
...
#define I40E_AQ_CAP_ID_LWM_MGMT		0x0080
...
#define I40E_AQ_VSI_PROP_SELWRITY_VALID		0x0002
...
#define I40E_AQ_VSI_QUE_OPT_RSS_LUT_VSI	0x40
	...
	__le16	qs_handle[8];
#define I40E_AQ_VSI_QS_HANDLE_ILWALID	0xFFFF
...
/* Set VSI Promislwous Modes (direct 0x0254) */
struct i40e_aqc_set_vsi_promislwous_modes {
	__le16	promislwous_flags;
	__le16	valid_flags;
...
I40E_CHECK_CMD_LENGTH(i40e_aqc_set_vsi_promislwous_modes);
...
#define I40E_AQC_ADD_CLOUD_TNL_TYPE_LWGRE_OMAC		1
...
enum i40e_aq_phy_type {
	...
	I40E_PHY_TYPE_40GBASE_CR4_LW		= 0xA,
	I40E_PHY_TYPE_10GBASE_CR1_LW		= 0xB,
	...
	I40E_PHY_TYPE_10GBASE_SFPP_LW		= 0x16,
...
#define I40E_PHY_TYPES_BITMASK (BIT_ULL(I40E_PHY_TYPE_SGMII) | \
				...
				BIT_ULL(I40E_PHY_TYPE_40GBASE_CR4_LW) | \
				BIT_ULL(I40E_PHY_TYPE_10GBASE_CR1_LW) | \
				...
				BIT_ULL(I40E_PHY_TYPE_10GBASE_SFPP_LW) | \
...
#define I40E_AQ_25G_LWM_CRC_ERR		0X02
 ...
 * LWM Update commands (indirect 0x0703)
 */
struct i40e_aqc_lwm_update {
	u8	command_flags;
#define I40E_AQ_LWM_LAST_CMD			0x01
#define I40E_AQ_LWM_REARRANGE_TO_FLAT		0x20
#define I40E_AQ_LWM_REARRANGE_TO_STRUCT		0x40
#define I40E_AQ_LWM_FLASH_ONLY			0x80
#define I40E_AQ_LWM_PRESERVATION_FLAGS_SHIFT	1
#define I40E_AQ_LWM_PRESERVATION_FLAGS_MASK	0x03
#define I40E_AQ_LWM_PRESERVATION_FLAGS_SELECTED	0x03
#define I40E_AQ_LWM_PRESERVATION_FLAGS_ALL	0x01
	u8	module_pointer;
	__le16	length;
	__le32	offset;
	__le32	addr_high;
...
I40E_CHECK_CMD_LENGTH(i40e_aqc_lwm_update);

/* LWM Config Read (indirect 0x0704) */
struct i40e_aqc_lwm_config_read {
	__le16	cmd_flags;
#define I40E_AQ_ALWM_SINGLE_OR_MULTIPLE_FEATURES_MASK	1
#define I40E_AQ_ALWM_READ_SINGLE_FEATURE		0
#define I40E_AQ_ALWM_READ_MULTIPLE_FEATURES		1
...
I40E_CHECK_CMD_LENGTH(i40e_aqc_lwm_config_read);

/* LWM Config Write (indirect 0x0705) */
struct i40e_aqc_lwm_config_write {
	__le16	cmd_flags;
	__le16	element_count;
	u8	reserved[4];
	__le32	address_high;
...
I40E_CHECK_CMD_LENGTH(i40e_aqc_lwm_config_write);

/* Used for 0x0704 as well as for 0x0705 commands */
#define I40E_AQ_ALWM_FEATURE_OR_IMMEDIATE_SHIFT		1
#define I40E_AQ_ALWM_FEATURE_OR_IMMEDIATE_MASK \
				(1 << I40E_AQ_ALWM_FEATURE_OR_IMMEDIATE_SHIFT)
#define I40E_AQ_ALWM_FEATURE		0
#define I40E_AQ_ALWM_IMMEDIATE_FIELD	(1 << FEATURE_OR_IMMEDIATE_SHIFT)
struct i40e_aqc_lwm_config_data_feature {
	__le16 feature_id;
#define I40E_AQ_ALWM_FEATURE_OPTION_OEM_ONLY		0x01
#define I40E_AQ_ALWM_FEATURE_OPTION_DWORD_MAP		0x08
#define I40E_AQ_ALWM_FEATURE_OPTION_POR_CSR		0x10
	__le16 feature_options;
	__le16 feature_selection;
};

I40E_CHECK_STRUCT_LEN(0x6, i40e_aqc_lwm_config_data_feature);

/* LWM Update in Process (direct 0x0706) */
struct i40e_aqc_lwm_update_in_process {
	u8	command;
...
I40E_CHECK_CMD_LENGTH(i40e_aqc_lwm_update_in_process);

struct i40e_aqc_lwm_config_data_immediate_field {
	__le32 field_id;
	__le32 field_value;
...
I40E_CHECK_STRUCT_LEN(0xc, i40e_aqc_lwm_config_data_immediate_field);
 ...
 */
struct i40e_aqc_lwm_oem_post_update {
#define I40E_AQ_LWM_OEM_POST_UPDATE_EXTERNAL_DATA	0x01
	u8 sel_data;
	u8 reserved[7];
};

I40E_CHECK_STRUCT_LEN(0x8, i40e_aqc_lwm_oem_post_update);

struct i40e_aqc_lwm_oem_post_update_buffer {
	u8 str_len;
	u8 dev_addr;
	__le16 eeprom_addr;
	u8 data[36];
...
I40E_CHECK_STRUCT_LEN(0x28, i40e_aqc_lwm_oem_post_update_buffer);
