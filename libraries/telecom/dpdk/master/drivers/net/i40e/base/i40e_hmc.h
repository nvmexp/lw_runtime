...
/**
 * I40E_ILWALIDATE_PF_HMC_PD - Ilwalidates the pd cache in the hardware
 * @hw: pointer to our hw struct
 * @sd_idx: segment descriptor index
 * @pd_idx: page descriptor index
 **/
#define I40E_ILWALIDATE_PF_HMC_PD(hw, sd_idx, pd_idx)			\
	wr32((hw), I40E_PFHMC_PDILW,					\
	    (((sd_idx) << I40E_PFHMC_PDILW_PMSDIDX_SHIFT) |		\
	     ((pd_idx) << I40E_PFHMC_PDILW_PMPDIDX_SHIFT)))
 ...
 *
 * This function callwlates the segment descriptor index and index limit
 ...
 *
 * Callwlates the page descriptor index and index limit for the resource
