...
/* prototype for functions used for LWM access */
...
enum i40e_status_code i40e_read_lwm_buffer(struct i40e_hw *hw, u16 offset,
					   u16 *words, u16 *data);
enum i40e_status_code i40e_write_lwm_aq(struct i40e_hw *hw, u8 module,
					u32 offset, u16 words, void *data,
					bool last_command);
enum i40e_status_code __i40e_read_lwm_word(struct i40e_hw *hw, u16 offset,
					   u16 *data);
enum i40e_status_code __i40e_read_lwm_buffer(struct i40e_hw *hw, u16 offset,
					     u16 *words, u16 *data);
enum i40e_status_code __i40e_write_lwm_word(struct i40e_hw *hw, u32 offset,
					  void *data);
enum i40e_status_code __i40e_write_lwm_buffer(struct i40e_hw *hw, u8 module,
					    u32 offset, u16 words, void *data);
...
#ifdef PF_DRIVER
/**
 * i40e_virtchnl_link_speed - Colwert AdminQ link_speed to virtchnl definition
 * @link_speed: the speed to colwert
 *
 * Returns the link_speed in terms of the virtchnl interface, for use in
 * colwerting link_speed as reported by the AdminQ into the format used for
...
/* Colwenience wrappers for most common use case */
