...
static int
i40e_vf_representor_promislwous_enable(struct rte_eth_dev *ethdev)
{
	struct i40e_vf_representor *representor = ethdev->data->dev_private;
...
static int
i40e_vf_representor_promislwous_disable(struct rte_eth_dev *ethdev)
{
	struct i40e_vf_representor *representor = ethdev->data->dev_private;
...
static const struct eth_dev_ops i40e_representor_dev_ops = {
	...
	.promislwous_enable   = i40e_vf_representor_promislwous_enable,
	.promislwous_disable  = i40e_vf_representor_promislwous_disable,
