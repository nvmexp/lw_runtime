...
struct ena_admin_get_set_feature_common_desc {
	 ...
	 *    device responds with the lwrrently supported feature version. The
	 *    field is zero based
	 */
...
struct ena_admin_feature_llq_desc {
	 ...
	 *    entries oclwpied by descriptors. This parameter defines the max
