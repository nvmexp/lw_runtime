...
struct ena_com_io_cq {
	...
	u16 lwr_rx_pkt_cdesc_count;
	/* save the firt cdesc idx of the current packet */
	u16 lwr_rx_pkt_cdesc_start_idx;
 ...
 * If polling mode is on, ena_com_exelwte_admin_command will perform a
...
/* ena_com_get_lwrrent_hash_function - Get RSS hash function
 * @ena_dev: ENA communication layer struct
 *
...
/* ena_com_exelwte_admin_command - Execute admin command
