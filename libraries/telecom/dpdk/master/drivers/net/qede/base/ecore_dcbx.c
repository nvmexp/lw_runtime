...
#define ECORE_DCBX_ILWALID_PRIORITY	0xFF
...
/*
 * Read updated MIB.
 * Reconfigure QM and ilwoke PF update ramrod command if operational MIB
 * change is detected.
 */
					     ...
					     u8 tlv_type)
{
	...
	case ECORE_LLDP_NEAREST_NON_TPMR_BRIDGE:
		...
		break;
	case ECORE_LLDP_NEAREST_LWSTOMER_BRIDGE:
		val = LLDP_NEAREST_LWSTOMER_BRIDGE;
		break;
	default:
