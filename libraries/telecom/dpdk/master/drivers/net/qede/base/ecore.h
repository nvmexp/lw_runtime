...
enum ecore_lwm_cmd {
	ECORE_PUT_FILE_BEGIN = DRV_MSG_CODE_LWM_PUT_FILE_BEGIN,
	ECORE_PUT_FILE_DATA = DRV_MSG_CODE_LWM_PUT_FILE_DATA,
	ECORE_LWM_READ_LWRAM = DRV_MSG_CODE_LWM_READ_LWRAM,
	ECORE_LWM_WRITE_LWRAM = DRV_MSG_CODE_LWM_WRITE_LWRAM,
	ECORE_LWM_DEL_FILE = DRV_MSG_CODE_LWM_DEL_FILE,
	ECORE_EXT_PHY_FW_UPGRADE = DRV_MSG_CODE_EXT_PHY_FW_UPGRADE,
	ECORE_LWM_SET_SELWRE_MODE = DRV_MSG_CODE_SET_SELWRE_MODE,
	...
	ECORE_GET_MCP_LWM_RESP = 0xFFFFFF00
};
...
struct ecore_lwm_image_info {
	u32				num_images;
	struct bist_lwm_image_att	*image_att;
	bool				valid;
};
...
#define ECORE_PATH_ID(_p_hwfn) \
	...
	/* Lwm images number and attributes */
...
/* The PFID<->PPFID callwlation is based on the relative index of a PF on its
