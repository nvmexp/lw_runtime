...
/* header of first vf->pf tlv carries the offset used to callwlate response
 * buffer address
 */
...
#define VFPF_ACQUIRE_CAP_100G		(1 << 1) /* VF can support 100g */
	 ...
	 * references.
	 * TODO - due to the CID limitations in Bar0, VFs lwrrently don't pass
