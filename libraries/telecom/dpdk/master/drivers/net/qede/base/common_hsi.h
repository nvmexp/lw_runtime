...
#define DQ_UCM_LWMF_NEW_CQE_CF_CMD          (1 << DQ_UCM_AGG_FLG_SHIFT_CF1)
...
#define PXP_BAR0_FIRST_ILWALID_ADDRESS          \
	(PXP_BAR0_END_PSDM + 1)
...
#define DB_RDMA_24B_ICID_DPM_PARAMS_ILW_BYTE_CNT_MASK        0x7
#define DB_RDMA_24B_ICID_DPM_PARAMS_ILW_BYTE_CNT_SHIFT       24
...
/* Set if L4 checksum was callwlated. */
#define PARSING_AND_ERR_FLAGS_L4CHKSMWASCALLWLATED_MASK        0x1
#define PARSING_AND_ERR_FLAGS_L4CHKSMWASCALLWLATED_SHIFT       6
/* Set for PTP packet. */
...
/* Set if GRE or VXLAN/GENEVE UDP checksum was callwlated. */
#define PARSING_AND_ERR_FLAGS_TUNNELL4CHKSMWASCALLWLATED_MASK  0x1
#define PARSING_AND_ERR_FLAGS_TUNNELL4CHKSMWASCALLWLATED_SHIFT 14
...
/* cksm callwlated and value isn't 0xffff or L4-cksm-wasnt-callwlated for any
...
#define TIMERS_CONTEXT_HOSTEXPRIRATIOLWALUE_MASK  0x7FFFFFF
#define TIMERS_CONTEXT_HOSTEXPRIRATIOLWALUE_SHIFT 0
#define TIMERS_CONTEXT_RESERVED6_MASK             0x1
#define TIMERS_CONTEXT_RESERVED6_SHIFT            27
/* Valid bit of host expiration */
#define TIMERS_CONTEXT_HOSTEXPRIRATIOLWALID_MASK  0x1
#define TIMERS_CONTEXT_HOSTEXPRIRATIOLWALID_SHIFT 28
