 ...
 *	- the bundle ID in LWRAM is invalid
 *	- the trace meta data cannot be found (in LWRAM or image file)
 * Otherwise, returns ok.
 */
 ...
 *	- the bundle ID in LWRAM is invalid
 *	- the trace meta data cannot be found (in LWRAM or image file)
 *	- the trace meta data cannot be read (from LWRAM or image file)
 * Otherwise, returns ok.
 */
