 ...
 * (i.e. lwrrently sysconf(_SC_PAGESIZE)).
 *
 * @param[in] size
...
static const struct eth_dev_ops mlx4_dev_ops = {
	...
	.promislwous_enable = mlx4_promislwous_enable,
	.promislwous_disable = mlx4_promislwous_disable,
...
RTE_INIT(rte_mlx4_pmd_init)
{
	 ...
	 */
	setelw("MLX4_DEVICE_FATAL_CLEANUP", "1", 1);
	/*
	 ...
	 */
	setelw("RDMAV_HUGEPAGES_SAFE", "1", 1);
#ifdef RTE_IBVERBS_LINK_DLOPEN
	if (mlx4_glue_init())
		return;
