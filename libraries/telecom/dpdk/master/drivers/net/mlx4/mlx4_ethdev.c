...
/**
 * Helper function to toggle promislwous and all multicast modes.
 *
 * @param dev
 *   Pointer to Ethernet device structure.
 * @param toggle
 ...
 */
int
mlx4_promislwous_enable(struct rte_eth_dev *dev)
{
 ...
 */
int
mlx4_promislwous_disable(struct rte_eth_dev *dev)
{
...
mlx4_dev_infos_get(struct rte_eth_dev *dev, struct rte_eth_dev_info *info)
{
	...
	info->speed_capa =
			...
			ETH_LINK_SPEED_40G |
			ETH_LINK_SPEED_56G;
	info->flow_type_rss_offloads = mlx4_colw_rss_types(priv, 0, 1);
