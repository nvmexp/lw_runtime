...
nicvf_single_pool_free_xmited_buffers(struct nicvf_txq *sq)
{
	...
	lwrr_head = nicvf_addr_read(sq->sq_head) >> 4;
	while (head != lwrr_head) {
		if (txbuffs[head])
...
static const uint32_t ptype_table[16][16] __rte_cache_aligned = {
	...
	[L3_NONE][L4_LWGRE] = RTE_PTYPE_TUNNEL_LWGRE,
	...
	[L3_IPV4][L4_LWGRE] = RTE_PTYPE_L3_IPV4 | RTE_PTYPE_TUNNEL_LWGRE,
	...
	[L3_IPV4_OPT][L4_LWGRE] = RTE_PTYPE_L3_IPV4_EXT |
	...
	[L3_IPV6][L4_LWGRE] = RTE_PTYPE_L3_IPV6 | RTE_PTYPE_TUNNEL_LWGRE,
	...
	[L3_IPV6_OPT][L4_UDP_VXLAN] = RTE_PTYPE_L3_IPV6_EXT |
					RTE_PTYPE_TUNNEL_VXLAN,
	[L3_IPV6_OPT][L4_LWGRE] = RTE_PTYPE_L3_IPV6_EXT |
					RTE_PTYPE_TUNNEL_LWGRE,
	...
	[L3_ET_STOP][L4_LWGRE] = RTE_PTYPE_TUNNEL_LWGRE,
	...
	[L3_OTHER][L4_LWGRE] = RTE_PTYPE_TUNNEL_LWGRE,
};
