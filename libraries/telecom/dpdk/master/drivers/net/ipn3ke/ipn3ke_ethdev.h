...
/**
 * Strulwte to store private data for each representor instance
 */
struct ipn3ke_rpst {
...
/**
 * @internal
 * Helper macro for drivers that need to colwert to struct rte_afu_device.
 */
...
int
ipn3ke_rpst_promislwous_enable(struct rte_eth_dev *ethdev);
int
ipn3ke_rpst_promislwous_disable(struct rte_eth_dev *ethdev);
int
