 ...
 * MAC address. This affects both unicast and multicast. Promislwous mode can
 * still be enabled/disabled for both unicast and multicast. If promislwous mode
 ...
 */
#define DPNI_OPT_LWSTOM_CG				0x000200
 ...
 *		only if the DPNI is created with  DPNI_OPT_LWSTOM_CG option
 */
 ...
 *		performing WRED and tail drop callwlations and threshold
 *		comparisons.
 */
...
/**
 * struct dpni_lwstom_tpid_cfg - custom TPID configuration. Contains custom TPID
