...
struct dpni_drv_sparser_param {
	/* The "lwstom_header_first" must be set if the custom header to parse
	 * is the first header in the packet, otherwise "lwstom_header_first"
	 * must be cleared.
	 */
	uint8_t             lwstom_header_first;
