	...
	const struct rte_eth_txconf *tx_conf)
{
	...
	/* Pass vf not pf because of cq index callwlation. See enic_alloc_wq */
...
static int enic_vf_promislwous_enable(struct rte_eth_dev *eth_dev)
{
	struct enic_vf_representor *vf;
...
static int enic_vf_promislwous_disable(struct rte_eth_dev *eth_dev)
{
	struct enic_vf_representor *vf;
...
static const struct eth_dev_ops enic_vf_representor_dev_ops = {
	...
	.promislwous_enable   = enic_vf_promislwous_enable,
	.promislwous_disable  = enic_vf_promislwous_disable,
...
int enic_vf_representor_init(struct rte_eth_dev *eth_dev, void *init_params)
{
	 ...
	 * allocator API instead of index number callwlations used throughout
	 * the driver..
	 */
	...
	/*
	 * Callwlate VF BDF. The firmware ensures that PF BDF is always
