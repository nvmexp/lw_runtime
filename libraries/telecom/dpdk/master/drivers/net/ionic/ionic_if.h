...
enum ionic_status_code {
	...
	IONIC_RC_EILWAL		= 14,	/* Invalid argument */
 ...
 *                      callwlation/insertion.  The device will
 *                      callwlate the L4 checksum value and
 *                      insert the result in the packet's L4
 *                      header checksum field.  The L4 checksum
 *                      is callwlated starting at @csum_start bytes
 ...
 *                      pseudo-header to seed the callwlation.
 ...
 *                      callwlate the outer header checksums.  If
 ...
 *                      segment.  The device will callwlate/
 ...
 *                      pseudo header callwlated with IP length = 0.
 *
 ...
 *                encap:
 *                    Callwlate encap header checksum.
 *                csum_l3:
 ...
 *                zero-value byte is included in the @csum callwlation but
 *                not included in @len.
 ...
 * @csum_tcp_ok:  The TCP checksum callwlated by the device
 *                matched the checksum in the receive packet's
 *                TCP header
 * @csum_tcp_bad: The TCP checksum callwlated by the device did
 *                not match the checksum in the receive packet's
 *                TCP header.
 * @csum_udp_ok:  The UDP checksum callwlated by the device
 *                matched the checksum in the receive packet's
 *                UDP header
 * @csum_udp_bad: The UDP checksum callwlated by the device did
 *                not match the checksum in the receive packet's
 *                UDP header.
 * @csum_ip_ok:   The IPv4 checksum callwlated by the device
 *                matched the checksum in the receive packet's
 *                first IPv4 header.  If the receive packet
 *                contains both a tunnel IPv4 header and a
 *                transport IPv4 header, the device validates the
 *                checksum for the both IPv4 headers.
 * @csum_ip_bad:  The IPv4 checksum callwlated by the device did
 *                not match the checksum in the receive packet's
 *                first IPv4 header. If the receive packet
 *                contains both a tunnel IPv4 header and a
 *                transport IPv4 header, the device validates the
...
enum ionic_xcvr_pid {
	...
	IONIC_XCVR_PID_SFP_10GBASE_LW   = 68,
...
struct ionic_lif_stats {
	...
	__le64 rdma_req_rx_remote_ilw_req_err;
	...
	__le64 rdma_req_rx_ilwalid_packets;
