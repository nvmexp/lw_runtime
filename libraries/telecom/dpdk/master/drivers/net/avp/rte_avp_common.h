...
struct rte_avp_fifo {
	...
	unsigned int len; /**< Cirlwlar buffer length */
...
#define RTE_AVP_MIGRATION_NONE      0 /**< Migration never exelwted */
 ...
 */
#define RTE_AVP_LWRRENT_HOST_VERSION \
 ...
 */
#define RTE_AVP_LWRRENT_GUEST_VERSION \
RTE_AVP_MAKE_VERSION(RTE_AVP_RELEASE_VERSION_1, \
