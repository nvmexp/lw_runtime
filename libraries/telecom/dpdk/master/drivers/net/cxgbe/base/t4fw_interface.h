...
enum fw_retval {
	...
	FW_ENOEXEC		= 8,	/* exec format error; ilw microcode */
...
#define S_FW_PFVF_CMD_LWI               16
#define M_FW_PFVF_CMD_LWI               0xff
#define G_FW_PFVF_CMD_LWI(x)            \
	(((x) >> S_FW_PFVF_CMD_LWI) & M_FW_PFVF_CMD_LWI)
