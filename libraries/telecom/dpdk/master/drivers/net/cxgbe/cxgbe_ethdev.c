...
int cxgbe_dev_promislwous_enable(struct rte_eth_dev *eth_dev)
{
	struct port_info *pi = eth_dev->data->dev_private;
	struct adapter *adapter = pi->adapter;
...
int cxgbe_dev_promislwous_disable(struct rte_eth_dev *eth_dev)
{
	struct port_info *pi = eth_dev->data->dev_private;
	struct adapter *adapter = pi->adapter;
...
static const struct eth_dev_ops cxgbe_eth_dev_ops = {
	...
	.promislwous_enable	= cxgbe_dev_promislwous_enable,
	.promislwous_disable	= cxgbe_dev_promislwous_disable,
