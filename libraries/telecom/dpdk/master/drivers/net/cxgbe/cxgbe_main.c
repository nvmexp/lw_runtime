...
static int adap_init0(struct adapter *adap)
{
	 ...
	 * in order to know how to colwert core ticks to seconds, etc.
	 */
 ...
 * ilwoked when a port module is removed or inserted for any OS-specific
 * processing.
 */
...
int cxgbe_link_start(struct port_info *pi)
{
	...
	/*
	 * We do not set address filters and promislwity here, the stack does
