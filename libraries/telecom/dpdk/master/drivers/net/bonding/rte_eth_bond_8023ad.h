 ...
 * @return
 *   0 - if ok
 *   -EILWAL if configuration is invalid.
 */
int
 ...
 * @return
 *   0 - if ok
 *   -EILWAL if conf is NULL or slave id is invalid (not a slave of given
