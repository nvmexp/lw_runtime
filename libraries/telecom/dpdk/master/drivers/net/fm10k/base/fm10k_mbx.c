...
/**
 *  fm10k_mbx_index_len - Colwert a head/tail index into a length value
 ...
 *  @mbx: pointer to mailbox
 *
 *  This function will return the length of the message lwrrently being
 ...
 *  value ilwerts the local seed and the result in order to capture all
 ...
 *  drop all messages, as this is too diffilwlt to parse and remove them from
...
STATIC s32 fm10k_sm_mbx_receive(struct fm10k_hw *hw,
				...
				u16 tail)
{
	/* reduce length by 1 to colwert to a mask */
