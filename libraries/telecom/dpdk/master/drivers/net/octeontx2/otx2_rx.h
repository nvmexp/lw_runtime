...
#define NIX_RX_OFFLOAD_SELWRITY_F      BIT(6)

/* Flags to control cqe_to_mbuf colwersion function.
		       ...
		       const void * const lookup_mem)
{
	...
	*rte_selwrity_dynfield(m) = sa->udata64;
		     ...
		     const uint64_t val, const uint16_t flag)
{
	...
	if ((flag & NIX_RX_OFFLOAD_SELWRITY_F) &&
...
#define RX_SEC_F   NIX_RX_OFFLOAD_SELWRITY_F
