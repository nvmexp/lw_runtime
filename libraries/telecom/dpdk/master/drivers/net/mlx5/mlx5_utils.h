...
/* Colwert a bit number to the corresponding 64-bit mask */
...
/* Colwenience macros for accessing mbuf fields. */
...
/* Transpose flags. Useful to colwert IBV to DPDK flags. */
 ...
 *
 * The lwrrently implementation introduces 10-10-12 32-bits splitting
...
#define TRUNK_ILWALID TRUNK_MAX_IDX
 ...
 * cleanup / free. Key of each entry will be callwlated with CRC in order to
 ...
 * give a callwlated hash signature and guarantee there is no collision.
 *
 * @param h
 *   Pointer to the hast list table.
 * @param entry
