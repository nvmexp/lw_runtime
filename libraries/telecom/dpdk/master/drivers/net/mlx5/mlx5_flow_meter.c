 ...
 * @param[in] fm
 *   Pointer to flow meter to be colwerted.
 *
 * @return
				 ...
				 struct rte_mtr_error *error)
{
	...
	if (profile == NULL)
		return -rte_mtr_error_set(error, EILWAL,
...
/**
 * Callwlate mantissa and exponent for cir.
 *
 * @param[in] cir
 *   Value to be callwlated.
 * @param[out] man
...
/**
 * Callwlate mantissa and exponent for xbs.
 *
 * @param[in] xbs
 *   Value to be callwlated.
 * @param[out] man
 ...
 *
 * @param[in,out] fmp
 *   Pointer to meter profie to be colwerted.
 * @param[out] error
 *   Pointer to the error structure.
 *
 * @return
...
/**
 * Colwert wrong color setting action to verbose error.
 *
 * @param[in] action
 *   Policy color action.
 *
