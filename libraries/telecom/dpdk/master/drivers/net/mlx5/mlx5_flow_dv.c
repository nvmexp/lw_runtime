...
/**
 * Colwert rte_mtr_color to mlx5 color.
 *
 * @param[in] rcol
 *   rte_mtr_color.
 *
 ...
 *
 * @return
 *   colwerted field in host endian format.
 */
...
/**
 * Colwert modify-header action to DV specification.
 *
 ...
 */
static int
flow_dv_colwert_modify_action(struct rte_flow_item *item,
			      ...
			      uint32_t type, struct rte_flow_error *error)
{
	...
	do {
		...
		/* Colwert entire record to expected big-endian format. */
		...
		if (type == MLX5_MODIFICATION_TYPE_COPY) {
			...
			/* Colwert entire record to big-endian format. */
...
/**
 * Colwert modify-header set IPv4 address action to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_modify_ipv4
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 ...
			 struct rte_flow_error *error)
{
	...
	item.spec = &ipv4;
	item.mask = &ipv4_mask;
	return flow_dv_colwert_modify_action(&item, modify_ipv4, NULL, resource,
					     MLX5_MODIFICATION_TYPE_SET, error);
}

/**
 * Colwert modify-header set IPv6 address action to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_modify_ipv6
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 struct rte_flow_error *error)
{
	...
	item.spec = &ipv6;
	item.mask = &ipv6_mask;
	return flow_dv_colwert_modify_action(&item, modify_ipv6, NULL, resource,
					     MLX5_MODIFICATION_TYPE_SET, error);
}

/**
 * Colwert modify-header set MAC address action to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_modify_mac
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 struct rte_flow_error *error)
{
	...
	item.spec = &eth;
	item.mask = &eth_mask;
	return flow_dv_colwert_modify_action(&item, modify_eth, NULL, resource,
					     MLX5_MODIFICATION_TYPE_SET, error);
}

/**
 * Colwert modify-header set VLAN VID action to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_modify_vlan_vid
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 struct rte_flow_error *error)
{
...
/**
 * Colwert modify-header set TP action to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_modify_tp
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 ...
			 bool tunnel_decap, struct rte_flow_error *error)
{
	...
	return flow_dv_colwert_modify_action(&item, field, NULL, resource,
					     MLX5_MODIFICATION_TYPE_SET, error);
}

/**
 * Colwert modify-header set TTL action to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_modify_ttl
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 const struct rte_flow_item *items,
			 union flow_dv_attr *attr, struct mlx5_flow *dev_flow,
...
/**
 * Colwert modify-header decrement TTL action to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_modify_dec_ttl
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_item *items,
			 union flow_dv_attr *attr, struct mlx5_flow *dev_flow,
			 bool tunnel_decap, struct rte_flow_error *error)
...
/**
 * Colwert modify-header increment/decrement TCP Sequence number
 * to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 ...
 */
static int
flow_dv_colwert_action_modify_tcp_seq
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 struct rte_flow_error *error)
{
	...
	item.spec = &tcp;
	item.mask = &tcp_mask;
	return flow_dv_colwert_modify_action(&item, modify_tcp, NULL, resource,
					     MLX5_MODIFICATION_TYPE_ADD, error);
}

/**
 * Colwert modify-header increment/decrement TCP Acknowledgment number
 * to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 ...
 */
static int
flow_dv_colwert_action_modify_tcp_ack
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 struct rte_flow_error *error)
{
...
/**
 * Colwert register set to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_set_reg
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 struct rte_flow_error *error)
{
...
/**
 * Colwert SET_TAG action to DV specification.
 *
 * @param[in] dev
 ...
 */
static int
flow_dv_colwert_action_set_tag
			 ...
			 struct rte_flow_error *error)
{
	...
	return flow_dv_colwert_modify_action(&item, reg_c_x, NULL, resource,
					     MLX5_MODIFICATION_TYPE_SET, error);
}

/**
 * Colwert internal COPY_REG action to DV specification.
 *
 * @param[in] dev
 *   Pointer to the rte_eth_dev structure.
 * @param[in,out] res
 ...
 */
static int
flow_dv_colwert_action_copy_mreg(struct rte_eth_dev *dev,
				 ...
				 struct rte_flow_error *error)
{
	...
	if (conf->dst == REG_C_0 || conf->src == REG_C_0) {
		...
		if (conf->dst == REG_C_0) {
			 ...
			 * there is no colwersion in datapath.
			 */
	...
	return flow_dv_colwert_modify_action(&item,
					     reg_src, &reg_dst, res,
...
/**
 * Colwert MARK action to DV specification. This routine is used
 ...
 */
static int
flow_dv_colwert_action_mark(struct rte_eth_dev *dev,
...
/**
 * Colwert SET_META action to DV specification.
 *
 * @param[in] dev
 *   Pointer to the rte_eth_dev structure.
 * @param[in,out] resource
 ...
 */
static int
flow_dv_colwert_action_set_meta
			(struct rte_eth_dev *dev,
			 struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_attr *attr,
			 ...
			 struct rte_flow_error *error)
{
	 ...
	 * pattern colwersions are done in rte_flow.
	 */
	if (reg == REG_C_0) {
		struct mlx5_priv *priv = dev->data->dev_private;
		uint32_t msk_c0 = priv->sh->dv_regc0_mask;
...
/**
 * Colwert modify-header set IPv4 DSCP action to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_modify_ipv4_dscp
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 struct rte_flow_error *error)
{
...
/**
 * Colwert modify-header set IPv6 DSCP action to DV specification.
 *
 * @param[in,out] resource
 *   Pointer to the modify-header resource.
 * @param[in] action
 ...
 */
static int
flow_dv_colwert_action_modify_ipv6_dscp
			(struct mlx5_flow_dv_modify_hdr_resource *resource,
			 const struct rte_flow_action *action,
			 struct rte_flow_error *error)
{
...
/**
 * Colwert the encap action data from list of rte_flow_item to raw buffer
 *
 * @param[in] items
 *   Pointer to rte_flow_item objects list.
 * @param[out] buf
 ...
 */
static int
flow_dv_colwert_encap_data(const struct rte_flow_item *items, uint8_t *buf,
...
flow_dv_zero_encap_udp_csum(void *data, struct rte_flow_error *error)
{
	...
	/* HW callwlates IPv4 csum. no need to proceed */
...
/**
 * Colwert L2 encap action to DV specification.
 *
 * @param[in] dev
 *   Pointer to rte_eth_dev structure.
 * @param[in] action
			       ...
			       struct rte_flow_error *error)
{
	...
	if (action->type == RTE_FLOW_ACTION_TYPE_RAW_ENCAP) {
		...
		if (action->type == RTE_FLOW_ACTION_TYPE_VXLAN_ENCAP)
			...
			encap_data =
				((const struct rte_flow_action_lwgre_encap *)
						action->conf)->definition;
		if (flow_dv_colwert_encap_data(encap_data, res.buf,
					       &res.size, error))
			return -rte_errno;
	}
...
/**
 * Colwert L2 decap action to DV specification.
 *
 * @param[in] dev
 *   Pointer to rte_eth_dev structure.
 * @param[in, out] dev_flow
...
/**
 * Colwert raw decap/encap (L3 tunnel) action to DV specification.
 *
 * @param[in] dev
 *   Pointer to rte_eth_dev structure.
 * @param[in] action
...
flow_dv_find_pool_by_id(struct mlx5_flow_counter_mng *cmng, int id)
{
	...
	if (cmng->last_pool_idx != POOL_IDX_ILWALID &&
		    ...
		    uint32_t age)
{
	...
	pool->time_of_last_age_check = MLX5_LWRR_TIME_SEC;
	rte_spinlock_lock(&cmng->pool_update_sl);
...
flow_dv_counter_free(struct rte_eth_dev *dev, uint32_t counter)
{
	 ...
	 * Lwrrently, we are using two list alternately, while one is in query,
			    ...
			    struct rte_flow_error *error)
{
	...
	if (attributes->transfer) {
		...
		if (!(priv->representor || priv->master))
			return rte_flow_error_set
				(error, EILWAL, RTE_FLOW_ERROR_TYPE_UNSPECIFIED,
		 ...
		 bool external, int hairpin, struct rte_flow_error *error)
{
	...
	for (; items->type != RTE_FLOW_ITEM_TYPE_END; items++) {
		...
		case RTE_FLOW_ITEM_TYPE_GRE:
			...
			break;
		case RTE_FLOW_ITEM_TYPE_LWGRE:
			ret = mlx5_flow_validate_item_lwgre(items, item_flags,
							    next_protocol,
							    error);
			if (ret < 0)
				return ret;
			last_item = MLX5_FLOW_LAYER_LWGRE;
			break;
	...
	for (; actions->type != RTE_FLOW_ACTION_TYPE_END; actions++) {
		...
		case RTE_FLOW_ACTION_TYPE_LWGRE_ENCAP:
		...
		case RTE_FLOW_ACTION_TYPE_LWGRE_DECAP:
		...
		case RTE_FLOW_ACTION_TYPE_SET_MAC_DST:
			 ...
			 * overlap in the header with 4B alignment, the colwert
...
/**
 * Add LWGRE item to matcher and to the value.
 *
 * @param[in, out] matcher
 *   Flow matcher.
 * @param[in, out] key
 ...
 */
static void
flow_dv_translate_item_lwgre(void *matcher, void *key,
			     const struct rte_flow_item *item,
			     int inner)
{
	const struct rte_flow_item_lwgre *lwgre_m = item->mask;
	const struct rte_flow_item_lwgre *lwgre_v = item->spec;
	void *misc_m = MLX5_ADDR_OF(fte_match_param, matcher, misc_parameters);
	void *misc_v = MLX5_ADDR_OF(fte_match_param, key, misc_parameters);
	...
	/* For LWGRE, GRE header fields must be set with defined values. */
	...
	if (!lwgre_v)
		return;
	if (!lwgre_m)
		lwgre_m = &rte_flow_item_lwgre_mask;
	tni_flow_id_m = (const char *)lwgre_m->tni;
	tni_flow_id_v = (const char *)lwgre_v->tni;
	size = sizeof(lwgre_m->tni) + sizeof(lwgre_m->flow_id);
...
/**
 * Callwlate flow matcher enable bitmap.
 *
			 ...
			 struct mlx5_cache_entry *entry, void *cb_ctx)
{
	...
	struct mlx5_flow_dv_matcher *lwr = container_of(entry, typeof(*lwr),
							entry);

	return lwr->crc != ref->crc ||
	       lwr->priority != ref->priority ||
	       memcmp((const void *)lwr->mask.buf,
...
/**
 * Colwert Sample action to DV specification.
 *
 * @param[in] dev
 *   Pointer to rte_eth_dev structure.
 * @param[in] action
		  ...
		  struct rte_flow_error *error)
{
	...
	for (; !actions_end ; actions++) {
		...
		case RTE_FLOW_ACTION_TYPE_FLAG:
			...
			if (dev_conf->dv_xmeta_en != MLX5_XMETA_MODE_LEGACY) {
				...
				if (flow_dv_colwert_action_mark(dev, &mark,
								mhdr_res,
								error))
					return -rte_errno;
		...
		case MLX5_RTE_FLOW_ACTION_TYPE_MARK:
			...
			break;
		case RTE_FLOW_ACTION_TYPE_SET_META:
			if (flow_dv_colwert_action_set_meta
				(dev, mhdr_res, attr,
			...
			break;
		case RTE_FLOW_ACTION_TYPE_SET_TAG:
			if (flow_dv_colwert_action_set_tag
				(dev, mhdr_res,
		...
		case RTE_FLOW_ACTION_TYPE_OF_SET_VLAN_VID:
			...
			if (flow_dv_colwert_action_modify_vlan_vid
		...
		case RTE_FLOW_ACTION_TYPE_SET_MAC_SRC:
		case RTE_FLOW_ACTION_TYPE_SET_MAC_DST:
			if (flow_dv_colwert_action_modify_mac
					(mhdr_res, actions, error))
				return -rte_errno;
			action_flags |= actions->type ==
					RTE_FLOW_ACTION_TYPE_SET_MAC_SRC ?
		...
		case RTE_FLOW_ACTION_TYPE_SET_IPV4_SRC:
		case RTE_FLOW_ACTION_TYPE_SET_IPV4_DST:
			if (flow_dv_colwert_action_modify_ipv4
					(mhdr_res, actions, error))
				return -rte_errno;
			action_flags |= actions->type ==
					RTE_FLOW_ACTION_TYPE_SET_IPV4_SRC ?
		...
		case RTE_FLOW_ACTION_TYPE_SET_IPV6_SRC:
		case RTE_FLOW_ACTION_TYPE_SET_IPV6_DST:
			if (flow_dv_colwert_action_modify_ipv6
					(mhdr_res, actions, error))
				return -rte_errno;
			action_flags |= actions->type ==
					RTE_FLOW_ACTION_TYPE_SET_IPV6_SRC ?
		...
		case RTE_FLOW_ACTION_TYPE_SET_TP_SRC:
		case RTE_FLOW_ACTION_TYPE_SET_TP_DST:
			if (flow_dv_colwert_action_modify_tp
			...
			break;
		case RTE_FLOW_ACTION_TYPE_DEC_TTL:
			if (flow_dv_colwert_action_modify_dec_ttl
			...
			break;
		case RTE_FLOW_ACTION_TYPE_SET_TTL:
			if (flow_dv_colwert_action_modify_ttl
		...
		case RTE_FLOW_ACTION_TYPE_INC_TCP_SEQ:
		case RTE_FLOW_ACTION_TYPE_DEC_TCP_SEQ:
			if (flow_dv_colwert_action_modify_tcp_seq
					(mhdr_res, actions, error))
				return -rte_errno;
			action_flags |= actions->type ==
					RTE_FLOW_ACTION_TYPE_INC_TCP_SEQ ?
		...
		case RTE_FLOW_ACTION_TYPE_INC_TCP_ACK:
		case RTE_FLOW_ACTION_TYPE_DEC_TCP_ACK:
			if (flow_dv_colwert_action_modify_tcp_ack
					(mhdr_res, actions, error))
				return -rte_errno;
			action_flags |= actions->type ==
					RTE_FLOW_ACTION_TYPE_INC_TCP_ACK ?
			...
			break;
		case MLX5_RTE_FLOW_ACTION_TYPE_TAG:
			if (flow_dv_colwert_action_set_reg
					(mhdr_res, actions, error))
				return -rte_errno;
			action_flags |= MLX5_FLOW_ACTION_SET_TAG;
			break;
		case MLX5_RTE_FLOW_ACTION_TYPE_COPY_MREG:
			if (flow_dv_colwert_action_copy_mreg
		...
		case RTE_FLOW_ACTION_TYPE_METER:
			...
			break;
		case RTE_FLOW_ACTION_TYPE_SET_IPV4_DSCP:
			if (flow_dv_colwert_action_modify_ipv4_dscp(mhdr_res,
							      actions, error))
				return -rte_errno;
			action_flags |= MLX5_FLOW_ACTION_SET_IPV4_DSCP;
			break;
		case RTE_FLOW_ACTION_TYPE_SET_IPV6_DSCP:
			if (flow_dv_colwert_action_modify_ipv6_dscp(mhdr_res,
							      actions, error))
				return -rte_errno;
			action_flags |= MLX5_FLOW_ACTION_SET_IPV6_DSCP;
			break;
	...
	for (; items->type != RTE_FLOW_ITEM_TYPE_END; items++) {
		...
		case RTE_FLOW_ITEM_TYPE_GRE_KEY:
			...
			break;
		case RTE_FLOW_ITEM_TYPE_LWGRE:
			flow_dv_translate_item_lwgre(match_mask, match_value,
						     items, tunnel);
			matcher.priority = MLX5_TUNNEL_PRIO_GET(rss_desc);
			last_item = MLX5_FLOW_LAYER_GRE;
			break;
 ...
 * @return
 *   0 on success, otherwise negative errno value.
 * @note: lwrrently only support update of RSS queues.
 */
static int
...
err:
	...
	if (flow) {
		...
		if (!matcher || (matcher && errno != EILWAL))
