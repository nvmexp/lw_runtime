...
#define MVNETA_COOKIE_ADDR_ILWALID ~0ULL
...
#define MVNETA_SET_COOKIE_HIGH_ADDR(addr) {				\
	if (unlikely(cookie_addr_high == MVNETA_COOKIE_ADDR_ILWALID))	\
		cookie_addr_high =					\
...
static uint64_t cookie_addr_high = MVNETA_COOKIE_ADDR_ILWALID;
