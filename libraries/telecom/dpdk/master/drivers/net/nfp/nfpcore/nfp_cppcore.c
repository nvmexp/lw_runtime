...
{
	if (!cpp)
		return NFP_CPP_INTERFACE(NFP_CPP_INTERFACE_TYPE_ILWALID, 0, 0);
			      ...
			      unsigned long size)
{
	 ...
	 * read or write modes, and that will set errno to EILWAL.
	 */
	tmp = errno;
