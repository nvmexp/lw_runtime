...
static void axgbe_callwlate_flow_control_threshold(struct axgbe_port *pdata)
{
	unsigned int q_fifo_size;
	unsigned int i;
...
static void axgbe_config_rx_fifo_size(struct axgbe_port *pdata)
{
	...
	/* Callwlate the fifo setting by dividing the queue's fifo size
	...
	/*Callwlate and config Flow control threshold*/
	axgbe_callwlate_flow_control_threshold(pdata);
