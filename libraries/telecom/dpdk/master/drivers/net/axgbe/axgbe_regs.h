...
static const uint32_t dma_txch_reg_tbl[] = {
	...
	DMA_CH_CATDR_LO,/* DMA LwrrApp TxDesc LAddr */
	DMA_CH_CATBR_HI,/* DMA LwrrApp TxBuf HAddr */
	DMA_CH_CATBR_LO,/* DMA LwrrApp TxBuf LAddr */
...
static const uint32_t dma_rxch_reg_tbl[] = {
	...
	DMA_CH_CARDR_LO,/* DMA LwrrApp RxDesc LAddr */
	DMA_CH_CARBR_HI,/* DMA LwrrApp RxBuf HAddr */
	DMA_CH_CARBR_LO,/* DMA LwrrApp RxBuf LAddr */
