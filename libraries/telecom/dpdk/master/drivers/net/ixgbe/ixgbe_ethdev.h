...
/* bit of LWGRE tunnel type | 7 bits of zeros  | 8 bits of zeros*/
#define IXGBE_FDIR_LWGRE_TUNNEL_TYPE    0x0
...
struct ixgbe_hw_fdir_info {
	...
	struct rte_hash *hash_handle; /* lwckoo hash handler */
...
uint32_t ixgbe_colwert_vm_rx_mask_to_val(uint16_t rx_mask, uint32_t orig_val);
