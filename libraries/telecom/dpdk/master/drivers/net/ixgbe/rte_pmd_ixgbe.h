 ...
 *   - (0) if successful.
 *   - (-ENODEV) if *port* invalid.
 *   - (-EILWAL) if *vf* or *mac_addr* is invalid.
 */
...
*    packets that match the PFUTA table, Broadcast and Multicast Promislwous.
 ...
 *
 * The bw_weight means the percentage oclwpied by the TC.
 ...
 * exelwting any other bypass API.
 *
 * @param port
 *   The port identifier of the Ethernet device.
 * @return
...
/**
 * Return bypass state when given event oclwrs.
 *
 * @param port
 *   The port identifier of the Ethernet device.
 * @param event
 ...
 * @param state
 *   The bypass state when given event oclwrred.
 *   - (1) Normal mode
 *   - (2) Bypass mode
 *   - (3) Isolate mode
 * @return
...
/**
 * Set bypass state when given event oclwrs.
 *
 * @param port
 *   The port identifier of the Ethernet device.
 * @param event
 ...
 *   - (5) Display or set the watchdog timer
 * @param state
 *   The assigned state when given event oclwrs.
 *   - (1) Normal mode
 *   - (2) Bypass mode
 *   - (3) Isolate mode
 * @return
...
/**
 * Data sent to the user application when the callback is exelwted.
 */
