		   ...
		   union ixgbe_tx_offload tx_offload)
{
	...
	if (likely((txq->ctx_cache[txq->ctx_lwrr].flags == flags) &&
		   (txq->ctx_cache[txq->ctx_lwrr].tx_offload.data[0] ==
		    (txq->ctx_cache[txq->ctx_lwrr].tx_offload_mask.data[0]
		     & tx_offload.data[0])) &&
		   (txq->ctx_cache[txq->ctx_lwrr].tx_offload.data[1] ==
		    (txq->ctx_cache[txq->ctx_lwrr].tx_offload_mask.data[1]
		     & tx_offload.data[1]))))
		return txq->ctx_lwrr;
...
#define IXGBE_PACKET_TYPE_LWGRE                   0X00
#define IXGBE_PACKET_TYPE_LWGRE_IPV4              0X01
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_TCP          0X11
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_UDP          0X21
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_SCTP         0X41
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_EXT          0X03
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_EXT_TCP      0X13
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_EXT_UDP      0X23
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_EXT_SCTP     0X43
#define IXGBE_PACKET_TYPE_LWGRE_IPV6              0X04
#define IXGBE_PACKET_TYPE_LWGRE_IPV6_TCP          0X14
#define IXGBE_PACKET_TYPE_LWGRE_IPV6_UDP          0X24
#define IXGBE_PACKET_TYPE_LWGRE_IPV6_SCTP         0X44
#define IXGBE_PACKET_TYPE_LWGRE_IPV6_EXT          0X0C
#define IXGBE_PACKET_TYPE_LWGRE_IPV6_EXT_TCP      0X1C
#define IXGBE_PACKET_TYPE_LWGRE_IPV6_EXT_UDP      0X2C
#define IXGBE_PACKET_TYPE_LWGRE_IPV6_EXT_SCTP     0X4C
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6         0X05
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_TCP     0X15
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_UDP     0X25
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_EXT     0X0D
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_EXT_TCP 0X1D
#define IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_EXT_UDP 0X2D
...
const uint32_t
	...
	[IXGBE_PACKET_TYPE_LWGRE] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_EXT] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4_EXT,
	[IXGBE_PACKET_TYPE_LWGRE_IPV6] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV6,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4,
	[IXGBE_PACKET_TYPE_LWGRE_IPV6_EXT] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV6_EXT,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_EXT] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_TCP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4 |
		RTE_PTYPE_INNER_L4_TCP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV6_TCP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV6 |
		RTE_PTYPE_INNER_L4_TCP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_TCP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4,
	[IXGBE_PACKET_TYPE_LWGRE_IPV6_EXT_TCP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV6_EXT |
		RTE_PTYPE_INNER_L4_TCP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_EXT_TCP] =
		RTE_PTYPE_L2_ETHER | RTE_PTYPE_L3_IPV4_EXT_UNKNOWN |
		RTE_PTYPE_TUNNEL_GRE | RTE_PTYPE_INNER_L2_ETHER |
		RTE_PTYPE_INNER_L3_IPV4,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_UDP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4 |
		RTE_PTYPE_INNER_L4_UDP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV6_UDP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV6 |
		RTE_PTYPE_INNER_L4_UDP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV6_SCTP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV6 |
		RTE_PTYPE_INNER_L4_SCTP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_UDP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4,
	[IXGBE_PACKET_TYPE_LWGRE_IPV6_EXT_UDP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV6_EXT |
		RTE_PTYPE_INNER_L4_UDP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV6_EXT_SCTP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV6_EXT |
		RTE_PTYPE_INNER_L4_SCTP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_IPV6_EXT_UDP] =
		RTE_PTYPE_L2_ETHER | RTE_PTYPE_L3_IPV4_EXT_UNKNOWN |
		RTE_PTYPE_TUNNEL_GRE | RTE_PTYPE_INNER_L2_ETHER |
		RTE_PTYPE_INNER_L3_IPV4,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_SCTP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4 |
		RTE_PTYPE_INNER_L4_SCTP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_EXT_SCTP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4_EXT |
		RTE_PTYPE_INNER_L4_SCTP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_EXT_TCP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4_EXT |
		RTE_PTYPE_INNER_L4_TCP,
	[IXGBE_PACKET_TYPE_LWGRE_IPV4_EXT_UDP] = RTE_PTYPE_L2_ETHER |
		RTE_PTYPE_L3_IPV4_EXT_UNKNOWN | RTE_PTYPE_TUNNEL_GRE |
		RTE_PTYPE_INNER_L2_ETHER | RTE_PTYPE_INNER_L3_IPV4_EXT |
		RTE_PTYPE_INNER_L4_UDP,
...
ixgbe_rx_scan_hw_ring(struct ixgbe_rx_queue *rxq)
{
	...
	for (i = 0; i < RTE_PMD_IXGBE_RX_MAX_BURST;
		...
		for (j = 0; j < nb_dd; ++j) {
			...
			/* colwert descriptor fields to rte mbuf flags */
	     ...
	     uint16_t nb_pkts)
{
	...
	if (rxq->rx_tail > rxq->rx_free_trigger) {
		uint16_t lwr_free_trigger = rxq->rx_free_trigger;
...
next_desc:
		 ...
		 * compiler lwrsed at me when I tried to cast away the
...
#ifdef RTE_LIB_SELWRITY
	if (dev->selwrity_ctx)
		tx_offload_capa |= DEV_TX_OFFLOAD_SELWRITY;
#endif
			 ...
			 const struct rte_eth_txconf *tx_conf)
{
	 ...
	 * aclwmulates WTHRESH descriptors.
	 */
 ...
 *           can be used.
 *  -EILWAL: the preconditions are NOT satisfied and the default Rx burst
...
#ifdef RTE_LIB_SELWRITY
	if (dev->selwrity_ctx)
		offloads |= DEV_RX_OFFLOAD_SELWRITY;
#endif
			...
			struct ixgbe_dcb_config *dcb_config)
{
	...
	/* colwert rte_eth_conf.rx_adv_conf to struct ixgbe_dcb_config */
			...
			struct ixgbe_dcb_config *dcb_config)
{
	...
	/*Callwlates traffic class credits*/
	ixgbe_dcb_callwlate_tc_credits_cee(hw, dcb_config, max_frame,
				IXGBE_DCB_TX_CONFIG);
	ixgbe_dcb_callwlate_tc_credits_cee(hw, dcb_config, max_frame,
				IXGBE_DCB_RX_CONFIG);
...
ixgbe_vmdq_rx_hw_configure(struct rte_eth_dev *dev)
{
	...
	for (i = 0; i < (int)num_pools; i++) {
		vmolr = ixgbe_colwert_vm_rx_mask_to_val(cfg->rx_mode, vmolr);
...
/**
 * ixgbe_get_rscctl_maxdesc - Callwlate the RSCCTL[n].MAXDESC for PF
 *
