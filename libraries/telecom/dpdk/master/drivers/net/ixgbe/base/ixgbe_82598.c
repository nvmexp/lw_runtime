				      ...
				      bool link_up_wait_to_complete)
{
	...
	/*
	 * SERDES PHY requires us to read link status from undolwmented
				      ...
				      bool autoneg_wait_to_complete)
{
	...
	u32 lwrr_autoc = IXGBE_READ_REG(hw, IXGBE_AUTOC);
	u32 autoc = lwrr_autoc;
...
STATIC s32 ixgbe_reset_hw_82598(struct ixgbe_hw *hw)
{
	...
	/*
	 * Power up the Atlas Tx lanes if they are lwrrently powered down.
