 ...
 *
 * Performs checksum callwlation and validates the EEPROM checksum
 **/
...
/**
 * ixgbe_fw_recovery_mode - Check if in FW LWM recovery mode
 * @hw: pointer to hardware structure
 *
 **/
 ...
 * is part of the Rx init addr exelwtion path.
 **/
