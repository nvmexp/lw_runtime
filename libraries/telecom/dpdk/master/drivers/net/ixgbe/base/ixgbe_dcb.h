...
/* DCB defines */
/* DCB credit callwlation defines */
...
/* DCB credits callwlation */
s32 ixgbe_dcb_callwlate_tc_credits(u8 *, u16 *, u16 *, int);
s32 ixgbe_dcb_callwlate_tc_credits_cee(struct ixgbe_hw *,
