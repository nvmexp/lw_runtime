...
/**
 * ixgbe_dcb_callwlate_tc_credits - This callwlates the ieee traffic class
 ...
 */
s32 ixgbe_dcb_callwlate_tc_credits(u8 *bw, u16 *refill, u16 *max,
				   int max_frame_size)
{
	int min_percent = 100;
...
/**
 * ixgbe_dcb_callwlate_tc_credits_cee - Callwlates traffic class credits
 * @hw: pointer to hardware structure
 * @dcb_config: Struct containing DCB settings
 * @max_frame_size: Maximum frame size
 * @direction: Configuring either Tx or Rx
 *
 * This function callwlates the credits allocated to each traffic class.
 * It should be called only after the rules are checked by
 * ixgbe_dcb_check_config_cee().
 */
s32 ixgbe_dcb_callwlate_tc_credits_cee(struct ixgbe_hw *hw,
				   ...
				   u32 max_frame_size, u8 direction)
{
	 ...
	 * percentages seen on the wire. To callwlate this ratio we use
	...
	for (i = 0; i < IXGBE_DCB_MAX_TRAFFIC_CLASS; i++) {
		...
		/* Callwlate credit refill ratio using multiplier */
		...
		/* Callwlate maximum credit for the TC */
