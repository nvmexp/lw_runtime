 ...
 * used in any case where the timeout oclwrred, or a failure to obtain a lock,
 ...
 * due to unsupported features. It should be used when a state oclwrs which
 ...
 * This category is for errors which are due to unsupported cirlwmstances or
 * configuration issues. It should not be used when the issue is due to an
 * invalid argument, but for when something has oclwrred that is unsupported
...
#define LWM_OROM_OFFSET		0x17
#define LWM_OROM_BLK_LOW	0x83
#define LWM_OROM_BLK_HI		0x84
#define LWM_OROM_PATCH_MASK	0xFF
#define LWM_OROM_SHIFT		8

#define LWM_VER_MASK		0x00FF /* version mask */
#define LWM_VER_SHIFT		8     /* version bit shift */
#define LWM_OEM_PROD_VER_PTR	0x1B  /* OEM Product version block pointer */
#define LWM_OEM_PROD_VER_CAP_OFF 0x1  /* OEM Product version format offset */
#define LWM_OEM_PROD_VER_OFF_L	0x2   /* OEM Product version offset low */
#define LWM_OEM_PROD_VER_OFF_H	0x3   /* OEM Product version offset high */
#define LWM_OEM_PROD_VER_CAP_MASK 0xF /* OEM Product version cap mask */
#define LWM_OEM_PROD_VER_MOD_LEN 0x3  /* OEM Product version module length */
#define LWM_ETK_OFF_LOW		0x2D  /* version low order word */
#define LWM_ETK_OFF_HI		0x2E  /* version high order word */
#define LWM_ETK_SHIFT		16    /* high version word shift */
#define LWM_VER_ILWALID		0xFFFF
#define LWM_ETK_VALID		0x8000
#define LWM_ILWALID_PTR		0xFFFF
#define LWM_VER_SIZE		32    /* version sting size */

struct ixgbe_lwm_version {
	u32 etk_id;
	u8  lwm_major;
	u16 lwm_minor;
	u8  lwm_id;
...
#define IXGBE_LSECRXILW(_n)	(0x08F6C + (0x04 * (_n))) /* InPktsIlwalid */
#define IXGBE_LSECRXLW(_n)	(0x08F74 + (0x04 * (_n))) /* InPktsNotValid */
...
#define IXGBE_FWSM_FW_LWM_RECOVERY_MODE (1 << 5)
...
/* VMOLR bitmasks */
#define IXGBE_VMOLR_UPE		0x00400000 /* unicast promislwous */
#define IXGBE_VMOLR_VPE		0x00800000 /* VLAN promislwous */
#define IXGBE_VMOLR_AUPE	0x01000000 /* accept untagged packets */
#define IXGBE_VMOLR_ROMPE	0x02000000 /* accept packets in MTA tbl */
#define IXGBE_VMOLR_ROPE	0x04000000 /* accept packets in UC tbl */
#define IXGBE_VMOLR_BAM		0x08000000 /* accept broadcast packets */
#define IXGBE_VMOLR_MPE		0x10000000 /* multicast promislwous */
...
#define IXGBE_GSSR_LWM_UPDATE_SM	0x0200
...
#define IXGBE_GSSR_LWM_PHY_MASK	0xF
...
#define IXGBE_LWM_POLL_WRITE		1 /* Flag for polling for wr complete */
#define IXGBE_LWM_POLL_READ		0 /* Flag for polling for rd complete */

#define LWM_INIT_CTRL_3		0x38
#define LWM_INIT_CTRL_3_LPLU	0x8
#define LWM_INIT_CTRL_3_D10GMP_PORT0 0x40
#define LWM_INIT_CTRL_3_D10GMP_PORT1 0x100
...
#define IXGBE_FCTRL_MPE		0x00000100 /* Multicast Promislwous Ena*/
#define IXGBE_FCTRL_UPE		0x00000200 /* Unicast Promislwous Ena */
...
#define IXGBE_RXDADV_IPSEC_ERROR_ILWALID_PROTOCOL 0x08000000
#define IXGBE_RXDADV_IPSEC_ERROR_ILWALID_LENGTH	0x10000000
...
#define IXGBE_RXD_STAT_UDPCS	0x10 /* UDP xsum callwlated */
#define IXGBE_RXD_STAT_L4CS	0x20 /* L4 xsum callwlated */
#define IXGBE_RXD_STAT_IPCS	0x40 /* IP xsum callwlated */
#define IXGBE_RXD_STAT_PIF	0x80 /* passed in-exact filter */
#define IXGBE_RXD_STAT_CRCV	0x100 /* Spelwlative CRC Valid */
#define IXGBE_RXD_STAT_OUTERIPCS	0x100 /* Cloud IP xsum callwlated */
...
#define IXGBE_ADVTXD_TUNNEL_TYPE_LWGRE	1  /* Adv Tx Desc Tunnel Type LWGRE */
...
#define IXGBE_PHYSICAL_LAYER_SFP_PLUS_LW	0x00008
 ...
 * Callwlation and defines taken from 802.1bb Annex O
 */

/* BitTimes (BT) colwersion */
#define IXGBE_BT2KB(BT)		((BT + (8 * 1024 - 1)) / (8 * 1024))
#define IXGBE_B2BT(BT)		(BT * 8)

/* Callwlate Delay to respond to PFC */
#define IXGBE_PFC_D	672

/* Callwlate Cable Delay */
#define IXGBE_CABLE_DC	5556 /* Delay Copper */
#define IXGBE_CABLE_DO	5000 /* Delay Optical */

/* Callwlate Interface Delay X540 */
...
/* Callwlate Interface Delay 82598, 82599 */
...
/* Callwlate Delay inlwrred from higher layer */
#define IXGBE_HD	6144

/* Callwlate PCI Bus delay for low thresholds */
#define IXGBE_PCI_DELAY	10000

/* Callwlate X540 delay value in bit times */
...
/* Callwlate 82599, 82598 delay value in bit times */
...
/* Callwlate low threshold delay values */
...
enum ixgbe_eeprom_type {
	...
	ixgbe_eeprom_spi,
	ixgbe_flash,
	ixgbe_eeprom_none /* No LWM support */
};
 ...
 * 1	SFP_SR
 * 2	SFP_LR
 * 3	SFP_DA_LW_CORE0 - 82599-specific
 * 4	SFP_DA_LW_CORE1 - 82599-specific
 * 5	SFP_SR/LR_CORE0 - 82599-specific
 * 6	SFP_SR/LR_CORE1 - 82599-specific
 */
enum ixgbe_sfp_type {
	ixgbe_sfp_type_da_lw = 0,
	ixgbe_sfp_type_sr = 1,
	ixgbe_sfp_type_lr = 2,
	ixgbe_sfp_type_da_lw_core0 = 3,
	ixgbe_sfp_type_da_lw_core1 = 4,
	ixgbe_sfp_type_srlr_core0 = 5,
	ixgbe_sfp_type_srlr_core1 = 6,
	ixgbe_sfp_type_da_act_lmt_core0 = 7,
	ixgbe_sfp_type_da_act_lmt_core1 = 8,
	ixgbe_sfp_type_1g_lw_core0 = 9,
	ixgbe_sfp_type_1g_lw_core1 = 10,
...
struct ixgbe_fc_info {
	...
	bool fc_was_autonegged; /* Is lwrrent_mode the result of autonegging? */
	enum ixgbe_fc_mode lwrrent_mode; /* FC mode in effect */
...
#define IXGBE_ERR_ILWALID_MAC_ADDR		-10
#define IXGBE_ERR_DEVICE_NOT_SUPPORTED		-11
#define IXGBE_ERR_MASTER_REQUESTS_PENDING	-12
#define IXGBE_ERR_ILWALID_LINK_SETTINGS		-13
#define IXGBE_ERR_AUTONEG_NOT_COMPLETE		-14
#define IXGBE_ERR_RESET_FAILED			-15
#define IXGBE_ERR_SWFW_SYNC			-16
#define IXGBE_ERR_PHY_ADDR_ILWALID		-17
...
#define IXGBE_KRM_RX_TRN_LINKUP_CTRL_COLW_WO_PROTOCOL	(1 << 4)
