...
static const struct eth_dev_ops ops = {
	...
	.promislwous_enable = nfb_eth_promislwous_enable,
	.promislwous_disable = nfb_eth_promislwous_disable,
...
nfb_eth_dev_init(struct rte_eth_dev *dev)
{
	...
	data->promislwous = nfb_eth_promislwous_get(dev);
	data->all_multicast = nfb_eth_allmulticast_get(dev);
	internals->rx_filter_original = data->promislwous;
