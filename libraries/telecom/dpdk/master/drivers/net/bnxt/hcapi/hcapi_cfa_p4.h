...
#define CFA_P4_ACT_ENCAP_MAX_MPLS_LABELS 8
		 ...
		 *      set to CFA_P4_TRUE;
		 * <li> CFA_P4_ACT_ENCAP_TNL_LWGRE. NOTE: only valid if
		...
		enum {
			...
			/** Set to enable LWGRE header encapsulation
			 */
			CFA_P4_ACT_ENCAP_TNL_LWGRE,
		...
		/* Lwrrently not planned */
		/* Custom Header */
		/*	uint8_t lwstom_enable; */
	} encap;
};
