...
#define FM_FD_CMD_DCL4C		0x10000000  /**< Didn't callwlate L4 Checksum */
...
typedef enum e_fm_exceptions {
	...
	e_FM_EX_QMI_DOUBLE_ECC,		/**< Double bit ECC oclwrred on QMI */
	...
	e_FM_EX_IRAM_ECC,		/**< Double bit ECC oclwrred on IRAM*/
	e_FM_EX_MURAM_ECC		/**< Double bit ECC oclwrred on MURAM*/
} e_fm_exceptions;
