...
/**
 * Control the RX mode, ie. promislwous, allmulti, etc...
...
vq_update_avail_ring(struct virtqueue *vq, uint16_t desc_idx)
{
	 ...
	 * lwrrently running on another CPU, we can keep it processing the new
	 * descriptor.
	 */
...
{
	uint16_t used_idx, id, lwrr_id, free_cnt = 0;
