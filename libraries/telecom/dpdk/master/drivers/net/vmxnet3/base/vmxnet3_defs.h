 ...
 *	the bit fields correctly. And cpu_to_le32 will colwert bitfields
...
#ifdef __BIG_ENDIAN_BITFIELD
   uint32 ext2:1;
   uint32 cnc:1;        /* Checksum Not Callwlated */
...
#define VMXNET3_ERR_TXD_ILWALID  0x80000007  /* invalid TxDesc */
...
#define VMXNET3_RXM_PROMISC   0x10  /* promislwous */
...
struct Vmxnet3_DriverShared {
   ...
   union {
      __le32            reserved1[4];
      Vmxnet3_CmdInfo   cmdInfo; /* only valid in the context of exelwting the
				  * relevant command
				  */
   } lw;
}
