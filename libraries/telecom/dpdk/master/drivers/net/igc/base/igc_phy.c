...
/**
 *  igc_check_downshift_generic - Checks whether a downshift in speed oclwrred
 *  @hw: pointer to the HW structure
 *
 *  Success returns 0, Failure returns 1
 *
