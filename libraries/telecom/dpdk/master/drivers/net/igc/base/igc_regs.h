...
#define IGC_I225_FLSELW	0x12114 /* FLASH Security */
#define IGC_FEXTLWM	0x00028  /* Future Extended LWM - RW */
#define IGC_FEXTLWM3	0x0003C  /* Future Extended LWM 3 - RW */
#define IGC_FEXTLWM4	0x00024  /* Future Extended LWM 4 - RW */
#define IGC_FEXTLWM5	0x00014  /* Future Extended LWM 5 - RW */
#define IGC_FEXTLWM6	0x00010  /* Future Extended LWM 6 - RW */
#define IGC_FEXTLWM7	0x000E4  /* Future Extended LWM 7 - RW */
#define IGC_FEXTLWM9	0x5BB4  /* Future Extended LWM 9 - RW */
#define IGC_FEXTLWM11	0x5BBC  /* Future Extended LWM 11 - RW */
...
#define IGC_ILWM_DATA_REG(_n)	(0x12120 + 4 * (_n))
#define IGC_ILWM_SIZE		64 /* Number of ILWM Data Registers */
 ...
 *
 * Example usage:
 * IGC_RDBAL_REG(lwrrent_rx_queue)
 */
...
#define IGC_LSECRXILW(_n)	(0x04380 + (0x04 * (_n))) /* Rx Invalid Cnt */
#define IGC_LSECRXLW(_n)	(0x043A0 + (0x04 * (_n))) /* Rx Not Valid Cnt */
...
#define IGC_LTRMILW	0x5BB0 /* LTR Minimum Value */
...
#define IGC_LTRMILW_SCALE_1024		0x02
#define IGC_LTRMILW_SCALE_32768	0x03
#define IGC_LTRMAXV_SCALE_1024		0x02
#define IGC_LTRMAXV_SCALE_32768	0x03
#define IGC_LTRMILW_LTRV_MASK		0x1ff
#define IGC_LTRMILW_LSNP_REQ		0x80
#define IGC_LTRMILW_SCALE_SHIFT	10
