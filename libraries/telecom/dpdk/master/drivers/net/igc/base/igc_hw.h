...
#define IGC_DEV_ID_I225_BLANK_LWM		0x15FD
...
enum igc_lwm_type {
	...
	igc_lwm_none,
	igc_lwm_eeprom_spi,
	igc_lwm_eeprom_microwire,
	igc_lwm_flash_hw,
	igc_lwm_ilwm,
	igc_lwm_flash_sw
};

enum igc_lwm_override {
	igc_lwm_override_none = 0,
	igc_lwm_override_spi_small,
	igc_lwm_override_spi_large,
	igc_lwm_override_microwire_small,
	igc_lwm_override_microwire_large
};
...
enum igc_ilwm_structure_type {
	igc_ilwm_uninitialized_structure		= 0x00,
	igc_ilwm_word_autoload_structure		= 0x01,
	igc_ilwm_csr_autoload_structure		= 0x02,
	igc_ilwm_phy_register_autoload_structure	= 0x03,
	igc_ilwm_rsa_key_sha256_structure		= 0x04,
	igc_ilwm_ilwalidated_structure		= 0x0f,
};
...
/* Function pointers for the LWM. */
struct igc_lwm_operations {
	s32  (*init_params)(struct igc_hw *hw);
	s32  (*acquire)(struct igc_hw *hw);
...
struct igc_info {
	s32 (*get_ilwariants)(struct igc_hw *hw);
	struct igc_mac_operations *mac_ops;
	const struct igc_phy_operations *phy_ops;
	struct igc_lwm_operations *lwm_ops;
};
...
struct igc_lwm_info {
	struct igc_lwm_operations ops;
	enum igc_lwm_type type;
	enum igc_lwm_override override;
...
struct igc_fc_info {
	...
	enum igc_fc_mode lwrrent_mode;  /* FC mode in effect */
