...
#define IGC_RXDADV_IPSEC_ERROR_ILWALID_PROTOCOL	0x08000000
#define IGC_RXDADV_IPSEC_ERROR_ILWALID_LENGTH		0x10000000
...
#define IGC_LWM_APME_82575		0x0400
...
#define IGC_VMOLR_MPME	0x10000000 /* Multicast promislwous mode */
#define IGC_VMOLR_STRVLAN	0x40000000 /* Vlan stripping enable */
#define IGC_VMOLR_STRCRC	0x80000000 /* CRC stripping enable */

#define IGC_VMOLR_VPE		0x00800000 /* VLAN promislwous enable */
...
s32 igc_init_lwm_params_82575(struct igc_hw *hw);
...
enum igc_promisc_type {
	...
	igc_promisc_unicast = 1,    /* unicast promislwous enabled */
	igc_promisc_multicast = 2,  /* multicast promislwous enabled */
