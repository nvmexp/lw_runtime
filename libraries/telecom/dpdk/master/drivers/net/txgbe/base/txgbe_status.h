...
#define TXGBE_ERR_PHY_ADDR_ILWALID		-(TERR_BASE + 17)
...
#define TXGBE_ERR_ILWALID_ARGUMENT		-(TERR_BASE + 32)
...
#define TXGBE_ERR_FW_RESP_ILWALID		-(TERR_BASE + 39)
