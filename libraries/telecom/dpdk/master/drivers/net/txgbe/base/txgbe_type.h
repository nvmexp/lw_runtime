...
#define TXGBE_PHYSICAL_LAYER_SFP_PLUS_LW	0x00008
...
enum txgbe_eeprom_type {
	...
	txgbe_eeprom_spi,
	txgbe_eeprom_flash,
	txgbe_eeprom_none /* No LWM support */
};
 ...
 * 1	SFP_SR
 * 2	SFP_LR
 * 3	SFP_DA_LW_CORE0 - chip-specific
 * 4	SFP_DA_LW_CORE1 - chip-specific
 * 5	SFP_SR/LR_CORE0 - chip-specific
 * 6	SFP_SR/LR_CORE1 - chip-specific
 */
enum txgbe_sfp_type {
	txgbe_sfp_type_unknown = 0,
	txgbe_sfp_type_da_lw,
	txgbe_sfp_type_sr,
	txgbe_sfp_type_lr,
	txgbe_sfp_type_da_lw_core0,
	txgbe_sfp_type_da_lw_core1,
...
struct txgbe_fc_info {
	...
	enum txgbe_fc_mode lwrrent_mode; /* FC mode in effect */
