...
txgbe_dcb_pfc_enable(struct txgbe_hw *hw, uint8_t tc_num)
{
	...
	if (!hw->fc.pause_time) {
		ret_val = TXGBE_ERR_ILWALID_LINK_SETTINGS;
		goto out;
	}
...
/**
 * txgbe_dcb_callwlate_tc_credits_cee - Callwlates traffic class credits
 * @hw: pointer to hardware structure
 ...
 */
s32 txgbe_dcb_callwlate_tc_credits_cee(struct txgbe_hw *hw,
