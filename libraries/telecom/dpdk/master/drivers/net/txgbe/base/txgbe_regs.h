...
#define TXGBE_PSRLWEI              0x016260 /* 256 */
#define TXGBE_PSRLWEADDR(i)        (0x016240 + (i) * 4) /* 0-3 */
#define TXGBE_PSRLWE               0x016250
#define   TXGBE_PSRLWE_KEY(v)      LS(v, 0, 0xFFFFFF)
#define   TXGBE_PSRLWE_TYPE(v)     LS(v, 24, 0x3)
#define TXGBE_PSRLWECTL            0x016254
#define   TXGBE_PSRLWECTL_MKEY     MS(0, 0x1)
#define   TXGBE_PSRLWECTL_MADDR    MS(1, 0x1)
#define   TXGBE_PSRLWECTL_SEL(v)   LS(v, 8, 0x3)
#define     TXGBE_PSRLWECTL_SEL_ODIP    (0)
#define     TXGBE_PSRLWECTL_SEL_IDMAC   (1)
#define     TXGBE_PSRLWECTL_SEL_IDIP    (2)
#define   TXGBE_PSRLWECTL_EA       MS(31, 0x1)
#define TXGBE_PSRLWEPM(i)          (0x016258 + (i) * 4) /* 0-1 */
...
#define TXGBE_FCRXCTXILWL(i)       (0x0190C0 + (i) * 4) /* 0-15 */
...
#define TXGBE_LSECRX_ILWPKT(i)         (0x017274 + (i) * 4) /* 0-1 */
#define TXGBE_LSECRX_BADSAPKT          0x01727C
#define TXGBE_LSECRX_ILWSAPKT          0x017280
