...
#define TXGBE_RXD_STAT_UDPCS       MS(6, 0x1) /* UDP xsum callwlated */
#define TXGBE_RXD_STAT_L4CS        MS(7, 0x1) /* L4 xsum callwlated */
#define TXGBE_RXD_STAT_IPCS        MS(8, 0x1) /* IP xsum callwlated */
#define TXGBE_RXD_STAT_PIF         MS(9, 0x1) /* Non-unicast address */
#define TXGBE_RXD_STAT_EIPCS       MS(10, 0x1) /* Encap IP xsum callwlated */
...
#define TXGBE_TXD_ELW              ((0x1) << 28) /* forward to ELW */
...
struct txgbe_tx_queue {
	...
	uint32_t            ctx_lwrr;      /**< Hardware context states. */
