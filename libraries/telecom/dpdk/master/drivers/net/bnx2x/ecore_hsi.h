...
struct shared_hw_cfg {			 /* LWRAM Offset */
	...
	/*  The fan failure mechanism is usually related to the PHY type
	      ...
	      Lwrrently, fan is required for most designs with SFX7101, BNX2X8727
	...
	/* This field extends the mf mode chosen in lwm cfg #73 (as we ran
	 * out of bits)
	 */
...
struct port_hw_cfg {		    /* port 0: 0x12c  port 1: 0x2bc */
	...
	/*
	 * The input pin I_FAULT which indicate over-current has oclwrred.
	 * Use the PIN_CFG_XXX defines on top
	 */
	uint32_t e3_cmn_pin_cfg1;				    /* 0x170 */
	#define PORT_HW_CFG_E3_OVER_LWRRENT_MASK            0x000000FF
	#define PORT_HW_CFG_E3_OVER_LWRRENT_SHIFT                    0
	...
	/*  When KR link is required to be set to force which is not
	      ...
	      When GPIO is selected, low input will force the speed. Lwrrently
	...
	/*  When enabled, all second phy lwram parameters will be swapped
 ...
 ****************************************************************************/
struct shared_feat_cfg {		 /* LWRAM Offset */

	uint32_t config;			/* 0x450 */
	#define SHARED_FEATURE_BMC_ECHO_MODE_EN             0x00000001

	/* Use LWRAM values instead of HW default values */
	...
	#define SHARED_FEAT_CFG_NCSI_ID_METHOD_MASK         0x00000008
		...
		#define SHARED_FEAT_CFG_NCSI_ID_METHOD_LWRAM         0x00000008
...
struct extended_dev_info_shared_cfg {             /* LWRAM OFFSET */
	...
	/*  Lwrrently enabled port(s) (bitmask for ports 3-1) */
	uint32_t lwrrent_iffe_mask;                              /* 0x4028 */
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_CFG_MASK         0x0000000E
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_CFG_SHIFT        1

	/*  Current iSCSI offload  */
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_ISCSI_MASK       0x00000010
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_ISCSI_SHIFT      4
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_ISCSI_DISABLED   0x00000000
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_ISCSI_ENABLED    0x00000010

	/*  Current FCoE offload  */
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_FCOE_MASK        0x00000020
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_FCOE_SHIFT       5
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_FCOE_DISABLED    0x00000000
	#define EXTENDED_DEV_INFO_SHARED_CFG_LWRRENT_FCOE_ENABLED     0x00000020
...
struct drv_func_mb {
	...
	#define DRV_MSG_CODE_GET_LWRR_KEY               0x80000000
	...
	#define FW_MSG_CODE_VRFY_OPT_MDL_ILWLD_IMG      0xa0200000
	#define FW_MSG_CODE_VRFY_OPT_MDL_UNAPPROVED     0xa0300000
	#define FW_MSG_CODE_VF_DISABLED_DONE            0xb0000000
	#define FW_MSG_CODE_HW_SET_ILWALID_IMAGE        0xb0100000
	...
	#define FW_PARAM_ILWALID_IMG                    0xffffffff
...
struct mf_cfg {
	...
	struct port_mf_cfg  port_mf_config[LWM_PATH_MAX][PORT_MAX];
    /* 0x10*2=0x20 */
 ...
 * The SHMEM HSI is aligned on 32 bit boundaries which makes it diffilwlt to
...
enum lwrr_cfg_method_e {
	LWRR_CFG_MET_NONE = 0,  /* default config */
	LWRR_CFG_MET_OS = 1,
	LWRR_CFG_MET_VENDOR_SPEC = 2,/* e.g. Option ROM, NPAR, O/S Cfg Utils */
	LWRR_CFG_MET_HP_OTHER = 3,
	LWRR_CFG_MET_VC_CLP = 4,  /* C-Class SM-CLP */
	LWRR_CFG_MET_HP_CNU = 5,  /*  Colwerged Network Utility */
	LWRR_CFG_MET_HP_DCI = 6,  /* DCi (BD) changes */
};
...
struct shmem2_region {
	...
	uint32_t lwm_retain_bitmap_addr;			/* 0x0070 */
	...
	/*
	 * bitmap notifying which VIF profiles stored in lwram are enabled by
	 * switch
	 */
	...
	/* pointer to extended dev_info shared data copied from lwm image */
	...
	/* FC_NPIV table offset in LWRAM */
	uint32_t fc_npiv_lwram_tbl_addr[PORT_MAX];		/* 0x1d4 */

	/* Shows last method that changed configuration of this device */
	enum lwrr_cfg_method_e lwrr_cfg;			/* 0x1dc */
	...
	uint32_t img_ilw_table_addr;	/* Address to ILW_TABLE_P */ /* 0x1f4 */
...
struct vlan_table_s {
	...
	uint8_t vlan_mode[LWM_PATH_MAX][PORT_MAX];
