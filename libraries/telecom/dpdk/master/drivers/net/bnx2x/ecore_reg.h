...
/* [R 5] Used to read the value of the XX protection CAM oclwpancy counter. */
#define CCM_REG_CAM_OCLWP					 0xd0188
...
/* [RW 32] Commands memory. The address to command X; row Y is to callwlated
 * as 14 * X+Y.
 */
...
#define MCP_REG_MCPR_LWM_ACCESS_ENABLE				 0x86424
#define MCP_REG_MCPR_LWM_ADDR					 0x8640c
#define MCP_REG_MCPR_LWM_CFG4					 0x8642c
#define MCP_REG_MCPR_LWM_COMMAND				 0x86400
#define MCP_REG_MCPR_LWM_READ					 0x86410
#define MCP_REG_MCPR_LWM_SW_ARB					 0x86420
#define MCP_REG_MCPR_LWM_WRITE					 0x86408
...
/* [R 32] read first 32 bit after ilwersion of function 0. mapped as
 ...
 */
#define MISC_REG_AEU_AFTER_ILWERT_1_FUNC_0			 0xa42c
#define MISC_REG_AEU_AFTER_ILWERT_1_FUNC_1			 0xa430
/* [R 32] read first 32 bit after ilwersion of mcp. mapped as follows: [0]
 ...
 */
#define MISC_REG_AEU_AFTER_ILWERT_1_MCP				 0xa434
/* [R 32] read second 32 bit after ilwersion of function 0. mapped as
 ...
 */
#define MISC_REG_AEU_AFTER_ILWERT_2_FUNC_0			 0xa438
#define MISC_REG_AEU_AFTER_ILWERT_2_FUNC_1			 0xa43c
/* [R 32] read second 32 bit after ilwersion of mcp. mapped as follows: [0]
 ...
 * [29] CSDM Hw interrupt; [30] CCM Parity error; [31] CCM Hw interrupt;
 */
#define MISC_REG_AEU_AFTER_ILWERT_2_MCP				 0xa440
/* [R 32] read third 32 bit after ilwersion of function 0. mapped as
 ...
 * attn1;
 */
#define MISC_REG_AEU_AFTER_ILWERT_3_FUNC_0			 0xa444
#define MISC_REG_AEU_AFTER_ILWERT_3_FUNC_1			 0xa448
/* [R 32] read third 32 bit after ilwersion of mcp. mapped as follows: [0]
 ...
 */
#define MISC_REG_AEU_AFTER_ILWERT_3_MCP				 0xa44c
/* [R 32] read fourth 32 bit after ilwersion of function 0. mapped as
 ...
 * Latched attn; [24] RBLW Latched attn; [25] RBCP Latched attn; [26] GRC
 * Latched timeout attention; [27] GRC Latched reserved access attention;
 * [28] MCP Latched rom_parity; [29] MCP Latched ump_rx_parity; [30] MCP
 * Latched ump_tx_parity; [31] MCP Latched scpad_parity;
 */
#define MISC_REG_AEU_AFTER_ILWERT_4_FUNC_0			 0xa450
#define MISC_REG_AEU_AFTER_ILWERT_4_FUNC_1			 0xa454
/* [R 32] read fourth 32 bit after ilwersion of mcp. mapped as follows: [0]
 ...
 * RBLW Latched attn; [25] RBCP Latched attn; [26] GRC Latched timeout
 * attention; [27] GRC Latched reserved access attention; [28] MCP Latched
 * rom_parity; [29] MCP Latched ump_rx_parity; [30] MCP Latched
 * ump_tx_parity; [31] MCP Latched scpad_parity;
 */
#define MISC_REG_AEU_AFTER_ILWERT_4_MCP				 0xa458
/* [R 32] Read fifth 32 bit after ilwersion of function 0. Mapped as
 * follows: [0] PGLUE config_space; [1] PGLUE misc_flr; [2] PGLUE B RBC
 * attention [3] PGLUE B RBC parity; [4] ATC attention; [5] ATC parity; [6]
 * mstat0 attention; [7] mstat0 parity; [8] mstat1 attention; [9] mstat1
 * parity; [31-10] Reserved;
 */
#define MISC_REG_AEU_AFTER_ILWERT_5_FUNC_0			 0xa700
/* [W 14] write to this register results with the clear of the latched
 * signals; one in d0 clears RBCR latch; one in d1 clears RBCT latch; one in
 * d2 clears RBCN latch; one in d3 clears RBLW latch; one in d4 clears RBCP
...
/* [RW 1] If set a system kill oclwrred. Reset on POR reset. */
#define MISC_REG_AEU_SYS_KILL_OCLWRRED				 0xa610
/* [RW 32] Represent the status of the input vector to the AEU when a system
 * kill oclwrred. The register is reset in por reset. Mapped as follows: [0]
 * NIG attention for function0; [1] NIG attention for function1; [2] GPIO1
 * mcp; [3] GPIO2 mcp; [4] GPIO3 mcp; [5] GPIO4 mcp; [6] GPIO1 function 1;
 * [7] GPIO2 function 1; [8] GPIO3 function 1; [9] GPIO4 function 1; [10]
 * PCIE glue/PXP VPD event function0; [11] PCIE glue/PXP VPD event
 ...
 * rst_rblw; [16] rst_pbf; [17] rst_qm; [18] rst_tm; [19] rst_dorq; [20]
 ...
 * sending it to the BRB or callwlating WoL on it. This bit controls port 1
...
/* [RW 1] When this bit is set; the LLH will classify the packet before
 * sending it to the BRB or callwlating WoL on it. This bit is applicable to
...
/* [R 12] Number of 8 bytes lines oclwpied in the task queue of port 0. */
#define PBF_REG_P0_TQ_OCLWPANCY					 0x1402fc
...
/* [R 12] Number of 8 bytes lines oclwpied in the task queue of port 1. */
#define PBF_REG_P1_TQ_OCLWPANCY					 0x140300
...
/* [R 12] Number of 8 bytes lines oclwpied in the task queue of port 4. */
#define PBF_REG_P4_TQ_OCLWPANCY					 0x140304
/* [RW 7] Interrupt mask register #0 read/write */
...
/* [R 13] Number of 8 bytes lines oclwpied in the task queue of the LB
 * queue.
 */
#define PBF_REG_TQ_OCLWPANCY_LB_Q				 0x1403a8
/* [R 13] Number of 8 bytes lines oclwpied in the task queue of queue 0. */
#define PBF_REG_TQ_OCLWPANCY_Q0					 0x1403ac
/* [R 13] Number of 8 bytes lines oclwpied in the task queue of queue 1. */
#define PBF_REG_TQ_OCLWPANCY_Q1					 0x1403b0
...
#define PRS_REG_CFC_LD_LWRRENT_CREDIT				 0x40164
/* [R 8] debug only: CFC search request current credit. Transaction based. */
#define PRS_REG_CFC_SEARCH_LWRRENT_CREDIT			 0x40168
...
#define PRS_REG_SRC_LWRRENT_CREDIT				 0x4016c
/* [RW 16] The Ethernet type value for L2 tag 0 */
...
#define PRS_REG_TCM_LWRRENT_CREDIT				 0x40160
/* [R 8] debug only: TSDM current credit. Transaction based. */
#define PRS_REG_TSDM_LWRRENT_CREDIT				 0x4015c
/* [RW 16] One of 8 values that should be compared to type in Ethernet
 * parsing. If there is a match; the field after Ethernet is the first VLAN.
 * Reset value is 0x8100 which is the standard VLAN type. Note that when
 * checking second VLAN; type is compared only to 0x8100.
...
/* [RW 10] Bandwidth Typical L for VQ5 Read- lwrrently not used */
...
/* [R 8] Number of entries oclwpied by vq 0 in pswrq memory */
#define PXP2_REG_RQ_VQ0_ENTRY_CNT				 0x120810
/* [R 8] Number of entries oclwpied by vq 10 in pswrq memory */
#define PXP2_REG_RQ_VQ10_ENTRY_CNT				 0x120818
/* [R 8] Number of entries oclwpied by vq 11 in pswrq memory */
#define PXP2_REG_RQ_VQ11_ENTRY_CNT				 0x120820
/* [R 8] Number of entries oclwpied by vq 12 in pswrq memory */
#define PXP2_REG_RQ_VQ12_ENTRY_CNT				 0x120828
/* [R 8] Number of entries oclwpied by vq 13 in pswrq memory */
#define PXP2_REG_RQ_VQ13_ENTRY_CNT				 0x120830
/* [R 8] Number of entries oclwpied by vq 14 in pswrq memory */
#define PXP2_REG_RQ_VQ14_ENTRY_CNT				 0x120838
/* [R 8] Number of entries oclwpied by vq 15 in pswrq memory */
#define PXP2_REG_RQ_VQ15_ENTRY_CNT				 0x120840
/* [R 8] Number of entries oclwpied by vq 16 in pswrq memory */
#define PXP2_REG_RQ_VQ16_ENTRY_CNT				 0x120848
/* [R 8] Number of entries oclwpied by vq 17 in pswrq memory */
#define PXP2_REG_RQ_VQ17_ENTRY_CNT				 0x120850
/* [R 8] Number of entries oclwpied by vq 18 in pswrq memory */
#define PXP2_REG_RQ_VQ18_ENTRY_CNT				 0x120858
/* [R 8] Number of entries oclwpied by vq 19 in pswrq memory */
#define PXP2_REG_RQ_VQ19_ENTRY_CNT				 0x120860
/* [R 8] Number of entries oclwpied by vq 1 in pswrq memory */
#define PXP2_REG_RQ_VQ1_ENTRY_CNT				 0x120868
/* [R 8] Number of entries oclwpied by vq 20 in pswrq memory */
#define PXP2_REG_RQ_VQ20_ENTRY_CNT				 0x120870
/* [R 8] Number of entries oclwpied by vq 21 in pswrq memory */
#define PXP2_REG_RQ_VQ21_ENTRY_CNT				 0x120878
/* [R 8] Number of entries oclwpied by vq 22 in pswrq memory */
#define PXP2_REG_RQ_VQ22_ENTRY_CNT				 0x120880
/* [R 8] Number of entries oclwpied by vq 23 in pswrq memory */
#define PXP2_REG_RQ_VQ23_ENTRY_CNT				 0x120888
/* [R 8] Number of entries oclwpied by vq 24 in pswrq memory */
#define PXP2_REG_RQ_VQ24_ENTRY_CNT				 0x120890
/* [R 8] Number of entries oclwpied by vq 25 in pswrq memory */
#define PXP2_REG_RQ_VQ25_ENTRY_CNT				 0x120898
/* [R 8] Number of entries oclwpied by vq 26 in pswrq memory */
#define PXP2_REG_RQ_VQ26_ENTRY_CNT				 0x1208a0
/* [R 8] Number of entries oclwpied by vq 27 in pswrq memory */
#define PXP2_REG_RQ_VQ27_ENTRY_CNT				 0x1208a8
/* [R 8] Number of entries oclwpied by vq 28 in pswrq memory */
#define PXP2_REG_RQ_VQ28_ENTRY_CNT				 0x1208b0
/* [R 8] Number of entries oclwpied by vq 29 in pswrq memory */
#define PXP2_REG_RQ_VQ29_ENTRY_CNT				 0x1208b8
/* [R 8] Number of entries oclwpied by vq 2 in pswrq memory */
#define PXP2_REG_RQ_VQ2_ENTRY_CNT				 0x1208c0
/* [R 8] Number of entries oclwpied by vq 30 in pswrq memory */
#define PXP2_REG_RQ_VQ30_ENTRY_CNT				 0x1208c8
/* [R 8] Number of entries oclwpied by vq 31 in pswrq memory */
#define PXP2_REG_RQ_VQ31_ENTRY_CNT				 0x1208d0
/* [R 8] Number of entries oclwpied by vq 3 in pswrq memory */
#define PXP2_REG_RQ_VQ3_ENTRY_CNT				 0x1208d8
/* [R 8] Number of entries oclwpied by vq 4 in pswrq memory */
#define PXP2_REG_RQ_VQ4_ENTRY_CNT				 0x1208e0
/* [R 8] Number of entries oclwpied by vq 5 in pswrq memory */
#define PXP2_REG_RQ_VQ5_ENTRY_CNT				 0x1208e8
/* [R 8] Number of entries oclwpied by vq 6 in pswrq memory */
#define PXP2_REG_RQ_VQ6_ENTRY_CNT				 0x1208f0
/* [R 8] Number of entries oclwpied by vq 7 in pswrq memory */
#define PXP2_REG_RQ_VQ7_ENTRY_CNT				 0x1208f8
/* [R 8] Number of entries oclwpied by vq 8 in pswrq memory */
#define PXP2_REG_RQ_VQ8_ENTRY_CNT				 0x120900
/* [R 8] Number of entries oclwpied by vq 9 in pswrq memory */
...
/* [RC 1] A flag to indicate that overflow error oclwrred in one of the
 * queues.
 */
#define QM_REG_OVFERROR						 0x16805c
/* [RC 6] the Q were the qverflow oclwrs */
...
/* [R 4] Used to read the value of the XX protection CAM oclwpancy counter. */
#define TCM_REG_CAM_OCLWP					 0x5017c
/* [RW 4] CFC output initial credit. Max credit available - 15.Write writes
 * the initial credit value; read returns the current value of the credit
 * counter. Must be initialized to 1 at start-up.
 */
...
/* [R 5] Used to read the XX protection CAM oclwpancy counter. */
#define UCM_REG_CAM_OCLWP					 0xe0170
/* [RW 4] CFC output initial credit. Max credit available - 15.Write writes
 * the initial credit value; read returns the current value of the credit
 * counter. Must be initialized to 1 at start-up.
 */
...
/* [R 5] Used to read the XX protection CAM oclwpancy counter. */
#define XCM_REG_CAM_OCLWP					 0x20244
/* [RW 4] CFC output initial credit. Max credit available - 15.Write writes
 * the initial credit value; read returns the current value of the credit
 * counter. Must be initialized to 1 at start-up.
 */
...
#define MCPR_LWM_ACCESS_ENABLE_EN				 (1L << 0)
#define MCPR_LWM_ACCESS_ENABLE_WR_EN				 (1L << 1)
#define MCPR_LWM_ADDR_LWM_ADDR_VALUE				(0xffffffL << 0)
#define MCPR_LWM_CFG4_FLASH_SIZE				 (0x7L << 0)
#define MCPR_LWM_COMMAND_DOIT					 (1L << 4)
#define MCPR_LWM_COMMAND_DONE					 (1L << 3)
#define MCPR_LWM_COMMAND_FIRST					 (1L << 7)
#define MCPR_LWM_COMMAND_LAST					 (1L << 8)
#define MCPR_LWM_COMMAND_WR					 (1L << 5)
#define MCPR_LWM_SW_ARB_ARB_ARB1				 (1L << 9)
#define MCPR_LWM_SW_ARB_ARB_REQ_CLR1				 (1L << 5)
#define MCPR_LWM_SW_ARB_ARB_REQ_SET1				 (1L << 1)
...
#define EMAC_RX_MODE_PROMISLWOUS				 (1L << 8)
...
#define HW_LOCK_RESOURCE_LWRAM					 12
...
#define PCICFG_PM_CAPABILITY_AUX_LWRRENT	(0x7<<22)
...
#define MDIO_SERDES_DIGITAL_A_1000X_CONTROL1_ILWERT_SIGNAL_DETECT	0x0008
...
#define PHY848xx_CMD_GET_LWRRENT_TEMP			0x8031
...
#define MDIO_REG_GPHY_SHADOW_ILWERT_FIB_SD		(0x1 << 8)
...
#define CDU_RSRVD_ILWALIDATE_CONTEXT_VALUE(_val) ((_val) & ~0x80)
