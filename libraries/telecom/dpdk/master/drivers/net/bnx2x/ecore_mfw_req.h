...
struct glob_ncsi_oem_data
{
	...
	uint32_t unused[3];
	struct fcoe_capabilities fcoe_features[LWM_PATH_MAX][PORT_MAX];
};

/* current drv_info version */
#define DRV_INFO_LWR_VER 2
...
#define FEATURE_ETH_TOE_MASK			0x20
	...
	uint32_t promislwous_mode;	/* Promislwous Mode. non-zero true */
