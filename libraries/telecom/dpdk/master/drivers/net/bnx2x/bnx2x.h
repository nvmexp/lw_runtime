...
/*
 * dropless fc callwlations for BDs
...
/*
 * dropless fc callwlations for RCQs
...
#define BNX2X_VF_ID_ILWALID  0xFF
...
/* CMNG constants, as derived from system spec callwlations */
/* default MIN rate in case VNIC min rate is configured to zero - 100Mbps */
#define DEF_MIN_RATE 100
/* resolution of the rate shaping timer - 400 usec */
#define RS_PERIODIC_TIMEOUT_USEC 400
/* number of bytes in single QM arbitration cycle -
 * coefficient for callwlating the fairness timer */
 ...
 * for callwlating the actual Tfair */
...
struct bnx2x_slowpath {
    ...
    /* used by the DMAE command exelwter */
...
#define CHIP_INT_MODE_IS_BC(sc) (!CHIP_INT_MODE_IS_NBC(sc))
	...
	uint32_t flash_size;
#define LWRAM_1MB_SIZE      0x20000
#define LWRAM_TIMEOUT_COUNT 30000
#define LWRAM_PAGE_SIZE     256
...
#define L2_ILT_LINES(sc)                                \
	...
	/*
	 * FW statistics request shortlwt (points at the beginning of fw_stats
	 * buffer).
	 */
	...
	/*
	 * FW statistics data shortlwt (points at the beginning of fw_stats
...
#define BNX2X_DCBX_ENABLED_ILWALID    -1
...
#define BNX2X_GRC_RSV     (GENERAL_ATTEN_OFFSET(LATCHED_ATTN_RBCR) | \
			 ...
			 GENERAL_ATTEN_OFFSET(LATCHED_ATTN_RBLW) | \
