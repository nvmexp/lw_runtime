...
#define MSG_ARG_ILWALID     "Invalid value for argument \"%s\".\n"
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&p.buffer_size, tokens[3]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "buffer_size");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.pool_size, tokens[5]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "pool_size");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.cache_size, tokens[7]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "cache_size");
		return;
	}
	...
	size_t out_size)
{
	...
	if (strcmp(tokens[2], "dev") == 0) {
		...
		if (softnic_parser_read_uint16(&p.port_id, tokens[3]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "port_id");
			return;
		}
	} else {
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&p.size, tokens[3]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "size");
		return;
	}
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&shaper_profile_id, tokens[4]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "profile_id");
		return;
	}
	...
	if (softnic_parser_read_uint64(&sp.peak.rate, tokens[6]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tb_rate");
		return;
	}
	...
	if (softnic_parser_read_uint64(&sp.peak.size, tokens[8]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tb_size");
		return;
	}
	...
	if (softnic_parser_read_int32(&sp.pkt_length_adjust, tokens[10]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "packet_length_adjust");
		return;
	}
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&shared_shaper_id, tokens[4]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "shared_shaper_id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&shaper_profile_id, tokens[6]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "shaper_profile_id");
		return;
	}
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&node_id, tokens[3]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "node_id");
		return;
	}
	...
	if (strcmp(tokens[5], "none") == 0)
		...
		if (softnic_parser_read_uint32(&parent_node_id, tokens[5]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "parent_node_id");
			return;
		}
	}
	...
	if (softnic_parser_read_uint32(&priority, tokens[7]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "priority");
		return;
	}
	...
	if (softnic_parser_read_uint32(&weight, tokens[9]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "weight");
		return;
	}
	...
	if (n_tokens >= 2 &&
		...
		if (softnic_parser_read_uint32(&np.nonleaf.n_sp_priorities, tokens[2]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "n_sp_priorities");
			return;
		}
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&p.n_spp, tokens[3]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "n_subports_per_port");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.n_pps, tokens[5]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "n_pipes_per_subport");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.port, tokens[9]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "port profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.subport, tokens[11]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "subport profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.pipe, tokens[13]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "pipe_profile_id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[0], tokens[15]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc0 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[1], tokens[17]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc1 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[2], tokens[19]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc2 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[3], tokens[21]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc3 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[4], tokens[23]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc4 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[5], tokens[25]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc5 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[6], tokens[27]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc6 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[7], tokens[29]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc7 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[8], tokens[31]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc8 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[9], tokens[33]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc9 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[10], tokens[35]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc10 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[11], tokens[37]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc11 profile id");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.shaper_profile_id.tc[12], tokens[39]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "tc12 profile id");
		return;
	}
	...
	if (strcmp(tokens[43], "none") == 0)
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[0],
			tokens[43]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc0");
			return;
		}
	...
	if (strcmp(tokens[45], "none") == 0)
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[1],
			tokens[45]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc1");
			return;
		}
	...
	if (strcmp(tokens[47], "none") == 0)
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[2],
			tokens[47]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc2");
			return;
		}
	...
	if (strcmp(tokens[49], "none") == 0)
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[3],
			tokens[49]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc3");
			return;
		}
	...
	if (strcmp(tokens[51], "none") == 0) {
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[4],
			tokens[51]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc4");
			return;
		}
	...
	if (strcmp(tokens[53], "none") == 0) {
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[5],
			tokens[53]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc5");
			return;
		}
	...
	if (strcmp(tokens[55], "none") == 0) {
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[6],
			tokens[55]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc6");
			return;
		}
	...
	if (strcmp(tokens[57], "none") == 0) {
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[7],
			tokens[57]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc7");
			return;
		}
	...
	if (strcmp(tokens[59], "none") == 0) {
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[8],
			tokens[59]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc8");
			return;
		}
	...
	if (strcmp(tokens[61], "none") == 0) {
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[9],
			tokens[61]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc9");
			return;
		}
	...
	if (strcmp(tokens[63], "none") == 0) {
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[10],
			tokens[63]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc10");
			return;
		}
	...
	if (strcmp(tokens[65], "none") == 0) {
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[11],
			tokens[65]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc11");
			return;
		}
	...
	if (strcmp(tokens[67], "none") == 0) {
		...
		if (softnic_parser_read_uint32(&p.shared_shaper_id.tc[12],
			tokens[67]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "shared shaper tc12");
			return;
		}
	...
	for (i = 0, j = 0; i < 16; i++) {
		if (i < RTE_SCHED_TRAFFIC_CLASS_BE) {
			...
			if (softnic_parser_read_uint32(&p.weight.queue[i],
				tokens[70 + j]) != 0) {
				snprintf(out, out_size, MSG_ARG_ILWALID, "weight queue");
				return;
			}
			j++;
		}
		...
		size_t out_size)
{
	...
	if (strcmp(tokens[2], "dev") == 0)
		...
		if (softnic_parser_read_uint32(&params.dev_id, tokens[3]) < 0) {
			snprintf(out, out_size,	MSG_ARG_ILWALID,
				"dev_id");
			return;
		}
	} else {
	...
	size_t out_size)
{
	...
	if (t0 < n_tokens &&
		...
		if (strcmp(tokens[t0 + 1], "match") == 0) {
			...
			snprintf(out, out_size, MSG_ARG_ILWALID, "match or mismatch");
			return;
		}
		...
		if (softnic_parser_read_uint32(&p.fltr.key_offset,
			tokens[t0 + 3]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "key_offset");
			return;
		}
		...
		if ((softnic_parse_hex_string(tokens[t0 + 5],
			...
			size != RTE_PORT_IN_ACTION_FLTR_KEY_SIZE) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "key_mask");
			return;
		}
		...
		if ((softnic_parse_hex_string(tokens[t0 + 7],
			p.fltr.key, &size) != 0) ||
			size != RTE_PORT_IN_ACTION_FLTR_KEY_SIZE) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "key_value");
			return;
		}
	...
	size_t out_size)
{
	...
	if (strcmp(tokens[4], "ipv4") == 0) {
		...
		snprintf(out, out_size, MSG_ARG_ILWALID, "ipv4 or ipv6");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.common.ip_offset,
		tokens[6]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "ip_offset");
		return;
	}
	...
	if (t0 < n_tokens &&
		...
		if (softnic_parser_read_uint32(&p.lb.out_offset,
			tokens[t0 + 6]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "out_offset");
			return;
		}
	...
	if (t0 < n_tokens &&
		...
		if (softnic_parser_read_uint32(&p.mtr.n_tc,
			tokens[t0 + 3]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "n_tc");
			return;
		}
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&p.timer_period_ms,
		tokens[3]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "timer_period_ms");
		return;
	}
	...
	if (softnic_parser_read_uint32(&p.offset_port_id,
		tokens[5]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "offset_port_id");
		return;
	}
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&p.burst_size, tokens[5]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "burst_size");
		return;
	}
	...
	if (strcmp(tokens[t0], "link") == 0) {
		...
		if (softnic_parser_read_uint32(&p.tap.mtu,
			tokens[t0 + 5]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "mtu");
			return;
		}
		...
		snprintf(out, out_size, MSG_ARG_ILWALID, tokens[0]);
		return;
	}
	...
	size_t out_size)
{
	...
	if (strcmp(tokens[6], "link") == 0) {
		...
		if (softnic_parser_read_uint16(&p.txq.queue_id,
			tokens[9]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "queue_id");
			return;
		}
		...
		if (n_tokens == 7) {
			...
			if (softnic_parser_read_uint32(&p.sink.max_n_pkts,
				tokens[10]) != 0) {
				snprintf(out, out_size, MSG_ARG_ILWALID, "max_n_pkts");
				return;
			}
		}
	...
	size_t out_size)
{
	...
	if (strcmp(tokens[t0], "acl") == 0) {
		...
		if (softnic_parser_read_uint32(&p.match.acl.n_rules,
			tokens[t0 + 5]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "n_rules");
			return;
		}
		...
		if (softnic_parser_read_uint32(&p.match.array.n_keys,
			tokens[t0 + 4]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "n_keys");
			return;
		}
		...
		if ((softnic_parser_read_uint32(&p.match.hash.key_size,
			...
			snprintf(out, out_size, MSG_ARG_ILWALID, "key_size");
			return;
		}
		...
		if (softnic_parser_read_uint32(&p.match.hash.n_buckets,
			tokens[t0 + 9]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "n_buckets");
			return;
		}
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&table_id, tokens[6]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "table_id");
		return;
	}
	...
	size_t out_size)
{
	...
	if (n_tokens == 8) {
		if (strcmp(tokens[7], "clear") != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "clear");
			return;
		}
	...
	struct softnic_table_rule_match *m)
{
	...
	if (strcmp(tokens[1], "array") == 0) {
		...
		if (softnic_parser_read_uint32(&m->match.array.pos, tokens[2]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "pos");
			return 0;
		}
	...
	if (strcmp(tokens[1], "hash") == 0) {
		...
		if (strcmp(tokens[2], "raw") == 0) {
			...
			if (softnic_parse_hex_string(tokens[3],
				...
				snprintf(out, out_size, MSG_ARG_ILWALID, "key");
				return 0;
			}
		...
		if (strcmp(tokens[2], "ipv4_5tuple") == 0) {
			...
			if (softnic_parser_read_uint16(&sp, tokens[5]) != 0) {
				snprintf(out, out_size, MSG_ARG_ILWALID, "sp");
				return 0;
			}

			if (softnic_parser_read_uint16(&dp, tokens[6]) != 0) {
				snprintf(out, out_size, MSG_ARG_ILWALID, "dp");
				return 0;
			}
	...
	if (strcmp(tokens[1], "lpm") == 0) {
		...
		if (softnic_parser_read_uint8(&m->match.lpm.depth, tokens[4]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "depth");
			return 0;
		}
	...
	struct softnic_table_rule_action *a)
{
	...
	if (n_tokens0 - n_tokens == 1) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "action");
		return 0;
	}
	...
	size_t out_size)
{
	...
	if (strcmp(tokens[6], "match") != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "match");
		return;
	}

	if (strcmp(tokens[7], "default") != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "default");
		return;
	}
	...
	if (strcmp(tokens[9], "fwd") != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "fwd");
		return;
	}
	...
	size_t out_size)
{
	...
	if (strcmp(tokens[6], "bulk") != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "bulk");
		return;
	}
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&meter_profile_id, tokens[6]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "meter_profile_id");
		return;
	}
	...
	if (strcmp(tokens[8], "srtcm") == 0) {
		...
		if (softnic_parser_read_uint64(&p.srtcm.cir, tokens[10]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "cir");
			return;
		}
		...
		if (softnic_parser_read_uint64(&p.srtcm.cbs, tokens[12]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "cbs");
			return;
		}
		...
		if (softnic_parser_read_uint64(&p.srtcm.ebs, tokens[14]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "ebs");
			return;
		}
		...
		if (softnic_parser_read_uint64(&p.trtcm.pir, tokens[12]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "pir");
			return;
		}
		...
		if (softnic_parser_read_uint64(&p.trtcm.pbs, tokens[16]) != 0) {
			snprintf(out, out_size, MSG_ARG_ILWALID, "pbs");
			return;
		}
	} else {
		snprintf(out, out_size, MSG_ARG_MISMATCH, tokens[0]);
	...
	size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&thread_id, tokens[1]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "thread_id");
		return;
	}
		...
		size_t out_size)
{
	...
	if (softnic_parser_read_uint32(&group_id, tokens[3]) != 0) {
		snprintf(out, out_size, MSG_ARG_ILWALID, "group_id");
		return;
	}
