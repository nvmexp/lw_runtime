...
#define ICE_DFLT_VSI_ILWAL 0xff
...
#define ICE_VSI_ILWAL_ID 0xFFFF
#define ICE_ILWAL_Q_HANDLE 0xFFFF
...
struct ice_fltr_mgmt_list_entry {
	...
	u16 vsi_count;
#define ICE_ILWAL_LG_ACT_INDEX 0xffff
	u16 lg_act_idx;
#define ICE_ILWAL_SW_MARKER_ID 0xffff
	u16 sw_marker_id;
	struct LIST_ENTRY_TYPE list_entry;
	struct ice_fltr_info fltr_info;
#define ICE_ILWAL_COUNTER_ID 0xff
	u8 counter_index;
};
