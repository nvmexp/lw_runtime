...
#define ICE_FLOW_PROF_ID_ILWAL		0xfffffffffffffffful
#define ICE_FLOW_PROF_ID_BYPASS		0
#define ICE_FLOW_PROF_ID_DEFAULT	1
#define ICE_FLOW_ENTRY_HANDLE_ILWAL	0
#define ICE_FLOW_VSI_ILWAL		0xffff
#define ICE_FLOW_FLD_OFF_ILWAL		0xffff
