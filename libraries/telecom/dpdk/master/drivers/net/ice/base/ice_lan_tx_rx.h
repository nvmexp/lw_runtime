...
enum ice_rx_desc_status_bits {
	...
	ICE_RX_DESC_STATUS_TSYLWALID_S		= 7,
...
#define ICE_RXD_QW1_STATUS_TSYLWALID_S ICE_RX_DESC_STATUS_TSYLWALID_S
#define ICE_RXD_QW1_STATUS_TSYLWALID_M BIT_ULL(ICE_RXD_QW1_STATUS_TSYLWALID_S)
...
/* The ice_ptype_lkup table is used to colwert from the 10-bit ptype in the
