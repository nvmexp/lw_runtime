...
static int
ice_dcf_dev_promislwous_enable(__rte_unused struct rte_eth_dev *dev)
{
	return 0;
}

static int
ice_dcf_dev_promislwous_disable(__rte_unused struct rte_eth_dev *dev)
{
	return 0;
}
...
static const struct eth_dev_ops ice_dcf_eth_dev_ops = {
	...
	.promislwous_enable      = ice_dcf_dev_promislwous_enable,
	.promislwous_disable     = ice_dcf_dev_promislwous_disable,
