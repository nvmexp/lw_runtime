...
STATIC s32  e1000_acquire_lwm_ich8lan(struct e1000_hw *hw);
STATIC void e1000_release_lwm_ich8lan(struct e1000_hw *hw);
...
STATIC s32  e1000_set_d3_lplu_state_ich8lan(struct e1000_hw *hw,
					    bool active);
STATIC s32  e1000_read_lwm_ich8lan(struct e1000_hw *hw, u16 offset,
				   u16 words, u16 *data);
STATIC s32  e1000_read_lwm_spt(struct e1000_hw *hw, u16 offset, u16 words,
			       u16 *data);
STATIC s32  e1000_write_lwm_ich8lan(struct e1000_hw *hw, u16 offset,
				    u16 words, u16 *data);
STATIC s32  e1000_validate_lwm_checksum_ich8lan(struct e1000_hw *hw);
STATIC s32  e1000_update_lwm_checksum_ich8lan(struct e1000_hw *hw);
STATIC s32  e1000_update_lwm_checksum_spt(struct e1000_hw *hw);
...
STATIC void e1000_toggle_lanphypc_pch_lpt(struct e1000_hw *hw)
{
	...
	mac_reg = E1000_READ_REG(hw, E1000_FEXTLWM3);
	mac_reg &= ~E1000_FEXTLWM3_PHY_CFG_COUNTER_MASK;
	mac_reg |= E1000_FEXTLWM3_PHY_CFG_COUNTER_50MSEC;
	E1000_WRITE_REG(hw, E1000_FEXTLWM3, mac_reg);
...
/**
 *  e1000_init_lwm_params_ich8lan - Initialize LWM function pointers
 *  @hw: pointer to the HW structure
 *
 *  Initialize family-specific LWM parameters and function
 *  pointers.
 **/
STATIC s32 e1000_init_lwm_params_ich8lan(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_init_lwm_params_ich8lan");

	lwm->type = e1000_lwm_flash_sw;

	if (hw->mac.type >= e1000_pch_spt) {
		/* in SPT, gfpreg doesn't exist. LWM size is taken from the
		 * STRAP register. This is because in SPT the GbE Flash region
		 * is no longer accessed through the flash registers. Instead,
		 * the mechanism has changed, and the Flash region access
		 * registers are now implemented in GbE memory space.
		 */
		lwm->flash_base_addr = 0;
		lwm_size =
		    (((E1000_READ_REG(hw, E1000_STRAP) >> 1) & 0x1F) + 1)
		    * LWM_SIZE_MULTIPLIER;
		lwm->flash_bank_size = lwm_size / 2;
		/* Adjust to word count */
		lwm->flash_bank_size /= sizeof(u16);
		...
		lwm->flash_base_addr = sector_base_addr
				       << FLASH_SECTOR_ADDR_SHIFT;

		/* find total size of the LWM, then cut in half since the total
		 * size represents two separate LWM banks.
		 */
		lwm->flash_bank_size = ((sector_end_addr - sector_base_addr)
					<< FLASH_SECTOR_ADDR_SHIFT);
		lwm->flash_bank_size /= 2;
		/* Adjust to word count */
		lwm->flash_bank_size /= sizeof(u16);
	}

	lwm->word_size = E1000_SHADOW_RAM_WORDS;

	/* Clear shadow ram */
	for (i = 0; i < lwm->word_size; i++) {
		dev_spec->shadow_ram[i].modified = false;
		dev_spec->shadow_ram[i].value    = 0xFFFF;
	}

	E1000_MUTEX_INIT(&dev_spec->lwm_mutex);
	E1000_MUTEX_INIT(&dev_spec->swflag_mutex);

	/* Function Pointers */
	lwm->ops.acquire	= e1000_acquire_lwm_ich8lan;
	lwm->ops.release	= e1000_release_lwm_ich8lan;
	if (hw->mac.type >= e1000_pch_spt) {
		lwm->ops.read	= e1000_read_lwm_spt;
		lwm->ops.update	= e1000_update_lwm_checksum_spt;
	} else {
		lwm->ops.read	= e1000_read_lwm_ich8lan;
		lwm->ops.update	= e1000_update_lwm_checksum_ich8lan;
	}
	lwm->ops.valid_led_default = e1000_valid_led_default_ich8lan;
	lwm->ops.validate	= e1000_validate_lwm_checksum_ich8lan;
	lwm->ops.write		= e1000_write_lwm_ich8lan;
...
{
	u32 fextlwm6 = E1000_READ_REG(hw, E1000_FEXTLWM6);
	...
	if (link && (status & E1000_STATUS_SPEED_1000)) {
		...
		E1000_WRITE_REG(hw, E1000_FEXTLWM6,
				fextlwm6 | E1000_FEXTLWM6_REQ_PLL_CLK);
...
release:
		...
		/* clear FEXTLWM6 bit 8 on link down or 10/100 */
		fextlwm6 &= ~E1000_FEXTLWM6_REQ_PLL_CLK;

		if ((hw->phy.revision > 5) || !link ||
		    ((status & E1000_STATUS_SPEED_100) &&
		     (status & E1000_STATUS_FD)))
			goto update_fextlwm6;
		...
		if (status & E1000_STATUS_SPEED_100) {
			...
			fextlwm6 &= ~E1000_FEXTLWM6_ENABLE_K1_ENTRY_CONDITION;
		} else {
...
update_fextlwm6:
		E1000_WRITE_REG(hw, E1000_FEXTLWM6, fextlwm6);
	}
...
skip_smbus:
	...
	mac_reg = E1000_READ_REG(hw, E1000_FEXTLWM7);
	mac_reg |= E1000_FEXTLWM7_DISABLE_SMB_PERST;
	E1000_WRITE_REG(hw, E1000_FEXTLWM7, mac_reg);
...
STATIC s32 e1000_check_for_copper_link_ich8lan(struct e1000_hw *hw)
{
	 ...
	 * ensure that FEXTLWM4 Beacon Duration is set correctly
	 * on power up.
	...
	if (hw->mac.type >= e1000_pch_lpt) {
		...
		mac_reg = E1000_READ_REG(hw, E1000_FEXTLWM4);
		mac_reg &= ~E1000_FEXTLWM4_BEACON_DURATION_MASK;
		mac_reg |= E1000_FEXTLWM4_BEACON_DURATION_8USEC;
		E1000_WRITE_REG(hw, E1000_FEXTLWM4, mac_reg);
	}
	...
	if (hw->mac.type >= e1000_pch_lpt) {
		...
		if (hw->mac.type == e1000_pch_spt) {
			/* FEXTLWM6 K1-off workaround - for SPT only */
			u32 pcieanacfg = E1000_READ_REG(hw, E1000_PCIEANACFG);

			if (pcieanacfg & E1000_FEXTLWM6_K1_OFF_ENABLE)
				fextlwm6 |= E1000_FEXTLWM6_K1_OFF_ENABLE;
			else
				fextlwm6 &= ~E1000_FEXTLWM6_K1_OFF_ENABLE;
		}
 ...
 *  @hw: pointer to the HW structure
 *
 *  Initialize family-specific function pointers for PHY, MAC, and LWM.
 **/
void e1000_init_function_pointers_ich8lan(struct e1000_hw *hw)
{
	...
	hw->lwm.ops.init_params = e1000_init_lwm_params_ich8lan;
	switch (hw->mac.type) {
	case e1000_ich8lan:
	case e1000_ich9lan:
	case e1000_ich10lan:
...
/**
 *  e1000_acquire_lwm_ich8lan - Acquire LWM mutex
 *  @hw: pointer to the HW structure
 *
 *  Acquires the mutex for performing LWM operations.
 **/
STATIC s32 e1000_acquire_lwm_ich8lan(struct e1000_hw *hw)
{
	DEBUGFUNC("e1000_acquire_lwm_ich8lan");

	E1000_MUTEX_LOCK(&hw->dev_spec.ich8lan.lwm_mutex);

	return E1000_SUCCESS;
}

/**
 *  e1000_release_lwm_ich8lan - Release LWM mutex
 *  @hw: pointer to the HW structure
 *
 *  Releases the mutex used while performing LWM operations.
 **/
STATIC void e1000_release_lwm_ich8lan(struct e1000_hw *hw)
{
	DEBUGFUNC("e1000_release_lwm_ich8lan");

	E1000_MUTEX_UNLOCK(&hw->dev_spec.ich8lan.lwm_mutex);
 ...
 *  routines for the PHY and LWM parts.
 **/
STATIC bool e1000_check_mng_mode_ich8lan(struct e1000_hw *hw)
{
	u32 fwsm;
 ...
 *  @hw:   pointer to the HW structure
 *
 *  SW should configure the LCD from the LWM extended configuration region
...
STATIC s32 e1000_sw_lcd_config_ich8lan(struct e1000_hw *hw)
{
	...
	/* Initialize the PHY from the LWM on ICH platforms.  This
	 * is needed due to an issue where the LWM configuration is
	 * not properly autoloaded after power transitions.
	 * Therefore, after each PHY reset, we will load the
	 * configuration data out of the LWM manually.
	 */
	switch (hw->mac.type) {
	case e1000_ich8lan:
		...
		if ((hw->device_id == E1000_DEV_ID_ICH8_IGP_AMT) ||
			...
			sw_cfg_mask = E1000_FEXTLWM_SW_CONFIG;
			break;
		}
		/* Fall-thru */
	case e1000_pchlan:
	...
	case e1000_pch_cnp:
	case e1000_pch_adp:
		sw_cfg_mask = E1000_FEXTLWM_SW_CONFIG_ICH8M;
		break;
	default:
		return ret_val;
	}
	...
	data = E1000_READ_REG(hw, E1000_FEXTLWM);
	if (!(data & sw_cfg_mask))
		goto release;
	...
	if (((hw->mac.type == e1000_pchlan) &&
		 ...
		 * OEM and LCD Write Enable bits are set in the LWM.
		 * When both LWM bits are cleared, SW will configure
		 * them instead.
		 */
	...
	for (i = 0; i < cnf_size; i++) {
		ret_val = hw->lwm.ops.read(hw, (word_addr + i * 2), 1,
					   &reg_data);
		if (ret_val)
			goto release;
...
STATIC s32 e1000_k1_gig_workaround_hv(struct e1000_hw *hw, bool link)
{
	s32 ret_val = E1000_SUCCESS;
	u16 status_reg = 0;
	bool k1_enable = hw->dev_spec.ich8lan.lwm_k1_enabled;
	...
	/* Disable K1 when link is 1Gbps, otherwise use the LWM setting */
	if (link) {
		if (hw->phy.type == e1000_phy_82578) {
 ...
 *
 *  SW will configure Gbe Disable and LPLU based on the LWM. The four bits are
 *  collectively called OEM bits.  The OEM Write Enable bit and SW Config bit
 *  in LWM determines whether HW should configure LPLU and Gbe Disable.
 **/
STATIC s32 e1000_oem_bits_config_ich8lan(struct e1000_hw *hw, bool d0_state)
{
	s32 ret_val = 0;
	...
	mac_reg = E1000_READ_REG(hw, E1000_FEXTLWM);
	if (!(mac_reg & E1000_FEXTLWM_SW_CONFIG_ICH8M))
		goto release;
...
{
	u32 poly = 0xEDB88320;	/* Polynomial for 802.3 CRC callwlation */
	u32 i, j, mask, crc;
...
STATIC s32 e1000_k1_workaround_lv(struct e1000_hw *hw)
{
	...
	if ((status_reg & (HV_M_STATUS_LINK_UP | HV_M_STATUS_AUTONEG_COMPLETE))
		...
		if (status_reg &
			...
			mac_reg = E1000_READ_REG(hw, E1000_FEXTLWM4);
			mac_reg &= ~E1000_FEXTLWM4_BEACON_DURATION_MASK;
			mac_reg |= E1000_FEXTLWM4_BEACON_DURATION_16USEC;
			E1000_WRITE_REG(hw, E1000_FEXTLWM4, mac_reg);
		}
	}
...
STATIC void e1000_lan_init_done_ich8lan(struct e1000_hw *hw)
{
	 ...
	 * count reaches 0, loading the configuration from LWM will
...
STATIC s32 e1000_post_phy_reset_ich8lan(struct e1000_hw *hw)
{
	...
	/* Configure the LCD with the extended configuration region in LWM */
	ret_val = e1000_sw_lcd_config_ich8lan(hw);
	if (ret_val)
		return ret_val;

	/* Configure the LCD with the OEM bits in LWM */
	ret_val = e1000_oem_bits_config_ich8lan(hw, true);
 ...
 *  bit are disabled in the LWM, writing the LPLU bits in the MAC will not set
...
/**
 *  e1000_valid_lwm_bank_detect_ich8lan - finds out the valid bank 0 or 1
 *  @hw: pointer to the HW structure
 *  @bank:  pointer to the variable that returns the active bank
 *
 *  Reads signature byte from the LWM using the flash access registers.
 *  Word 0x13 bits 15:14 = 10b indicate a valid signature for that bank.
 **/
STATIC s32 e1000_valid_lwm_bank_detect_ich8lan(struct e1000_hw *hw, u32 *bank)
{
	u32 eecd;
	struct e1000_lwm_info *lwm = &hw->lwm;
	u32 bank1_offset = lwm->flash_bank_size * sizeof(u16);
	u32 act_offset = E1000_ICH_LWM_SIG_WORD * 2 + 1;
	u32 lwm_dword = 0;
	u8 sig_byte = 0;
	s32 ret_val;

	DEBUGFUNC("e1000_valid_lwm_bank_detect_ich8lan");

	switch (hw->mac.type) {
	case e1000_pch_spt:
	case e1000_pch_cnp:
	case e1000_pch_adp:
		bank1_offset = lwm->flash_bank_size;
		act_offset = E1000_ICH_LWM_SIG_WORD;
		...
		*bank = 0;
		...
		if (ret_val)
			return ret_val;
		sig_byte = (u8)((lwm_dword & 0xFF00) >> 8);
		if ((sig_byte & E1000_ICH_LWM_VALID_SIG_MASK) ==
		    E1000_ICH_LWM_SIG_VALUE) {
			*bank = 0;
			return E1000_SUCCESS;
		}
		...
		DEBUGOUT("ERROR: No valid LWM bank present\n");
	...
	case e1000_ich9lan:
		...
		DEBUGOUT("Unable to determine valid LWM bank via EEC - reading flash signature\n");
		/* fall-thru */
	default:
		/* set bank to 0 in case flash read fails */
		*bank = 0;
...
/**
 *  e1000_read_lwm_spt - LWM access for SPT
 *  @hw: pointer to the HW structure
 *  @offset: The offset (in bytes) of the word(s) to read.
 *  @words: Size of data to read in words.
 *  @data: pointer to the word(s) to read at offset.
 *
 *  Reads a word(s) from the LWM
 **/
STATIC s32 e1000_read_lwm_spt(struct e1000_hw *hw, u16 offset, u16 words,
			      u16 *data)
{
	...
	ret_val = e1000_valid_lwm_bank_detect_ich8lan(hw, &bank);
	if (ret_val != E1000_SUCCESS) {
		DEBUGOUT("Could not detect valid bank, assuming bank 0\n");
		bank = 0;
	}

	act_offset = (bank) ? lwm->flash_bank_size : 0;
	act_offset += offset;
...
/**
 *  e1000_read_lwm_ich8lan - Read word(s) from the LWM
 *  @hw: pointer to the HW structure
 *  @offset: The offset (in bytes) of the word(s) to read.
 *  @words: Size of data to read in words
 *  @data: Pointer to the word(s) to read at offset.
 *
 *  Reads a word(s) from the LWM using the flash access registers.
 **/
STATIC s32 e1000_read_lwm_ich8lan(struct e1000_hw *hw, u16 offset, u16 words,
				  u16 *data)
{
	struct e1000_lwm_info *lwm = &hw->lwm;
	struct e1000_dev_spec_ich8lan *dev_spec = &hw->dev_spec.ich8lan;
	...
	DEBUGFUNC("e1000_read_lwm_ich8lan");
 ...
 *
 *  Reads the flash dword at offset into data.  Offset is colwerted
					  ...
					  u32 *data)
{
	...
	/* Must colwert word offset into bytes. */
	offset <<= 1;
 ...
 *  @data: pointer to the location for storing the data
 *
 *  Reads the flash word at offset into data.  Offset is colwerted
 *  to bytes before read.
 **/
					 ...
					 u16 *data)
{
	...
	/* Must colwert offset into bytes. */
	offset <<= 1;
 ...
 *
 *  Reads a single byte from the LWM using the flash access registers.
 **/
...
/**
 *  e1000_read_flash_data_ich8lan - Read byte or word from LWM
 *  @hw: pointer to the HW structure
 *  @offset: The offset (in bytes) of the byte or word to read.
 *  @size: Size of data to read, 1=byte 2=word
 *  @data: Pointer to the word to store the value read.
 *
 *  Reads a byte or word from the LWM using the flash access registers.
 **/
STATIC s32 e1000_read_flash_data_ich8lan(struct e1000_hw *hw, u32 offset,
					 u8 size, u16 *data)
{
...
/**
 *  e1000_read_flash_data32_ich8lan - Read dword from LWM
 *  @hw: pointer to the HW structure
...
/**
 *  e1000_write_lwm_ich8lan - Write word(s) to the LWM
 *  @hw: pointer to the HW structure
 *  @offset: The offset (in bytes) of the word(s) to write.
 *  @words: Size of data to write in words
 *  @data: Pointer to the word(s) to write at offset.
 *
 *  Writes a byte or word to the LWM using the flash access registers.
 **/
STATIC s32 e1000_write_lwm_ich8lan(struct e1000_hw *hw, u16 offset, u16 words,
				   u16 *data)
{
	struct e1000_lwm_info *lwm = &hw->lwm;
	struct e1000_dev_spec_ich8lan *dev_spec = &hw->dev_spec.ich8lan;
	...
	DEBUGFUNC("e1000_write_lwm_ich8lan");
...
/**
 *  e1000_update_lwm_checksum_spt - Update the checksum for LWM
 *  @hw: pointer to the HW structure
 *
 *  The LWM checksum is updated by calling the generic update_lwm_checksum,
...
STATIC s32 e1000_update_lwm_checksum_spt(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_update_lwm_checksum_spt");

	ret_val = e1000_update_lwm_checksum_generic(hw);
	if (ret_val)
		goto out;

	if (lwm->type != e1000_lwm_flash_sw)
		goto out;
	...
	if (bank == 0) {
		new_bank_offset = lwm->flash_bank_size;
		old_bank_offset = 0;
		ret_val = e1000_erase_flash_bank_ich8lan(hw, 1);
		if (ret_val)
			goto release;
	} else {
		old_bank_offset = lwm->flash_bank_size;
		new_bank_offset = 0;
	...
	for (i = 0; i < E1000_SHADOW_RAM_WORDS; i += 2) {
		 ...
		 * in the other LWM bank or a modified value stored
		 * in the shadow RAM
		 */
		 ...
		 */
		if (i == E1000_ICH_LWM_SIG_WORD - 1)
			dword |= E1000_ICH_LWM_SIG_MASK << 16;

		/* Colwert offset to bytes. */
	 ...
	 */
	act_offset = new_bank_offset + E1000_ICH_LWM_SIG_WORD;
	...
	/* offset in words but we read dword*/
	act_offset = old_bank_offset + E1000_ICH_LWM_SIG_WORD - 1;
	ret_val = e1000_read_flash_dword_ich8lan(hw, act_offset, &dword);
...
out:
	if (ret_val)
		DEBUGOUT1("LWM update error: %d\n", ret_val);

	return ret_val;
}

/**
 *  e1000_update_lwm_checksum_ich8lan - Update the checksum for LWM
 *  @hw: pointer to the HW structure
 *
 *  The LWM checksum is updated by calling the generic update_lwm_checksum,
 *  which writes the checksum to the shadow ram.  The changes in the shadow
...
STATIC s32 e1000_update_lwm_checksum_ich8lan(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_update_lwm_checksum_ich8lan");
	...
	for (i = 0; i < E1000_SHADOW_RAM_WORDS; i++) {
		 ...
		 * while the write is still in progress
		 */
		if (i == E1000_ICH_LWM_SIG_WORD)
			data |= E1000_ICH_LWM_SIG_MASK;
	...
	/* And ilwalidate the previously valid segment by setting
	 * its signature word (0x13) high_byte to 0b. This can be
	 * done without an erase because flash erase sets all bits
	 * to 1's. We can write 1's to 0's without an erase
	 */
	act_offset = (old_bank_offset + E1000_ICH_LWM_SIG_WORD) * 2 + 1;
...
/**
 *  e1000_validate_lwm_checksum_ich8lan - Validate EEPROM checksum
 *  @hw: pointer to the HW structure
 *
 *  Check to see if checksum needs to be fixed by reading bit 6 in word 0x19.
 *  If the bit is 0, that the EEPROM had been modified, but the checksum was not
 *  callwlated, in which case we need to callwlate the checksum and set bit 6.
 **/
STATIC s32 e1000_validate_lwm_checksum_ich8lan(struct e1000_hw *hw)
{
	s32 ret_val;
	...
	DEBUGFUNC("e1000_validate_lwm_checksum_ich8lan");

	/* Read LWM and check Invalid Image CSUM bit.  If this bit is 0,
	 * the checksum needs to be fixed.  This bit is an indication that
	 * the LWM was prepared by OEM software and did not callwlate
	...
	case e1000_pch_adp:
		word = LWM_COMPAT;
		valid_csum_mask = LWM_COMPAT_VALID_CSUM;
		break;
	default:
		word = LWM_FUTURE_INIT_WORD1;
		valid_csum_mask = LWM_FUTURE_INIT_WORD1_VALID_CSUM;
		break;
	}

	ret_val = hw->lwm.ops.read(hw, word, 1, &data);
	if (ret_val)
		return ret_val;

	if (!(data & valid_csum_mask)) {
		data |= valid_csum_mask;
		ret_val = hw->lwm.ops.write(hw, word, 1, &data);
		if (ret_val)
			return ret_val;
		ret_val = hw->lwm.ops.update(hw);
		if (ret_val)
			return ret_val;
	}

	return e1000_validate_lwm_checksum_generic(hw);
}

/**
 *  e1000_write_flash_data_ich8lan - Writes bytes to the LWM
 *  @hw: pointer to the HW structure
 *  @offset: The offset (in bytes) of the byte/word to read.
 *  @size: Size of data to read, 1=byte 2=word
 *  @data: The byte(s) to write to the LWM.
 *
 *  Writes one/two bytes to the LWM using the flash access registers.
 **/
...
/**
*  e1000_write_flash_data32_ich8lan - Writes 4 bytes to the LWM
*  @hw: pointer to the HW structure
*  @offset: The offset (in bytes) of the dwords to read.
*  @data: The 4 bytes to write to the LWM.
*
*  Writes one/two/four bytes to the LWM using the flash access registers.
**/
...
/**
 *  e1000_write_flash_byte_ich8lan - Write a single byte to LWM
 *  @hw: pointer to the HW structure
 *  @offset: The index of the byte to read.
 *  @data: The byte to write to the LWM.
 *
 *  Writes a single byte to the LWM using the flash access registers.
 **/
...
/**
*  e1000_retry_write_flash_dword_ich8lan - Writes a dword to LWM
*  @hw: pointer to the HW structure
*  @offset: The offset of the word to write.
*  @dword: The dword to write to the LWM.
*
*  Writes a single dword to the LWM using the flash access registers.
...
/**
 *  e1000_retry_write_flash_byte_ich8lan - Writes a single byte to LWM
 *  @hw: pointer to the HW structure
 *  @offset: The offset of the byte to write.
 *  @byte: The byte to write to the LWM.
 *
 *  Writes a single byte to the LWM using the flash access registers.
 *  Goes through a retry algorithm before giving up.
 **/
...
/**
 *  e1000_erase_flash_bank_ich8lan - Erase a bank (4k) from LWM
 *  @hw: pointer to the HW structure
...
STATIC s32 e1000_erase_flash_bank_ich8lan(struct e1000_hw *hw, u32 bank)
{
	...
	u32 flash_bank_size = lwm->flash_bank_size * 2;
	s32 ret_val;
	s32 count = 0;
	 ...
	 *     conselwtive sectors.  The start index for the nth Hw sector
	 *     can be callwlated as = bank * 4096 + n * 256
	 * 01: The Hw sector is 4K bytes, hence we need to erase 1 sector.
	 *     The start index for the nth Hw sector can be callwlated
	 *     as = bank * 4096
	...
	flash_linear_addr = hw->lwm.flash_base_addr;
 ...
 *
 *  Reads the LED default settings from the LWM to data.  If the LWM LED
...
STATIC s32 e1000_id_led_init_pchlan(struct e1000_hw *hw)
{
	...
	ret_val = hw->lwm.ops.valid_led_default(hw, &data);
	if (ret_val)
		return ret_val;
...
STATIC s32 e1000_reset_hw_ich8lan(struct e1000_hw *hw)
{
	...
	if (hw->mac.type == e1000_pchlan) {
		/* Save the LWM K1 bit setting*/
		ret_val = e1000_read_lwm(hw, E1000_LWM_K1_CONFIG, 1, &kum_cfg);
		if (ret_val)
			return ret_val;

		if (kum_cfg & E1000_LWM_K1_ENABLE)
			dev_spec->lwm_k1_enabled = true;
		else
			dev_spec->lwm_k1_enabled = false;
	}
	...
	/* Set Phy Config Counter to 50msec */
	if (hw->mac.type == e1000_pch2lan) {
		reg = E1000_READ_REG(hw, E1000_FEXTLWM3);
		reg &= ~E1000_FEXTLWM3_PHY_CFG_COUNTER_MASK;
		reg |= E1000_FEXTLWM3_PHY_CFG_COUNTER_50MSEC;
		E1000_WRITE_REG(hw, E1000_FEXTLWM3, reg);
	}
...
STATIC s32 e1000_setup_link_ich8lan(struct e1000_hw *hw)
{
	...
	/* ICH parts do not have a word in the LWM to determine
	 ...
	 */
	hw->fc.lwrrent_mode = hw->fc.requested_mode;
 ...
 *  the LPLU setting in the LWM or custom setting.  For PCH and newer parts,
...
STATIC s32 e1000_led_on_pchlan(struct e1000_hw *hw)
{
	...
	/* If no link, then turn LED on by setting the ilwert bit
...
STATIC s32 e1000_led_off_pchlan(struct e1000_hw *hw)
{
	...
	/* If no link, then turn LED off by clearing the ilwert bit
...
STATIC s32 e1000_get_cfg_done_ich8lan(struct e1000_hw *hw)
{
	...
	if (hw->mac.type <= e1000_ich9lan) {
		...
		if (e1000_valid_lwm_bank_detect_ich8lan(hw, &bank)) {
