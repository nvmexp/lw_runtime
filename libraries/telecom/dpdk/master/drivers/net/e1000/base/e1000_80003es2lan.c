...
STATIC s32  e1000_acquire_lwm_80003es2lan(struct e1000_hw *hw);
STATIC void e1000_release_lwm_80003es2lan(struct e1000_hw *hw);
...
STATIC s32  e1000_write_phy_reg_gg82563_80003es2lan(struct e1000_hw *hw,
						    u32 offset,
						    u16 data);
STATIC s32  e1000_write_lwm_80003es2lan(struct e1000_hw *hw, u16 offset,
					u16 words, u16 *data);
...
/**
 *  e1000_init_lwm_params_80003es2lan - Init ESB2 LWM func ptrs.
 *  @hw: pointer to the HW structure
 **/
STATIC s32 e1000_init_lwm_params_80003es2lan(struct e1000_hw *hw)
{
	struct e1000_lwm_info *lwm = &hw->lwm;
	u32 eecd = E1000_READ_REG(hw, E1000_EECD);
	u16 size;

	DEBUGFUNC("e1000_init_lwm_params_80003es2lan");
	...
	/* Function Pointers */
	lwm->ops.acquire	= e1000_acquire_lwm_80003es2lan;
	lwm->ops.read		= e1000_read_lwm_eerd;
	lwm->ops.release	= e1000_release_lwm_80003es2lan;
	...
	lwm->ops.write		= e1000_write_lwm_80003es2lan;
...
void e1000_init_function_pointers_80003es2lan(struct e1000_hw *hw)
{
	...
	hw->lwm.ops.init_params = e1000_init_lwm_params_80003es2lan;
...
/**
 *  e1000_acquire_lwm_80003es2lan - Acquire rights to access LWM
 *  @hw: pointer to the HW structure
 *
...
STATIC s32 e1000_acquire_lwm_80003es2lan(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_acquire_lwm_80003es2lan");
...
/**
 *  e1000_release_lwm_80003es2lan - Relinquish rights to access LWM
 *  @hw: pointer to the HW structure
 *
...
STATIC void e1000_release_lwm_80003es2lan(struct e1000_hw *hw)
{
	DEBUGFUNC("e1000_release_lwm_80003es2lan");
...
/**
 *  e1000_write_lwm_80003es2lan - Write to ESB2 LWM
 *  @hw: pointer to the HW structure
 *  @offset: offset of the register to read
 *  @words: number of words to write
 *  @data: buffer of data to write to the LWM
 *
 *  Write "words" of data to the ESB2 LWM.
 **/
STATIC s32 e1000_write_lwm_80003es2lan(struct e1000_hw *hw, u16 offset,
				       u16 words, u16 *data)
{
	DEBUGFUNC("e1000_write_lwm_80003es2lan");

	return e1000_write_lwm_spi(hw, offset, words, data);
}
