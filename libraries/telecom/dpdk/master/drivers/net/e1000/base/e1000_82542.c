...
STATIC s32  e1000_init_lwm_params_82542(struct e1000_hw *hw);
...
/**
 *  e1000_init_lwm_params_82542 - Init LWM func ptrs.
 *  @hw: pointer to the HW structure
 **/
STATIC s32 e1000_init_lwm_params_82542(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_init_lwm_params_82542");
	...
	lwm->ops.release	= e1000_stop_lwm;
...
void e1000_init_function_pointers_82542(struct e1000_hw *hw)
{
	...
	hw->lwm.ops.init_params = e1000_init_lwm_params_82542;
...
STATIC s32 e1000_reset_hw_82542(struct e1000_hw *hw)
{
	...
	if (hw->revision_id == E1000_REVISION_2) {
		if (bus->pci_cmd_word & CMD_MEM_WRT_ILWALIDATE)
...
STATIC s32 e1000_init_hw_82542(struct e1000_hw *hw)
{
	...
	if (hw->revision_id == E1000_REVISION_2) {
		...
		E1000_WRITE_FLUSH(hw);
		msec_delay(1);
		if (hw->bus.pci_cmd_word & CMD_MEM_WRT_ILWALIDATE)
			e1000_pci_set_mwi(hw);
	}
