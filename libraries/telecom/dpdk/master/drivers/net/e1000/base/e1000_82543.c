...
STATIC s32  e1000_init_lwm_params_82543(struct e1000_hw *hw);
...
/**
 *  e1000_init_lwm_params_82543 - Init LWM func ptrs.
 *  @hw: pointer to the HW structure
 **/
STATIC s32 e1000_init_lwm_params_82543(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_init_lwm_params_82543");
...
void e1000_init_function_pointers_82543(struct e1000_hw *hw)
{
	...
	hw->lwm.ops.init_params = e1000_init_lwm_params_82543;
...
STATIC u16 e1000_shift_in_mdi_bits_82543(struct e1000_hw *hw)
{
	 ...
	 * for the turnaround bits.  The first clock oclwrred when we clocked
...
STATIC s32 e1000_reset_hw_82543(struct e1000_hw *hw)
{
	...
	/*
	 * After MAC reset, force reload of LWM to restore power-on
	 * settings to device.
	 */
...
STATIC s32 e1000_setup_link_82543(struct e1000_hw *hw)
{
	...
	/*
	 * Take the 4 bits from LWM word 0xF that determine the initial
	...
	if (hw->mac.type == e1000_82543) {
		...
		ctrl_ext = ((data & LWM_WORD0F_SWPDIO_EXT_MASK) <<
			    LWM_SWDPIO_EXT_SHIFT);
		E1000_WRITE_REG(hw, E1000_CTRL_EXT, ctrl_ext);
	}
