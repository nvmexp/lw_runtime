...
s32 e1000_copper_link_setup_igp(struct e1000_hw *hw)
{
	...
	/* Wait 100ms for MAC to configure PHY from LWM settings, to avoid
	 * timeout issues when LFS is enabled.
	 */
	msec_delay(100);

	/* The LWM settings will configure LPLU in D3 for
	 * non-IGP1 PHYs.
	 */
...
/**
 *  e1000_check_downshift_generic - Checks whether a downshift in speed oclwrred
 *  @hw: pointer to the HW structure
 *
 *  Success returns 0, Failure returns 1
 *
...
s32 e1000_get_cable_length_igp_2(struct e1000_hw *hw)
{
	...
	u16 lwr_agc_index, max_agc_index = 0;
	...
	for (i = 0; i < IGP02E1000_PHY_CHANNEL_NUM; i++) {
		 ...
		 */
		lwr_agc_index = ((phy_data >> IGP02E1000_AGC_LENGTH_SHIFT) &
				 IGP02E1000_AGC_LENGTH_MASK);

		/* Array index bound check. */
		if ((lwr_agc_index >= IGP02E1000_CABLE_LENGTH_TABLE_SIZE) ||
		    (lwr_agc_index == 0))
			return -E1000_ERR_PHY;

		/* Remove min & max AGC values from callwlation. */
		if (e1000_igp_2_cable_length_table[min_agc_index] >
		    e1000_igp_2_cable_length_table[lwr_agc_index])
			min_agc_index = lwr_agc_index;
		if (e1000_igp_2_cable_length_table[max_agc_index] <
		    e1000_igp_2_cable_length_table[lwr_agc_index])
			max_agc_index = lwr_agc_index;

		agc_value += e1000_igp_2_cable_length_table[lwr_agc_index];
	}
	...
	/* Callwlate cable length with the error range of +/- 10 meters. */
...
s32 e1000_phy_init_script_igp3(struct e1000_hw *hw)
{
	...
	/* Increasing ADC OPAMP stage 1 lwrrents to max */
