...
STATIC s32  e1000_acquire_lwm_82571(struct e1000_hw *hw);
STATIC void e1000_release_lwm_82571(struct e1000_hw *hw);
STATIC s32  e1000_write_lwm_82571(struct e1000_hw *hw, u16 offset,
				  u16 words, u16 *data);
STATIC s32  e1000_update_lwm_checksum_82571(struct e1000_hw *hw);
STATIC s32  e1000_validate_lwm_checksum_82571(struct e1000_hw *hw);
...
STATIC s32  e1000_fix_lwm_checksum_82571(struct e1000_hw *hw);
...
STATIC s32  e1000_write_lwm_eewr_82571(struct e1000_hw *hw, u16 offset,
				       u16 words, u16 *data);
...
/**
 *  e1000_init_lwm_params_82571 - Init LWM func ptrs.
 *  @hw: pointer to the HW structure
 **/
STATIC s32 e1000_init_lwm_params_82571(struct e1000_hw *hw)
{
	struct e1000_lwm_info *lwm = &hw->lwm;
	u32 eecd = E1000_READ_REG(hw, E1000_EECD);
	u16 size;

	DEBUGFUNC("e1000_init_lwm_params_82571");
	...
	default:
		...
		lwm->address_bits = eecd & E1000_EECD_ADDR_BITS ? 16 : 8;
		break;
	}
	...
	case e1000_82574:
	case e1000_82583:
		lwm->ops.acquire = e1000_get_hw_semaphore_82574;
		lwm->ops.release = e1000_put_hw_semaphore_82574;
		break;
	default:
		lwm->ops.acquire = e1000_acquire_lwm_82571;
		lwm->ops.release = e1000_release_lwm_82571;
		break;
	}
	lwm->ops.read = e1000_read_lwm_eerd;
	lwm->ops.update = e1000_update_lwm_checksum_82571;
	lwm->ops.validate = e1000_validate_lwm_checksum_82571;
	lwm->ops.valid_led_default = e1000_valid_led_default_82571;
	lwm->ops.write = e1000_write_lwm_82571;
...
STATIC s32 e1000_init_mac_params_82571(struct e1000_hw *hw)
{
	 ...
	 * first LWM or PHY access. This should be done for single-port
	 * devices, and for one port only on dual-port devices so that
	 * for those devices we can still use the SMBI lock to synchronize
	 * inter-port accesses to the PHY & LWM.
	 */
	switch (hw->mac.type) {
	case e1000_82571:
	case e1000_82572:
...
void e1000_init_function_pointers_82571(struct e1000_hw *hw)
{
	...
	hw->lwm.ops.init_params = e1000_init_lwm_params_82571;
...
{
	u32 swsm;
	s32 sw_timeout = hw->lwm.word_size + 1;
	s32 fw_timeout = hw->lwm.word_size + 1;
	s32 i = 0;
 ...
 *  @hw: pointer to the HW structure
 *
 *  Release hardware semaphore used to access the PHY or LWM
 **/
STATIC void e1000_put_hw_semaphore_82571(struct e1000_hw *hw)
{
	u32 swsm;
...
/**
 *  e1000_acquire_lwm_82571 - Request for access to the EEPROM
 *  @hw: pointer to the HW structure
 *
...
STATIC s32 e1000_acquire_lwm_82571(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_acquire_lwm_82571");
...
/**
 *  e1000_release_lwm_82571 - Release exclusive access to EEPROM
 *  @hw: pointer to the HW structure
 *
...
STATIC void e1000_release_lwm_82571(struct e1000_hw *hw)
{
	DEBUGFUNC("e1000_release_lwm_82571");
...
/**
 *  e1000_write_lwm_82571 - Write to EEPROM using appropriate interface
 *  @hw: pointer to the HW structure
 ...
 **/
STATIC s32 e1000_write_lwm_82571(struct e1000_hw *hw, u16 offset, u16 words,
				 u16 *data)
{
	s32 ret_val;

	DEBUGFUNC("e1000_write_lwm_82571");

	switch (hw->mac.type) {
	case e1000_82573:
	case e1000_82574:
	case e1000_82583:
		ret_val = e1000_write_lwm_eewr_82571(hw, offset, words, data);
		break;
	case e1000_82571:
	case e1000_82572:
		ret_val = e1000_write_lwm_spi(hw, offset, words, data);
		break;
	default:
...
/**
 *  e1000_update_lwm_checksum_82571 - Update EEPROM checksum
 *  @hw: pointer to the HW structure
 *
...
STATIC s32 e1000_update_lwm_checksum_82571(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_update_lwm_checksum_82571");

	ret_val = e1000_update_lwm_checksum_generic(hw);
	if (ret_val)
		return ret_val;

	/* If our lwm is an EEPROM, then we're done
	 * otherwise, commit the checksum to the flash LWM.
	 */
	if (hw->lwm.type != e1000_lwm_flash_hw)
		return E1000_SUCCESS;
...
/**
 *  e1000_validate_lwm_checksum_82571 - Validate EEPROM checksum
 *  @hw: pointer to the HW structure
 *
...
STATIC s32 e1000_validate_lwm_checksum_82571(struct e1000_hw *hw)
{
	DEBUGFUNC("e1000_validate_lwm_checksum_82571");

	if (hw->lwm.type == e1000_lwm_flash_hw)
		e1000_fix_lwm_checksum_82571(hw);

	return e1000_validate_lwm_checksum_generic(hw);
}

/**
 *  e1000_write_lwm_eewr_82571 - Write to EEPROM for 82573 silicon
 *  @hw: pointer to the HW structure
 *  @offset: offset within the EEPROM to be written to
 *  @words: number of words to write
 *  @data: 16 bit word(s) to be written to the EEPROM
				      ...
				      u16 words, u16 *data)
{
	...
	DEBUGFUNC("e1000_write_lwm_eewr_82571");
	...
	for (i = 0; i < words; i++) {
		eewr = ((data[i] << E1000_LWM_RW_REG_DATA) |
			((offset + i) << E1000_LWM_RW_ADDR_SHIFT) |
			E1000_LWM_RW_REG_START);

		ret_val = e1000_poll_eerd_eewr_done(hw, E1000_LWM_POLL_WRITE);
		if (ret_val)
			break;
...
STATIC s32 e1000_reset_hw_82571(struct e1000_hw *hw)
{
	...
	/* Phy configuration from LWM just starts after EECD_AUTO_RD is set.
...
STATIC void e1000_initialize_hw_bits_82571(struct e1000_hw *hw)
{
	...
	case e1000_82583:
		...
		/* Workaround for hardware errata.
		 * apply workaround for hardware errata dolwmented in errata
		 * docs Fixes issue where some error prone or unreliable PCIe
		 * completions are oclwrring, partilwlarly with ASPM enabled.
 ...
 *  @hw: pointer to the HW structure
 *
 *  Reads the LWM Initialization Control Word 2 and returns true
...
STATIC bool e1000_check_mng_mode_82574(struct e1000_hw *hw)
{
	...
	ret_val = hw->lwm.ops.read(hw, LWM_INIT_CONTROL2_REG, 1, &data);
	if (ret_val)
		return false;

	return (data & E1000_LWM_INIT_CTRL2_MNGM) != 0;
}
...
STATIC s32 e1000_setup_link_82571(struct e1000_hw *hw)
{
	...
	/* 82573 does not have a word in the LWM to determine
...
/**
 *  e1000_fix_lwm_checksum_82571 - Fix EEPROM checksum
 *  @hw: pointer to the HW structure
 *
...
STATIC s32 e1000_fix_lwm_checksum_82571(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_fix_lwm_checksum_82571");

	if (lwm->type != e1000_lwm_flash_hw)
		return E1000_SUCCESS;

	/* Check bit 4 of word 10h.  If it is 0, firmware is done updating
	 * 10h-12h.  Checksum may need to be fixed.
	 */
	ret_val = lwm->ops.read(hw, 0x10, 1, &data);
	if (ret_val)
		return ret_val;
	...
	if (!(data & 0x10)) {
		 ...
		 * checksum.
		 */
		ret_val = lwm->ops.read(hw, 0x23, 1, &data);
		if (ret_val)
			return ret_val;

		if (!(data & 0x8000)) {
			data |= 0x8000;
			ret_val = lwm->ops.write(hw, 0x23, 1, &data);
			if (ret_val)
				return ret_val;
			ret_val = lwm->ops.update(hw);
			if (ret_val)
				return ret_val;
		}
	}
