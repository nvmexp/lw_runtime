...
STATIC s32  e1000_acquire_lwm_82575(struct e1000_hw *hw);
STATIC void e1000_release_lwm_82575(struct e1000_hw *hw);
...
STATIC s32 e1000_validate_lwm_checksum_82580(struct e1000_hw *hw);
STATIC s32 e1000_update_lwm_checksum_82580(struct e1000_hw *hw);
STATIC s32 e1000_update_lwm_checksum_with_offset(struct e1000_hw *hw,
						 u16 offset);
STATIC s32 e1000_validate_lwm_checksum_with_offset(struct e1000_hw *hw,
						   u16 offset);
STATIC s32 e1000_validate_lwm_checksum_i350(struct e1000_hw *hw);
STATIC s32 e1000_update_lwm_checksum_i350(struct e1000_hw *hw);
...
/**
 * e1000_init_lwm_params_82575 - Initialize LWM function ptrs
 * @hw: pointer to the HW structure
 **/
s32 e1000_init_lwm_params_82575(struct e1000_hw *hw)
{
	struct e1000_lwm_info *lwm = &hw->lwm;
	u32 eecd = E1000_READ_REG(hw, E1000_EECD);
	u16 size;

	DEBUGFUNC("e1000_init_lwm_params_82575");
	...
	if (hw->mac.type < e1000_i210) {
		...
		switch (lwm->override) {
		case e1000_lwm_override_spi_large:
			lwm->page_size = 32;
			lwm->address_bits = 16;
			break;
		case e1000_lwm_override_spi_small:
			lwm->page_size = 8;
			lwm->address_bits = 8;
			break;
		default:
			lwm->page_size = eecd & E1000_EECD_ADDR_BITS ? 32 : 8;
			lwm->address_bits = eecd & E1000_EECD_ADDR_BITS ?
					    16 : 8;
			break;
		}
		...
		lwm->type = e1000_lwm_eeprom_spi;
	} else {
		lwm->type = e1000_lwm_flash_hw;
	}

	/* Function Pointers */
	lwm->ops.acquire = e1000_acquire_lwm_82575;
	lwm->ops.release = e1000_release_lwm_82575;
	if (lwm->word_size < (1 << 15))
		lwm->ops.read = e1000_read_lwm_eerd;
	else
		lwm->ops.read = e1000_read_lwm_spi;

	lwm->ops.write = e1000_write_lwm_spi;
	lwm->ops.validate = e1000_validate_lwm_checksum_generic;
	lwm->ops.update = e1000_update_lwm_checksum_generic;
	lwm->ops.valid_led_default = e1000_valid_led_default_82575;

	/* override generic family function pointers for specific descendants */
	switch (hw->mac.type) {
	case e1000_82580:
		lwm->ops.validate = e1000_validate_lwm_checksum_82580;
		lwm->ops.update = e1000_update_lwm_checksum_82580;
		break;
	case e1000_i350:
		lwm->ops.validate = e1000_validate_lwm_checksum_i350;
		lwm->ops.update = e1000_update_lwm_checksum_i350;
		break;
	default:
		break;
	}
...
void e1000_init_function_pointers_82575(struct e1000_hw *hw)
{
	...
	hw->lwm.ops.init_params = e1000_init_lwm_params_82575;
...
/**
 *  e1000_acquire_lwm_82575 - Request for access to EEPROM
 *  @hw: pointer to the HW structure
 *
...
STATIC s32 e1000_acquire_lwm_82575(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_acquire_lwm_82575");
	...
	if (hw->mac.type == e1000_i350) {
		...
		if (eecd & (E1000_EECD_BLOCKED | E1000_EECD_ABORT |
			...
			DEBUGOUT("Lwm bit banging access error detected and cleared.\n");
		}
	}
	...
	ret_val = e1000_acquire_lwm_generic(hw);
	if (ret_val)
...
/**
 *  e1000_release_lwm_82575 - Release exclusive access to EEPROM
 *  @hw: pointer to the HW structure
 *
...
STATIC void e1000_release_lwm_82575(struct e1000_hw *hw)
{
	DEBUGFUNC("e1000_release_lwm_82575");

	e1000_release_lwm_generic(hw);
...
STATIC s32 e1000_get_cfg_done_82575(struct e1000_hw *hw)
{
	...
	if (hw->bus.func == E1000_FUNC_1)
		mask = E1000_LWM_CFG_DONE_PORT_1;
	else if (hw->bus.func == E1000_FUNC_2)
		mask = E1000_LWM_CFG_DONE_PORT_2;
	else if (hw->bus.func == E1000_FUNC_3)
		mask = E1000_LWM_CFG_DONE_PORT_3;
	while (timeout) {
...
STATIC s32 e1000_setup_serdes_link_82575(struct e1000_hw *hw)
{
	...
	default:
		if (hw->mac.type == e1000_82575 ||
			...
			ret_val = hw->lwm.ops.read(hw, LWM_COMPAT, 1, &data);
			if (ret_val) {
...
void e1000_vmdq_set_loopback_pf(struct e1000_hw *hw, bool enable)
{
	...
	case e1000_i354:
		...
		break;
	default:
		/* Lwrrently no other hardware supports loopback */
		break;
	}
...
STATIC s32 e1000_reset_mdicnfg_82580(struct e1000_hw *hw)
{
	...
	ret_val = hw->lwm.ops.read(hw, LWM_INIT_CONTROL3_PORT_A +
				   LWM_82580_LAN_FUNC_OFFSET(hw->bus.func), 1,
				   &lwm_data);
	if (ret_val) {
		DEBUGOUT("LWM Read Error\n");
		goto out;
	...
	if (lwm_data & LWM_WORD24_EXT_MDIO)
		mdicnfg |= E1000_MDICNFG_EXT_MDIO;
	if (lwm_data & LWM_WORD24_COM_MDIO)
 ...
 *  This function colwerts the retrieved value into the correct table value
...
/**
 *  e1000_validate_lwm_checksum_with_offset - Validate EEPROM
 *  checksum
 *  @hw: pointer to the HW structure
 ...
 **/
s32 e1000_validate_lwm_checksum_with_offset(struct e1000_hw *hw, u16 offset)
{
	s32 ret_val = E1000_SUCCESS;
	u16 checksum = 0;
	u16 i, lwm_data;

	DEBUGFUNC("e1000_validate_lwm_checksum_with_offset");

	for (i = offset; i < ((LWM_CHECKSUM_REG + offset) + 1); i++) {
...
/**
 *  e1000_update_lwm_checksum_with_offset - Update EEPROM
 *  checksum
 *  @hw: pointer to the HW structure
 *  @offset: offset in words of the checksum protected region
 *
 ...
 *  value to the EEPROM.
 **/
s32 e1000_update_lwm_checksum_with_offset(struct e1000_hw *hw, u16 offset)
{
	s32 ret_val;
	u16 checksum = 0;
	u16 i, lwm_data;

	DEBUGFUNC("e1000_update_lwm_checksum_with_offset");

	for (i = offset; i < (LWM_CHECKSUM_REG + offset); i++) {
		ret_val = hw->lwm.ops.read(hw, i, 1, &lwm_data);
		if (ret_val) {
	...
	ret_val = hw->lwm.ops.write(hw, (LWM_CHECKSUM_REG + offset), 1,
				    &checksum);
	if (ret_val)
...
/**
 *  e1000_validate_lwm_checksum_82580 - Validate EEPROM checksum
 *  @hw: pointer to the HW structure
 *
 *  Callwlates the EEPROM section checksum by reading/adding each word of
...
STATIC s32 e1000_validate_lwm_checksum_82580(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_validate_lwm_checksum_82580");

	ret_val = hw->lwm.ops.read(hw, LWM_COMPATIBILITY_REG_3, 1, &lwm_data);
	if (ret_val) {
		DEBUGOUT("LWM Read Error\n");
		goto out;
	}

	if (lwm_data & LWM_COMPATIBILITY_BIT_MASK) {
	...
	for (j = 0; j < eeprom_regions_count; j++) {
		lwm_offset = LWM_82580_LAN_FUNC_OFFSET(j);
		ret_val = e1000_validate_lwm_checksum_with_offset(hw,
								  lwm_offset);
		if (ret_val != E1000_SUCCESS)
			goto out;
	}
...
/**
 *  e1000_update_lwm_checksum_82580 - Update EEPROM checksum
 *  @hw: pointer to the HW structure
 *
 *  Updates the EEPROM section checksums for all 4 ports by reading/adding
 *  each word of the EEPROM up to the checksum.  Then callwlates the EEPROM
...
STATIC s32 e1000_update_lwm_checksum_82580(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_update_lwm_checksum_82580");

	ret_val = hw->lwm.ops.read(hw, LWM_COMPATIBILITY_REG_3, 1, &lwm_data);
	if (ret_val) {
		DEBUGOUT("LWM Read Error while updating checksum compatibility bit.\n");
		goto out;
	}

	if (!(lwm_data & LWM_COMPATIBILITY_BIT_MASK)) {
		/* set compatibility bit to validate checksums appropriately */
		lwm_data = lwm_data | LWM_COMPATIBILITY_BIT_MASK;
		ret_val = hw->lwm.ops.write(hw, LWM_COMPATIBILITY_REG_3, 1,
					    &lwm_data);
		if (ret_val) {
			DEBUGOUT("LWM Write Error while updating checksum compatibility bit.\n");
			goto out;
		}
	}
	...
	for (j = 0; j < 4; j++) {
		lwm_offset = LWM_82580_LAN_FUNC_OFFSET(j);
		ret_val = e1000_update_lwm_checksum_with_offset(hw, lwm_offset);
		if (ret_val)
			goto out;
	}
...
/**
 *  e1000_validate_lwm_checksum_i350 - Validate EEPROM checksum
 *  @hw: pointer to the HW structure
 *
 *  Callwlates the EEPROM section checksum by reading/adding each word of
 *  the EEPROM and then verifies that the sum of the EEPROM is
...
STATIC s32 e1000_validate_lwm_checksum_i350(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_validate_lwm_checksum_i350");
...
/**
 *  e1000_update_lwm_checksum_i350 - Update EEPROM checksum
 *  @hw: pointer to the HW structure
 *
 *  Updates the EEPROM section checksums for all 4 ports by reading/adding
 *  each word of the EEPROM up to the checksum.  Then callwlates the EEPROM
...
STATIC s32 e1000_update_lwm_checksum_i350(struct e1000_hw *hw)
{
	...
	DEBUGFUNC("e1000_update_lwm_checksum_i350");
