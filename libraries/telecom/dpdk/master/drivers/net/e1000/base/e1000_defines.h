...
#define E1000_RXD_STAT_UDPCS	0x10    /* UDP xsum callwlated */
#define E1000_RXD_STAT_TCPCS	0x20    /* TCP xsum callwlated */
#define E1000_RXD_STAT_IPCS	0x40    /* IP xsum callwlated */
...
#define E1000_CTRL_ILOS		0x00000080  /* Ilwert Loss-Of Signal */
...
#define E1000_STATUS_LAN_INIT_DONE	0x00000200 /* Lan Init Compltn by LWM */
...
#define E1000_ERR_ILWALID_ARGUMENT	16
#define E1000_ERR_NO_SPACE		17
#define E1000_ERR_LWM_PBA_SECTION	18
#define E1000_ERR_I2C			19
#define E1000_ERR_ILWM_VALUE_NOT_FOUND	20
...
/* LWM Control */
#define E1000_EECD_SK		0x00000001 /* LWM Clock */
#define E1000_EECD_CS		0x00000002 /* LWM Chip Select */
#define E1000_EECD_DI		0x00000004 /* LWM Data In */
#define E1000_EECD_DO		0x00000008 /* LWM Data Out */
#define E1000_EECD_REQ		0x00000040 /* LWM Access Request */
#define E1000_EECD_GNT		0x00000080 /* LWM Access Grant */
#define E1000_EECD_PRES		0x00000100 /* LWM Present */
#define E1000_EECD_SIZE		0x00000200 /* LWM Size (0=64 word 1=256 word) */
#define E1000_EECD_BLOCKED	0x00008000 /* Bit banging access blocked flag */
#define E1000_EECD_ABORT	0x00010000 /* LWM operation aborted flag */
#define E1000_EECD_TIMEOUT	0x00020000 /* LWM read operation timeout flag */
#define E1000_EECD_ERROR_CLR	0x00040000 /* LWM error status clear bit */
/* LWM Addressing bits based on type 0=small, 1=large */
#define E1000_EECD_ADDR_BITS	0x00000400
#define E1000_EECD_TYPE		0x00002000 /* LWM Type (1-SPI, 0-Microwire) */
#ifndef E1000_LWM_GRANT_ATTEMPTS
#define E1000_LWM_GRANT_ATTEMPTS	1000 /* LWM # attempts to gain grant */
#endif
#define E1000_EECD_AUTO_RD		0x00000200  /* LWM Auto Read done */
#define E1000_EECD_SIZE_EX_MASK		0x00007800  /* LWM Size */
...
#define E1000_LWM_RW_REG_DATA	16  /* Offset to data in LWM read/write regs */
#define E1000_LWM_RW_REG_DONE	2   /* Offset to READ/WRITE done bit */
#define E1000_LWM_RW_REG_START	1   /* Start operation */
#define E1000_LWM_RW_ADDR_SHIFT	2   /* Shift to the address bits */
#define E1000_LWM_POLL_WRITE	1   /* Flag for polling for write complete */
#define E1000_LWM_POLL_READ	0   /* Flag for polling for read complete */
...
#define E1000_I210_LWM_FW_MODULE_PTR	0x0010
#define E1000_I350_LWM_FW_MODULE_PTR	0x0051
...
#define E1000_I350_LWM_FW_LOADER_PATCH_PTR_OFFSET	0x01
/* Patch generation hour & minutes */
#define E1000_I350_LWM_FW_VER_WORD1_OFFSET		0x04
/* Patch generation month & day */
#define E1000_I350_LWM_FW_VER_WORD2_OFFSET		0x05
/* Patch generation year */
#define E1000_I350_LWM_FW_VER_WORD3_OFFSET		0x06
/* Patch major & minor numbers */
#define E1000_I350_LWM_FW_VER_WORD4_OFFSET		0x07
...
#define E1000_LWM_CFG_DONE_PORT_0	0x040000 /* MNG config cycle done */
#define E1000_LWM_CFG_DONE_PORT_1	0x080000 /* ...for second port */
#define E1000_LWM_CFG_DONE_PORT_2	0x100000 /* ...for third port */
#define E1000_LWM_CFG_DONE_PORT_3	0x200000 /* ...for fourth port */

#define LWM_82580_LAN_FUNC_OFFSET(a)	((a) ? (0x40 + (0x40 * (a))) : 0)
