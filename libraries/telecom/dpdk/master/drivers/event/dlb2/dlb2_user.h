...
enum dlb2_error {
	...
	DLB2_ST_ILWALID_DOMAIN_ID,
	DLB2_ST_ILWALID_QID_INFLIGHT_ALLOCATION,
	DLB2_ST_ATOMIC_INFLIGHTS_UNAVAILABLE,
	DLB2_ST_HIST_LIST_ENTRIES_UNAVAILABLE,
	DLB2_ST_ILWALID_LDB_QUEUE_ID,
	DLB2_ST_ILWALID_CQ_DEPTH,
	DLB2_ST_ILWALID_CQ_VIRT_ADDR,
	DLB2_ST_ILWALID_PORT_ID,
	DLB2_ST_ILWALID_QID,
	DLB2_ST_ILWALID_PRIORITY,
	DLB2_ST_NO_QID_SLOTS_AVAILABLE,
	DLB2_ST_ILWALID_DIR_QUEUE_ID,
	...
	DLB2_ST_MBOX_ERROR,
	DLB2_ST_ILWALID_HIST_LIST_DEPTH,
	DLB2_ST_NO_MEMORY,
	DLB2_ST_ILWALID_LOCK_ID_COMP_LEVEL,
	DLB2_ST_ILWALID_COS_ID,
};
...
/*
 * DLB2_CMD_GET_SN_OCLWPANCY: Get a sequence number group's oclwpancy
 *
 ...
 */
struct dlb2_get_sn_oclwpancy_args {
	/* Output parameters */
	struct dlb2_cmd_response response;
	/* Input parameters */
	__u32 group;
