...
enum dlb2_mbox_cmd_type {
	...
	DLB2_MBOX_CMD_GET_SN_OCLWPANCY,
...
enum dlb2_mbox_status_type {
	...
	DLB2_MBOX_ST_ILWALID_CMD_TYPE,
	DLB2_MBOX_ST_VERSION_MISMATCH,
	DLB2_MBOX_ST_ILWALID_OWNER_VF,
};
...
struct dlb2_mbox_get_sn_oclwpancy_cmd_req {
	struct dlb2_mbox_req_hdr hdr;
	u32 group_id;
};

struct dlb2_mbox_get_sn_oclwpancy_cmd_resp {
	struct dlb2_mbox_resp_hdr hdr;
	u32 num;
};
