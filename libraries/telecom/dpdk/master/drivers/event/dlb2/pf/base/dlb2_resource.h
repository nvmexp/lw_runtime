 ...
 *
 * Return:
 * Returns 0 upon success, < 0 otherwise. If an error oclwrs, resp->status is
 ...
 *
 * Errors:
 * EILWAL - A requested resource is unavailable, or the requested domain name
 *	    is already in use.
 ...
 *
 * Errors:
 * EILWAL - A requested resource is unavailable, the domain is not configured,
 ...
 *
 * Errors:
 * EILWAL - A requested resource is unavailable, a credit setting is invalid, a
 ...
 *
 * Errors:
 * EILWAL - the domain is not configured, or the domain is already started.
 */
 ...
 *
 * Errors:
 * EILWAL - A requested resource is unavailable, invalid port or queue ID, or
 ...
 *
 * Errors:
 * EILWAL - The port ID is invalid or the domain is not configured.
 * EFAULT - Internal error (resp->status not set).
 */
 ...
 *
 * Return:
 * Returns true if an ingress error interrupt oclwrred, false otherwise
 */
 ...
 *
 * Return:
 * Returns -EILWAL if group_id is invalid, else the group's SNs per queue.
 */
int dlb2_get_group_sequence_numbers(struct dlb2_hw *hw,
				    unsigned int group_id);

/**
 * dlb2_get_group_sequence_number_oclwpancy() - return a group's in-use slots
 * @hw: dlb2_hw handle for a particular device.
 * @group_id: sequence number group ID.
 *
 ...
 * Returns -EILWAL if group_id is invalid, else the group's SNs per queue.
 */
int dlb2_get_group_sequence_number_oclwpancy(struct dlb2_hw *hw,
					     unsigned int group_id);
 ...
 *
 * Return:
 * Returns 0 upon success; -EILWAL if group_id or val is invalid, -EPERM if an
 ...
 * through this domain's producer ports before ilwoking this function, or
 ...
 *
 * EILWAL - Invalid domain ID, or the domain is not configured.
 ...
 *
 * EILWAL - Invalid domain or port ID, or the domain is not configured.
 */
 ...
 *
 * Return:
 * Returns 0 upon success, -EILWAL if vdev_request is true and vdev_id is
 * invalid.
 */
 ...
 *
 * This function returns a boolean indicating whether the PF has finished
 * exelwting the VF FLR. It should only be called after setting the VF's FLR
 * bit.
 */
 ...
 * Returns 0 upon success, <0 otherwise.
 *
 * EILWAL - len >= DLB2_VF2PF_REQ_BYTES.
 */
 ...
 * Returns 0 upon success, <0 otherwise.
 *
 * EILWAL - len >= DLB2_VF2PF_RESP_BYTES.
 */
 ...
 * Returns 0 upon success, <0 otherwise.
 *
 * EILWAL - len >= DLB2_PF2VF_RESP_BYTES.
 */
 ...
 * Returns 0 upon success, <0 otherwise.
 *
 * EILWAL - len >= DLB2_PF2VF_REQ_BYTES.
 */
 ...
 *
 * Errors:
 * EILWAL - id is invalid, or the requested number of resources are
 *	    unavailable.
 ...
 * @id: virtual device ID
 *
 * This function takes any resources lwrrently assigned to the vdev and
 ...
 *
 * Errors:
 * EILWAL - Invalid domain ID or queue ID.
 */
 ...
 *
 * Return:
 * Returns -EILWAL if cos_id is invalid, else the class' bandwidth allocation.
 */
 ...
 *
 * Errors:
 * EILWAL - Invalid cos ID, bandwidth is greater than 100, or bandwidth would
 ...
 *
 * Errors:
 * EILWAL - Invalid directed port ID.
 */
 ...
 *
 * Errors:
 * EILWAL - Invalid load-balanced port ID.
 */
