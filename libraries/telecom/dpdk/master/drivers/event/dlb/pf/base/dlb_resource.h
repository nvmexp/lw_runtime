...
/**
 * dlb_get_group_sequence_number_oclwpancy() - return a group's in-use slots
 * @hw: dlb_hw handle for a particular device.
 * @group_id: sequence number group ID.
 *
 ...
 *
 * Return:
 * Returns -EILWAL if group_id is invalid, else the group's oclwpancy.
 */
int dlb_get_group_sequence_number_oclwpancy(struct dlb_hw *hw,
