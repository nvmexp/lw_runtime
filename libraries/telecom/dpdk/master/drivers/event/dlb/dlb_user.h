...
enum dlb_error {
	...
	DLB_ST_ILWALID_DOMAIN_ID,
	DLB_ST_ILWALID_QID_INFLIGHT_ALLOCATION,
	DLB_ST_ATOMIC_INFLIGHTS_UNAVAILABLE,
	DLB_ST_HIST_LIST_ENTRIES_UNAVAILABLE,
	DLB_ST_ILWALID_LDB_CREDIT_POOL_ID,
	DLB_ST_ILWALID_DIR_CREDIT_POOL_ID,
	DLB_ST_ILWALID_POP_COUNT_VIRT_ADDR,
	DLB_ST_ILWALID_LDB_QUEUE_ID,
	DLB_ST_ILWALID_CQ_DEPTH,
	DLB_ST_ILWALID_CQ_VIRT_ADDR,
	DLB_ST_ILWALID_PORT_ID,
	DLB_ST_ILWALID_QID,
	DLB_ST_ILWALID_PRIORITY,
	DLB_ST_NO_QID_SLOTS_AVAILABLE,
	DLB_ST_QED_FREELIST_ENTRIES_UNAVAILABLE,
	DLB_ST_DQED_FREELIST_ENTRIES_UNAVAILABLE,
	DLB_ST_ILWALID_DIR_QUEUE_ID,
	DLB_ST_DIR_QUEUES_UNAVAILABLE,
	DLB_ST_ILWALID_LDB_CREDIT_LOW_WATERMARK,
	DLB_ST_ILWALID_LDB_CREDIT_QUANTUM,
	DLB_ST_ILWALID_DIR_CREDIT_LOW_WATERMARK,
	DLB_ST_ILWALID_DIR_CREDIT_QUANTUM,
	...
	DLB_ST_ILWALID_MEASUREMENT_DURATION,
	DLB_ST_ILWALID_PERF_METRIC_GROUP_ID,
	DLB_ST_LDB_PORT_REQUIRED_FOR_LDB_QUEUES,
	DLB_ST_DOMAIN_RESET_FAILED,
	DLB_ST_MBOX_ERROR,
	DLB_ST_ILWALID_HIST_LIST_DEPTH,
	DLB_ST_NO_MEMORY,
};
...
/*
 * DLB_CMD_GET_SN_OCLWPANCY: Get a sequence number group's oclwpancy
 *
 ...
 *
 * This ioctl returns the group's number of in-use slots. If its oclwpancy is
 ...
 */
struct dlb_get_sn_oclwpancy_args {
	/* Output parameters */
	__u64 response;
	/* Input parameters */
	__u32 group;
