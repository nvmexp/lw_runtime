 ...
 * Callwlations on sequence numbers need to be done with other uint32_t values
...
update_available_seq(struct opdl_stage *s)
{
	 ...
	 * callwlating available slots and also the condition which is used to
...
/* Colwert head and tail of claim_manager into valid index */
static __rte_always_inline uint32_t
