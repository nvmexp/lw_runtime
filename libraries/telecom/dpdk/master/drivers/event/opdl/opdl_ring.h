 ...
 *   many entries as lwrrently possible.
 *
 * @return
 ...
 *   it disclaims as many as lwrrently possible, with non fully disclaimed
 ...
 *   disclaims as many claims as lwrrently possible and an attempt to disclaim
 ...
 *
 * @return
 *   The number of new entries lwrrently allowed to be input.
 */
uint32_t
 ...
 *
 * @return
 *   The number of entries lwrrently available to be processed in this stage.
 */
uint32_t
