		...
		void *arg __rte_unused)
{
	...
	while (lwr_len < len) {
		const void *va = RTE_PTR_ADD(addr, lwr_len);
...
int rte_fslmc_vfio_dmamap(void)
{
	...
	/* TODO - This is a W.A. as VFIO lwrrently does not add the mapping of
...
fslmc_vfio_process_group(void)
{
	...
	int dpmcp_count = 0, dpio_count = 0, lwrrent_device;
