...
#define RTE_GRAPH_OFF_ILWALID UINT32_MAX /**< Invalid graph offset. */
#define RTE_NODE_ID_ILWALID UINT32_MAX   /**< Invalid node id. */
#define RTE_EDGE_ID_ILWALID UINT16_MAX   /**< Invalid edge id. */
#define RTE_GRAPH_ID_ILWALID UINT16_MAX  /**< Invalid graph id. */
 ...
 *
 * The function ilwoked when the worker thread walks on nodes using
 * rte_graph_walk().
 *
 * @param graph
 ...
 *
 * The function ilwoked when the user creates the graph using rte_graph_create()
 *
 * @param graph
 *   Pointer to the graph object.
 * @param node
 ...
 *
 * The function ilwoked when the user destroys the graph using
 * rte_graph_destroy().
 *
 * @param graph
 *   Pointer to the graph object.
 ...
 *
 * @return
 *   Unique graph id on success, RTE_GRAPH_ID_ILWALID otherwise.
 */
__rte_experimental
 ...
 *
 * @return
 *   Graph id on success, RTE_GRAPH_ID_ILWALID otherwise.
 */
__rte_experimental
 ...
 *
 * @return
 *   Valid node id on success, RTE_NODE_ID_ILWALID otherwise.
 *
...
#define RTE_NODE_REGISTER(node)                                                \
	...
	{                                                                      \
		node.parent_id = RTE_NODE_ID_ILWALID;                          \
 ...
 *
 * @return
 *   Valid edge count on success, RTE_EDGE_ID_ILWALID otherwise.
 */
__rte_experimental
 ...
 *   Valid node id.
 * @param from
 *   Index to update the edges from. RTE_EDGE_ID_ILWALID is valid,
 ...
 *
 * @return
 *   New size on success, RTE_EDGE_ID_ILWALID otherwise.
 */
__rte_experimental
...
rte_node_is_ilwalid(rte_node_t id)
{
	return (id == RTE_NODE_ID_ILWALID);
}
 ...
 */
static __rte_always_inline int
rte_edge_is_ilwalid(rte_edge_t id)
{
	return (id == RTE_EDGE_ID_ILWALID);
}
 ...
 */
static __rte_always_inline int
rte_graph_is_ilwalid(rte_graph_t id)
{
	return (id == RTE_GRAPH_ID_ILWALID);
}
