...
/**
 * This function checks that the lwrrently used CPU supports the CPU features
 ...
 * errno to determine if an error oclwrred.
 */
unsigned long
 ...
 * check errno to determine if an error oclwrred.
 */
int
