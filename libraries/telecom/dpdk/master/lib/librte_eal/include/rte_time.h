 ...
 * in colwerting cycles to nanoseconds.
 */
...
/**
 * Colwerts cyclecounter cycles to nanoseconds.
 */
...
rte_timecounter_update(struct rte_timecounter *tc, uint64_t cycle_now)
{
	...
	/* Callwlate the delta since the last call. */
...
/**
 * Colwert from timespec structure into nanosecond units.
 */
static inline uint64_t
...
/**
 * Colwert from nanosecond units into timespec structure.
 */
