...
enum rte_lcore_state_t {
	...
	RUNNING,    /**< exelwting command */
	FINISHED,   /**< command exelwted */
};
 ...
 *
 * To be exelwted on the MAIN lcore only.
 *
 ...
 * exelwtion is done, the remote lcore switches to a FINISHED state and
 ...
 * @param worker_id
 *   The identifier of the lcore on which the function should be exelwted.
 * @return
 *   - 0: Success. Exelwtion of function f started on the remote lcore.
...
enum rte_rmt_call_main_t {
	SKIP_MAIN = 0, /**< lcore handler not exelwted by main core. */
	CALL_MAIN,     /**< lcore handler exelwted by main core. */
};
 ...
 * @return
 *   - 0: Success. Exelwtion of function f started on all remote lcores.
 ...
 *
 * To be exelwted on the MAIN lcore only. Issue an
