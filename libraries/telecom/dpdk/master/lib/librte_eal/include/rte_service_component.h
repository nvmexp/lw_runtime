...
struct rte_service_spec {
	...
	/** The callback to ilwoke to run one iteration of the service. */
 ...
 * component is ready to be exelwted.
 *
 ...
 *         -EILWAL Attempted to register an invalid service (eg, no callback
 *         set)
 */
 ...
 * @retval -EBUSY The service is lwrrently running, stop the service before
 ...
 * @retval -EILWAL Error while iterating over services
 ...
 * This routine is to be ilwoked prior to process termination.
 *
 * @retval None
 */
