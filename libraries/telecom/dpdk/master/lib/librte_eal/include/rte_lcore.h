...
/**
 * Return the Application thread ID of the exelwtion unit.
 *
...
/**
 * Return the number of exelwtion units (lcores) on the system.
 *
 * @return
 *   the number of exelwtion units (lcores) on the system.
 */
 ...
 *   - -1 on error, with errno set to EILWAL
 */
int
...
/**
 * Register callbacks ilwoked when initializing and uninitializing a lcore.
 *
 ...
 *
 * Note: callbacks exelwtion is serialised under a write lock protecting the
 * lcores and callbacks list.
 *
 * @param name
 *   A name serving as a small description for this callback.
 * @param init
 *   The callback ilwoked when a lcore_id is initialized.
 *   init can be NULL.
 * @param uninit
 *   The callback ilwoked when a lcore_id is uninitialized.
 *   uninit can be NULL.
 * @param arg
 ...
 * ilwoked in parallel as they are run under a read lock protecting the lcores
 * and callbacks list.
 *
 * @param cb
 ...
 * @param start_routine
 *   Function to be exelwted by the new thread.
 * @param arg
