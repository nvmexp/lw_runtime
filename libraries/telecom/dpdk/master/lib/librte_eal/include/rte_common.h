...
/** C extension macro for elwironments lacking C11 features. */
...
/*********** Macros for callwlating min and max **********/
...
/**
 * Colwerts a numeric string to the equivalent uint64_t value.
 * As well as straight number colwersion, also recognises the suffixes
 ...
 *
 * @param str
 *     String containing number to colwert.
 * @return
 *     Number.
 */
static inline uint64_t
