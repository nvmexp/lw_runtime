 ...
 *
 * This function is to be exelwted on the MAIN lcore only, as soon
 ...
 *
 *     EILWAL indicates invalid parameters were passed as argv/argc.
 *
...
/**
 * Check if a primary process is lwrrently alive
 *
 * This function returns true when a primary process is lwrrently
 * active.
 *
 ...
 *
 * @note IPC may be unsupported in certain cirlwmstances, so caller should check
 *    for ENOTSUP error.
 *
 * @param name
 ...
 *
 * @param msg
 *   The msg argument contains the lwstomized message.
 *
 * @return
 *  - On success, return 0.
 ...
 *
 * @param req
 *   The req argument contains the lwstomized request message.
 *
 * @param reply
