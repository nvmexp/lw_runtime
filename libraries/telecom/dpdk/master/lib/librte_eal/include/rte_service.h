 ...
 * @retval -EILWAL Null *service_id* pointer provided
 ...
 * @retval -EILWAL An invalid service or lcore was provided.
 */
 ...
 * @retval -EILWAL Invalid service id
 */
...
/**
 * This function returns whether the service may be lwrrently exelwting on
 ...
 * is still exelwting a service lcore.
 *
 ...
 * safe to run on this lcore. Multi-thread safe services are ilwoked even if
 ...
 * - When set, the function will check if a service is already being ilwoked
 ...
 *   indicated by *id* is not going to be ilwoked by another lcore. This setting
 ...
 * @retval -EBUSY Another lcore is exelwting the service, and it is not a
 ...
 *
 * @retval 0 Success
 * @retval -EILWAL Failed to start core. The *lcore_id* passed in is not
 *          lwrrently assigned to be a service core.
 */
...
/**
 * Reports if a service lcore is lwrrently running.
 *
 ...
 * @retval -EILWAL Invalid lcore provided
 */
 ...
 * @retval -EILWAL failed to add lcore to service core mask.
 */
int32_t rte_service_lcore_del(uint32_t lcore);

/**
 * Retrieve the number of service cores lwrrently available.
 *
 ...
 * service core.
 *
 * @return The number of service cores lwrrently configured.
 */
 ...
 * @retval 0 Success
 * @retval -EILWAL Invalid service pointer passed
 */
int32_t rte_service_set_stats_enable(uint32_t id, int32_t enable);

/**
 * Retrieve the list of lwrrently enabled service cores.
 *
 ...
 * @retval -EILWAL Invalid service id provided
 */
...
/**
 * Returns the count of ilwocations of this service function
 */
 ...
 *         -EILWAL Invalid id, attr_id or attr_value was NULL.
 */
 ...
 *         -EILWAL Invalid service id provided
 */
 ...
 * @retval 0 Success, the attribute value has been written to *attr_value*.
 *         -EILWAL Invalid lcore, attr_id or attr_value was NULL.
