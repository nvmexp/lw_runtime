 ...
 * The device matching is made among all buses and classes lwrrently registered,
 ...
 *   NULL if an error oclwrred (rte_errno is set).
 ...
 * @b EXPERIMENTAL: this API may change without prior notice
 *
 * Exelwtes all the user application registered callbacks for
 * the specific device.
 *
 * @param device_name
 *  The device name.
