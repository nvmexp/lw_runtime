...
/**
 * Callwlate the size of the mempool header.
 *
 * @param mp
 *   Pointer to the memory pool.
 * @param cs
...
/**
 * Callwlate memory size required to store given number of objects.
 *
...
/**
 * @internal Helper to callwlate memory size required to store given
 * number of objects.
 *
...
/**
 * Default way to callwlate memory size required to store given number of
 * objects.
 *
 ...
 * @param[in] obj_cb
 *   Callback function to be exelwted for each populated object.
 * @param[in] obj_cb_arg
...
struct rte_mempool_ops {
	...
	/**
	 * Optional callback to callwlate memory size required to
 ...
 * API to callwlate size of memory required to store specified number of
 * object.
 *
 * @param[in] mp
 *   Pointer to the memory pool.
 ...
 *   - -EILWAL - Invalid ops struct name provided.
 ...
 *   - -EILWAL - some missing callbacks while registering ops struct.
 ...
 *    - EILWAL - cache size provided is too large
 ...
 * callwlates header, trailer, body and total sizes of the mempool object.
 *
 * @param elt_size
 ...
 *   The size of each element.
 * @param sz
 *   The callwlated detailed size the mempool object. May be NULL.
 * @return
