...
rte_mempool_populate_default(struct rte_mempool *mp)
{
	...
	/*
	 * the following section callwlates page shift and page size values.
	 *
	...
	void *opaque)
{
	...
	/*
	 * Callwlate size since memhdr->len has contiguous chunk length
	 * which may be smaller if anon map is split into many contiguous
	 * chunks. Result must be the same as we callwlated on populate.
	 */
	...
	int socket_id, unsigned flags)
{
	...
	/* callwlate mempool object sizes. */
