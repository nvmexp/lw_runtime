 ...
 * lwrrently at least one user (i.e. MTR object) of this profile.
 *
 * @param[in] port_id
 *   The port identifier of the Ethernet device.
 * @param[in] meter_profile_id
 ...
 * MTR object destroy
 *
 * Delete an existing MTR object. This operation fails when there is lwrrently
 ...
 *   lwrrently enabled for this MTR object, indicating which of the counters
