...
struct rte_meter_srtcm {
	...
	uint64_t tc;   /* Number of bytes lwrrently available in the committed (C) token bucket */
	uint64_t te;   /* Number of bytes lwrrently available in the excess (E) token bucket */
};
...
struct rte_meter_trtcm {
	...
	uint64_t tc;
	/**< Number of bytes lwrrently available in committed(C) token bucket */
	uint64_t tp;
	/**< Number of bytes lwrrently available in the peak(P) token bucket */
};
...
struct rte_meter_trtcm_rfc4115 {
	...
	/**< Number of bytes lwrrently available in committed(C) token bucket */
	uint64_t te;
	/**< Number of bytes lwrrently available in the excess(E) token bucket */
};
