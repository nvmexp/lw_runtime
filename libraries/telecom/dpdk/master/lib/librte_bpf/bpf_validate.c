	...
	struct bpf_reg_val *rv)
{
	...
	if (RTE_BPF_ARG_PTR_TYPE(arg->type) != 0) {
		 ...
		 * as an argument, mark stack space it oclwpies as initialized.
		 */
 ...
 * and it fields don't violate partciular instrlwtion type restrictions.
 */
static const char *
