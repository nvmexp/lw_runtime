...
/**
 * De-allocate all memory used by this eBPF exelwtion context.
 *
 * @param bpf
...
/**
 * Create a new eBPF exelwtion context and load given BPF code into it.
 *
 * @param prm
 *  Parameters used to create and initialise the BPF exelwtion context.
 * @return
...
/**
 * Create a new eBPF exelwtion context and load BPF code from given ELF
 * file into it.
 ...
 * @param sname
 *  Name of the exelwtable section within the file to load.
 * @return
 *   BPF handle that is used in future BPF operations,
 *   or NULL on error, with error code set in rte_errno.
 *   Possible rte_errno errors include:
