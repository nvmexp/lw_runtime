...
/*
 * vBF lwrrently implemented as a big array.
 ...
 *
 * Lwrrently the implementation supports vBF containing 1,2,4,8,16,32 BFs.
 */
int
		...
		const struct rte_member_parameters *params)
{
	...
	RTE_MEMBER_LOG(DEBUG, "vector bloom filter created, "
		...
		"The new callwlated vBF false positive rate is %.5f\n",
