...
enum rte_crypto_asym_xform_type {
	 ...
	 * Refer to rte_crypto_asym_op_type
	 */
	RTE_CRYPTO_ASYM_XFORM_MODILW,
	/**< Modular Multiplicative Ilwerse
	 * Perform Modular Multiplicative Ilwerse b^(-1) mod n
	 */
	...
	/**< Elliptic Lwrve Digital Signature Algorithm
	 * Perform Signature Generation and Verification.
	 */
	RTE_CRYPTO_ASYM_XFORM_ECPM,
	/**< Elliptic Lwrve Point Multiplication */
...
struct rte_crypto_rsa_priv_key_qt {
	...
	rte_crypto_param qIlw;
	/**< qIlw - Private CRT component
	 * Private CRT component of RSA parameter  required for CRT method
	 * RSA private key operations in Octet-string network byte order
	 * format.
	 * qIlw = ilw q mod p
...
/**
 * Asymmetric modular multiplicative ilwerse transform operation
 *
 * Structure describing modular multiplicative ilwerse transform
 *
 */
struct rte_crypto_modilw_xform {
	rte_crypto_param modulus;
	/**<
	 * Pointer to the modulus data for modular multiplicative ilwerse
	 ...
	 * in corresponding Modular Multiplicative Ilwerse
...
/**
 * Structure for elliptic lwrve point
 */
...
/**
 * Asymmetric elliptic lwrve transform data
 *
 * Structure describing all EC based xform params
 *
 */
struct rte_crypto_ec_xform {
	enum rte_crypto_ec_group lwrve_id;
	/**< Pre-defined ec groups */
};

/**
 * Operations params for modular operations:
 * exponentiation and multiplicative ilwerse
 *
 */
struct rte_crypto_mod_op_param {
	 ...
	 * ilwerse data in octet-string network byte order format
	 *
	 * In case Multiplicative Ilwerse is used this number shall
	 * be relatively prime to modulus in corresponding Modular
	 * Multiplicative Ilwerse rte_crypto_modilw_xform
	 */

	rte_crypto_param result;
	/**<
	 * Pointer to the result of modular exponentiation/multiplicative ilwerse
	 * data in octet-string network byte order format.
	 *
	 * This field shall be big enough to hold the result of Modular
	 * Exponentiation or Modular Multiplicative Ilwerse
...
struct rte_crypto_asym_xform {
	...
	union {
		...
		struct rte_crypto_modilw_xform modilw;
		/**< Modular Multiplicative Ilwerse xform parameters */
		...
		/**< EC xform parameters, used by elliptic lwrve based
		 * operations.
		 */
	};
};
...
struct rte_crypto_dh_op_param {
	...
	/**<
	 * Output with callwlated shared secret
...
struct rte_crypto_ecdsa_op_param {
	...
	rte_crypto_param r;
	/**< r component of elliptic lwrve signature
	 *     output : for signature generation
	 *     input  : for signature verification
	 */
	rte_crypto_param s;
	/**< s component of elliptic lwrve signature
	 *     output : for signature generation
	 *     input  : for signature verification
	 */
};
...
struct rte_crypto_asym_op {
	...
	union {
		...
		struct rte_crypto_mod_op_param modilw;
