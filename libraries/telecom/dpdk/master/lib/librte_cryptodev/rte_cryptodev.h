...
struct rte_cryptodev_asymmetric_xform_capability {
	...
	/**< Transform type: RSA/MODEXP/DH/DSA/MODILW */
...
#define	RTE_CRYPTODEV_FF_SELWRITY			(1ULL << 16)
 ...
 *	 - 1: qp was configured
 *	 - -EILWAL: device was not configured
 */
__rte_experimental
int
 ...
 *
 * The rte_cryptodev_enqueue_burst() function is ilwoked to place
 ...
 * @return
 *  - On success, zero.
 *  - -EILWAL if input parameters are invalid.
 ...
 * @return
 *  - 0 if successful.
 *  - -EILWAL if device is invalid or session is NULL.
 ...
 *				     called.
 *				- negative integer: Error oclwrred.
 * @return
