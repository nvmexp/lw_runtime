 ...
 * - PKT_RX_OUTER_L4_CKSUM_ILWALID: invalid outer L4 checksum state.
 *
...
#define PKT_RX_OUTER_L4_CKSUM_ILWALID	((1ULL << 21) | (1ULL << 22))
 ...
 * So, for mbufs that planned to be ilwolved into RX/TX, the recommended
...
#define RTE_MBUF_PORT_ILWALID UINT16_MAX
/** For backwards compatibility. */
#define MBUF_ILWALID_PORT RTE_MBUF_PORT_ILWALID
 ...
 *   The packet mbuf.
 * @param o
 *   The offset into the data to callwlate address from.
 */
