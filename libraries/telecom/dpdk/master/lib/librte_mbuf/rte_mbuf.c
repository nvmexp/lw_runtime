...
/* colwert multi-segment mbuf to single mbuf */
int
...
const char *rte_get_rx_ol_flag_name(uint64_t mask)
{
	...
	case PKT_RX_OUTER_L4_CKSUM_ILWALID:
		return "PKT_RX_OUTER_L4_CKSUM_ILWALID";
...
rte_get_rx_ol_flag_list(uint64_t mask, char *buf, size_t buflen)
{
	const struct flag_mask rx_flags[] = {
		...
		{ PKT_RX_OUTER_L4_CKSUM_GOOD, PKT_RX_OUTER_L4_CKSUM_MASK,
		  NULL },
		{ PKT_RX_OUTER_L4_CKSUM_ILWALID, PKT_RX_OUTER_L4_CKSUM_MASK,
		  NULL },
