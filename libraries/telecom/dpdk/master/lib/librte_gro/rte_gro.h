...
/**< the number of lwrrently supported GRO types */
 ...
 * checksums and doesn't re-callwlate checksums for merged packets.
 ...
 * re-callwlate checksums for merged packets. Additionally, it assumes
 ...
 * this function doesn't re-callwlate checksums for merged packets.
 *
 * @param ctx
 *  GRO context object pointer.
