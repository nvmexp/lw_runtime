 ...
 * This function is used for flow based latency callwlations.
 *
 * @param pkt
 ...
 *  Used for flow based latency callwlation.
 *  If the value is NULL, global stats will be callwlated,
 *  else flow based latency stats will be callwlated.
...
/**
 * Callwlates the latency and jitter values internally, exposing the updated
