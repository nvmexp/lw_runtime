...
/**
 * Unlinks in progress. Returns number of unlinks that the PMD is lwrrently
...
/**
 * Colwerts nanoseconds to *timeout_ticks* value for rte_event_dequeue()
 *
 * @param dev
 *   Event device pointer
 * @param ns
...
/**
 * Add ethernet Rx queues to event device. This callback is ilwoked if
...
/**
 * Delete ethernet Rx queues from event device. This callback is ilwoked if
...
/**
 * Start ethernet Rx adapter. This callback is ilwoked if
 * the caps returned from eventdev_eth_rx_adapter_caps_get(.., eth_port_id)
...
/**
 * Stop ethernet Rx adapter. This callback is ilwoked if
 * the caps returned from eventdev_eth_rx_adapter_caps_get(..,eth_port_id)
 * has RTE_EVENT_ETH_RX_ADAPTER_CAP_INTERNAL_PORT set and Rx queues
 * from eth_port_id have been added to the event device.
 *
 ...
 * This API may change without prior notice
 *
 * Add crypto queue pair to event device. This callback is ilwoked if
 ...
 * This API may change without prior notice
 *
 * Delete crypto queue pair to event device. This callback is ilwoked if
 * the caps returned from rte_event_crypto_adapter_caps_get(, cdev_id)
 * has RTE_EVENT_CRYPTO_ADAPTER_CAP_INTERNAL_PORT_* set.
 *
 * @param dev
...
/**
 * Start crypto adapter. This callback is ilwoked if
 * the caps returned from rte_event_crypto_adapter_caps_get(.., cdev_id)
...
/**
 * Stop crypto adapter. This callback is ilwoked if
 * the caps returned from rte_event_crypto_adapter_caps_get(.., cdev_id)
 * has RTE_EVENT_CRYPTO_ADAPTER_CAP_INTERNAL_PORT_* set and queue pairs
 * from cdev_id have been added to the event device.
 *
...
struct rte_eventdev_ops {
	...
	/**< Colwerts ns to *timeout_ticks* value for rte_event_dequeue() */
