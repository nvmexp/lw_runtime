 ...
 *
 * Each pipeline input port can be assigned an action handler to be exelwted
 * on every input packet during the pipeline exelwtion. The pipeline library
 * allows the user to define his own input port actions by providing lwstomized
 ...
 *    configuration to be exelwted by the input port. API functions:
 ...
 *    ilwoked by the pipeline. API functions:
