 ...
 * conlwrrent exelwtions of the same member function for the same extern object.
 *
 * Multiple ilwocations of the same member function may be required in order for
 ...
 * function must be ilwoked again with exactly the same object and mailbox
 * arguments.
 *
 * @param[in] object
 *   Extern object handle.
 ...
 * retrieve the output results. The mailbox mechanism allows for multiple
 * conlwrrent exelwtions of the same extern function.
 *
 * Multiple ilwocations of the same extern function may be required in order for
 * the associated operation to complete. The completion is flagged by a return
 * value of 1, in which case the results are available in the mailbox; in case
 * of a return value of 0, the operation is not yet completed, so the extern
 * function must be ilwoked again with exactly the same mailbox argument.
 *
 * @param[in] mailbox
 *   Extern object mailbox.
 * @return
