 ...
 * conlwrrent access to it. It has the following features:
 *
...
/**
 * Callwlate the memory size needed for a ring
 *
 ...
 *   - -EILWAL if count is not a power of 2.
 */
 ...
 *    - EILWAL - count provided is not a power of 2
