...
/**
 * Colwert guest physical address to host virtual address
 *
...
/**
 * Colwert guest physical address to host virtual address safely
 *
 ...
 *
 * This function only need be ilwoked when the live migration starts.
 ...
 * - it must be ilwoked before vhost-user negotiation starts.
 *
 * @param path
 *  The vhost-user socket file path
 * @param features
