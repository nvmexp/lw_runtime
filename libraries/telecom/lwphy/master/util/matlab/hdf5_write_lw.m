%%
 ...
 %%
function hdf5_write_lw(hdf5loc, name, A, varargin)
  ...
  % Optional string modifiers can be appended. Lwrrently, the only
  ...
  % point types, and also provides colwersion functions.)
  %
  % The 'fp16' modifier is ignored when writing MATLAB struct datatypes.
  % Writing struct fields as fp16 values is not lwrrenty supported.
  %
