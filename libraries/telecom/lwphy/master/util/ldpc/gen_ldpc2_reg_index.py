...
lwphyStatus_t decode_ldpc2_reg_index_half_BG1_Z{Z}(ldpc::decoder&            dec,
...
lwphyStatus_t decode_ldpc2_reg_index_float_BG1_Z{Z}(ldpc::decoder&            dec,
                                                   const LDPC_config&        cfg,
                                                   const LDPC_kernel_params& params,
                                                   const dim3&               grdDim,
                                                   const dim3&               blkDim,
...
lwphyStatus_t decode_ldpc2_reg_index_half_BG2_Z{Z}(ldpc::decoder&             dec,
                                                   const LDPC_config&        cfg,
                                                   const LDPC_kernel_params& params,
                                                   const dim3&               grdDim,
                                                   const dim3&               blkDim,
...
lwphyStatus_t decode_ldpc2_reg_index_float_BG2_Z{Z}(ldpc::decoder&            dec,
                                                    const LDPC_config&        cfg,
                                                    const LDPC_kernel_params& params,
                                                    const dim3&               grdDim,
                                                    const dim3&               blkDim,
...
for Z_val in Z_lwrrent:
    ...
    fname = 'ldpc2_reg_index_BG1_Z%d.lw' % Z_val
...
for Z_val in Z_lwrrent:
    ...
    sub_dict = {'Z':                 str(Z_val),
                ...
                'float_guard_begin': guard_dict_begin[(False, Z_val in Z_optional)],
                'float_guard_end':   guard_dict_end  [(False, Z_val in Z_optional)]}
    fname = 'ldpc2_reg_index_BG2_Z%d.lw' % Z_val
