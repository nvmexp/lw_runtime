...
typedef volatile struct _clc7b5_tag0 {
    ...
    LwV32 Reserved06[0x1C];
    LwV32 LaunchDma;                                                            // 0x00000300 - 0x00000303
    LwV32 Reserved07[0x3F];
...
#define LWC7B5_SET_GLOBAL_COUNTER_UPPER                                         (0x00000280)
#define LWC7B5_SET_GLOBAL_COUNTER_UPPER_V                                       31:0
#define LWC7B5_SET_GLOBAL_COUNTER_LOWER                                         (0x00000284)
#define LWC7B5_SET_GLOBAL_COUNTER_LOWER_V                                       31:0
#define LWC7B5_SET_PAGEOUT_START_PAUPPER                                        (0x00000288)
#define LWC7B5_SET_PAGEOUT_START_PAUPPER_V                                      4:0
#define LWC7B5_SET_PAGEOUT_START_PALOWER                                        (0x0000028C)
#define LWC7B5_SET_PAGEOUT_START_PALOWER_V                                      31:0
...
#define LWC7B5_LAUNCH_DMA_VPRMODE_VPR_VID2SYS                                   (0x00000002)
#define LWC7B5_LAUNCH_DMA_VPRMODE_VPR_SYS2VID                                   (0x00000003)
