...
** the NUL, or (JSUint32)-1 if an error oclwrs.
*/
...
** the stuff function, or (JSUint32)-1 if an error oclwrs.
*/
...
**     colwersions, and stores the colwerted values in the data objects
...
**     const char *fmt
**         the format control string for the colwersions
**     ...
**         variable number of arguments, each of them is a pointer to
**         a data object in which the colwerted value will be stored
** OUTPUTS: none
** RETURNS: JSInt32
**     The number of values colwerted and stored.
** RESTRICTIONS:
