...
/***********************************************************************
** MACROS:      JSLL_<colwersion operators>
**
**  JSLL_L2I            Colwert to signed 32 bit
**  JSLL_L2UI           Colwert to unsigned 32 bit
**  JSLL_L2F            Colwert to floating point
**  JSLL_L2D            Colwert to floating point
**  JSLL_I2L            Colwert signed to 64 bit
**  JSLL_UI2L           Colwert unsigned to 64 bit
**  JSLL_F2L            Colwert float to 64 bit
**  JSLL_D2L            Colwert float to 64 bit
***********************************************************************/
