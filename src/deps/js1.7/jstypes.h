...
**
** Prototypes and macros used to make up for deficiencies in ANSI elwironments
** that we have found.
**
...
//#define JS_USE_STRONGLY_TYPED_JSVAL_AND_JSID
#endif
...
#if defined(_WIN32_DLL) && !defined(__MWERKS__)
...
**              JS_UINT32_TO_PTR
** DESCRIPTION:
** Integer to pointer and pointer to integer colwersion macros.
***********************************************************************/
#define JS_PTR_TO_INT32(x)  ((jsint)((const char *)(x) - (const char *)0))
#define JS_PTR_TO_UINT32(x) ((jsuint)((const char *)(x) - (const char *)0))
