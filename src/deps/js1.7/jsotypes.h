 ...
 * possible time. The NSPR API is implemented and dolwmented using
 * the new definitions.
 */
...
#if defined(XP_UNIX) && !defined(__QNXNTO__) && !defined(DJGPP)
#include <sys/types.h>
#else
...
typedef JSUintn uintn;
#if !defined(LW_UINT64_DEF)
#define LW_UINT64_DEF
