...
typedef JSHashNumber (* JS_DLL_CALLBACK JSHashFunction)(const void *key, void *closure);
typedef intN (* JS_DLL_CALLBACK JSHashKeyComparator)(const void *v1, const void *v2, void *closure);
typedef intN (* JS_DLL_CALLBACK JSHashValueComparator)(const void *v1, const void *v2);
...
struct JSHashTable {
    ...
    void                 *keyHashData;
    JSHashKeyComparator   keyCompare;     /* key comparison function */
    void                 *keyCompareData;
    JSHashValueComparator valueCompare;   /* value comparison function */
...
JS_NewHashTable(uint32 n, JSHashFunction keyHash, void *keyHashData,
                JSHashKeyComparator keyCompare, void *keyCompareData,
                JSHashValueComparator valueCompare, JSHashAllocOps *allocOps,
                void *allocPriv);
...
JS_HashString(const void *key, void *);

/* Stub function just returns v1 == v2 */
extern JS_PUBLIC_API(intN)
JS_CompareHashKeys(const void *v1, const void *v2, void *);

/* Stub function just returns v1 == v2 */
extern JS_PUBLIC_API(intN)
JS_CompareHashValues(const void *v1, const void *v2);
