                     ...
                     void *closure)
{
    ...
    return jsd_CallExelwtionHook(jsdc, cx, JSD_HOOK_INTERRUPTED,
                                 hook, hookData, rval);
}
                    ...
                    jsval *rval, void *closure)
{
    ...
    return jsd_CallExelwtionHook(jsdc, cx, JSD_HOOK_DEBUGGER_KEYWORD,
                                 hook, hookData, rval);
}
                 ...
                 jsval *rval, void *closure)
{
    ...
    return jsd_CallExelwtionHook(jsdc, cx, JSD_HOOK_THROW,
                                 hook, hookData, rval);
}
