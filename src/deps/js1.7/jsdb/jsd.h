...
struct JSDContext
{
    ...
    void*                   scriptHookData;
    JSD_ExelwtionHookProc   interruptHook;
    void*                   interruptHookData;
    JSRuntime*              jsrt;
    JSD_ErrorReporter       errorReporter;
    void*                   errorReporterData;
    JSCList                 threadsStates;
    JSD_ExelwtionHookProc   debugBreakHook;
    void*                   debugBreakHookData;
    JSD_ExelwtionHookProc   debuggerHook;
    void*                   debuggerHookData;
    JSD_ExelwtionHookProc   throwHook;
    void*                   throwHookData;
...
struct JSDProfileData
{
    ...
    uintN    callCount;
    uintN    relwrseDepth;
    uintN    maxRelwrseDepth;
    jsdouble minExelwtionTime;
    jsdouble maxExelwtionTime;
    jsdouble totalExelwtionTime;
    jsdouble minOwnExelwtionTime;
    jsdouble maxOwnExelwtionTime;
    jsdouble totalOwnExelwtionTime;
};
...
/* Script exelwtion hook functions */
...
extern JSTrapStatus
jsd_CallExelwtionHook(JSDContext*           jsdc,
                      JSContext*            cx,
                      uintN                 type,
                      JSD_ExelwtionHookProc hook,
                      void*                 hookData,
...
#define JSD_LWRRENT_THREAD()        jsd_LwrrentThread()

#else  /* !JSD_THREADSAFE */

#define JSD_LWRRENT_THREAD()        ((void*)0)
...
#define JSD_IS_DANGEROUS_THREAD(jsdc) \
    (JSD_LWRRENT_THREAD() == jsdc->dangerousThread)
