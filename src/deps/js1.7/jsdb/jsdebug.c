...
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    return jsd_GetScriptMaxRelwrseDepth(jsdc, script);
}
...
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    return jsd_GetScriptMinExelwtionTime(jsdc, script);
}
...
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    return jsd_GetScriptMaxExelwtionTime(jsdc, script);
}
...
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    return jsd_GetScriptTotalExelwtionTime(jsdc, script);
}
...
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    return jsd_GetScriptMinOwnExelwtionTime(jsdc, script);
}
...
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    return jsd_GetScriptMaxOwnExelwtionTime(jsdc, script);
}
...
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    return jsd_GetScriptTotalOwnExelwtionTime(jsdc, script);
}
                     ...
                     void*                 callerdata)
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    JSD_ASSERT_VALID_SCRIPT(jsdscript);
    return jsd_SetExelwtionHook(jsdc, jsdscript, pc, hook, callerdata);
}
                       ...
                       jsuword              pc)
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    JSD_ASSERT_VALID_SCRIPT(jsdscript);
    return jsd_ClearExelwtionHook(jsdc, jsdscript, pc);
}
...
JSD_ClearAllExelwtionHooksForScript(JSDContext* jsdc, JSDScript* jsdscript)
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    JSD_ASSERT_VALID_SCRIPT(jsdscript);
    return jsd_ClearAllExelwtionHooksForScript(jsdc, jsdscript);
}
...
{
    JSD_ASSERT_VALID_CONTEXT(jsdc);
    return jsd_ClearAllExelwtionHooks(jsdc);
}
