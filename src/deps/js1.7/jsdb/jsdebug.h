...
* JSD_SCRIPT_DEBUG_BIT, the exelwtion hook is ignored.  Setting the
...
* will not be debugged (the exelwtion hook will not be ilwoked.)
*
...
*/
extern JSD_PUBLIC_API(uintN)
JSD_GetScriptMaxRelwrseDepth(JSDContext* jsdc, JSDScript *script);

/*
* Get the shortest exelwtion time recorded.
*/
extern JSD_PUBLIC_API(jsdouble)
JSD_GetScriptMinExelwtionTime(JSDContext* jsdc, JSDScript *script);

/*
* Get the longest exelwtion time recorded.
*/
extern JSD_PUBLIC_API(jsdouble)
JSD_GetScriptMaxExelwtionTime(JSDContext* jsdc, JSDScript *script);

/*
* Get the total amount of time spent in this script.
*/
extern JSD_PUBLIC_API(jsdouble)
JSD_GetScriptTotalExelwtionTime(JSDContext* jsdc, JSDScript *script);

/*
* Get the shortest exelwtion time recorded, excluding time spent in called
* functions.
*/
extern JSD_PUBLIC_API(jsdouble)
JSD_GetScriptMinOwnExelwtionTime(JSDContext* jsdc, JSDScript *script);

/*
* Get the longest exelwtion time recorded, excluding time spent in called
* functions.
*/
extern JSD_PUBLIC_API(jsdouble)
JSD_GetScriptMaxOwnExelwtionTime(JSDContext* jsdc, JSDScript *script);
...
*/
extern JSD_PUBLIC_API(jsdouble)
JSD_GetScriptTotalOwnExelwtionTime(JSDContext* jsdc, JSDScript *script);
...
* of the first bit of exelwtable code for this line of source. This 'pc' should 
...
* This function can be used to set breakpoints -- see JSD_SetExelwtionHook
*/
...
JSD_AppendUCSourceText(JSDContext*     jsdc,
                       ...
                       JSDSourceStatus status);
/*
 * Colwienence function for adding complete source of url in one call.
 * same as:
 *   JSDSourceText* jsdsrc;
...
/***************************************************************************/
/* Exelwtion/Interrupt Hook functions */

/* possible 'type' params for JSD_ExelwtionHookProc */
...
/* legal return values for JSD_ExelwtionHookProc */
...
/*
* Implement a callback of this form in order to hook exelwtion.
*/
typedef uintN
(* JS_DLL_CALLBACK JSD_ExelwtionHookProc)(JSDContext*     jsdc,
...
/*
* Set Hook to be called whenever the given pc is about to be exelwted --
* i.e. for 'trap' or 'breakpoint'
*/
extern JSD_PUBLIC_API(JSBool)
JSD_SetExelwtionHook(JSDContext*           jsdc,
                     JSDScript*            jsdscript,
                     jsuword               pc,
                     JSD_ExelwtionHookProc hook,
                     void*                 callerdata);
...
*/
extern JSD_PUBLIC_API(JSBool)
JSD_ClearExelwtionHook(JSDContext*          jsdc,
                       JSDScript*           jsdscript,
                       jsuword              pc);
...
*/
extern JSD_PUBLIC_API(JSBool)
JSD_ClearAllExelwtionHooksForScript(JSDContext* jsdc, JSDScript* jsdscript);
...
*/
extern JSD_PUBLIC_API(JSBool)
JSD_ClearAllExelwtionHooks(JSDContext* jsdc);

/*
* Set a hook to be called before the next instruction is exelwted. Depending
* on the threading situation and whether or not an JS code is lwrrently
* exelwting the hook might be called before this call returns, or at some
* future time. The hook will continue to be called as each instruction
* exelwtes until cleared.
*/
extern JSD_PUBLIC_API(JSBool)
...
* encountered by the JavaScript interpreter during exelwtion.
*/
extern JSD_PUBLIC_API(JSBool)
...
/*
* Get the name of the function exelwting in this stack frame.  Especially useful
...
/*
* Colwert the given jsval to a string
* NOTE: The ErrorReporter hook might be called if this fails.
*/
...
/*
* Get the JSDValue lwrrently being thrown as an exception (may be NULL).
...
/*
* Set the JSDValue lwrrently being thrown as an exception.
* *** new for version 1.1 ****
*/
extern JSD_PUBLIC_API(JSBool)
...
/*
* Return JSBool value (does NOT do colwersion).
* *** new for version 1.1 ****
*/
extern JSD_PUBLIC_API(JSBool)
...
/*
* Return int32 value (does NOT do colwersion).
* *** new for version 1.1 ****
*/
...
/*
* Return double value (does NOT do colwersion).
* *** new for version 1.1 ****
*/
extern JSD_PUBLIC_API(jsdouble*)
...
/*
* Return JSString value (DOES do colwersion if necessary).
...
#define JSDPD_EXCEPTION  JSPD_EXCEPTION    /* exception oclwrred looking up */
