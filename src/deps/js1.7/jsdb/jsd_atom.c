...
JS_STATIC_DLL_CALLBACK(intN)
_compareAtomKeys(const void *v1, const void *v2, void *closure)
{
...
{
    return 0 == strcmp(((const JSDAtom*)v1)->str, ((const JSDAtom*)v2)->str);
}        
...
{
    jsdc->atoms = JS_NewHashTable(256, JS_HashString, NULL, _compareAtomKeys, NULL, _compareAtoms,
                                  NULL, NULL);
#ifdef TEST_ATOMS
    _testAtoms(jsdc);
#endif    
    return jsdc->atoms != 0 ? JS_TRUE : JS_FALSE;
}
