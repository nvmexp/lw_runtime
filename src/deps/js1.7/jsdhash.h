 ...
 * and 1 values.  The stored keyHash value is table size ilwariant, and it is
...
/*
 * A JSDHashTable is lwrrently 8 words (without the JS_DHASHMETER overhead)
 ...
 *
 * To see these lwrves, feed gnuplot input like so:
 *
 ...
 * ilwoked during a JS_DHASH_REMOVE operation (see below for operation codes),
