 ...
 * to avoid relwrsion when processing expression chains.
...
struct JSParseNode {
    ...
    union {
        struct {                        /* TOK_FUNCTION node */
            ...
            uint32      flags;          /* aclwmulated tree context flags */
...
#define PNX_FORILWAR    0x08            /* TOK_VAR is left kid of TOK_IN node,
