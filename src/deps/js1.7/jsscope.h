 ...
 * until a "middle delete" oclwrs, we use linear search from scope->lastProp
...
#define SPROP_ILWALID_SLOT              0xffffffff
...
#define SPROP_GET(cx,sprop,obj,obj2,vp)                                                                \
    (((sprop)->attrs & JSPROP_GETTER)                                                                  \
     ? js_InternalGetOrSet(cx, obj, (sprop)->id,                                                       \
                           OBJECT_TO_JSVAL(reinterpret_cast<JSObject *>((sprop)->getter)), JSACC_READ, \
                           0, 0, vp)                                                                   \
...
#define SPROP_SET(cx,sprop,obj,obj2,vp)                                                                 \
    (((sprop)->attrs & JSPROP_SETTER)                                                                   \
     ? js_InternalGetOrSet(cx, obj, (sprop)->id,                                                        \
                           OBJECT_TO_JSVAL(reinterpret_cast<JSObject *>((sprop)->setter)), JSACC_WRITE, \
                           1, vp, vp)                                                                   \
     : ((sprop)->attrs & JSPROP_GETTER)                                                                 \
