...
#if defined(__arm) || defined(__arm32__) || defined(__arm26__) || defined(__arm__) || defined(__aarch64__)
#define CPU_IS_ARM
#endif
...
/* Colwert a number to a GC'ed string. */
extern JSString *
js_NumberToString(JSContext *cx, jsdouble d);

/*
 * Colwert a value to a number, returning false after reporting any error,
...
/*
 * Colwert a value or a double to an int32, according to the ECMA rules
 * for ToInt32.
 */
extern JSBool
...
/*
 * Colwert a value or a double to a uint32, according to the ECMA rules
 * for ToUint32.
 */
extern JSBool
...
/*
 * Colwert a value to a number, then to a uint16 according to the ECMA rules
 * for ToUint16.
 */
extern JSBool
...
/*
 * Colwert a jsdouble to an integral number, stored in a jsdouble.
 * If d is NaN, return 0.  If d is an infinity, return it without colwersion.
 */
extern jsdouble
