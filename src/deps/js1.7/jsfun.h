...
struct JSFunction {
    ...
    union {
        ...
        struct {
            uint16   lwars;     /* number of local variables */
 ...
 * fact that JSILWOKE_CONSTRUCT (aka JSFRAME_CONSTRUCTING) is 1, and test that
 * with #if/#error in jsfun.c.
 */
#define JSV2F_CONSTRUCT         JSILWOKE_CONSTRUCT
#define JSV2F_ITERATOR          JSILWOKE_ITERATOR
