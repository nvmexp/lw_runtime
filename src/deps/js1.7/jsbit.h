...
#define JS_TEST_BIT(_map,_bit) \
    ((_map)[(_bit)>>JS_BITS_PER_WORD_LOG2] & (((jsbitmap)1) << ((_bit) & (JS_BITS_PER_WORD-1))))
 ...
 * The built-in allows to speedup callwlations of ceiling/floor log2,
 * see bug 327129.
 */
...
/*
 * Use __builtin_clz or count-leading-zeros to callwlate ceil(log2(_n)).
...
*/
#if defined(JS_GCC_HAS_BUILTIN_CLZ) && JS_GCC_HAS_BUILTIN_CLZ
/*
 * Use __builtin_clz or count-leading-zeros to callwlate floor(log2(_n)).
