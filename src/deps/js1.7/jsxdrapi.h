...
#define JSXDR_MAGIC_SCRIPT_LWRRENT  JSXDR_MAGIC_SCRIPT_5
 ...
 * the current version, abort deserialization and ilwalidate the file.
 */
 ...
 * colwersion. Do not use it in the new code! See bug 325202.
 */
extern JSBool
