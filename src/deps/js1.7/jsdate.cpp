...
date_parseString(JSString *str, jsdouble *result)
{
    ...
    while (i < limit) {
        ...
        if ('0' <= c && c <= '9') {
            ...
            for (k = (sizeof(wtb)/sizeof(char*)); --k >= 0;)
                if (date_regionMatches(wtb[k], 0, s, (int)st, (int)(i-st), 1)) {
                    int action = ttb[k];
                    if (action != 0) {
                        if (action < 0) {
                            /*
    ...
    */
    ...
    mon -= 1; /* colwert month to 0-based */
    if (sec < 0)
        sec = 0;
    if (min < 0)
        min = 0;
                    ...
                    jsval *argv, jsval *rval, const char *format)
{
    ...
    if (!JSDOUBLE_IS_FINITE(*date)) {
        ...
        result_len = (intN)PRMJ_FormatTime(buf, (intN)(sizeof buf), format, &split);
             ...
             jsval *rval)
{
    ...
    /* If called directly with no arguments, colwert to a time number. */
    if (argc == 0)
        return date_getTime(cx, obj, argc, argv, rval);

    /* Colwert to number only if the hint was given, otherwise favor string. */
    if (argc == 1) {
        JSString *str, *str2;
...
static JSFunctionSpec date_static_methods[] = {
    {MKJSID("UTC"),               date_UTC,               MAXARGS,0,0 },
    {MKJSID("parse"),             date_parse,             1,0,0 },
    {MKJSID("now"),               date_now,               0,0,0 },
    {0,0,0,0,0}
};

static JSFunctionSpec date_methods[] = {
    {MKJSID("getTime"),             date_getTime,           0,0,0 },
    {MKJSID("getTimezoneOffset"),   date_getTimezoneOffset, 0,0,0 },
    {MKJSID("getYear"),             date_getYear,           0,0,0 },
    {MKJSID("getFullYear"),         date_getFullYear,       0,0,0 },
    {MKJSID("getUTCFullYear"),      date_getUTCFullYear,    0,0,0 },
    {MKJSID("getMonth"),            date_getMonth,          0,0,0 },
    {MKJSID("getUTCMonth"),         date_getUTCMonth,       0,0,0 },
    {MKJSID("getDate"),             date_getDate,           0,0,0 },
    {MKJSID("getUTCDate"),          date_getUTCDate,        0,0,0 },
    {MKJSID("getDay"),              date_getDay,            0,0,0 },
    {MKJSID("getUTCDay"),           date_getUTCDay,         0,0,0 },
    {MKJSID("getHours"),            date_getHours,          0,0,0 },
    {MKJSID("getUTCHours"),         date_getUTCHours,       0,0,0 },
    {MKJSID("getMinutes"),          date_getMinutes,        0,0,0 },
    {MKJSID("getUTCMinutes"),       date_getUTCMinutes,     0,0,0 },
    {MKJSID("getSeconds"),          date_getUTCSeconds,     0,0,0 },
    {MKJSID("getUTCSeconds"),       date_getUTCSeconds,     0,0,0 },
    {MKJSID("getMilliseconds"),     date_getUTCMilliseconds,0,0,0 },
    {MKJSID("getUTCMilliseconds"),  date_getUTCMilliseconds,0,0,0 },
    {MKJSID("setTime"),             date_setTime,           1,0,0 },
    {MKJSID("setYear"),             date_setYear,           1,0,0 },
    {MKJSID("setFullYear"),         date_setFullYear,       3,0,0 },
    {MKJSID("setUTCFullYear"),      date_setUTCFullYear,    3,0,0 },
    {MKJSID("setMonth"),            date_setMonth,          2,0,0 },
    {MKJSID("setUTCMonth"),         date_setUTCMonth,       2,0,0 },
    {MKJSID("setDate"),             date_setDate,           1,0,0 },
    {MKJSID("setUTCDate"),          date_setUTCDate,        1,0,0 },
    {MKJSID("setHours"),            date_setHours,          4,0,0 },
    {MKJSID("setUTCHours"),         date_setUTCHours,       4,0,0 },
    {MKJSID("setMinutes"),          date_setMinutes,        3,0,0 },
    {MKJSID("setUTCMinutes"),       date_setUTCMinutes,     3,0,0 },
    {MKJSID("setSeconds"),          date_setSeconds,        2,0,0 },
    {MKJSID("setUTCSeconds"),       date_setUTCSeconds,     2,0,0 },
    {MKJSID("setMilliseconds"),     date_setMilliseconds,   1,0,0 },
    {MKJSID("setUTCMilliseconds"),  date_setUTCMilliseconds,1,0,0 },
    {MKJSID("toUTCString"),         date_toGMTString,       0,0,0 },
    {js_toLocaleString_str,         date_toLocaleString,    0,0,0 },
    {MKJSID("toLocaleDateString"),  date_toLocaleDateString,0,0,0 },
    {MKJSID("toLocaleTimeString"),  date_toLocaleTimeString,0,0,0 },
    {MKJSID("toLocaleFormat"),      date_toLocaleFormat,    1,0,0 },
    {MKJSID("toDateString"),        date_toDateString,      0,0,0 },
    {MKJSID("toTimeString"),        date_toTimeString,      0,0,0 },
#if JS_HAS_TOSOURCE
...
js_InitDateClass(JSContext *cx, JSObject *obj)
{
    ...
    if (!JS_AliasProperty(cx, proto, MKJSID("toUTCString"), MKJSID("toGMTString")))
        return NULL;
