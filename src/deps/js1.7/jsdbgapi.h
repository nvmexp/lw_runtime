...
JS_GetFrameReturlwalue(JSContext *cx, JSStackFrame *fp);

extern JS_PUBLIC_API(void)
JS_SetFrameReturlwalue(JSContext *cx, JSStackFrame *fp, jsval rval);
...
#define JSPD_EXCEPTION  0x40    /* exception oclwrred fetching the property, */
                                /* value is exception */
...
extern JS_PUBLIC_API(JSBool)
JS_SetExelwteHook(JSRuntime *rt, JSInterpreterHook hook, void *closure);
...
extern JS_PUBLIC_API(JSBool)
JS_SetConcatHook(JSRuntime *rt, JSConcatHook hook, void *closure);

extern JS_PUBLIC_API(JSBool)
JS_SetStrFinalizeHook(JSRuntime *rt, JSFinalizeStrHook hook, void *closure);

extern JS_PUBLIC_API(JSBool)
JS_SetEvalHook(JSRuntime *rt, JSEvalHook hook, void *closure);

extern JS_PUBLIC_API(JSBool)
JS_SetAddPropHook(JSRuntime *rt, JSAddPropHook hook, void *closure);

extern JS_PUBLIC_API(JSBool)
JS_SetArrayJoinHook(JSRuntime *rt, JSArrayJoinHook hook, void *closure);

extern JS_PUBLIC_API(JSBool)
JS_SetCheckIndexHook(JSRuntime *rt, JSCheckIndexHook hook, void *closure);

extern JS_PUBLIC_API(JSBool)
JS_SetDefaultNumHook(JSRuntime *rt, JSDefaultNumHook hook, void *closure);

extern JS_PUBLIC_API(JSBool)
JS_SetExpandErrArgHook(JSRuntime *rt, JSExpandErrArgHook hook, void *closure);

extern JS_PUBLIC_API(JSBool)
JS_SetValDecompileHook(JSRuntime *rt, JSValDecompileHook hook, void *closure);

#if defined(__cplusplus) && (__cplusplus > 201103L || defined(_MSC_VER))
typedef std::remove_pointer_t<decltype(JS_SetDebuggerHandler)>  JS_SetDebuggerHandlerType;
typedef std::remove_pointer_t<decltype(JS_SetSourceHandler)>    JS_SetSourceHandlerType;
typedef std::remove_pointer_t<decltype(JS_SetExelwteHook)>      JS_SetExelwteHookType;
typedef std::remove_pointer_t<decltype(JS_SetCallHook)>         JS_SetCallHookType;
typedef std::remove_pointer_t<decltype(JS_SetObjectHook)>       JS_SetObjectHookType;
typedef std::remove_pointer_t<decltype(JS_SetThrowHook)>        JS_SetThrowHookType;
typedef std::remove_pointer_t<decltype(JS_SetDebugErrorHook)>   JS_SetDebugErrorHookType;
typedef std::remove_pointer_t<decltype(JS_SetStrFinalizeHook)>  JS_SetStrFinalizeHookType;
typedef std::remove_pointer_t<decltype(JS_SetEvalHook)>         JS_SetEvalHookType;
typedef std::remove_pointer_t<decltype(JS_SetAddPropHook)>      JS_SetAddPropHookType;
typedef std::remove_pointer_t<decltype(JS_SetArrayJoinHook)>    JS_SetArrayJoinHookType;
typedef std::remove_pointer_t<decltype(JS_SetCheckIndexHook)>   JS_SetCheckIndexHookType;
typedef std::remove_pointer_t<decltype(JS_SetDefaultNumHook)>   JS_SetDefaultNumHookType;
typedef std::remove_pointer_t<decltype(JS_SetExpandErrArgHook)> JS_SetExpandErrArgHookType;
typedef std::remove_pointer_t<decltype(JS_SetValDecompileHook)> JS_SetValDecompileHookType;
#endif
/************************************************************************/
