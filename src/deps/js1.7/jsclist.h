...
/*
** Remove the element "_e" from it's cirlwlar list.
*/
...
/*
** Remove the element "_e" from it's cirlwlar list. Also initializes the
** linkage.
*/
...
/*
** Return non-zero if the given cirlwlar list "_l" is empty, zero if the
** cirlwlar list is not empty
*/
#define JS_CLIST_IS_EMPTY(_l) \
    ((_l)->next == (_l))

/*
** Initialize a cirlwlar list
*/
