...
#define I2C_EEPROM_BUS_SV10              0x0
#define I2C_EEPROM_ADDRESS_SV10          0xA0
...
static LwlStatus _lwswitch_i2c_i2cPollHwUntilDoneOrTimeoutForStatus(lwswitch_device *device, LwU32 port);
 ...
 */
#define I2C_STRETCHED_LOW_TIMEOUT_NS_SV10 2000000

//
// E3600 bringup board
//
LWSWITCH_I2C_DEVICE_DESCRIPTOR_TYPE lwswitch_i2c_device_list_E3600_A01[] =
{
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0xA0, _AT24C02C,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // EEPROM
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0xB2, _CDFP_LOWER_PADDLE,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // lower paddle
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0xBA, _CDFP_UPPER_PADDLE,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // upper paddle
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0x98, _ADT7461,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // Thermal: mutually exclusive
//    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0x5C, _ADT7473  ),
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0x2A, _NCT3933U,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // VR shmoo DAC
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0x42, _TCA6408,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // GPIO expander

    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CB, 0xA0, _AT24C02C,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // EEPROM
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CB, 0xB2, _CDFP_LOWER_PADDLE,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // lower paddle
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CB, 0xBA, _CDFP_UPPER_PADDLE,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // upper paddle

    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CC, 0xA0, _AT24C02C,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // EEPROM
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CC, 0x82, _INA3221,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // INA3221 pin measurement
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CC, 0x84, _INA3221,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // INA3221 pin measurement

    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CD, 0xA0, _AT24C02C,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC))    // EEPROM
};

const LwU32 lwswitch_i2c_device_list_E3600_A01_size = LW_ARRAY_ELEMENTS(lwswitch_i2c_device_list_E3600_A01);

LWSWITCH_I2C_DEVICE_DESCRIPTOR_TYPE lwswitch_i2c_device_list_E3600_A02[] =
{
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0xA0, _AT24CM02,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // EEPROM
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0xB2, _CDFP_LOWER_PADDLE,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
...
//    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0x5C, _ADT7473  ),
    ...
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CB, 0xA0, _AT24CM02,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // EEPROM
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CB, 0xB2, _CDFP_LOWER_PADDLE,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
    ...
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CC, 0xA0, _AT24CM02,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC)),   // EEPROM
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CC, 0x82, _INA3221,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
    ...
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CD, 0xA0, _AT24CM02,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC))    // EEPROM
};

const LwU32 lwswitch_i2c_device_list_E3600_A02_size = LW_ARRAY_ELEMENTS(lwswitch_i2c_device_list_E3600_A02);

LWSWITCH_GPIO_INFO lwswitch_gpio_pin_E3600[] =
{
    LWSWITCH_DESCRIBE_GPIO_PIN(0x09, _THERMAL_ALERT, 22, ILW_IN),    // Thermal alert
    LWSWITCH_DESCRIBE_GPIO_PIN(0x08, _OVERTEMP,      23, ILW_IN)     // Thermal over temperature
};

const LwU32 lwswitch_gpio_pin_E3600_size = LW_ARRAY_ELEMENTS(lwswitch_gpio_pin_E3600);

//
// Explorer DGX board
//
LWSWITCH_I2C_DEVICE_DESCRIPTOR_TYPE lwswitch_i2c_device_list_Explorer[] =
{
    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CA, 0xA0, _AT24CM02,
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _READ_ACCESS_LEVEL, _PUBLIC) |
        DRF_DEF(_LWSWITCH, _I2C_DEVICE, _WRITE_ACCESS_LEVEL, _PUBLIC))            // EEPROM
//    LWSWITCH_DESCRIBE_I2C_DEVICE(_I2CB, 0x9E, _FPGA )              // FPGA
};

const LwU32 lwswitch_i2c_device_list_Explorer_size = LW_ARRAY_ELEMENTS(lwswitch_i2c_device_list_Explorer);

LWSWITCH_GPIO_INFO lwswitch_gpio_pin_Explorer[] =
{
    LWSWITCH_DESCRIBE_GPIO_PIN( 9, _THERMAL_ALERT, 22, ILW_IN),      // Thermal alert
    LWSWITCH_DESCRIBE_GPIO_PIN( 8, _OVERTEMP,      23, ILW_IN),      // Thermal over temperature
    LWSWITCH_DESCRIBE_GPIO_PIN( 2, _INSTANCE_ID0,   0, IN),          // Instance ID bit 0
    LWSWITCH_DESCRIBE_GPIO_PIN( 3, _INSTANCE_ID1,   0, IN),          // Instance ID bit 1
    LWSWITCH_DESCRIBE_GPIO_PIN( 4, _INSTANCE_ID2,   0, IN),          // Instance ID bit 2
    LWSWITCH_DESCRIBE_GPIO_PIN( 5, _INSTANCE_ID3,   0, IN),          // Instance ID bit 3
    LWSWITCH_DESCRIBE_GPIO_PIN( 6, _INSTANCE_ID4,   0, IN),          // Instance ID bit 4
    LWSWITCH_DESCRIBE_GPIO_PIN( 7, _INSTANCE_ID5,   0, IN),          // Instance ID bit 5
    LWSWITCH_DESCRIBE_GPIO_PIN(15, _INSTANCE_ID6,   0, IN),          // Instance ID bit 6
    LWSWITCH_DESCRIBE_GPIO_PIN(17, _INSTANCE_ID7,   0, IN),          // Instance ID bit 7
    LWSWITCH_DESCRIBE_GPIO_PIN(18, _INSTANCE_ID8,   0, IN),          // Instance ID bit 8
    LWSWITCH_DESCRIBE_GPIO_PIN( 0, _INSTANCE_ID9,   0, IN)           // Instance ID bit 9
};

const LwU32 lwswitch_gpio_pin_Explorer_size = LW_ARRAY_ELEMENTS(lwswitch_gpio_pin_Explorer);
...
static LwlStatus
_lwswitch_i2c_i2cTranslateRegAddr_HAL
(
...
//-----------------------------------------------------
// _lwswitch_i2c_i2cGetHwStatus_HAL
//
//-----------------------------------------------------
static void
_lwswitch_i2c_i2cGetHwStatus_HAL
...
)
{
    ...
    status = _lwswitch_i2c_i2cTranslateRegAddr_HAL(device, pmgrReg_i2cOverride,
             port, &regAddr);
    ...
    status = _lwswitch_i2c_i2cTranslateRegAddr_HAL(device, pmgrReg_i2cCntl,
             port, &regAddr);
    LWSWITCH_ASSERT(status == (LWL_SUCCESS) && regAddr);
    regData = LWSWITCH_OFF_RD32(device, regAddr);
    LWSWITCH_PRINT(device, ERROR,
    ...
    status = _lwswitch_i2c_i2cTranslateRegAddr_HAL(device, pmgrReg_i2cPoll,
             port, &regAddr);
    LWSWITCH_ASSERT(status == (LWL_SUCCESS) && regAddr);
    regData = LWSWITCH_OFF_RD32(device, regAddr);
    LWSWITCH_PRINT(device, ERROR,
    ...
    status = _lwswitch_i2c_i2cTranslateRegAddr_HAL(device, pmgrReg_i2cAddr,
             port, &regAddr);
    LWSWITCH_ASSERT(status == (LWL_SUCCESS) && regAddr);
    regData = LWSWITCH_OFF_RD32(device, regAddr);
    LWSWITCH_PRINT(device, ERROR,
    ...
    status = _lwswitch_i2c_i2cTranslateRegAddr_HAL(device, pmgrReg_i2cData,
             port, &regAddr);
    LWSWITCH_ASSERT(status == (LWL_SUCCESS) && regAddr);
    regData = LWSWITCH_OFF_RD32(device, regAddr);
    LWSWITCH_PRINT(device, ERROR,
    ...
    status = _lwswitch_i2c_i2cTranslateRegAddr_HAL(device, pmgrReg_i2cTiming,
             port, &regAddr);
    LWSWITCH_ASSERT(status == (LWL_SUCCESS) && regAddr);
    regData = LWSWITCH_OFF_RD32(device, regAddr);
    LWSWITCH_PRINT(device, ERROR,
 ...
 */
static LwU32
_lwswitch_i2c_i2cPollHwUntilDoneOrTimeout
(
    lwswitch_device *device,
    LwU32   port
)
{
    ...
    status = _lwswitch_i2c_i2cTranslateRegAddr_HAL(device,
        ...
        lwswitch_timeout_check(&timeout))
    {
        LWSWITCH_PRINT(device, ERROR,
            "Timeout waiting for CYCLE to be DONE on port: %d with CNTL: 0x%x\n",
             port, cntl);
        _lwswitch_i2c_i2cGetHwStatus_HAL(device, port);
    }
 ...
 */
static LwlStatus
_lwswitch_i2c_i2cHwStatusToI2cStatus_HAL
(
    lwswitch_device *device,
    LwU32 hwStatus
)
 ...
 */
static LwlStatus
_lwswitch_i2c_i2cSendStartViaHw_HAL
(
    lwswitch_device *device,
    LwU32 port
)
{
    ...
    return _lwswitch_i2c_i2cPollHwUntilDoneOrTimeoutForStatus(device, port);
}
 ...
 */
static LwlStatus
_lwswitch_i2c_i2cWriteByteViaHw_HAL
(
    lwswitch_device *device,
    LwU32 port,
    LwU32 data
 ...
 */
static LwlStatus
_lwswitch_i2c_i2cSendStopViaHw_HAL
(
    lwswitch_device *device,
    LwU32 port
)
 ...
 */
static LwU32
_lwswitch_i2c_i2cSendAddressViaHw_HAL
(
    lwswitch_device *device,
...
)
{
    ...
    switch (DRF_VAL(SWITCH_CTRL, _I2C_FLAGS, _ADDRESS_MODE, flags))
    {
        ...
        case LWSWITCH_CTRL_I2C_FLAGS_ADDRESS_MODE_7BIT:
            return _lwswitch_i2c_i2cWriteByteViaHw_HAL(device, port, (address | !bSending) & 0xFF);
        ...
        case LWSWITCH_CTRL_I2C_FLAGS_ADDRESS_MODE_10BIT:
            ...
            //
            status = _lwswitch_i2c_i2cWriteByteViaHw_HAL(device, port, (((address >> 9) << 1) & 0xF7) |
                     0xF0 | !bSending);
            LWSWITCH_CHECK_STATUS(device, status);
            if (status == LWL_SUCCESS)
            {
                status = _lwswitch_i2c_i2cWriteByteViaHw_HAL(device, port, (address >> 1) & 0xFF);
                LWSWITCH_CHECK_STATUS(device, status);
            }
            return status;
    }
 ...
 */
static void
_lwswitch_i2c_i2cHwShortWrite_HAL
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pParams
)
 ...
 */
static LwU32
_lwswitch_i2c_i2cHwInitCmdWrite_HAL
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pParams,
...
)
{
    ...
    {
        _lwswitch_i2c_i2cHwShortWrite_HAL(device, pParams);
        pCmd->cntl = 0;
        pCmd->data = 0;
    ...
    status = _lwswitch_i2c_i2cSendStartViaHw_HAL(device, port);

    if (status == LWL_SUCCESS)
    {
        status = _lwswitch_i2c_i2cSendAddressViaHw_HAL(device, pParams, LW_TRUE);
    }

    for (i = 0; (status == LWL_SUCCESS) && (i < indexLength); i++)
    {
        status = _lwswitch_i2c_i2cWriteByteViaHw_HAL(device, port, pParams->index[i]);
    }
        ...
        FLD_TEST_DRF(SWITCH_CTRL, _I2C_FLAGS, _RESTART, _SEND, flags))
    {
        ...
        if (status == LWL_SUCCESS)
        {
            (void)_lwswitch_i2c_i2cSendAddressViaHw_HAL(device, pParams, LW_TRUE);
        }
    }
    ...
    else // pParams->messageLength != 0
    {
        if (FLD_TEST_DRF(SWITCH_CTRL, _I2C_FLAGS, _BLOCK_PROTOCOL, _ENABLED, flags))
        {
            ...
            // failed!
            //
            (void)_lwswitch_i2c_i2cPollHwUntilDoneOrTimeout(device, port);
        }
...
static LwU32
_lwswitch_i2c_i2cHwWriteNext_HAL
(
    lwswitch_device *device,
    PLWSWITCH_I2C_HW_CMD pCmd
)
{
    ...
    status = _lwswitch_i2c_i2cHwStatusToI2cStatus_HAL(device,
 ...
 */
static void
_lwswitch_i2c_i2cHwReadPrep_HAL
(
    lwswitch_device *device,
    PLWSWITCH_I2C_HW_CMD pCmd,
 ...
 */
static void
_lwswitch_i2c_i2cHwInitCmdReadWithShortIndex_HAL
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pParams,
    PLWSWITCH_I2C_HW_CMD          pCmd,
...
static LwU32
_lwswitch_i2c_i2cHwReadNext_HAL
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pParams,
    PLWSWITCH_I2C_HW_CMD          pCmd,
...
)
{
    ...
    if (status == LWL_SUCCESS)
    {
        ...
        {
            _lwswitch_i2c_i2cHwReadPrep_HAL(device, pCmd, pCmd->bytesRemaining);
...
)
{
    ...
    if (status == LWL_SUCCESS)
    {
        status = _lwswitch_i2c_i2cWriteByteViaHw_HAL(device, port, offset);
        LWSWITCH_CHECK_STATUS(device, status);
    }
    ...
    {
        (void)_lwswitch_i2c_i2cSendStopViaHw_HAL(device, port);
    }
...
static LwlStatus
_lwswitch_i2c_i2cHwReadChunks_LongIndex
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pParams,
    PLWSWITCH_I2C_HW_CMD          pCmd,
...
)
{
    ...
    while ((pCmd->status == LWL_SUCCESS) && (pCmd->bytesRemaining > 0))
    {
        ...
        pCmd->status = _lwswitch_i2c_i2cPollHwUntilDoneOrTimeoutForStatus(device, pCmd->port);
...
)
{
    ...
    do {
        if (FLD_TEST_DRF(SWITCH_CTRL, _I2C_FLAGS, _INDEX_LENGTH, _ONE, pParams->flags))
        {
            ...
            status = _lwswitch_i2c_i2cSendByteCmd(device, pParams, bSendStop, offset);
            LWSWITCH_CHECK_STATUS(device, status);
        }

        if (status == LWL_SUCCESS)
        {
            _lwswitch_i2c_i2cHwInitCmdReadWithShortIndex_HAL(device, pParams, pCmd, LW_FALSE, LW_TRUE ,bytesRemaining);
        }

        if (status == LWL_SUCCESS)
        {
            status = _lwswitch_i2c_i2cPollHwUntilDoneOrTimeoutForStatus(device, pCmd->port);
            if (status == LWL_SUCCESS)
            {
                status = _lwswitch_i2c_i2cHwReadNext_HAL(device, pParams, pCmd, LW_FALSE);
                LWSWITCH_CHECK_STATUS(device, status);
            }
        }
...
)
{
    ...
    if (DRF_VAL(SWITCH_CTRL, _I2C_FLAGS, _INDEX_LENGTH, flags) > 1)
    {
        status = _lwswitch_i2c_i2cHwReadChunks_LongIndex(device, pParams, pCmd, LW_FALSE);
    }
    else
    {
        status = _lwswitch_i2c_i2cHwReadChunks(device, pParams, pCmd, LW_FALSE);
    }
    if (status != LWL_SUCCESS)
    {
        (void)_lwswitch_i2c_i2cSendStopViaHw_HAL(device, pCmd->port);
    }
...
{
    LwlStatus status  = _lwswitch_i2c_i2cHwInitCmdWrite_HAL(device, pParams, pCmd);
    ...
    while ((status == LWL_SUCCESS) && (pCmd->status == -LWL_MORE_PROCESSING_REQUIRED))
    {
        ...
        if (status == LWL_SUCCESS)
        {
            status = _lwswitch_i2c_i2cHwWriteNext_HAL(device, pCmd);
            LWSWITCH_CHECK_STATUS(device, status);
        }
    }
    ...
    status2 = _lwswitch_i2c_i2cSendStopViaHw_HAL(device, pCmd->port);
 ...
 */
static LwlStatus
_lwswitch_i2c_i2cPerformTransactiolwiaHw
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pParams
)
{
    ...
    if (pParams->bIsRead)
    {
        status = _lwswitch_i2c_i2cHwRead(device, pParams, pCmd);
    }
    else
    {
        status = _lwswitch_i2c_i2cHwWrite(device, pParams, pCmd);
        LWSWITCH_CHECK_STATUS(device, status);
    }
 ...
 *
 *  @param[in,out]  pI2c            The I2C system.
...
)
{
    ...
    // There are four I2Cs
    // There are 21 GPIOs
    //  GPIO[0..1]: thermal alerts
    //  GPIO[2..5]: LEDs

    _lwswitch_i2c_set_port_pmgr(device, 0);
    _lwswitch_i2c_set_port_pmgr(device, 1);
    _lwswitch_i2c_set_port_pmgr(device, 2);
    _lwswitch_i2c_set_port_pmgr(device, 3);

    //
    // This is a little tricky.  The primitive board identification method by
    // checking what devices are available on the I2C bus requires the I2C bus
    // voltage be set correctly, but we need to know what the board id is to
    // select the correct voltage.
    // The detection examines WS_I2C_C, which is unpopulated on everything
    // except E3600 bringup board, so we should be able to safely probe the
    // bus at 3.3V without damaging devices on the bus if it should be set to
    // 1.8V.
    //
    // Set I2C_C to use 3.3V, everything else to 1.8V
    //
    LWSWITCH_REG_WR32(device, _PMGR, _RCV_33_18_SEL_I2C,
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SDA, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SDA, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SCL, _SEL_33) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SDA, _SEL_33) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SDA, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C4_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C4_SDA, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C5_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C5_SDA, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C6_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C6_SDA, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C7_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C7_SDA, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C8_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C8_SDA, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C9_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C9_SDA, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2CS_SCL, _SEL_18) |
        DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2CS_SDA, _SEL_18));
    ...
    else
    {
        ...
        //
        // We can identify E3600 board and rev by looking for certain key
        // components on the I2C bus unique to E3600 bringup platform.  It has
        // an EEPROM on each of the four I2C busses, as well as two current/voltage
        // measuring devices (INA3221) on I2C_C.  Looking at just I2C_C bus for
        // an EEPROM and two INA3221s, we can identify whether the board is E3600
        // or something else.
        // To differentiate E3600 A01 vs A02, we can use a slight BOM difference.
        // A01 has 2kb EEPROMs which use an 8-bit address.  Addressing an EEPROM
        // location is simply a matter of addressing the EEPROM (I2C 0xA0) and
        // sending a single byte index.
        // A02 has 2Mb EEPROMs which use an 18-bit address.  Addressing an EEPROM
        // location requires sending a two byte (16-bit) index.  The missing two
        // bits are incorporated into the device address in bits 1 and 2.  To
        // access each successive 64kB the client would address the partitions
        // at I2C 0xA0, 0xA2, 0xA4, and 0xA6.
        // Therefore, in an over-simplified view, A01 has a single EEPROM at 0xA0,
        // and A02 appears to have four EEPROMs at 0xA0, 0xA2, 0xA4, and 0xA6.
        //

        device->board_id = LWSWITCH_BOARD_ID_E3600_A01;     // Guess this is an E3600 A01

        for (idx_i2cdevice=0; idx_i2cdevice < lwswitch_i2c_device_list_E3600_A01_size; idx_i2cdevice++)
        {
            //
            // Test for E3600 presence by pinging the devices found on WS_I2C_C
            // (EEPROM and two current/voltage monitors)
            //
            if (lwswitch_i2c_device_list_E3600_A01[idx_i2cdevice].i2cPortLogical == LWSWITCH_I2C_PORT_I2CC)
            {
                i2c_params.port    = lwswitch_i2c_device_list_E3600_A01[idx_i2cdevice].i2cPortLogical;
                i2c_params.address = (LwU16)lwswitch_i2c_device_list_E3600_A01[idx_i2cdevice].i2cAddress;
                ...
                {
                    // Failed to find the expected E3600 I2C_C devices
                    device->board_id = LWSWITCH_BOARD_ID_UNKNOWN;
                    break;
                }
            }
        ...
        {
            LwU32   AT24C02C_addr_list[4] = {0xA0, 0xA2, 0xA4, 0xA6};

            device->board_id = LWSWITCH_BOARD_ID_E3600_A02;     // Guess this is an E3600 A02

            // Check if this is A01 or A02 by checking the EEPROM device
            for (idx_i2cdevice=0; idx_i2cdevice < 4; idx_i2cdevice++)
            {
                i2c_params.port    = LWSWITCH_I2C_PORT_I2CC;
                i2c_params.address = (LwU16)AT24C02C_addr_list[idx_i2cdevice];
                i2c_params.bIsRead = LW_TRUE;
                i2c_params.flags   =
                    DRF_DEF(SWITCH_CTRL, _I2C_FLAGS, _START, _SEND) |
                    DRF_DEF(SWITCH_CTRL, _I2C_FLAGS, _RESTART, _NONE) |
                ...
                if (LWL_SUCCESS != lwswitch_ctrl_i2c_indexed(device, &i2c_params))
                {
                    // Failed to find the expected E3600 A02 I2C_C devices
                    device->board_id = LWSWITCH_BOARD_ID_E3600_A01;
                    break;
                }
            }
        }
        else if (device->board_id == LWSWITCH_BOARD_ID_UNKNOWN)
        {
            // Assume this is Explorer
            device->board_id = LWSWITCH_BOARD_ID_EXPLORER;
        }
    }
        ...
        (device->board_id == LWSWITCH_BOARD_ID_E3600_A02))
    {
        //
        // E3600-only
        // Set I2C_A .. I2C_D to use 3.3V.
        //
        LWSWITCH_REG_WR32(device, _PMGR, _RCV_33_18_SEL_I2C,
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C4_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C4_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C5_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C5_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C6_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C6_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C7_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C7_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C8_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C8_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C9_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C9_SDA, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2CS_SCL, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2CS_SDA, _SEL_33));

        LWSWITCH_REG_WR32(device, _PMGR, _RCV_33_18_SEL_GPIO,
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_0, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_1, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_2, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_3, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_4, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_5, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_6, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_7, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_8, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_9, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_10, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_11, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_12, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_13, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_14, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_15, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_16, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_17, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_18, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_19, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_20, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_21, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_22, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_23, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_24, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_25, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_26, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_27, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_28, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_29, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_30, _SEL_33) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_31, _SEL_33));
    }
    else
#endif //(!defined(LWRM_UNPUBLISHED_OPAQUE) || LWRM_UNPUBLISHED_OPAQUE == 1)
    {
        // Set I2C_A .. I2C_D to use 1.8V.
        LWSWITCH_REG_WR32(device, _PMGR, _RCV_33_18_SEL_I2C,
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SCL, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SDA, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SCL, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SDA, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SCL, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SDA, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SCL, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SDA, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C4_SCL, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_I2C, _I2C4_SDA, _SEL_18) |
        ...
        LWSWITCH_REG_WR32(device, _PMGR, _RCV_33_18_SEL_GPIO,
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_0, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_1, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_2, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_3, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_4, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_5, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_6, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_7, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_8, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_9, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_10, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_11, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_12, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_13, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_14, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_15, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_16, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_17, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_18, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_19, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_20, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_21, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_22, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_23, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_24, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_25, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_26, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_27, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_28, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_29, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_30, _SEL_18) |
            DRF_DEF(_PMGR, _RCV_33_18_SEL_GPIO, _GPIO_31, _SEL_18));
    }
}

static void
_lwswitch_update_i2c_voltage_sv10
(
    lwswitch_device *device
)
{
    LwU32 idx_port;
    LwU32 pmgr_i2c_voltage;

    //
    // I2C voltage was set earlier based on detected board type.  If the ROM
    // included I2C voltage info, update the settings.
    //

    if (!device->firmware.dcb.dcb_found)
    {
        return;
    }

    pmgr_i2c_voltage = LWSWITCH_REG_RD32(device, _PMGR, _RCV_33_18_SEL_I2C);
    for (idx_port = 0; idx_port < LWSWITCH_MAX_I2C_PORTS; idx_port++)
    {
        if (device->firmware.dcb.i2c[idx_port].valid)
        {
            if (device->firmware.dcb.i2c[idx_port].i2c_33v)
            {
                switch (idx_port)
                {
                    case 0:
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SCL, _SEL_33, pmgr_i2c_voltage);
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SDA, _SEL_33, pmgr_i2c_voltage);
                        break;
                    case 1:
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SCL, _SEL_33, pmgr_i2c_voltage);
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SDA, _SEL_33, pmgr_i2c_voltage);
                        break;
                    case 2:
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SCL, _SEL_33, pmgr_i2c_voltage);
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SDA, _SEL_33, pmgr_i2c_voltage);
                        break;
                    case 3:
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SCL, _SEL_33, pmgr_i2c_voltage);
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SDA, _SEL_33, pmgr_i2c_voltage);
                        break;
                }
            }
            else
            {
                ...
                {
                    case 0:
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SCL, _SEL_18, pmgr_i2c_voltage);
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C0_SDA, _SEL_18, pmgr_i2c_voltage);
                        break;
                    case 1:
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SCL, _SEL_18, pmgr_i2c_voltage);
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C1_SDA, _SEL_18, pmgr_i2c_voltage);
                        break;
                    case 2:
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SCL, _SEL_18, pmgr_i2c_voltage);
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C2_SDA, _SEL_18, pmgr_i2c_voltage);
                        break;
                    case 3:
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SCL, _SEL_18, pmgr_i2c_voltage);
                        pmgr_i2c_voltage = FLD_SET_DRF(_PMGR, _RCV_33_18_SEL_I2C, _I2C3_SDA, _SEL_18, pmgr_i2c_voltage);
                        break;
                }
            }
        }
    }
    LWSWITCH_REG_WR32(device, _PMGR, _RCV_33_18_SEL_I2C, pmgr_i2c_voltage);
}

static void
_lwswitch_update_gpio_config_sv10
(
    lwswitch_device *device
)
{
    ...
    LwU32 idx_gpio;
    LwU32 data;
    LwU32 gpio_input_ctrl;
    LwU32 gpio_output_ctrl;

    // Setup GPIO I/O, ILW, etc.
    for (idx_gpio = 0; idx_gpio < chip_device->gpio_pin_size; idx_gpio++)
    {
        if (chip_device->gpio_pin[idx_gpio].hw_select != LWSWITCH_GPIO_ENTRY_INPUT_HW_SELECT_NONE)
        {
            gpio_input_ctrl = LWSWITCH_REG_RD32(device, _PMGR,
                _GPIO_INPUT_CNTL(chip_device->gpio_pin[idx_gpio].hw_select));
            gpio_input_ctrl = FLD_SET_DRF_NUM(_PMGR, _GPIO_INPUT_CNTL, _PINNUM,
                chip_device->gpio_pin[idx_gpio].pin, gpio_input_ctrl);
            if (chip_device->gpio_pin[idx_gpio].misc == LWSWITCH_GPIO_ENTRY_MISC_IO_ILW_IN)
            {
                gpio_input_ctrl = FLD_SET_DRF(_PMGR, _GPIO_INPUT_CNTL, _ILW, _YES, gpio_input_ctrl);
            }
            else
            {
                gpio_input_ctrl = FLD_SET_DRF(_PMGR, _GPIO_INPUT_CNTL, _ILW, _NO, gpio_input_ctrl);
            }
            LWSWITCH_REG_WR32(device, _PMGR,
                 _GPIO_INPUT_CNTL(chip_device->gpio_pin[idx_gpio].hw_select), gpio_input_ctrl);
        }

        gpio_output_ctrl = LWSWITCH_REG_RD32(device, _PMGR, _GPIO_OUTPUT_CNTL(chip_device->gpio_pin[idx_gpio].pin));
        gpio_output_ctrl = FLD_SET_DRF(_PMGR, _GPIO_OUTPUT_CNTL, _SEL, _NORMAL, gpio_output_ctrl);
        if ((chip_device->gpio_pin[idx_gpio].misc == LWSWITCH_GPIO_ENTRY_MISC_IO_ILW_OUT) ||
            (chip_device->gpio_pin[idx_gpio].misc == LWSWITCH_GPIO_ENTRY_MISC_IO_OUT))
        {
            gpio_output_ctrl = FLD_SET_DRF(_PMGR, _GPIO_OUTPUT_CNTL, _IO_OUT_EN, _YES, gpio_output_ctrl);
        }
        else
        {
            gpio_output_ctrl = FLD_SET_DRF(_PMGR, _GPIO_OUTPUT_CNTL, _IO_OUT_EN, _NO, gpio_output_ctrl);
        }
        if ((chip_device->gpio_pin[idx_gpio].misc == LWSWITCH_GPIO_ENTRY_MISC_IO_ILW_OUT) ||
            (chip_device->gpio_pin[idx_gpio].misc == LWSWITCH_GPIO_ENTRY_MISC_IO_ILW_OUT_TRISTATE) ||
            (chip_device->gpio_pin[idx_gpio].misc == LWSWITCH_GPIO_ENTRY_MISC_IO_ILW_OUT_TRISTATE_LO))
        {
            gpio_output_ctrl = FLD_SET_DRF(_PMGR, _GPIO_OUTPUT_CNTL, _IO_OUT_ILW, _ENABLE, gpio_output_ctrl);
        }
        else
        {
            gpio_output_ctrl = FLD_SET_DRF(_PMGR, _GPIO_OUTPUT_CNTL, _IO_OUT_ILW, _DISABLE, gpio_output_ctrl);
        }
        LWSWITCH_REG_WR32(device, _PMGR, _GPIO_OUTPUT_CNTL(chip_device->gpio_pin[idx_gpio].pin), gpio_output_ctrl);
    }

    LWSWITCH_REG_WR32(device, _PMGR, _GPIO_OUTPUT_CNTL_TRIGGER,
        DRF_DEF(_PMGR, _GPIO_OUTPUT_CNTL_TRIGGER, _UPDATE, _TRIGGER));
    lwswitch_timeout_create(LWSWITCH_INTERVAL_50USEC_IN_NS, &timeout);
    do
    {
        data = LWSWITCH_REG_RD32(device, _PMGR, _GPIO_OUTPUT_CNTL_TRIGGER);
    }
    while((!FLD_TEST_DRF(_PMGR, _GPIO_OUTPUT_CNTL_TRIGGER, _UPDATE, _DONE, data)) &&
          (!lwswitch_timeout_check(&timeout)));

    // Find and store thermal warn GPIO
    chip_device->thermal_alert.gpio_thermal_alert = NULL;
    for (idx_gpio = 0; idx_gpio < chip_device->gpio_pin_size; idx_gpio++)
    {
        if (chip_device->gpio_pin[idx_gpio].function == LWSWITCH_GPIO_ENTRY_FUNCTION_THERMAL_ALERT)
        {
            chip_device->thermal_alert.gpio_thermal_alert = &chip_device->gpio_pin[idx_gpio];
            break;
        }
    }
}
...
)
{
    ...
    _lwswitch_update_i2c_voltage_sv10(device);

    // GPIO pin & I2C device list should come from ROM, but may not be present
    pI2c->device_list = device->firmware.dcb.i2c_device;
    pI2c->device_list_size = device->firmware.dcb.i2c_device_count;

#if (!defined(LWRM_UNPUBLISHED_OPAQUE) || LWRM_UNPUBLISHED_OPAQUE == 1)
    // If ROM did not enumerate any I2C devices, use the board type
    if (pI2c->device_list_size == 0)
    {
        switch (device->board_id)
        {
            case LWSWITCH_BOARD_ID_E3600_A01:
                LWSWITCH_PRINT(device, SETUP,
                    "%s: E3600 A01\n",
                    __FUNCTION__);
                pI2c->device_list = lwswitch_i2c_device_list_E3600_A01;
                pI2c->device_list_size = lwswitch_i2c_device_list_E3600_A01_size;
            break;

            case LWSWITCH_BOARD_ID_E3600_A02:
                LWSWITCH_PRINT(device, SETUP,
                    "%s: E3600 A02\n",
                    __FUNCTION__);
                pI2c->device_list = lwswitch_i2c_device_list_E3600_A02;
                pI2c->device_list_size = lwswitch_i2c_device_list_E3600_A02_size;
            break;

            case LWSWITCH_BOARD_ID_EXPLORER:
                LWSWITCH_PRINT(device, SETUP,
                    "%s: Explorer\n",
                    __FUNCTION__);
                pI2c->device_list = lwswitch_i2c_device_list_Explorer;
                pI2c->device_list_size = lwswitch_i2c_device_list_Explorer_size;
            break;
    ...
    // If ROM did not enumerate any GPIO pins, use the board type
    chip_device->gpio_pin = device->firmware.dcb.gpio_pin;
    chip_device->gpio_pin_size = device->firmware.dcb.gpio_pin_count;

#if (!defined(LWRM_UNPUBLISHED_OPAQUE) || LWRM_UNPUBLISHED_OPAQUE == 1)
    if (chip_device->gpio_pin_size == 0)
    {
        switch (device->board_id)
        {
            case LWSWITCH_BOARD_ID_E3600_A01:
            case LWSWITCH_BOARD_ID_E3600_A02:
                chip_device->gpio_pin = lwswitch_gpio_pin_E3600;
                chip_device->gpio_pin_size = lwswitch_gpio_pin_E3600_size;
            break;

            case LWSWITCH_BOARD_ID_EXPLORER:
                chip_device->gpio_pin = lwswitch_gpio_pin_Explorer;
                chip_device->gpio_pin_size = lwswitch_gpio_pin_Explorer_size;
            break;

            case LWSWITCH_BOARD_ID_UNKNOWN:
            default:
                // At a minimum, the two thermal inputs *always* need to be setup
                chip_device->gpio_pin = lwswitch_gpio_pin_E3600;
                chip_device->gpio_pin_size = lwswitch_gpio_pin_E3600_size;
            break;
        }
    ...
    _lwswitch_update_gpio_config_sv10(device);
}
...
static LwlStatus
_lwswitch_i2c_i2cPollHwUntilDoneOrTimeoutForStatus
(
    lwswitch_device *device,
    LwU32   port
)
{
    ...
    cntl = _lwswitch_i2c_i2cPollHwUntilDoneOrTimeout(device, port);
 ...
 */
static void
_lwswitch_i2c_i2cDrive_HAL        // GM20X
(
    lwswitch_device *device,
 ...
 */
static void
_lwswitch_i2c_i2cInitSwi2c_HAL        // GM20X
(
    LWSWITCH_I2C_SW_BUS *const pBus
)
{
 ...
 */
static void
_lwswitch_i2c_i2cDriveAndDelay
(
    lwswitch_device *device,
    LWSWITCH_I2C_SW_BUS *const pBus,
    LwU32             pos,
...
{
    _lwswitch_i2c_i2cDrive_HAL(device, pBus, pos, bValue);
 ...
 */
static LwBool
_lwswitch_i2c_i2cWaitSclReleasedTimedOut
(
    lwswitch_device *device,
    LWSWITCH_I2C_SW_BUS *pBus
)
{
    ...
    LwU32 iter_count = 0;
    LwU64 timeout_ns = I2C_STRETCHED_LOW_TIMEOUT_NS_SV10;
    ...
    do
    {
        ...
        line_high = _lwswitch_i2c_i2cIsLineHigh(device, pBus);
        iter_count++;
    }
...
)
{
    ...
    _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sdaOut, LWSWITCH_LOW, pBus->tF + pBus->tHdSta);
...
)
{
    ...
    _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sclOut, LWSWITCH_LOW, pBus->tF);

    _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sdaOut, LWSWITCH_HIGH, pBus->tR + pBus->tLow);

    _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sclOut, LWSWITCH_HIGH, pBus->tR);

    // Wait for SCL to be released by the slave.
    if (_lwswitch_i2c_i2cWaitSclReleasedTimedOut(device, pBus))
    {
        LWSWITCH_PRINT(device, ERROR,
...
)
{
    ...
    _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sclOut, LWSWITCH_LOW, pBus->tF + pBus->tHdDat);
    ...
    _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sdaOut, LWSWITCH_LOW, pBus->tF + pBus->tLow - pBus->tHdDat);
    ...
    _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sdaOut, LWSWITCH_HIGH, pBus->tR + pBus->tBuf);
...
)
{
    ...
    for (i = 0; i < LWSWITCH_BITS_PER_BYTE; i++)
    {
        ...
        if (bIsRead)
        {
            _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sclOut, LWSWITCH_LOW,
                pBus->tF + pBus->tSuDat);

            // Don't mask the transmission.
            _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sdaOut, LWSWITCH_HIGH,
                pBus->tR + pBus->tHdDat);
        }
        else
        {
            ...
            _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sdaOut,
                ((data << i) & 0x80) ? LWSWITCH_HIGH : LWSWITCH_LOW, pBus->tR + pBus->tSuDat);
        }

        // Note that here we do NOT have any delay for Write.
        _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sclOut, LWSWITCH_HIGH, bIsRead ? pBus->tR : 0);
    ...
    _lwswitch_i2c_i2cDriveAndDelay(device, pBus, pBus->sdaOut, bIsRead ? (bLast ? LWSWITCH_HIGH : LWSWITCH_LOW) : LWSWITCH_HIGH,
        pBus->tR + pBus->tSuDat);
...
{
    return _lwswitch_i2c_i2cProcessByte(device, pBus, pData, bIgnored, LW_FALSE);
}
...
{
    return _lwswitch_i2c_i2cProcessByte(device, pBus, pData, bLast, LW_TRUE);
}
...
)
{
    ...
    switch (DRF_VAL(SWITCH_CTRL, _I2C_FLAGS, _ADDRESS_MODE, pTa->flags))
    {
        ...
        case LWSWITCH_CTRL_I2C_FLAGS_ADDRESS_MODE_7BIT:
        {
            ...
            error = _lwswitch_i2c_i2cWriteByte(device, pBus, &byte, LW_FALSE);
            break;
        }
        ...
        case LWSWITCH_CTRL_I2C_FLAGS_ADDRESS_MODE_10BIT:
        {
            ...
            if (error == LWL_SUCCESS)
            {
                ...
                if (error == LWL_SUCCESS)
                {
                    ...
                    if (bIsRead)
                    {
                        error = _lwswitch_i2c_i2cSendRestart(device, pBus);
 ...
 */
#define I2C_TIMING_FAST(timing, speed)  (((timing) * 400) / (speed))
 ...
 */
static void
_lwswitch_i2c_i2cBusAndSpeedInit
(
    lwswitch_device *device,
    LWSWITCH_I2C_SW_BUS     *pBus,
...
{
    _lwswitch_i2c_i2cInitSwi2c_HAL(pBus);
    pBus->port = port;
    ...
    {
        pBus->tF     = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tF, 200);
        pBus->tR     = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tR, 200);
        pBus->tSuDat = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tSUDAT, 200);
        pBus->tHdDat = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tHDDAT, 200);
        pBus->tHigh  = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tHIGH, 200);
        pBus->tSuSto = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tSUSTO, 200);
        pBus->tHdSta = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tHDSTA, 200);
        pBus->tSuSta = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tSUSTA, 200);
        pBus->tBuf   = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tBUF, 200);
        pBus->tLow   = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tLOW, 200);
    }
    else if (speedMode == LWSWITCH_CTRL_I2C_FLAGS_SPEED_MODE_300KHZ)
    {
        pBus->tF     = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tF, 300);
        pBus->tR     = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tR, 300);
        pBus->tSuDat = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tSUDAT, 300);
        pBus->tHdDat = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tHDDAT, 300);
        pBus->tHigh  = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tHIGH, 300);
        pBus->tSuSto = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tSUSTO, 300);
        pBus->tHdSta = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tHDSTA, 300);
        pBus->tSuSta = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tSUSTA, 300);
        pBus->tBuf   = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tBUF, 300);
        pBus->tLow   = I2C_TIMING_FAST(LWSWITCH_I2C_PROFILE_FAST_tLOW, 300);
    }
 ...
 */
static LwlStatus
_lwswitch_i2c_indexed_check_state
(
    lwswitch_device *device,
    LwU32 port
)
 ...
 */
static LwlStatus
_lwswitch_ctrl_i2c_indexedCheckPreconditions
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pParams
)
{
    ...
    status = _lwswitch_i2c_indexed_check_state(device, pParams->port);
    if (status != LWL_SUCCESS)
    {
        LWSWITCH_CHECK_STATUS(device, status)
        return status;
...
)
{
    ...
    if ((LWL_SUCCESS) != _lwswitch_i2c_i2cSetAcquired(device, port, acquirer, NULL))
    {
        return (-LWL_ERR_STATE_IN_USE);
    }
 ...
 */
static void
_lwswitch_i2c_UnlockObjI2c
(
    lwswitch_device *device,
    LwU32   port
)
{
    _lwswitch_i2c_i2cSetAcquired(device, port, LWSWITCH_I2C_ACQUIRER_NONE, NULL);
    return;
}
 ...
 */
static LwBool
_lwswitch_i2c_i2cIsBusReady_HAL       // GM20X
(
    lwswitch_device *device,
    LwU32 port
)
 ...
 */
static void
_lwswitch_i2c_i2cRestoreMode_HAL      // GM20X
(
    lwswitch_device *device,
    LwU32 port,
    LwU32 bWasBb
 ...
 */
static LwlStatus
_lwswitch_i2c_i2cSetMode_HAL      // GM20X
(
    lwswitch_device *device,
    LwU32   port,
    LwBool  bSwI2c,
...
)
{
    ...
    if (!bSwI2c)
    {
        return _lwswitch_i2c_i2cHwReset_HAL(device, port);
    }
 ...
 */
static LwlStatus
_lwswitch_i2c_i2cRecoverBusViaSw
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pParams
)
{
    ...
    _lwswitch_i2c_i2cBusAndSpeedInit(device,
    ...
    //
    _lwswitch_i2c_i2cReadByte(device, &bus, &junk, LW_TRUE);
    _lwswitch_i2c_i2cSendStop(device, &bus);

    return _lwswitch_i2c_i2cIsBusReady_HAL(device, port) ?
 ...
 */
static LwlStatus
_lwswitch_i2c_i2cPerformTransactiolwiaSw
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pTa
)
{
    ...
    _lwswitch_i2c_i2cBusAndSpeedInit(device, &bus, DRF_VAL(SWITCH_CTRL, _I2C_FLAGS, _SPEED_MODE, flags), pTa->port);
    ...
    {
        error = _lwswitch_i2c_i2cSendStart(device, &bus);
    ...
    if (error == LWL_SUCCESS)
    {
        error = _lwswitch_i2c_i2cSendAddress(device, &bus, pTa, pTa->bIsRead &&
    ...
    if ((error == LWL_SUCCESS) && indexLength)
    {
        ...
        {
            error = _lwswitch_i2c_i2cWriteByte(device, &bus, &pTa->index[i], LW_FALSE);
            LWSWITCH_CHECK_STATUS(device, error);
        }
        ...
        if ((error == LWL_SUCCESS) &&
            FLD_TEST_DRF(SWITCH_CTRL, _I2C_FLAGS, _RESTART, _SEND, flags))
        {
            error = _lwswitch_i2c_i2cSendRestart(device, &bus);
            LWSWITCH_CHECK_STATUS(device, error);
    ...
    {
        error = _lwswitch_i2c_i2cProcessByte(device, &bus, &messageSize, LW_FALSE, pTa->bIsRead);
        LWSWITCH_CHECK_STATUS(device, error);
         ...
         i++)
    {
        ...
        error = _lwswitch_i2c_i2cProcessByte(device, &bus, &pTa->message[i],
    ...
    //
    error2 = _lwswitch_i2c_i2cSendStop(device, &bus);
 ...
 *
 * @param[out] pRmCtrlParams
 *      The parameters for the RM Control.  Please see ctrl402c.h for more
 *       information.
 *
 * @return (-LWL_BAD_ARGS)
 ...
 *
 * @return (LWL_SUCCESS)
 *      The control call is completed successfully.
 */
LwlStatus
lwswitch_ctrl_i2c_get_port_info_sv10
(
    lwswitch_device *device,
...
)
{
    ...
    {
        pParams->info[port] = _lwswitch_i2c_get_port_info(device, port);
    }
 ...
 */
LwlStatus
lwswitch_ctrl_i2c_indexed_sv10
(
    lwswitch_device *device,
    LWSWITCH_CTRL_I2C_INDEXED_PARAMS *pParams
)
{
    ...
    status = _lwswitch_ctrl_i2c_indexedCheckPreconditions(device, pParams);
    LWSWITCH_CHECK_STATUS(device, status);
    if (status != (LWL_SUCCESS))
    {
        goto done;
    ...
    status = _lwswitch_i2c_LockObjI2c(device, pParams->port, pParams->acquirer);
    LWSWITCH_CHECK_STATUS(device, status);
    if (status != (LWL_SUCCESS))
    {
        goto done;
    ...
    // Brackets indicate period where LWSWITCH_OBJI2C lock is held.
    {
        ...
        if (status == LWL_SUCCESS)
        {
            ...
            //
            if (!_lwswitch_i2c_i2cIsBusReady_HAL(device, port))
            {
                // set the i2c mode to bit-banging mode (should never fail!)
                status = _lwswitch_i2c_i2cSetMode_HAL(device, port, LW_TRUE, &bWasBb);
                LWSWITCH_CHECK_STATUS(device, status);

                // now attempt to recover the bus
                status = _lwswitch_i2c_i2cRecoverBusViaSw(device, pParams);
                LWSWITCH_CHECK_STATUS(device, status);
                _lwswitch_i2c_i2cRestoreMode_HAL(device, port, bWasBb);
            ...
            // transaction.
            //
            status = _lwswitch_i2c_i2cSetMode_HAL(device, port, bSwImpl, &bWasBb);
            LWSWITCH_CHECK_STATUS(device, status);
            if (status == LWL_SUCCESS)
            {
                if (bSwImpl)
                {
                    status = _lwswitch_i2c_i2cPerformTransactiolwiaSw(device, pParams);
                }
                else
                {
                    status = _lwswitch_i2c_i2cPerformTransactiolwiaHw(device, pParams);
                }
                _lwswitch_i2c_i2cRestoreMode_HAL(device, port, bWasBb);
            }
        }
...
i2cPerformTransaction_done:
        _lwswitch_i2c_UnlockObjI2c(device, pParams->port);
    }
...
)
{
    ...
    //
    // There is only one LWSwitch on an E3600 - it has no ID pins defined
    //
    // Explorer
    // [2:0] LWSwitch ID on base board
    // [4:3] Spine board connector ID
    // [6:5] 00
    // [9:7] 000
    //
    // Pioneer
    // [2:0] LWSwitch ID on base board
    // [4:3] Spine board connector ID
    // [6:5] Plane board connector ID
    // [9:7] 000=base board, 001=plane card
    //

    for (idx_gpio = 0; idx_gpio < chip_device->gpio_pin_size; idx_gpio++)
    {
        if ((chip_device->gpio_pin[idx_gpio].function >= LWSWITCH_GPIO_ENTRY_FUNCTION_INSTANCE_ID0) &&
            (chip_device->gpio_pin[idx_gpio].function <= LWSWITCH_GPIO_ENTRY_FUNCTION_INSTANCE_ID9))
        {
            if (chip_device->gpio_pin[idx_gpio].misc == LWSWITCH_GPIO_ENTRY_MISC_IO_ILW_IN)
            {
            ...
            physical_id |=
                (DRF_VAL(_PMGR, _GPIO_INPUT_CNTL_1, _READ, data) ^
                DRF_VAL(_PMGR, _GPIO_INPUT_CNTL_1, _ILW, data)) <<
                ((chip_device->gpio_pin[idx_gpio].function - LWSWITCH_GPIO_ENTRY_FUNCTION_INSTANCE_ID0));
        }
    }
...
)
{
    ...
    if (device->board_id == LWSWITCH_BOARD_ID_E3600_A01)
    {
        eeprom->device_type = LWSWITCH_I2C_DEVICE_AT24C02C;
        eeprom->index_size = AT24C02C_INDEX_SIZE;
        eeprom->block_size = AT24C02C_BLOCK_SIZE;
    }
    else
#endif //(!defined(LWRM_UNPUBLISHED_OPAQUE) || LWRM_UNPUBLISHED_OPAQUE == 1)
    {
        eeprom->device_type = LWSWITCH_I2C_DEVICE_AT24CM02;
        eeprom->index_size = AT24CM02_INDEX_SIZE;
        eeprom->block_size = AT24CM02_BLOCK_SIZE;
    }

    eeprom->block_count = (1 << eeprom->index_size) / eeprom->block_size;
    eeprom->eeprom_size = eeprom->block_count * eeprom->block_size;

    eeprom->i2c_port = I2C_EEPROM_BUS_SV10;
    eeprom->i2c_address = I2C_EEPROM_ADDRESS_SV10;

    LWSWITCH_PRINT(device, SETUP,
        "Reading %s @0x%02x on I2C_%c (%d-bit indexing)\n",
        eeprom->device_type == LWSWITCH_I2C_DEVICE_AT24C02C ? "AT24C02C" : "AT24CM02",
        eeprom->i2c_address,
        'A' + eeprom->i2c_port,
        eeprom->index_size);
...
)
{
    ...
    return LW_TRUE;
#else
    // We don't want the OS layers to enumerate I2C ports on SV10
    return LW_FALSE;
#endif
}
 ...
 */
LwBool
lwswitch_i2c_is_device_access_allowed_sv10
(
    lwswitch_device *device,
    LwU32 port,
    LwU8 addr,
 ...
 *
 * @param[in,out] pRmCtrlParams
 *      The parameters for the RM Control.  Please see ctrl402c.h for more
 *      information on the param.
 *
 * @return (-LWL_BAD_ARGS)
 *      The arguments passed to the control call are NULL.
 *
 * @return (-LWL_ERR_ILWALID_STATE)
 *      Current RM data/state needed to process the control call is invalid.
 *
 * @return (LWL_SUCCESS)
 *      The control call is completed successfully.
 */
LwlStatus
lwswitch_ctrl_i2c_get_dev_info_sv10
(
    lwswitch_device *device,
