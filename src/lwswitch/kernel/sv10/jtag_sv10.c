...
#include "lwswitch/svnp01/dev_host.h"
...
)
{
    ...
    if (lwswitch_fuse_opt_read_sv10(device, LW_FUSE_OPT_SELWRE_PJTAG_ACCESS_WR_SELWRE) ==
        LW_FUSE_OPT_SELWRE_PJTAG_ACCESS_WR_SELWRE_DATA_ENABLE)
    {
        LWSWITCH_PRINT(device, ERROR,
            "%s: JTAG disabled by security fuse\n",
            __FUNCTION__);
