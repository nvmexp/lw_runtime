 ...
 */
static void
_lwswitch_pex_get_lane_error_counts_lr10
(
    ...
    switch (counterType)
    {
        ...
        case LWSWITCH_PEX_COUNTER_LANE_ERRORS:
        {
            *pCount = 0;
            ...
            _lwswitch_pex_get_lane_error_counts_lr10(device,
...
LwlStatus
lwswitch_ctrl_pex_get_lane_counters_lr10
(
    lwswitch_device *device,
    LWSWITCH_PEX_GET_LANE_COUNTERS_PARAMS *pParams
)
{
    _lwswitch_pex_get_lane_error_counts_lr10(device, &pParams->pexLaneErrorStatus,
...
LwlStatus
lwswitch_ctrl_pex_clear_counters_lr10
(
    lwswitch_device *device,
...
LwlStatus
lwswitch_ctrl_pex_set_eom_lr10
(
    lwswitch_device *device,
...
LwlStatus
lwswitch_ctrl_pex_get_eom_status_lr10
(
    lwswitch_device *device,
...
LwlStatus
lwswitch_ctrl_get_uphy_dln_cfg_space_lr10
(
    lwswitch_device *device,
...
LwlStatus
lwswitch_ctrl_set_pcie_link_speed_lr10
(
    lwswitch_device *device,
...
)
{
    ...
    // On lr10, link speed must not be greater than gen3.
    if ((pParams->linkSpeed ==   LWSWITCH_BIF_LINK_SPEED_ILWALID) ||
        (pParams->linkSpeed > LWSWITCH_BIF_LINK_SPEED_GEN3PCIE))
    {
