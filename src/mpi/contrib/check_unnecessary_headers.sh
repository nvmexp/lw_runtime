...
SEARCH_HEADER[28]="opal/util/bit_ops.h opal_hibit opal_lwbe_dim"
...
SEARCH_HEADER[30]="opal/util/colwert.h opal_size2int"
...
SEARCH_HEADER[35]="opal/util/opal_elwiron.h opal_elwiron_merge opal_setelw opal_unsetelw opal_home_directory opal_tmp_directory elwiron"
...
###
SEARCH_HEADER[21]="orte/types.h orte_std_cntr_t ORTE_STD_CNTR_ orte_local_rank_t orte_node_rank_t ORTE_LOCAL_RANK ORTE_NODE_RANK ORTE_LOCAL_RANK_MAX ORTE_NODE_RANK_MAX ORTE_LOCAL_RANK_ILWALID ORTE_NODE_RANK_ILWALID orte_jobid_t ORTE_JOBID_ orte_vpid_t ORTE_VPID_ ORTE_PROCESS_NAME_HTON ORTE_PROCESS_NAME_NTOH ORTE_NAME_ARGS ORTE_JOBID_ILWALID ORTE_VPID_ILWALID ORTE_JOBID_WILDCARD ORTE_VPID_WILDCARD orte_process_name_t orte_iov_base_ptr_t ORTE_STD_CNTR ORTE_NAME ORTE_VPID ORTE_JOBID ORTE_NODE_STATE ORTE_PROC_STATE ORTE_JOB_STATE ORTE_EXIT_CODE ORTE_VALUE ORTE_APP_CONTEXT ORTE_NODE_DESC ORTE_SLOT_DESC ORTE_JOB ORTE_NODE ORTE_PROC ORTE_JOB_MAP ORTE_RML_TAG ORTE_DAEMON_CMD ORTE_GRPCOMM_MODE ORTE_IOF_TAG"
###
...
SEARCH_HEADER[4]="ompi/communicator/communicator.h MPI_Comm MPI_COMM_WORLD ompi_communicator_t OMPI_COMM_INTER OMPI_COMM_CART OMPI_COMM_GRAPH OMPI_COMM_NAMEISSET OMPI_COMM_ISFREED OMPI_COMM_INTRINSIC OMPI_COMM_DYNAMIC OMPI_COMM_ILWALID OMPI_COMM_PML_ADDED OMPI_COMM_IS_ OMPI_COMM_SET_ OMPI_COMM_ALLGATHER_TAG OMPI_COMM_BARRIER_TAG OMPI_COMM_ALLREDUCE_TAG OMPI_COMM_CID_ OMPI_COMM_BLOCK_ ompi_predefined_communicator_t ompi_mpi_comm_parent ompi_mpi_comm_world ompi_mpi_comm_self ompi_mpi_comm_null ompi_comm_ilwalid ompi_comm_rank ompi_comm_size ompi_comm_remote_size ompi_comm_get_cid ompi_comm_lookup ompi_comm_peer_lookup ompi_comm_peer_ilwalid ompi_comm_init ompi_comm_link_function ompi_comm_group ompi_comm_create ompi_topo_create ompi_comm_split ompi_comm_dup ompi_comm_compare ompi_comm_free ompi_comm_allocate ompi_comm_nextcid ompi_comm_finalize ompi_comm_set ompi_comm_get_rprocs ompi_comm_overlapping_groups ompi_comm_determine_first ompi_comm_activate ompi_comm_dump ompi_comm_set_name ompi_comm_reg_init ompi_comm_reg_finalize ompi_comm_num_dyncomm ompi_mpi_cxx_comm_errhandler_ilwoke"
SEARCH_HEADER[5]="ompi/datatype/colwertor.h OMPI_COMM_INTER OMPI_COMM_CART OMPI_COMM_GRAPH OMPI_COMM_NAMEISSET OMPI_COMM_ISFREED OMPI_COMM_INTRINSIC OMPI_COMM_DYNAMIC OMPI_COMM_ILWALID OMPI_COMM_PML_ADDED OMPI_COMM_IS_ OMPI_COMM_SET_ OMPI_COMM_ALLGATHER_TAG OMPI_COMM_BARRIER_TAG OMPI_COMM_ALLREDUCE_TAG OMPI_COMM_CID_ OMPI_COMM_BLOCK_ ompi_predefined_communicator_t ompi_mpi_comm_parent ompi_mpi_comm_null ompi_comm_ilwalid ompi_comm_rank ompi_comm_size ompi_comm_remote_size ompi_comm_get_cid ompi_comm_lookup ompi_comm_peer_lookup ompi_comm_peer_ilwalid ompi_comm_init ompi_comm_link_function ompi_comm_group ompi_comm_create ompi_topo_create ompi_comm_split ompi_comm_dup ompi_comm_compare ompi_comm_free ompi_comm_allocate ompi_comm_nextcid ompi_comm_finalize ompi_comm_set ompi_comm_get_rprocs ompi_comm_overlapping_groups ompi_comm_determine_first ompi_comm_activate ompi_comm_dump ompi_comm_set_name ompi_comm_reg_init ompi_comm_reg_finalize ompi_comm_num_dync COLWERTOR_DATATYPE_MASK COLWERTOR_SEND_COLWERSION COLWERTOR_RECV COLWERTOR_SEND COLWERTOR_HOMOGENEOUS COLWERTOR_NO_OP COLWERTOR_WITH_CHECKSUM COLWERTOR_TYPE_MASK COLWERTOR_STATE_START COLWERTOR_STATE_COMPLETE COLWERTOR_STATE_ALLOC COLWERTOR_COMPLETED ompi_colwertor_t ompi_colwertor_master_t dt_stack_t DT_STATIC_STACK_SIZE ompi_colwertor_get_checksum ompi_colwertor_pack ompi_colwertor_unpack ompi_colwertor_create ompi_colwertor_cleanup ompi_colwertor_need_buffers ompi_colwertor_get_packed_size ompi_colwertor_get_unpacked_size ompi_colwertor_get_lwrrent_pointer ompi_colwertor_prepare_for_send ompi_colwertor_copy_and_prepare_for_send ompi_colwertor_prepare_for_recv ompi_colwertor_copy_and_prepare_for_recv ompi_colwertor_raw ompi_colwertor_set_position_nocheck ompi_colwertor_set_position ompi_colwertor_personalize ompi_colwertor_clone ompi_colwertor_clone_with_position ompi_colwertor_dump ompi_ddt_dump_stack ompi_colwertor_generic_simple_position MPI_Datatype"
...
###
SEARCH_HEADER[27]="ompi/win/win.h OMPI_WIN_FREED OMPI_WIN_ILWALID OMPI_WIN_NO_LOCKS OMPI_WIN_ACCESS_EPOCH OMPI_WIN_EXPOSE_EPOCH OMPI_WIN_FENCE OMPI_WIN_POSTED OMPI_WIN_STARTED OMPI_WIN_LOCK_ACCESS ompi_mpi_windows ompi_win_t ompi_predefined_win_t ompi_mpi_win_null ompi_win_init ompi_win_finalize ompi_win_create ompi_win_free ompi_win_set_name ompi_win_get_name ompi_win_group ompi_win_ilwalid ompi_win_peer_ilwalid ompi_win_rank ompi_win_allow_locks ompi_win_get_mode ompi_win_set_mode ompi_win_append_mode ompi_win_remove_mode ompi_win_access_epoch ompi_win_exposure_epoch ompi_win_comm_allowed MPI_Win"
SEARCH_HEADER[28]=""
...
# and is not necessary, if no oclwrences of #include "orte..."  reside...
