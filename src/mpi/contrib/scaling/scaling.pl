...
my @options = ("", "", "", "-mca mpi_add_procs_lwtoff 0 -mca pmix_base_async_modex 1 -mca pmix_base_collect_data 0", "-mca mpi_add_procs_lwtoff 0 -mca pmix_base_async_modex 1 -mca async_mpi_init 1 -mca async_mpi_finalize 1 -mca pmix_base_collect_data 0");
...
--showme             Show the actual commands without exelwting them
