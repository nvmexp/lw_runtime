...
# colwerts all the PML specific strings in the PML to be compared to
# "ob1".  For example, with the bfo, all "bfo" strings are colwerted
# to "ob1" and all "BFO" strings are colwerted to "OB1".  In this way,
...
if ($verbose_arg) {
  ...
  print "All $pml/$PML strings colwerted to ob1/OB1 strings in bfo files\n";
}
