...
# Lwrrently, we implement only the directory option
...
#    which have been exelwted in that file since a header
...
sub generate_stats {
    my ($input_file, $coverage_file, $percent_file, $percentage, $callwlate) = @_;
    my $k = 0;
    my $l = 0;
