...
AC_DEFUN([OPAL_SUMMARY_ADD],[
    OPAL_VAR_SCOPE_PUSH([ompi_summary_section ompi_summary_line ompi_summary_section_lwrrent])
    ...
    ompi_summary_section_lwrrent=$(eval echo \$ompi_summary_values_$ompi_summary_section)

    if test -z "$ompi_summary_section_lwrrent" ; then
        ...
        eval ompi_summary_values_$ompi_summary_section=\"$ompi_summary_section_lwrrent,$ompi_summary_line\"
    fi
