...
# will add -pthread to the list of CFLAGS the wrappers use when ilwoked.
#
# This macro MAY NOT be ilwoked from configure macros for MCA components.
...
# prevent lots of callwlations and then an abort for a silly user typo.  This
...
AC_DEFUN([OPAL_SETUP_WRAPPER_FINAL],[
    ...
    m4_ifdef([project_opal], [
       ...
       # Colwert @{libdir} to ${libdir} for pkg-config
