...
dnl
dnl _OPAL_CHECK_PACKAGE_LIB() ilwokes OPAL_LIBNL_SANITY_CHECK() in order
...
dnl
dnl This macro is ilwoked from OPAL_CHECK_PACKAGE to make sure that
          ...
          [AS_IF([test -z "$opal_libnl_location"],
           ...
           AS_IF([test $opal_libnlv3_happy -eq 1],
                 [OPAL_CHECK_PACKAGE([$2],
                  ...
                  # success (checking for success oclwrs below).
