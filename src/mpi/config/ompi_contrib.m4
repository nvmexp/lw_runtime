...
# OMPI_CONTRIB
#
# configure the contributed software components.  Lwrrently fairly
...
# Lwrrently assumes that there is a configure.m4 file in the
...
AC_DEFUN([_OMPI_CONTRIB_CONFIGURE],[
    ...
    # Put in a colwenient enable/disable switch (it's a little more
    # user friendly than
