...
AC_DEFUN([_OMPI_FIND_MPI_COUNT_TYPE], [
    ...
    # will only be 4 bytes).  The entire BTL, PML, and colwertor
    ...
    # doesn't lwrrently support this configuration -- re-tooling in
    # the colwertor/PML/BML/BTL will be necessary before that can work
    # properly.
