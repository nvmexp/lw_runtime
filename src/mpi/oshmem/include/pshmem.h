...
OSHMEM_DECLSPEC void pshmem_set_cache_ilw(void);
OSHMEM_DECLSPEC void pshmem_set_cache_line_ilw(void* target);
OSHMEM_DECLSPEC void pshmem_clear_cache_ilw(void);
OSHMEM_DECLSPEC void pshmem_clear_cache_line_ilw(void* target);
