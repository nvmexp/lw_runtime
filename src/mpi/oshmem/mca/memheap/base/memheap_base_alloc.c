                                ...
                                char *timing_prefix)
{
    ...
    OPAL_TIMING_ELW_INIT_PREFIX(timing_prefix, timing);
    ...
    OPAL_TIMING_ELW_NEXT(timing, "oshmem_get_unique_file_name()");

    ret = mca_sshmem_segment_create(s, seg_filename, size, hint);

    OPAL_TIMING_ELW_NEXT(timing, "mca_sshmem_segment_create()");
