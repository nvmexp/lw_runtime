 ...
 *
 * This function ilwokes the selection process for shmem components,
 ...
 *   function ilwoked to let them know that they were not selected.
 * - The selected component will have its "init" function ilwoked to
 ...
 *
 * It must be the last function ilwoked on the sshmem MCA
 * framework.
 */
OSHMEM_DECLSPEC int
