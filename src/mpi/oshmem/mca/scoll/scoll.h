...
#define SCOLL_ALG_BARRIER_RELWRSIVE_DOUBLING    2
...
/** Per guidance in mca.h, use the ulwersioned struct name if you just
 want to always keep up with the most recent version of the
 interface. */
