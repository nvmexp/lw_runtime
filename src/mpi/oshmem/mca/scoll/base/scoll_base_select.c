...
int mca_scoll_base_select(struct oshmem_group_t *group)
{
    ...
    OPAL_TIMING_ELW_INIT(mca_scoll_base_select);
    ...
    OPAL_TIMING_ELW_NEXT(mca_scoll_base_select, "setup");
    ...
    OPAL_TIMING_ELW_NEXT(mca_scoll_base_select, "check_components");
    ...
    OPAL_TIMING_ELW_NEXT(mca_scoll_base_select, "select_loop");
    ...
    OPAL_TIMING_ELW_NEXT(mca_scoll_base_select, "release");
                       ...
                       mca_scoll_base_module_1_0_0_t **module)
{
    ...
    /* There's lwrrently no need for colwersion */
