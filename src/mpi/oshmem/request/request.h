...
do {                                                                    \
    (request)->req_state = OSHMEM_REQUEST_ILWALID;                        \
...
/**
 * Initialize the OSHMEM_Request subsystem; ilwoked during SHMEM_INIT.
 */
...
/**
 * Shut down the SHMEM_Request subsystem; ilwoked during SHMEM_FINALIZE.
 */
 ...
 *  we know the current exelwtion flow created the request, and is still
 *  in the _START macro.
 */
