...
PN (void, shmem_set_cache_ilw, SHMEM_SET_CACHE_ILW, (void));
PN (void, shmem_set_cache_line_ilw, SHMEM_SET_CACHE_LINE_ILW, (FORTRAN_POINTER_T target));
PN (void, shmem_clear_cache_ilw, SHMEM_CLEAR_CACHE_ILW, (void));
PN (void, shmem_clear_cache_line_ilw, SHMEM_CLEAR_CACHE_LINE_ILW, (FORTRAN_POINTER_T target));
