...
#define shmem_set_cache_ilw_ pshmem_set_cache_ilw_
#define shmem_set_cache_ilw__ pshmem_set_cache_ilw__

#define SHMEM_SET_CACHE_LINE_ILW PSHMEM_SET_CACHE_LINE_ILW
#define shmem_set_cache_line_ilw_ pshmem_set_cache_line_ilw_
#define shmem_set_cache_line_ilw__ pshmem_set_cache_line_ilw__

#define SHMEM_CLEAR_CACHE_ILW PSHMEM_CLEAR_CACHE_ILW
#define shmem_clear_cache_ilw_ pshmem_clear_cache_ilw_
#define shmem_clear_cache_ilw__ pshmem_clear_cache_ilw__

#define SHMEM_CLEAR_CACHE_LINE_ILW PSHMEM_CLEAR_CACHE_LINE_ILW
#define shmem_clear_cache_line_ilw_ pshmem_clear_cache_line_ilw_
#define shmem_clear_cache_line_ilw__ pshmem_clear_cache_line_ilw__
