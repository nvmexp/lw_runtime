...
PN (void, pshmem_set_cache_ilw, PSHMEM_SET_CACHE_ILW, (void));
PN (void, pshmem_set_cache_line_ilw, PSHMEM_SET_CACHE_LINE_ILW, (FORTRAN_POINTER_T target));
PN (void, pshmem_clear_cache_ilw, PSHMEM_CLEAR_CACHE_ILW, (void));
PN (void, pshmem_clear_cache_line_ilw, PSHMEM_CLEAR_CACHE_LINE_ILW, (FORTRAN_POINTER_T target));
