...
#define shmem_set_cache_ilw         pshmem_set_cache_ilw
#define shmem_set_cache_line_ilw    pshmem_set_cache_line_ilw
#define shmem_clear_cache_ilw       pshmem_clear_cache_ilw
#define shmem_clear_cache_line_ilw  pshmem_clear_cache_line_ilw
