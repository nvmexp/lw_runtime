...
/*
 * WHAT: add thread for ilwoking opal_progress() function
 ...
 * WHY:  there oclwres a segfault sometimes and sleep()
...
static int _shmem_init(int argc, char **argv, int requested, int *provided)
{
    ...
    OPAL_TIMING_ELW_NEXT(timing, "shmem_params");
    /* initialize info */
    ...
    OPAL_TIMING_ELW_NEXT(timing, "oshmem_info_init()");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "oshmem_proc_init()");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "oshmem_op_init()");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "open SPML framework");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "open SCOLL framework");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "select SPML framework");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "find SCOLL components");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "oshmem_request_init()");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "oshmem_proc_group_init()");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "MCA_SPML_CALL(enable())");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "MCA_SPML_CALL(add_procs())");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "open SSHMEM framework");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "select SSHMEM framework");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "open MEMHEAP framework");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "select MEMHEAP framework");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "open ATOMIC framework");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "find avail ATOMIC framework");
    ...
    OPAL_TIMING_ELW_NEXT(timing, "mca_scoll_enable()");
