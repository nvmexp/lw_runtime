...
int main( int argc, char* argv[] )
{
     ...
     */
    colwertor = opal_colwertor_create( opal_local_arch, 0 );
    opal_colwertor_personalize( colwertor, COLWERTOR_WITH_CHECKSUM, NULL );
    opal_colwertor_prepare_for_send( colwertor, &(sparse->super), SIZE, sparse_array );
    ...
    pack_checksum = colwertor->checksum;
    ...
    colwertor = opal_colwertor_create( opal_local_arch, 0 );
    opal_colwertor_personalize( colwertor, COLWERTOR_WITH_CHECKSUM, NULL );
    opal_colwertor_prepare_for_send( colwertor, &(ompi_mpi_int.dt.super), SIZE, packed );
    ...
    iov_count = 1;
    opal_colwertor_pack( colwertor, iov, &iov_count, &max_data );
    contiguous_checksum = colwertor->checksum;
    ...
    colwertor = opal_colwertor_create( opal_local_arch, 0 );
    opal_colwertor_personalize( colwertor, COLWERTOR_WITH_CHECKSUM, NULL );
    opal_colwertor_prepare_for_recv( colwertor, &(sparse->super), SIZE, sparse_array );
    ...
    sparse_checksum = colwertor->checksum;
