...
int main (int argc, char* argv[])
{
    ...
    fprintf(test_out, "exelwting test1\n");
    if (test1()) {
    ...
    fprintf(test_out, "exelwting test2\n");
    if (test2()) {
    ...
    fprintf(test_out, "exelwting test3\n");
    if (test3()) {
    ...
    fprintf(test_out, "exelwting test4\n");
    if (test4()) {
    ...
    fprintf(test_out, "exelwting test5\n");
    if (test5()) {
    ...
    fprintf(test_out, "exelwting test6\n");
    if (test6()) {
    ...
    fprintf(test_out, "exelwting test7\n");
    if (test7()) {
    ...
    fprintf(test_out, "exelwting test8\n");
    if (test8()) {
    ...
    fprintf(test_out, "exelwting test9\n");
    if (test9()) {
    ...
    fprintf(test_out, "exelwting test11\n");
    if (test11()) {
    ...
    fprintf(test_out, "exelwting test12\n");
    if (test12()) {
    ...
    fprintf(test_out, "exelwting test13\n");
    if (test13()) {
