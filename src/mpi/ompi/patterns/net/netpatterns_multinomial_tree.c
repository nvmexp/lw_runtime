        ...
        netpatterns_tree_node_t *tree_nodes)
{
    ...
    int n_lwm_nodes,lwrrent_level,node,n_nodes_prev_level,rank,parent_rank;
    ...
    node_index=-1;
    n_lwm_nodes=0;
    for( lwrrent_level = 0 ; lwrrent_level < n_lvls_in_tree ; lwrrent_level++) {
