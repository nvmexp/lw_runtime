...
/**
 * Group structure
 * Lwrrently we have four formats for storing the process pointers that are members
 * of the group.
...
/**
 * Table for Fortran <-> C group handle colwersion
 */
...
/**
 *  Functions to callwlate storage spaces
 */
