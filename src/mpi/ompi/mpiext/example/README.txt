...
- Extensions create specifically-named libtool colwenience archives
...
- builds a Libtool colwenience library named libmpiext_<ext_name>_c.la
...
- builds a Libtool colwenience library named libmpiext_<ext_name>_mpifh.la
...
- builds a Libtool colwenience library named
...
1. For the colweneince of the developer, so that you can issue normal
