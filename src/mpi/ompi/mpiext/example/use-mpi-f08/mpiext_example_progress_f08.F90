...
! colwentions and generally implements whatever the extension needs.
...
subroutine OMPI_Progress_f08(count, comm, ierror)
  ...
  ! Prototype the back-end function in mpif-h that we'll be ilwoking
  ...
  interface
     ...
     ! bindings that this interface will ilwoke.  See below.
  ...
  ! but colwert the mpi_f08-style MPI handles to mpif.h-style handles
