...
#define FCA_COLWERTOR_T opal_colwertor_t
#define FCA_COLWERTOR_COPY_AND_PREPARE_FOR_SEND opal_colwertor_copy_and_prepare_for_send
#define FCA_COLWERTOR_COPY_AND_PREPARE_FOR_RECV opal_colwertor_copy_and_prepare_for_recv
#define FCA_COLWERTOR_COLWERTOR_GET_PACKED_SIZE opal_colwertor_get_packed_size
#define FCA_COLWERTOR_COLWERTOR_UNPACK opal_colwertor_unpack
#define FCA_COLWERTOR_COLWERTOR_PACK opal_colwertor_pack
...
#include "ompi/datatype/colwertor.h"
#define FCA_COLWERTOR_T ompi_colwertor_t
#define FCA_COLWERTOR_COPY_AND_PREPARE_FOR_SEND ompi_colwertor_copy_and_prepare_for_send
#define FCA_COLWERTOR_COPY_AND_PREPARE_FOR_RECV ompi_colwertor_copy_and_prepare_for_recv
#define FCA_COLWERTOR_COLWERTOR_GET_PACKED_SIZE ompi_colwertor_get_packed_size
#define FCA_COLWERTOR_COLWERTOR_UNPACK ompi_colwertor_unpack
#define FCA_COLWERTOR_COLWERTOR_PACK ompi_colwertor_pack
