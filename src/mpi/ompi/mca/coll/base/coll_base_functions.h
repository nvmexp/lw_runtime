...
int ompi_coll_base_allgather_intra_relwrsivedoubling(ALLGATHER_ARGS);
...
int ompi_coll_base_allreduce_intra_relwrsivedoubling(ALLREDUCE_ARGS);
...
int ompi_coll_base_barrier_intra_relwrsivedoubling(BARRIER_ARGS);
...
/* Exscan */
int ompi_coll_base_exscan_intra_relwrsivedoubling(EXSCAN_ARGS);
...
int ompi_coll_base_reduce_scatter_intra_basic_relwrsivehalving(REDUCESCATTER_ARGS);
...
int ompi_coll_base_reduce_scatter_block_intra_relwrsivedoubling(REDUCESCATTERBLOCK_ARGS);
int ompi_coll_base_reduce_scatter_block_intra_relwrsivehalving(REDUCESCATTERBLOCK_ARGS);
int ompi_coll_base_reduce_scatter_block_intra_butterfly(REDUCESCATTERBLOCK_ARGS);

/* Scan */
int ompi_coll_base_scan_intra_relwrsivedoubling(SCAN_ARGS);
