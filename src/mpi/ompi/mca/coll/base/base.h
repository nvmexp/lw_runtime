 ...
 *
 * These functions are normally ilwoked by the back-ends of:
 *
 ...
 *
 * This function is ilwoked when a new communicator is created and a
 * coll component needs to be selected for it.  It should be ilwoked
 ...
 * ilwoking this function.  Specifically: this function is called in
 * the depths of communicator creation, but during the exelwtion of
