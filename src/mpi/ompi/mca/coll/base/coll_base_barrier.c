...

{
 ...
 error_handler:
    ...
    OPAL_OUTPUT ((ompi_coll_base_framework.framework_output, "%s:%d: Error %d oclwrred\n",
                  __FILE__, line, rc));
...
int ompi_coll_base_barrier_intra_relwrsivedoubling(struct ompi_communicator_t *comm,
                                                    mca_coll_base_module_t *module)
{
    ...
    OPAL_OUTPUT((ompi_coll_base_framework.framework_output,
                 "ompi_coll_base_barrier_intra_relwrsivedoubling rank %d",
                 rank));
...
/*
 * Another relwrsive doubling type algorithm, but in this case
