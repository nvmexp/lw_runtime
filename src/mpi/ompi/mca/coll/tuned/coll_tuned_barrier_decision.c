...
int ompi_coll_tuned_barrier_intra_check_forced_init (coll_tuned_force_algorithm_mca_param_indices_t *mca_param_indices)
{
    ...
    mca_param_indices->algorithm_param_index =
        mca_base_component_var_register(&mca_coll_tuned_component.super.collm_version,
                                        "barrier_algorithm",
                                        "Which barrier algorithm is used. Can be locked down to choice of: 0 ignore, 1 linear, 2 double ring, 3: relwrsive doubling 4: bruck, 5: two proc only, 6: tree",
                                           ...
                                           int algorithm, int faninout, int segsize)
{
    ...
    case (3):   return ompi_coll_base_barrier_intra_relwrsivedoubling(comm, module);
