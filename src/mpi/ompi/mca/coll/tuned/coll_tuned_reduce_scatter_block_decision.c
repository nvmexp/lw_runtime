...
int ompi_coll_tuned_reduce_scatter_block_intra_check_forced_init (coll_tuned_force_algorithm_mca_param_indices_t *mca_param_indices)
{
    ...
    mca_param_indices->algorithm_param_index =
        mca_base_component_var_register(&mca_coll_tuned_component.super.collm_version,
                                        ...
                                        "Can be locked down to choice of: 0 ignore, 1 basic_linear, 2 relwrsive_doubling, "
                                        "3 relwrsive_halving, 4 butterfly",
                                                       ...
                                                       int algorithm, int faninout, int segsize)
{
    ...
    case (1): return ompi_coll_base_reduce_scatter_block_basic_linear(sbuf, rbuf, rcount,
                                                                      dtype, op, comm, module);
    case (2): return ompi_coll_base_reduce_scatter_block_intra_relwrsivedoubling(sbuf, rbuf, rcount,
                                                                                 dtype, op, comm, module);
    case (3): return ompi_coll_base_reduce_scatter_block_intra_relwrsivehalving(sbuf, rbuf, rcount,
                                                                                dtype, op, comm, module);
