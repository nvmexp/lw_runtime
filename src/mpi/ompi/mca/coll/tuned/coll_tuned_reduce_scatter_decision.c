...
int ompi_coll_tuned_reduce_scatter_intra_check_forced_init (coll_tuned_force_algorithm_mca_param_indices_t *mca_param_indices)
{
    ...
    mca_param_indices->algorithm_param_index =
        mca_base_component_var_register(&mca_coll_tuned_component.super.collm_version,
                                        ...
                                        "Which reduce reduce_scatter algorithm is used. Can be locked down to choice of: 0 ignore, 1 non-overlapping (Reduce + Scatterv), 2 relwrsive halving, 3 ring, 4 butterfly",
                                                 ...
                                                 int algorithm, int faninout, int segsize)
{
    ...
    case (1): return ompi_coll_base_reduce_scatter_intra_nonoverlapping(sbuf, rbuf, rcounts,
                                                                        dtype, op, comm, module);
    case (2): return ompi_coll_base_reduce_scatter_intra_basic_relwrsivehalving(sbuf, rbuf, rcounts,
                                                                                dtype, op, comm, module);
