                                          ...
                                          mca_coll_base_module_t *module)
{
     ...
     *
     * Lwrrently, linear, relwrsive doubling, and nonoverlapping algorithms
                                            ...
                                            mca_coll_base_module_t *module)
{
     ...
     * the use the relwrsive doubling algorithm, otherwise
    ...
    return ompi_coll_base_barrier_intra_relwrsivedoubling(comm, module);
}
                                            ...
                                            mca_coll_base_module_t *module)
{
    ...
    /**
     * If the operation is non commutative we lwrrently have choice of linear
                                                    ...
                                                    mca_coll_base_module_t *module)
{
    ...
    if ((total_message_size <= small_message_size) ||
        ...
        return
            ompi_coll_base_reduce_scatter_intra_basic_relwrsivehalving(sbuf, rbuf, rcounts,
                                                                       dtype, op,
                                                                       comm, module);
    }
                                              ...
                                              mca_coll_base_module_t *module)
{
    ...
    /* Decision based on MX 2Gb results from Grig cluster at
       ...
       relwrsive doubling for non-power of two and power of two nodes,
       respectively.
    ...
    */
    ...
    /* Decision as in MPICH-2
       ...
       (up to 512KB) use relwrsive doubling
