 ...
 * required level of thread support.  This function is ilwoked exactly
 * once.
 */
                             ...
                             struct ompi_communicator_t *comm)
{
    ...
    */
    ...
    /* Once the communicator is bootstrapped, setup the pointers into
       ...
       there can never be more than one outstanding barrier oclwring
                          ...
                          mca_coll_sm_module_t *module)
{
    ...
    /* Callwlate how much space we need in the per-communicator shmem
