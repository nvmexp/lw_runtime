                            ...
                            mca_coll_base_module_t *module)
{
    ...
    /* Lazily enable the module the first time we ilwoke a collective
       on it */
    ...
    if (root == rank) {
        ...
        /* The root needs a send colwertor to pack from the user's
        ...
        opal_colwertor_get_packed_size(&colwertor, &total_size);
        ...
        do {
            ...
            do {
                ...
                COPY_FRAGMENT_IN(colwertor, index, rank, iov, max_data);
                bytes += max_data;
     ...
     *********************************************************************/
        ...
        /* Non-root processes need a receive colwertor to unpack from
            ...
            do {
                ...
                if (num_children > 0) {
                    ...
                    /* Set the "copy from buffer" to be my local
                       ...
                       inlwr a non-local memory copy from the parent's
                ...
                COPY_FRAGMENT_OUT(colwertor, src_rank, index, iov, max_data);
