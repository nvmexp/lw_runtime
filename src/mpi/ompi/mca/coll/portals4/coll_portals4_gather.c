                              ...
                              mca_coll_portals4_module_t   *portals4_module)
{
    ...
    ompi_coll_portals4_create_send_colwerter (&request->u.gather.send_colwerter,
    ...
    opal_colwertor_get_packed_size(&request->u.gather.send_colwerter, &request->u.gather.packed_size);
    ...
    if (vrank == 0) {
        ...
        opal_colwertor_pack(&request->u.gather.send_colwerter, &iov, &iov_count, &max_data);
                                             ...
                                             mca_coll_base_module_t *module)
{
    ...
    request->u.gather.gather_mdh=PTL_ILWALID_HANDLE;
    request->u.gather.gather_cth=PTL_ILWALID_HANDLE;
    request->u.gather.gather_meh=PTL_ILWALID_HANDLE;
    request->u.gather.sync_mdh=PTL_ILWALID_HANDLE;
    request->u.gather.sync_cth=PTL_ILWALID_HANDLE;
    request->u.gather.sync_meh=PTL_ILWALID_HANDLE;
                                                ...
                                                ompi_coll_portals4_request_t *request)
{
    ...
    if (request->u.gather.my_rank == request->u.gather.root_rank) {
        ...
        for (i=0;i<request->u.gather.size;i++) {
            ...
            ompi_coll_portals4_create_recv_colwerter (&request->u.gather.recv_colwerter,
            ...
            opal_colwertor_unpack(&request->u.gather.recv_colwerter, &iov, &iov_count, &max_data);

            OBJ_DESTRUCT(&request->u.gather.recv_colwerter);
        }
    }
