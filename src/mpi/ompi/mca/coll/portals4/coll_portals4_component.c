...
portals4_open(void)
{
    ...
    mca_coll_portals4_component.ni_h = PTL_ILWALID_HANDLE;
    ...
    mca_coll_portals4_component.eq_h = PTL_ILWALID_HANDLE;
    mca_coll_portals4_component.unex_me_h = PTL_ILWALID_HANDLE;
    mca_coll_portals4_component.finish_me_h = PTL_ILWALID_HANDLE;
    mca_coll_portals4_component.zero_md_h = PTL_ILWALID_HANDLE;
    mca_coll_portals4_component.data_md_h = PTL_ILWALID_HANDLE;
...
portals4_close(void)
{
    ...
    if (!PtlHandleIsEqual(mca_coll_portals4_component.zero_md_h, PTL_ILWALID_HANDLE)) {
    ...
    if (!PtlHandleIsEqual(mca_coll_portals4_component.data_md_h, PTL_ILWALID_HANDLE)) {
    ...
    if (!PtlHandleIsEqual(mca_coll_portals4_component.finish_me_h, PTL_ILWALID_HANDLE)) {
        do {
    ...
    if (!PtlHandleIsEqual(mca_coll_portals4_component.unex_me_h, PTL_ILWALID_HANDLE)) {
        do {
    ...
    if (!PtlHandleIsEqual(mca_coll_portals4_component.eq_h, PTL_ILWALID_HANDLE)) {
    ...
    if (!PtlHandleIsEqual(mca_coll_portals4_component.ni_h, PTL_ILWALID_HANDLE)) {
