...
static bool libnbc_in_progress = false;     /* protect from relwrsive calls */
...
libnbc_register(void)
{
     ...
     * We are ilwestigating a fix for this problem, but it is taking a while.
    ...
    mca_base_component_var_register(&mca_coll_libnbc_component.super.collm_version,
                                    ...
                                    "Which iallgather algorithm is used: 0 ignore, 1 linear, 2 relwrsive_doubling",
    ...
    mca_base_component_var_register(&mca_coll_libnbc_component.super.collm_version,
                                    ...
                                    "Which iallreduce algorithm is used: 0 ignore, 1 ring, 2 binomial, 3 rabenseifner, 4 relwrsive_doubling",
                                    MCA_BASE_VAR_TYPE_INT, new_enum, 0, MCA_BASE_VAR_FLAG_SETTABLE,
                                    OPAL_INFO_LVL_5, MCA_BASE_VAR_SCOPE_ALL,
    ...
    mca_base_component_var_register(&mca_coll_libnbc_component.super.collm_version,
                                    "iexscan_algorithm",
                                    "Which iexscan algorithm is used: 0 ignore, 1 linear, 2 relwrsive_doubling",
                                    MCA_BASE_VAR_TYPE_INT, new_enum, 0, MCA_BASE_VAR_FLAG_SETTABLE,
                                    OPAL_INFO_LVL_5, MCA_BASE_VAR_SCOPE_ALL,
    ...
    mca_base_component_var_register(&mca_coll_libnbc_component.super.collm_version,
                                    "iscan_algorithm",
                                    "Which iscan algorithm is used: 0 ignore, 1 linear, 2 relwrsive_doubling",
                                    MCA_BASE_VAR_TYPE_INT, new_enum, 0, MCA_BASE_VAR_FLAG_SETTABLE,
                                    OPAL_INFO_LVL_5, MCA_BASE_VAR_SCOPE_ALL,
