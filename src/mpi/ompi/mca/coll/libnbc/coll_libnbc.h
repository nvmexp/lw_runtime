...
#define NBC_ILWALID_PARAM 7 /* invalid parameters */
#define NBC_ILWALID_TOPOLOGY_COMM 8 /* invalid topology attached to communicator */
...
struct NBC_Schedule {
    opal_object_t super;
    volatile int size;
    volatile int lwrrent_round_offset;
    char *data;
};
