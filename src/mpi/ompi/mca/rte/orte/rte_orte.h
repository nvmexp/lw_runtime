...
#define ompi_rte_colwert_string_to_process_name(a,b) orte_util_colwert_string_to_process_name(a,b)
#define ompi_rte_colwert_process_name_to_string(a,b) orte_util_colwert_process_name_to_string(a,b)
#define OMPI_NAME_WILDCARD  ORTE_NAME_WILDCARD
#define OMPI_NODE_RANK_ILWALID ORTE_NODE_RANK_ILWALID
#define OMPI_LOCAL_RANK_ILWALID ORTE_LOCAL_RANK_ILWALID
