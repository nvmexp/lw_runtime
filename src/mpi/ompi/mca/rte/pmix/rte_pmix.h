...
OMPI_DECLSPEC int ompi_rte_colwert_string_to_process_name(opal_process_name_t *name,
                                                          const char* name_string);
OMPI_DECLSPEC int ompi_rte_colwert_process_name_to_string(char** name_string,
...
#define OMPI_NODE_RANK_ILWALID UINT16_MAX
#define OMPI_LOCAL_RANK_ILWALID UINT16_MAX
