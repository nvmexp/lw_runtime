...
struct ompio_file_t;
typedef int (*mca_common_ompio_generate_lwrrent_file_view_fn_t) (struct ompio_file_t *fh,
							         size_t max_data,
							         struct iovec **f_iov,
							         int *iov_count);
...
struct ompio_file_t {
    ...
    */
    ...
    mca_common_ompio_generate_lwrrent_file_view_fn_t f_generate_lwrrent_file_view;
 ...
 * into an iovec using the colwertor_raw function
 */
...
OMPI_DECLSPEC int mca_common_ompio_set_callbacks(mca_common_ompio_generate_lwrrent_file_view_fn_t generate_lwrrent_file_view,
