...
int ompi_io_ompio_generate_lwrrent_file_view (struct ompio_file_t *fh,
                                              size_t max_data,
                                              struct iovec **f_iov,
                                              int *iov_count)
{
...
int mca_io_ompio_get_mca_parameter_value ( char *mca_parameter_name, int name_length )
{
    ...
    else if ( !strncmp ( mca_parameter_name, "aggregators_lwtoff_threshold", name_length )) {
        return mca_io_ompio_aggregators_lwtoff_threshold;
    }
