...
#include "ompi/mca/common/ompio/common_ompio_lwda.h"
#endif
...
int mca_io_ompio_aggregators_lwtoff_threshold=3;
...
static int register_component(void)
{
    ...
    mca_io_ompio_aggregators_lwtoff_threshold=3;
    (void) mca_base_component_var_register(&mca_io_ompio_component.io_version,
                                           "aggregators_lwtoff_threshold",
                                           ...
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY,
                                           &mca_io_ompio_aggregators_lwtoff_threshold);
...
static int open_component(void)
{
    ...
    return mca_common_ompio_set_callbacks(ompi_io_ompio_generate_lwrrent_file_view,
...
#if OPAL_LWDA_SUPPORT
    mca_common_ompio_lwda_alloc_fini();
#endif
...
static int register_datarep(const char * datarep,
                            MPI_Datarep_colwersion_function* read_fn,
                            MPI_Datarep_colwersion_function* write_fn,
