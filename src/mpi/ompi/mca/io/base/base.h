...
BEGIN_C_DECLS
     ...
     *
     * This function is ilwoked during ompi_mpi_init() to query all
     ...
     *
     * This function is ilwoked when a new file handle is created and a
     * io component needs to be selected for it.  It should be ilwoked
     * near the end of the file handle creation process such that
     * almost everything else is functional on the file handle.
     *
     * This function ilwokes the selection process for io components,
     ...
     *   "unquery" function ilwoked to let them know that they were not
     *   selected.
     * - The selected module will have its "init" function
     *   ilwoked to let it know that it was selected.  All unselected
     *   components will have their file_unselect function ilwoked.
     ...
     *
     * This function is ilwoked near the beginning of the destruction of
    ...
    /**
     * Ilwoke a back-end component to delete a file.
     *
     ...
     * function function ilwokes appropriate delete handlers on all
    ...
    OMPI_DECLSPEC int mca_io_base_register_datarep(const char *,
                                              MPI_Datarep_colwersion_function*,
                                              MPI_Datarep_colwersion_function*,
