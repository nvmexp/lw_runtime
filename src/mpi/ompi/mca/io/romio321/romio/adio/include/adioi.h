...
/* Functions and datataypes that are "internal" to the ADIO implementation 
   ...
   "externally visible" (dolwmented) ADIO interface are prefixed ADIO_.
...
typedef struct ADIOI_Datarep {
    ...
    MPI_Datarep_colwersion_function *read_colw_fn;
    MPI_Datarep_colwersion_function *write_colw_fn;
...
MPI_Count ADIOI_Count_contiguous_blocks(MPI_Datatype type, MPI_Count *lwrr_index);
