                       ...
                       *error_code)
{
	...
	*error_code = MPI_SUCCESS; 
	...
	int flag;
        ...
        /* First we're going to callwlate a set of values for use in all
	...
	/* End of callwlations.  At this point the following values have
	 * been callwlated and are ready for use:
	 * - start_off
	 * - end_offset
	 * - st_n_filetypes
	 * - st_index
