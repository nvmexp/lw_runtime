...
/* For this process's request, callwlate the list of offsets and
	...
	*end_offset_ptr = offset_list[0] + len_list[0] - 1;
	...
	if (file_ptr_type == ADIO_INDIVIDUAL) fd->fp_ind = *end_offset_ptr + 1;
       ...
       /* First callwlate what size of offset_list and len_list to allocate */
	...
	if (file_ptr_type == ADIO_INDIVIDUAL) {
		...
		abs_off_in_filetype;
         ...
         /* callwlate how much space to allocate for offset_list, len_list */
	...
	*start_offset_ptr = offset; /* callwlated above */
