...
int ADIO_Init_keyval=MPI_KEYVAL_ILWALID;

MPI_Errhandler ADIOI_DFLT_ERR_HANDLER = MPI_ERRORS_RETURN;


static void my_consensus(void *ilwec, void *inoutvec, int *len, MPI_Datatype *datatype)
{
    int i, *in, *inout;
    in = (int*)ilwec;
    inout = (int*)inoutvec;
