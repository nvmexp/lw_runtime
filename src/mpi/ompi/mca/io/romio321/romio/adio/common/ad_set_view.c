		...
		MPI_Datatype filetype, MPI_Info info,  int *error_code) 
{
	...
	ADIOI_Type_get_elwelope(etype, &i, &j, &k, &combiner);
	...
	ADIOI_Type_get_elwelope(filetype, &i, &j, &k, &combiner);
