...
/** \page mpiio_vars MPIIO Configuration
  \section elw_sec Environment Variables
 ...
 *   callwlated (block size).  Possible values:
 *   - 0 - Evenly callwlate file domains across aggregators.  Also use
 ...
 *   am sure there is a better way to do this ilwolving comm threads - this is
 ...
 *   a statistical issue only, the data is still aclwrately written out
 *
...
void ad_gpfs_get_elw_vars() {
    ...
    x = getelw( "GPFSMPIO_ONESIDED_INFORM_RMW" );
