...
AC_LINK_IFELSE([
    ...
    AC_MSG_WARN([installation or configuration problem: Fortran 90 compiler cannot create exelwtables.])
])
...
dnl Restore FCFLAGS before 2nd/3rd argument commands are exelwted,
