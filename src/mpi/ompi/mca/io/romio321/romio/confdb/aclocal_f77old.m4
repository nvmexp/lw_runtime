...
[
    ...
    # 1.0 / 0 at compile time, even though the code may never be exelwted.
...
EOF
	...
	# exelwtable code that then did not run.
...
$flag"
	...
	3) # Posix alternative
	   ...
	   ;;
	4) # Nag f90_unix_elw module
	   FXX_MODULE="        use f90_unix_elw"
	   F77_GETARGDECL=""
	   F77_GETARG="call getarg(i,s)"
	   F77_IARGC="iargc()"
	   MSG="f90_unix_elw module"
	   ;;
