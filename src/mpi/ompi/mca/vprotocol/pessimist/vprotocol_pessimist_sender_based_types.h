...
typedef struct vprotocol_pessimist_sender_based_t
{
    ...
    uintptr_t sb_colw_to_pessimist_offset; /* end of request from req_colw */
#endif
    ...
    uintptr_t sb_lwrsor;    /* current pointer to writeable memory */
...
typedef struct vprotocol_pessimist_sender_based_request_t
{
    ...
    colwertor_advance_fct_t colw_advance;
    uint32_t colw_flags;
