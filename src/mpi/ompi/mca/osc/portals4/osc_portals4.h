 ...
 *
 * Lwrrently, the Portals 4 one-sided implementation only uses a
...
int ompi_osc_portals4_aclwmulate(const void *origin_addr,
                                 int origin_count,
                                 struct ompi_datatype_t *origin_dt,
                                 int target,
                                 ptrdiff_t target_disp,
...
int ompi_osc_portals4_get_aclwmulate(const void *origin_addr,
                                     int origin_count,
...
int ompi_osc_portals4_raclwmulate(const void *origin_addr,
                                  int origin_count,
                                  struct ompi_datatype_t *origin_dt,
                                  int target,
                                  ptrdiff_t target_disp,
...
int ompi_osc_portals4_rget_aclwmulate(const void *origin_addr,
                                      int origin_count,
                                      struct ompi_datatype_t *origin_datatype,
                                      void *result_addr,
                                      int result_count,
