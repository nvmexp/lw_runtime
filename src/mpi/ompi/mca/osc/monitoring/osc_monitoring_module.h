...
#define MCA_OSC_MONITORING_MODULE_TEMPLATE_GENERATE(template)           \
    ...
    {                                                                   \
        ...
        static const ompi_osc_base_module_t module_specific_interception_layer = { \
            ...
            .osc_aclwmulate = ompi_osc_monitoring_## template ##_aclwmulate, \
            ...
            .osc_get_aclwmulate = ompi_osc_monitoring_## template ##_get_aclwmulate, \
                                                                        \
            .osc_rput = ompi_osc_monitoring_## template ##_rput,        \
            .osc_rget = ompi_osc_monitoring_## template ##_rget,        \
            .osc_raclwmulate = ompi_osc_monitoring_## template ##_raclwmulate, \
            .osc_rget_aclwmulate = ompi_osc_monitoring_## template ##_rget_aclwmulate, \
                                                                        \
