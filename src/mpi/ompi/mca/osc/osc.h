 ...
 * @retval OMPI_ERROR   An unspecified error oclwrred
 */
...
typedef int (*ompi_osc_base_module_aclwmulate_fn_t)(const void *origin_addr,
                                                   int origin_count,
                                                   struct ompi_datatype_t *origin_dt,
                                                   int target,
                                                   ptrdiff_t target_disp,
...
typedef int (*ompi_osc_base_module_get_aclwmulate_fn_t)(const void *origin_addr,
                                                        int origin_count,
...
typedef int (*ompi_osc_base_module_raclwmulate_fn_t)(const void *origin_addr,
                                                     int origin_count,
                                                     struct ompi_datatype_t *origin_dt,
                                                     int target,
                                                     ptrdiff_t target_disp,
...
typedef int (*ompi_osc_base_module_rget_aclwmulate_fn_t)(const void *origin_addr,
                                                         int origin_count,
                                                         struct ompi_datatype_t *origin_datatype,
                                                         void *result_addr,
                                                         int result_count,
...
struct ompi_osc_base_module_3_0_0_t {
    ...
    ompi_osc_base_module_aclwmulate_fn_t osc_aclwmulate;
    ompi_osc_base_module_compare_and_swap_fn_t osc_compare_and_swap;
    ompi_osc_base_module_fetch_and_op_fn_t osc_fetch_and_op;
    ompi_osc_base_module_get_aclwmulate_fn_t osc_get_aclwmulate;

    ompi_osc_base_module_rput_fn_t osc_rput;
    ompi_osc_base_module_rget_fn_t osc_rget;
    ompi_osc_base_module_raclwmulate_fn_t osc_raclwmulate;
    ompi_osc_base_module_rget_aclwmulate_fn_t osc_rget_aclwmulate;
