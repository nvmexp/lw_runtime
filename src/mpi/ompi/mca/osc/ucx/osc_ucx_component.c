...
ompi_osc_ucx_module_t ompi_osc_ucx_module_template = {
    {
        ...
        .osc_aclwmulate = ompi_osc_ucx_aclwmulate,
        .osc_compare_and_swap = ompi_osc_ucx_compare_and_swap,
        .osc_fetch_and_op = ompi_osc_ucx_fetch_and_op,
        .osc_get_aclwmulate = ompi_osc_ucx_get_aclwmulate,

        .osc_rput = ompi_osc_ucx_rput,
        .osc_rget = ompi_osc_ucx_rget,
        .osc_raclwmulate = ompi_osc_ucx_raclwmulate,
        .osc_rget_aclwmulate = ompi_osc_ucx_rget_aclwmulate,
...
static int component_finalize(void) {
    ...
    if (mca_osc_ucx_component.elw_initialized == true) {
        OBJ_DESTRUCT(&mca_osc_ucx_component.requests);
        ucp_cleanup(mca_osc_ucx_component.ucp_context);
        mca_osc_ucx_component.elw_initialized = false;
    }
...
static void ompi_osc_ucx_unregister_progress()
{
    ...
    /* May be called conlwrrently - protect */
    _osc_ucx_init_lock();
...
static int component_select(struct ompi_win_t *win, void **base, size_t size, int disp_unit,
    ...
    int is_eps_ready;
    bool eps_created = false, elw_initialized = false;
    ...
    if (mca_osc_ucx_component.elw_initialized == false) {
        ...
        mca_osc_ucx_component.elw_initialized = true;
        elw_initialized = true;
    }
