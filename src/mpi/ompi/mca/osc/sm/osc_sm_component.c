...
ompi_osc_sm_module_t ompi_osc_sm_module_template = {
    {
        ...
        .osc_aclwmulate = ompi_osc_sm_aclwmulate,
        .osc_compare_and_swap = ompi_osc_sm_compare_and_swap,
        .osc_fetch_and_op = ompi_osc_sm_fetch_and_op,
        .osc_get_aclwmulate = ompi_osc_sm_get_aclwmulate,

        .osc_rput = ompi_osc_sm_rput,
        .osc_rget = ompi_osc_sm_rget,
        .osc_raclwmulate = ompi_osc_sm_raclwmulate,
        .osc_rget_aclwmulate = ompi_osc_sm_rget_aclwmulate,
                 ...
                 int flavor, int *model)
{
    ...
    *base = module->bases[ompi_comm_rank(module->comm)];
    ...
    opal_atomic_lock_init(&module->my_node_state->aclwmulate_lock, OPAL_ATOMIC_LOCK_UNLOCKED);
