...
ompi_osc_pt2pt_module_t ompi_osc_pt2pt_module_template = {
    {
        ...
        ompi_osc_pt2pt_put,
        ompi_osc_pt2pt_get,
        ompi_osc_pt2pt_aclwmulate,
        ompi_osc_pt2pt_compare_and_swap,
        ompi_osc_pt2pt_fetch_and_op,
        ompi_osc_pt2pt_get_aclwmulate,

        ompi_osc_pt2pt_rput,
        ompi_osc_pt2pt_rget,
        ompi_osc_pt2pt_raclwmulate,
        ompi_osc_pt2pt_rget_aclwmulate,
...
#if 1
    module->aclwmulate_ordering = 1;
#else
    ompi_osc_base_config_value_equal("aclwmulate_ordering", info, "none");
#endif
