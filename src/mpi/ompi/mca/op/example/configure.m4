...
# MCA_<framework>_<component>_CONFIG that exelwtes either $1 if the
# component wants to build itself, or $2 if the component does not
# want to build itself.

# Do *NOT* ilwoke AC_MSG_ERROR, or any other macro that will abort
...
AC_DEFUN([MCA_ompi_op_example_CONFIG],[
    ...
    # one test and exelwting either $1 or $2, depending on the output
    # of the test.
