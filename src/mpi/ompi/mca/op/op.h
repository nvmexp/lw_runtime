 ...
 *
 * 1. ompi_op_base_open() is ilwoked during MPI_INIT to find/open all
 * op components.
 *
 * 2. ompi_op_base_find_available() is ilwoked during MPI_INIT to call
 ...
 *
 * 3. ompi_op_base_op_select() is ilwoked during MPI_INIT for each
 ...
 *
 * 5. Finally, during MPI_FINALIZE, ompi_op_base_close() is ilwoked to
...
/** Per guidence in mca.h, use the ulwersioned struct name if you just
 ...
 * query function and being ilwoked for MPI_Op operations.
 */
...
/**
 * Declare the module as a class, ulwersioned
 */
