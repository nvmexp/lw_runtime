...
int mca_fs_gpfs_file_set_info(ompio_file_t *fh, struct ompi_info_t *info)
{
    ...
    //CN: TODO: Implement the following lwrrently unused GPFS hints
    /*
    struct {
        gpfsFcntlHeader_t gpfsFcntlHeader;
    ...
    */
    ...
    if (flag) {
        ...
        gpfs_hint_AccessRange.gpfsFcntlHeader.fcntlVersion = GPFS_FCNTL_LWRRENT_VERSION;
    ...
    if (flag) {
        ...
        gpfs_hint_FreeRange.gpfsFcntlHeader.fcntlVersion = GPFS_FCNTL_LWRRENT_VERSION;
    ...
    if (flag & (strcmp(value, "true") == 0)) {
        ...
        gpfs_hint_ClearFileCache.gpfsFcntlHeader.fcntlVersion = GPFS_FCNTL_LWRRENT_VERSION;
    ...
    if (flag & (strcmp(value, "true") == 0)) {
        ...
        gpfs_hint_CancelHints.gpfsFcntlHeader.fcntlVersion = GPFS_FCNTL_LWRRENT_VERSION;
    ...
    if (flag) {
        ...
        gpfs_hint_SetReplication.gpfsFcntlHeader.fcntlVersion = GPFS_FCNTL_LWRRENT_VERSION;
    ...
    if (flag) {
        ...
        gpfs_hint_ByteRange.gpfsFcntlHeader.fcntlVersion = GPFS_FCNTL_LWRRENT_VERSION;
    ...
    if (flag) {
        ...
        gpfs_hint_RestripeData.gpfsFcntlHeader.fcntlVersion = GPFS_FCNTL_LWRRENT_VERSION;
...
//CN: configure option to enable/disable SIOX support?
    ...
    if (siox_gpfs_uiid == SIOX_ILWALID_ID){
