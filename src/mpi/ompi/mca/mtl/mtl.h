...
#define MCA_MTL_BASE_FLAG_LWDA_INIT_DISABLE 0x00000002
#endif
 ...
 * @param colwertor (IN) Datatype colwertor describing send datatype.
 ...
 * @param tag (IN)       MPI tag used for sending.  See note below.
 * @param colwertor (IN) Datatype colwertor describing receive datatype.
