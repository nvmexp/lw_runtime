...
ompi_mtl_portals4_component_open(void)
{
    ...
    ompi_mtl_portals4.ni_h = PTL_ILWALID_HANDLE;
    ompi_mtl_portals4.send_eq_h = PTL_ILWALID_HANDLE;
    ompi_mtl_portals4.recv_eq_h = PTL_ILWALID_HANDLE;
    ompi_mtl_portals4.zero_md_h = PTL_ILWALID_HANDLE;
    ompi_mtl_portals4.send_md_h = PTL_ILWALID_HANDLE;
    ompi_mtl_portals4.long_overflow_me_h = PTL_ILWALID_HANDLE;
