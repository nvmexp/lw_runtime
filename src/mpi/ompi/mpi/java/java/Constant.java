...
class Constant
{
	...
	protected int ROOT, KEYVAL_ILWALID, BSEND_OVERHEAD;
	...
	protected int DISPLACEMENT_LWRRENT;
	protected int SEEK_SET, SEEK_LWR, SEEK_END;
