...
public final class MPI
{
	...
	public static final Info INFO_ELW, INFO_NULL;
	...
	public static final int ROOT, KEYVAL_ILWALID, BSEND_OVERHEAD;
	...
	public static final int DISPLACEMENT_LWRRENT;
	public static final int SEEK_SET, SEEK_LWR, SEEK_END;
	...
	public static final int ERR_COLWERSION;
	...
	static
	{
		...
		ROOT           = c.ROOT;
		KEYVAL_ILWALID = c.KEYVAL_ILWALID;
		...
		DISPLACEMENT_LWRRENT = c.DISPLACEMENT_LWRRENT;
		...
		ERR_BASE         = c.ERR_BASE;
		ERR_COLWERSION   = c.ERR_COLWERSION;
		ERR_DISP         = c.ERR_DISP;
