...
public class Comm implements Freeable, Cloneable
{
	 ...
	 * <p>If such a message is lwrrently available, a status object similar
	 * to the return value of a matching {@code recv} operation is returned.
	 * @param source rank of source
	 * @param tag    message tag
	 * @return status object if such a message is lwrrently available,
	 *         {@code null} otherwise.
	 * @throws MPIException Signals that an MPI exception of some sort has oclwrred.
	 */
	...
	// Elwiromental Management

	/**
	 * Abort MPI.
	 * <p>Java binding of the MPI operation {@code MPI_ABORT}.
	 * @param errorcode error code for Unix or POSIX elwironments
	 * @throws MPIException Signals that an MPI exception of some sort has oclwrred.
	 */
	...
	/**
	 * Returns the error handler lwrrently associated with the communicator.
	 * <p>Java binding of the MPI operation {@code MPI_COMM_GET_ERRHANDLER}.
	 * @return MPI error handler lwrrently associated with communicator
	 * @throws MPIException Signals that an MPI exception of some sort has oclwrred.
	 */
	...
	/**
	 * Calls the error handler lwrrently associated with the communicator.
	...
	/**
	 * Ilwerse of the operation {@code gather}.
	...
	/**
	 * Ilwerse of the operation {@code gatherv}.
					...
					throws MPIException
	{
		...
		long[] sendHandles = colwertTypeArray(sendTypes);
		long[] recvHandles = colwertTypeArray(recvTypes);
	...
	/**
	 * A helper method to colwert an array of Datatypes to
	 * an array of longs (handles).
	 * @param dArray	Array of Datatypes
	 * @return colwerted Datatypes
	 */
	private long[] colwertTypeArray(Datatype[] dArray) {
