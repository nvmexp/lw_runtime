...
public final class Win implements Freeable
{
	...
	/**
	 * Java binding of {@code MPI_ACLWMULATE}.
	 * @param origin      origin buffer
	 * @param orgCount    number of entries in origin buffer
	 * @param orgType     datatype of each entry in origin buffer
	 * @param targetRank  rank of target
	 ...
	 * @return MPI error handler lwrrently associated with window
	 * @throws MPIException Signals that an MPI exception of some sort has oclwrred.
	 */
	...
	/**
	 * Java binding of {@code MPI_RACLWMULATE}.
	 * @param origin      origin buffer
	 * @param orgCount    number of entries in origin buffer
	 * @param orgType     datatype of each entry in origin buffer
	 * @param targetRank  rank of target
	 ...
	 * @throws MPIException Signals that an MPI exception of some sort has oclwrred.
	 */
	public Request rAclwmulate(Buffer origin, int orgCount, Datatype orgType,
			int targetRank, int targetDisp, int targetCount,
			Datatype targetType, Op op)
					throws MPIException
	{
		...
		if(!origin.isDirect())
			throw new IllegalArgumentException("The origin must be direct buffer.");
		Request req = new Request(rAclwmulate(handle, origin, orgCount, orgType.handle,
				targetRank, targetDisp, targetCount, targetType.handle,
				op, op.handle, getBaseType(orgType, targetType)));
	...
	private native long rAclwmulate(
			long win, Buffer origin, int orgCount, long orgType,
			int targetRank, int targetDisp, int targetCount, long targetType,
			Op jOp, long hOp, int baseType) throws MPIException;

	/**
	 * Java binding of {@code MPI_GET_ACLWMULATE}.
	 * @param origin      	origin buffer
	 * @param orgCount    	number of entries in origin buffer
	 * @param orgType		datatype of each entry in origin buffer
	...
	public void getAclwmulate(Buffer origin, int orgCount, Datatype orgType,
					...
					throws MPIException
	{
		...
		getAclwmulate(handle, origin, orgCount, orgType.handle,
				resultAddr, resultCount, resultType.handle,
				targetRank, targetDisp, targetCount, targetType.handle,
				op, op.handle, getBaseType(orgType, targetType));
	}

	private native void getAclwmulate(
			long win, Buffer origin, int orgCount, long orgType,
	...
	/**
	 * Java binding of {@code MPI_RGET_ACLWMULATE}.
	 * @param origin      	origin buffer
	 * @param orgCount    	number of entries in origin buffer
	 * @param orgType		datatype of each entry in origin buffer
	 * @param resultAddr   	result buffer
	...
	public Request rGetAclwmulate(Buffer origin, int orgCount, Datatype orgType,
			Buffer resultAddr, int resultCount, Datatype resultType,
			int targetRank, int targetDisp, int targetCount,
			Datatype targetType, Op op)
					throws MPIException
	{
		...
		if(!origin.isDirect())
			throw new IllegalArgumentException("The origin must be direct buffer.");
		Request req = new Request(rGetAclwmulate(handle, origin, orgCount, orgType.handle,
				resultAddr, resultCount, resultType.handle,
				targetRank, targetDisp, targetCount, targetType.handle,
				op, op.handle, getBaseType(orgType, targetType)));
		req.addRecvBufRef(origin);
	...
	private native long rGetAclwmulate(
			long win, Buffer origin, int orgCount, long orgType,
			Buffer resultAddr, int resultCount, long resultType,
			int targetRank, int targetDisp, int targetCount, long targetType,
			Op jOp, long hOp, int baseType) throws MPIException;
