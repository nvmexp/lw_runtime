...
JNIEXPORT jlong JNICALL Java_mpi_Errhandler_getFatal(JNIElw *elw, jclass clazz)
{
    return (jlong)MPI_ERRORS_ARE_FATAL;
}

JNIEXPORT jlong JNICALL Java_mpi_Errhandler_getReturn(JNIElw *elw, jclass clazz)
{
