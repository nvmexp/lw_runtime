                        ...
                        int *readonly, int *continuous, int *atomic)
{
    ...
    do {
        ...
        if (OMPI_SUCCESS != ret) {
            ret = (OPAL_ERR_NOT_FOUND == ret) ? MPI_T_ERR_ILWALID_INDEX : MPI_T_ERR_ILWALID;
            break;
        }
        ...
        if (OMPI_SUCCESS != ret) {
            ret = MPI_T_ERR_ILWALID;  /* can't really happen as MPI_SUCCESS is the only
