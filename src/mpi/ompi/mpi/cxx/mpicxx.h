...
static const int ompi_stdio_seek_lwr = SEEK_LWR;
...
static const int SEEK_LWR = ompi_stdio_seek_lwr;
...
#include "openmpi/ompi/mpi/cxx/datatype.h"
  ...
  typedef void User_function(const void* ilwec, void* inoutvec, int len,
