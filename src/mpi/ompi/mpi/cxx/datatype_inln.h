                            ...
                            MPI::Datatype array_of_datatypes[]) const
{
    ...
    (void) MPI_Type_get_contents(mpi_datatype, max_integers, max_addresses,
                                 ...
                                 c_datatypes);
    // Colwert the C MPI_Datatypes to the user's OUT MPI::Datatype
    // array parameter
...
inline void
MPI::Datatype::Get_elwelope(int& num_integers, int& num_addresses,
			  int& num_datatypes, int& combiner) const
{
  (void) MPI_Type_get_elwelope(mpi_datatype, &num_integers, &num_addresses,
