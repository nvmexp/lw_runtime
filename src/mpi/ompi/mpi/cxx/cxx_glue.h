...
void ompi_mpi_cxx_comm_errhandler_ilwoke (MPI_Comm *mpi_comm, int *err,
                                          const char *message, void *comm_fn);
void ompi_mpi_cxx_win_errhandler_ilwoke (MPI_Win *mpi_comm, int *err,
                                         const char *message, void *win_fn);
int ompi_cxx_errhandler_ilwoke_file (MPI_File file, int ret, const char *message);
void ompi_mpi_cxx_file_errhandler_ilwoke (MPI_File *mpi_comm, int *err,
