...
// that conform to the C bindings.  In these intercepts, colwert the
// arguments to C++ calling colwertions, and then ilwoke the actual
// C++ callbacks.
...
// Intercept function for read colwersions
                             ...
                             void *extra_state)
{
    ...
    MPI::Datarep_colwersion_function *read_fn_cxx =
        (MPI::Datarep_colwersion_function *) intercept_data->read_fn_cxx;
...
// Intercept function for write colwersions
                              ...
                              void *extra_state)
{
    ...
    ompi_cxx_intercept_file_extra_state_t *intercept_data =
        (ompi_cxx_intercept_file_extra_state_t*) extra_state;
    MPI::Datarep_colwersion_function *write_fn_cxx =
        (MPI::Datarep_colwersion_function *) intercept_data->write_fn_cxx;
...
// Intercept function for extent callwlations
...
MPI::Register_datarep(const char* datarep,
                      Datarep_colwersion_function* read_fn_cxx,
                      Datarep_colwersion_function* write_fn_cxx,
                      ...
                      void* extra_state_cxx)
{
    ...
    if (NULL == intercept) {
        ompi_cxx_errhandler_ilwoke_file (MPI_FILE_NULL, OMPI_ERR_OUT_OF_RESOURCE,
...
void
MPI::Register_datarep(const char* datarep,
                      MPI_Datarep_colwersion_function* read_fn_c,
                      Datarep_colwersion_function* write_fn_cxx,
                      Datarep_extent_function* extent_fn_cxx,
                      void* extra_state_cxx)
{
...
MPI::Register_datarep(const char* datarep,
                      Datarep_colwersion_function* read_fn_cxx,
                      MPI_Datarep_colwersion_function* write_fn_c,
                      Datarep_extent_function* extent_fn_cxx,
                      void* extra_state_cxx)
{
    ompi_cxx_intercept_file_extra_state_t *intercept;
