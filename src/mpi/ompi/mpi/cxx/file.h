...
typedef void Datarep_colwersion_function(void* userbuf, Datatype& datatype,
...
void Register_datarep(const char* datarep,
                      Datarep_colwersion_function* read_colwersion_fn,
                      Datarep_colwersion_function* write_colwersion_fn,
                      Datarep_extent_function* dtype_file_extent_fn,
                      void* extra_state);

// Overload for C read callback function (MPI_COLWERSION_FN_NULL)
void Register_datarep(const char* datarep,
...
// Overload for C write callback function (MPI_COLWERSION_FN_NULL)
void Register_datarep(const char* datarep,
                      Datarep_colwersion_function* read_colwersion_fn,
...
// Overload for C read and write callback functions (MPI_COLWERSION_FN_NULL)
void Register_datarep(const char* datarep,
                      MPI_Datarep_colwersion_function* read_colwersion_fn,
                      MPI_Datarep_colwersion_function* write_colwersion_fn,
                      Datarep_extent_function* dtype_file_extent_fn,
