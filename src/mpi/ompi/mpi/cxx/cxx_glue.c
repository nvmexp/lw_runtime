...
int ompi_cxx_errhandler_ilwoke_comm (MPI_Comm comm, int ret, const char *message)
{
    return OMPI_ERRHANDLER_ILWOKE (comm, ret, message);
}

int ompi_cxx_errhandler_ilwoke_file (MPI_File file, int ret, const char *message)
{
    return OMPI_ERRHANDLER_ILWOKE (file, ret, message);
}
...
MPI_Errhandler ompi_cxx_errhandler_create_comm (ompi_cxx_dummy_fn_t *fn)
{
    ...
    errhandler->eh_cxx_dispatch_fn =
        (ompi_errhandler_cxx_dispatch_fn_t *) ompi_mpi_cxx_comm_errhandler_ilwoke;
    return errhandler;
}
...
MPI_Errhandler ompi_cxx_errhandler_create_win (ompi_cxx_dummy_fn_t *fn)
{
    ...
    errhandler = ompi_errhandler_create(OMPI_ERRHANDLER_TYPE_WIN,
                                        ...
                                        OMPI_ERRHANDLER_LANG_CXX);
    errhandler->eh_cxx_dispatch_fn =
        (ompi_errhandler_cxx_dispatch_fn_t *) ompi_mpi_cxx_win_errhandler_ilwoke;
    return errhandler;
}
...
MPI_Errhandler ompi_cxx_errhandler_create_file (ompi_cxx_dummy_fn_t *fn)
{
    ...
    errhandler = ompi_errhandler_create(OMPI_ERRHANDLER_TYPE_FILE,
                                        ...
                                        OMPI_ERRHANDLER_LANG_CXX);
    errhandler->eh_cxx_dispatch_fn =
        (ompi_errhandler_cxx_dispatch_fn_t *) ompi_mpi_cxx_file_errhandler_ilwoke;
    return errhandler;
}
