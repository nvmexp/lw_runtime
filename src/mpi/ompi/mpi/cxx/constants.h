...
static const int ERR_COLWERSION = MPI_ERR_COLWERSION;
...
static const int KEYVAL_ILWALID = MPI_KEYVAL_ILWALID;
...
static const int DISPLACEMENT_LWRRENT = MPI_DISPLACEMENT_LWRRENT;

#if !defined(OMPI_IGNORE_CXX_SEEK) && OMPI_WANT_MPI_CXX_SEEK
static const int SEEK_SET = ::SEEK_SET;
static const int SEEK_LWR = ::SEEK_LWR;
