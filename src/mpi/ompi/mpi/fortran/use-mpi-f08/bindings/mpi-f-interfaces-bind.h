...
! ilwoke a back-end ompi_*_f() subroutine, which is BIND(C)-bound to a
...
! ilwoke the back-end ompi_*_f() C function.  There are 2 cases:
...
! function, which then ilwokes the corresponding function in the
...
! the right types (e.g., colwert MPI handles from comm to
...
! above. :-(
!
! The problem oclwrs because in the mpi_f08 module, an MPI_Status is
...
subroutine ompi_type_get_elwelope_f(datatype,num_integers, &
                                    num_addresses,num_datatypes,combiner,ierror) &
   BIND(C, name="ompi_type_get_elwelope_f")
   implicit none
   INTEGER, INTENT(IN) :: datatype
   INTEGER, INTENT(OUT) :: num_integers, num_addresses, num_datatypes, combiner
   INTEGER, INTENT(OUT) :: ierror
end subroutine ompi_type_get_elwelope_f
...
subroutine ompi_aclwmulate_f(origin_addr,origin_count,origin_datatype, &
                             target_rank,target_disp, &
                             target_count,target_datatype,op,win,ierror) &
   BIND(C, name="ompi_aclwmulate_f")
   use :: mpi_f08_types, only : MPI_ADDRESS_KIND
   implicit none
   ...
   INTEGER, INTENT(IN) :: win
   INTEGER, INTENT(OUT) :: ierror
end subroutine ompi_aclwmulate_f

subroutine ompi_raclwmulate_f(origin_addr,origin_count,origin_datatype, &
                              target_rank,target_disp, &
                              target_count,target_datatype,op,win, &
                              request,ierror) &
   BIND(C, name="ompi_raclwmulate_f")
   use :: mpi_f08_types, only : MPI_ADDRESS_KIND
   implicit none
   OMPI_FORTRAN_IGNORE_TKR_TYPE, INTENT(IN) :: origin_addr
   INTEGER, INTENT(IN) :: origin_count, target_rank, target_count
   ...
   INTEGER, INTENT(OUT) :: request
   INTEGER, INTENT(OUT) :: ierror
end subroutine ompi_raclwmulate_f
...
subroutine ompi_get_aclwmulate_f(origin_addr,origin_count,origin_datatype, &
                                 result_addr,result_count,result_datatype, &
                                 target_rank,target_disp, &
                                 target_count,target_datatype,op,win, &
                                 ierror) &
   BIND(C, name="ompi_get_aclwmulate_f")
   use :: mpi_f08_types, only : MPI_ADDRESS_KIND
   implicit none
   OMPI_FORTRAN_IGNORE_TKR_TYPE, INTENT(IN) :: origin_addr
   ...
   INTEGER, INTENT(IN) :: win
   INTEGER, INTENT(OUT) :: ierror
end subroutine ompi_get_aclwmulate_f

subroutine ompi_rget_aclwmulate_f(origin_addr,origin_count,origin_datatype, &
                                  result_addr,result_count,result_datatype, &
                                  target_rank,target_disp, &
                                  target_count,target_datatype,op,win, &
                                  request,ierror) &
   BIND(C, name="ompi_rget_aclwmulate_f")
   use :: mpi_f08_types, only : MPI_ADDRESS_KIND
   implicit none
   OMPI_FORTRAN_IGNORE_TKR_TYPE, INTENT(IN) :: origin_addr
   INTEGER, INTENT(IN) :: origin_count, result_count, target_rank, target_count
   ...
   INTEGER, INTENT(OUT) :: request
   INTEGER, INTENT(OUT) :: ierror
end subroutine ompi_rget_aclwmulate_f
...
subroutine ompi_register_datarep_f(datarep,read_colwersion_fn, &
                                   write_colwersion_fn,dtype_file_extent_fn, &
   ...
   use, intrinsic :: iso_c_binding, only: c_funptr
   implicit none
   type(c_funptr), value :: read_colwersion_fn
   type(c_funptr), value :: write_colwersion_fn
