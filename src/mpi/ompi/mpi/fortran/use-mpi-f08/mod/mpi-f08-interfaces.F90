...
interface  MPI_Type_get_elwelope
subroutine MPI_Type_get_elwelope_f08(datatype,num_integers,num_addresses,num_datatypes, &
                                     combiner,ierror)
   use :: mpi_f08_types, only : MPI_Datatype
   implicit none
   TYPE(MPI_Datatype), INTENT(IN) :: datatype
   ...
   INTEGER, OPTIONAL, INTENT(OUT) :: ierror
end subroutine MPI_Type_get_elwelope_f08
end interface  MPI_Type_get_elwelope
...
interface  MPI_Aclwmulate
subroutine MPI_Aclwmulate_f08(origin_addr,origin_count,origin_datatype,target_rank, &
   ...
   TYPE(MPI_Win), INTENT(IN) :: win
   INTEGER, OPTIONAL, INTENT(OUT) :: ierror
end subroutine MPI_Aclwmulate_f08
end interface  MPI_Aclwmulate

interface  MPI_Raclwmulate
subroutine MPI_Raclwmulate_f08(origin_addr,origin_count,origin_datatype,target_rank, &
   ...
   TYPE(MPI_Request), INTENT(OUT) :: request
   INTEGER, OPTIONAL, INTENT(OUT) :: ierror
end subroutine MPI_Raclwmulate_f08
end interface  MPI_Raclwmulate
...
interface  MPI_Get_aclwmulate
subroutine MPI_Get_aclwmulate_f08(origin_addr,origin_count,origin_datatype,result_addr, &
   ...
   TYPE(MPI_Win), INTENT(IN) :: win
   INTEGER, OPTIONAL, INTENT(OUT) :: ierror
end subroutine MPI_Get_aclwmulate_f08
end interface  MPI_Get_aclwmulate

interface  MPI_Rget_aclwmulate
subroutine MPI_Rget_aclwmulate_f08(origin_addr,origin_count,origin_datatype,result_addr, &
                                   result_count,result_datatype,target_rank,target_disp, &
   ...
   TYPE(MPI_Request), INTENT(OUT) :: request
   INTEGER, OPTIONAL, INTENT(OUT) :: ierror
end subroutine MPI_Rget_aclwmulate_f08
end interface  MPI_Rget_aclwmulate
