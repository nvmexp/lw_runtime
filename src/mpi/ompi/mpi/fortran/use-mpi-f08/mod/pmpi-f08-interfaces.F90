...
interface  PMPI_Type_get_elwelope
subroutine PMPI_Type_get_elwelope_f08(datatype,num_integers,num_addresses,num_datatypes, &
                                     combiner,ierror)
   use :: mpi_f08_types, only : MPI_Datatype
   implicit none
   TYPE(MPI_Datatype), INTENT(IN) :: datatype
...
end interface  PMPI_Type_get_elwelope
...
interface  PMPI_Aclwmulate
subroutine PMPI_Aclwmulate_f08(origin_addr,origin_count,origin_datatype,target_rank, &
   ...
   TYPE(MPI_Win), INTENT(IN) :: win
   INTEGER, OPTIONAL, INTENT(OUT) :: ierror
end subroutine PMPI_Aclwmulate_f08
end interface  PMPI_Aclwmulate

interface  PMPI_Raclwmulate
subroutine PMPI_Raclwmulate_f08(origin_addr,origin_count,origin_datatype,target_rank, &
   ...
   TYPE(MPI_Request), INTENT(OUT) :: request
   INTEGER, OPTIONAL, INTENT(OUT) :: ierror
end subroutine PMPI_Raclwmulate_f08
end interface  PMPI_Raclwmulate
...
interface  PMPI_Get_aclwmulate
subroutine PMPI_Get_aclwmulate_f08(origin_addr,origin_count,origin_datatype,result_addr, &
   ...
   TYPE(MPI_Win), INTENT(IN) :: win
   INTEGER, OPTIONAL, INTENT(OUT) :: ierror
end subroutine PMPI_Get_aclwmulate_f08
end interface  PMPI_Get_aclwmulate

interface  PMPI_Rget_aclwmulate
subroutine PMPI_Rget_aclwmulate_f08(origin_addr,origin_count,origin_datatype,result_addr, &
                                   result_count,result_datatype,target_rank,target_disp, &
   ...
   TYPE(MPI_Request), INTENT(OUT) :: request
   INTEGER, OPTIONAL, INTENT(OUT) :: ierror
end subroutine PMPI_Rget_aclwmulate_f08
end interface  PMPI_Rget_aclwmulate
...
subroutine PMPI_Register_datarep_f08(datarep,read_colwersion_fn,write_colwersion_fn, &
