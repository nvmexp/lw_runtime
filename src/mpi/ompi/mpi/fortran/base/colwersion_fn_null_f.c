 ...
 * MPI_COLWERSION_FN_NULL.  These functions will never be ilwoked, but
 ...
 * symbol colwentions), and given that these symbols must be the same
 ...
 * (e.g., the back-end mpi_colwersion_fn_null_f function will never be
 * used for anything).
 *
...
#pragma weak MPI_COLWERSION_FN_NULL   = mpi_colwersion_fn_null_f
#pragma weak mpi_colwersion_fn_null   = mpi_colwersion_fn_null_f
#pragma weak mpi_colwersion_fn_null_  = mpi_colwersion_fn_null_f
#pragma weak mpi_colwersion_fn_null__ = mpi_colwersion_fn_null_f
#endif

#if ! OPAL_HAVE_WEAK_SYMBOLS && ! OMPI_PROFILE_LAYER
OMPI_GENERATE_F77_BINDINGS(MPI_COLWERSION_FN_NULL,
                           mpi_colwersion_fn_null,
                           mpi_colwersion_fn_null_,
                           mpi_colwersion_fn_null__,
                           mpi_colwersion_fn_null_f,
...
void mpi_colwersion_fn_null_f(char *userbuf, MPI_Fint *datatype,
