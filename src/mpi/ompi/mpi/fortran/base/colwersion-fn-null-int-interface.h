...
!
! INTEGER handle pre-defined colwersion callback function interface
!

interface

    subroutine MPI_COLWERSION_FN_NULL(userbuf, datatype, count, filebuf, &
    ...
    end subroutine MPI_COLWERSION_FN_NULL
