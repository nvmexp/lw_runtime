...
BEGIN_C_DECLS
    /**
     * Colwert a fortran string to a C string.
     *
     ...
     * colwert fortran strings to C strings before ilwoking a back-end
    ...
    /**
     * Colwert a C string to a fortran string.
     *
     * @param cstr C string
     ...
     *
     * This function is intended to be used in the MPI F77 bindings to
     * colwert C strings to fortran strings.  It is assumed that the
    ...
    /**
     * Colwert an array of Fortran strings that are terminated with a
     ...
     * colwert arrays of fortran strings to argv-style arrays of C
     * strings.  The argv array will be allocated and returned; it is
     * the caller's responsibility to ilwoke opal_argv_free() to free
     ...
     * colwerted to individual C-style argv vectors.  In this case,
    ...
    /**
     * Colwert an array of a specific number of Fortran strings to an
    ...
    /**
     * Colwert an array of argvs to a C style array of argvs
