...
#pragma weak PMPI_RGET_ACLWMULATE = ompi_rget_aclwmulate_f
#pragma weak pmpi_rget_aclwmulate = ompi_rget_aclwmulate_f
#pragma weak pmpi_rget_aclwmulate_ = ompi_rget_aclwmulate_f
#pragma weak pmpi_rget_aclwmulate__ = ompi_rget_aclwmulate_f

#pragma weak PMPI_Rget_aclwmulate_f = ompi_rget_aclwmulate_f
#pragma weak PMPI_Rget_aclwmulate_f08 = ompi_rget_aclwmulate_f
#else
OMPI_GENERATE_F77_BINDINGS (PMPI_RGET_ACLWMULATE,
                            pmpi_rget_aclwmulate,
                            pmpi_rget_aclwmulate_,
                            pmpi_rget_aclwmulate__,
                            pompi_rget_aclwmulate_f,
...
#if OPAL_HAVE_WEAK_SYMBOLS
#pragma weak MPI_RGET_ACLWMULATE = ompi_rget_aclwmulate_f
#pragma weak mpi_rget_aclwmulate = ompi_rget_aclwmulate_f
#pragma weak mpi_rget_aclwmulate_ = ompi_rget_aclwmulate_f
#pragma weak mpi_rget_aclwmulate__ = ompi_rget_aclwmulate_f

#pragma weak MPI_Rget_aclwmulate_f = ompi_rget_aclwmulate_f
#pragma weak MPI_Rget_aclwmulate_f08 = ompi_rget_aclwmulate_f
#else
#if ! OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS (MPI_RGET_ACLWMULATE,
                            mpi_rget_aclwmulate,
                            mpi_rget_aclwmulate_,
                            mpi_rget_aclwmulate__,
                            ompi_rget_aclwmulate_f,
                            (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype, char *result_addr, MPI_Fint *result_count, MPI_Fint *result_datatype, MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count, MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win, MPI_Fint *request, MPI_Fint *ierr),
                            (origin_addr, origin_count, origin_datatype, result_addr, result_count, result_datatype, target_rank, target_disp, target_count, target_datatype, op, win, request, ierr) )
#else
#define ompi_rget_aclwmulate_f pompi_rget_aclwmulate_f
#endif
#endif


void ompi_rget_aclwmulate_f(char *origin_addr, MPI_Fint *origin_count,
                            ...
                            MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Rget_aclwmulate(OMPI_F2C_BOTTOM(origin_addr),
