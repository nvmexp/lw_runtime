                                 ...
                                 MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Dist_graph_neighbors(c_comm, OMPI_FINT_2_INT(*maxindegree),
                                       OMPI_ARRAY_NAME_COLWERT(sources),
                                       OMPI_IS_FORTRAN_UNWEIGHTED(sourceweights) ? MPI_UNWEIGHTED : OMPI_ARRAY_NAME_COLWERT(sourceweights),
                                       OMPI_FINT_2_INT(*maxoutdegree), OMPI_ARRAY_NAME_COLWERT(destinations),
                                       OMPI_IS_FORTRAN_UNWEIGHTED(destweights) ? MPI_UNWEIGHTED : OMPI_ARRAY_NAME_COLWERT(destweights));
