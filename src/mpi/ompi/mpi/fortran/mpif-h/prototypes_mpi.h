 ...
 * symbol colwentions as well as all the internal real OMPI wrapper
 * functions (different from any of the four fortran symbol
 * colwentions for clarity, at the cost of more typing for me...).
...
PN2(void, MPI_Aclwmulate, mpi_aclwmulate, MPI_ACLWMULATE, (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype, MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count, MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win, MPI_Fint *ierr));
...
PN2(void, MPI_Raclwmulate, mpi_raclwmulate, MPI_RACLWMULATE, (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype, MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count, MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win, MPI_Fint *request, MPI_Fint *ierr));
...
PN2(void, MPI_Register_datarep, mpi_register_datarep, MPI_REGISTER_DATAREP, (char *datarep, ompi_mpi2_fortran_datarep_colwersion_fn_t *read_colwersion_fn, ompi_mpi2_fortran_datarep_colwersion_fn_t *write_colwersion_fn, ompi_mpi2_fortran_datarep_extent_fn_t *dtype_file_extent_fn, MPI_Aint *extra_state, MPI_Fint *ierr, int datarep_len));
...
PN2(void, MPI_Rget_aclwmulate, mpi_rget_aclwmulate, MPI_RGET_ACLWMULATE, (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype, char *result_addr, MPI_Fint *result_count, MPI_Fint *result_datatype, MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count, MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win, MPI_Fint *request, MPI_Fint *ierr));
...
PN2(void, MPI_Type_get_elwelope, mpi_type_get_elwelope, MPI_TYPE_GET_ELWELOPE, (MPI_Fint *type, MPI_Fint *num_integers, MPI_Fint *num_addresses, MPI_Fint *num_datatypes, MPI_Fint *combiner, MPI_Fint *ierr));
