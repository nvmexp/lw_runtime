...
#pragma weak PMPI_GET_ACLWMULATE = ompi_get_aclwmulate_f
#pragma weak pmpi_get_aclwmulate = ompi_get_aclwmulate_f
#pragma weak pmpi_get_aclwmulate_ = ompi_get_aclwmulate_f
#pragma weak pmpi_get_aclwmulate__ = ompi_get_aclwmulate_f

#pragma weak PMPI_Get_aclwmulate_f = ompi_get_aclwmulate_f
#pragma weak PMPI_Get_aclwmulate_f08 = ompi_get_aclwmulate_f
#else
OMPI_GENERATE_F77_BINDINGS (PMPI_GET_ACLWMULATE,
                            pmpi_get_aclwmulate,
                            pmpi_get_aclwmulate_,
                            pmpi_get_aclwmulate__,
                            pompi_get_aclwmulate_f,
...
#if OPAL_HAVE_WEAK_SYMBOLS
#pragma weak MPI_GET_ACLWMULATE = ompi_get_aclwmulate_f
#pragma weak mpi_get_aclwmulate = ompi_get_aclwmulate_f
#pragma weak mpi_get_aclwmulate_ = ompi_get_aclwmulate_f
#pragma weak mpi_get_aclwmulate__ = ompi_get_aclwmulate_f

#pragma weak MPI_Get_aclwmulate_f = ompi_get_aclwmulate_f
#pragma weak MPI_Get_aclwmulate_f08 = ompi_get_aclwmulate_f
#else
#if ! OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS (MPI_GET_ACLWMULATE,
                            mpi_get_aclwmulate,
                            mpi_get_aclwmulate_,
                            mpi_get_aclwmulate__,
                            ompi_get_aclwmulate_f,
                            (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype, char *result_addr, MPI_Fint *result_count, MPI_Fint *result_datatype, MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count, MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win, MPI_Fint *ierr),
                            (origin_addr, origin_count, origin_datatype, result_addr, result_count, result_datatype, target_rank, target_disp, target_count, target_datatype, op, win, ierr) )
#else
#define ompi_get_aclwmulate_f pompi_get_aclwmulate_f
#endif
#endif


void ompi_get_aclwmulate_f(char *origin_addr, MPI_Fint *origin_count,
                           ...
                           MPI_Fint *op, MPI_Fint *win, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Get_aclwmulate(OMPI_F2C_BOTTOM(origin_addr),
