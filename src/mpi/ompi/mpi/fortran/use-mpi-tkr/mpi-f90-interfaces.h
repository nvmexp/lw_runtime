...
subroutine MPI_Register_datarep(datarep, read_colwersion_fn, write_colwersion_fn, dtype_file_extent_fn, extra_state&
        , ierror)
  include 'mpif-config.h'
  character(len=*), intent(in) :: datarep
...
subroutine MPI_Type_get_elwelope(datatype, num_integers, num_addresses, num_datatypes, combiner&
        , ierror)
  integer, intent(in) :: datatype
  ...
  integer, intent(out) :: ierror
end subroutine MPI_Type_get_elwelope
