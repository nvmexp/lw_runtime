...
subroutine PMPI_Register_datarep(datarep, read_colwersion_fn, write_colwersion_fn, dtype_file_extent_fn, extra_state&
        , ierror)
  include 'mpif-config.h'
  character(len=*), intent(in) :: datarep
  external :: read_colwersion_fn
  external :: write_colwersion_fn
...
subroutine PMPI_Type_get_elwelope(datatype, num_integers, num_addresses, num_datatypes, combiner&
        , ierror)
  integer, intent(in) :: datatype
  ...
  integer, intent(out) :: ierror
end subroutine PMPI_Type_get_elwelope
