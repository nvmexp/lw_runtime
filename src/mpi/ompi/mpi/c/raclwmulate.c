...
#pragma weak MPI_Raclwmulate = PMPI_Raclwmulate
#endif
#define MPI_Raclwmulate PMPI_Raclwmulate
#endif

static const char FUNC_NAME[] = "MPI_Raclwmulate";

int MPI_Raclwmulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype,
                   ...
                   MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request)
{
        ...
        if (ompi_win_ilwalid(win)) {
            ...
            if (OMPI_SUCCESS == rc) {
                ...
                if (op != &ompi_mpi_op_replace.op && op != &ompi_mpi_op_no_op.op) {
                    ...
                    /* RACLWMULATE, unlike REDUCE, can use with derived
    ...
    rc = ompi_win->w_osc_module->osc_raclwmulate(origin_addr,
                                                origin_count,
                                                origin_datatype,
                                                target_rank,
                                                target_disp,
