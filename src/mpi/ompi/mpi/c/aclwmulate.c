...
#pragma weak MPI_Aclwmulate = PMPI_Aclwmulate
#endif
#define MPI_Aclwmulate PMPI_Aclwmulate
#endif

static const char FUNC_NAME[] = "MPI_Aclwmulate";

int MPI_Aclwmulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype,
                   ...
                   MPI_Datatype target_datatype, MPI_Op op, MPI_Win win)
{
    ...
    rc = ompi_win->w_osc_module->osc_aclwmulate(origin_addr,
                                                origin_count,
                                                origin_datatype,
                                                target_rank,
                                                target_disp,
