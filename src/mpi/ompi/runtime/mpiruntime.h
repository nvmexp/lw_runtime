...
typedef enum {
    ...
    /* The PAST_COMM_SELF_DESTRUCT state is needed because attribute
       callbacks that are ilwoked during the very beginning of
 ...
 *  levels. Required to support heterogeneous elwironments */
 ...
 * by transports and/or elwironments where MPI dynamic process
