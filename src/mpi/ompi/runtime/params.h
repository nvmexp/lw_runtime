 ...
 * corresponding destructor is ilwoked.  If enabled, Open MPI will not
 ...
 * MCA parameters are being used in the current program exelwtion.
 */
 ...
 */
OMPI_DECLSPEC extern uint32_t ompi_add_procs_lwtoff;
