 ...
 *
 * - ompi_grequest_complete() (i.e., GREQUEST_COMPLETE) is ilwoked
 * - ompi_grequest_free() is ilwoked
 *
 * Remember that ompi_grequest_free() is ilwoked by MPI_TEST* and
 ...
 * ilwoked by REQUEST_FREE).  Hence, these two functions will *always*
 * be ilwoked, but the order in which they are ilwoked is up to the
 ...
 * functions were ilwoked, then the destructor is ilwoked and
 * everything is cleaned up (and we ilwoked the grequest free_fn).
 */
...
/*
 * Grequest queries are ilwoked in two places:
 *
 ...
 *
 */
int ompi_grequest_ilwoke_query(ompi_request_t *request,
