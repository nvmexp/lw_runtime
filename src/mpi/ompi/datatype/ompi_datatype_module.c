...
int32_t ompi_datatype_init( void )
{
     ...
     * can have conselwtive, dense numbers. */
...
#define MOOG(name, index)                                               \
    ...
    ompi_datatype_default_colwertors_init();
    return OMPI_SUCCESS;
}
...
int32_t ompi_datatype_finalize( void )
{
    ...
    /* release the local colwertors (external32 and local) */
    ompi_datatype_default_colwertors_fini();
