...
opal_colwertor_t* ompi_mpi_external32_colwertor = NULL;
opal_colwertor_t* ompi_mpi_local_colwertor = NULL;

int32_t ompi_datatype_default_colwertors_init( void )
{
   /* create the extern32 colwertor */
    ompi_mpi_external32_colwertor = opal_colwertor_create( ompi_datatype_external32_arch_id, 0 );

    /* create the local colwertor */
    ompi_mpi_local_colwertor = opal_colwertor_create( opal_local_arch, 0 );

    return OMPI_SUCCESS;
}


int32_t ompi_datatype_default_colwertors_fini( void )
{
    OBJ_RELEASE( ompi_mpi_external32_colwertor );
    OBJ_RELEASE( ompi_mpi_local_colwertor );
