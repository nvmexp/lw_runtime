...
/* Base colwertor for all external32 operations */
OMPI_DECLSPEC extern opal_colwertor_t* ompi_mpi_external32_colwertor;
OMPI_DECLSPEC extern opal_colwertor_t* ompi_mpi_local_colwertor;
...
OMPI_DECLSPEC int32_t ompi_datatype_default_colwertors_init( void );
OMPI_DECLSPEC int32_t ompi_datatype_default_colwertors_fini( void );
