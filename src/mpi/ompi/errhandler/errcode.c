...
static ompi_mpi_errcode_t ompi_err_colwersion;
...
static ompi_mpi_errcode_t ompi_t_err_ilwalid_index;
static ompi_mpi_errcode_t ompi_t_err_ilwalid_item;
static ompi_mpi_errcode_t ompi_t_err_ilwalid_handle;
static ompi_mpi_errcode_t ompi_t_err_out_of_handles;
static ompi_mpi_errcode_t ompi_t_err_out_of_sessions;
static ompi_mpi_errcode_t ompi_t_err_ilwalid_session;
...
static ompi_mpi_errcode_t ompi_t_err_ilwalid;
static ompi_mpi_errcode_t ompi_t_err_ilwalid_name;
...
int ompi_mpi_errcode_init (void)
{
    ...
    CONSTRUCT_ERRCODE( ompi_err_colwersion, MPI_ERR_COLWERSION, "MPI_ERR_COLWERSION: error in data colwersion" );
    ...
    CONSTRUCT_ERRCODE( ompi_err_rma_sync, MPI_ERR_RMA_SYNC, "MPI_ERR_RMA_SYNC: error exelwting rma sync" );
    ...
    CONSTRUCT_ERRCODE( ompi_t_err_ilwalid_index, MPI_T_ERR_ILWALID_INDEX, "MPI_T_ERR_ILWALID_INDEX: invalid index" );
    CONSTRUCT_ERRCODE( ompi_t_err_ilwalid_item, MPI_T_ERR_ILWALID_ITEM, "MPI_T_ERR_ILWALID_ITEM: the item index queried is out of range" );
    CONSTRUCT_ERRCODE( ompi_t_err_ilwalid_handle, MPI_T_ERR_ILWALID_HANDLE, "MPI_T_ERR_ILWALID_HANDLE: the handle is invalid" );
    ...
    CONSTRUCT_ERRCODE( ompi_t_err_ilwalid_session, MPI_T_ERR_ILWALID_SESSION, "MPI_T_ERR_ILWALID_SESSION: session argument is not a valid session" );
    ...
    CONSTRUCT_ERRCODE( ompi_t_err_cvar_set_never, MPI_T_ERR_CVAR_SET_NEVER, "MPI_T_ERR_CVAR_SET_NEVER: variable cannot be set until end of exelwtion" );
    ...
    CONSTRUCT_ERRCODE( ompi_t_err_ilwalid, MPI_T_ERR_ILWALID, "MPI_T_ERR_ILWALID: Invalid use of the interface or bad parameter value(s)" );
    CONSTRUCT_ERRCODE( ompi_t_err_ilwalid_name, MPI_T_ERR_ILWALID_NAME, "MPI_T_ERR_ILWALID_NAME: The variable or category name is invalid" );
...
int ompi_mpi_errcode_finalize(void)
{
    ...
    OBJ_DESTRUCT(&ompi_err_colwersion);
    ...
    OBJ_DESTRUCT(&ompi_t_err_ilwalid_index);
    OBJ_DESTRUCT(&ompi_t_err_ilwalid_item);
    OBJ_DESTRUCT(&ompi_t_err_ilwalid_handle);
    OBJ_DESTRUCT(&ompi_t_err_out_of_handles);
    OBJ_DESTRUCT(&ompi_t_err_out_of_sessions);
    OBJ_DESTRUCT(&ompi_t_err_ilwalid_session);
    ...
    OBJ_DESTRUCT(&ompi_t_err_ilwalid);
    OBJ_DESTRUCT(&ompi_t_err_ilwalid_name);
