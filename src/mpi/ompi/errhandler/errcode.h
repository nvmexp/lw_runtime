 ...
 */
static inline bool ompi_mpi_errcode_is_ilwalid(int errcode)
{
 ...
 *
 * Ilwoked from ompi_mpi_init(); sets up all static MPI error codes,
 */
 ...
 *
 * Ilwokes from ompi_mpi_finalize(); tears down the error code array.
 */
