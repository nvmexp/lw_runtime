...
$constants->{MPI_KEYVAL_ILWALID} = -1;
...
$constants->{MPI_ERR_COLWERSION} = 25;
...
$constants->{MPI_T_ERR_ILWALID_INDEX} = 57;
$constants->{MPI_T_ERR_ILWALID_ITEM} = 58;
$constants->{MPI_T_ERR_ILWALID_HANDLE} = 59;
$constants->{MPI_T_ERR_OUT_OF_HANDLES} = 60;
$constants->{MPI_T_ERR_OUT_OF_SESSIONS} = 61;
$constants->{MPI_T_ERR_ILWALID_SESSION} = 62;
...
$constants->{MPI_T_ERR_ILWALID} = 72;
...
$constants->{OMPI_COMM_TYPE_LW} = 10;
...
my $lio_constants;
$lio_constants->{MPI_DISPLACEMENT_LWRRENT} = -54278278;
