...
!     Note that MPI_COLWERSION_FN_NULL is a "constant" (it is only ever
!     checked for comparison; it is never ilwoked), but it is passed as
...
!     defined with an integer value in mpif-common.h.
      external MPI_COLWERSION_FN_NULL
