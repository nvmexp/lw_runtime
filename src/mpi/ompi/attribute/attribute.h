...
/**
 * Union to help colwert between Fortran attributes (which must be
...
/**
 * Colwenient way to initialize the attribute hash table per MPI-Object
 */
 ...
 * @param type           Type of attribute (COMM/WIN/DTYPE) (IN)
 * @param key            key, which is set to MPI_KEY_ILWALID (IN/OUT)
