...
static int ompi_comm_activate_nb_complete (ompi_comm_request_t *request)
{
     ...
     *
     * Specifically, this function is ilwoked by all proceses in the
     ...
     * the old communicator need to ilwoke this function.
     *
                                         ...
                                         ompi_request_t **req)
{
    ...
    /* basic relwrsive doubling allreduce on the group */
