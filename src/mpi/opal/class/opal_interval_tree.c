...
{
    /* Relwrsive inorder traversal for delete */
                                            ...
                                            int lwrrent_black_depth)
{
    ...
    return opal_interval_tree_verify_node (tree, node->left, black_depth, lwrrent_black_depth) ||
        opal_interval_tree_verify_node (tree, node->right, black_depth, lwrrent_black_depth);
}
