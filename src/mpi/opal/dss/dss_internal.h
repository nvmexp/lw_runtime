...
int opal_dss_pack_status(opal_buffer_t *buffer, const void *src,
                         int32_t num_vals, opal_data_type_t type);
int opal_dss_pack_elwar(opal_buffer_t *buffer, const void *src,
                        int32_t num_vals, opal_data_type_t type);
...
int opal_dss_unpack_elwar(opal_buffer_t *buffer, void *dest,
                          int32_t *num_vals, opal_data_type_t type);
...
int opal_dss_copy_elwar(opal_elwar_t **dest, opal_elwar_t *src, opal_data_type_t type);
...
int opal_dss_compare_elwar(opal_elwar_t *value1, opal_elwar_t *value2, opal_data_type_t type);
