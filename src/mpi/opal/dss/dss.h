 ...
 * payload - the load function cannot colwert to network byte order
 ...
 * exelwted as part of the program startup.
 */
 ...
 *
 * Since registered data types can be complex structures, the system
 * needs some way to know how to print them (i.e., colwert them to a string
 * representation).
 *
 ...
 * future ilwocations of opal_dss.pack(), opal_dss.unpack(), opal_dss.copy(),
 ...
 * used relwrsively to build larger types (e.g., packing/unpacking
