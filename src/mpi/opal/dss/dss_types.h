...
#define OPAL_DSS_ID_ILWALID OPAL_DSS_ID_MAX
...
#define    OPAL_ELWAR               (opal_data_type_t)   39 /**< corresponds to PMIx elwar type */
 ...
 * values and still *know* how to colwert it for PMIx */
...
/* defaine a struct for elwar directives */
typedef struct {
    opal_list_item_t super;
    char *elwar;
    char *value;
...
OPAL_DECLSPEC OBJ_CLASS_DECLARATION(opal_elwar_t);
