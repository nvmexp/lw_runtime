...
struct opal_datatype_t {
    ...
    dt_type_desc_t     opt_desc; /**< short description of the data used when colwersion is useless
                                      or in the send case (without colwersion) */

    size_t             *ptypes;  /**< array of basic predefined types that facilitate the computing
                                      of the remote size in heterogeneous elwironments. The length of the
