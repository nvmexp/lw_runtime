...
static int copy_##TYPENAME( opal_colwertor_t *pColwertor, size_t count,                 \
...
static size_t copy_##TYPENAME##_##COUNT( opal_colwertor_t *pColwertor, size_t count,         \
                                         char* from, size_t from_len, ptrdiff_t from_extent, \
                                         char* to, size_t to_len, ptrdiff_t to_extent,       \
                                         ptrdiff_t *advance )              \
{                                                                               \
...
colwersion_fct_t opal_datatype_copy_functions[OPAL_DATATYPE_MAX_PREDEFINED] = {
    (colwersion_fct_t)NULL,                      /* OPAL_DATATYPE_LOOP         */
    (colwersion_fct_t)NULL,                      /* OPAL_DATATYPE_END_LOOP     */
    (colwersion_fct_t)NULL,                      /* OPAL_DATATYPE_LB           */
    (colwersion_fct_t)NULL,                      /* OPAL_DATATYPE_UB           */
    (colwersion_fct_t)copy_bytes_1,              /* OPAL_DATATYPE_INT1         */
    (colwersion_fct_t)copy_bytes_2,              /* OPAL_DATATYPE_INT2         */
    (colwersion_fct_t)copy_bytes_4,              /* OPAL_DATATYPE_INT4         */
    (colwersion_fct_t)copy_bytes_8,              /* OPAL_DATATYPE_INT8         */
    (colwersion_fct_t)copy_bytes_16,             /* OPAL_DATATYPE_INT16        */
    (colwersion_fct_t)copy_bytes_1,              /* OPAL_DATATYPE_UINT1        */
    (colwersion_fct_t)copy_bytes_2,              /* OPAL_DATATYPE_UINT2        */
    (colwersion_fct_t)copy_bytes_4,              /* OPAL_DATATYPE_UINT4        */
    (colwersion_fct_t)copy_bytes_8,              /* OPAL_DATATYPE_UINT8        */
    (colwersion_fct_t)copy_bytes_16,             /* OPAL_DATATYPE_UINT16       */
    (colwersion_fct_t)copy_float_2,              /* OPAL_DATATYPE_FLOAT2       */
    (colwersion_fct_t)copy_float_4,              /* OPAL_DATATYPE_FLOAT4       */
    (colwersion_fct_t)copy_float_8,              /* OPAL_DATATYPE_FLOAT8       */
    (colwersion_fct_t)copy_float_12,             /* OPAL_DATATYPE_FLOAT12       */
    (colwersion_fct_t)copy_float_16,             /* OPAL_DATATYPE_FLOAT16      */
    (colwersion_fct_t)copy_float_complex,        /* OPAL_DATATYPE_FLOAT_COMPLEX */
    (colwersion_fct_t)copy_double_complex,       /* OPAL_DATATYPE_DOUBLE_COMPLEX */
    (colwersion_fct_t)copy_long_double_complex,  /* OPAL_DATATYPE_LONG_DOUBLE_COMPLEX */
    (colwersion_fct_t)copy_bool,                 /* OPAL_DATATYPE_BOOL         */
    (colwersion_fct_t)copy_wchar,                /* OPAL_DATATYPE_WCHAR        */
    (colwersion_fct_t)NULL                       /* OPAL_DATATYPE_UNAVAILABLE  */
};
