...
enum {
    ...
    /** address range is lwca buffer */
    MCA_RCACHE_FLAGS_LWDA_GPU_MEM      = 0x0008,
    /** register with common lwca */
    MCA_RCACHE_FLAGS_LWDA_REGISTER_MEM = 0x0010,
    /** invalid registration (no valid for passing to rcache register) */
    MCA_RCACHE_FLAGS_ILWALID           = 0x0080,
...
struct mca_rcache_base_registration_t {
    ...
    unsigned char *bound;
    /** artifact of old mpool/rcache architecture. used by lwca code */
 ...
 */
typedef int (*mca_rcache_base_module_ilwalidate_range_fn_t) (mca_rcache_base_module_t *rcache,
...
struct mca_rcache_base_module_t {
    ...
    mca_rcache_base_module_ilwalidate_range_fn_t rcache_ilwalidate_range;
