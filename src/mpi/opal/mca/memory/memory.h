...
/* NOTE: This framework accomodates two kinds of memory hooks systems:
   ...
   memoryc_process() function pointer (below), will be ilwoked.  If
   ...
   never be ilwoked (and can legally be NULL).
*/
...
/**
 * Prototype for a function that is ilwoked when the memory base is
 * trying to select a component. This funtionality is required.
 */
typedef int (*opal_memory_base_component_query_fn_t)(int *priority);

/**
 * Prototype for a function that is ilwoked when Open MPI starts to
 ...
 * opal_memory_base_component_register_fn_t: this function is ilwoked
...
typedef struct opal_memory_base_component_2_0_0_t {
    ...
    /** Function ilwoked when Open MPI starts "caring" about a
        specific memory region */
    opal_memory_base_component_register_fn_t memoryc_register;
    /** Function ilwoked when Open MPI stops "caring" about a
        specific memory region */
    opal_memory_base_component_deregister_fn_t memoryc_deregister;
    /** Function ilwoked in order to set malloc'ed memory alignment */
