...
mca_btl_portals4_component_open(void)
{
    ...
    mca_btl_portals4_module.send_md_h = PTL_ILWALID_HANDLE;

    mca_btl_portals4_module.portals_ni_h = PTL_ILWALID_HANDLE;
    mca_btl_portals4_module.zero_md_h = PTL_ILWALID_HANDLE;

    mca_btl_portals4_module.long_overflow_me_h = PTL_ILWALID_HANDLE;
