...
struct mca_btl_base_endpoint_t {
    ...
    opal_mutex_t                    endpoint_send_lock;    /**< lock for conlwrrent access to endpoint state */
    opal_mutex_t                    endpoint_recv_lock;    /**< lock for conlwrrent access to endpoint state */
    ...
    bool                            endpoint_nbo;          /**< colwert headers to network byte order? */
};
