...
mca_base_var_enum_value_flag_t mca_btl_base_flag_enum_flags[] = {
    ...
    {MCA_BTL_FLAGS_LWDA_PUT, "lwca-put", 0},
    {MCA_BTL_FLAGS_LWDA_GET, "lwca-get", 0},
    {MCA_BTL_FLAGS_LWDA_COPY_ASYNC_SEND, "lwca-async-send", 0},
    {MCA_BTL_FLAGS_LWDA_COPY_ASYNC_RECV, "lwca-async-recv", 0},
