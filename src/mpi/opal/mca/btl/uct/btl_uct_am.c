...
static inline void _mca_btl_uct_send_pack (void *data, void *header, size_t header_size, opal_colwertor_t *colwertor,
                                           size_t payload_size)
{
    ...
    (void) opal_colwertor_pack (colwertor, &iov, &iov_count, &length);
                                                           ...
                                                           size_t *size, uint32_t flags)
{
    ...
    if (OPAL_UNLIKELY(opal_colwertor_need_buffers(colwertor) || total_size > uct_btl->super.btl_eager_limit)) {
        ...
        opal_colwertor_get_lwrrent_pointer (colwertor, &data_ptr);
...
int mca_btl_uct_send_frag (mca_btl_uct_module_t *uct_btl, mca_btl_uct_base_frag_t *frag, bool append)
{
     ...
     * to protect against deep relwrsion */
...
static size_t mca_btl_uct_sendi_pack (void *data, void *arg)
{
    ...
    _mca_btl_uct_send_pack ((void *)((intptr_t)data + 8), args->header, args->header_size, args->colwertor,
                            args->payload_size);
...
int mca_btl_uct_sendi (mca_btl_base_module_t *btl, mca_btl_base_endpoint_t *endpoint, opal_colwertor_t *colwertor,
                       ...
                       mca_btl_base_tag_t tag, mca_btl_base_descriptor_t **descriptor)
{
    ...
    if (0 == payload_size) {
        ...
        _mca_btl_uct_send_pack (data, header, header_size, colwertor, payload_size);
        ...
        size = uct_ep_am_bcopy (ep_handle, MCA_BTL_UCT_FRAG, mca_btl_uct_sendi_pack,
                                &(mca_btl_uct_sendi_pack_args_t) {.am_header = am_header.value,
                                        ...
                                        .colwertor = colwertor, .payload_size = payload_size}, 0);
