...
/**
 * @brief Colwert UCT capabilities to BTL flags
 */
...
/**
 * @brief Colwert UCT capability flags to BTL flags
 *
...
/**
 * @brief Colwert UCT capabilities to BTL atomic flags
 */
...
/**
 * @brief Colwert UCT capability flags to BTL atomic flags
 *
 * @param[in] cap_flags  UCT capability flags
 *
...
mca_btl_uct_device_context_t *mca_btl_uct_context_create (mca_btl_uct_module_t *module, mca_btl_uct_tl_t *tl, int context_id, bool enable_progress)
{
    ...
    OBJ_CONSTRUCT(&context->mutex, opal_relwrsive_mutex_t);
