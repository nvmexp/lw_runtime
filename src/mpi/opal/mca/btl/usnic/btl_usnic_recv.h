    ...
    uint32_t window_index)
{
    ...
    /* See if the leftmost segment in the receiver window is
       oclwpied.  If so, advance the window.  Repeat until we hit
       an unoclwpied position in the window. */
 ...
 * possible.
 * See README.txt for a dislwssion of receive fastpath
 */
static inline void
