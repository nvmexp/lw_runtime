...
static char* pmix_error(int pmix_err)
{
    ...
    case PMI2_ERR_ILWALID_ARG: err_msg = "Invalid argument"; break;
    case PMI2_ERR_ILWALID_KEY: err_msg = "Invalid key argument"; break;
    case PMI2_ERR_ILWALID_KEY_LENGTH: err_msg = "Invalid key length argument"; break;
    case PMI2_ERR_ILWALID_VAL: err_msg = "Invalid value argument"; break;
    case PMI2_ERR_ILWALID_VAL_LENGTH: err_msg = "Invalid value length argument"; break;
    case PMI2_ERR_ILWALID_LENGTH: err_msg = "Invalid length argument"; break;
    case PMI2_ERR_ILWALID_NUM_ARGS: err_msg = "Invalid number of arguments"; break;
    case PMI2_ERR_ILWALID_ARGS: err_msg = "Invalid args argument"; break;
    case PMI2_ERR_ILWALID_NUM_PARSED: err_msg = "Invalid num_parsed length argument"; break;
    case PMI2_ERR_ILWALID_KEYVALP: err_msg = "Invalid keyvalp argument"; break;
    case PMI2_ERR_ILWALID_SIZE: err_msg = "Invalid size argument"; break;
