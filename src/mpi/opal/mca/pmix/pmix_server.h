 ...
 * exelwtes the callback function, thus allowing the server support
 ...
 * how the fence is to be exelwted (e.g., timeout limits).
 *
 ...
 *
 * The list of opal_value_t includes any directives from the user regarding
 * how the operation is to be exelwted (e.g., timeout limits).
 */
 ...
 * before exelwting the callback function, or should callback with whatever
 * data is immediately available.
 *
 * The list of opal_value_t includes any directives from the user regarding
 * how the operation is to be exelwted (e.g., timeout limits, whether the
 ...
 * of string keys along with the scope within which the data is expected to have
 * been published. The callback is to be exelwted upon completion of the delete
 * procedure */
