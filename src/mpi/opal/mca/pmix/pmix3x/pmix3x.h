...
OPAL_MODULE_DECLSPEC void pmix3x_server_deregister_client(const opal_process_name_t *proc,
                                                          opal_pmix_op_cbfunc_t cbfunc,
                                                          void *cbdata);
OPAL_MODULE_DECLSPEC int pmix3x_server_setup_fork(const opal_process_name_t *proc, char ***elw);
...
OPAL_MODULE_DECLSPEC void pmix3x_event_hdlr(size_t evhdlr_registration_id,
                                            ...
                                            void *cbdata);
OPAL_MODULE_DECLSPEC pmix_status_t pmix3x_colwert_opalrc(int rc);
OPAL_MODULE_DECLSPEC int pmix3x_colwert_rc(pmix_status_t rc);

OPAL_MODULE_DECLSPEC opal_vpid_t pmix3x_colwert_rank(pmix_rank_t rank);
OPAL_MODULE_DECLSPEC pmix_rank_t pmix3x_colwert_opalrank(opal_vpid_t vpid);

OPAL_MODULE_DECLSPEC opal_pmix_scope_t pmix3x_colwert_scope(pmix_scope_t scope);
OPAL_MODULE_DECLSPEC pmix_scope_t pmix3x_colwert_opalscope(opal_pmix_scope_t scope);

OPAL_MODULE_DECLSPEC pmix_data_range_t pmix3x_colwert_opalrange(opal_pmix_data_range_t range);
OPAL_MODULE_DECLSPEC opal_pmix_data_range_t pmix3x_colwert_range(pmix_data_range_t range);

OPAL_MODULE_DECLSPEC opal_pmix_persistence_t pmix3x_colwert_persist(pmix_persistence_t scope);
OPAL_MODULE_DECLSPEC pmix_persistence_t pmix3x_colwert_opalpersist(opal_pmix_persistence_t scope);
...
OPAL_MODULE_DECLSPEC opal_pmix_alloc_directive_t pmix3x_colwert_allocdir(pmix_alloc_directive_t dir);

OPAL_MODULE_DECLSPEC char* pmix3x_colwert_jobid(opal_jobid_t jobid);

OPAL_MODULE_DECLSPEC int pmix3x_colwert_state(pmix_proc_state_t state);

OPAL_MODULE_DECLSPEC pmix_proc_state_t pmix3x_colwert_opalstate(int state);
