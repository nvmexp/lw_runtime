...
. PMI_ERR_ILWALID_ARG - invalid argument
. PMI_ERR_ILWALID_KEY - invalid key argument
. PMI_ERR_ILWALID_KEY_LENGTH - invalid key length argument
. PMI_ERR_ILWALID_VAL - invalid val argument
. PMI_ERR_ILWALID_VAL_LENGTH - invalid val length argument
. PMI_ERR_ILWALID_LENGTH - invalid length argument
. PMI_ERR_ILWALID_NUM_ARGS - invalid number of arguments
. PMI_ERR_ILWALID_ARGS - invalid args argument
. PMI_ERR_ILWALID_NUM_PARSED - invalid num_parsed length argument
. PMI_ERR_ILWALID_KEYVALP - invalid keyvalp argument
- PMI_ERR_ILWALID_SIZE - invalid size argument
...
. PMI_ERR_ILWALID_ARG - invalid rank argument
. PMI_ERR_ILWALID_LENGTH - invalid length argument
...
different implementations of PMI to be used with the same exelwtable.  These
...
. PMI_ERR_ILWALID_KVS - invalid kvsname argument
. PMI_ERR_ILWALID_KEY - invalid key argument
. PMI_ERR_ILWALID_VAL - invalid val argument
- PMI_FAIL - put failed
