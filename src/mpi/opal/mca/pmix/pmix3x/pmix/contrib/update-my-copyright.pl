...
$my_search_name = $ELW{PMIX_COPYRIGHT_SEARCH_NAME}
    if (defined($ELW{PMIX_COPYRIGHT_SEARCH_NAME}));
$my_formal_name = $ELW{PMIX_COPYRIGHT_FORMAL_NAME}
    if (defined($ELW{PMIX_COPYRIGHT_FORMAL_NAME}));
