...
# src/mca/installdirs/config for pkgdatadir; there is lwrrently no
...
rapid launch and wireup of the roughly 1M processes exelwting across 100k nodes
...
module-whatis   "Sets up PMIx v%{version} in your elwiornment"
