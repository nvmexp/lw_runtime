...
AC_DEFUN([PMIX_CHECK_DSTOR_LOCK],[
    ...
    PMIX_VAR_SCOPE_PUSH(orig_libs pmix_prefer_write_nonrelwrsive)
    ...
    pmix_prefer_write_nonrelwrsive=0
    ...
    if test "$DSTORE_PTHREAD_LOCK" = "1"; then
        ...
        AC_CHECK_FUNC([pthread_rwlockattr_setkind_np],
                      [pmix_pthread_rwlockattr_setkind_np=yes
                       AC_EGREP_CPP([yes],
                                    [#include <pthread.h>
                                     #ifdef PTHREAD_RWLOCK_PREFER_WRITER_NONRELWRSIVE_NP
                                       yes
                                     #endif
                                    ],
                                    [pmix_pthread_rwlock_prefer_writer_nonrelwrsive_np=yes],
                                    [pmix_pthread_rwlock_prefer_writer_nonrelwrsive_np=no])],
        ...
        AS_IF([test "$pmix_pthread_rwlockattr_setkind_np" = "yes" && test "$pmix_pthread_rwlock_prefer_writer_nonrelwrsive_np" = "yes"],
              [pmix_prefer_write_nonrelwrsive=1],
              [pmix_prefer_write_nonrelwrsive=0])
    ...
    AC_DEFINE_UNQUOTED([PMIX_PTHREAD_RWLOCK_PREFER_WRITER_NONRELWRSIVE_NP],
                       [$pmix_prefer_write_nonrelwrsive],
                       [Whether or not we found the optional write_nonrelwrsive_np flag])
