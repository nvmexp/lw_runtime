...
AC_DEFUN([PMIX_SUMMARY_ADD],[
    PMIX_VAR_SCOPE_PUSH([pmix_summary_section pmix_summary_line pmix_summary_section_lwrrent])
    ...
    pmix_summary_section_lwrrent=$(eval echo \$pmix_summary_values_$pmix_summary_section)

    if test -z "$pmix_summary_section_lwrrent" ; then
        ...
        eval pmix_summary_values_$pmix_summary_section=\"$pmix_summary_section_lwrrent,$pmix_summary_line\"
    fi
