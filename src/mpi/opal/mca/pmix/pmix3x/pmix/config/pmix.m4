...
dnl Copyright (c) 2011-2013 LWPU Corporation.  All rights reserved.
...
AC_DEFUN([PMIX_SETUP_CORE],[
    ...
    AC_CHECK_FUNCS([asprintf snprintf vasprintf vsnprintf strsignal socketpair strncpy_s usleep statfs statvfs getpeereid getpeerucred strnlen posix_fallocate tcgetpgrp setpgid ptsname openpty setelw])
...
# PMIX_INIT and an external caller (if PMIX_INIT is not ilwoked).
