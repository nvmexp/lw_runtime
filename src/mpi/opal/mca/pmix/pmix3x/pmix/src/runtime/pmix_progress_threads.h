 ...
 *
 * Once this function is ilwoked as many times as
 * pmix_progress_thread_init() was ilwoked on this name (or NULL), the
 ...
 *
 * Once this function is ilwoked after pmix_progress_thread_stop() has been called
 * as many times as pmix_progress_thread_init() was ilwoked on this name (or NULL),
 ...
 * that event base until pmix_progress_thread_resume() is ilwoked on
 * that name.
 *
 * Will return PMIX_ERR_NOT_FOUND if the progress thread name does not
 * exist; PMIX_SUCCESS otherwise.
