...
typedef void (*pmix_ilwentory_cbfunc_t)(pmix_status_t status,
...
typedef struct {
    ...
    pmix_info_t *info;
    size_t ninfo;
    pmix_ilwentory_cbfunc_t cbfunc;
    pmix_info_cbfunc_t infocbfunc;
    pmix_op_cbfunc_t opcbfunc;
    void *cbdata;
} pmix_ilwentory_rollup_t;
PMIX_CLASS_DECLARATION(pmix_ilwentory_rollup_t);
...
typedef struct {
    ...
    pmix_modex_cbfunc_t cbfunc;     // cbfunc to be exelwted when data is available
    void *cbdata;
} pmix_dmdx_request_t;
...
#define PMIX_EXELWTE_COLLECTIVE(c, t, f)                        \
    do {                                                        \
