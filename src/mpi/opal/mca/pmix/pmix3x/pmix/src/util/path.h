 ...
 *  @param elwv  Pointer to string containing environment
 *
...
PMIX_EXPORT char *pmix_path_find(char *fname, char **pathv, int mode,
                                 char **elwv) __pmix_attribute_malloc__ __pmix_attribute_warn_unused_result__;
 ...
 *  @param elwv  Pointer to environment list
...
PMIX_EXPORT char *pmix_path_findv(char *fname, int mode,
                                  char **elwv, char *wrkdir) __pmix_attribute_malloc__ __pmix_attribute_warn_unused_result__;
/**
...
/**
 * Find the absolute path for an exelwtable and return it.
 *
 *  @param app_name  Exelwtable name
 *
 ...
 * on any network file system (lwrrently NFS, Lustre, GPFS,  Panasas
 * and PVFS2 ).
 *
