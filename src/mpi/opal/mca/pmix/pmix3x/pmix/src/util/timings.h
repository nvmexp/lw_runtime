 ...
 * @param ... other parameters that should be colwerted to string representation
 *
 ...
 * @param func function name where event oclwrs
 * @param file file name where event oclwrs
 ...
 * Colwinient macro, may be implemented with the sequence of three previously
 * defined macroses:
