 ...
 * without the need to repeatedly ilwoke pmix_cmd_line_make_opt3() (or
...
BEGIN_C_DECLS
    ...
    struct pmix_cmd_line_t {
        ...
        /** Thread safety */
        pmix_relwrsive_mutex_t lcl_mutex;
     ...
     * pmix_cmd_line_parse(), or pmix_cmd_line_parse() was not ilwoked on
     * this handle.
     *
     ...
     * handle, or pmix_cmd_line_parse() was not ilwoked on this handle.
     */
