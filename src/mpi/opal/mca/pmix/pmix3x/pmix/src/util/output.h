 ...
 * pmix_output_init() (and closed after ilwoking
...
struct pmix_output_stream_t {
     ...
     * exist when pmix_output_open() is ilwoked.  See pmix_output()
 ...
 * session directory does not exist when pmix_output() is ilwoked,
 ...
 * function will effectively ilwoke pmix_output to send the output to
 * the stream.
 *
 ...
 * will be used for all future ilwocations of pmix_output_verbose().
 */
