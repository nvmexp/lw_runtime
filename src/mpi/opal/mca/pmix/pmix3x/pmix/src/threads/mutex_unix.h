...
PMIX_EXPORT PMIX_CLASS_DECLARATION(pmix_relwrsive_mutex_t);

#if defined(PTHREAD_RELWRSIVE_MUTEX_INITIALIZER_NP)
#define PMIX_PTHREAD_RELWRSIVE_MUTEX_INITIALIZER PTHREAD_RELWRSIVE_MUTEX_INITIALIZER_NP
#elif defined(PTHREAD_RELWRSIVE_MUTEX_INITIALIZER)
#define PMIX_PTHREAD_RELWRSIVE_MUTEX_INITIALIZER PTHREAD_RELWRSIVE_MUTEX_INITIALIZER
#endif
...
#if defined(PMIX_PTHREAD_RELWRSIVE_MUTEX_INITIALIZER)

#if PMIX_ENABLE_DEBUG
#define PMIX_RELWRSIVE_MUTEX_STATIC_INIT                                \
    {                                                                   \
        .super = PMIX_OBJ_STATIC_INIT(pmix_mutex_t),                    \
        .m_lock_pthread = PMIX_PTHREAD_RELWRSIVE_MUTEX_INITIALIZER,     \
        .m_lock_debug = 0,                                              \
        .m_lock_file = NULL,                                            \
        .m_lock_line = 0,                                               \
        .m_lock_atomic = {PMIX_ATOMIC_LOCK_UNLOCKED},                   \
