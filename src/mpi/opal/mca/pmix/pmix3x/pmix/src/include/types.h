...
/*
 * Colwert a 64 bit value to network byte order.
 */
...
/*
 * Colwert a 64 bit value from network to host byte order.
 */
...
/* Colwert size_t value from host to network byte order and back */
#if SIZEOF_SIZE_T == 4
...
/**
 * Colwert between a local representation of pointer and a 64 bits value.
 */
