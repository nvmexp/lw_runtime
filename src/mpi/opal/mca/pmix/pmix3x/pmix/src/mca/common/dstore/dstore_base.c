...
#define ESH_ELW_INITIAL_SEG_SIZE    "INITIAL_SEG_SIZE"
#define ESH_ELW_NS_META_SEG_SIZE    "NS_META_SEG_SIZE"
#define ESH_ELW_NS_DATA_SEG_SIZE    "NS_DATA_SEG_SIZE"
#define ESH_ELW_LINEAR              "SM_USE_LINEAR_SEARCH"
...
static void _set_constants_from_env(pmix_common_dstore_ctx_t *ds_ctx)
{
    ...
    if( NULL != (str = getenv(ESH_ELW_INITIAL_SEG_SIZE)) ) {
    ...
    if( NULL != (str = getenv(ESH_ELW_NS_META_SEG_SIZE)) ) {
    ...
    if( NULL != (str = getenv(ESH_ELW_NS_DATA_SEG_SIZE)) ) {
    ...
    if (NULL != (str = getenv(ESH_ELW_LINEAR))) {
