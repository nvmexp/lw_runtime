...
static void _notification_eviction_cbfunc(struct pmix_hotel_t *hotel,
                                          ...
                                          void *oclwpant)
{
    pmix_notify_caddy_t *cache = (pmix_notify_caddy_t*)oclwpant;
    PMIX_RELEASE(cache);
}
                  ...
                  pmix_ptl_cbfunc_t cbfunc)
{
    ...
    pmix_globals.myid.rank = PMIX_RANK_ILWALID;
    ...
    if (NULL != (evar = getelw("PMIX_HOSTNAME"))) {
    ...
    if (NULL != (evar = getelw("PMIX_DEBUG"))) {
