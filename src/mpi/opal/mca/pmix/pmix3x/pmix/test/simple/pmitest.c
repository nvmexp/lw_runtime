...
static const char * PMI_Err_str(int error)
{
    ...
    case PMI_FAIL:
	return "PMI_FAIL";
    case PMI_ERR_ILWALID_ARG:
	return "PMI_ERR_ILWALID_ARG";
    case PMI_ERR_ILWALID_KEY:
	return "PMI_ERR_ILWALID_KEY";
    case PMI_ERR_ILWALID_KEY_LENGTH:
	return "PMI_ERR_ILWALID_KEY_LENGTH";
    case PMI_ERR_ILWALID_VAL:
	return "PMI_ERR_ILWALID_VAL";
    case PMI_ERR_ILWALID_VAL_LENGTH:
	return "PMI_ERR_ILWALID_VAL_LENGTH";
    case PMI_ERR_ILWALID_LENGTH:
