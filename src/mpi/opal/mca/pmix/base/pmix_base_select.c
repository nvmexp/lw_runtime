...
int opal_pmix_base_select(void)
{
    ...
    // MCA param).
    char *pmix_show_load_errors_elw = mca_base_component_show_load_errors ? "1" : "0";
    opal_setelw("PMIX_MCA_mca_base_component_show_load_errors", pmix_show_load_errors_elw, true, &elwiron);
