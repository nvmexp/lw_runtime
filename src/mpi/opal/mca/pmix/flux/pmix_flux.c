...
#define PMI_ERR_ILWALID_ARG          3
#define PMI_ERR_ILWALID_KEY          4
#define PMI_ERR_ILWALID_KEY_LENGTH   5
#define PMI_ERR_ILWALID_VAL          6
#define PMI_ERR_ILWALID_VAL_LENGTH   7
#define PMI_ERR_ILWALID_LENGTH       8
#define PMI_ERR_ILWALID_NUM_ARGS     9
#define PMI_ERR_ILWALID_ARGS        10
#define PMI_ERR_ILWALID_NUM_PARSED  11
#define PMI_ERR_ILWALID_KEYVALP     12
#define PMI_ERR_ILWALID_SIZE        13
...
static int PMI_Init (int *spawned)
{
    ...
    if (!dso) {
        const char *path;
        if ((path = getelw ("FLUX_PMI_LIBRARY_PATH")))
...
static int flux_init(opal_list_t *ilist)
{
    ...
    /* get integer job id */
    if (!(jobid = getelw ("FLUX_JOB_ID"))) {
        opal_output(0, "getelw FLUX_JOB_ID [%s:%d:%s]: failed\n",
