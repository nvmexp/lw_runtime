...
static void opal_opcbfunc(int status, void *cbdata)
{
    ...
    if (NULL != opalcaddy->opcbfunc) {
        opalcaddy->opcbfunc(ext2x_colwert_opalrc(status), opalcaddy->cbdata);
    }
                                                ...
                                                pmix_op_cbfunc_t cbfunc, void *cbdata)
{
    ...
    proc.vpid = ext2x_colwert_rank(p->rank);
                                     ...
                                     pmix_op_cbfunc_t cbfunc, void *cbdata)
{
    ...
    for (n=0; n < nprocs; n++) {
        ...
        nm->name.vpid = ext2x_colwert_rank(procs[n].rank);
    }
    ...
    if (NULL != opalcaddy->lkupcbfunc) {
        ...
        if (NULL != data) {
            ...
            OPAL_LIST_FOREACH(p, data, opal_pmix_pdata_t) {
                ...
                d[n].proc.rank = ext2x_colwert_opalrank(p->proc.vpid);
                                         ...
                                         pmix_op_cbfunc_t cbfunc, void *cbdata)
{
    ...
    src.vpid = ext2x_colwert_rank(source->rank);
                        ...
                        void *release_cbdata)
{
    ...
    /* colwert the status */
    pcaddy->status = ext2x_colwert_opalrc(status);
                                  ...
                                  void *cbdata)
{
    ...
    requestor.vpid = ext2x_colwert_rank(proct->rank);
                                     ...
                                     pmix_info_cbfunc_t cbfunc, void *cbdata)
{
    ...
    odir = ext2x_colwert_allocdir(directive);
                                        ...
                                        pmix_info_cbfunc_t cbfunc, void *cbdata)
{
    ...
    for (n=0; n < ntargets; n++) {
        ...
        nm->name.vpid = ext2x_colwert_rank(targets[n].rank);
    }
