...
OPAL_MODULE_DECLSPEC void pmix1_server_deregister_client(const opal_process_name_t *proc,
                                                         opal_pmix_op_cbfunc_t cbfunc,
                                                         void *cbdata);
OPAL_MODULE_DECLSPEC int pmix1_server_setup_fork(const opal_process_name_t *proc, char ***elw);
...
OPAL_MODULE_DECLSPEC pmix_status_t pmix1_colwert_opalrc(int rc);
OPAL_MODULE_DECLSPEC int pmix1_colwert_rc(pmix_status_t rc);
OPAL_MODULE_DECLSPEC pmix_scope_t pmix1_colwert_opalscope(opal_pmix_scope_t scope);
