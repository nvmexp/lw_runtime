...
AC_DEFUN([MCA_opal_hwloc_CONFIG_REQUIRE],[
   ...
   # If this shell variable is not 1, then this m4 is being ilwoked
   ...
   AS_IF([test "$opal_hwloc_its_time_to_configure" != "1"],
    ...
    # "opal" and "hwloc", because this macro is ilwoked via AC
    # REQUIRE.
   ...
   # Similar to above, if this m4 is being ilwoked "early" via AC
