 ...
 *
 * \note Flags \p flags are lwrrently unused, must be 0.
 */
 ...
 * \return -1 with errno set to EILWAL if \p fileoffset, \p mmap_address
 ...
 *
 * \return -1 with errno set to EILWAL if the layout of the topology structure
