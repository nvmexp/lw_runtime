 ...
 * this file so as to ease colwersion between their respective types.
 */
 ...
 *
 * This interface offers ways to colwert between hwloc cpusets and glibc cpusets
...
/** \brief Colwert hwloc CPU set \p toposet into glibc sched affinity CPU set \p schedset
 *
...
/** \brief Colwert glibc sched affinity CPU set \p schedset into hwloc CPU set
 *
 * This function may be used before calling sched_setaffinity  or any other function
 * that takes a cpu_set_t  as input parameter.
 *
