...
#define HWLOC_DISTANCES_ADD_FLAG_GROUP_INACLWRATE HWLOC_NAME_CAPS(DISTANCES_ADD_FLAG_GROUP_INACLWRATE)
...
#define hwloc_lwda_get_device_pci_ids HWLOC_NAME(lwda_get_device_pci_ids)
#define hwloc_lwda_get_device_cpuset HWLOC_NAME(lwda_get_device_cpuset)
#define hwloc_lwda_get_device_pcidev HWLOC_NAME(lwda_get_device_pcidev)
#define hwloc_lwda_get_device_osdev HWLOC_NAME(lwda_get_device_osdev)
#define hwloc_lwda_get_device_osdev_by_index HWLOC_NAME(lwda_get_device_osdev_by_index)

/* lwdart.h */

#define hwloc_lwdart_get_device_pci_ids HWLOC_NAME(lwdart_get_device_pci_ids)
#define hwloc_lwdart_get_device_cpuset HWLOC_NAME(lwdart_get_device_cpuset)
#define hwloc_lwdart_get_device_pcidev HWLOC_NAME(lwdart_get_device_pcidev)
#define hwloc_lwdart_get_device_osdev_by_index HWLOC_NAME(lwdart_get_device_osdev_by_index)

/* lwml.h */

#define hwloc_lwml_get_device_cpuset HWLOC_NAME(lwml_get_device_cpuset)
#define hwloc_lwml_get_device_osdev HWLOC_NAME(lwml_get_device_osdev)
#define hwloc_lwml_get_device_osdev_by_index HWLOC_NAME(lwml_get_device_osdev_by_index)
...
#define hwloc_internal_distances_ilwalidate_cached_objs HWLOC_NAME(hwloc_internal_distances_ilwalidate_cached_objs)
