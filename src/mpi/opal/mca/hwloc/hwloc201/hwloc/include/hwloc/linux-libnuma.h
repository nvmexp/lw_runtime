 ...
 * include this file so as to ease colwersion between their respective types.
*/
 ...
 *
 * This interface helps colwerting between Linux libnuma unsigned long masks
...
/** \brief Colwert hwloc CPU set \p cpuset into the array of unsigned long \p mask
 *
...
/** \brief Colwert hwloc NUMA node set \p nodeset into the array of unsigned long \p mask
 *
 * \p mask is the array of unsigned long that will be filled.
 * \p maxnode contains the maximal node number that may be stored in \p mask.
 * \p maxnode will be set to the maximal node number that was found, plus one.
...
/** \brief Colwert the array of unsigned long \p mask into hwloc CPU set
 *
...
/** \brief Colwert the array of unsigned long \p mask into hwloc NUMA node set
 *
 * \p mask is a array of unsigned long that will be read.
 * \p maxnode contains the maximal node number that may be read in \p mask.
 *
 ...
 *
 * This interface helps colwerting between Linux libnuma bitmasks
 * and hwloc cpusets and nodesets.
 *
 * \note Topology \p topology must match the current machine.
 *
...
/** \brief Colwert hwloc CPU set \p cpuset into the returned libnuma bitmask
 *
...
/** \brief Colwert hwloc NUMA node set \p nodeset into the returned libnuma bitmask
 *
 * The returned bitmask should later be freed with numa_bitmask_free.
 *
 * This function may be used before calling many numa_ functions
...
/** \brief Colwert libnuma bitmask \p bitmask into hwloc CPU set \p cpuset
 *
...
/** \brief Colwert libnuma bitmask \p bitmask into hwloc NUMA node set \p nodeset
 *
 * This function may be used after calling many numa_ functions
 * that use a struct bitmask as an output parameter.
 */
