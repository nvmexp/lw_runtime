 ...
 * that colwerts this opaque userdata into an exportable string.
 *
 * \p export_cb is ilwoked during XML export for each object whose
 ...
 * It may be ilwoked one of multiple times to export some userdata to XML.
 ...
 * the function returns -1 with errno set to EILWAL.
 *
