...
#include <sys/param.h>  /* for HZ to colwert jiffies to actual time */
...
static float colwert_value(char *value)
{
    char *ptr;
    float fval;
    ...
    if (NULL != stats) {
        ...
        while (NULL != (dptr = local_getline(fp))) {
            ...
            if (0 == strncmp(dptr, "VmPeak", strlen("VmPeak"))) {
                stats->peak_vsize = colwert_value(value);
            } else if (0 == strncmp(dptr, "VmSize", strlen("VmSize"))) {
                stats->vsize = colwert_value(value);
            } else if (0 == strncmp(dptr, "VmRSS", strlen("VmRSS"))) {
                stats->rss = colwert_value(value);
            }
        }
        fclose(fp);
    ...
    if (NULL != nstats) {
        ...
        while (NULL != (dptr = local_getline(fp))) {
            ...
            if (0 == strcmp(dptr, "MemTotal")) {
                nstats->total_mem = colwert_value(value);
            } else if (0 == strcmp(dptr, "MemFree")) {
                nstats->free_mem = colwert_value(value);
            } else if (0 == strcmp(dptr, "Buffers")) {
                nstats->buffers = colwert_value(value);
            } else if (0 == strcmp(dptr, "Cached")) {
                nstats->cached = colwert_value(value);
            } else if (0 == strcmp(dptr, "SwapCached")) {
                nstats->swap_cached = colwert_value(value);
            } else if (0 == strcmp(dptr, "SwapTotal")) {
                nstats->swap_total = colwert_value(value);
            } else if (0 == strcmp(dptr, "SwapFree")) {
                nstats->swap_free = colwert_value(value);
            } else if (0 == strcmp(dptr, "Mapped")) {
                nstats->mapped = colwert_value(value);
            }
        }
        fclose(fp);
