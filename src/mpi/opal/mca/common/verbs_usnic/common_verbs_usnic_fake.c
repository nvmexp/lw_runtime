 ...
 * ibv_get_device_list() is ilwoked, libibverbs cannot find a plugin
...
/* Put just enough in here to colwince libibverbs that this is a valid
                                                 ...
                                                 int abi_version)
{
    ...
    /* This function should only be ilwoked for
