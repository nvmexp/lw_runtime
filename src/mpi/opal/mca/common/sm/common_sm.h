 ...
 * array.
 *
 * @returlwalue OPAL_SUCCESS on success, something else, otherwise.
 */
 ...
 *
 *  @returlwalue pointer to control structure at head of shared memory segment.
 *  Returns NULL if an error oclwrred.
 */
 ...
 *
 * @returlwalue OPAL_SUCCESS if the operation completed successfully,
