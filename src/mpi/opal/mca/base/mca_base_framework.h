 ...
 *
 * This must be the first function ilwoked in the MCA framework.
 * It initializes the MCA framework, finds and opens components,
 * populates the components list, etc.
 *
 * This function is ilwoked during opal_init() and during the
 ...
 *
 * It must be the last function ilwoked on the MCA framework.
 *
 * Frameworks are NOT required to provide this function. It may
