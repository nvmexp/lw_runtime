...
enum {
    ...
    /** also emit relevant tracing information (e.g., which functions were ilwoked /
 ...
 * repository.
 *
 * It must be the first MCA function ilwoked.  It is normally
 * ilwoked during the initialization stage and specifically
 * ilwoked in the special case of the *_info command.
 */
 ...
 *
 * It must be the last MCA function ilwoked.  It is normally ilwoked
