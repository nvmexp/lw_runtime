...
OPAL_DECLSPEC OBJ_CLASS_DECLARATION(opal_relwrsive_mutex_t);

#if defined(PTHREAD_RELWRSIVE_MUTEX_INITIALIZER_NP)
#define OPAL_PTHREAD_RELWRSIVE_MUTEX_INITIALIZER PTHREAD_RELWRSIVE_MUTEX_INITIALIZER_NP
#elif defined(PTHREAD_RELWRSIVE_MUTEX_INITIALIZER)
#define OPAL_PTHREAD_RELWRSIVE_MUTEX_INITIALIZER PTHREAD_RELWRSIVE_MUTEX_INITIALIZER
#endif
...
#if defined(OPAL_PTHREAD_RELWRSIVE_MUTEX_INITIALIZER)

#if OPAL_ENABLE_DEBUG
#define OPAL_RELWRSIVE_MUTEX_STATIC_INIT                                \
    {                                                                   \
        .super = OPAL_OBJ_STATIC_INIT(opal_mutex_t),                    \
        .m_lock_pthread = OPAL_PTHREAD_RELWRSIVE_MUTEX_INITIALIZER,     \
        .m_lock_debug = 0,                                              \
        .m_lock_file = NULL,                                            \
        .m_lock_line = 0,                                               \
        .m_lock_atomic = { .u = { .lock = OPAL_ATOMIC_LOCK_UNLOCKED } },     \
