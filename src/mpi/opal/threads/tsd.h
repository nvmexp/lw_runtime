 ...
 *
 * Destruct all thread-specific data keys and ilwoke the destructor
 *
 * This should only be ilwoked in the main thread.
 * This is made necessary since destructors are not ilwoked on the
