 ...
 * FreeBSD interface is dolwmented at
 *
 ...
 * considered private.  The implementation lwrrently in use may choose
 ...
 *
 * @param addr          Address of <TYPE>
 * @param delta         Value to add (colwerted to <TYPE>).
 */
 ...
 *
 * @param addr          Address of <TYPE>
 * @param delta         Value to substract (colwerted to <TYPE>).
 */
