...
opal_err2str(int errnum, const char **errmsg)
{
    ...
    case OPAL_ERR_NOT_ENOUGH_CORES:
        ...
        break;
    case OPAL_ERR_ILWALID_PHYS_CPU:
...
int opal_init_psm(void)
{
    ...
    if (NULL == getelw("IPATH_NO_BACKTRACE")) {
        opal_setelw("IPATH_NO_BACKTRACE", "1", true, &elwiron);
    }
    if (NULL == getelw("HFI_NO_BACKTRACE")) {
        opal_setelw("HFI_NO_BACKTRACE", "1", true, &elwiron);
    }
...
opal_init_util(int* pargc, char*** pargv)
{
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_malloc_init");
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_show_help_init");

    /* register handler for errnum -> string colwerstion */
    if (OPAL_SUCCESS !=
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_init_psm");
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_var_init");
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_var_cache");
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_net_init");
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_arch_init");
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_datatype_init");
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_dss_open");
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "mca_base_open");
    ...
    OPAL_TIMING_ELW_NEXT(otmng, "opal_if_init");
...
opal_init(int* pargc, char*** pargv)
{
     ...
     * Note: Lwrrently only used in C/R so it has been marked to only
