...
OPAL_DECLSPEC extern bool opal_built_with_lwda_support;

/**
 *  * Whether we want to enable LWCA GPU buffer send and receive support.
 *   */
OPAL_DECLSPEC extern bool opal_lwda_support;

/**
 *  * Whether we want to warn the user when liblwda is missing.
 *   */
OPAL_DECLSPEC extern bool opal_warn_on_missing_liblwda;
