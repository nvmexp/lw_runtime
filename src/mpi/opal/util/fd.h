 ...
 * oclwrs.  EAGAIN and EINTR are transparently handled.
 */
...
/**
 * Colwenience function to set a file descriptor to be close-on-exec.
 *
 * @param fd File descriptor
 *
 ...
 * @returns OPAL_ERR_IN_ERRNO otherwise.
 *
 * This is simply a colwenience function because there's a few steps
 * to setting a file descriptor to be close-on-exec.
 */
OPAL_DECLSPEC int opal_fd_set_cloexec(int fd);

/**
 * Colwenience function to check if fd point to an accessible regular file.
 *
 * @param fd File descriptor
 *
...
/**
 * Colwenience function to check if fd point to an accessible character device.
 *
 * @param fd File descriptor
 *
 * @returns true if "fd" points to a regular file.
...
/**
 * Colwenience function to check if fd point to an accessible block device.
 *
 * @param fd File descriptor
 *
 * @returns true if "fd" points to a regular file.
...
/**
 * Colwenience function to get a string name of the peer on the other
