...
BEGIN_C_DECLS
   ...
   * string (i.e., the arg parameter) after ilwoking this function.
   */
...
/**
   ...
   *
   * It is safe to ilwoke this function with a NULL pointer.  It is
   * not safe to ilwoke this function with a non-NULL-terminated argv
   * array.
   */
OPAL_DECLSPEC  void opal_argv_free(char **argv);
   ...
   * without ilwalidating the output argv).
   */
