...
opal_process_name_t opal_name_ilwalid = {OPAL_JOBID_ILWALID, OPAL_VPID_ILWALID};
...
static opal_proc_t opal_local_proc = {
    { .opal_list_next = NULL,
      .opal_list_prev = NULL},
    {OPAL_JOBID_ILWALID, OPAL_VPID_ILWALID},
    0,
    0,
    NULL,
    NULL
...
static void opal_proc_construct(opal_proc_t* proc)
{
    ...
    proc->proc_colwertor = NULL;
    proc->proc_flags = 0;
    proc->proc_name = *OPAL_NAME_ILWALID;
...
static int opal_colwert_string_to_process_name_should_never_be_called(opal_process_name_t *name,
                                                                      const char* name_string)
{
    return OPAL_ERR_NOT_SUPPORTED;
}

static int opal_colwert_process_name_to_string_should_never_be_called(char** name_string,
...
static int opal_colwert_string_to_jobid_should_never_be_called(opal_jobid_t *jobid, const char *jobid_string)
{
    return OPAL_ERR_NOT_SUPPORTED;
}
...
int (*opal_colwert_string_to_process_name)(opal_process_name_t *name, const char* name_string) = opal_colwert_string_to_process_name_should_never_be_called;
int (*opal_colwert_process_name_to_string)(char** name_string, const opal_process_name_t *name) = opal_colwert_process_name_to_string_should_never_be_called;
int (*opal_snprintf_jobid)(char* name_string, size_t size, opal_jobid_t jobid) = opal_snprintf_jobid_should_never_be_called;
int (*opal_colwert_string_to_jobid)(opal_jobid_t *jobid, const char *jobid_string) = opal_colwert_string_to_jobid_should_never_be_called;
