...
OPAL_DECLSPEC char *opal_path_find(char *fname, char **pathv, int mode,
                                   char **elwv) __opal_attribute_malloc__ __opal_attribute_warn_unused_result__;
...
OPAL_DECLSPEC char *opal_path_findv(char *fname, int mode,
                                    char **elwv, char *wrkdir) __opal_attribute_malloc__ __opal_attribute_warn_unused_result__;
/**
