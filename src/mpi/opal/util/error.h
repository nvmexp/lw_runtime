 ...
 * \internal
 *
 * Register a handler for colwerting errnums to error strings
 *
 * Handlers will be ilwoked by opal_perror() , opal_strerror(), and
 * opal_strerror_r() to return the appropriate values.
 *
 * \note A maximum of 5 colwerters can be registered.  The 6th
 * colwerter registration attempt will return OPAL_ERR_OUT_OF_RESOURCE
 */
