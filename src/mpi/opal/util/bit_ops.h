...
/**
 * Callwlates the highest bit in an integer
 *
...
/**
 * Returns the lwbe dimension of a given value.
 *
 * @param value The integer value to examine
 *
 * @returns lwbedim The smallest lwbe dimension containing that value
 *
 * Look at the integer "value" and callwlate the smallest power of two
 ...
 * compared to the loop-version (on Intel Nehalem -- with icc-12.1.0 -O2).
 */
static inline int opal_lwbe_dim(int value)
{
    int dim, size;
