...
**   bits 5 & 6: reserved for later use. lwrrently set to 00
**   bits 7 & 8: reserved for later use. lwrrently set to 00
** 2. Byte:
**   bits 1 & 2: length of long: 00 = 32, 01 = 64
**   bits 3 & 4: lenght of long long (not used lwrrently, set to 00).
...
**   bits 3 & 4: reserved for later use. lwrrently set to 11
**   bits 5 & 6: reserved for later use. lwrrently set to 11
**   bits 7 & 8: reserved for later use. lwrrently set to 11
*/
