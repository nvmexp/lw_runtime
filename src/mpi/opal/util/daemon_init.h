 ...
 *
 * This function colwerts a process into a daemon in an orderly manner. It first forks a child process,
 ...
 *
 * @retval OPAL_SUCCESS Indicates that the colwersion was successful
 * @retval OPAL_ERROR Indicates that the colwersion was not successful - a fork could not be completed.
 */
