 ...
 * that specifies how subsequent arguments are colwerted for output.
 *
 ...
 * facilities of stdarg(3) are colwerted for output.
 *
 * @param str   Output string buffer
 * @param size  Size of string buffer
 * @param fmt   Output format
 ...
 * string that specifies how subsequent arguments are colwerted for
 * output.
 *
 ...
 * variable-length argument facilities of stdarg(3) are colwerted for
 * output.
 *
 * @param *ptr  Pointer to output string buffer
 * @param fmt   Output format
