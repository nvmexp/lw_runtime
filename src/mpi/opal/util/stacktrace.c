...
#endif
#ifdef FPE_FLTILW
            case FPE_FLTILW: si_code_str = "Invalid floating point operation"; break;
#endif
#ifdef FPE_FLTSUB
...
char *opal_stackframe_output_string(void)
{
    ...
    /* Callwlate the space needed for the string */
 ...
 * by the user.
 *
 *  @returlwalue OPAL_SUCCESS
 *  @returlwalue OPAL_ERR_BAD_PARAM if the value in the signal-list
