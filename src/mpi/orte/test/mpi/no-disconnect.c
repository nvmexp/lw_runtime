...
/* Turns out the hnp cannot handle conlwrrent MPI_Comm_spawns
...
int main (int argc, char **argv)
{
    ...
    if (OMPI_MAJOR_VERSION < 2) {
        printf("Skipping, because the orte cannot handle conlwrrent MPI_Comm_spawns\n");
        return 77;
    } else {
        printf("Verify that this test is truly working because connlwrrent MPI_Comm_spawns"
