...
int main(int argc, char* argv[])
{
    ...
    elwar = getelw("OMPI_UNIVERSE_SIZE");
    ...
    printf("Hello, World, I am %d of %d on host %s from app number %s universe size %s universe elwar %s\n",
           rank, size, hostname, appstr, unistr, (NULL == elwar) ? "NULL" : elwar);
