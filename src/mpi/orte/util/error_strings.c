...
int orte_err2str(int errnum, const char **errmsg)
{
    ...
    case ORTE_ERR_NODE_FULLY_USED:
        ...
        break;
    case ORTE_ERR_ILWALID_NUM_PROCS:
    ...
    case ORTE_ERR_EXE_NOT_FOUND:
        retval = "The specified exelwtable could not be found";
        break;
    case ORTE_ERR_PIPE_READ_FAILURE:
        retval = "A pipe could not be read";
        break;
    case ORTE_ERR_EXE_NOT_ACCESSIBLE:
        retval = "The specified exelwtable could not be exelwted";
        break;
    case ORTE_ERR_FAILED_TO_START:
        retval = "The specified application failed to start";
        break;
    case ORTE_ERR_FILE_NOT_EXELWTABLE:
        retval = "A system-required exelwtable either could not be found or was not exelwtable by this user";
        break;
    ...
    case ORTE_ERR_RESTART_LIMIT_EXCEEDED:
        ...
        break;
    case ORTE_ERR_ILWALID_NODE_RANK:
        retval = "Invalid node rank";
        break;
    case ORTE_ERR_ILWALID_LOCAL_RANK:
    ...
    case ORTE_ERR_NO_EXE_SPECIFIED:
        retval = "No exelwtable specified";
        break;
