...
ORTE_DECLSPEC int orte_util_colwert_jobid_to_string(char **jobid_string, const orte_jobid_t jobid);
ORTE_DECLSPEC int orte_util_colwert_string_to_jobid(orte_jobid_t *jobid, const char* jobidstring);
ORTE_DECLSPEC int orte_util_colwert_vpid_to_string(char **vpid_string, const orte_vpid_t vpid);
ORTE_DECLSPEC int orte_util_colwert_string_to_vpid(orte_vpid_t *vpid, const char* vpidstring);
ORTE_DECLSPEC int orte_util_colwert_string_to_process_name(orte_process_name_t *name,
                                             const char* name_string);
ORTE_DECLSPEC int orte_util_colwert_process_name_to_string(char** name_string,
...
ORTE_DECLSPEC int orte_util_colwert_string_to_sysinfo(char **cpu_type, char **cpu_model,
                                             const char* sysinfo_string);
ORTE_DECLSPEC int orte_util_colwert_sysinfo_to_string(char** sysinfo_string,
