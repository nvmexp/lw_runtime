...
#define ORTE_NAME_ILWALID {ORTE_JOBID_ILWALID, ORTE_VPID_ILWALID}

ORTE_DECLSPEC orte_proc_info_t orte_process_info = {
    .my_name =                         ORTE_NAME_ILWALID,
    .my_daemon =                       ORTE_NAME_ILWALID,
    .my_daemon_uri =                   NULL,
    .my_hnp =                          ORTE_NAME_ILWALID,
    .my_hnp_uri =                      NULL,
    .my_parent =                       ORTE_NAME_ILWALID,
    .hnp_pid =                         0,
    .app_num =                         0,
    .num_procs =                       1,
    .max_procs =                       1,
    ...
    .my_port =                         0,
    .num_restarts =                    0,
    .my_node_rank =                    ORTE_NODE_RANK_ILWALID,
    .my_local_rank =                   ORTE_LOCAL_RANK_ILWALID,
    .num_local_peers =                 0,
    .tmpdir_base =                     NULL,
...
int orte_proc_info(void)
{
     ...
     */
    orte_ess_node_rank = ORTE_NODE_RANK_ILWALID;
