...
int orte_register_params(void)
{
    ...
    orte_exelwte_quiet = false;
    (void) mca_base_var_register ("orte", "orte", NULL, "exelwte_quiet",
    ...
    (void) mca_base_var_register ("orte", "orte", NULL, "debugger_test_daemon",
                                  "Name of the exelwtable to be used to simulate a debugger colaunch (relative or absolute path)",
                                  MCA_BASE_VAR_TYPE_STRING, NULL, 0, 0,
                                  OPAL_INFO_LVL_9, MCA_BASE_VAR_SCOPE_READONLY,
    ...
    orted_debug_failure = ORTE_VPID_ILWALID;
    ...
    orte_base_user_debugger = "totalview @mpirun@ -a @mpirun_args@ : ddt -n @np@ -start @exelwtable@ @exelwtable_argv@ @single_app@ : fxp @mpirun@ -a @mpirun_args@";
    ...
    mca_base_param_reg_int_name("orte", "abort_timeout",
                                ...
                                false, false, 1, &value);
    orte_max_timeout = 1000000.0 * value;  /* colwert to usec */
    ...
    (void) mca_base_var_register ("orte", "orte", NULL, "default_hostfile",
                                  "Name of the default hostfile (relative or absolute path, \"none\" to ignore elwironmental or default MCA param setting)",
                                  MCA_BASE_VAR_TYPE_STRING, NULL, 0, 0,
                                  OPAL_INFO_LVL_9, MCA_BASE_VAR_SCOPE_READONLY,
    ...
    (void) mca_base_var_register ("orte", "orte", NULL, "default_dash_host",
                                  "Default -host setting (specify \"none\" to ignore elwironmental or default MCA param setting)",
                                  MCA_BASE_VAR_TYPE_STRING, NULL, 0, 0,
                                  OPAL_INFO_LVL_9, MCA_BASE_VAR_SCOPE_READONLY,
    ...
    if (!orte_enable_recovery && orte_max_restarts != 0) {
        if (ORTE_PROC_IS_HNP) {
            opal_output(orte_clean_output,
                        ...
                        "Max restarts: %d\n"
                        "We are enabling process recovery and continuing exelwtion. To avoid\n"
