...
enum {
    ...
    ORTE_ERR_ILWALID_PHYS_CPU               = OPAL_ERR_ILWALID_PHYS_CPU,
 ...
 */
    ...
    ORTE_ERR_ILWALID_NUM_PROCS              = (ORTE_ERR_BASE - 15),
    ...
    ORTE_ERR_FILE_NOT_EXELWTABLE            = (ORTE_ERR_BASE - 26),
    ...
    ORTE_ERR_ILWALID_NODE_RANK              = (ORTE_ERR_BASE - 32),
    ORTE_ERR_ILWALID_LOCAL_RANK             = (ORTE_ERR_BASE - 33),
