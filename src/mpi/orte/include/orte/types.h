...
#define ORTE_STD_CNTR_ILWALID   -1
...
#define ORTE_LOCAL_RANK_ILWALID UINT16_MAX
#define ORTE_NODE_RANK_ILWALID  UINT16_MAX
...
#define ORTE_NAME_ARGS(n) \
    (unsigned long) ((NULL == n) ? (unsigned long)ORTE_JOBID_ILWALID : (unsigned long)(n)->jobid), \
    (unsigned long) ((NULL == n) ? (unsigned long)ORTE_VPID_ILWALID : (unsigned long)(n)->vpid) \

/*
 * define invalid values
 */
#define ORTE_JOBID_ILWALID          OPAL_JOBID_ILWALID
#define ORTE_VPID_ILWALID           OPAL_VPID_ILWALID
#define ORTE_LOCAL_JOBID_ILWALID    (ORTE_JOBID_ILWALID & 0x0000FFFF)
...
#define    ORTE_VALUE               (OPAL_DSS_ID_DYNAMIC + 6)  /**< registry return value */
    /* Resource types */
#define    ORTE_APP_CONTEXT         (OPAL_DSS_ID_DYNAMIC + 7) /**< argv and elwiro arrays */
