 ...
 * ilwokes ORTE through one of two channels:
 *
 ...
 * cases, systems pass allocation information via elwironmental
 * parameters.  Thus, the RAS components must know the correct
 * elwironmental parameter to look for within the environment they
