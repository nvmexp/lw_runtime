 ...
 * to be exelwted for that state. Events can be defined
 ...
 * potentially lwstomized by selected components within
 ...
 * function.
 *
 * For colwenience, an ANY state can be defined along with a generic
 ...
 * will cause this default action to be exelwted. Thus, you
 ...
 * @retval ORTE_ERROR   An unspecifed error oclwrred
 */
 ...
 *
 * Note the inherent assumption in this design that any lwstomization
