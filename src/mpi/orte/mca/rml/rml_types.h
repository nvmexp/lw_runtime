...
/* Colwenience def for readability */
...
/*** max valu in unit32_t is 0xFFFF_FFFF when colwerted to char this is 8  **
...
#define ORTE_RML_CONDUIT_ILWALID  0xff
