 ...
 * @retval ORTE_ERROR  An unspecified error oclwrred during the update
 */
 ...
 * @retval ORTE_ERROR  An unspecified error oclwrred
 */
 ...
 * reasonable value.
 *
 * @retval NULL An error oclwrred and initialization did not occur
