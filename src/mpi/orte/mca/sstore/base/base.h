...
ORTE_DECLSPEC int orte_sstore_base_colwert_key_to_string(orte_sstore_base_key_t key, char **key_str);
ORTE_DECLSPEC int orte_sstore_base_colwert_string_to_key(char *key_str, orte_sstore_base_key_t *key);
