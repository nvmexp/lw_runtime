...
orte_sstore_base_handle_t orte_sstore_handle_lwrrent = {0};
...
static int orte_sstore_base_open(mca_base_open_flag_t flags)
{
    ...
    orte_sstore_handle_lwrrent     = ORTE_SSTORE_HANDLE_ILWALID;
    orte_sstore_handle_last_stable = ORTE_SSTORE_HANDLE_ILWALID;
