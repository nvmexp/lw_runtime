...
ORTE_DECLSPEC const char* orte_schizo_base_print_elw(orte_schizo_launch_elwiron_t elw);
...
ORTE_DECLSPEC int orte_schizo_base_parse_elw(char *path,
...
ORTE_DECLSPEC int orte_schizo_base_setup_child(orte_job_t *jobdat,
                                               ...
                                               char ***elw);
ORTE_DECLSPEC orte_schizo_launch_elwiron_t orte_schizo_base_check_launch_elwironment(void);
