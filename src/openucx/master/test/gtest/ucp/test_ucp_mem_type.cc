...
#define UCP_INSTANTIATE_TEST_CASE_MEMTYPES(_test_case) \
    ...
    UCP_INSTANTIATE_TEST_CASE_MEMTYPE(_test_case, lwca,         UCS_MEMORY_TYPE_LWDA) \
    UCP_INSTANTIATE_TEST_CASE_MEMTYPE(_test_case, lwda_managed, UCS_MEMORY_TYPE_LWDA_MANAGED) \
