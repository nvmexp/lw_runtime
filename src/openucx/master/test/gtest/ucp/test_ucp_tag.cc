...
void test_ucp_tag::enable_tag_mp_offload()
{
    ...
    m_elw.push_back(new ucs::scoped_setelw("UCX_RC_TM_MP_SRQ_ENABLE", "try"));
    m_elw.push_back(new ucs::scoped_setelw("UCX_RC_TM_MP_NUM_STRIDES", "8"));
    m_elw.push_back(new ucs::scoped_setelw("UCX_IB_MLX5_DEVX_OBJECTS",
...
public:
    test_ucp_tag_limits() {
        ...
        m_elw.push_back(new ucs::scoped_setelw("UCX_RC_TM_ENABLE",
