...
protected:
    ...
    ucs::ptr_vector<ucs::scoped_setelw> m_elw;
};
...
void test_ucp_peer_failure::set_timeouts() {
    ...
    m_elw.push_back(new ucs::scoped_setelw("UCX_RC_TIMEOUT",     "10ms"));
    m_elw.push_back(new ucs::scoped_setelw("UCX_RC_RNR_TIMEOUT", "10ms"));
    m_elw.push_back(new ucs::scoped_setelw("UCX_RC_RETRY_COUNT", "2"));
}
