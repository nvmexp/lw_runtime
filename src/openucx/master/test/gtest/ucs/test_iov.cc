...
protected:
    ...
    size_t iov_colwerter(T1 *src_iov, size_t *src_iov_cnt_p,
                         T2 *dst_iov, size_t dst_iov_cnt,
                         size_t max_length, ucs_iov_iter_t *iov_iter_p) {
        return ucs_iov_colwerter(src_iov, src_iov_cnt_p,
    ...
    void test_iov_type_pair(T1 *iov1, size_t iov1_cnt,
        ...
        ucs_iov_iter_init(&iov_iter);
        cnt    = 0;
        length = iov_colwerter((T1*)NULL, &cnt,
                               iov2, iov2_cnt,
                               max_length, &iov_iter);
