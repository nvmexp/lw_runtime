 ...
 */
#define UCS_SHORT_TIME_CMP  UCS_CIRLWLAR_COMPARE32
 ...
 */
static inline double ucs_get_aclwrate_time()
{
    struct timeval tv;
...
/**
 * Colwert seconds to UCS time units.
 */
...
/**
 * Colwert UCS time units to seconds.
 */
...
/**
 * Colwert UCS time units to milliseconds.
 */
...
/**
 * Colwert UCS time units to microseconds.
 */
...
/**
 * Colwert UCS time units to nanoseconds.
 */
...
/**
 * Colwert UCS time interval (small) to nanoseconds.
 */
...
/* Colwert seconds to POSIX timeval */
...
/* Colwert seconds to POSIX timespec */
