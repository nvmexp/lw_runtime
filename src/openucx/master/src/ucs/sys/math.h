...
/**
 * Colwert flags without a branch
 * @return '_newflag' if '_oldflag' is set in '_value', otherwise - 0
 */
#define ucs_colwert_flag(_value, _oldflag, _newflag) \
    ({ \
 ...
 */
#define UCS_CIRLWLAR_COMPARE(__a, __op, __b, __signed_type)  \
    ((__signed_type)((__a) - (__b)) __op 0)

#define UCS_CIRLWLAR_COMPARE8(__a, __op, __b)  UCS_CIRLWLAR_COMPARE(__a, __op, __b, int8_t)
#define UCS_CIRLWLAR_COMPARE16(__a, __op, __b)  UCS_CIRLWLAR_COMPARE(__a, __op, __b, int16_t)
#define UCS_CIRLWLAR_COMPARE32(__a, __op, __b)  UCS_CIRLWLAR_COMPARE(__a, __op, __b, int32_t)
#define UCS_CIRLWLAR_COMPARE64(__a, __op, __b)  UCS_CIRLWLAR_COMPARE(__a, __op, __b, int64_t)
