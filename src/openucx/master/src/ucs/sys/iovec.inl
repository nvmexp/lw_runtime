 ...
 */
#define ucs_iov_colwerter(_dst_iov, _dst_iov_cnt_p, \
...
/**
 * Callwlates the total length of the IOV array buffers.
 *
...
/**
 * Callwlates the flat offset in the IOV array, which is the total data size
...
/**
 * Callwlates the total length of the IOVEC array buffers.
 *
