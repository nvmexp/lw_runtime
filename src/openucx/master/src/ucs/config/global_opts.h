...
#define UCS_GLOBAL_OPTS_WARN_UNUSED_CONFIG    "WARN_UNUSED_ELW_VARS"
...
typedef struct {
    ...
    /* Issue warning about UCX_ elw vars which were not used by config parser */
    int                        warn_unused_elw_vars;
