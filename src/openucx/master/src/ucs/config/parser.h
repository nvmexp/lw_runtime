...
#define UCS_DEFAULT_ELW_PREFIX "UCX_"
 ...
 *
 * name: <elw_prefix><table_prefix><field_name>
 *
 * - elw_prefix:     supplied by user to ucs_config_read_XXX() API
 ...
 * @param opts           User-defined options structure to fill.
 * @param fields         Array of fields which define how to parse.
 * @param elw_prefix     Prefix to add to all environment variables,
 *                       elw_prefix may consist of multiple sub preifxes
...
/**
 * Wrapper for `ucs_config_parser_warn_unused_elw_vars`
 * that ensures that this is called once
 *
 * @param elw_prefix     Environment variable prefix.
 *                       elw_prefix may consist of multiple sub prefixex
 */
