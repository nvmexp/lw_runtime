...
/**
 * Colwenience macro to pull from a non-empty queue and return the containing element.
 *
 * @param queue   Non-empty queue to pull from.
...
/**
 * Colwenience macro to get the head element of a non-empty queue.
 *
...
/**
 * Colwenience macro to get the tail element of a non-empty queue.
 *
 * @param queue   Non-empty queue whose head element to get.
 * @param type    Container element type.
 * @param member  Queue element member inside the container.
