...
#define UCT_ILWALID_RKEY           ((uintptr_t)(-1))
 ...
 *       elements and distance of @a stride byte between conselwtive elements
 *
 */
 ...
 *
 * This callback routine will be ilwoked on the server side upon receiving an
 ...
 *        from the server.
 *
 * This callback routine will be ilwoked on the client side upon receiving an
 ...
 *
 * This callback routine will be ilwoked on the client and server sides upon
 * a disconnect of the remote peer. It will disconnect the given endpoint from
 * the remote peer.
 * This callback won't be ilwoked if @ref uct_ep_disconnect was called locally
 ...
 *
 * This callback routine will be ilwoked on the client side, before sending the
 ...
 *
 * This callback is ilwoked when tagged message sent by eager protocol has
 * arrived and no corresponding tag has been posted.
 *
 * @note The callback is always ilwoked from the context (thread, process)
 ...
 *
 * This callback is ilwoked when rendezvous send notification has arrived
