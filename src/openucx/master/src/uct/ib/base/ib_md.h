...
typedef struct uct_ib_md_config {
    ...
    UCS_CONFIG_STRING_ARRAY_FIELD(spec) lwstom_devices; /**< Custom device specifications */
 ...
 * high 32 bits contain either UCT_IB_ILWALID_RKEY or a valid indirect key.
 */
                                                  ...
                                                  uint64_t *remote_addr_p)
{
    ...
    if (atomic_rkey == UCT_IB_ILWALID_RKEY) {
