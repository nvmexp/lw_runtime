...
#define UCT_IB_ICRC_LEN                   4   /* IB ilwariant crc footer */
...
#define UCT_IB_ILWALID_RKEY               0xffffffffu
...
typedef struct uct_ib_device {
    ...
    ucs_relwrsive_spinlock_t    ah_lock;
} uct_ib_device_t;
...
/**
 * Colwert time-in-seconds to IB fabric QP time value
 */
uint8_t uct_ib_to_qp_fabric_time(double time);


/**
 * Colwert time-in-seconds to IB fabric RNR time value
 */
