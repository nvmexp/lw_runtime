...
typedef struct uct_ugni_smsg_iface {
    ...
    uct_ugni_smsg_desc_t    *smsg_list[UCT_UGNI_HASH_SIZE]; /**< A list of descriptors lwrrently outstanding */
    ucs_relwrsive_spinlock_t mbox_lock; /**< Lock for processing SMSG mboxes */
