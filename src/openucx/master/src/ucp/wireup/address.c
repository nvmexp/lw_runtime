...
enum {
    ...
    UCP_ADDRESS_VERSION_LWRRENT = UCP_ADDRESS_VERSION_LAST - 1
};
                                        ...
                                        ucp_rsc_index_t num_devices)
{
    ...
    *address_header_p = UCP_ADDRESS_VERSION_LWRRENT;
                                ...
                                ucp_unpacked_address_t *unpacked_address)
{
    ...
    if (address_version != UCP_ADDRESS_VERSION_LWRRENT) {
        ucs_error("address version mismatch: expected %u, actual %u",
                  UCP_ADDRESS_VERSION_LWRRENT, address_version);
