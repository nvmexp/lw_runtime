...
typedef struct ucp_context_config {
    ...
    /** Threshold for switching UCP to rendezvous protocol in case the callwlated
...
/**
 * Callwlate a small value to overcome float imprecision
