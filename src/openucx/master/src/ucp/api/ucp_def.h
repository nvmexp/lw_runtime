 ...
 * resources associated with the context to manage multiple conlwrrent
 ...
 * optimize conlwrrent communications.
 */
 ...
 *
 * This callback routine is ilwoked whenever the @ref ucp_tag_send_nb
 * "send operation" is completed. It is important to note that the call-back is
 * only ilwoked in a case when the operation cannot be completed in place.
 *
 ...
 *
 * This callback routine is ilwoked whenever the @ref ucp_tag_send_nbx
 * "send operation" is completed. It is important to note that the call-back is
 * only ilwoked in a case when the operation cannot be completed in place.
 *
 * @param [in]  request   The completed send request.
 ...
 *
 * This callback routine is ilwoked when transport level error detected.
 *
 ...
 *        @ref ucp_listener_h.
 *
 *  This callback routine is ilwoked on the server side upon creating a connection
 ...
 * from a client.
 *
 * This callback routine is ilwoked on the server side to handle incoming
 ...
 * - The callback is thread safe with respect to the worker it is ilwoked on.
 ...
 *
 * This callback routine is ilwoked whenever the @ref ucp_stream_recv_nb
 ...
 *
 * This callback routine is ilwoked whenever the @ref ucp_tag_recv_nb
 * "receive operation" is completed and the data is ready in the receive buffer.
 *
 * @param [in]  request   The completed receive request.
 * @param [in]  status    Completion status. If the send operation was completed
 ...
 *
 * This callback routine is ilwoked whenever the @ref ucp_tag_recv_nbx
 * "receive operation" is completed and the data is ready in the receive buffer.
 *
 * @param [in]  request   The completed receive request.
 * @param [in]  status    Completion status. If the send operation was completed
