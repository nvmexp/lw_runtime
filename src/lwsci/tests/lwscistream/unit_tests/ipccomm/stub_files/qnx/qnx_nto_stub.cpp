...
int ChannelCreate_r_mock(unsigned __flags)
{
...
int ConnectAttach_r_mock(_Uint32t __nd, pid_t __pid, int __chid, unsigned __index, int __flags)
{
...
int ConnectDetach_mock(int __coid)
{
    return 0;
}

int ChannelDestroy_mock(int __chid)
{
    return 0;
}

int MsgReceivePulse_r_mock(int __chid, void *__pulse, _Sizet __bytes, struct _msg_info *__info)
{
...
int MsgSendPulse_r_mock(int __coid, int __priority, int __code, int  __value)
{
