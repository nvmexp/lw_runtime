...
if ( $1 == "host" ) then
    ...
    echo 'options C_PREPROCESS_CMD gcc -E -C -U__x86_64__ -DNDEBUG -DGL_EXPERT -DLWPMAPI -DLWCONFIG_PROFILE=tegragpu_unix_arm_embedded_external_profile -D_LANGUAGE_C -D__NO_CTYPE -DLW_BUILD_CONFIGURATION_EXPOSING_T18X=1 -DLW_BUILD_CONFIGURATION_EXPOSING_T19X=1 -DLW_BUILD_CONFIGURATION_EXPOSING_T23X=0 -DLW_DEBUG=0 -DLW_IS_SAFETY=1 -DLWCFG_ENABLED -DLW_BUILD_EMBEDDED=1 -DPIC  -DLW_TEGRA_MIRROR_INCLUDES -DLW_SCI_DESKTOP_COMPATIBLE_HEADERS -D_QNX_SOURCE -DLW_QNX' >> commands.tmp
...
# testable dirs
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/inc/' >> commands.tmp
...
echo 'options TESTABLE_SOURCE_DIR ./include/outmirror/tegra_top/core/include' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../../../sdk/lwpu/inc/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/attribute/core/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/attribute/inc/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/attribute/reconcile/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/attribute/transport/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/core/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/cpu_wait_context/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/fence/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/ipc_table/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/module/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/object/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/object/inc/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/primitives/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/primitives/platform/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/primitives/semaphore/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/primitives/syncpoint/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/rm_backend/' >> commands.tmp
echo 'options TESTABLE_SOURCE_DIR ../../../../lwscisync/src/timestamps/' >> commands.tmp
...
# Keep blank line, otherwise clicast won't be exelwted
