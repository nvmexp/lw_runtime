/*
 * lwscibuf_gv_constraints.h
 *
 * Header file to define gpu GV arch's constraint extraction APIs.
 *
...
#ifndef INCLUDED_LWSCIBUF_GV_CONSTRAINTS_H
#define INCLUDED_LWSCIBUF_GV_CONSTRAINTS_H
...
#endif /* INCLUDED_LWSCIBUF_GV_CONSTRAINTS_H */
