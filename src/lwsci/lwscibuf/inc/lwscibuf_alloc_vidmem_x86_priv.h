...
typedef struct LwSciBufAllocVidMemContextRec LwSciBufAllocVidMemContext;

typedef struct {
    LwRmShimDeviceContext* rmDevicePtr;
    LwSciBufAllocVidMemContext* vidMemContextPtr;
} LwSciBufPerGpuContext;

struct LwSciBufAllocVidMemContextRec {
