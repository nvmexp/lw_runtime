/*
 * lwscibuf_gp_constraints.h
 *
 * Header file to define gpu GP arch's constraint extraction APIs.
 *
...
#ifndef INCLUDED_LWSCIBUF_GP_CONSTRAINTS_H
#define INCLUDED_LWSCIBUF_GP_CONSTRAINTS_H
...
#endif /* INCLUDED_LWSCIBUF_GP_CONSTRAINTS_H */
