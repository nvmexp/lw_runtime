...
#define D3D11DDI_MINOR_HEADER_VERSION 6
#endif
...
typedef enum D3D10DDIRESOURCE_TYPE
{
    ...
    D3D10DDIRESOURCE_TEXTURELWBE = 5,
#if D3D11DDI_MINOR_HEADER_VERSION >= 1
...
typedef enum D3D10_DDI_RESOURCE_MISC_FLAG
{
    ...
    // Reserved for D3D11_RESOURCE_MISC_TEXTURELWBE           0x00000004L,
...
#endif
#if D3D11DDI_MINOR_HEADER_VERSION >= 4
#define D3DWDDM1_3DDI_FORMAT_SUPPORT_TILED                0x00010000 // format supports use in a tiled Texture1D/2D/Lwbe/Array (not incl Texture3D)
#endif
#if D3D11DDI_MINOR_HEADER_VERSION >= 5
#define D3DWDDM2_0DDI_FORMAT_SUPPORT_UAV_READS            0x00020000 // format supports Typed UAV Loads
#endif
#define D3D10_DDI_FORMAT_SUPPORT_NOT_SUPPORTED            0x80000000 // format is not supported at all. Lwrrently only valid for DXGI_FORMAT_R10G10B10_XR_BIAS_A2_UNORM. (Set only this bit)
...
typedef struct D3D10DDIARG_CREATERESOURCE
{
    ...
    CONST D3D10_DDIARG_SUBRESOURCE_UP*   pInitialDataUP; // non-NULL if Usage has ilwariant
...
typedef struct D3D10DDIARG_TEXLWBE_SHADERRESOURCEVIEW
{
    UINT     MostDetailedMip;
    UINT     MipLevels;
} D3D10DDIARG_TEXLWBE_SHADERRESOURCEVIEW;
...
typedef struct D3D10DDIARG_CREATESHADERRESOURCEVIEW
{
    ...
    union
    {
        ...
        D3D10DDIARG_TEXLWBE_SHADERRESOURCEVIEW TexLwbe;
    };
...
typedef struct D3D10DDIARG_TEXLWBE_RENDERTARGETVIEW
{
    UINT     MipSlice;
    UINT     FirstArraySlice;
    UINT     ArraySize;
} D3D10DDIARG_TEXLWBE_RENDERTARGETVIEW;
...
typedef struct D3D10DDIARG_CREATERENDERTARGETVIEW
{
    ...
    union
    {
        ...
        D3D10DDIARG_TEXLWBE_RENDERTARGETVIEW TexLwbe;
    };
...
typedef struct D3D10DDIARG_TEXLWBE_DEPTHSTENCILVIEW
{
    UINT     MipSlice;
    UINT     FirstArraySlice;
    UINT     ArraySize;
} D3D10DDIARG_TEXLWBE_DEPTHSTENCILVIEW;
...
typedef struct D3D10DDIARG_CREATEDEPTHSTENCILVIEW
{
    ...
    union
    {
        ...
        D3D10DDIARG_TEXLWBE_DEPTHSTENCILVIEW TexLwbe;
    };
...
/* TextureLwbe Face identifiers */
typedef enum D3D10_DDI_TEXTURELWBE_FACE
{
    D3D10_DDI_TEXTURELWBE_FACE_POSITIVE_X = 0,
    D3D10_DDI_TEXTURELWBE_FACE_NEGATIVE_X = 1,
    D3D10_DDI_TEXTURELWBE_FACE_POSITIVE_Y = 2,
    D3D10_DDI_TEXTURELWBE_FACE_NEGATIVE_Y = 3,
    D3D10_DDI_TEXTURELWBE_FACE_POSITIVE_Z = 4,
    D3D10_DDI_TEXTURELWBE_FACE_NEGATIVE_Z = 5
} D3D10_DDI_TEXTURELWBE_FACE;
...
// Keep LWLL_MODE values in sync with earlier DX versions (HW consumes values directly).
typedef enum D3D10_DDI_LWLL_MODE
{
    D3D10_DDI_LWLL_NONE = 1,
    D3D10_DDI_LWLL_FRONT = 2,
    D3D10_DDI_LWLL_BACK = 3
} D3D10_DDI_LWLL_MODE;
...
typedef enum D3D10_DDI_BLEND
{
    ...
    D3D10_DDI_BLEND_ILW_SRC_COLOR = 4, // 1.0f - PS output oN.rgb
    D3D10_DDI_BLEND_SRC_ALPHA = 5, // PS output oN.a
    D3D10_DDI_BLEND_ILW_SRC_ALPHA = 6, // 1.0f - PS output oN.a
    D3D10_DDI_BLEND_DEST_ALPHA = 7, // RT(N).a (N is current RT being blended)
    D3D10_DDI_BLEND_ILW_DEST_ALPHA = 8, // 1.0f - RT(N).a
    D3D10_DDI_BLEND_DEST_COLOR = 9, // RT(N).rgb
    D3D10_DDI_BLEND_ILW_DEST_COLOR = 10,// 1.0f - RT(N).rgb
    D3D10_DDI_BLEND_SRC_ALPHASAT = 11,// (f,f,f,1), f = min(1 - RT(N).a, oN.a)
    // 12 reserved (was BOTHSRCALPHA)
    // 13 reserved (was BOTH_ILW_SRC_ALPHA)
    D3D10_DDI_BLEND_BLEND_FACTOR = 14,
    D3D10_DDI_BLEND_ILWBLEND_FACTOR = 15,
    D3D10_DDI_BLEND_SRC1_COLOR = 16, // PS output o1.rgb
    D3D10_DDI_BLEND_ILW_SRC1_COLOR = 17, // 1.0f - PS output o1.rgb
    D3D10_DDI_BLEND_SRC1_ALPHA = 18, // PS output o1.a
    D3D10_DDI_BLEND_ILW_SRC1_ALPHA = 19, // 1.0f - PS output o1.a
} D3D10_DDI_BLEND;
...
typedef struct D3D10DDIARG_VERTEXPIPELINEOUTPUT
{
    ...
    // The number of lwll distances in the vertex data
    UINT                        NumLwllDistances;
    ...
    // Pointer to the array of offsets in bytes in the vertex data for lwll distances.
    // The number of elements in the array is NumLwllDistances.
    CONST UINT*                 pLwllDistanceOffsets;
...
// !!! BEGIN HIGH-FREQUENCY !!!
    ...
    PFND3D10DDI_SETCONSTANTBUFFERS                        pflwsSetConstantBuffers;
    PFND3D10DDI_SETSHADERRESOURCES                        pfnPsSetShaderResources;
    PFND3D10DDI_SETSHADER                                 pfnPsSetShader;
    PFND3D10DDI_SETSAMPLERS                               pfnPsSetSamplers;
    PFND3D10DDI_SETSHADER                                 pflwsSetShader;
...
// !!! BEGIN MIDDLE-FREQUENCY !!!
    ...
    PFND3D10DDI_SETSHADERRESOURCES                        pflwsSetShaderResources;
    PFND3D10DDI_SETSAMPLERS                               pflwsSetSamplers;
...
typedef struct D3D10_1DDIARG_TEXLWBE_SHADERRESOURCEVIEW
{
    UINT MostDetailedMip;
    UINT MipLevels;
    UINT First2DArrayFace;
    UINT NumLwbes;
} D3D10_1DDIARG_TEXLWBE_SHADERRESOURCEVIEW;
...
typedef struct D3D10_1DDIARG_CREATESHADERRESOURCEVIEW
{
    ...
    union
    {
        ...
        D3D10DDIARG_TEX2D_SHADERRESOURCEVIEW     Tex2D;
        D3D10DDIARG_TEX3D_SHADERRESOURCEVIEW     Tex3D;
        D3D10_1DDIARG_TEXLWBE_SHADERRESOURCEVIEW TexLwbe;
    };
...
// Infrequent paths:
    ...
    PFND3D10DDI_RESOURCECOPY                              pfnResourceColwert;
    PFND3D10DDI_RESOURCECOPYREGION                        pfnResourceColwertRegion;
...
typedef enum D3D11_DDI_VIDEO_DECODER_BUFFER_TYPE
{
    ...
    D3D11_1DDI_VIDEO_DECODER_BUFFER_ILWERSE_QUANTIZATION_MATRIX      = 5,
...
typedef struct D3D11DDIARG_CREATEUNORDEREDACCESSVIEW
{
    D3D10DDI_HRESOURCE    hDrvResource;
    DXGI_FORMAT           Format;
    D3D10DDIRESOURCE_TYPE ResourceDimension; // Runtime will never set this to TexLwbe
...
typedef VOID ( APIENTRY* PFND3D11DDI_COMMANDLISTEXELWTE )(
    D3D10DDI_HDEVICE, D3D11DDI_HCOMMANDLIST );
...
// Infrequent paths:
    ...
    PFND3D11DDI_COMMANDLISTEXELWTE                          pfnCommandListExelwte; // Only required when supporting D3D11DDICAPS_COMMANDLISTS
    ...
    PFND3D11DDI_SETSHADER_WITH_IFACES                       pflwsSetShaderWithIfaces;
...
typedef enum D3D11_1_DDI_LOGIC_OP
{
    ...
    D3D11_1_DDI_LOGIC_OP_COPY_ILWERTED,  // ~s
    D3D11_1_DDI_LOGIC_OP_NOOP,           // d
    D3D11_1_DDI_LOGIC_OP_ILWERT,         // ~d
    ...
    D3D11_1_DDI_LOGIC_OP_AND_ILWERTED,   // ~s & d
    D3D11_1_DDI_LOGIC_OP_OR_REVERSE,     // s | ~d
    D3D11_1_DDI_LOGIC_OP_OR_ILWERTED,    // ~s | d
...
// !!! BEGIN HIGH-FREQUENCY !!!
    ...
    PFND3D11_1DDI_SETCONSTANTBUFFERS                        pflwsSetConstantBuffers;
    PFND3D10DDI_SETSHADERRESOURCES                          pfnPsSetShaderResources;
    PFND3D10DDI_SETSHADER                                   pfnPsSetShader;
    PFND3D10DDI_SETSAMPLERS                                 pfnPsSetSamplers;
    PFND3D10DDI_SETSHADER                                   pflwsSetShader;
...
// Infrequent paths:
    ...
    // Start additional 10.1 entries:
    PFND3D10DDI_RESOURCECOPY                                pfnResourceColwert;
    PFND3D11_1DDI_RESOURCECOPYREGION                        pfnResourceColwertRegion;
...
DEFINE_GUID( D3D11_1DDI_AUTHENTICATED_QUERY_LWRRENT_ENCRYPTION_WHEN_ACCESSIBLE, 0xec1791c7, 0xdad3, 0x4f15, 0x9e, 0xc3, 0xfa, 0xa9, 0x3d, 0x60, 0xd4, 0xf0 );
...
typedef enum D3D11_1DDI_VIDEO_PROCESSOR_DEVICE_CAPS
{
    ...
    D3D11_1DDI_VIDEO_PROCESSOR_DEVICE_CAPS_RGB_RANGE_COLWERSION    = 0x4,
    D3D11_1DDI_VIDEO_PROCESSOR_DEVICE_CAPS_YCbCr_MATRIX_COLWERSION = 0x8,
...
typedef struct D3D11_1DDI_VIDEO_PROCESSOR_CAPS
{
    ...
    UINT AutoStreamCaps;
    UINT StereoCaps;
    UINT RateColwersionCapsCount;
    UINT MaxInputStreams;
    UINT MaxStreamStates;
} D3D11_1DDI_VIDEO_PROCESSOR_CAPS;

typedef enum D3D11_1DDI_VIDEO_PROCESSOR_COLWERSION_CAPS
{
    D3D11_1DDI_VIDEO_PROCESSOR_COLWERSION_CAPS_DEINTERLACE_BLEND                 = 0x1,
    D3D11_1DDI_VIDEO_PROCESSOR_COLWERSION_CAPS_DEINTERLACE_BOB                   = 0x2,
    D3D11_1DDI_VIDEO_PROCESSOR_COLWERSION_CAPS_DEINTERLACE_ADAPTIVE              = 0x4,
    D3D11_1DDI_VIDEO_PROCESSOR_COLWERSION_CAPS_DEINTERLACE_MOTION_COMPENSATION   = 0x8,
    D3D11_1DDI_VIDEO_PROCESSOR_COLWERSION_CAPS_ILWERSE_TELECINE                  = 0x10,
    D3D11_1DDI_VIDEO_PROCESSOR_COLWERSION_CAPS_FRAME_RATE_COLWERSION             = 0x20
} D3D11_1DDI_VIDEO_PROCESSOR_COLWERSION_CAPS;
...
typedef struct D3D11_1DDI_VIDEO_PROCESSOR_RATE_COLWERSION_CAPS
{
    UINT PastFrames;
    UINT FutureFrames;
    UINT ColwersionCaps;
    UINT ITelecineCaps;
    UINT LwstomRateCount;
} D3D11_1DDI_VIDEO_PROCESSOR_RATE_COLWERSION_CAPS;
...
typedef struct D3D11_1DDI_VIDEO_PROCESSOR_LWSTOM_RATE
{
    DXGI_RATIONAL LwstomRate;
    UINT          OutputFrames;
    BOOL          InputInterlaced;
    UINT          InputFramesOrFields;
} D3D11_1DDI_VIDEO_PROCESSOR_LWSTOM_RATE;
...
typedef enum D3D11_1DDI_VIDEO_PROCESSOR_OUTPUT_RATE
{
    ...
    D3D11_1DDI_VIDEO_PROCESSOR_OUTPUT_RATE_LWSTOM   = 2
...
typedef struct D3D11_1DDI_AUTHENTICATED_QUERY_LWRRENT_ACCESSIBILITY_ENCRYPTION_OUTPUT
{
    D3D11_1DDI_AUTHENTICATED_QUERY_OUTPUT Output;
    GUID       EncryptionGuid;
} D3D11_1DDI_AUTHENTICATED_QUERY_LWRRENT_ACCESSIBILITY_ENCRYPTION_OUTPUT;
...
typedef VOID ( APIENTRY* PFND3D11_1DDI_GETVIDEOPROCESSORRATECOLWERSIONCAPS )(
    D3D10DDI_HDEVICE, D3D11_1DDI_HVIDEOPROCESSORENUM, UINT, D3D11_1DDI_VIDEO_PROCESSOR_RATE_COLWERSION_CAPS* );
typedef VOID ( APIENTRY* PFND3D11_1DDI_GETVIDEOPROCESSORLWSTOMRATE )(
    D3D10DDI_HDEVICE, D3D11_1DDI_HVIDEOPROCESSORENUM, UINT, UINT, D3D11_1DDI_VIDEO_PROCESSOR_LWSTOM_RATE* );
...
typedef struct D3D11_1DDI_VIDEODEVICEFUNCS
{
    ...
    PFND3D11_1DDI_VIDEODECODEREXTENSION                       pflwideoDecoderExtension;
    PFND3D11_1DDI_VIDEODECODERBEGINFRAME                      pflwideoDecoderBeginFrame;
    PFND3D11_1DDI_VIDEODECODERENDFRAME                        pflwideoDecoderEndFrame;
    PFND3D11_1DDI_VIDEODECODERSUBMITBUFFERS                   pflwideoDecoderSubmitBuffers;
    ...
    PFND3D11_1DDI_GETVIDEOPROCESSORRATECOLWERSIONCAPS         pfnGetVideoProcessorRateColwersionCaps;
    PFND3D11_1DDI_GETVIDEOPROCESSORLWSTOMRATE                 pfnGetVideoProcessorLwstomRate;
    ...
    PFND3D11_1DDI_VIDEOPROCESSORSETOUTPUTTARGETRECT           pflwideoProcessorSetOutputTargetRect;
    PFND3D11_1DDI_VIDEOPROCESSORSETOUTPUTBACKGROUNDCOLOR      pflwideoProcessorSetOutputBackgroundColor;
    PFND3D11_1DDI_VIDEOPROCESSORSETOUTPUTCOLORSPACE           pflwideoProcessorSetOutputColorSpace;
    PFND3D11_1DDI_VIDEOPROCESSORSETOUTPUTALPHAFILLMODE        pflwideoProcessorSetOutputAlphaFillMode;
    PFND3D11_1DDI_VIDEOPROCESSORSETOUTPUTCONSTRICTION         pflwideoProcessorSetOutputConstriction;
    PFND3D11_1DDI_VIDEOPROCESSORSETOUTPUTSTEREOMODE           pflwideoProcessorSetOutputStereoMode;
    PFND3D11_1DDI_VIDEOPROCESSORSETOUTPUTEXTENSION            pflwideoProcessorSetOutputExtension;
    PFND3D11_1DDI_VIDEOPROCESSORGETOUTPUTEXTENSION            pflwideoProcessorGetOutputExtension;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMFRAMEFORMAT          pflwideoProcessorSetStreamFrameFormat;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMCOLORSPACE           pflwideoProcessorSetStreamColorSpace;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMOUTPUTRATE           pflwideoProcessorSetStreamOutputRate;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMSOURCERECT           pflwideoProcessorSetStreamSourceRect;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMDESTRECT             pflwideoProcessorSetStreamDestRect;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMALPHA                pflwideoProcessorSetStreamAlpha;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMPALETTE              pflwideoProcessorSetStreamPalette;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMPIXELASPECTRATIO     pflwideoProcessorSetStreamPixelAspectRatio;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMLUMAKEY              pflwideoProcessorSetStreamLumaKey;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMSTEREOFORMAT         pflwideoProcessorSetStreamStereoFormat;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMAUTOPROCESSINGMODE   pflwideoProcessorSetStreamAutoProcessingMode;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMFILTER               pflwideoProcessorSetStreamFilter;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMEXTENSION            pflwideoProcessorSetStreamExtension;
    PFND3D11_1DDI_VIDEOPROCESSORGETSTREAMEXTENSION            pflwideoProcessorGetStreamExtension;
    PFND3D11_1DDI_VIDEOPROCESSORBLT                           pflwideoProcessorBlt;
    ...
    PFND3D11_1DDI_VIDEOPROCESSORINPUTVIEWREADAFTERWRITEHAZARD pflwideoProcessorInputViewReadAfterWriteHazard;
    ...
    PFND3D11_1DDI_VIDEODECODERGETHANDLE                       pflwideoDecoderGetHandle;
    PFND3D11_1DDI_CRYPTOSESSIONGETHANDLE                      pfnCryptoSessionGetHandle;
    PFND3D11_1DDI_VIDEOPROCESSORSETSTREAMROTATION             pflwideoProcessorSetStreamRotation;
...
typedef struct D3DWDDM2_0DDI_CHECK_VIDEO_PROCESSOR_FORMAT_COLWERSION 
{ 
    ...
    BOOL Supported; 
} D3DWDDM2_0DDI_CHECK_VIDEO_PROCESSOR_FORMAT_COLWERSION;
...
typedef enum D3DWDDM2_0DDI_VIDEO_PROCESSOR_BEHAVIOR_HINTS
{
    ...
    D3DWDDM2_0DDI_VIDEO_PROCESSOR_BEHAVIOR_HINT_MULTIPLANE_OVERLAY_COLOR_SPACE_COLWERSION = 0x04,
...
typedef HRESULT ( APIENTRY* PFND3DWDDM2_0DDI_VIDEODECODERUPDATEDOWNSAMPLING )( 
    ...
    _In_ CONST D3D11_1DDI_VIDEO_DECODER_DESC* pOutputDesc, 
    _In_ D3DDDI_COLOR_SPACE_TYPE OutputColorSpace);
typedef VOID ( APIENTRY* PFND3DWDDM2_0DDI_CHECKVIDEOPROCESSORFORMATCOLWERSION )( 
    _In_ D3D10DDI_HDEVICE hDevice, 
    _In_ D3D11_1DDI_HVIDEOPROCESSORENUM hProcessorEnum, 
    _In_ D3DWDDM2_0DDI_CHECK_VIDEO_PROCESSOR_FORMAT_COLWERSION* pColwersion);
...
typedef struct D3DWDDM2_0DDI_VIDEODEVICEFUNCS
{
    ...
    PFND3DWDDM2_0DDI_VIDEODECODERSUBMITBUFFERS1               pflwideoDecoderSubmitBuffers1;
    PFND3DWDDM2_0DDI_QUERYVIDEOCAPABILITIES                   pfnQueryVideoCapabilities; 
    PFND3DWDDM2_0DDI_CHECKVIDEOPROCESSORFORMATCOLWERSION      pfnCheckVideoProcessorFormatColwersion; 
    PFND3DWDDM2_0DDI_VIDEODECODERENABLEDOWNSAMPLING           pflwideoDecoderEnableDownsampling; 
    PFND3DWDDM2_0DDI_VIDEODECODERUPDATEDOWNSAMPLING           pflwideoDecoderUpdateDownsampling;  
    PFND3DWDDM2_0DDI_VIDEOPROCESSORSETSTREAMMIRROR            pflwideoProcessorSetStreamMirror; 
    PFND3DWDDM2_0DDI_VIDEOPROCESSORSETOUTPUTCOLORSPACE1       pflwideoProcessorSetOutputColorSpace1;
    PFND3DWDDM2_0DDI_VIDEOPROCESSORSETSTREAMCOLORSPACE1       pflwideoProcessorSetStreamColorSpace1;
    PFND3DWDDM2_0DDI_VIDEOPROCESSORSETOUTPUTSHADERUSAGE       pflwideoProcessorSetOutputShaderUsage;
    PFND3DWDDM2_0DDI_VIDEOPROCESSORGETBEHAVIORHINTS           pflwideoProcessorGetBehaviorHints;
...
typedef struct D3DWDDM1_3DDI_TILE_REGION_SIZE
{
    ...
    BOOL bUseBox; // TRUE: Uses width/height/depth parameters below to define the region.
                  ...
                  //   how many tiles are ilwolved anyway.)
...
#define D3DWDDM1_3DDI_SETMARKERMODE_LWSTOMDRIVEREVENTS 0x1
...
typedef struct D3D10DDIARG_CREATEDEVICE
{
    ...
    CONST D3DDDI_DEVICECALLBACKS*   pKTCallbacks;           // in:  Pointer to runtime callbacks that ilwoke kernel
    union
    {
...
//Note: d3d10_1 doesn't lwrrently ship on vista gold. This definition is included for completeness in the event
...
const UINT D3D10_16BIT_INDEX_STRIP_LWT_VALUE = 0xffff;
const UINT D3D10_32BIT_INDEX_STRIP_LWT_VALUE = 0xffffffff;
const UINT D3D10_8BIT_INDEX_STRIP_LWT_VALUE = 0xff;
const UINT D3D10_ARRAY_AXIS_ADDRESS_RANGE_BIT_COUNT = 9;
const UINT D3D10_CLIP_OR_LWLL_DISTANCE_COUNT = 8;
const UINT D3D10_CLIP_OR_LWLL_DISTANCE_ELEMENT_COUNT = 2;
...
const UINT D3D10_REQ_GS_ILWOCATION_32BIT_OUTPUT_COMPONENT_LIMIT = 1024;
...
const UINT D3D10_REQ_TEXTURELWBE_DIMENSION = 8192;
