...
public:
    ...
    void Run(bool bIsPStateForced);
    void Run_TargetCycles(bool bIsPStateForced,DWORD TargetCycles,DWORD DelayIntervalStep, int StepDirection);
    void Run_MinMaxHold(bool bIsPStateforced, DWORD MaxTriangles, DWORD MaxDelayInterval, DWORD HoldInterval);
