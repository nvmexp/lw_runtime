...
// to be available at compile-time. This macro gives us a colwenient way to
...
// The same problem oclwrs with has_facet.
...
// exelwtable). These macros provide a uniform way to cope with the
...
// Colwerts the parameter X to a string after macro replacement
