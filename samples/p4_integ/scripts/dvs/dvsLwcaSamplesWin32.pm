...
$VERSION     = 1.00;
@ISA         = qw(Exporter);
@EXPORT      = qw(set_elwironment_win32 set_elwironment_win32_docker set_paths_win32
...
sub set_elwironment_win32_docker
{
  my ($host_arch, $target_arch, $os, $build, $environment, $toolkit_rootdir, $driver_rootdir, $p4_toolkit_dir, $debug) = @_;
      ...
      if ($^O eq "MSWin32")
        {
          ...
          $ELW{'LWDA_PATH_V11_0'} = "$toolkit_bin_path/local";
          $ELW{'LWDA_PATH_V11_1'} = "$toolkit_bin_path/local";
          $ELW{'LWDA_PATH_V11_2'} = "$toolkit_bin_path/local";
          $ELW{'LWDAPropsPath'}  = "$toolkit_bin_path\\MsBuildExtensions";
        }

      $ELW{'LIBLWDA_PATH'}   =~ s#/#\\#g;
      $ELW{'LWDA_PATH'}      =~ s#/#\\#g;
      $ELW{'LWDA_PATH_V11_0'} =~ s#/#\\#g;
      $ELW{'LWDA_PATH_V11_1'} =~ s#/#\\#g;
      $ELW{'LWDA_PATH_V11_2'} =~ s#/#\\#g;
  ...
  if ($debug)
    {
      ...
      print "  LWDA_PATH_V11_0 = $ELW{'LWDA_PATH_V11_0'}\n";
      print "  LWDA_PATH_V11_1 = $ELW{'LWDA_PATH_V11_1'}\n";
      print "  LWDA_PATH_V11_2 = $ELW{'LWDA_PATH_V11_2'}\n";
  ...
  if ($environment eq "rel" && $vulcan_toolkit_dir ne "")
    {
       ...
       $ELW{'LWDA_PATH_V11_0'} =  $vulcan_toolkit_dir;
