...
my @default_desktop_sms = ("30", "35", "37", "50", "52", "60", "61", "70", "75", "80", "86");
my @default_tegra_sms = ("53", "61", "62", "70", "72", "75", "80", "86", "87");
my @tegra_only_sms = ("32", "53", "62", "72", "87");
...
sub ParseSMs
{
    ...
    if (defined $all_supported_sms)
    {
        ...
        for my $i (0 .. $#supported_desktop_sms)
        {
            ...
            foreach (@default_tegra_sms)
            {
                if ($supported_desktop_sms[$i] eq $_)
                {
                    $supported_tegra_sms[$k++] = $_;
                }
            }
            if ($exists eq 0)
            {
    ...
    if ($fallback_min_ptx)
    {
        return (\@supported_desktop_sms, \@supported_tegra_sms);
    }
