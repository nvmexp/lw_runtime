...
#define WGL_ERROR_INCOMPATIBLE_AFFINITY_MASKS_LW 0x20D0
#define WGL_ERROR_MISSING_AFFINITY_MASK_LW 0x20D1
#endif
...
#ifdef WGL_WGLEXT_PROTOTYPES
extern BOOL WINAPI wglMakeContextLwrrentARB(HDC, HDC, HGLRC);
extern HDC WINAPI wglGetLwrrentReadDCARB(void);
#endif /* WGL_WGLEXT_PROTOTYPES */
...
#ifdef WGL_WGLEXT_PROTOTYPES
extern BOOL WINAPI wglMakeContextLwrrentEXT(HDC, HDC, HGLRC);
extern HDC WINAPI wglGetLwrrentReadDCEXT(void);
#endif /* WGL_WGLEXT_PROTOTYPES */
...
#ifdef WGL_WGLEXT_PROTOTYPES
extern void *WINAPI wglAllocateMemoryLW(GLsizei, GLfloat, GLfloat, GLfloat);
extern void WINAPI wglFreeMemoryLW(void *);
#endif /* WGL_WGLEXT_PROTOTYPES */
...
#ifdef WGL_WGLEXT_PROTOTYPES
extern BOOL WINAPI wglJoinSwapGroupLW(HDC hDC, GLuint group);
extern BOOL WINAPI wglBindSwapBarrierLW(GLuint group, GLuint barrier);
extern BOOL WINAPI wglQuerySwapGroupLW(HDC hDC, GLuint *group, GLuint *barrier);
extern BOOL WINAPI wglQueryMaxSwapGroupsLW(HDC hDC, GLuint *maxGroups, GLuint *maxBarriers);
extern BOOL WINAPI wglQueryFrameCountLW(HDC hDC, GLuint *count);
extern BOOL WINAPI wglResetFrameCountLW(HDC hDC);
#endif /* WGL_WGLEXT_PROTOTYPES */
...
#ifdef WGL_WGLEXT_PROTOTYPES
extern BOOL WINAPI wglEnumGpusLW(UINT iIndex, HGPULW *hGpu);
extern BOOL WINAPI wglEnumGpuDevicesLW(HGPULW hGpu, UINT iIndex, PGPU_DEVICE pGpuDevice);
extern HDC WINAPI wglCreateAffinityDCLW(const HGPULW *pGpuList);
extern BOOL WINAPI wglEnumGpusFromAffinityDCLW(HDC hAffinityDC, UINT iIndex, HGPULW *hGpu);
extern BOOL WINAPI wglDeleteDCLW(HDC hAffinityDC);
#else
typedef BOOL (WINAPI *PFNWGLENUMGPUSLWPROC)(UINT iIndex, HGPULW *hGpu);
typedef BOOL (WINAPI *PFNWGLENUMGPUDEVICESLWPROC)(HGPULW hGpu, UINT iIndex, PGPU_DEVICE pGpuDevice);
typedef HDC(WINAPI *PFNWGLCREATEAFFINITYDCLWPROC)(const HGPULW *pGpuList);
typedef BOOL (WINAPI *PFNWGLENUMGPUSFROMAFFINITYDCLWPROC)(HDC hAffinityDC, UINT iIndex, HGPULW *hGpu);
typedef BOOL (WINAPI *PFNWGLDELETEDCLWPROC)(HDC hAffinityDC);
#endif
#endif
