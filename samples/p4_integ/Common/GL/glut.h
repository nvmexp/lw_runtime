...
#pragma warning (disable:4244)  /* Disable bogus colwersion warnings. */
...
#define GLUT_WINDOW_ACLWM_RED_SIZE  111
#define GLUT_WINDOW_ACLWM_GREEN_SIZE    112
#define GLUT_WINDOW_ACLWM_BLUE_SIZE 113
#define GLUT_WINDOW_ACLWM_ALPHA_SIZE    114
...
/* glutSetLwrsor parameters. */
/* Basic arrows. */
#define GLUT_LWRSOR_RIGHT_ARROW     0
#define GLUT_LWRSOR_LEFT_ARROW      1
/* Symbolic cursor shapes. */
#define GLUT_LWRSOR_INFO        2
#define GLUT_LWRSOR_DESTROY     3
#define GLUT_LWRSOR_HELP        4
#define GLUT_LWRSOR_CYCLE       5
#define GLUT_LWRSOR_SPRAY       6
#define GLUT_LWRSOR_WAIT        7
#define GLUT_LWRSOR_TEXT        8
#define GLUT_LWRSOR_CROSSHAIR       9
/* Directional lwrsors. */
#define GLUT_LWRSOR_UP_DOWN     10
#define GLUT_LWRSOR_LEFT_RIGHT      11
/* Sizing lwrsors. */
#define GLUT_LWRSOR_TOP_SIDE        12
#define GLUT_LWRSOR_BOTTOM_SIDE     13
#define GLUT_LWRSOR_LEFT_SIDE       14
#define GLUT_LWRSOR_RIGHT_SIDE      15
#define GLUT_LWRSOR_TOP_LEFT_CORNER 16
#define GLUT_LWRSOR_TOP_RIGHT_CORNER    17
#define GLUT_LWRSOR_BOTTOM_RIGHT_CORNER 18
#define GLUT_LWRSOR_BOTTOM_LEFT_CORNER  19
/* Inherit from parent window. */
#define GLUT_LWRSOR_INHERIT     100
/* Blank cursor. */
#define GLUT_LWRSOR_NONE        101
/* Fullscreen crosshair (if available). */
#define GLUT_LWRSOR_FULL_CROSSHAIR  102
#endif
...
extern void APIENTRY glutSetLwrsor(int cursor);
#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
...
extern void APIENTRY glutWireLwbe(GLdouble size);
extern void APIENTRY glutSolidLwbe(GLdouble size);
