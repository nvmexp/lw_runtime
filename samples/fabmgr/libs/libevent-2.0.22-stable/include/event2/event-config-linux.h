...
/* Define to 1 if you have the `putelw' function. */
#define _EVENT_HAVE_PUTELW 1
...
/* Define to 1 if you have the `setelw' function. */
#define _EVENT_HAVE_SETELW 1
...
/* Define to 1 if you have the `unsetelw' function. */
#define _EVENT_HAVE_UNSETELW 1
