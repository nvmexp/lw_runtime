...
std::string
GlobalFMLWLinkState::getMainLinkState(uint32 linkMode)
{
    switch (linkMode) {
...
std::string
GlobalFMLWLinkState::getTxSubLinkState(uint32 txSubLinkMode)
{
...
std::string
GlobalFMLWLinkState::getRxSubLinkState(uint32 rxSubLinkMode)
{
