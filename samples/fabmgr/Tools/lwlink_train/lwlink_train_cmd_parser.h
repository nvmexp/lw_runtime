...
typedef enum NTSteps_enum
{
    ...
    NT_SET_INITPHASE5 = 9,
    NT_DO_LINK_INITIALIZATION = 10,
    NT_DO_ALL_THE_INITIALIZATION_IN_SINGLE_STEP = 11,

    NT_DISCOVER_CONNECTIONS_INTRA_NODE = 12,
    NT_TRAIN_AN_INTRA_NODE_CONNECTION_TO_HIGH_SPEED = 13,
    NT_TRAIN_AN_INTRA_NODE_CONNECTION_TO_OFF = 14,
    NT_TRAIN_AN_INTRA_NODE_CONNECTION_TO_SAFE = 15,
    NT_TRAIN_ALL_INTRA_NODE_CONNECTIONS_TO_HIGH_SPEED = 16,
    NT_TRAIN_ALL_INTRA_NODE_CONNECTIONS_TO_OFF = 17,
    NT_TRAIN_ALL_INTRA_NODE_CONNECTIONS_TO_SAFE = 18,
    NT_SHOW_MULTI_NODE_TRAINING_OPTIONS = 19,
    NT_GET_DEVICE_INFORMATION = 20,

    NT_DO_INITNEGOTIATE = 21
}NTSteps_t;
