...
#ifndef BASIC_E3600_CONFIG7_H
#define BASIC_E3600_CONFIG7_H

#include "fabricConfig.h"

//
//
//    Basic E3600 configuration 7 
//
//    GPU (N0_G0)             Switch (N0_S0)                Switch (N0_S1)  GPU (N0_G1)
//
//    N0_G0_P1    <----> N0_S0_P0       N0_S0_P8            N0_S1_P0 <----> N0_G1_P1
//    N0_G0_P0    <----> N0_S0_P1       N0_S0_P9            N0_S1_P1 <----> N0_G1_P0
//    N0_G0_P5    <----> N0_S0_P2       N0_S0_P10           N0_S1_P2 <----> N0_G1_P5
//    N0_G0_P4    <----> N0_S0_P3       N0_S0_P11           N0_S1_P3 <----> N0_G1_P4
//    N0_G0_P2    <----> N0_S0_P4       N0_S0_P12           N0_S1_P4 <----> N0_G1_P2
//    N0_G0_P3    <----> N0_S0_P5       N0_S0_P13           N0_S1_P5 <----> N0_G1_P3
//                       N0_S0_P6       N0_S0_P14 <---->    N0_S1_P7
//                       N0_S0_P7       N0_S0_P15 <---->    N0_S1_P6
//                                      N0_S0_P16
//                                      N0_S0_P17
//   switch N0_S0
//   Switch 0 port 0 to 5 are connected to GPU 0, ingress packets are xbar switched to port 14 and 15
//
//   switch N0_S1
//   Switch 0 port 0 to 5 are connected to GPU 1, ingress packets are xbar switched to port 7 and 6
//
//   GPU Configuration
//
...
//
//    N0_S1_P0    0             0          1         1           7 (1 * 6 + 1)  ACCESS_PORT_GPU
//    N0_S1_P1    1             0          1         0           6 (1 * 6 + 0)  ACCESS_PORT_GPU
//    N0_S1_P2    2             0          1         5          11 (1 * 6 + 5)  ACCESS_PORT_GPU
//    N0_S1_P3    3             0          1         4          10 (1 * 6 + 4)  ACCESS_PORT_GPU
//    N0_S1_P4    4             0          1         2           8 (1 * 6 + 2)  ACCESS_PORT_GPU
//    N0_S1_P5    5             0          1         3           9 (1 * 6 + 3)  ACCESS_PORT_GPU
//
//    Trunk Ports
//    Port        localPortNum  farNodeID  farPeerID farPortNum  type
//    N0_S0_P14   14            0          1         7           TRUNK_PORT_GPU
//    N0_S0_P15   15            0          1         6           TRUNK_PORT_GPU
//
//    N0_S1_P6    6             0          0         15          TRUNK_PORT_GPU
//    N0_S1_P7    7             0          0         14          TRUNK_PORT_GPU


class basicE3600Config7 : public fabricConfig
{
public:
      basicE3600Config7( fabricTopologyEnum topo );
      virtual ~basicE3600Config7();
