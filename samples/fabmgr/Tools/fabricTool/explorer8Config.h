...
#ifndef EXPLORER8_CONFIG_H
#define EXPLORER8_CONFIG_H
...
class explorer8Config : public fabricConfig
{
public:
      explorer8Config( fabricTopologyEnum topo );
      virtual ~explorer8Config();
