#ifndef EXPLORER16_KT_CONFIG_H
#define EXPLORER16_KT_CONFIG_H
...
class explorer16KTConfig : public fabricConfig
{
public:
      explorer16KTConfig( fabricTopologyEnum topo );
      virtual ~explorer16KTConfig();
