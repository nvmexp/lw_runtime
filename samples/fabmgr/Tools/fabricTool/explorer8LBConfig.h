...
#ifndef EXPLORER8LB_CONFIG_H
#define EXPLORER8LB_CONFIG_H
...
class explorer8LBConfig : public fabricConfig
{
public:
      explorer8LBConfig( fabricTopologyEnum topo );
      virtual ~explorer8LBConfig();
