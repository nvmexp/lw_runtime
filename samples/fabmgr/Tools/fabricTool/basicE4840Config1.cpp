...
basicE4840Config1::basicE4840Config1( fabricTopologyEnum topo ) : fabricConfig( topo )
{
    uint64_t targetId;
    ...
    mSxm5Slot0   = NotPopulated;
    mSxm5Slot1   = NotPopulated;
...
basicE4840Config1::~basicE4840Config1()
{
    if ( mFabric )
    {
        delete( mFabric );
...
void
basicE4840Config1::setE4840Config(E4840EndpointType_t sxm5Slot0, E4840EndpointType_t sxm5Slot1,
                                  bool enableWarmup, bool enableSpray, bool useTrunkPort)
{
    ...
    mSxm5Slot0   = sxm5Slot0;
    mSxm5Slot1   = sxm5Slot1;

    if ( ( mSxm5Slot0 != PG520 ) || ( mSxm5Slot1 != PG520 ) )
    {
        // no spray if there's only 1 GPU
        mEnableSpray = false;
    }
    ...
    else if ( mSxm5Slot0 == E4824 )
    {
        //                  nodeId, swPhysicalId, swPort, rlandId, connectToGpu, peerGpuPhysicalId, peerGpuPort, connectToSw, peerSwNodeId, peerSwPhysicalId, peerSwPort
        mSwitchPorts[0][0]  = {0,      0,            0,      0,        false,        0,                 0,           true,        0,            0,                4};
        mSwitchPorts[0][1]  = {0,      0,            1,      1,        false,        0,                 0,           true,        0,            0,                5};
        mSwitchPorts[0][2]  = {0,      0,            2,      2,        false,        0,                 0,           true,        0,            0,                6};
        mSwitchPorts[0][3]  = {0,      0,            3,      3,        false,        0,                 0,           true,        0,            0,                7};
        mSwitchPorts[0][4]  = {0,      0,            4,      4,        false,        0,                 0,           true,        0,            0,                0};
        mSwitchPorts[0][5]  = {0,      0,            5,      5,        false,        0,                 0,           true,        0,            0,                1};
        mSwitchPorts[0][6]  = {0,      0,            6,      6,        false,        0,                 0,           true,        0,            0,                2};
        mSwitchPorts[0][7]  = {0,      0,            7,      7,        false,        0,                 0,           true,        0,            0,                3};
        mSwitchPorts[0][8]  = {0,      0,            8,      8,        false,        0,                 0,           true,        0,            0,                8};
        mSwitchPorts[0][9]  = {0,      0,            9,      9,        false,        0,                 0,           true,        0,            0,                9};
        mSwitchPorts[0][10] = {0,      0,            10,     10,       false,        0,                 0,           true,        0,            0,               10};
        mSwitchPorts[0][11] = {0,      0,            11,     11,       false,        0,                 0,           true,        0,            0,               11};
        mSwitchPorts[0][12] = {0,      0,            12,     12,       false,        0,                 0,           true,        0,            0,               12};
        mSwitchPorts[0][13] = {0,      0,            13,     13,       false,        0,                 0,           true,        0,            0,               13};
        mSwitchPorts[0][14] = {0,      0,            14,     14,       false,        0,                 0,           true,        0,            0,               14};
        mSwitchPorts[0][15] = {0,      0,            15,     15,       false,        0,                 0,           true,        0,            0,               15};
        mSwitchPorts[0][16] = {0,      0,            16,     16,       false,        0,                 0,           true,        0,            0,               16};
        mSwitchPorts[0][17] = {0,      0,            17,     17,       false,        0,                 0,           true,        0,            0,               17};
    }
    ...
    else if ( mSxm5Slot1 == E4824 )
    {
        //                  nodeId, swPhysicalId, swPort, rlandId, connectToGpu, peerGpuPhysicalId, peerGpuPort, connectToSw, peerSwNodeId, peerSwPhysicalId, peerSwPort
        mSwitchPorts[0][18] = {0,      0,            18,    17,        false,        0,                 0,           true,        0,            0,                18};
        mSwitchPorts[0][19] = {0,      0,            19,    16,        false,        0,                 0,           true,        0,            0,                19};
        mSwitchPorts[0][20] = {0,      0,            20,    15,        false,        0,                 0,           true,        0,            0,                20};
        mSwitchPorts[0][21] = {0,      0,            21,    14,        false,        0,                 0,           true,        0,            0,                21};
        mSwitchPorts[0][22] = {0,      0,            22,    13,        false,        0,                 0,           true,        0,            0,                22};
        mSwitchPorts[0][23] = {0,      0,            23,    12,        false,        0,                 0,           true,        0,            0,                23};
        mSwitchPorts[0][24] = {0,      0,            24,    11,        false,        0,                 0,           true,        0,            0,                24};
        mSwitchPorts[0][25] = {0,      0,            25,    10,        false,        0,                 0,           true,        0,            0,                25};
        mSwitchPorts[0][28] = {0,      0,            28,     9,        false,        0,                 0,           true,        0,            0,                26};
        mSwitchPorts[0][29] = {0,      0,            29,     8,        false,        0,                 0,           true,        0,            0,                27};
        mSwitchPorts[0][28] = {0,      0,            28,     7,        false,        0,                 0,           true,        0,            0,                32};
        mSwitchPorts[0][29] = {0,      0,            29,     6,        false,        0,                 0,           true,        0,            0,                33};
        mSwitchPorts[0][30] = {0,      0,            30,     5,        false,        0,                 0,           true,        0,            0,                34};
        mSwitchPorts[0][31] = {0,      0,            31,     4,        false,        0,                 0,           true,        0,            0,                35};
        mSwitchPorts[0][32] = {0,      0,            32,     3,        false,        0,                 0,           true,        0,            0,                28};
        mSwitchPorts[0][33] = {0,      0,            33,     2,        false,        0,                 0,           true,        0,            0,                29};
        mSwitchPorts[0][34] = {0,      0,            34,     1,        false,        0,                 0,           true,        0,            0,                30};
        mSwitchPorts[0][35] = {0,      0,            35,     0,        false,        0,                 0,           true,        0,            0,                31};
    }

    // OSFP connections, only use 18 trunks to make routing symmetrical

    // OSFP0 connects to OSPF1
    //                nodeId, swPhysicalId, swPort, rlandId, connectToGpu, peerGpuPhysicalId, peerGpuPort, connectToSw, peerSwNodeId, peerSwPhysicalId, peerSwPort
    mSwitchPorts[0][36] = {0,      0,            36,     17,      false,        0,                 0,           true,        0,            0,                40};
    mSwitchPorts[0][37] = {0,      0,            37,     16,      false,        0,                 0,           true,        0,            0,                41};
    mSwitchPorts[0][38] = {0,      0,            38,     15,      false,        0,                 0,           true,        0,            0,                42};
    mSwitchPorts[0][39] = {0,      0,            39,     14,      false,        0,                 0,           true,        0,            0,                43};
    // OSFP1 connects to OSPF0
    mSwitchPorts[0][40] = {0,      0,            40,     13,      false,        0,                 0,           true,        0,            0,                36};
    mSwitchPorts[0][41] = {0,      0,            41,     12,      false,        0,                 0,           true,        0,            0,                37};
    mSwitchPorts[0][42] = {0,      0,            42,     11,      false,        0,                 0,           true,        0,            0,                38};
    mSwitchPorts[0][43] = {0,      0,            43,     10,      false,        0,                 0,           true,        0,            0,                39};

    // OSFP2 connects to OSPF3
    //                nodeId, swPhysicalId, swPort, rlandId, connectToGpu, peerGpuPhysicalId, peerGpuPort, connectToSw, peerSwNodeId, peerSwPhysicalId, peerSwPort
    mSwitchPorts[0][44] = {0,      0,            44,     9,        false,        0,                 0,           true,        0,            0,                48};
    mSwitchPorts[0][45] = {0,      0,            45,     8,        false,        0,                 0,           true,        0,            0,                49};
    mSwitchPorts[0][46] = {0,      0,            46,     7,        false,        0,                 0,           true,        0,            0,                50};
    mSwitchPorts[0][47] = {0,      0,            47,     6,        false,        0,                 0,           true,        0,            0,                51};
    // OSFP3 connects to OSPF2
    mSwitchPorts[0][48] = {0,      0,            48,     5,        false,        0,                 0,           true,        0,            0,                44};
    mSwitchPorts[0][49] = {0,      0,            49,     4,        false,        0,                 0,           true,        0,            0,                45};
    mSwitchPorts[0][50] = {0,      0,            50,     3,        false,        0,                 0,           true,        0,            0,                46};
    mSwitchPorts[0][51] = {0,      0,            51,     2,        false,        0,                 0,           true,        0,            0,                47};

    // OSFP6 loopback
    //                nodeId, swPhysicalId, swPort, rlandId, connectToGpu, peerGpuPhysicalId, peerGpuPort, connectToSw, peerSwNodeId, peerSwPhysicalId, peerSwPort
    mSwitchPorts[0][62] = {0,      0,            62,     1,        false,        0,                 0,           true,        0,            0,                62};
    mSwitchPorts[0][63] = {0,      0,            63,     0,        false,        0,                 0,           true,        0,            0,                63};
...
void basicE4840Config1::makeRemapTable( int nodeIndex, int swIndex )
{
    ...
    if ( (nodeIndex == 0) && (swIndex == 0) )
    {
        ...
        for ( portIndex = 0; portIndex < MAX_PORTS_PER_LWSWITCH; portIndex++ )
        {
            ...
            {
                if ( ( ( targetId == 0 ) && ( mSxm5Slot0 == PG520 ) ) ||
                     ( ( targetId == 1 ) && ( mSxm5Slot1 == PG520 ) ) )
                {
...
void basicE4840Config1::makeRIDRouteTable( int nodeIndex, int swIndex )
{
    return;
}

void basicE4840Config1::makeRLANRouteTable( int nodeIndex, int swIndex )
{
    return;
}

int
basicE4840Config1::getNumTrunkPorts( uint32_t nodeIndex, uint32_t swIndex )
{
    int count = 0;
    for ( int i = 0; i < MAX_PORTS_PER_LWSWITCH; i++ )
    {
...
int
basicE4840Config1::getSwitchPortIndex( uint32_t nodeIndex, uint32_t swIndex, uint32_t swPort )
{
    for ( int i = 0; i < MAX_PORTS_PER_LWSWITCH; i++ )
    {
        if ( ( mSwitchPorts[swIndex][i].nodeId == nodeIndex ) &&
...
int
basicE4840Config1::getSwitchPortIndexWithRlanId( uint32_t nodeIndex, uint32_t swIndex, uint32_t rlanId)
{
    for ( int i = 0; i < MAX_PORTS_PER_LWSWITCH; i++ )
    {
        if ( ( mSwitchPorts[swIndex][i].nodeId == nodeIndex ) &&
...
void basicE4840Config1::getEgressPortsToGpu( uint32_t nodeIndex, uint32_t swIndex, uint32_t ingressPortNum,
...
void basicE4840Config1::makeRIDandRlanRouteTable( int nodeIndex, int swIndex )
{
    ...
    if ( (nodeIndex == 0) && (swIndex == 0) )
    {
        ...
        {
            if ( ( ( gpuPhysicalId == 0 ) && ( mSxm5Slot0 == PG520 ) ) ||
                 ( ( gpuPhysicalId == 1 ) && ( mSxm5Slot1 == PG520 ) ) )
            {
...
void basicE4840Config1::makeGangedLinkTable( int nodeIndex, int swIndex )
{
    return;
}

void basicE4840Config1::makeAccessPorts( int nodeIndex, int swIndex )
{
...
void basicE4840Config1::makeTrunkPorts( int nodeIndex, int swIndex )
{
    if ( (nodeIndex == 0) && (swIndex == 0) )
    {
        for ( int i = 0; i < MAX_PORTS_PER_LWSWITCH; i++ )
...
void basicE4840Config1::makeOneLwswitch( int nodeIndex, int swIndex )
{
...
void basicE4840Config1::makeOneNode( int nodeIndex, int gpuNum, int lrNum )
{
    int i, j;
...
void basicE4840Config1::makeNodes()
{
    int i, nodeIndex = 0;
...
void basicE4840Config1::makeOneWillow( int nodeIndex, int willowIndex )
{
    return;
}

void basicE4840Config1::makeIngressReqTable( int nodeIndex, int willowIndex )
{
    return;
}

void basicE4840Config1::makeIngressRespTable( int nodeIndex, int willowIndex )
{
    return;
}
