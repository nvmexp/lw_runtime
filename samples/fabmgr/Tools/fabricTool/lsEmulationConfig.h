...
#ifndef LS_EMULATION_CONFIG_H
#define LS_EMULATION_CONFIG_H

#include "fabricConfig.h"

class lsEmulationConfig : public fabricConfig
{
public:
      lsEmulationConfig( fabricTopologyEnum topo );
      virtual ~lsEmulationConfig();
