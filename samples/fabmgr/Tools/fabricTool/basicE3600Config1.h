...
#ifndef BASIC_E3600_CONFIG1_H
#define BASIC_E3600_CONFIG1_H
...
//                                      N0_S0_P17
//
//   Switch port 0 to 5 are connected to GPU 0, ingress packets are xbar switched to port 8 and 13.
//   Switch port 8 to 13 are connected to GPU 1, ingress packets are xbar switched to port 0 and 5.
//
//
//   GPU Configuration
//
...
//    will be switched to trunk port N0_S0_P8 to N0_S0_P13 VC mode 0
...
//    will be switched to trunk port N0_S0_P8 and N0_S0_P13 VC mode 0
...
class basicE3600Config1 : public fabricConfig
{
public:
      basicE3600Config1( fabricTopologyEnum topo );
      virtual ~basicE3600Config1();
