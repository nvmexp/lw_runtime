...
#ifndef BASIC_E4700_CONFIG2_H
#define BASIC_E4700_CONFIG2_H

#include "fabricConfig.h"

class basicE4700Config2 : public fabricConfig
{
public:
    typedef enum {
        NotPopulated  = 0,
      ...
      basicE4700Config2( fabricTopologyEnum topo );

      virtual ~basicE4700Config2();
...
private:
      ...
      bool isGpuConnectedToSwitch( uint32_t swNodeIndex, uint32_t swIndex, uint32_t gpuNodeIndex, uint32_t gpuPhysicalId );
