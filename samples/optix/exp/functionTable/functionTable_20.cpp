...
extern "C" {
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 18 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 19 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 20 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
}
...
FunctionTable_20 g_functionTable_20 = {
    // clang-format off
    optixGetErrorName,
    optixGetErrorString,
    nullptr,
...
{
    if( sizeOfFunctionTable != sizeof( FunctionTable_20 ) )
    {
#if defined( OPTIX_ENABLE_LOGGING )
        lerr << "sizeOfFunctionTable != sizeof( FunctionTable_20 ) ( " << sizeOfFunctionTable << " != " << sizeof( FunctionTable_20 ) << ")\n";
#endif
        return OPTIX_ERROR_FUNCTION_TABLE_SIZE_MISMATCH;
    }

    FunctionTable_20* ftable = reinterpret_cast<FunctionTable_20*>( functionTable );
    memcpy( ftable, &g_functionTable_20, sizeOfFunctionTable );
    switch( abi )
    {
        case 18:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 18 );
            break;
        case 19:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 19 );
            break;
        case 20:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 20 );
            break;
        default:
#if defined( OPTIX_ENABLE_LOGGING )
