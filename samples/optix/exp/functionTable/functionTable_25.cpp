...
extern "C" {
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 23 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 24 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 25 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
}
...
FunctionTable_25 g_functionTable_25 = {
    // clang-format off
    optixGetErrorName,
    optixGetErrorString,
    nullptr,
...
{
    if( sizeOfFunctionTable != sizeof( FunctionTable_25 ) )
    {
#if defined( OPTIX_ENABLE_LOGGING )
        lerr << "sizeOfFunctionTable != sizeof( FunctionTable_25 ) ( " << sizeOfFunctionTable << " != " << sizeof( FunctionTable_25 ) << ")\n";
#endif
        return OPTIX_ERROR_FUNCTION_TABLE_SIZE_MISMATCH;
    }

    FunctionTable_25* ftable = reinterpret_cast<FunctionTable_25*>( functionTable );
    memcpy( ftable, &g_functionTable_25, sizeOfFunctionTable );
    switch( abi )
    {
        case 23:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 23 );
            break;
        case 24:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 24 );
            break;
        case 25:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 25 );
            break;
        default:
#if defined( OPTIX_ENABLE_LOGGING )
