...
OptixResult translateCompileOptimizationLevel( OptixCompileOptimizationLevel& newOptLevel,
...
OptixResult translateABI_ProgramGroupPayloadTypeID( const OptixProgramGroupOptions* inOptions,
                                                    ...
                                                    ErrorDetails&                   errDetails );
OptixResult validatePayloadType( const OptixPayloadType& optLevel, ErrorDetails& errDetails );
