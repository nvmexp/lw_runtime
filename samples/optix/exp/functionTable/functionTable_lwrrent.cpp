...
extern "C" {
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 53 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 54 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 55 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 56 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 57 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 58 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 59 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
OptixResult OPTIX_DEVICE_CONTEXT_CREATE_NAME( 60 )( LWcontext, const OptixDeviceContextOptions*, OptixDeviceContext* );
}
...
struct FunctionTable_lwrrent
{
    ...
    OptixResult ( *optixDisplacedMicromeshArrayBuild )( OptixDeviceContext                            context,
                                                        ...
                                                        unsigned int numEmittedProperties );
#else
    void ( *optixDummy1 )( void );
    void ( *optixDummy2 )( void );
...
FunctionTable_lwrrent g_functionTable_lwrrent = {
    // clang-format off
    optixGetErrorName,
    optixGetErrorString,
    nullptr,
...
#if LWCFG(GLOBAL_FEATURE_GR1354_MICROMESH)
    optixVisibilityMapArrayComputeMemoryUsage,
    optixVisibilityMapArrayBuild,
    optixDisplacedMicromeshArrayComputeMemoryUsage,
    optixDisplacedMicromeshArrayBuild,
#else
    dummy,
    dummy,
#endif  // LWCFG(GLOBAL_FEATURE_GR1354_MICROMESH)
...
{
    if( sizeOfFunctionTable != sizeof( FunctionTable_lwrrent ) )
    {
#if defined( OPTIX_ENABLE_LOGGING )
        lerr << "sizeOfFunctionTable != sizeof( FunctionTable_lwrrent ) ( " << sizeOfFunctionTable << " != " << sizeof( FunctionTable_lwrrent ) << " )\n";
#endif
        return OPTIX_ERROR_FUNCTION_TABLE_SIZE_MISMATCH;
    }

    FunctionTable_lwrrent* ftable = reinterpret_cast<FunctionTable_lwrrent*>( functionTable );
    memcpy( ftable, &g_functionTable_lwrrent, sizeOfFunctionTable );
    switch( abi )
    {
        case 53:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 53 );
            break;
        case 54:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 54 );
            break;
        case 55:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 55 );
            break;
        case 56:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 56 );
            break;
        case 57:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 57 );
            break;
        case 58:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 58 );
            break;
        case 59:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 59 );
            break;
        case 60:
            ftable->optixDeviceContextCreate = OPTIX_DEVICE_CONTEXT_CREATE_NAME( 60 );
            break;
        default:
#if defined( OPTIX_ENABLE_LOGGING )
