...
{
  public:
    RtcDmmBuilder( DeviceContext* context, bool computeMemory, ErrorDetails& errDetails );
    OptixResult init( const OptixDisplacedMicromeshArrayBuildInput* buildInput );
  ...
  private:
    ...
    const OptixDisplacedMicromeshArrayBuildInput* m_buildInput;
    RtcDisplacedMicromeshArrayBuildInput          m_rtcBuildInput;
};
