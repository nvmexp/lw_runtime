...
namespace optix_impl {
    ...
    static __forceinline__ __device__ void optixDumpExceptionDetails()
    {
        ...
        {
            OptixTraversableHandle handle = optixGetExceptionIlwalidTraversable();
            printf("(%4i,%4i,%4i) error: invalid traversable %p\n", index.x,index.y,index.z, (void*)handle);
            dumpTlist = true;
        }
        else if( exceptionCode == OPTIX_EXCEPTION_CODE_TRAVERSAL_ILWALID_MISS_SBT )
        {
            int sbtOffset = optixGetExceptionIlwalidSbtOffset();
            printf("(%4i,%4i,%4i) error: invalid miss sbt of %i\n", index.x,index.y,index.z, sbtOffset);
        }
        else if( exceptionCode == OPTIX_EXCEPTION_CODE_TRAVERSAL_ILWALID_HIT_SBT )
        {
            int sbtOffset = optixGetExceptionIlwalidSbtOffset();
        ...
        {
            OptixIlwalidRayExceptionDetails ray = optixGetExceptionIlwalidRay();
        ...
        else if( exceptionCode == OPTIX_EXCEPTION_CODE_CALLABLE_ILWALID_SBT )
        {
            int sbtOffset = optixGetExceptionIlwalidSbtOffset();
        ...
        else if( ( exceptionCode <= OPTIX_EXCEPTION_CODE_ILWALID_VALUE_ARGUMENT_0 ) && ( exceptionCode >= OPTIX_EXCEPTION_CODE_ILWALID_VALUE_ARGUMENT_2 ) )
        {
            printf("(%4i,%4i,%4i) error: invalid value for argument %i\n", index.x,index.y,index.z, -(exceptionCode - OPTIX_EXCEPTION_CODE_ILWALID_VALUE_ARGUMENT_0) );
        }
