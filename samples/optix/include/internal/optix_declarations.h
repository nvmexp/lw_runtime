...
typedef enum
{
  ...
  RT_TEXTURE_READ_ELEMENT_TYPE_SRGB = 2,      /*!< Read element type and apply sRGB to linear colwersion during texture read for 8-bit integer buffer formats     */
  RT_TEXTURE_READ_NORMALIZED_FLOAT_SRGB = 3   /*!< Read normalized float and apply sRGB to linear colwersion during texture read for 8-bit integer buffer formats */
} RTtexturereadmode;
...
typedef enum
{
  ...
  RT_TARGET_GL_TEXTURE_LWBE_MAP,      /*!< GL lwbe map texture     */
  RT_TARGET_GL_TEXTURE_LWBE_MAP_ARRAY /*!< GL array of lwbe maps   */
} RTgltarget;
...
typedef enum
{
  ...
  RT_BUFFER_COPY_ON_DIRTY        = 0x8,  /*!< A LWCA Interop buffer will only be synchronized across devices when dirtied by @ref rtBufferMap or @ref rtBufferMarkDirty */
  ...
  RT_BUFFER_LWBEMAP              = 0x400000, /*!< Enables creation of lwbemaps. If this flag is set, Width must be equal to Height, and Depth must be six. If the @ref RT_BUFFER_LAYERED flag is also set, then Depth must be a multiple of six */
} RTbufferflag;
...
typedef enum
{
  ...
  RT_EXCEPTION_PROGRAM_ID_ILWALID                = 0x3EE,    /*!< Program ID not valid                                                */
  RT_EXCEPTION_TEXTURE_ID_ILWALID                = 0x3EF,    /*!< Texture ID not valid                                                */
  RT_EXCEPTION_BUFFER_ID_ILWALID                 = 0x3FA,    /*!< Buffer ID not valid                                                 */
  ...
  RT_EXCEPTION_ILWALID_RAY                       = 0x3FE,    /*!< Invalid ray                                                         */
...
typedef enum
{
    ...
    RT_ERROR_ILWALID_CONTEXT          = 0x500, /*!< Invalid Context              */
    RT_ERROR_ILWALID_VALUE            = 0x501, /*!< Invalid Value                */
    RT_ERROR_MEMORY_ALLOCATION_FAILED = 0x502, /*!< Memory allocation failed     */
    ...
    RT_ERROR_ILWALID_SOURCE           = 0x507, /*!< Invalid source               */
    ...
    RT_ERROR_ILWALID_DEVICE          = 0x602, /*!< Invalid device               */
    RT_ERROR_ILWALID_IMAGE           = 0x603, /*!< Invalid image                */
    RT_ERROR_FILE_NOT_FOUND          = 0x604, /*!< File not found               */
    RT_ERROR_ALREADY_MAPPED          = 0x605, /*!< Already mapped               */
    RT_ERROR_ILWALID_DRIVER_VERSION  = 0x606, /*!< Invalid driver version       */
    ...
    RT_ERROR_ILWALID_GLOBAL_ATTRIBUTE = 0xC00, /*!< Invalid global attribute     */
...
typedef enum
{
  ...
  RT_GLOBAL_ATTRIBUTE_DISPLAY_DRIVER_VERSION_MINOR = 2,  /*!< sizeof(int)    */
  RT_GLOBAL_ATTRIBUTE_DEMAND_LOAD_NUM_VIRTUAL_PAGES = 3, /*!< sizeof(int)    */
#ifdef OPTIX_OPTIONAL_FEATURE_INTERNAL_ATTRIBUTES
  RT_GLOBAL_INTERNAL_ATTRIBUTE_FORCE_DEMAND_LOAD_WHOLE_MIP_LEVEL = 0x1000, /* sizeof(int) */
  // These values in the 0x2000000 range are for backwards compatibility with internal
  // context attributes that were used with a nullptr context.
  RT_GLOBAL_INTERNAL_ATTRIBUTE_SUBFRAME_INDEX                     = 0x2000006, /* sizeof(int) */
  RT_GLOBAL_INTERNAL_ATTRIBUTE_RESERVE_PROGRAM_ID                 = 0x2000010, /* sizeof(int) */
  RT_GLOBAL_INTERNAL_ATTRIBUTE_RESERVE_BUFFER_ID                  = 0x2000011, /* sizeof(int) */
  RT_GLOBAL_INTERNAL_ATTRIBUTE_RESERVE_TEXTURE_SAMPLER_ID         = 0x2000012, /* sizeof(int) */
  RT_GLOBAL_INTERNAL_ATTRIBUTE_PROGRAM_ID_HINT                    = 0x2000013, /* sizeof(int) */
  RT_GLOBAL_INTERNAL_ATTRIBUTE_BUFFER_ID_HINT                     = 0x2000014, /* sizeof(int) */
  RT_GLOBAL_INTERNAL_ATTRIBUTE_TEXTURE_SAMPLER_ID_HINT            = 0x2000015, /* sizeof(int) */
  RT_GLOBAL_INTERNAL_ATTRIBUTE_STACK_SIZE                         = 0x2000016, /* sizeof(size_t[3]) */
#ifdef OPTIX_OPTIONAL_FEATURE_DEPRECATED_ATTRIBUTES
  // A distinct global attribute value was introduced for this behavior above.
  RT_GLOBAL_INTERNAL_ATTRIBUTE_FORCE_DEMAND_LOAD_WHOLE_MIP_LEVEL_BACK_COMPAT = 0x2000017, /* sizeof(int) */
  ...
  RT_GLOBAL_ATTRIBUTE_DEVELOPER_OPTIONS = 0x10000001    /*!< Knobs string   */
} RTglobalattribute;

/*! Context attributes */
typedef enum
{
  RT_CONTEXT_ATTRIBUTE_MAX_TEXTURE_COUNT                           = 0,         /*!< sizeof(int)       */
  RT_CONTEXT_ATTRIBUTE_CPU_NUM_THREADS                             = 1,         /*!< sizeof(int)       */
  RT_CONTEXT_ATTRIBUTE_USED_HOST_MEMORY                            = 2,         /*!< sizeof(RTsize)    */
  RT_CONTEXT_ATTRIBUTE_GPU_PAGING_ACTIVE                           = 3,         /*!< sizeof(int)       */
  RT_CONTEXT_ATTRIBUTE_GPU_PAGING_FORCED_OFF                       = 4,         /*!< sizeof(int)       */
  RT_CONTEXT_ATTRIBUTE_DISK_CACHE_ENABLED                          = 5,         /*!< sizeof(int)       */
  RT_CONTEXT_ATTRIBUTE_PREFER_FAST_RECOMPILES                      = 6,         /*!< sizeof(int)       */
  RT_CONTEXT_ATTRIBUTE_FORCE_INLINE_USER_FUNCTIONS                 = 7,         /*!< sizeof(int)       */
  RT_CONTEXT_ATTRIBUTE_OPTIX_SALT                                  = 8,         /*!< 32                */
  RT_CONTEXT_ATTRIBUTE_VENDOR_SALT                                 = 9,         /*!< 32                */
  RT_CONTEXT_ATTRIBUTE_PUBLIC_VENDOR_KEY                           = 10,        /*!< variable          */
  RT_CONTEXT_ATTRIBUTE_DISK_CACHE_LOCATION                         = 11,        /*!< sizeof(char*)     */
  RT_CONTEXT_ATTRIBUTE_DISK_CACHE_MEMORY_LIMITS                    = 12,        /*!< sizeof(RTsize[2]) */
  RT_CONTEXT_ATTRIBUTE_PREFER_WATERTIGHT_TRAVERSAL                 = 13,        /*!< sizeof(int)       */
  RT_CONTEXT_ATTRIBUTE_MAX_CONLWRRENT_LAUNCHES                     = 14,        /*!< sizeof(int)       */
#ifdef OPTIX_OPTIONAL_FEATURE_DEPRECATED_ATTRIBUTES
  RT_CONTEXT_ATTRIBUTE_DEMAND_LOAD_NUM_THREADS                     = 15,        /*!< sizeof(int)       */
#endif  // OPTIX_OPTIONAL_FEATURE_DEPRECATED_ATTRIBUTES
  RT_CONTEXT_ATTRIBUTE_DEMAND_LOAD_MULTITHREADED_CALLBACKS_ENABLED = 16,        /*!< sizeof(int)       */
  RT_CONTEXT_ATTRIBUTE_USE_HARDWARE_SPARSE_TEXTURES                = 17,        /*!< sizeof(int)       */
#ifdef OPTIX_OPTIONAL_FEATURE_INTERNAL_ATTRIBUTES
  RT_CONTEXT_INTERNAL_ATTRIBUTE_DEMAND_LOAD_FORCE_SYNCHRONOUS      = 18,        /*!< sizeof(int)       */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_DEMAND_LOAD_USE_ASYNC_COPIES       = 19,        /*!< sizeof(int)       */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_DEMAND_LOAD_STAMP_MEMORY_BLOCKS    = 20,        /*!< sizeof(int)       */
  //
  // Retired internal attributes are commented out for reference. Don't reuse their values
  // when adding a new internal attribute.
  //
  // RT_CONTEXT_INTERNAL_ATTRIBUTE_ABI_STATUS                       0x2000000 /* sizeof(int) */
  // RT_CONTEXT_INTERNAL_ATTRIBUTE_CALLID                           0x2000001 /* sizeof(long long) */
  // RT_CONTEXT_INTERNAL_ATTRIBUTE_ACCELERATION_BAKE_CHILD_POINTERS 0x2000002 /* sizeof(int) */
  // RT_CONTEXT_INTERNAL_ATTRIBUTE_COMPARE_LWBIN_HASH               0x2000003 /* sizeof(int) */
  // RT_CONTEXT_INTERNAL_ATTRIBUTE_ALLOW_32BITBUFFER_OPTIMIZATION   0x2000004 /* sizeof(int) */
  // RT_CONTEXT_INTERNAL_ATTRIBUTE_LIMIT_RESIDENT_DEVICE_MEMORY     0x2000005 /* sizeof(size_t) */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_SUBFRAME_INDEX                    = 0x2000006, /* sizeof(int) */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_RESERVE_PROGRAM_ID                = 0x2000010, /* sizeof(int) */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_RESERVE_BUFFER_ID                 = 0x2000011, /* sizeof(int) */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_RESERVE_TEXTURE_SAMPLER_ID        = 0x2000012, /* sizeof(int) */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_PROGRAM_ID_HINT                   = 0x2000013, /* sizeof(int) */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_BUFFER_ID_HINT                    = 0x2000014, /* sizeof(int) */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_TEXTURE_SAMPLER_ID_HINT           = 0x2000015, /* sizeof(int) */
  RT_CONTEXT_INTERNAL_ATTRIBUTE_STACK_SIZE                        = 0x2000016, /* sizeof(size_t[3]) */
#ifdef OPTIX_OPTIONAL_FEATURE_DEPRECATED_ATTRIBUTES
  RT_CONTEXT_INTERNAL_ATTRIBUTE_FORCE_DEMAND_LOAD_WHOLE_MIP_LEVEL = 0x2000017, /* sizeof(int) */
#endif // OPTIX_OPTIONAL_FEATURE_DEPRECATED_ATTRIBUTES
  // RT_CONTEXT_INTERNAL_ATTRIBUTE_LWBIN_HASH                       0x3000000 /* 2*sizeof(long long) */
  // RT_CONTEXT_INTERNAL_ATTRIBUTE_LWBIN_SMVERSION  (0x3000000 + RT_CONTEXT_INTERNAL_MAX_LWBIN_CACHE)   /* sizeof(int) */
  // RT_CONTEXT_INTERNAL_ATTRIBUTE_LWBIN_DATA       (0x3000000 + 2*RT_CONTEXT_INTERNAL_MAX_LWBIN_CACHE) /* chars */
#endif  // OPTIX_OPTIONAL_FEATURE_INTERNAL_ATTRIBUTES
  RT_CONTEXT_ATTRIBUTE_AVAILABLE_DEVICE_MEMORY                     = 0x10000000 /*!< sizeof(RTsize)    */
} RTcontextattribute;
#define RT_CONTEXT_USE_HARDWARE_SPARSE_TEXTURES RT_CONTEXT_ATTRIBUTE_USE_HARDWARE_SPARSE_TEXTURES
...
typedef enum
{
  ...
  RT_GEOMETRY_FLAG_DISABLE_ANYHIT  = 0x01, /*!< Disable any-hit program exelwtion (exelwtion will be skipped,including the no-op any-hit program
  ...
  RT_GEOMETRY_FLAG_NO_SPLITTING    = 0x02, /*!< Disable primitive splitting to avoid potential multiple any-hit program exelwtion for a single intersection */
} RTgeometryflags;
...
typedef enum
{
  ...
  RT_INSTANCE_FLAG_DISABLE_TRIANGLE_LWLLING = 1u << 0,  /*!< Prevent triangles from getting lwlled due to face orientation (overrides ray lwlling flags). */
  RT_INSTANCE_FLAG_FLIP_TRIANGLE_FACING     = 1u << 1,  /*!< Flip triangle orientation. This affects front/back face lwlling. */
  RT_INSTANCE_FLAG_DISABLE_ANYHIT           = 1u << 2,  /*!< Disable any-hit program exelwtion (including the no-op any-hit program
                                                             used when an any-hit program is not specified).
  ...
  RT_INSTANCE_FLAG_FORCE_ANYHIT             = 1u << 3   /*!< Force any-hit program exelwtion.
...
{
  RT_RAY_FLAG_NONE                          = 0u,
  RT_RAY_FLAG_DISABLE_ANYHIT                = 1u << 0, /*!< Disable any-hit program exelwtion for the ray (exelwtion will be skipped,including the no-op any-hit program
                                                            used when an any-hit program is not specified).
                                                            Mutually exclusive with RT_RAY_FLAG_FORCE_ANYHIT.
                                                            If set, overrides any potentially set @ref RT_INSTANCE_FLAG_FORCE_ANYHIT.
                                                            Overriding precedence: RTrayflags > RTinstanceflags > RTgeometryflags */
  RT_RAY_FLAG_FORCE_ANYHIT                  = 1u << 1, /*!< Force any-hit program exelwtion for the ray. See @ref RT_RAY_FLAG_DISABLE_ANYHIT.
  ...
  RT_RAY_FLAG_DISABLE_CLOSESTHIT            = 1u << 3, /*!< Disable closest-hit program exelwtion for the ray. */
  RT_RAY_FLAG_LWLL_BACK_FACING_TRIANGLES    = 1u << 4, /*!< Do not intersect triangle back faces. */
  RT_RAY_FLAG_LWLL_FRONT_FACING_TRIANGLES   = 1u << 5, /*!< Do not intersect triangle front faces. */
  RT_RAY_FLAG_LWLL_DISABLED_ANYHIT          = 1u << 6, /*!< Do not intersect geometry which disables any-hit programs (due to any geometry, instance, or ray flag). */
  RT_RAY_FLAG_LWLL_ENABLED_ANYHIT           = 1u << 7  /*!< Do not intersect geometry which exelwtes any-hit programs (i.e., forced or not disabled any-hit program exelwtion, this includes a potential no-op any-hit program). */
} RTrayflags;
