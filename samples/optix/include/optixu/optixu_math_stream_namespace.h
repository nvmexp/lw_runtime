 ...
 *
 * Stream operators for LWCA vector types
 */
...
namespace optix {
  ...
  /**
  * Provide access to stream functionalities with LWCA float vector types
  * @{
  */
  ...
  /**
  * Provide access to stream functionalities with LWCA int vector types
  * @{
  */
  ...
  /**
  * Provide access to stream functionalities with LWCA uint vector types
  * @{
  */
