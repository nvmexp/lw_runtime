...
namespace optix {
  ...
  public:
    ...
    /// Note that this function is wrapped by the colwenience function Handle::operator[].
  ...
  public:
    ...
    /// Create a lwbe mipmapped buffer with given RTbuffertype, RTformat and dimension.  See @ref rtBufferCreate,
    /// @ref rtBufferSetFormat,  @ref rtBufferSetMipLevelCount, and @ref rtBufferSetSize3D.
    Buffer createLwbeBuffer(unsigned int type, RTformat format, RTsize width, RTsize height, unsigned int levels);
    /// Create a lwbe layered mipmapped buffer with given RTbuffertype, RTformat and dimension.  See @ref rtBufferCreate,
    /// @ref rtBufferSetFormat,  @ref rtBufferSetMipLevelCount, and @ref rtBufferSetSize3D.
    Buffer createLwbeLayeredBuffer(unsigned int type, RTformat format, RTsize width, RTsize height, RTsize faces, unsigned int levels);

    /// Create a buffer for LWCA with given RTbuffertype.  See @ref rtBufferCreate.
    Buffer createBufferForLWDA(unsigned int type);
    /// Create a buffer for LWCA with given RTbuffertype and RTformat.  See @ref rtBufferCreate, @ref rtBufferSetFormat
    Buffer createBufferForLWDA(unsigned int type, RTformat format);
    /// Create a buffer for LWCA with given RTbuffertype, RTformat and dimension.  See @ref rtBufferCreate,
    /// @ref rtBufferSetFormat and @ref rtBufferSetSize1D.
    Buffer createBufferForLWDA(unsigned int type, RTformat format, RTsize width);
    /// Create a buffer for LWCA with given RTbuffertype, RTformat and dimension.  See @ref rtBufferCreate,
    /// @ref rtBufferSetFormat and @ref rtBufferSetSize2D.
    Buffer createBufferForLWDA(unsigned int type, RTformat format, RTsize width, RTsize height);
    /// Create a buffer for LWCA with given RTbuffertype, RTformat and dimension.  See @ref rtBufferCreate,
    /// @ref rtBufferSetFormat and @ref rtBufferSetSize3D.
    Buffer createBufferForLWDA(unsigned int type, RTformat format, RTsize width, RTsize height, RTsize depth);
    ...
    /// See @ref rtContextGetDevices.  This returns the list of lwrrently enabled devices.
  ...
  public:
    ...
    /// Throws @ref RT_ERROR_ILWALID_VALUE if the parameter is invalid.
  ...
  public:
    ...
    void setMatrix(bool transpose, const float* matrix, const float* ilwerse_matrix);
    /// Get the transform matrix for this node.  See @ref rtTransformGetMatrix.
    void getMatrix(bool transpose, float* matrix, float* ilwerse_matrix) const;
    /// @}
  ...
  public:
    ...
    /// See @ref rtGeometryTrianglesSetMotiolwertices
    void setMotiolwertices( unsigned int num_vertices,
    ...
    /// See @ref rtGeometryTrianglesSetMotiolwerticesMultiBuffer
    template <class BufferIterator>
    void setMotiolwerticesMultiBuffer( unsigned int   num_vertices,
...
#define rtMarkedCallableProgramId optix::markedCallableProgramId
  ...
  public:
    ...
    /// @{
    // Excelwte the command list. Can only be called after finalizing it. See @ref rtCommandListExelwte.
    void execute();
    /// @}
    ...
    /// @{
    /// Sets the lwca stream for this command list. See @ref rtCommandListSetLwdaStream.
    void setLwdaStream( void* stream );

    /// Gets the lwca stream set for this command list. See @ref rtCommandListGetLwdaStream.
  ...
  inline Buffer ContextObj::createLwbeBuffer(unsigned int type, RTformat format, RTsize width, RTsize height, unsigned int levels)
  {
    RTbuffer buffer;
    checkError( rtBufferCreate( m_context, type | RT_BUFFER_LWBEMAP, &buffer ) );
    checkError( rtBufferSetFormat( buffer, format ) );
    checkError( rtBufferSetMipLevelCount( buffer, levels ) );
  ...
  inline Buffer ContextObj::createLwbeLayeredBuffer(unsigned int type, RTformat format, RTsize width, RTsize height, RTsize faces, unsigned int levels)
  {
    RTbuffer buffer;
    checkError( rtBufferCreate( m_context, type | RT_BUFFER_LWBEMAP | RT_BUFFER_LAYERED, &buffer ) );
    checkError( rtBufferSetFormat( buffer, format ) );
    checkError( rtBufferSetMipLevelCount( buffer, levels ) );
  ...
  inline Buffer ContextObj::createBufferForLWDA(unsigned int type)
  {
    RTbuffer buffer;
    checkError( rtBufferCreateForLWDA( m_context, type, &buffer ) );
    return Buffer::take(buffer);
  }

  inline Buffer ContextObj::createBufferForLWDA(unsigned int type, RTformat format)
  {
    RTbuffer buffer;
    checkError( rtBufferCreateForLWDA( m_context, type, &buffer ) );
    checkError( rtBufferSetFormat( buffer, format ) );
  ...
  inline Buffer ContextObj::createBufferForLWDA(unsigned int type, RTformat format, RTsize width)
  {
    RTbuffer buffer;
    checkError( rtBufferCreateForLWDA( m_context, type, &buffer ) );
    checkError( rtBufferSetFormat( buffer, format ) );
  ...
  inline Buffer ContextObj::createBufferForLWDA(unsigned int type, RTformat format, RTsize width, RTsize height)
  {
    RTbuffer buffer;
    checkError( rtBufferCreateForLWDA( m_context, type, &buffer ) );
    checkError( rtBufferSetFormat( buffer, format ) );
  ...
  inline Buffer ContextObj::createBufferForLWDA(unsigned int type, RTformat format, RTsize width, RTsize height, RTsize depth)
  {
    RTbuffer buffer;
    checkError( rtBufferCreateForLWDA( m_context, type, &buffer ) );
    checkError( rtBufferSetFormat( buffer, format ) );
  ...
  inline void SelectorObj::removeChild(unsigned int index)
  {
    ...
    if(index >= count) {
      RTcontext c = this->getContext()->get();
      throw Exception::makeException( RT_ERROR_ILWALID_VALUE, c );
    }
  ...
  inline void TransformObj::setMatrix(bool transpose, const float* matrix, const float* ilwerse_matrix)
  {
    checkError( rtTransformSetMatrix( m_transform, transpose, matrix, ilwerse_matrix ) );
  }

  inline void TransformObj::getMatrix(bool transpose, float* matrix, float* ilwerse_matrix) const
  {
    checkError( rtTransformGetMatrix( m_transform, transpose, matrix, ilwerse_matrix ) );
  }
  ...
  {
    checkError( rtAcceleratiolwalidate(m_acceleration) );
  }
  ...
  inline void GeometryTrianglesObj::setMotiolwertices( unsigned int num_vertices,
                                                       Buffer       vertex_buffer,
                                                       RTsize       vertex_buffer_byte_offset,
                                                       RTsize       vertex_byte_stride,
                                                       RTsize       vertex_motion_step_byte_stride,
                                                       RTformat     position_format )
  {
      checkError( rtGeometryTrianglesSetMotiolwertices( m_geometryTriangles, num_vertices, vertex_buffer->get(), vertex_buffer_byte_offset,
                                                        vertex_byte_stride, vertex_motion_step_byte_stride, position_format ) );
  }

  template <class BufferIterator>
  inline void GeometryTrianglesObj::setMotiolwerticesMultiBuffer( unsigned int   num_vertices,
                                                                  BufferIterator vertex_buffers_begin,
                                                                  BufferIterator vertex_buffers_end,
                                                                  RTsize         vertex_buffer_byte_offset,
                                                                  RTsize         vertex_byte_stride,
                                                                  RTformat       position_format )
  {
      ...
      checkError( rtGeometryTrianglesSetMotiolwerticesMultiBuffer( m_geometryTriangles, num_vertices,
  ...
  {
    Context context = getContext();
    checkError(rtCommandListExelwte(m_list), context);
  }

  inline void CommandListObj::setLwdaStream( void* stream )
  {
    Context context = getContext();
    checkError( rtCommandListSetLwdaStream( m_list, stream ) );
  }

  inline void CommandListObj::getLwdaStream( void** stream )
  {
      Context context = getContext();
      checkError( rtCommandListGetLwdaStream( m_list, stream ) );
  }
