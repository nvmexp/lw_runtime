 ...
 * (float3, float4 etc.) since these are not provided as standard by LWCA.
 *
 * The syntax is modeled on the Cg standard library.
 *
 * This file has also been modified from the original lwtil_math.h file.
 * lwtil_math.h is a subset of this file, and you should use this file in place
 * of any lwtil_math.h file you wish to use.
*/
...
#include "../o6/optix.h"                  // For RT_HOSTDEVICE
...
#if !defined(_WIN32) && !defined(__LWDACC_RTC__)
...
// __forceinline__ works in lwca, VS, and with gcc.  Leave it as macro in case
...
/******************************************************************************/
namespace optix {
#if (defined(_WIN32) && !defined(RT_UINT_USHORT_DEFINED)) || defined(__LWDACC_RTC__)
...
/* Functions that LWCA provides for device code but are lacking on some host platform */
...
namespace optix {
...
#if !defined(_WIN32) || defined (__LWDACC__)
  // These functions are in the global namespace on POSIX (not _WIN32) and in LWCA C.
  using ::fminf;
  using ::fmaxf;
  using ::copysignf;
#endif
  ...
  // These are defined by LWCA in the global namespace.
#ifdef __LWDACC__
  using ::min;
  using ::max;
#else
...
/**
*  Callwlates refraction direction
*  r   : refraction vector
*  i   : incident vector
*  n   : surface normal
...
/** Callwlate the NTSC luminance value of an rgb triple
*/
...
/** Callwlate the CIE luminance value of an rgb triple
*/
...
/**
* Colwert Cartesian coordinates to polar coordinates
*/
...
struct Onb
{
  ...
  OPTIXU_INLINE RT_HOSTDEVICE void ilwerse_transform(float3& p) const
  {
...
/* These are defined by LWCA and non-Windows platforms in the global namespace. */
#if !defined(_WIN32) || defined (__LWDACC__)
using optix::fmaxf;
using optix::fminf;
