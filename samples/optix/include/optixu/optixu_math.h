...
/*
 * This is a backward compatibility header designed to keep all the LWCA vector types in
...
/*
 * These need to be included first in order to make sure the LWCA vector types are defined
