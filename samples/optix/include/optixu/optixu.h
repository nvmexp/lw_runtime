 ...
 */
 ...
 /**
 * \file optixu.h
 * \brief Colwenience functions for the OptiX API.
 */
...
extern "C" {
  ...
  * Returns @ref RT_ERROR_ILWALID_VALUE if the format isn't recognized, @ref RT_SUCCESS otherwise.
  *
  ...
  * @retval RTresult  Return code
  */
  RTresult RTAPI rtuLWDACompileString( const char* source, const char** preprocessorArguments, unsigned int numPreprocessorArguments, RTsize* resultSize, RTsize* errorSize );

 /**
  * \ingroup rtu
  *
  * Compile a lwca source file.
  *
  ...
  * @retval RTresult  Return code
  */
  RTresult RTAPI rtuLWDACompileFile( const char* filename, const char** preprocessorArguments, unsigned int numPreprocessorArguments, RTsize* resultSize, RTsize* errorSize );
  ...
  * @retval RTresult  Return code
  */
  RTresult RTAPI rtuLWDAGetCompileResult( char* result, char* error );
  ...
  * Returns @ref RT_SUCCESS if the child was found, @ref RT_ERROR_ILWALID_VALUE otherwise.
  * @{
  */
