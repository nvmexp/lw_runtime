...
typedef struct ID3D10Resource ID3D10Resource;
  ...
  * function must be exelwted once for \a context before any call to @ref rtBufferCreateFromD3D10Resource or @ref rtTextureSamplerCreateFromD3D10Resource can
