...
typedef struct ID3D11Resource ID3D11Resource;
  ...
  * function must be exelwted once for \a context before any call to @ref rtBufferCreateFromD3D11Resource or @ref rtTextureSamplerCreateFromD3D11Resource can
