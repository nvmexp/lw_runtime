...
enum RTPresult
{
  ...
  RTP_ERROR_ILWALID_VALUE             =   1,  /*!< An invalid value was provided */
  RTP_ERROR_OUT_OF_MEMORY             =   2,  /*!< Out of memory */
  RTP_ERROR_ILWALID_HANDLE            =   3,  /*!< An invalid handle was supplied */
  ...
  RTP_ERROR_ILWALID_CONTEXT           =   7,  /*!< An invalid context was provided */
  RTP_ERROR_VALIDATION_ERROR          =   8,  /*!< A validation error oclwrred */
  RTP_ERROR_ILWALID_OPERATION         =   9,  /*!< An invalid operation was performed */
...
enum RTPcontexttype 
{
  ...
  RTP_CONTEXT_TYPE_LWDA = 0x101,  /*!< LWCA context */
};
...
enum RTPbuffertype 
{
  ...
  RTP_BUFFER_TYPE_LWDA_LINEAR = 0x201   /*!< Linear buffer in device memory on a lwca device */
};
...
enum RTPqueryhint 
{
  ...
  RTP_QUERY_HINT_ASYNC       = 0x4001,  /*!< Asynchronous query exelwtion */
