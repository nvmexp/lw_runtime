 ...
 * optix_lwda.h
 *
 * This file provides the lwcc interface for generating PTX that the OptiX is
...
#if defined(__APPLE__) || defined(__x86_64) || defined(AMD64) || defined(_M_AMD64) || defined(__powerpc64__) || defined(__EDG_IA64_ABI)/*=LWRTC*/ || defined(__aarch64__)
...
/**
  ...
  * variable will be visible to all of the lwca functions defined in the
  ...
  * - \b rtLwrrentRay - The lwrrently active ray, valid only when a call to @ref rtTrace is active.  The vector is \em not guaranteed to be normalized.  Type must be \a optix::Ray and is read-only.
  * - \b rtLwrrentTime - The current ray time.  Type must be \a float and is read-only.
...
/**
  ...
  * ignored, and sequences of whitespace in the middle of the text is colwerted to
...
/* Declares a function that can be set via rtVariableSetObject and called from LWCA C.
...
/*
   Texture - they are defined in LWCA
*/
...
namespace optix {
  ...
  /**
    * @brief Similar to LWCA C's texture functions, OptiX programs can access textures in a bindless way
    *
    * @ingroup rtTex
    *
    * <B>Description</B>
    ...
    *
    * And lwbeamp textures with \b rtTexLwbemap, \b rtTexLwbemapLod, \b rtTexLwbemapLayered and \b rtTexLwbemapLayeredLod.
    *
    * @code
    ...
    * \b rtTex2DGather, \b rtTex1DGrad, \b rtTex2DGrad, \b rtTex3DGrad, \b rtTex1DLayeredGrad, \b rtTex2DLayeredGrad,
    * \b rtTex1DLod, \b rtTex2DLod, \b rtTex3DLod, \b rtTex1DLayeredLod, \b rtTex2DLayeredLod, \b rtTex1DLayered, \b rtTex2DLayered,
    * \b rtTexLwbemap, \b rtTexLwbemapLod, \b rtTexLwbemapLayered and \b rtTexLwbemapLayeredLod
  ...
  template<typename T>
  inline __device__ T rtTexLwbemap(rtTextureId id, float x, float y, float z);
  template<> inline __device__ float4 rtTexLwbemap(rtTextureId id, float x, float y, float z)
  {
    return optix::rt_texture_get_base_id(id, TEX_LOOKUP_LWBE, x, y, z, 0 );
  }
  template<> inline __device__ int4 rtTexLwbemap(rtTextureId id, float x, float y, float z)
  {
    return float4AsInt4(optix::rt_texture_get_base_id(id, TEX_LOOKUP_LWBE, x, y, z, 0 ));
  }
  template<> inline __device__ uint4 rtTexLwbemap(rtTextureId id, float x, float y, float z)
  {
    return float4AsUInt4(optix::rt_texture_get_base_id(id, TEX_LOOKUP_LWBE, x, y, z, 0 ));
  }
  _OPTIX_TEX_FUNC_DECLARE_(rtTexLwbemap, (rtTextureId id, float x, float y, float z), (id, x, y, z) )
  template<typename T>
  inline __device__ void rtTexLwbemap(T* retVal, rtTextureId id, float x, float y, float z)
  {
    T tmp = rtTexLwbemap<T>(id, x, y, z);
    *retVal = tmp;
  }

  template<typename T>
  inline __device__ T rtTexLwbemapLayered(rtTextureId id, float x, float y, float z, int layer);
  template<> inline __device__ float4 rtTexLwbemapLayered(rtTextureId id, float x, float y, float z, int layer)
  {
    return optix::rt_texture_get_base_id(id, TEX_LOOKUP_ALWBE, x, y, z, layer );
  }
  template<> inline __device__ int4 rtTexLwbemapLayered(rtTextureId id, float x, float y, float z, int layer)
  {
    return float4AsInt4(optix::rt_texture_get_base_id(id, TEX_LOOKUP_ALWBE, x, y, z, layer ));
  }
  template<> inline __device__ uint4 rtTexLwbemapLayered(rtTextureId id, float x, float y, float z, int layer)
  {
    return float4AsUInt4(optix::rt_texture_get_base_id(id, TEX_LOOKUP_ALWBE, x, y, z, layer ));
  }
  _OPTIX_TEX_FUNC_DECLARE_(rtTexLwbemapLayered, (rtTextureId id, float x, float y, float z, int layer), (id, x, y, z, layer) )
  template<typename T>
  inline __device__ void rtTexLwbemapLayered(T* retVal, rtTextureId id, float x, float y, float z, int layer)
  {
    T tmp = rtTexLwbemapLayered<T>(id, x, y, z, layer);
    *retVal = tmp;
  }

  template<typename T>
  inline __device__ T rtTexLwbemapLod(rtTextureId id, float x, float y, float z, float level);
  template<> inline __device__ float4 rtTexLwbemapLod(rtTextureId id, float x, float y, float z, float level)
  {
    return optix::rt_texture_get_level_id(id, TEX_LOOKUP_LWBE, x, y, z, 0, level );
  }
  template<> inline __device__ int4 rtTexLwbemapLod(rtTextureId id, float x, float y, float z, float level)
  {
    return float4AsInt4(optix::rt_texture_get_level_id(id, TEX_LOOKUP_LWBE, x, y, z, 0, level ));
  }
  template<> inline __device__ uint4 rtTexLwbemapLod(rtTextureId id, float x, float y, float z, float level)
  {
    return float4AsUInt4(optix::rt_texture_get_level_id(id, TEX_LOOKUP_LWBE, x, y, z, 0, level ));
  }
  _OPTIX_TEX_FUNC_DECLARE_(rtTexLwbemapLod, (rtTextureId id, float x, float y, float z, float level), (id, x, y, z, level) )
  template<typename T>
  inline __device__ void rtTexLwbemapLod(T* retVal, rtTextureId id, float x, float y, float z, float level)
  {
    T tmp = rtTexLwbemapLod<T>(id, x, y, z, level);
    *retVal = tmp;
  }

  template<typename T>
  inline __device__ T rtTexLwbemapLayeredLod(rtTextureId id, float x, float y, float z, int layer, float level);
  template<> inline __device__ float4 rtTexLwbemapLayeredLod(rtTextureId id, float x, float y, float z, int layer, float level)
  {
    return optix::rt_texture_get_level_id(id, TEX_LOOKUP_ALWBE, x, y, z, layer, level );
  }
  template<> inline __device__ int4 rtTexLwbemapLayeredLod(rtTextureId id, float x, float y, float z, int layer, float level)
  {
    return float4AsInt4(optix::rt_texture_get_level_id(id, TEX_LOOKUP_ALWBE, x, y, z, layer, level ));
  }
  template<> inline __device__ uint4 rtTexLwbemapLayeredLod(rtTextureId id, float x, float y, float z, int layer, float level)
  {
    return float4AsUInt4(optix::rt_texture_get_level_id(id, TEX_LOOKUP_ALWBE, x, y, z, layer, level ));
  }
  _OPTIX_TEX_FUNC_DECLARE_(rtTexLwbemapLayeredLod, (rtTextureId id, float x, float y, float z, int layer, float level), (id, x, y, z, layer, level) )
  template<typename T>
  inline __device__ void rtTexLwbemapLayeredLod(T* retVal, rtTextureId id, float x, float y, float z, int layer, float level)
  {
    T tmp = rtTexLwbemapLayeredLod<T>(id, x, y, z, layer, level);
    *retVal = tmp;
  }
...
/**
  ...
  * reference return value (type \b lwrt::AAbb&). Intersection programs will
 ...
 *    case LWCA will force the inline of the proxy function removing the call altogether,
 *    and in the case of passing pointers as integers, LWCA will assume that any pointer
...
*/
  ...
  * that are exelwted during this invocation of trace. \a topNode must refer
  ...
  * The ray time is available in user programs as the rtLwrrentTime semantic variable.
  ...
  * Note that visibility is lwrrently limited to eight groups, only the lower eight bits of \p mask will
...
/* Overload without time parameter, dolwmented above */
template<class T>
...
/**
  ...
  * which is usually different when launching multiple conlwrrent command lists.
  *
...
/**
  ...
  * active transformation stack (the ilwerse transpose).  During
...
/**
  * @brief Get the index of the closest hit or lwrrently intersecting primitive
  *
  * @ingroup LWDACFunctions
  *
  * <B>Description</B>
...
/**
* @brief Returns if the hit kind of the closest hit or lwrrently intersecting primitive is a builtin triangle
*
* @ingroup LWDACFunctions
*
* <B>Description</B>
...
/**
  ...
  * Text printed using @ref rtPrintf is aclwmulated in a buffer and printed to the standard
  ...
  * ilwocations will be silently ignored.
  *
  * <B>History</B>
  *
...
/**
  ...
  * is immediately aborted and the corresponding exception program is exelwted. @ref rtThrow
  * does not return.
  *
...
static inline __device__ void rtPrintExceptionDetails()
{
  ...
  else if( code == RT_EXCEPTION_PROGRAM_ID_ILWALID )
  {
    switch( rti_internal_register::reg_exception_detail1 )
    {
      case 1:
        rtPrintf(
          "Caught RT_EXCEPTION_PROGRAM_ID_ILWALID\n"
  ...
  else if( code == RT_EXCEPTION_TEXTURE_ID_ILWALID )
  {
    switch( rti_internal_register::reg_exception_detail1 )
    {
      case 1:
        rtPrintf(
          "Caught RT_EXCEPTION_TEXTURE_ID_ILWALID\n"
  ...
  else if( code == RT_EXCEPTION_BUFFER_ID_ILWALID )
  {
    switch( rti_internal_register::reg_exception_detail1 )
    {
      case 1:
        rtPrintf(
          "Caught RT_EXCEPTION_BUFFER_ID_ILWALID\n"
  ...
  else if( code == RT_EXCEPTION_ILWALID_RAY )
  {
    rtPrintf(
      "Caught RT_EXCEPTION_ILWALID_RAY\n"
      "  launch index  : %d, %d, %d\n"
      "  location      : %s\n"
      "  ray origin    : %f %f %f\n"
      "  ray direction : %f %f %f\n"
