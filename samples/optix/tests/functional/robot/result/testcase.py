...
class TestCase(model.TestCase):
    ...
    def __init__(self, name='', doc='', tags=None, timeout=None, status='FAIL',
        ...
        #: Test case exelwtion start time in format ``%Y%m%d %H:%M:%S.%f``.
        self.starttime = starttime
        #: Test case exelwtion end time in format ``%Y%m%d %H:%M:%S.%f``.
        self.endtime = endtime

    @property
    def elapsedtime(self):
        """Elapsed exelwtion time of the test case in milliseconds."""
