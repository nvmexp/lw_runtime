...
class Keyword(model.Keyword):
    ...
    def __init__(self, name='', doc='', args=(), type='kw', timeout='',
        ...
        #: String 'PASS' of 'FAIL'.
        self.status = status
        #: Keyword exelwtion start time in format ``%Y%m%d %H:%M:%S.%f``.
        self.starttime = starttime
        #: Keyword exelwtion end time in format ``%Y%m%d %H:%M:%S.%f``.
    ...
    def elapsedtime(self):
        """Elapsed exelwtion time of the keyword in milliseconds."""
