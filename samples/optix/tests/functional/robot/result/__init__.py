...
"""Implements parsing exelwtion results from XML output files.

The public API of this package is the :func:`~.ExelwtionResult` factory
...
from .exelwtionresult import Result
from .resultbuilder import ExelwtionResult
