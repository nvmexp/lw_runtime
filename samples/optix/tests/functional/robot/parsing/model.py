...
class TestDataDirectory(_TestData):
    ...
    def populate(self, include_suites=None, warn_on_skipped=False, relwrse=True):
        FromDirectoryPopulator().populate(self.source, self, include_suites,
                                          warn_on_skipped, relwrse)
...
class _Table(object):
    ...
    def report_ilwalid_syntax(self, message, level='ERROR'):
        self.parent.report_ilwalid_syntax(message, level)
...
class _WithSettings(object):
    ...
    def get_setter(self, setting_name):
        ...
        self.report_ilwalid_syntax("Non-existing setting '%s'." % setting_name)
...
class _SettingTable(_Table, _WithSettings):
    ...
    def add_resource(self, name, ilwalid_args=None, comment=None):
        self.imports.add(Resource(self, name, ilwalid_args, comment=comment))
        return self.imports[-1]
...
class Variable(object):
    ...
    def report_ilwalid_syntax(self, message, level='ERROR'):
        self.parent.report_ilwalid_syntax("Setting variable '%s' failed: %s"
