...
"""Implements the core test exelwtion logic.

The public API of this package consists of the following two classes:

* :class:`~robot.running.model.TestSuite` for creating an exelwtable
  test suite structure programmatically.

* :class:`~robot.running.builder.TestSuiteBuilder` for creating exelwtable
...
Rewriting of the test exelwtion logic will continue in future releases,
...
We can easily parse and create an exelwtable test suite based on the above file
...
:class:`~robot.result.exelwtionresult.Result` object contains correct
information::
