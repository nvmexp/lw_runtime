...
class ExelwtionContexts(object):
    ...
    def start_suite(self, namespace, output, dry_run=False):
        self._contexts.append(_ExelwtionContext(namespace, output, dry_run))
        return self.current
...
# This is ugly but lwrrently needed e.g. by BuiltIn
EXELWTION_CONTEXTS = ExelwtionContexts()


class _ExelwtionContext(object):
    ...
    # TODO: Move start_suite here from EXELWTION_CONTEXT
    ...
    def start_test(self, test):
        ...
        self.variables['${TEST_DOLWMENTATION}'] = test.doc
