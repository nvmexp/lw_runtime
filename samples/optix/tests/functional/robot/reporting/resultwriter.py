...
from robot.result import ExelwtionResult, Result
...
class ResultWriter(object):
    ...
    :param sources: Either one :class:`~robot.result.exelwtionresult.Result`
    ...
    :meth:`write_results` method. The latter is typically more colwenient::
...
class Results(object):
    ...
    def result(self):
        if self._result is None:
            ...
            self._result = ExelwtionResult(include_keywords=include_keywords,
