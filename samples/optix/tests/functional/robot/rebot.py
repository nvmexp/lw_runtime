...
earlier Rebot exelwtions. When more than one input file is given, a new top
...
=======
 ...
 -L --loglevel level      Threshold for selecting messages. Available levels:
    ...
    --starttime timestamp  Set starting time of test exelwtion when creating
    ...
    --endtime timestamp   Same as --starttime but for ending time. If both
                          ...
                          callwlated based on them. For combined suites,
                          it is otherwise callwlated by adding elapsed times
...
# Exelwting `robot.rebot` module using Python and creating combined outputs.
...
class Rebot(RobotFramework):
    ...
    def __init__(self):
        Application.__init__(self, USAGE, arg_limits=(1,),
                             elw_options='REBOT_OPTIONS', logger=LOGGER)
...
def rebot_cli(arguments):
    """Command line exelwtion entry point for running rebot.
