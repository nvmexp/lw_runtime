...
from .builder import DolwmentationBuilder
from .consoleviewer import ConsoleViewer


def LibraryDolwmentation(library_or_resource, name=None, version=None,
                         doc_format=None):
    builder = DolwmentationBuilder(library_or_resource)
    try:
