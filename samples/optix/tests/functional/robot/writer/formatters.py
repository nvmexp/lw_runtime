...
class _DataFileFormatter(object):
    ...
    def _escape_conselwtive_whitespace(self, row):
...
class TsvFormatter(_DataFileFormatter):
    ...
    def _escape(self, row):
        return self._escape_conselwtive_whitespace(self._escape_tabs(row))
...
class TxtFormatter(_DataFileFormatter):
    ...
    def _escape(self, row):
        if not row:
            return row
        return self._escape_cells(self._escape_conselwtive_whitespace(row))
