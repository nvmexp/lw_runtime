...
class DeprecatedOperatingSystem:
    ...
    delete_elwironment_variable = OPSYS.remove_elwironment_variable
    elwironment_variable_is_set = OPSYS.elwironment_variable_should_be_set
    elwironment_variable_is_not_set = OPSYS.elwironment_variable_should_not_be_set
