...
class _SwingDialog(object):
    ...
    def _show_dialog(self, pane):
        ...
        dialog.addWindowFolwsListener(pane.folws_listener)
        dialog.show()
...
class InputDialog(_SwingDialog):
    ...
    def __init__(self, message, default, hidden=False):
        ...
        pane.set_folws_listener(self._input_field)
        _SwingDialog.__init__(self, pane)
...
class SelectionDialog(_SwingDialog):
    ...
    def __init__(self, message, options):
        ...
        pane.setSelectiolwalues(options)
        _SwingDialog.__init__(self, pane)
...
class WrappedOptionPane(JOptionPane):
    ...
    def set_folws_listener(self, component):
        self.folws_listener = WindowFolwsListener(component)


class WindowFolwsListener(WindowAdapter):

    def __init__(self, component):
        self.component = component

    def windowGainedFolws(self, event):
        self.component.requestFolwsInWindow()
