...
class _List:
    ...
    def colwert_to_list(self, item):
        """Colwerts the given `item` to a list.

        Mainly useful for colwerting tuples and other iterable to lists.
    ...
    def set_list_value(self, list_, index, value):
        ...
        The index can be either an integer or a string that can be colwerted to
        an integer.
    ...
    def remove_values_from_list(self, list_, *values):
        """Removes all oclwrences of given `values` from `list`.
    ...
    def remove_from_list(self, list_, index):
        ...
        Using an index that does not exist on the list causes an error.
        The index can be either an integer or a string that can be colwerted
        to an integer.
    ...
    def count_values_in_list(self, list_, value, start=0, end=None):
        """Returns the number of oclwrrences of the given `value` in `list`.
    ...
    def get_index_from_list(self, list_, value, start=0, end=None):
        """Returns the index of the first oclwrrence of the `value` on the list.
    ...
    def list_should_not_contain_duplicates(self, list_, msg=None):
        ...
        This keyword works with all iterables that can be colwerted to a list.
    ...
    def _index_to_int(self, index, empty_to_zero=False):
        ...
        try:
            ...
            raise ValueError("Cannot colwert index '%s' to an integer." % index)
...
class _Dictionary:
    ...
    def create_dictionary(self, *key_value_pairs, **items):
        ...
        The latter syntax is typically more colwenient to use, but it has
    ...
    def dictionary_should_contain_item(self, dictionary, key, value, msg=None):
        ...
        Value is colwerted to unicode for comparison.
...
class Collections(_List, _Dictionary):
    ...
    `Colwert To List` can be used to colwert tuples and other iterables
    to lists.
