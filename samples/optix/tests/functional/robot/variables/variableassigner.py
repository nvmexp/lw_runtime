...
class VariableAssigner(object):
    ...
    def assign(self, context, return_value):
        ...
        if self.scalar_vars or self.list_var:
            self._assign(context, Returlwalue(self.scalar_vars, self.list_var,
                                              return_value))
...
class Returlwalue(object):
    ...
    def get_variables_to_set(self):
        ...
        ret = self._colwert_to_list(self._return)
        if not self._list:
