...
class _RelwrsionAvoidingMetaclass(type):
    """Metaclass to wrap listener methods so that they cannot cause relwrsion.

    Relwrsion would otherwise happen if one listener logs something and that
...
class Listeners(object):
    __metaclass__ = _RelwrsionAvoidingMetaclass
