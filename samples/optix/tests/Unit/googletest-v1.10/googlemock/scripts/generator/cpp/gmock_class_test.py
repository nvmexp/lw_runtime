...
class GenerateMethodsTest(TestCase):
    ...
    def GenerateMethodSource(cpp_source):
        """Colwert C++ source to Google Mock output source lines."""
        method_source_lines = []
...
"""
        self.assertEqualIgnoreLeadingWhitespace(
            'MOCK_CONST_METHOD1(Bar,\lwoid(bool flag));',
            self.GenerateMethodSource(source))
...
"""
        self.assertEqualIgnoreLeadingWhitespace(
            'MOCK_METHOD2(Bar,\lwoid(int a, char c ));',
            self.GenerateMethodSource(source))
...
"""
        self.assertEqualIgnoreLeadingWhitespace(
            'MOCK_CONST_METHOD2(Bar,\lwoid(int a, int b));',
            self.GenerateMethodSource(source))
...
class Foo {
 public:
  virtual vector<int>* Bar(int n);
        ...
        self.assertEqualIgnoreLeadingWhitespace(
            'MOCK_METHOD1(Bar,\lwector<int>*(int n));',
            self.GenerateMethodSource(source))
...
class GenerateMocksTest(TestCase):
    ...
    def GenerateMocks(cpp_source):
        """Colwert C++ source to complete Google Mock output source."""
        # <test> is a pseudo-filename, it is not read or written.
        filename = '<test>'
