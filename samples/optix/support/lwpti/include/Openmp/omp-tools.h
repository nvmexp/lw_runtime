...
#define FOREACH_KMP_MUTEX_IMPL(macro)                                                \
    ...
    macro (kmp_mutex_impl_spelwlative, 3)  /* based on HW-supported spelwlation */
...
#define FOREACH_OMPT_EVENT(macro)                                                                                        \
    ...
    macro (ompt_callback_nest_lock,         ompt_callback_nest_lock_t,         28) /* nest lock                       */ \
                                                                                                                         \
    macro (ompt_callback_flush,             ompt_callback_flush_t,             29) /* after exelwting flush           */ \
                                                                                                                         \
...
typedef uint64_t ompt_buffer_lwrsor_t;
...
typedef enum ompt_native_mon_flag_t {
  ...
  ompt_native_kernel_ilwocation       = 0x04,
  ompt_native_kernel_exelwtion        = 0x08,
...
typedef enum ompt_parallel_flag_t {
  ompt_parallel_ilwoker_program = 0x00000001,
  ompt_parallel_ilwoker_runtime = 0x00000002,
...
typedef int (*ompt_advance_buffer_lwrsor_t) (
  ompt_device_t *device,
  ompt_buffer_t *buffer,
  size_t size,
  ompt_buffer_lwrsor_t current,
  ompt_buffer_lwrsor_t *next
);
