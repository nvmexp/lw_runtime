...
#if !defined(_LWPTI_OPENACC_H_)
#define _LWPTI_OPENACC_H_
 ...
 */
LWptiResult LWPTIAPI
lwptiOpenACCInitialize(void *profRegister, void *profUnregister, void *profLookup);
