 ...
 *
 * The next three colwenience functions are intended to be used as the pfn_notify parameter to clCreateContext().
...
#define CL_ILWALID_EXTERNAL_DEVICEGROUP_REFERENCE_KHR   -1122
#define CL_ILWALID_EXT_MEM_DESC_KHR                     -1123
#define CL_LWRRENT_DEVICE_FOR_EXTERNAL_CONTEXT_KHR      0x2036
...
/******************************************
* cl_lw_device_attribute_query extension *
******************************************/

/* cl_lw_device_attribute_query extension - no extension #define since it has no functions */
#define CL_DEVICE_COMPUTE_CAPABILITY_MAJOR_LW       0x4000
#define CL_DEVICE_COMPUTE_CAPABILITY_MINOR_LW       0x4001
#define CL_DEVICE_REGISTERS_PER_BLOCK_LW            0x4002
#define CL_DEVICE_WARP_SIZE_LW                      0x4003
#define CL_DEVICE_GPU_OVERLAP_LW                    0x4004
#define CL_DEVICE_KERNEL_EXEC_TIMEOUT_LW            0x4005
#define CL_DEVICE_INTEGRATED_MEMORY_LW              0x4006
#define CL_DEVICE_ATTRIBUTE_ASYNC_ENGINE_COUNT_LW   0x4007
#define CL_DEVICE_PCI_BUS_ID_LW                     0x4008
#define CL_DEVICE_PCI_SLOT_ID_LW                    0x4009
#define CL_DEVICE_PCI_DOMAIN_ID_LW                  0x400A
#define CL_DEVICE_MAX_LOCAL_MEMORY_PER_SM_LW        0x400B
...
/******************************************
* cl_lw_create_buffer extension *
******************************************/

typedef cl_bitfield         cl_mem_flags_LW;
CL_API_ENTRY cl_mem CL_API_CALL
clCreateBufferLW(cl_context     context,
               cl_mem_flags     flags,
               cl_mem_flags_LW  flags_LW,
               size_t           size,
               void             *host_ptr,
               cl_int           *errcode_ret);

/******************************************
* cl_kernel_attribute_lw extension *
*******************************************/

typedef enum kernel_attribute_enum {
    CL_KERNEL_PREFERRED_LOCAL_MEMORY_SIZE_LW = 0,   /* setting preferred shared memory size */
} cl_kernel_attribute_lw;

CL_API_ENTRY cl_int CL_API_CALL
clSetKernelAttributeLW(cl_kernel kernel,
                       cl_device_id device,
                       cl_kernel_attribute_lw k_attr,
                       size_t param_value_size,
                       const void *param_value);

CL_API_ENTRY cl_int CL_API_CALL
clGetKernelAttributeLW(cl_kernel kernel,
                       cl_device_id device,
                       cl_kernel_attribute_lw k_attr,
                       size_t param_value_size,
                       void *param_value,
...
#define CL_MEM_LOCATION_HOST_LW                     (1 << 0)
#define CL_MEM_PINNED_LW                            (1 << 1)
...
#define CL_ILWALID_PARTITION_COUNT_EXT              -1058
#define CL_ILWALID_PARTITION_NAME_EXT               -1059
