...
#ifndef LWTOOLSEXT_LWDA_V3
#define LWTOOLSEXT_LWDA_V3
...
*/
#define LWTX_RESOURCE_CLASS_LWDA  4
/** \endcond */

/*  ------------------------------------------------------------------------- */
/** \brief Resource types for LWCA
*/
typedef enum lwtxResourceLWDAType_t
{
    LWTX_RESOURCE_TYPE_LWDA_DEVICE = LWTX_RESOURCE_MAKE_TYPE(LWCA, 1), /* LWdevice */
    LWTX_RESOURCE_TYPE_LWDA_CONTEXT = LWTX_RESOURCE_MAKE_TYPE(LWCA, 2), /* LWcontext */
    LWTX_RESOURCE_TYPE_LWDA_STREAM = LWTX_RESOURCE_MAKE_TYPE(LWCA, 3), /* LWstream */
    LWTX_RESOURCE_TYPE_LWDA_EVENT = LWTX_RESOURCE_MAKE_TYPE(LWCA, 4), /* LWevent */
} lwtxResourceLWDAType_t;
...
#ifndef LWTX_NO_IMPL
#define LWTX_IMPL_GUARD_LWDA /* Ensure other headers cannot included directly */
#include "lwtxDetail/lwtxImplLwda_v3.h"
#undef LWTX_IMPL_GUARD_LWDA
#endif /*LWTX_NO_IMPL*/

#endif /* LWTOOLSEXT_LWDA_V3 */
