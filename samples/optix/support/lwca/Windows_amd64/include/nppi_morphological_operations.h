  ...
  * Users Notice. 
  */ 
#ifndef LW_NPPI_MORPHOLOGICAL_OPERATIONS_H
#define LW_NPPI_MORPHOLOGICAL_OPERATIONS_H
...
/**
 * Callwlate scratch buffer size needed for 1 channel 8-bit unsigned integer MorphCloseBorder, MorphOpenBorder, MorphTopHatBorder, 
...
/**
 * Callwlate scratch buffer size needed for 3 channel 8-bit unsigned integer MorphCloseBorder, MorphOpenBorder, MorphTopHatBorder, 
 * MorphBlackHatBorder or MorphGradientBorder function based on destination image oSizeROI width and height.
 *
 * For common parameter descriptions, see <a href="#CommonMorphGetBufferSizeParameters">Common parameters for nppiMorphGetBufferSize functions</a>.
 *
...
/**
 * Callwlate scratch buffer size needed for 4 channel 8-bit unsigned integer MorphCloseBorder, MorphOpenBorder, MorphTopHatBorder,
 * MorphBlackHatBorder, or MorphGradientBorder function based on destination image oSizeROI width and height.
 *
 * For common parameter descriptions, see <a href="#CommonMorphGetBufferSizeParameters">Common parameters for nppiMorphGetBufferSize functions</a>.
 *
...
/**
 * Callwlate scratch buffer size needed for 1 channel 16-bit unsigned integer MorphCloseBorder, MorphOpenBorder, MorphTopHatBorder,
 * MorphBlackHatBorder, or MorphGradientBorder function based on destination image oSizeROI width and height.
 *
 * For common parameter descriptions, see <a href="#CommonMorphGetBufferSizeParameters">Common parameters for nppiMorphGetBufferSize functions</a>.
 *
...
/**
 * Callwlate scratch buffer size needed for 1 channel 16-bit signed integer MorphCloseBorder, MorphOpenBorder, MorphTopHatBorder,
 * MorphBlackHatBorder, or MorphGradientBorder function based on destination image oSizeROI width and height.
 *
 * For common parameter descriptions, see <a href="#CommonMorphGetBufferSizeParameters">Common parameters for nppiMorphGetBufferSize functions</a>.
 *
...
/**
 * Callwlate scratch buffer size needed for 1 channel 32-bit floating point MorphCloseBorder, MorphOpenBorder, MorphTopHatBorder,
 * MorphBlackHatBorder, or MorphGradientBorder function based on destination image oSizeROI width and height.
 *
 * For common parameter descriptions, see <a href="#CommonMorphGetBufferSizeParameters">Common parameters for nppiMorphGetBufferSize functions</a>.
 *
...
/**
 * Callwlate scratch buffer size needed for 3 channel 32-bit floating point MorphCloseBorder, MorphOpenBorder, MorphTopHatBorder,
 * MorphBlackHatBorder, or MorphGradientBorder function based on destination image oSizeROI width and height.
 *
 * For common parameter descriptions, see <a href="#CommonMorphGetBufferSizeParameters">Common parameters for nppiMorphGetBufferSize functions</a>.
 *
...
/**
 * Callwlate scratch buffer size needed for 4 channel 32-bit floating point MorphCloseBorder, MorphOpenBorder, MorphTopHatBorder,
 * MorphBlackHatBorder, or MorphGradientBorder function based on destination image oSizeROI width and height.
 *
 * For common parameter descriptions, see <a href="#CommonMorphGetBufferSizeParameters">Common parameters for nppiMorphGetBufferSize functions</a>.
 *
...
#endif /* LW_NPPI_MORPHOLOGICAL_OPERATIONS_H */
