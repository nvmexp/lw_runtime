 ...
 * ::lwdaChannelFormatKindUnsigned, lwdaChannelFormatKindFloat or ::lwdaChannelFormatKindLW12.
 *
 * \return
 ...
 * \endcode
 *
 * where ::lwdaChannelFormatKind is one of ::lwdaChannelFormatKindSignedNormalized8X1, ::lwdaChannelFormatKindSignedNormalized8X2, 
 * ::lwdaChannelFormatKindSignedNormalized8X4, ::lwdaChannelFormatKindUnsignedNormalized8X1, ::lwdaChannelFormatKindUnsignedNormalized8X2,
 * ::lwdaChannelFormatKindUnsignedNormalized8X4, ::lwdaChannelFormatKindSignedNormalized16X1,  ::lwdaChannelFormatKindSignedNormalized16X2,
 * ::lwdaChannelFormatKindSignedNormalized16X4, ::lwdaChannelFormatKindUnsignedNormalized16X1,  ::lwdaChannelFormatKindUnsignedNormalized16X2,
 * ::lwdaChannelFormatKindUnsignedNormalized16X4 or ::lwdaChannelFormatKindLW12.
 *
 * \return
 * Channel descriptor with format \p f
 *
