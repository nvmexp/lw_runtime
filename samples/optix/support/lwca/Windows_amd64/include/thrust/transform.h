 ...
 *                        and \c InputIterator's \c value_type is colwertible to \c UnaryFunction's \c argument_type.
 ...
 *                              and \c UnaryFunction's \c result_type is colwertible to \c OutputIterator's \c value_type.
 *
 ...
 *  using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
...
__host__ __device__
  OutputIterator transform(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *                        and \c InputIterator1's \c value_type is colwertible to \c BinaryFunction's \c first_argument_type.
 *  \tparam InputIterator2 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>
 *                        and \c InputIterator2's \c value_type is colwertible to \c BinaryFunction's \c second_argument_type.
 *  \tparam OutputIterator is a model of <a href="http://www.sgi.com/tech/stl/OutputIterator.html">Output Iterator</a>.
 *  \tparam BinaryFunction is a model of <a href="http://www.sgi.com/tech/stl/BinaryFunction.html">Binary Function</a>
 *                              and \c BinaryFunction's \c result_type is colwertible to \c OutputIterator's \c value_type.
 *
 ...
 *  ranges using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
 *  #include <thrust/transform.h>
 *  #include <thrust/functional.h>
 ...
 *  not evaluated and no assignment oclwrs. The input and output sequences may coincide,
 ...
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam InputIterator is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *                        and \c InputIterator's \c value_type is colwertible to \c Predicate's \c argument_type,
 *                        and \c InputIterator's \c value_type is colwertible to \c UnaryFunction's \c argument_type.
 ...
 *  elements of a range using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
 *  #include <thrust/transform.h>
 *  #include <thrust/functional.h>
...
template<typename DerivedPolicy,
         ...
         typename Predicate>
__host__ __device__
  ForwardIterator transform_if(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                               InputIterator first, InputIterator last,
 ...
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam InputIterator1 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>
 *                         and \c InputIterator1's \c value_type is colwertible to \c UnaryFunction's \c argument_type.
 *  \tparam InputIterator2 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>
 *                         and \c InputIterator2's \c value_type is colwertible to \c Predicate's \c argument_type.
 *  \tparam ForwardIterator is a model of <a href="http://www.sgi.com/tech/stl/ForwardIterator.html">Forward Iterator</a>.
 *  \tparam UnaryFunction is a model of <a href="http://www.sgi.com/tech/stl/UnaryFunction.html">Unary Function</a>
 *                        and \c UnaryFunction's \c result_type is colwertible to \c OutputIterator's \c value_type.
 *  \tparam Predicate is a model of <a href="http://www.sgi.com/tech/stl/Predicate.html">Predicate</a>.
