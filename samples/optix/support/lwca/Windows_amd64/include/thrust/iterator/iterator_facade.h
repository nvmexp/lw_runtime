...
class iterator_core_access
{
    ...
    // Facade2 is colwertible to Facade1,
    ...
    // Facade2 is not colwertible to Facade1,
      ...
      distance_from(Facade1 const& f1, Facade2 const& f2)
    {
      ...
      return distance_from(f1, f2,
        typename thrust::detail::is_colwertible<Facade2,Facade1>::type());
    }

    //
    // Lwriously Relwrring Template interface.
    //
