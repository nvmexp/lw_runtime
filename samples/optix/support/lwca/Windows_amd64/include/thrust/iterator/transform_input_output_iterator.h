    ...
    : public detail::transform_input_output_iterator_base<InputFunction, OutputFunction, Iterator>::type
{
   ...
   * \param input_function An \c InputFunction to be exelwted on values read from the iterator
   * \param output_function An \c OutputFunction to be exelwted on values written to the iterator
   */
    __host__ __device__
