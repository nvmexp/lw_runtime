...
// define apply2 for tuple_meta_aclwmulate_impl
...
// ordinary aclwmulation.
//
template<class Tuple, class BinaryMetaFun, class StartType>
  struct tuple_meta_aclwmulate;

template<
    class BinaryMetaFun
  , typename StartType
>
  struct tuple_meta_aclwmulate<thrust::tuple<>,BinaryMetaFun,StartType>
{
...
template<
  ...
  , typename... Ts
>
  struct tuple_meta_aclwmulate<thrust::tuple<T,Ts...>,BinaryMetaFun,StartType>
{
   typedef typename apply2<
       BinaryMetaFun
     , T
     , typename tuple_meta_aclwmulate<
           thrust::tuple<Ts...>
         , BinaryMetaFun
         , StartType 
       >::type
...
struct minimum_traversal_category_in_iterator_tuple
{
  ...
  typedef typename tuple_impl_specific::tuple_meta_aclwmulate<
