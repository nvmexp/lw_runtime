 ...
 *  without either explicitly storing it in memory, or explicitly exelwting the transformation.
 *  Using \p transform_iterator facilitates kernel fusion by deferring the exelwtion
    ...
    : public detail::transform_iterator_base<AdaptableUnaryFunction, Iterator, Reference, Value>::type
{
  ...
  public:
    ...
    transform_iterator(const transform_iterator<OtherAdaptableUnaryFunction, OtherIterator, OtherReference, OtherValue> &other,
                       typename thrust::detail::enable_if_colwertible<OtherIterator, Iterator>::type* = 0,
                       typename thrust::detail::enable_if_colwertible<OtherAdaptableUnaryFunction, AdaptableUnaryFunction>::type* = 0)
  ...
  private:
    ...
    typename super_t::reference dereference() const
    {
      ...
      // colwert to their value type before calling m_f. Note that this
