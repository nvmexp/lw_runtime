  ...
  public:
      ...
      struct result
    {
      typedef typename Eval0::template result<
        thrust::tuple<
          typename Eval1::template result<Elw>::type
        >
      >::type type;
    };
    ...
    template<typename Elw>
    __host__ __device__
    typename result<Elw>::type
    eval(const Elw &x) const
    {
      typename Eval1::template result<Elw>::type result1 = m_eval1.eval(x);
  ...
  public:
      ...
      struct result
    {
      typedef typename Eval0::template result<
        thrust::tuple<
          typename Eval1::template result<Elw>::type,
          typename Eval2::template result<Elw>::type
        >
      >::type type;
    };
    ...
    {
      typename Eval1::template result<Elw>::type result1 = m_eval1.eval(x);
      typename Eval2::template result<Elw>::type result2 = m_eval2.eval(x);
