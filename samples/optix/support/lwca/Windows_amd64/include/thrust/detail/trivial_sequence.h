...
struct _trivial_sequence<Iterator, DerivedPolicy, thrust::detail::true_type>
{
    ...
    __host__ __device__
    _trivial_sequence(thrust::exelwtion_policy<DerivedPolicy> &, Iterator _first, Iterator _last) : first(_first), last(_last)
    {
    }
...
struct _trivial_sequence<Iterator, DerivedPolicy, thrust::detail::false_type>
{
    ...
    __host__ __device__
    _trivial_sequence(thrust::exelwtion_policy<DerivedPolicy> &exec, Iterator first, Iterator last)
  ...
  : detail::_trivial_sequence<Iterator, DerivedPolicy, typename thrust::is_contiguous_iterator<Iterator>::type>
{
    ...
    __host__ __device__
    trivial_sequence(thrust::exelwtion_policy<DerivedPolicy> &exec, Iterator first, Iterator last) : super_t(exec, first, last) { }
};
