...
template<typename DerivedPolicy,
  ...
  RandomAccessIterator2 overlapped_copy(thrust::system::cpp::detail::exelwtion_policy<DerivedPolicy> &,
...
template<typename DerivedPolicy,
         typename RandomAccessIterator1,
         typename RandomAccessIterator2>
  RandomAccessIterator2 overlapped_copy(thrust::exelwtion_policy<DerivedPolicy> &exec,
                                        RandomAccessIterator1 first,
                                        RandomAccessIterator1 last,
                                        RandomAccessIterator2 result)
{
