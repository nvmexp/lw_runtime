...
__host__ __device__
  thrust::pair<thrust::pointer<T,DerivedPolicy>, typename thrust::pointer<T,DerivedPolicy>::difference_type>
    get_temporary_buffer(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec, typename thrust::pointer<T,DerivedPolicy>::difference_type n)
{
  using thrust::detail::get_temporary_buffer; // exelwte_with_allocator
...
__host__ __device__
  void return_temporary_buffer(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec, Pointer p, std::ptrdiff_t n)
{
  using thrust::detail::return_temporary_buffer; // exelwte_with_allocator
