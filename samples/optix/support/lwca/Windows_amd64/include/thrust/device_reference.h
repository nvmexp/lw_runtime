 ...
 *  its referent object oclwrs when passing them as parameters to functions like \c printf
             ...
             >
{
  ...
  public:
    ...
    device_reference(const device_reference<OtherT> &other,
                     typename thrust::detail::enable_if_colwertible<
...
// they actually exist in a derived-from class
    ...
    /*! Colwersion operator colwerts this \p device_reference to T
     ...
     *  \endcode
     *
     *  \note The increment exelwtes as if it were exelwted on the host.
     ...
     *  \endcode
     *
     *  \note The add-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
     ...
     *  \endcode
     *
     *  \note The decrement exelwtes as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator--(void);
     ...
     *  \endcode
     *
     *  \note The subtract-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator-=(const T &rhs);
     ...
     *  \endcode
     *
     *  \note The multiply-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator*=(const T &rhs);
     ...
     *  \endcode
     *
     *  \note The divide-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator/=(const T &rhs);
     ...
     *  \endcode
     *
     *  \note The modulus-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator%=(const T &rhs);
     ...
     *  \endcode
     *
     *  \note The left shift-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator<<=(const T &rhs);
     ...
     *  \endcode
     *
     *  \note The right shift-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator>>=(const T &rhs);
     ...
     *  \endcode
     *
     *  \note The AND-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator&=(const T &rhs);
     ...
     *  \endcode
     *
     *  \note The OR-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator|=(const T &rhs);
     ...
     *  \endcode
     *
     *  \note The XOR-assignment exelwtes as as if it were exelwted on the host.
     *  This may change in a later version.
     */
    device_reference &operator^=(const T &rhs);
