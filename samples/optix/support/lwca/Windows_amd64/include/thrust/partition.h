 ...
 *          and \p ForwardIterator's \c value_type is colwertible to \p Predicate's \c argument_type,
 *          and \p ForwardIterator is mutable.
 *  \tparam Predicate is a model of <a href="http://www.sgi.com/tech/stl/Predicate.html">Predicate</a>.
 *
 *  The following code snippet demonstrates how to use \p partition to reorder a
 *  sequence so that even numbers precede odd numbers using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
...
template<typename DerivedPolicy,
         ...
         typename Predicate>
__host__ __device__
  ForwardIterator partition(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *          and \p InputIterator's \c value_type is colwertible to \p Predicate's \c argument_type.
 *  \tparam Predicate is a model of <a href="http://www.sgi.com/tech/stl/Predicate.html">Predicate</a>.
 *
 ...
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam InputIterator is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          and \p InputIterator's \c value_type is colwertible to \p Predicate's \c argument_type and \p InputIterator's \c value_type
 *          is colwertible to \p OutputIterator1 and \p OutputIterator2's \c value_types.
 ...
 *  sequence into two output sequences of even and odd numbers using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
 *  #include <thrust/partition.h>
 *  #include <thrust/exelwtion_policy.h>
...
__host__ __device__
  thrust::pair<OutputIterator1,OutputIterator2>
    partition_copy(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                   InputIterator first,
                   InputIterator last,
 ...
 *          and \p InputIterator's \c value_type is colwertible to \p OutputIterator1 and \p OutputIterator2's \c value_types.
 *  \tparam InputIterator2 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          and \p InputIterator2's \c value_type is colwertible to \p Predicate's \c argument_type.
 *  \tparam OutputIterator1 is a model of <a href="http://www.sgi.com/tech/stl/OutputIterator.html">Output Iterator</a>.
 *  \tparam OutputIterator2 is a model of <a href="http://www.sgi.com/tech/stl/OutputIterator.html">Output Iterator</a>.
 *  \tparam Predicate is a model of <a href="http://www.sgi.com/tech/stl/Predicate.html">Predicate</a>.
 *
 ...
 *
 *  The following code snippet demonstrates how to use \p partition_copy to separate a
 *  sequence into two output sequences of even and odd numbers using the \p thrust::host exelwtion
...
template<typename DerivedPolicy,
         ...
         typename Predicate>
__host__ __device__
  ForwardIterator stable_partition(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                   ForwardIterator first,
                                   ForwardIterator last,
                                   Predicate pred);
 ...
 *  reorder a sequence so that even numbers precede odd numbers using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
 *  #include <thrust/partition.h>
 *  #include <thrust/exelwtion_policy.h>
...
__host__ __device__
  thrust::pair<OutputIterator1,OutputIterator2>
    stable_partition_copy(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                          InputIterator first,
                          InputIterator last,
                          OutputIterator1 out_true,
                          OutputIterator2 out_false,
...
__host__ __device__
  ForwardIterator partition_point(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                  ForwardIterator first,
                                  ForwardIterator last,
                                  Predicate pred);
...
__host__ __device__
  bool is_partitioned(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                      InputIterator first,
                      InputIterator last,
                      Predicate pred);
