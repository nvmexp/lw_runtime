 ...
 *  of interest from a range using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
...
template<typename DerivedPolicy,
         ...
         typename T>
__host__ __device__
  ForwardIterator remove(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *          and \p InputIterator's \c value_type is colwertible to a type in \p OutputIterator's set of \c value_types.
...
template<typename DerivedPolicy,
         ...
         typename T>
__host__ __device__
  OutputIterator remove_copy(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                             InputIterator first,
                             InputIterator last,
 ...
 *  all even numbers from an array of integers using the \p thrust::host exelwtion policy for
 *  parallelization:
 *
 *  \code
 *  #include <thrust/remove.h>
...
template<typename DerivedPolicy,
         ...
         typename Predicate>
__host__ __device__
  ForwardIterator remove_if(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                            ForwardIterator first,
                            ForwardIterator last,
                            Predicate pred);
 ...
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam InputIterator is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          \p InputIterator's \c value_type is colwertible to a type in \p OutputIterator's set of \c value_types,
...
template<typename DerivedPolicy,
         ...
         typename Predicate>
__host__ __device__
  OutputIterator remove_copy_if(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                InputIterator first,
                                InputIterator last,
                                OutputIterator result,
                                Predicate pred);
 ...
 *
 *  The following code snippet demonstrates how to use \p remove_if to remove
 *  specific elements from an array of integers using the \p thrust::host exelwtion policy for
 *  parallelization:
 *
 *  \code
 *  #include <thrust/remove.h>
 ...
 *
 *  The algorithm's exelwtion policy is parallelized as determined by \p exec.
 *
 *  \param exec The exelwtion policy to use for parallelization.
 *  \param first The beginning of the range of interest.
 *  \param last The end of the range of interest.
 ...
 *          \p InputIterator1's \c value_type is colwertible to a type in \p OutputIterator's set of \c value_types.
