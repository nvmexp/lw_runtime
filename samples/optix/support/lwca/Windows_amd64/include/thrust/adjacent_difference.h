 ...
 *  \brief Compute difference between conselwtive elements of a range
 */
...
/*! \p adjacent_difference callwlates the differences of adjacent elements in the
 ...
 *
 *  This version of \p adjacent_difference uses <tt>operator-</tt> to callwlate
 *  differences.
 *
 ...
 *          and the return type of <tt>x - y</tt> is colwertible to a type in \p OutputIterator's set of \c value_types.
 ...
 *  the difference between adjacent elements of a range using the \p thrust::device exelwtion policy:
 *
 *  \code
...
__host__ __device__
OutputIterator adjacent_difference(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam InputIterator is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          and \p InputIterator's \c value_type is colwertible to \p BinaryFunction's \c first_argument_type and \c second_argument_type,
 *          and \p InputIterator's \c value_type is colwertible to a type in \p OutputIterator's set of \c value_types.
 *  \tparam OutputIterator is a model of <a href="http://www.sgi.com/tech/stl/OutputIterator.html">Output Iterator</a>.
 *  \tparam BinaryFunction's \c result_type is colwertible to a type in \p OutputIterator's set of \c value_types.
 *
 *  \remark Note that \p result is permitted to be the same iterator as \p first. This is
 *          useful for computing differences "in place".
 *
 *  The following code snippet demonstrates how to use \p adjacent_difference to compute
 *  the sum between adjacent elements of a range using the \p thrust::device exelwtion policy:
 *
 *  \code
 *  #include <thrust/adjacent_difference.h>
