 ...
 *  \p merge to compute the merger of two sorted sets of integers using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
...
__host__ __device__
  OutputIterator merge(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *  descending order using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
 *  #include <thrust/merge.h>
 ...
 *  ascending order using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
 *  #include <thrust/merge.h>
 *  #include <thrust/functional.h>
...
__host__ __device__
  thrust::pair<OutputIterator1,OutputIterator2>
    merge_by_key(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *
 *  The algorithm's exelwtion is parallelized using \p exec.
 *
 *  \param exec The exelwtion policy to use for parallelization.
 *  \param keys_first1 The beginning of the first input range of keys.
 *  \param keys_last1 The end of the first input range of keys.
 ...
 *  \tparam InputIterator1 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          \p InputIterator1's \c value_type is colwertable to \p StrictWeakCompare's \c first_argument_type.
 *          and \p InputIterator1's \c value_type is colwertable to a type in \p OutputIterator1's set of \c value_types.
 *  \tparam InputIterator2 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          \p InputIterator2's \c value_type is colwertable to \p StrictWeakCompare's \c second_argument_type.
 *          and \p InputIterator2's \c value_type is colwertable to a type in \p OutputIterator1's set of \c value_types.
 *  \tparam InputIterator3 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          and \p InputIterator3's \c value_type is colwertible to a type in \p OutputIterator2's set of \c value_types.
 *  \tparam InputIterator4 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          and \p InputIterator4's \c value_type is colwertible to a type in \p OutputIterator2's set of \c value_types.
