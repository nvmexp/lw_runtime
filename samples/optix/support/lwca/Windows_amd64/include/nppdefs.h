...
// Workaround for lwda_fp16.h C incompatibility
typedef 
struct
{
   short fp16;
...
typedef struct
{
    ...
    unsigned int nLwrContourPixelIndex;      /**< current index of pixel being added to geometry info list */
...
typedef struct
{
    ...
    int nLwdaDeviceId; /* From lwdaGetDevice() */
    int nMultiProcessorCount; /* From lwdaGetDeviceProperties() */
    int nMaxThreadsPerMultiProcessor; /* From lwdaGetDeviceProperties() */
    int nMaxThreadsPerBlock; /* From lwdaGetDeviceProperties() */
    size_t nSharedMemPerBlock; /* From lwdaGetDeviceProperties */
    int nLwdaDevAttrComputeCapabilityMajor; /* From lwdaGetDeviceAttribute() */
    int nLwdaDevAttrComputeCapabilityMinor; /* From lwdaGetDeviceAttribute() */
    unsigned int nStreamFlags; /* From lwdaStreamGetFlags() */
    int nReserved0;
} NppStreamContext;
