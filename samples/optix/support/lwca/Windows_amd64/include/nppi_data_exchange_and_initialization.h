  ...
  * Users Notice. 
  */ 
#ifndef LW_NPPI_DATA_EXCHANGE_AND_INITIALIZATION_H
#define LW_NPPI_DATA_EXCHANGE_AND_INITIALIZATION_H
 ...
 *  @ingroup nppi
 *
 * Functions for initializing, copying and colwerting image data.
 *
 * @{
 *
 ...
 *
 * \param lwalue The pixel value to be set.
 ...
 */
NppStatus 
nppiSet_8s_C1R_Ctx(const Npp8s lwalue, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_8s_C1R(const Npp8s lwalue, Npp8s * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_8u_C1R_Ctx(const Npp8u lwalue, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_8u_C1R(const Npp8u lwalue, Npp8u * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_16u_C1R_Ctx(const Npp16u lwalue, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_16u_C1R(const Npp16u lwalue, Npp16u * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_16s_C1R_Ctx(const Npp16s lwalue, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_16s_C1R(const Npp16s lwalue, Npp16s * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_32s_C1R_Ctx(const Npp32s lwalue, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_32s_C1R(const Npp32s lwalue, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_32u_C1R_Ctx(const Npp32u lwalue, Npp32u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_32u_C1R(const Npp32u lwalue, Npp32u * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_16f_C1R_Ctx(const Npp32f lwalue, Npp16f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_16f_C1R(const Npp32f lwalue, Npp16f * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_32f_C1R_Ctx(const Npp32f lwalue, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_32f_C1R(const Npp32f lwalue, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 *
 * \param lwalue The pixel value to be set for single channel functions.
 ...
 */
NppStatus 
nppiSet_8u_C1MR_Ctx(Npp8u lwalue, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_8u_C1MR(Npp8u lwalue, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep);
 ...
 */
NppStatus 
nppiSet_16u_C1MR_Ctx(Npp16u lwalue, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_16u_C1MR(Npp16u lwalue, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep);
 ...
 */
NppStatus 
nppiSet_16s_C1MR_Ctx(Npp16s lwalue, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_16s_C1MR(Npp16s lwalue, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep);
 ...
 */
NppStatus 
nppiSet_32s_C1MR_Ctx(Npp32s lwalue, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_32s_C1MR(Npp32s lwalue, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep);
 ...
 */
NppStatus 
nppiSet_32f_C1MR_Ctx(Npp32f lwalue, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_32f_C1MR(Npp32f lwalue, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, const Npp8u * pMask, int nMaskStep);
 ...
 */
NppStatus 
nppiSet_8u_C3CR_Ctx(Npp8u lwalue, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_8u_C3CR(Npp8u lwalue, Npp8u * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_8u_C4CR_Ctx(Npp8u lwalue, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_8u_C4CR(Npp8u lwalue, Npp8u * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_16u_C3CR_Ctx(Npp16u lwalue, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_16u_C3CR(Npp16u lwalue, Npp16u * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_16u_C4CR_Ctx(Npp16u lwalue, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_16u_C4CR(Npp16u lwalue, Npp16u * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_16s_C3CR_Ctx(Npp16s lwalue, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_16s_C3CR(Npp16s lwalue, Npp16s * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_16s_C4CR_Ctx(Npp16s lwalue, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_16s_C4CR(Npp16s lwalue, Npp16s * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_32s_C3CR_Ctx(Npp32s lwalue, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_32s_C3CR(Npp32s lwalue, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_32s_C4CR_Ctx(Npp32s lwalue, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_32s_C4CR(Npp32s lwalue, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_32f_C3CR_Ctx(Npp32f lwalue, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_32f_C3CR(Npp32f lwalue, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 */
NppStatus 
nppiSet_32f_C4CR_Ctx(Npp32f lwalue, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiSet_32f_C4CR(Npp32f lwalue, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);
 ...
 * \param lwalue The pixel value to be set for border pixels for single channel functions.
...
NppStatus nppiCopyConstBorder_8u_C1R_Ctx(const Npp8u * pSrc,   int nSrcStep, NppiSize oSrcSizeROI,
                                         ...
                                         Npp8u lwalue, NppStreamContext nppStreamCtx);
...
NppStatus nppiCopyConstBorder_16u_C1R_Ctx(const Npp16u * pSrc,  int nSrcStep, NppiSize oSrcSizeROI,
                                          ...
                                          int nTopBorderHeight, int nLeftBorderWidth,
                                          Npp16u lwalue, NppStreamContext nppStreamCtx);
...
NppStatus nppiCopyConstBorder_16s_C1R_Ctx(const Npp16s * pSrc,  int nSrcStep, NppiSize oSrcSizeROI,
                                          ...
                                          int nTopBorderHeight, int nLeftBorderWidth,
                                          Npp16s lwalue, NppStreamContext nppStreamCtx);
...
NppStatus nppiCopyConstBorder_32s_C1R_Ctx(const Npp32s * pSrc,  int nSrcStep, NppiSize oSrcSizeROI,
                                          ...
                                          int nTopBorderHeight, int nLeftBorderWidth,
                                          Npp32s lwalue, NppStreamContext nppStreamCtx);
...
NppStatus nppiCopyConstBorder_32f_C1R_Ctx(const Npp32f * pSrc,  int nSrcStep, NppiSize oSrcSizeROI,
                                          ...
                                          int nTopBorderHeight, int nLeftBorderWidth,
                                          Npp32f lwalue, NppStreamContext nppStreamCtx);
...
/** 
 * @defgroup image_colwert Colwert Bit Depth
 * Functions for colwerting bit depth without scaling.
 *
 * @{
 *
 */
...
/** 
 * @defgroup image_colwert_increase Colwert To Increased Bit Depth
 * The integer colwersion methods do not involve any scaling. Also, even when increasing the bit-depth
 * loss of information may occur:
 * - When colwerting integers (e.g. Npp32u) to float (e.g. Npp32f) integer value not aclwrately representable 
 *   by the float are rounded to the closest floating-point value.
 * - When colwerting signed integers to unsigned integers all negative values are lost (saturated to 0).
 *  
 ...
 *  
 * <h3><a name="CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions include:</a></h3>
 *
 * \param pSrc \ref source_image_pointer.
 * \param nSrcStep \ref source_image_line_step.
 * \param pDst \ref destination_image_pointer.
...
/** 
 * Single channel 8-bit unsigned to 16-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u16u_C1R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u16u_C1R(const Npp8u  * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 8-bit unsigned to 16-bit unsigned  colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u16u_C3R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u16u_C3R(const Npp8u  * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit unsigned to 16-bit unsigned  colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u16u_C4R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u16u_C4R(const Npp8u  * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit unsigned to 16-bit unsigned colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u16u_AC4R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u16u_AC4R(const Npp8u  * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 8-bit unsigned to 16-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u16s_C1R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u16s_C1R(const Npp8u  * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 8-bit unsigned to 16-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u16s_C3R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u16s_C3R(const Npp8u  * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit unsigned to 16-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u16s_C4R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u16s_C4R(const Npp8u  * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit unsigned to 16-bit signed colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u16s_AC4R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u16s_AC4R(const Npp8u  * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 8-bit unsigned to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u32s_C1R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u32s_C1R(const Npp8u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 8-bit unsigned to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u32s_C3R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u32s_C3R(const Npp8u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit unsigned to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u32s_C4R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u32s_C4R(const Npp8u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit unsigned to 32-bit signed colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u32s_AC4R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u32s_AC4R(const Npp8u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 8-bit unsigned to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u32f_C1R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u32f_C1R(const Npp8u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 8-bit unsigned to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u32f_C3R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u32f_C3R(const Npp8u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit unsigned to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u32f_C4R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u32f_C4R(const Npp8u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit unsigned to 32-bit floating-point colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u32f_AC4R_Ctx(const Npp8u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u32f_AC4R(const Npp8u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 8-bit signed to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s32s_C1R_Ctx(const Npp8s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s32s_C1R(const Npp8s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 8-bit signed to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s32s_C3R_Ctx(const Npp8s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s32s_C3R(const Npp8s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit signed to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s32s_C4R_Ctx(const Npp8s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s32s_C4R(const Npp8s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit signed to 32-bit signed colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s32s_AC4R_Ctx(const Npp8s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s32s_AC4R(const Npp8s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 8-bit signed to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s32f_C1R_Ctx(const Npp8s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s32f_C1R(const Npp8s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 8-bit signed to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s32f_C3R_Ctx(const Npp8s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s32f_C3R(const Npp8s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit signed to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s32f_C4R_Ctx(const Npp8s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s32f_C4R(const Npp8s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 8-bit signed to 32-bit floating-point colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s32f_AC4R_Ctx(const Npp8s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s32f_AC4R(const Npp8s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 16-bit unsigned to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u32s_C1R_Ctx(const Npp16u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u32s_C1R(const Npp16u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 16-bit unsigned to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u32s_C3R_Ctx(const Npp16u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u32s_C3R(const Npp16u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit unsigned to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u32s_C4R_Ctx(const Npp16u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u32s_C4R(const Npp16u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit unsigned to 32-bit signed colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u32s_AC4R_Ctx(const Npp16u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u32s_AC4R(const Npp16u  * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 16-bit unsigned to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u32f_C1R_Ctx(const Npp16u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u32f_C1R(const Npp16u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 16-bit unsigned to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u32f_C3R_Ctx(const Npp16u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u32f_C3R(const Npp16u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit unsigned to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u32f_C4R_Ctx(const Npp16u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u32f_C4R(const Npp16u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit unsigned to 32-bit floating-point colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u32f_AC4R_Ctx(const Npp16u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u32f_AC4R(const Npp16u  * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 16-bit signed to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s32s_C1R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s32s_C1R(const Npp16s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 16-bit signed to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s32s_C3R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s32s_C3R(const Npp16s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit signed to 32-bit signed colwersion.
 * 
 */
NppStatus 
nppiColwert_16s32s_C4R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s32s_C4R(const Npp16s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit signed to 32-bit signed colwersion, not affecting Alpha.
 * 
  * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
*/
NppStatus 
nppiColwert_16s32s_AC4R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s32s_AC4R(const Npp16s * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 16-bit signed to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s32f_C1R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s32f_C1R(const Npp16s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 16-bit signed to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s32f_C3R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s32f_C3R(const Npp16s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit signed to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s32f_C4R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s32f_C4R(const Npp16s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit signed to 32-bit floating-point colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s32f_AC4R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s32f_AC4R(const Npp16s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 16-bit floating-point to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16f32f_C1R_Ctx(const Npp16f * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16f32f_C1R(const Npp16f * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 16-bit floating-point to 32-bit floating-point colwersion. 
 *  
 * Note that all pointers and step sizes for images with 16f (Npp16f) data types perform best when they are at least 16 byte aligned 
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 ...
 */
NppStatus 
nppiColwert_16f32f_C3R_Ctx(const Npp16f * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16f32f_C3R(const Npp16f * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit floating-point to 32-bit floating-point colwersion.
 *  
 * Note that all pointers and step sizes for images with 16f (Npp16f) data types perform best when they are at least 16 byte aligned. 
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 ...
 */
NppStatus 
nppiColwert_16f32f_C4R_Ctx(const Npp16f * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16f32f_C4R(const Npp16f * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit floating-point to 32-bit floating-point colwersion, not affecting Alpha.
 *  
 * Note that all pointers and step sizes for images with 16f (Npp16f) data types perform best when they are at least 16 byte aligned. 
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 ...
 */
NppStatus 
nppiColwert_16f32f_AC4R_Ctx(const Npp16f * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16f32f_AC4R(const Npp16f * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 8-bit signed to 8-bit unsigned colwersion with saturation.
 *  
 * Note that all pointers and step sizes for images with 16f (Npp16f) data types perform best when they are at least 16 byte aligned. 
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 ...
 */
NppStatus 
nppiColwert_8s8u_C1Rs_Ctx(const Npp8s * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s8u_C1Rs(const Npp8s * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 8-bit signed to 16-bit unsigned colwersion with saturation.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s16u_C1Rs_Ctx(const Npp8s * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s16u_C1Rs(const Npp8s * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 8-bit signed to 16-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s16s_C1R_Ctx(const Npp8s * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s16s_C1R(const Npp8s * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 8-bit signed to 32-bit unsigned colwersion with saturation.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8s32u_C1Rs_Ctx(const Npp8s * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8s32u_C1Rs(const Npp8s * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 16-bit signed to 16-bit unsigned colwersion with saturation.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s16u_C1Rs_Ctx(const Npp16s * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s16u_C1Rs(const Npp16s * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 16-bit signed to 32-bit unsigned colwersion with saturation.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s32u_C1Rs_Ctx(const Npp16s * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s32u_C1Rs(const Npp16s * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 16-bit unsigned to 32-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u32u_C1R_Ctx(const Npp16u * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u32u_C1R(const Npp16u * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI);


/** 
 * Single channel 32-bit signed to 32-bit unsigned colwersion with saturation.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32s32u_C1Rs_Ctx(const Npp32s * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32s32u_C1Rs(const Npp32s * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 32-bit signed to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32s32f_C1R_Ctx(const Npp32s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32s32f_C1R(const Npp32s * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Single channel 32-bit unsigned to 32-bit floating-point colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToIncreasedBitDepthParameters">Common parameters for nppiColwert to increased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32u32f_C1R_Ctx(const Npp32u * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32u32f_C1R(const Npp32u * pSrc, int nSrcStep, Npp32f * pDst, int nDstStep, NppiSize oSizeROI);

/** @} image_colwert_increase */

/** 
 * @defgroup image_colwert_decrease Colwert To Decreased Bit Depth
 * The integer colwersion methods do not involve any scaling. When colwerting floating-point values
 * to integers the user may choose the most appropriate rounding-mode. Typically information is lost when
 * colwerting to lower bit depth:
 * - All colwerted values are saturated to the destination type's range. E.g. any values larger than
 *   the largest value of the destination type are clamped to the destination's maximum.
 * - Colwerting floating-point values to integer also ilwolves rounding, effectively loosing all
 *   fractional value information in the process.
 *  
 * Note that all pointers and step sizes for images with 16f (Npp16f) data types perform best when they are at least 16 byte aligned. 
 *
 * <h3><a name="CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions include:</a></h3>
 *
 * \param pSrc \ref source_image_pointer.
 * \param nSrcStep \ref source_image_line_step.
 * \param pDst \ref destination_image_pointer.
...
/** 
 * Single channel 16-bit unsigned to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u8u_C1R_Ctx(const Npp16u * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u8u_C1R(const Npp16u * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Three channel 16-bit unsigned to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u8u_C3R_Ctx(const Npp16u * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u8u_C3R(const Npp16u * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit unsigned to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u8u_C4R_Ctx(const Npp16u * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u8u_C4R(const Npp16u * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit unsigned to 8-bit unsigned colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u8u_AC4R_Ctx(const Npp16u * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);
          
NppStatus 
nppiColwert_16u8u_AC4R(const Npp16u * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);
          
/** 
 * Single channel 16-bit signed to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s8u_C1R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);
          
NppStatus 
nppiColwert_16s8u_C1R(const Npp16s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);
          
/** 
 * Three channel 16-bit signed to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s8u_C3R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s8u_C3R(const Npp16s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit signed to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s8u_C4R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s8u_C4R(const Npp16s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 16-bit signed to 8-bit unsigned colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus
nppiColwert_16s8u_AC4R_Ctx(const Npp16s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);
          
NppStatus
nppiColwert_16s8u_AC4R(const Npp16s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);
          
/** 
 * Single channel 32-bit signed to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32s8u_C1R_Ctx(const Npp32s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);
          
NppStatus 
nppiColwert_32s8u_C1R(const Npp32s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);
          
/** 
 * Three channel 32-bit signed to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32s8u_C3R_Ctx(const Npp32s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32s8u_C3R(const Npp32s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 32-bit signed to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32s8u_C4R_Ctx(const Npp32s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32s8u_C4R(const Npp32s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 32-bit signed to 8-bit unsigned colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus
nppiColwert_32s8u_AC4R_Ctx(const Npp32s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);
          
NppStatus
nppiColwert_32s8u_AC4R(const Npp32s * pSrc, int nSrcStep, Npp8u  * pDst, int nDstStep, NppiSize oSizeROI);
          
/** 
 * Single channel 32-bit signed to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32s8s_C1R_Ctx(const Npp32s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);
          
NppStatus 
nppiColwert_32s8s_C1R(const Npp32s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI);
          
/** 
 * Three channel 32-bit signed to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32s8s_C3R_Ctx(const Npp32s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32s8s_C3R(const Npp32s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 32-bit signed to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32s8s_C4R_Ctx(const Npp32s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32s8s_C4R(const Npp32s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI);

/** 
 * Four channel 32-bit signed to 8-bit signed colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus
nppiColwert_32s8s_AC4R_Ctx(const Npp32s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppStreamContext nppStreamCtx);
          
NppStatus
nppiColwert_32s8s_AC4R(const Npp32s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI);
          
/** 
 * Single channel 8-bit unsigned to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_8u8s_C1RSfs_Ctx(const Npp8u * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_8u8s_C1RSfs(const Npp8u * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 16-bit unsigned to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u8s_C1RSfs_Ctx(const Npp16u * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u8s_C1RSfs(const Npp16u * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 16-bit signed to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16s8s_C1RSfs_Ctx(const Npp16s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16s8s_C1RSfs(const Npp16s * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 16-bit unsigned to 16-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_16u16s_C1RSfs_Ctx(const Npp16u * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_16u16s_C1RSfs(const Npp16u * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 32-bit unsigned to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32u8u_C1RSfs_Ctx(const Npp32u * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32u8u_C1RSfs(const Npp32u * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 32-bit unsigned to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32u8s_C1RSfs_Ctx(const Npp32u * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32u8s_C1RSfs(const Npp32u * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 32-bit unsigned to 16-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32u16u_C1RSfs_Ctx(const Npp32u * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32u16u_C1RSfs(const Npp32u * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 32-bit unsigned to 16-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32u16s_C1RSfs_Ctx(const Npp32u * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32u16s_C1RSfs(const Npp32u * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 32-bit unsigned to 32-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32u32s_C1RSfs_Ctx(const Npp32u * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32u32s_C1RSfs(const Npp32u * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);
 ...
 */
NppStatus 
nppiColwert_32s16u_C1RSfs_Ctx(const Npp32s * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32s16u_C1RSfs(const Npp32s * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);
 ...
 */
NppStatus 
nppiColwert_32s16s_C1RSfs_Ctx(const Npp32s * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32s16s_C1RSfs(const Npp32s * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 32-bit floating point to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f8u_C1R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8u_C1R(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Three channel 32-bit floating point to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f8u_C3R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8u_C3R(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Four channel 32-bit floating point to 8-bit unsigned colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f8u_C4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8u_C4R(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Four channel 32-bit floating point to 8-bit unsigned colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f8u_AC4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8u_AC4R(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Single channel 32-bit floating point to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f8s_C1R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8s_C1R(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Three channel 32-bit floating point to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f8s_C3R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8s_C3R(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Four channel 32-bit floating point to 8-bit signed colwersion.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f8s_C4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8s_C4R(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Four channel 32-bit floating point to 8-bit signed colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f8s_AC4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8s_AC4R(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Single channel 32-bit floating point to 16-bit unsigned colwersion.
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f16u_C1R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16u_C1R(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Three channel 32-bit floating point to 16-bit unsigned colwersion.
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f16u_C3R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16u_C3R(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Four channel 32-bit floating point to 16-bit unsigned colwersion.
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f16u_C4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16u_C4R(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Four channel 32-bit floating point to 16-bit unsigned colwersion, not affecting Alpha.
 * 
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f16u_AC4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16u_AC4R(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Single channel 32-bit floating point to 16-bit signed colwersion.
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f16s_C1R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16s_C1R(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Three channel 32-bit floating point to 16-bit signed colwersion.
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f16s_C3R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16s_C3R(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Four channel 32-bit floating point to 16-bit signed colwersion.
 *
  * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
*/
NppStatus 
nppiColwert_32f16s_C4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16s_C4R(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Four channel 32-bit floating point to 16-bit floating-point colwersion.
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f16s_AC4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16s_AC4R(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Single channel 32-bit floating point to 16-bit floating-point colwersion.
 *  
 * Note that all pointers and step sizes for images with 16f (Npp16f) data types perform best when they are at least 16 byte aligned. 
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 ...
 */
NppStatus 
nppiColwert_32f16f_C1R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16f * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16f_C1R(const Npp32f * pSrc, int nSrcStep, Npp16f * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);

/** 
 * Three channel 32-bit floating point to 16-bit floating-point colwersion.
 *  
 * Note that all pointers and step sizes for images with 16f (Npp16f) data types perform best when they are at least 16 byte aligned. 
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 ...
 */
NppStatus 
nppiColwert_32f16f_C3R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16f * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16f_C3R(const Npp32f * pSrc, int nSrcStep, Npp16f * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);
...
*/
NppStatus 
nppiColwert_32f16f_C4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16f * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16f_C4R(const Npp32f * pSrc, int nSrcStep, Npp16f * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);
 ...
 */
NppStatus 
nppiColwert_32f16f_AC4R_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16f * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16f_AC4R(const Npp32f * pSrc, int nSrcStep, Npp16f * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode);
 ...
 */
NppStatus 
nppiColwert_32f8u_C1RSfs_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8u_C1RSfs(const Npp32f * pSrc, int nSrcStep, Npp8u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);
 ...
 */
NppStatus 
nppiColwert_32f8s_C1RSfs_Ctx(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f8s_C1RSfs(const Npp32f * pSrc, int nSrcStep, Npp8s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);
 ...
 */
NppStatus 
nppiColwert_32f16u_C1RSfs_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16u_C1RSfs(const Npp32f * pSrc, int nSrcStep, Npp16u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);
 ...
 */
NppStatus 
nppiColwert_32f16s_C1RSfs_Ctx(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f16s_C1RSfs(const Npp32f * pSrc, int nSrcStep, Npp16s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 32-bit floating point to 32-bit unsigned colwersion.
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f32u_C1RSfs_Ctx(const Npp32f * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f32u_C1RSfs(const Npp32f * pSrc, int nSrcStep, Npp32u * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** 
 * Single channel 32-bit floating point to 32-bit signed colwersion.
 *
 * For common parameter descriptions, see <a href="#CommonImageColwertToDecreasedBitDepthParameters">Common parameters for nppiColwert to decreased bit depth functions</a>.
 *
 */
NppStatus 
nppiColwert_32f32s_C1RSfs_Ctx(const Npp32f * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppiColwert_32f32s_C1RSfs(const Npp32f * pSrc, int nSrcStep, Npp32s * pDst, int nDstStep, NppiSize oSizeROI, NppRoundMode eRoundMode, int nScaleFactor);

/** @} image_colwert_decrease */
 ...
 *
 * For colwersions between integer data types, the entire integer numeric range of the input data type is mapped onto 
 * the entire integer numeric range of the output data type.
 *
 * For colwersions to floating point data types the floating point data range is defined by the user supplied floating point values
 ...
 * callwlations and also as the saturation values to which output data is clamped.
 *
 * When colwerting from floating-point values to integer values, nMax and nMin are used as the srcMaxRangeValue and srcMinRangeValue
 * respectively in the scaleFactor and dstPixelValue callwlations. Output values are saturated and clamped to the full output integer
 * pixel value range.
 *
 ...
 * \param nDstStep \ref destination_image_line_step.
 * \param oSizeROI \ref roi_specification.
 * \param hint algorithm performance or accuracy selector, lwrrently ignored
 * \param nMin specifies the minimum saturation value to which every output value will be clamped.
 * \param nMax specifies the maximum saturation value to which every output value will be clamped.
 * \param nppStreamCtx \ref application_managed_stream_context. 
 * \return \ref image_data_error_codes, \ref roi_error_codes, ::NPP_SCALE_RANGE_ERROR indicates an error condition if nMax <= nMin.
 ...
 *      the output image. E.g. Given an RGB image, aDstOrder = [2,1,0] colwerts this to BGR
 *      channel order.
 * \param nppStreamCtx \ref application_managed_stream_context. 
 * \return \ref image_data_error_codes, \ref roi_error_codes
 */
 ...
 * \param aDstOrder Host memory integer array describing how channel values are permutated. The n-th entry
 *      of the array contains the number of the channel that is stored in the n-th channel of
 *      the output image. E.g. Given an RGBA image, aDstOrder = [2,1,0] colwerts this to a 3 channel BGR
 *      channel order.
 * \param nppStreamCtx \ref application_managed_stream_context. 
 * \return \ref image_data_error_codes, \ref roi_error_codes
 */
 ...
 * \param aDstOrder Host memory integer array describing how channel values are permutated. The n-th entry
 *      of the array contains the number of the channel that is stored in the n-th channel of
 *      the output image. E.g. Given an ARGB image, aDstOrder = [3,2,1,0] colwerts this to BGRA
 *      channel order.
 * \param nppStreamCtx \ref application_managed_stream_context. 
 * \return \ref image_data_error_codes, \ref roi_error_codes
 */
 ...
 * \param aDstOrder Host memory integer array describing how channel values are permutated. The n-th entry
 *      of the array contains the number of the channel that is stored in the n-th channel of
 *      the output image. E.g. Given an RGB image, aDstOrder = [3,2,1,0] colwerts this to VBGR
 *      channel order.
 * \param lwalue (V) Single channel constant value that can be replicated in one or more of the 4 destination channels.
 *      lwalue is either written or not written to a particular channel depending on the aDstOrder entry for that destination
 *      channel. An aDstOrder value of 3 will output lwalue to that channel, an aDstOrder value greater than 3 will leave that
 *      particular destination channel value unmodified.
 * \param nppStreamCtx \ref application_managed_stream_context. 
 * \return \ref image_data_error_codes, \ref roi_error_codes
 */
NppStatus nppiSwapChannels_8u_C3C4R_Ctx(const Npp8u * pSrc, int nSrcStep, 
                                              Npp8u * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp8u lwalue, NppStreamContext nppStreamCtx);

NppStatus nppiSwapChannels_8u_C3C4R(const Npp8u * pSrc, int nSrcStep, 
                                          Npp8u * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp8u lwalue);
 ...
 *      channel order.
 *      of the array contains the number of the channel that is stored in the n-th channel of
 *      the output image. E.g. Given an RGBA image, aDstOrder = [2,1,0] colwerts this to BGRA
...
NppStatus nppiSwapChannels_16u_C3C4R_Ctx(const Npp16u * pSrc, int nSrcStep, 
                                               Npp16u * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp16u lwalue, NppStreamContext nppStreamCtx);

NppStatus nppiSwapChannels_16u_C3C4R(const Npp16u * pSrc, int nSrcStep, 
                                           Npp16u * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp16u lwalue);
...
NppStatus nppiSwapChannels_16s_C3C4R_Ctx(const Npp16s * pSrc, int nSrcStep, 
                                               Npp16s * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp16s lwalue, NppStreamContext nppStreamCtx);

NppStatus nppiSwapChannels_16s_C3C4R(const Npp16s * pSrc, int nSrcStep, 
                                           Npp16s * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp16s lwalue);
...
NppStatus nppiSwapChannels_32s_C3C4R_Ctx(const Npp32s * pSrc, int nSrcStep, 
                                               Npp32s * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp32s lwalue, NppStreamContext nppStreamCtx);

NppStatus nppiSwapChannels_32s_C3C4R(const Npp32s * pSrc, int nSrcStep, 
                                           Npp32s * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp32s lwalue);
...
NppStatus nppiSwapChannels_32f_C3C4R_Ctx(const Npp32f * pSrc, int nSrcStep, 
                                               Npp32f * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp32f lwalue, NppStreamContext nppStreamCtx);

NppStatus nppiSwapChannels_32f_C3C4R(const Npp32f * pSrc, int nSrcStep, 
                                           Npp32f * pDst, int nDstStep, NppiSize oSizeROI, const int aDstOrder[4], const Npp32f lwalue);
...
#endif /* LW_NPPI_DATA_EXCHANGE_AND_INITIALIZATION_H */
