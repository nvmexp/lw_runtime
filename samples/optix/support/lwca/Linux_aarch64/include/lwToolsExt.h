...
/**
 * Size of the lwtxInitializationAttributes_t structure.
 */
#define LWTX_INITIALIZATION_ATTRIB_STRUCT_SIZE ( (uint16_t)( sizeof(lwtxInitializationAttributes_t) ) )
...
*
*/
typedef struct lwtxStringHandle* lwtxStringHandle_t;
...
*
*/
typedef struct lwtxDomainHandle* lwtxDomainHandle_t;
...
* ------------------------------------------------------------------------- */
typedef enum lwtxInitializationMode_t
{
    LWTX_INITIALIZATION_MODE_UNKNOWN = 0,   /**< A platform that supports indirect initialization will attempt this style, otherwise expect failure. */
    LWTX_INITIALIZATION_MODE_CALLBACK_V1 = 1,   /**< A function pointer conforming to LWTX_VERSION=1 will be used. */
    LWTX_INITIALIZATION_MODE_CALLBACK_V2 = 2,   /**< A function pointer conforming to LWTX_VERSION=2 will be used. */
    LWTX_INITIALIZATION_MODE_SIZE
} lwtxInitializationMode_t;
...
* LWTX_INITIALIZATION_ATTRIB_STRUCT_SIZE may be used for the size.
*
* It is recommended that the caller use one of the following to methods
* to initialize the event attributes structure:
*
* \par Method 1: Initializing lwtxInitializationAttributes_t for future compatibility
* \code
* lwtxInitializationAttributes_t initAttribs = {0};
* initAttribs.version = LWTX_VERSION;
* initAttribs.size = LWTX_INITIALIZATION_ATTRIB_STRUCT_SIZE;
* \endcode
*
* \par Method 2: Initializing lwtxInitializationAttributes_t for a specific version
* \code
* lwtxInitializationAttributes_t initAttribs = {0};
* initAttribs.version =2;
* initAttribs.size = (uint16_t)(sizeof(lwtxInitializationAttributes_v2));
* \endcode
*
...
* LWTX_INITIALIZATION_ATTRIB_STRUCT_SIZE (Method 1) or use explicit values
...
* initAttribs.mode = LWTX_INITIALIZATION_MODE_CALLBACK_V2;
* initAttribs.fnptr = InitializeInjectionLwtx2;
* \endcode
...
* ::lwtxInitialize
*/
typedef struct lwtxInitializationAttributes_v2
{
    /**
    ...
    *
    * Default Value is LWTX_INITIALIZATION_MODE_UNKNOWN = 0
    * \sa
    * ::lwtxInitializationMode_t
    */
    uint32_t mode;
    ...
    * LWTX_INITIALIZATION_MODE_CALLBACK_V# for this to be used.  The mode
    ...
    *
    * Default Value is LWTX_INITIALIZATION_MODE_UNKNOWN which will either
...
} lwtxInitializationAttributes_v2;

typedef struct lwtxInitializationAttributes_v2 lwtxInitializationAttributes_t;


/* ------------------------------------------------------------------------- */
/** \brief Force initialization (optional on most platforms)
*
* Force LWTX library to initialize.  On some platform LWTX will implicit initialize
* upon the first function call into an LWTX API.
*
* \return Result codes are simplest to assume LWTX_SUCCESS or !LWTX_SUCCESS
*
* \param initAttrib - The initialization attribute structure
*
* \sa
* ::lwtxInitializationAttributes_t
*
* \version \LWTX_VERSION_2
* @{ */
LWTX_DECLSPEC int LWTX_API lwtxInitialize(const lwtxInitializationAttributes_t* initAttrib);
/** @} */
