  ...
  * Users Notice. 
  */ 
#ifndef LW_NPPS_SUPPORT_FUNCTIONS_H
#define LW_NPPS_SUPPORT_FUNCTIONS_H
 ...
 * LWCA device-memory pointers can be passed to NPP primitives. 
 *
 * @{
 */
 ...
 *         that an error oclwrred during allocation.
 */
Npp8u * 
...
#endif /* LW_NPPS_SUPPORT_FUNCTIONS_H */
