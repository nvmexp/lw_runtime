...
//
// lwfftXtWorkAreaPolicy specifies policy for lwfftXtSetWorkAreaPolicy
//
typedef enum lwfftXtWorkAreaPolicy_t {
    LWFFT_WORKAREA_MINIMAL = 0, /* maximum reduction */
    LWFFT_WORKAREA_USER = 1, /* use workSize parameter as limit */
    LWFFT_WORKAREA_PERFORMANCE = 2, /* default - 1x overhead or more, maximum performance */
} lwfftXtWorkAreaPolicy;
...
lwfftResult LWFFTAPI lwfftXtSetWorkAreaPolicy(lwfftHandle plan, lwfftXtWorkAreaPolicy policy, size_t *workSize);
