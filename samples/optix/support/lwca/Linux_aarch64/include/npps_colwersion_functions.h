 ...
 *  @ingroup npps
 * Functions that provide colwersion and threshold operations
 * @{
 *
 */

/** @defgroup signal_colwert Colwert
 * The set of colwersion operations available in the library
 * @{
 *
 */
...
NppStatus 
nppsColwert_8s16s_Ctx(const Npp8s * pSrc, Npp16s * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_8s16s(const Npp8s * pSrc, Npp16s * pDst, int nLength);

NppStatus 
nppsColwert_8s32f_Ctx(const Npp8s * pSrc, Npp32f * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_8s32f(const Npp8s * pSrc, Npp32f * pDst, int nLength);

NppStatus 
nppsColwert_8u32f_Ctx(const Npp8u * pSrc, Npp32f * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_8u32f(const Npp8u * pSrc, Npp32f * pDst, int nLength);

NppStatus 
nppsColwert_16s8s_Sfs_Ctx(const Npp16s * pSrc, Npp8s * pDst, Npp32u nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_16s8s_Sfs(const Npp16s * pSrc, Npp8s * pDst, Npp32u nLength, NppRoundMode eRoundMode, int nScaleFactor);

NppStatus 
nppsColwert_16s32s_Ctx(const Npp16s * pSrc, Npp32s * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_16s32s(const Npp16s * pSrc, Npp32s * pDst, int nLength);

NppStatus 
nppsColwert_16s32f_Ctx(const Npp16s * pSrc, Npp32f * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_16s32f(const Npp16s * pSrc, Npp32f * pDst, int nLength);

NppStatus 
nppsColwert_16u32f_Ctx(const Npp16u * pSrc, Npp32f * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_16u32f(const Npp16u * pSrc, Npp32f * pDst, int nLength);

NppStatus 
nppsColwert_32s16s_Ctx(const Npp32s * pSrc, Npp16s * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32s16s(const Npp32s * pSrc, Npp16s * pDst, int nLength);

NppStatus 
nppsColwert_32s32f_Ctx(const Npp32s * pSrc, Npp32f * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32s32f(const Npp32s * pSrc, Npp32f * pDst, int nLength);

NppStatus 
nppsColwert_32s64f_Ctx(const Npp32s * pSrc, Npp64f * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32s64f(const Npp32s * pSrc, Npp64f * pDst, int nLength);

NppStatus 
nppsColwert_32f64f_Ctx(const Npp32f * pSrc, Npp64f * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32f64f(const Npp32f * pSrc, Npp64f * pDst, int nLength);

NppStatus 
nppsColwert_64s64f_Ctx(const Npp64s * pSrc, Npp64f * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_64s64f(const Npp64s * pSrc, Npp64f * pDst, int nLength);

NppStatus 
nppsColwert_64f32f_Ctx(const Npp64f * pSrc, Npp32f * pDst, int nLength, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_64f32f(const Npp64f * pSrc, Npp32f * pDst, int nLength);

NppStatus 
nppsColwert_16s32f_Sfs_Ctx(const Npp16s * pSrc, Npp32f * pDst, int nLength, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_16s32f_Sfs(const Npp16s * pSrc, Npp32f * pDst, int nLength, int nScaleFactor);

NppStatus 
nppsColwert_16s64f_Sfs_Ctx(const Npp16s * pSrc, Npp64f * pDst, int nLength, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_16s64f_Sfs(const Npp16s * pSrc, Npp64f * pDst, int nLength, int nScaleFactor);

NppStatus 
nppsColwert_32s16s_Sfs_Ctx(const Npp32s * pSrc, Npp16s * pDst, int nLength, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32s16s_Sfs(const Npp32s * pSrc, Npp16s * pDst, int nLength, int nScaleFactor);

NppStatus 
nppsColwert_32s32f_Sfs_Ctx(const Npp32s * pSrc, Npp32f * pDst, int nLength, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32s32f_Sfs(const Npp32s * pSrc, Npp32f * pDst, int nLength, int nScaleFactor);

NppStatus 
nppsColwert_32s64f_Sfs_Ctx(const Npp32s * pSrc, Npp64f * pDst, int nLength, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32s64f_Sfs(const Npp32s * pSrc, Npp64f * pDst, int nLength, int nScaleFactor);

NppStatus 
nppsColwert_32f8s_Sfs_Ctx(const Npp32f * pSrc, Npp8s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32f8s_Sfs(const Npp32f * pSrc, Npp8s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor);

NppStatus 
nppsColwert_32f8u_Sfs_Ctx(const Npp32f * pSrc, Npp8u * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32f8u_Sfs(const Npp32f * pSrc, Npp8u * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor);

NppStatus 
nppsColwert_32f16s_Sfs_Ctx(const Npp32f * pSrc, Npp16s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32f16s_Sfs(const Npp32f * pSrc, Npp16s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor);

NppStatus 
nppsColwert_32f16u_Sfs_Ctx(const Npp32f * pSrc, Npp16u * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32f16u_Sfs(const Npp32f * pSrc, Npp16u * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor);

NppStatus 
nppsColwert_32f32s_Sfs_Ctx(const Npp32f * pSrc, Npp32s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_32f32s_Sfs(const Npp32f * pSrc, Npp32s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor);

NppStatus 
nppsColwert_64s32s_Sfs_Ctx(const Npp64s * pSrc, Npp32s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_64s32s_Sfs(const Npp64s * pSrc, Npp32s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor);

NppStatus 
nppsColwert_64f16s_Sfs_Ctx(const Npp64f * pSrc, Npp16s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_64f16s_Sfs(const Npp64f * pSrc, Npp16s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor);

NppStatus 
nppsColwert_64f32s_Sfs_Ctx(const Npp64f * pSrc, Npp32s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);

NppStatus 
nppsColwert_64f32s_Sfs(const Npp64f * pSrc, Npp32s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor);

NppStatus 
nppsColwert_64f64s_Sfs_Ctx(const Npp64f * pSrc, Npp64s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_16s_Ctx(const Npp16s * pSrc, Npp16s * pDst, int nLength, Npp16s nLevel, Npp16s lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_16s_I_Ctx(Npp16s * pSrcDst, int nLength, Npp16s nLevel, Npp16s lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_16sc_Ctx(const Npp16sc * pSrc, Npp16sc * pDst, int nLength, Npp16s nLevel, Npp16sc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_16sc_I_Ctx(Npp16sc * pSrcDst, int nLength, Npp16s nLevel, Npp16sc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_32f_Ctx(const Npp32f * pSrc, Npp32f * pDst, int nLength, Npp32f nLevel, Npp32f lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_32f_I_Ctx(Npp32f * pSrcDst, int nLength, Npp32f nLevel, Npp32f lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_32fc_Ctx(const Npp32fc * pSrc, Npp32fc * pDst, int nLength, Npp32f nLevel, Npp32fc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_32fc_I_Ctx(Npp32fc * pSrcDst, int nLength, Npp32f nLevel, Npp32fc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_64f_Ctx(const Npp64f * pSrc, Npp64f * pDst, int nLength, Npp64f nLevel, Npp64f lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_64f_I_Ctx(Npp64f * pSrcDst, int nLength, Npp64f nLevel, Npp64f lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_64fc_Ctx(const Npp64fc * pSrc, Npp64fc * pDst, int nLength, Npp64f nLevel, Npp64fc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_LTVal_64fc_I_Ctx(Npp64fc * pSrcDst, int nLength, Npp64f nLevel, Npp64fc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_16s_Ctx(const Npp16s * pSrc, Npp16s * pDst, int nLength, Npp16s nLevel, Npp16s lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_16s_I_Ctx(Npp16s * pSrcDst, int nLength, Npp16s nLevel, Npp16s lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_16sc_Ctx(const Npp16sc * pSrc, Npp16sc * pDst, int nLength, Npp16s nLevel, Npp16sc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_16sc_I_Ctx(Npp16sc * pSrcDst, int nLength, Npp16s nLevel, Npp16sc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_32f_Ctx(const Npp32f * pSrc, Npp32f * pDst, int nLength, Npp32f nLevel, Npp32f lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_32f_I_Ctx(Npp32f * pSrcDst, int nLength, Npp32f nLevel, Npp32f lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_32fc_Ctx(const Npp32fc * pSrc, Npp32fc * pDst, int nLength, Npp32f nLevel, Npp32fc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_32fc_I_Ctx(Npp32fc * pSrcDst, int nLength, Npp32f nLevel, Npp32fc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_64f_Ctx(const Npp64f * pSrc, Npp64f * pDst, int nLength, Npp64f nLevel, Npp64f lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_64f_I_Ctx(Npp64f * pSrcDst, int nLength, Npp64f nLevel, Npp64f lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_64fc_Ctx(const Npp64fc * pSrc, Npp64fc * pDst, int nLength, Npp64f nLevel, Npp64fc lwalue, NppStreamContext nppStreamCtx);
 ...
 */
NppStatus 
nppsThreshold_GTVal_64fc_I_Ctx(Npp64fc * pSrcDst, int nLength, Npp64f nLevel, Npp64fc lwalue, NppStreamContext nppStreamCtx);
