...
struct exelwte_with_allocator
  : BaseSystem<exelwte_with_allocator<Allocator, BaseSystem> >
{
private:
  typedef BaseSystem<exelwte_with_allocator<Allocator, BaseSystem> > super_t;

  Allocator alloc;

public:
  __host__ __device__
  exelwte_with_allocator(super_t const& super, Allocator alloc_)
    : super_t(super), alloc(alloc_)
  {}

  __thrust_exec_check_disable__
  __host__ __device__
  exelwte_with_allocator(Allocator alloc_)
    : alloc(alloc_)
  {}
  ...
  __host__
  exelwte_with_allocator_and_dependencies<Allocator, BaseSystem, Dependencies...>
