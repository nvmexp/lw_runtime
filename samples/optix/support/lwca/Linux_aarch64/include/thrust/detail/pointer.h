...
// 3. constructor from OtherPointer related by colwertibility
// 4. constructor from OtherPointer to void
// 5. assignment from OtherPointer related by colwertibility
    ...
    : public thrust::detail::pointer_base<Element,Tag,Reference,Derived>::type
{
  ...
  public:
    ...
    // OtherValue shall be colwertible to Value
    ...
    // OtherPointer's element_type shall be colwertible to Element
    // OtherPointer's system shall be colwertible to Tag
    ...
    explicit
    pointer(const OtherPointer &other,
            typename thrust::detail::enable_if_void_pointer_is_system_colwertible<
              OtherPointer,
              pointer<Element,Tag,Reference,Derived>
            >::type * = 0);
