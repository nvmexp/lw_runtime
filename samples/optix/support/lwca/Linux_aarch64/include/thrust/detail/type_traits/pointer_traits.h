...
template<typename FromPtr, typename ToPtr>
  struct is_pointer_system_colwertible
    : thrust::detail::is_colwertible<
...
template<typename FromPtr, typename ToPtr>
  struct is_pointer_colwertible
    : thrust::detail::and_<
        thrust::detail::is_colwertible<
          typename pointer_element<FromPtr>::type *,
          typename pointer_element<ToPtr>::type *
        >,
        is_pointer_system_colwertible<FromPtr, ToPtr>
      >
{};

template<typename FromPtr, typename ToPtr>
  struct is_void_pointer_system_colwertible
    : thrust::detail::and_<
...
template<typename FromPtr, typename ToPtr>
  struct lazy_is_pointer_colwertible
    : thrust::detail::eval_if<
        is_thrust_pointer<FromPtr>::value && is_thrust_pointer<ToPtr>::value,
        is_pointer_colwertible<FromPtr,ToPtr>,
        thrust::detail::identity_<thrust::detail::false_type>
      >
{};

template<typename FromPtr, typename ToPtr>
  struct lazy_is_void_pointer_system_colwertible
    : thrust::detail::eval_if<
        is_thrust_pointer<FromPtr>::value && is_thrust_pointer<ToPtr>::value,
        is_void_pointer_system_colwertible<FromPtr,ToPtr>,
        thrust::detail::identity_<thrust::detail::false_type>
      >
{};

template<typename FromPtr, typename ToPtr, typename T = void>
  struct enable_if_pointer_is_colwertible
    : thrust::detail::enable_if<
        lazy_is_pointer_colwertible<FromPtr,ToPtr>::type::value,
        T
      >
{};

template<typename FromPtr, typename ToPtr, typename T = void>
  struct enable_if_void_pointer_is_system_colwertible
    : thrust::detail::enable_if<
        lazy_is_void_pointer_system_colwertible<FromPtr,ToPtr>::type::value,
        T
      >
{};
