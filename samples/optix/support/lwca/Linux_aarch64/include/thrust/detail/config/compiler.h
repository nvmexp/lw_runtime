...
#define THRUST_DEVICE_COMPILER_LWCC    3
...
#define THRUST_DEVICE_COMPILER THRUST_DEVICE_COMPILER_LWCC
...
#if defined(_OPENMP) || defined(_LWHPC_STDPAR_OPENMP)
...
#if (THRUST_HOST_COMPILER == THRUST_HOST_COMPILER_MSVC) && !defined(__LWDA_ARCH__)
...
#if (THRUST_HOST_COMPILER == THRUST_HOST_COMPILER_CLANG) && !defined(__LWDA_ARCH__)
...
#if (THRUST_HOST_COMPILER == THRUST_HOST_COMPILER_GCC) && !defined(__LWDA_ARCH__)
