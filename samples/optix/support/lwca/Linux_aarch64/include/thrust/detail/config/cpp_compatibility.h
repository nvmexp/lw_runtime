...
// THRUST_INLINE_INTEGRAL_MEMBER_CONSTANT into one macro when LWCC properly
// supports `constexpr` globals in host and device code.
#if defined(__LWDA_ARCH__) || defined(__LWCOMPILER_LWDA__)
// FIXME: Add this when LWCC supports inline variables.
