 ...
 *  to search for values in a ordered range using the \p thrust::device exelwtion policy for parallelization:
 *
 *  \code
...
__host__ __device__
ForwardIterator lower_bound(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *  to search for values in a ordered range using the \p thrust::device exelwtion policy for parallelism:
 *
 *  \code
 *  #include <thrust/binary_search.h>
 *  #include <thrust/device_vector.h>
...
template<typename DerivedPolicy, typename ForwardIterator, typename LessThanComparable>
__host__ __device__
ForwardIterator upper_bound(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                            ForwardIterator first,
                            ForwardIterator last,
                            const LessThanComparable &value);
...
template <typename DerivedPolicy, typename ForwardIterator, typename LessThanComparable>
__host__ __device__
bool binary_search(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                   ForwardIterator first, 
                   ForwardIterator last,
                   const LessThanComparable& value);
...
equal_range(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
            ForwardIterator first,
            ForwardIterator last,
            const LessThanComparable& value);
 ...
 *                        and \c ForwardIterator's difference_type is colwertible to \c OutputIterator's \c value_type.
 *
 *  \pre The ranges <tt>[first,last)</tt> and <tt>[result, result + (last - first))</tt> shall not overlap.
 *
 *  The following code snippet demonstrates how to use \p lower_bound
 *  to search for multiple values in a ordered range using the \p thrust::device exelwtion policy for
 *  parallelization:
 *
 *  \code
 *  #include <thrust/binary_search.h>
...
__host__ __device__
OutputIterator lower_bound(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                           ForwardIterator first, 
                           ForwardIterator last,
...
template <typename DerivedPolicy, typename ForwardIterator, typename InputIterator, typename OutputIterator>
__host__ __device__
OutputIterator upper_bound(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                           ForwardIterator first, 
                           ForwardIterator last,
                           InputIterator values_first, 
                           InputIterator values_last,
 ...
 *                        and \c InputIterator's \c value_type is <a href="http://www.sgi.com/tech/stl/LessThanComparable.html">LessThanComparable</a>.
 *  \tparam OutputIterator is a model of <a href="http://www.sgi.com/tech/stl/OutputIterator.html">Output Iterator</a>.
 *                        and bool is colwertible to \c OutputIterator's \c value_type.
 *
 *  \pre The ranges <tt>[first,last)</tt> and <tt>[result, result + (last - first))</tt> shall not overlap.
 *
 *  The following code snippet demonstrates how to use \p binary_search
...
template <typename DerivedPolicy, typename ForwardIterator, typename InputIterator, typename OutputIterator>
__host__ __device__
OutputIterator binary_search(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                             ForwardIterator first, 
                             ForwardIterator last,
                             InputIterator values_first, 
                             InputIterator values_last,
