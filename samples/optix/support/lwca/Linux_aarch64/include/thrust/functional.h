 ...
 *  is to make it more colwenient to define types that are models of the
 ...
 *          and if \c x and \c y are objects of type \p T, then <tt>x+y</tt> must be defined and must have a return type that is colwertible to \c T.
 *
 ...
 *
 *  \tparam T is a model of <a href="http://www.sgi.com/tech/stl/Assignable.html">Assignable</a>,
 *          and if \c x is an object of type \p T, then <tt>-x</tt> must be defined and must have a return type that is colwertible to \c T.
 *
 ...
 *
 *  \tparam T is a model of <a href="http://www.sgi.com/tech/stl/Assignable.html">Assignable</a>,
 *          and if \c x is an object of type \p T, then <tt>x*x</tt> must be defined and must have a return type that is colwertible to \c T.
 *
 ...
 *  class \c T (where \c T is colwertible to \c bool) then <tt>f(x,y)</tt> returns \c true
 *  if and only if both \c x and \c y are \c true.
 *
 *  \tparam T must be colwertible to \c bool.
 *
 ...
 *  class \c T (where \c T is colwertible to \c bool) then <tt>f(x)</tt> returns \c true
