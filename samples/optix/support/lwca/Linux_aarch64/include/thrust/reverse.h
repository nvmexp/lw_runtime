 ...
 *  \p device_vector of integers using the \p thrust::device exelwtion policy for
 *  parallelization:
 *
 *  \code
...
__host__ __device__
  void reverse(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *          and \p BidirectionalIterator's \p value_type is colwertible to \p OutputIterator's \p value_type.
...
__host__ __device__
  OutputIterator reverse_copy(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                              BidirectionalIterator first,
                              BidirectionalIterator last,
