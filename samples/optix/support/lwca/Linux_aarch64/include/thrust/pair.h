  ...
  struct pair
{
   ...
   *  colwertible to this \p pair's \c first_type and \c second_type,
   *  respectively.
   *
   *  \param p The \p pair to copy from.
   *
   *  \tparam U1 is colwertible to \c first_type.
   *  \tparam U2 is colwertible to \c second_type.
   */
...
/*! This colwenience function creates a \p pair from two objects.
 *
...
/*! This colwenience metafunction is included for compatibility with
...
/*! This colwenience function returns a reference to either the first or
...
/*! This colwenience function returns a const reference to either the
