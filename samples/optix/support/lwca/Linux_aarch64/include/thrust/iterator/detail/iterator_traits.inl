...
template <typename T>
  struct is_iterator_traversal
    : thrust::detail::is_colwertible<T, incrementable_traversal_tag>
{
...
template<typename T>
  struct is_iterator_system
    : detail::or_<
        detail::is_colwertible<T, any_system_tag>,
        detail::or_<
          detail::is_colwertible<T, host_system_tag>,
          detail::is_colwertible<T, device_system_tag>
        >
      >
{
