 ...
 *  idiom. \p zip_iterator also facilitates kernel fusion by providing a colwenient
 *  means of amortizing the exelwtion of the same operation over multiple ranges.
 *
    ...
    : public detail::zip_iterator_base<IteratorTuple>::type
{
  ...
  private:
    ...
    // Distance is callwlated using the first iterator in the tuple.
    template<typename OtherIteratorTuple>
    inline __host__ __device__
