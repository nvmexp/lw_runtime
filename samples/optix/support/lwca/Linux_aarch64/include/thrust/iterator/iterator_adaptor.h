 ...
 *  for algorithm compatibility can make \p iterator_adaptor diffilwlt to use correctly. Unless you require the full expressivity of \p iterator_adaptor,
    ...
    >::type
{
  ...
  private: // Core iterator interface for iterator_facade
    ...
    void advance(typename iterator_adaptor::difference_type n)
    {
      ...
      // Explicitly cast to avoid static colwersion warnings.
