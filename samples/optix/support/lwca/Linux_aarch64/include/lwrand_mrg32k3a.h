 ...
 * Users Notice.
 */
#if !defined(LWRAND_MRG32K3A_MATRICES_H_)
#define LWRAND_MRG32K3A_MATRICES_H_

#if defined(__LWDACC_RDC__) && (__cplusplus >= 201703L) && defined(__cpp_inline_variables)
#define LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS inline __device__
#else
#define LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS static __device__
#endif

#if (__cplusplus >= 201703L) && defined(__cpp_inline_variables)
#define LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS inline
#else
#define LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS static
#endif
...
LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS unsigned int mrg32k3aM1[64][3][3] = {
        {
            {               0u,               1u,               0u },
            {               0u,               0u,               1u },
...
LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS unsigned int mrg32k3aM1Host[64][3][3] = {
        {
            {               0u,               1u,               0u },
            {               0u,               0u,               1u },
            {      4294156359u,         1403580u,               0u }
...
LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS unsigned int mrg32k3aM2[64][3][3] = {
        {
            {               0u,               1u,               0u },
            {               0u,               0u,               1u },
...
#ifndef __LWDACC_RTC__
LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS unsigned int mrg32k3aM2Host[64][3][3] = {
        {
            {               0u,               1u,               0u },
            {               0u,               0u,               1u },
            {      4293573854u,               0u,          527612u }
...
LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS unsigned int mrg32k3aM1SubSeq[56][3][3] = {
        {
...
#ifndef __LWDACC_RTC__
LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS unsigned int mrg32k3aM1SubSeqHost[56][3][3] = {
        {
            {        82758667u,      1871391091u,      4127413238u },
            {      3672831523u,        69195019u,      1871391091u },
            {      3672091415u,      3528743235u,        69195019u }
...
LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS unsigned int mrg32k3aM2SubSeq[56][3][3] = {
        {
...
#ifndef __LWDACC_RTC__
LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS unsigned int mrg32k3aM2SubSeqHost[56][3][3] = {
        {
            {      1511326704u,      3759209742u,      1610795712u },
            {      4292754251u,      1511326704u,      3889917532u },
            {      3859662829u,      4292754251u,      3708466080u }
...
LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS unsigned int mrg32k3aM1Seq[64][3][3] = {
        {
...
#ifndef __LWDACC_RTC__
LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS unsigned int mrg32k3aM1SeqHost[64][3][3] = {
        {
            {      2427906178u,      3580155704u,       949770784u },
            {       226153695u,      1230515664u,      3580155704u },
            {      1988835001u,       986791581u,      1230515664u }
...
LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS unsigned int mrg32k3aM2Seq[64][3][3] = {
        {
...
#ifndef __LWDACC_RTC__
LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS unsigned int mrg32k3aM2SeqHost[64][3][3] = {
        {
            {      1464411153u,       277697599u,      1610723613u },
            {        32183930u,      1464411153u,      1022607788u },
            {      2824425944u,        32183930u,      2093834863u }
...
#ifdef LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS
#undef LWRAND_MRG32K3A_MATRICES_DEVICE_QUALIFIERS
#endif

#ifdef LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS
#undef LWRAND_MRG32K3A_MATRICES_HOST_QUALIFIERS
#endif

#endif /* !defined(LWRAND_MRG32K3A_MATRICES_H_) */
