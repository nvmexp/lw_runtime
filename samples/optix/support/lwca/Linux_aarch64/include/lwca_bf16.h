...
* \returns lw_bfloat16
* \retval a colwerted to lw_bfloat16.
* \internal
...
* \retval The \p lw_bfloat162 value with both halves equal to the colwerted lw_bfloat16
* precision number.
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
...
* 
* \returns lw_bfloat162
* \retval The \p lw_bfloat162 value with corresponding halves equal to the
...
*  
* \returns lw_bfloat162
* \retval The \p lw_bfloat162 which has corresponding halves equal to the
...
* 
* \returns int
* \retval h colwerted to a signed integer. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* 
* \returns lw_bfloat16
* \retval i colwerted to lw_bfloat16. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* 
* \returns short int
* \retval h colwerted to a signed short integer. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* \retval h colwerted to an unsigned integer. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* \retval h colwerted to an unsigned short integer. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* \retval h colwerted to an unsigned 64-bit integer. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* \retval h colwerted to a signed 64-bit integer. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
*
* \returns lw_bfloat16
* \retval Returns \p lw_bfloat16 which contains low 16 bits of the input \p a. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* 
* \returns lw_bfloat162
* \retval The lw_bfloat162 with one lw_bfloat16 equal to \p a and the other to \p b. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* 
* \returns lw_bfloat162
* \retval The lw_bfloat162 with both halves equal to the low 16 bits of the input. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
* 
* \returns lw_bfloat162
* \retval The lw_bfloat162 with both halves equal to the high 16 bits of the input. 
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
*
* \returns lw_bfloat162
* \retval The \p lw_bfloat162 result of less-equal comparison of vectors \p a and \p b.
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
*
* \returns lw_bfloat162
* \retval The lw_bfloat162 vector result of less-than comparison of vectors \p a and \p b.
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
*
* \returns lw_bfloat162
* \retval The \p lw_bfloat162 vector result of unordered greater-equal comparison of vectors \p a and \p b.
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
*
* \returns lw_bfloat162
* \retval The \p lw_bfloat162 vector result of unordered greater-than comparison of vectors \p a and \p b.
* \internal
* \exception-guarantee no-throw guarantee
* \behavior reentrant, thread safe
* \endinternal
...
*
* \returns lw_bfloat162
* \retval The lw_bfloat162 with the corresponding \p lw_bfloat16 results set to
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of if-equal comparison
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of not-equal comparison
* of vectors \p a and \p b are true, 
* \retval false otherwise. 
* \internal
* \exception-guarantee no-throw guarantee
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of less-equal comparison
* of vectors \p a and \p b are true; 
* \retval false otherwise. 
* \internal
* \exception-guarantee no-throw guarantee
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of greater-equal
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of less-than comparison
* of vectors \p a and \p b are true; 
* \retval false otherwise. 
* \internal
* \exception-guarantee no-throw guarantee
...
* 
* \returns bool 
* \retval true if both \p lw_bfloat16 results of greater-than
* comparison of vectors \p a and \p b are true; 
* \retval false otherwise. 
* \internal
* \exception-guarantee no-throw guarantee
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of unordered if-equal
* comparison of vectors \p a and \p b are true; 
* \retval false otherwise. 
* \internal
* \exception-guarantee no-throw guarantee
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of unordered not-equal
* comparison of vectors \p a and \p b are true;
* \retval false otherwise. 
* \internal
* \exception-guarantee no-throw guarantee
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of unordered less-equal
* comparison of vectors \p a and \p b are true; 
* \retval false otherwise. 
* \internal
* \exception-guarantee no-throw guarantee
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of unordered
...
*
* \returns bool
* \retval true if both \p lw_bfloat16 results of unordered less-than comparison of 
