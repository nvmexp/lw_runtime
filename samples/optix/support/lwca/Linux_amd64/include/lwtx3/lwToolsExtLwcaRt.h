...
#ifndef LWTOOLSEXT_LWDART_V3
#define LWTOOLSEXT_LWDART_V3
...
#ifndef LWTX_NO_IMPL
#define LWTX_IMPL_GUARD_LWDART /* Ensure other headers cannot included directly */
#include "lwtxDetail/lwtxImplLwdaRt_v3.h"
#undef LWTX_IMPL_GUARD_LWDART
#endif /*LWTX_NO_IMPL*/

#endif /* LWTOOLSEXT_LWDART_V3 */
