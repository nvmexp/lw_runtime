...
#ifndef LWTOOLSEXT_OPENCL_V3
#define LWTOOLSEXT_OPENCL_V3
...
#ifndef LWTX_NO_IMPL
#define LWTX_IMPL_GUARD_OPENCL /* Ensure other headers cannot included directly */
#include "lwtxDetail/lwtxImplOpenCL_v3.h"
#undef LWTX_IMPL_GUARD_OPENCL
#endif /*LWTX_NO_IMPL*/

#endif /* LWTOOLSEXT_OPENCL_V3 */
