...
#define __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_VECTOR_TYPES_H__
#endif
...
#if !defined(__LWDACC__) && !defined(__LWDACC_RTC__) && \
...
#else /* !__LWDACC__ && !__LWDACC_RTC__ && _WIN32 && !_WIN64 */
...
#endif /* !__LWDACC__ && !__LWDACC_RTC__ && _WIN32 && !_WIN64 */
...
#if !defined(__LWDACC__) && defined(__arm__) && \
...
#else /* !__LWDACC__ && __arm__ && __ARM_PCS_VFP &&
         __GNUC__ == 4&& __GNUC_MINOR__ == 6 */

__lwda_builtin_vector_align8(float2, float x; float y;);

#endif /* !__LWDACC__ && __arm__ && __ARM_PCS_VFP &&
          __GNUC__ == 4&& __GNUC_MINOR__ == 6 */
...
#if !defined(__LWDACC__) && defined(_WIN32) && !defined(_WIN64)
...
#if defined(__UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_VECTOR_TYPES_H__)
#undef __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#undef __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_VECTOR_TYPES_H__
#endif
