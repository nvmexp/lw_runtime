 ...
 *  a range of uninitialized memory using the \p thrust::device exelwtion policy for
 *  parallelization:
 *
 *  \code
...
__host__ __device__
  ForwardIterator uninitialized_copy(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                     InputIterator first,
                                     InputIterator last,
...
__host__ __device__
  ForwardIterator uninitialized_copy_n(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                       InputIterator first,
                                       Size n,
                                       ForwardIterator result);
