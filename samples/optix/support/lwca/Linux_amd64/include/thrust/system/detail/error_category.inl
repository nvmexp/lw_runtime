  ...
  public:
    ...
    inline virtual error_condition default_error_condition(int ev) const
    {
      ...
      switch(ev)
      {
        ...
        case enoexec:         return make_error_condition(exelwtable_format_error);
        ...
        case eilwal:          return make_error_condition(ilwalid_argument);
        case espipe:          return make_error_condition(ilwalid_seek);
        ...
        case edeadlk:         return make_error_condition(resource_deadlock_would_oclwr);
