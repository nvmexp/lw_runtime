...
/*! \file thrust/system/tbb/exelwtion_policy.h
 *  \brief Exelwtion policies for Thrust's TBB system.
 */

#include <thrust/detail/config.h>

// get the exelwtion policies definitions first
#include <thrust/system/tbb/detail/exelwtion_policy.h>
...
/*! \p thrust::tbb::exelwtion_policy is the base class for all Thrust parallel exelwtion
 ...
 *  Iterators "tagged" with a type which is colwertible to \p tbb::tag assert that they may be
 *  "dispatched" to algorithm implementations in the \p tbb system.
 */
struct tag : thrust::system::tbb::exelwtion_policy<tag> { unspecified };


/*! \p thrust::tbb::par is the parallel exelwtion policy associated with Thrust's TBB
 *  backend system.
 *
 ...
 *  #include <thrust/system/tbb/exelwtion_policy.h>
 *  #include <cstdio>
 *
