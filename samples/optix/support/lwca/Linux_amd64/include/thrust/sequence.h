 ...
 *  with a sequence of numbers using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
 ...
 *        guarantee on order of exelwtion.
 *
 ...
 *
 *  The following code snippet demonstrates how to use \p sequence to fill a range
 *  with a sequence of numbers starting from the value 1 using the \p thrust::host exelwtion
 ...
 *  \param last The end of the sequence.
 *  \param init The first value of the sequence of numbers
 *  \param step The difference between conselwtive elements.
 *
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam ForwardIterator is a model of <a href="http://www.sgi.com/tech/stl/ForwardIterator.html">Forward Iterator</a>,
 *          and \p ForwardIterator is mutable,
