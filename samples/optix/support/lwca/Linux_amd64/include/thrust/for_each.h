 ...
 *  order of exelwtion. For this reason, this version of \p for_each
...
__host__ __device__
InputIterator for_each(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                       InputIterator first,
                       InputIterator last,
                       UnaryFunction f);
...
template<typename DerivedPolicy,
         ...
         typename UnaryFunction>
__host__ __device__
InputIterator for_each_n(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                         InputIterator first,
                         Size n,
                         UnaryFunction f);
