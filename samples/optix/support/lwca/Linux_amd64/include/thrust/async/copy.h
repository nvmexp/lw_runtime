...
event<FromPolicy>
async_copy(
  thrust::exelwtion_policy<FromPolicy>& from_exec
, thrust::exelwtion_policy<ToPolicy>&   to_exec
...
struct copy_fn final
{
  ...
  __host__
  static auto call(
    thrust::detail::exelwtion_policy_base<FromPolicy> const& from_exec
  , thrust::detail::exelwtion_policy_base<ToPolicy> const&   to_exec
  ...
  THRUST_RETURNS(
    copy_fn::call(
      ...
      // Synthesize a suitable new exelwtion policy, because we don't want to
