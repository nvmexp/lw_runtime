 ...
 *  a sequence of integers using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
...
__host__ __device__
  void sort(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *  \tparam RandomAccessIterator is a model of <a href="http://www.sgi.com/tech/stl/RandomAccessIterator.html">Random Access Iterator</a>,
 *          \p RandomAccessIterator is mutable,
 *          and \p RandomAccessIterator's \c value_type is colwertible to \p StrictWeakOrdering's
 ...
 *  using the greater<int> comparison operator using the \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
 *  #include <thrust/sort.h>
...
template<typename DerivedPolicy, typename RandomAccessIterator>
__host__ __device__
  void stable_sort(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                   RandomAccessIterator first,
                   RandomAccessIterator last);
 ...
 *  an array of character values using integers as sorting keys using the \p thrust::host exelwtion policy
 *  for parallelization:
 *
 *  \code
 *  #include <thrust/sort.h>
...
__host__ __device__
  void sort_by_key(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *  \tparam RandomAccessIterator1 is a model of <a href="http://www.sgi.com/tech/stl/RandomAccessIterator.html">Random Access Iterator</a>,
 *          \p RandomAccessIterator1 is mutable,
 *          and \p RandomAccessIterator1's \c value_type is colwertible to \p StrictWeakOrdering's
 *          \c first_argument_type and \c second_argument_type.
 *  \tparam RandomAccessIterator2 is a model of <a href="http://www.sgi.com/tech/stl/RandomAccessIterator.hml">Random Access Iterator</a>,
 *          and \p RandomAccessIterator2 is mutable.
 *  \tparam StrictWeakOrdering is a model of <a href="http://www.sgi.com/tech/stl/StrictWeakOrdering.html">Strict Weak Ordering</a>.
 ...
 *  an array of characters using integers as sorting keys using the \p thrust::host exelwtion policy for
 *  parallelization:
 *
 *  \code
 *  #include <thrust/sort.h>
...
template<typename DerivedPolicy,
         ...
         typename RandomAccessIterator2>
__host__ __device__
  void stable_sort_by_key(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                          RandomAccessIterator1 keys_first,
                          RandomAccessIterator1 keys_last,
                          RandomAccessIterator2 values_first);
 ...
 *
 *  The following code snippet demonstrates how to use \p sort_by_key to sort
 *  an array of character values using integers as sorting keys using the \p thrust::host exelwtion policy for
 ...
 *  contents of a \c device_vector are stored in ascending order using the \p thrust::device exelwtion policy
 *  for parallelization:
 *
 *  \code
 *  #include <thrust/sort.h>
...
__host__ __device__
  bool is_sorted(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam ForwardIterator is a model of <a href="http://www.sgi.com/tech/stl/ForwardIterator.html">Forward Iterator</a>,
 *          and \p ForwardIterator's \c value_type is colwertible to both \c StrictWeakOrdering's \c first_argument_type
 ...
 *  contents of a \c device_vector are stored in descending order using the \p thrust::device exelwtion
 ...
 *  in an array where the data becomes unsorted using the \p thrust::host exelwtion policy for
 *  parallelization:
 *  
 *  \code
 *  #include <thrust/sort.h>
...
template<typename DerivedPolicy, typename ForwardIterator>
__host__ __device__
  ForwardIterator is_sorted_until(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                  ForwardIterator first,
                                  ForwardIterator last);
 ...
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam ForwardIterator is a model of <a href="http://www.sgi.com/tech/stl/ForwardIterator.html">Forward Iterator</a> and
 *          \p ForwardIterator's \c value_type is colwertible to \p Compare's \c argument_type.
 *  \tparam Compare is a model of <a href="http://www.sgi.com/tech/stl/StrictWeakOrdering.html">Strict Weak Ordering</a>.
 *
 *  The following code snippet demonstrates how to use \p is_sorted_until to find the first position
 *  in an array where the data becomes unsorted in descending order using the \p thrust::host exelwtion
 *  policy for parallelization:
 *
 *  \code
 *  #include <thrust/sort.h>
