...
// Use ilwoke_result / result_of when FuncType::result_type is not defined.
...
private:
  ...
  struct impl<F(Args...)>
  {
    using type = std::ilwoke_result_t<F, Args...>;
  };
...
// specialization for ilwocations which define result_type
