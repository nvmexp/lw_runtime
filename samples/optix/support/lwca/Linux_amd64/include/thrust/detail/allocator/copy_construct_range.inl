...
__host__ __device__
  typename enable_if_colwertible<
    FromSystem,
    ToSystem,
    Pointer
  >::type
    uninitialized_copy_with_allocator(Allocator &a,
                                      const thrust::exelwtion_policy<FromSystem> &,
                                      const thrust::exelwtion_policy<ToSystem> &to_system,
                                      InputIterator first,
                                      InputIterator last,
                                      Pointer result)
{
...
template<typename Allocator, typename FromSystem, typename ToSystem, typename InputIterator, typename Pointer>
__host__ __device__
  typename disable_if_colwertible<
    FromSystem,
    ToSystem,
    Pointer
  >::type
    uninitialized_copy_with_allocator(Allocator &,
                                      const thrust::exelwtion_policy<FromSystem> &from_system,
                                      const thrust::exelwtion_policy<ToSystem> &to_system,
                                      InputIterator first,
                                      InputIterator last,
                                      Pointer result)
...
__host__ __device__
  typename disable_if<
    ...
    Pointer
  >::type
    copy_construct_range(thrust::exelwtion_policy<FromSystem> &from_system,
                         Allocator &a,
                         InputIterator first,
                         InputIterator last,
                         Pointer result)
...
__host__ __device__
  typename disable_if<
    ...
    Pointer
  >::type
    copy_construct_range_n(thrust::exelwtion_policy<FromSystem> &from_system,
                           Allocator &a,
                           InputIterator first,
                           Size n,
                           Pointer result)
...
__host__ __device__
  Pointer copy_construct_range(thrust::exelwtion_policy<System> &from_system,
                               Allocator &a,
                               InputIterator first,
                               InputIterator last,
                               Pointer result)
...
__host__ __device__
  Pointer copy_construct_range_n(thrust::exelwtion_policy<System> &from_system,
                                 Allocator &a,
                                 InputIterator first,
                                 Size n,
                                 Pointer result)
