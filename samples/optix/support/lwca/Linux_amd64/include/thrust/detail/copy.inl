...
__host__ __device__
  OutputIterator two_system_copy(const thrust::exelwtion_policy<System1> &system1,
                                 const thrust::exelwtion_policy<System2> &system2,
                                 InputIterator first,
                                 InputIterator last,
                                 OutputIterator result)
{
...
template<typename System1,
         ...
         typename OutputIterator>
__host__ __device__
  OutputIterator two_system_copy_n(const thrust::exelwtion_policy<System1> &system1,
                                   const thrust::exelwtion_policy<System2> &system2,
                                   InputIterator first,
                                   Size n,
                                   OutputIterator result)
