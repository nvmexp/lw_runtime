...
__host__ __device__
bool equal(const thrust::detail::exelwtion_policy_base<System> &system, InputIterator1 first1, InputIterator1 last1, InputIterator2 first2)
{
...
__host__ __device__
bool equal(const thrust::detail::exelwtion_policy_base<System> &system, InputIterator1 first1, InputIterator1 last1, InputIterator2 first2, BinaryPredicate binary_pred)
{
  using thrust::system::detail::generic::equal;
