...
template <unsigned int N, unsigned int Lwr>
struct log2
{
    static const unsigned int value = log2<N / 2,Lwr+1>::value;
};

template <unsigned int Lwr>
struct log2<1, Lwr>
{
    static const unsigned int value = Lwr;
};
