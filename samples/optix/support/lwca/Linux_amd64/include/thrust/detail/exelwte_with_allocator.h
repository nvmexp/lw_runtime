...
get_temporary_buffer(
    thrust::detail::exelwte_with_allocator<Allocator, BaseSystem>& system
  , std::ptrdiff_t n
    )
{
...
thrust::pair<T*, std::ptrdiff_t>
get_temporary_buffer(
    thrust::detail::exelwte_with_allocator_and_dependencies<Allocator, BaseSystem, Dependencies...>& system,
    std::ptrdiff_t n
    )
{
  typedef typename thrust::detail::remove_reference<Allocator>::type naked_allocator;
