#pragma once
/*
 *  Copyright 2008-2016 LWPU Corporation
 *
...
get_iterator_value(thrust::exelwtion_policy<DerivedPolicy> &, Iterator it)
{
  return *it;
...
// to perform a dereferencing consistent with the exelwtion policy
template<typename DerivedPolicy, typename Pointer>
__host__ __device__
typename thrust::detail::pointer_traits<Pointer*>::element_type 
get_iterator_value(thrust::exelwtion_policy<DerivedPolicy> &exec, Pointer* ptr)
{
