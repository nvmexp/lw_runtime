...
// define these types without inheritance to avoid ambiguous colwersion to base classes
...
// create this struct to control colwersion precedence in random_access_universal_iterator_tag
template<typename T>
