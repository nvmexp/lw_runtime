 ...
 *  \note Unlike \p retag, \p reinterpret_tag does not enforce that the colwerted-to system tag be
 *        related to the colwerted-from system tag.
 *  \see retag
 */
 ...
 *  \tparam Tag \p Tag shall be colwertible to <tt>thrust::iterator_system<Iterator>::type</tt>,
 ...
 *  \note Unlike \p reinterpret_tag, \p retag enforces that the colwerted-to system tag be
 *        related to the colwerted-from system tag.
 *  \see reinterpret_tag
 */
template<typename Tag, typename Iterator>
