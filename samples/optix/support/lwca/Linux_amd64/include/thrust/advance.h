 ...
 *  If <tt>n > 0</tt> it is equivalent to exelwting <tt>++i</tt> \p n
 *  times, and if <tt>n < 0</tt> it is equivalent to exelwting <tt>--i</tt>
 ...
 *  \tparam Distance is an integral type that is colwertible to \p InputIterator's distance type.
 *
