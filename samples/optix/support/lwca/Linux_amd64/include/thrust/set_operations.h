 ...
 *          and \p InputIterator1's \c value_type is colwertable to a type in \p OutputIterator's set of \c value_types.
 ...
 *          and \p InputIterator2's \c value_type is colwertable to a type in \p OutputIterator's set of \c value_types.
 ...
 *  set difference of two sets of integers sorted in ascending order using the \p thrust::host exelwtion
...
__host__ __device__
  OutputIterator set_difference(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
 ...
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam InputIterator1 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          \p InputIterator1's \c value_type is colwertable to \p StrictWeakCompare's \c first_argument_type.
 *          and \p InputIterator1's \c value_type is colwertable to a type in \p OutputIterator's set of \c value_types.
 *  \tparam InputIterator2 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          \p InputIterator2's \c value_type is colwertable to \p StrictWeakCompare's \c second_argument_type.
 *          and \p InputIterator2's \c value_type is colwertable to a type in \p OutputIterator's set of \c value_types.
 *  \tparam OutputIterator is a model of <a href="http://www.sgi.com/tech/stl/OutputIterator.html">Output Iterator</a>.
 ...
 *
 *  The following code snippet demonstrates how to use \p set_difference to compute the
 *  set difference of two sets of integers sorted in descending order using the \p thrust::host exelwtion
 *  policy for parallelization:
 *
 *  \code
 *  #include <thrust/set_operations.h>
 ...
 *  set intersection of two sets of integers sorted in ascending order using the \p thrust::host exelwtion
 *  policy for parallelization:
 *
 *  \code
 *  #include <thrust/set_operations.h>
...
template<typename DerivedPolicy,
         ...
         typename OutputIterator>
__host__ __device__
  OutputIterator set_intersection(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                  InputIterator1                                              first1,
                                  InputIterator1                                              last1,
                                  InputIterator2                                              first2,
                                  InputIterator2                                              last2,
 ...
 *  the set intersection of sets of integers sorted in descending order using the \p thrust::host exelwtion
 *  policy for parallelization:
 *
 *  \code
 *  #include <thrust/set_operations.h>
 ...
 *
 *  In the simplest case, \p set_symmetric_difference performs a set theoretic callwlation:
 ...
 *  exelwtion policy for parallelization:
 *
 *  \code
 *  #include <thrust/set_operations.h>
 *  #include <thrust/exelwtion_policy.h>
...
template<typename DerivedPolicy,
         ...
         typename OutputIterator>
__host__ __device__
  OutputIterator set_symmetric_difference(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                          InputIterator1                                              first1,
                                          InputIterator1                                              last1,
                                          InputIterator2                                              first2,
                                          InputIterator2                                              last2,
 ...
 *  two sets of integers sorted in ascending order using the \p thrust::host exelwtion policy for
 *  parallelization:
 *
 *  \code
 *  #include <thrust/set_operations.h>
...
template<typename DerivedPolicy,
         ...
         typename OutputIterator>
__host__ __device__
  OutputIterator set_union(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                           InputIterator1                                              first1,
                           InputIterator1                                              last1,
                           InputIterator2                                              first2,
                           InputIterator2                                              last2,
 ...
 *          and \p InputIterator3's \c value_type is colwertible to a type in \p OutputIterator2's set of \c value_types.
 *  \tparam InputIterator4 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          and \p InputIterator4's \c value_type is colwertible to a type in \p OutputIterator2's set of \c value_types.
...
__host__ __device__
  thrust::pair<OutputIterator1,OutputIterator2>
    set_difference_by_key(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
...
__host__ __device__
  thrust::pair<OutputIterator1,OutputIterator2>
    set_intersection_by_key(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                            InputIterator1                                              keys_first1,
                            InputIterator1                                              keys_last1,
                            InputIterator2                                              keys_first2,
                            InputIterator2                                              keys_last2,
 ...
 *  \p thrust::host exelwtion policy for parallelization:
 *
 *  \code
 *  #include <thrust/set_operations.h>
 *  #include <thrust/functional.h>
 ...
 *  value ranges need not be sorted.
 *
 *  In the simplest case, \p set_symmetric_difference_by_key performs a set theoretic callwlation:
 *  it constructs the union of the two sets A - B and B - A, where A and B are the two
 *  input ranges. That is, the output range contains a copy of every element that is
...
__host__ __device__
  thrust::pair<OutputIterator1,OutputIterator2>
    set_symmetric_difference_by_key(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                    InputIterator1                                              keys_first1,
                                    InputIterator1                                              keys_last1,
                                    InputIterator2                                              keys_first2,
                                    InputIterator2                                              keys_last2,
...
__host__ __device__
  thrust::pair<OutputIterator1,OutputIterator2>
    set_union_by_key(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                     InputIterator1                                              keys_first1,
                     InputIterator1                                              keys_last1,
                     InputIterator2                                              keys_first2,
                     InputIterator2                                              keys_last2,
