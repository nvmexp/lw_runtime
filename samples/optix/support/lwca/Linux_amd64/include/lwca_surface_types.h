...
#if !defined(__LWDA_SURFACE_TYPES_H__)
#define __LWDA_SURFACE_TYPES_H__
...
struct __device_builtin_surface_type__ surface : public surfaceReference
{
  ...
  __host__ surface(struct lwdaChannelFormatDesc desc)
  {
    channelDesc = desc;
  }
#endif /* !__LWDACC_RTC__ */  
...
struct  __device_builtin_surface_type__  surface<void, dim> : public surfaceReference
{
  ...
  __host__ surface(void)
  {
    channelDesc = lwdaCreateChannelDesc<void>();
  }
#endif /* !__LWDACC_RTC__ */  
};
...
#endif /* !__LWDA_SURFACE_TYPES_H__ */
