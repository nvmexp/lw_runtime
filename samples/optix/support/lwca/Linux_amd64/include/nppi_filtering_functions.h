 /* Copyright 2009-2021 LWPU Corporation.  All rights reserved. 
  * 
  * NOTICE TO LICENSEE: 
  * 
 ...
 * The set colwolution functions available in the library.
 * @{
 *
 */
...
/**
 * Single channel 16-bit floating point colwolution filter.
 * 
 * For common parameter descriptions, see <a href="#CommonFilter32fParameters">Common parameters for nppiFilter32f functions</a>.
 *
 */
...
/**
 * Three channel 16-bit floating point colwolution filter.
 * 
 * For common parameter descriptions, see <a href="#CommonFilter32fParameters">Common parameters for nppiFilter32f functions</a>.
 *
 */
...
/**
 * Four channel 16-bit floating point colwolution filter.
 * 
 * For common parameter descriptions, see <a href="#CommonFilter32fParameters">Common parameters for nppiFilter32f functions</a>.
 *
 */
...
/**
 * Single channel 16-bit floating point colwolution filter with border control.
 * 
 * For common parameter descriptions, see <a href="#CommonFilterBorder32fParameters">Common parameters for nppiFilterBorder32f functions</a>.
 *
 */
...
/**
 * Three channel 16-bit floating point colwolution filter with border control.
 * 
 * For common parameter descriptions, see <a href="#CommonFilterBorder32fParameters">Common parameters for nppiFilterBorder32f functions</a>.
 *
 */
...
/**
 * Four channel 16-bit floating point colwolution filter with border control.
 * 
 * For common parameter descriptions, see <a href="#CommonFilterBorder32fParameters">Common parameters for nppiFilterBorder32f functions</a>.
 *
 */
...
nppiFilterThresholdAdaptiveBoxBorder_8u_C1R_Ctx(const Npp8u * pSrc, Npp32s nSrcStep, NppiSize oSrcSize, NppiPoint oSrcOffset, Npp8u * pDst, Npp32s nDstStep, NppiSize oSizeROI, 
                                                NppiSize oMaskSize, Npp32f nDelta, Npp8u lwalGT, Npp8u lwalLE, NppiBorderType eBorderType, NppStreamContext nppStreamCtx);
...
nppiFilterBilateralGaussBorder_8u_C1R_Ctx(const Npp8u * pSrc, Npp32s nSrcStep, NppiSize oSrcSize, NppiPoint oSrcOffset, Npp8u * pDst, Npp32s nDstStep, NppiSize oSizeROI,
                                          const int nRadius, const int nStepBetweenSrcPixels, const Npp32f lwalSquareSigma, const Npp32f nPosSquareSigma, NppiBorderType eBorderType, NppStreamContext nppStreamCtx);
...
/**
 * Callwlate scratch buffer size needed for the DistanceTransformPBA function based on destination image SizeROI width and height.
 *
 * \param oSizeROI \ref roi_specification.
...
/**
 * Callwlate scratch buffer size needed for the SignedDistanceTransformShiftPBA function based on destination image SizeROI width and height.
 *
 * \param oSizeROI \ref roi_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 ...
 * This function exelwtes in two passes, the first pass prioritizes pixels outside of closed regions, the second pass 
 ...
 * \param pSrc \ref source_image_pointer.
 * \param nSrcStep \ref source_image_line_step.
 * \param nLwtoffValue source image pixel values < nLwtoffValue will be considered fully outside of pixel regions (and set to -1).
...
/**
 * Callwlate scratch buffer size needed for the FloodFill function based on destination image oSizeROI width and height.
 *
 * \param oSizeROI \ref roi_specification.
...
/**
 * Callwlate scratch buffer size needed for 1 channel 8-bit unsigned integer LabelMarkers function based on destination image oSizeROI width and height.
 *
 * \param oSizeROI \ref roi_specification.
 * \param hpBufferSize Required buffer size in bytes.
 *  
...
/**
 * Callwlate scratch buffer size needed for 1 channel 8-bit to 1 channel 32-bit unsigned integer LabelMarkers function based on destination image oSizeROI width and height.
 *
 * \param oSizeROI \ref roi_specification.
 * \param hpBufferSize Required buffer size in bytes.
 *  
...
/**
 * Callwlate scratch buffer size needed for 1 channel 16-bit unsigned integer LabelMarkers function based on destination image oSizeROI width and height.
 *
 * \param oSizeROI \ref roi_specification.
 * \param hpBufferSize Required buffer size in bytes.
 *  
 ...
 * non-zero pixel region bounded by pixel values less than or equal to nMilwal. 
 ...
 * generated in the first pass.  However during colwergence passes higher label ID numbers in connected regions containing
 ...
 * case ID values will roll over causing some to be used on multiple connected regions.  If this oclwrs for 8 bit data 
 * it is recommended that you use the 8u32u version of the function for 8 bit data. Pixels not connected
 * to any connected region like those with values less than or equal to nMilwal will be assigned a marker label ID value of 0. 
 *
 * Before calling any of the LabelMarkers functions the application first needs to call the corresponding
 ...
 * \param oSizeROI \ref roi_specification.
 * \param nMilwal Pixel values less than or equal to nMilwal will be excluded as members of any connected region and given a label ID of 0.
 * \param eNorm Type of pixel connectivity test to use, nppiNormInf will use 8 way connectivity and nppiNormL1 will use 4 way connectivity. 
...
nppiLabelMarkers_8u_C1IR_Ctx(Npp8u * pSrcDst, int nSrcDstStep, NppiSize oSizeROI, 
                             Npp8u nMilwal, NppiNorm eNorm, int * pNumber, Npp8u * pBuffer, NppStreamContext nppStreamCtx);

NppStatus 
nppiLabelMarkers_8u_C1IR(Npp8u * pSrcDst, int nSrcDstStep, NppiSize oSizeROI, 
                         Npp8u nMilwal, NppiNorm eNorm, int * pNumber, Npp8u * pBuffer);
...
nppiLabelMarkers_16u_C1IR_Ctx(Npp16u * pSrcDst, int nSrcDstStep, NppiSize oSizeROI, 
                              Npp16u nMilwal, NppiNorm eNorm, int * pNumber, Npp8u * pBuffer, NppStreamContext nppStreamCtx);

NppStatus 
nppiLabelMarkers_16u_C1IR(Npp16u * pSrcDst, int nSrcDstStep, NppiSize oSizeROI, 
                          Npp16u nMilwal, NppiNorm eNorm, int * pNumber, Npp8u * pBuffer);
...
/**
 * Callwlate scratch buffer size needed 1 channel 32-bit unsigned integer LabelMarkersUF function based on destination image oSizeROI width and height.
 *
 * \param oSizeROI \ref roi_specification.
 * \param hpBufferSize Required buffer size in bytes.
 */
 ...
 * Note that these functions lwrrently only support image ROI sizes up to 4 gigapixels. Also note that while these functions support destination image pitches that 
 * are not exactly equal to oSizeROI.width * sizeof(Npp32u) it can avoid a lwdaMemCpyAsync() call to copy the final result from the working buffer to the destination 
 ...
 *  
 * Note that the destination image in these functions must be allocated with lwdaMalloc() and NOT lwdaMallocPitch(). 
 ...
 * be numeric gaps between sequential marker IDs.  To limit the number of marker IDs generated the application should pass the image 
 * through a threshold filter before calling this funcion.  Doing so however does not necessarily limit the maximum marker ID value generated by this function. 
 * Note that these functions lwrrently only support image ROI sizes up to 4 gigapixels. Also note that these functions work directly in the destination image 
 ...
 * for you use the single image version of these functions or lwdaMemCopy2D can be called for each output image to restore the original pitch. Note that all source and destination images in the batch list must contain enough device memory 
 * to support the full ROI size. ROIs in descriptor lists are ignored in these functions.
 *  
 * The algorithm used in this implementation is based on the one described in "An Optimized Union-Find Algorithm for Connected Components Labeling Using GPUs" by Jun Chen and others. 
 *  
 * Note that the destination images in these functions must be allocated with lwdaMalloc() and NOT lwdaMallocPitch(). 
 * Also the pitch of the output image MUST be set to oSizeROI.width * sizeof(Npp32u).
 *
 * @{
 *
 ...
 * than that of the output will be in that format. If this doesn't work for you use the single image version of these functions or lwdaMemCopy2D can be called for each output 
...
/**
 * Callwlate scratch buffer size needed for 1 channel 8-bit unsigned integer CompressMarkerLabels function based on the number returned in pNumber from a previous nppiLabelMarkers call.
 *
...
/**
 * Callwlate scratch buffer size needed for 1 channel 32-bit unsigned integer to 8-bit unsigned integer CompressMarkerLabels function based on the number returned in pNumber from a previous nppiLabelMarkers call.
 *
...
/**
 * Callwlate scratch buffer size needed for 1 channel 16-bit unsigned integer CompressMarkerLabels function based on the number returned in pNumber from a previous nppiLabelMarkers call.
 *
...
/**
 * Callwlate scratch buffer size needed for 1 channel 32-bit unsigned integer to 16-bit unsigned integer CompressMarkerLabels function based on the number returned in pNumber from a previous nppiLabelMarkers call.
 *
 * \param nStartingNumber The value returned from a previous call to the nppiLabelMarkers_8u32u function or ROI width * ROI height for images generated by the nppiLabelMarkersUF funcions.
 * \param hpBufferSize Required buffer size in bytes.
 *    
...
/**
 * Callwlate scratch buffer size needed for 1 channel 32-bit unsigned integer CompressMarkerLabels function based on the number returned in pNumber from a previous nppiLabelMarkers call.
 ...
 * \return \ref image_data_error_codes, \ref roi_error_codes. 
 *  
 * Note that the image in this function must be allocated with lwdaMalloc() and NOT lwdaMallocPitch(). 
 ...
 *    
 * Also note that the images in this function must be allocated with lwdaMalloc() and NOT lwdaMallocPitch(). 
 ...
 *    
 * Also note that the input image in this function must have been allocated with lwdaMalloc() and NOT lwdaMallocPitch(). 
...
/**
 * Callwlate the size of device memory needed for the CompressedMarkerLabelsGetInfoList function based on nMaxMarkerLabelID value 
 ...
 * \return \ref image_data_error_codes, \ref roi_error_codes. 
 *  
 * Note that the input image in this function must be allocated with lwdaMalloc() and NOT lwdaMallocPitch(). 
 * Also the pitch MUST be set to oSizeROI.width * sizeof(Npp32u).  And the image pointer and oSizeROI values MUST match those used when nppiLabelMarkersUF was called.
 *    
 */
 ...
 *
 * Before calling any of the CompressedMarkerLabelsUFContourGeometryLists function the application first needs to call the corresponding
 * CompressedMarkerLabelsUFGetGeometryListsSize to determine the amount of device memory to allocate to receive the contour 
 * geometry lists for up to nMaxMarkerLabelID contours in the image. 
 *  
 * Note that these functions are only supported for output from the UF versions of LabelMarkers functions. Also the pointer to 
 * the beginning of the compressed marker labels image and ROI that was used when generating the compressed marker labels image MUST be used.
 *    
 * Also note that the input images and output list memory for this function must have been allocated in device memory. 
 *  
 * @{
 *
 */
...
/**
 * Callwlate the size of device memory needed for the CompressedMarkerLabelsUFContourGeometryLists function based on nMaxMarkerLabelID value 
 * returned by previous call to CompressMarkerLabelsUF function and oContourTotalsInfo.nLongestImageContourPixelCount returned by 
 * the previous call to the nppiCompressedMarkerLabelsUFInfo function. 
 *
 * \param nMaxMarkerLabelID value returned by previous call to CompressMarkerLabelsUF for this image. 
 * \param nLongestImageContourPixelCount pixel count of the longest contour in the image.  
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return \ref image_data_error_codes, \ref roi_error_codes
 */
NppStatus
nppiCompressedMarkerLabelsUFGetGeometryListsSize_C1R(unsigned int nMaxMarkerLabelID, unsigned int nLongestImageContourPixelCount, unsigned int * hpBufferSize);

/**
 * 1 channel connected region contours image to contours geometry info list in device memory. 
 *  
 * Note that ALL input and output data for the function MUST be in device memory. 
 * Also nFirstContourID and nLastContourID allow only a portion of the contour geometry lists in the image to be output. 
 *  
 * \param pMarkerLabelsInfoList \ref source_image_pointer to buffer which contains the output returned by the corresponding nppiCompressedMarkerLabelsUFInfo_32u_C1R_Ctx call.
 * \param pContoursImage \ref source_image_pointer to output image containing contours (boundaries) around each uniquely labeled connected pixel region returned by corresponding nppiCompressedMarkerLabelsUFInfo call. 
 * \param nContoursImageStep image_line_step for contours image. 
 * \param pContoursDirectionImage \ref source_image_pointer to output image containing per contour pixel direction info around each uniquely labeled connected pixel region returned by corresponding nppiCompressedMarkerLabelsUFInfo call. 
 * \param nContoursDirectionImageStep image_line_step for contours image. 
 * \param pContoursGeometryLists pointer to device memory buffer allocated to be at least as big as size returned by corresponding nppiCompressedMarkerLabelsUFGetGeometryListsSize call. 
 ...
 * \param nLongestImageContourPixelCount NppiContourTotalsInfo.nLongestImageContourPixelCount value returned by corresponding  nppiCompressedMarkerLabelsUFInfo_32u_C1R_Ctx call.
 * \param nMaxMarkerLabelID the value of the maximum marker label ID returned by corresponding compress marker labels UF call. 
 ...
 * \return \ref image_data_error_codes, \ref roi_error_codes. 
 *  
 * Note that the geometry list for each contour will begin at pContoursGeometryListsHost[nContourID * nLongestImageContourPixelCount]. 
 *  
 */ 

NppStatus
nppiCompressedMarkerLabelsUFContoursPixelGeometryLists_C1R_Ctx(NppiCompressedMarkerLabelsInfo * pMarkerLabelsInfoList,
                                                               Npp8u * pContoursImage, Npp32s nContoursImageStep,
                                                               NppiContourPixelDirectionInfo * pContoursDirectionImage, Npp32s nContoursDirectionImageStep,
                                                               NppiContourPixelGeometryInfo * pContoursPixelGeometryLists,
                                                               Npp32u * pContoursPixelCountsListHost,
                                                               unsigned int nLongestImageContourPixelCount,
                                                               unsigned int nMaxMarkerLabelID,
                                                               unsigned int nFirstContourGeometryListID,
                                                               unsigned int nLastContourGeometryListID,
                                                               NppiSize oSizeROI,
                                                               NppStreamContext nppStreamCtx);
...
/**
 * Callwlate scratch buffer sizes needed for 1 channel 8-bit unsigned integer watershed segmentation function based on destination image oSizeROI width and height.
 *  
 * \param oSizeROI \ref roi_specification. 
...
/**
 * Callwlate scratch buffer sizes needed for 1 channel 16-bit unsigned integer watershed segmentation function based on destination image oSizeROI width and height.
 *  
 * \param oSizeROI \ref roi_specification. 
 * \param hpDeviceMemoryBufferSize  Required device memory buffer size in bytes. 
 * \return \ref image_data_error_codes, \ref roi_error_codes
