 /* Copyright 2009-2018 LWPU Corporation.  All rights reserved. 
  * 
  * NOTICE TO LICENSEE: 
  * 
...
NppStatus nppiThreshold_Val_8u_C1R_Ctx(const Npp8u * pSrc, int nSrcStep,
                                             Npp8u * pDst, int nDstStep, 
                                       NppiSize oSizeROI, 
                                       const Npp8u nThreshold, const Npp8u lwalue, NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx); 
...
NppStatus nppiThreshold_Val_16u_C1R_Ctx(const Npp16u * pSrc, int nSrcStep,
                                              Npp16u * pDst, int nDstStep, 
                                        NppiSize oSizeROI, 
                                        const Npp16u nThreshold, const Npp16u lwalue, NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx); 
...
NppStatus nppiThreshold_Val_16s_C1R_Ctx(const Npp16s * pSrc, int nSrcStep,
                                              Npp16s * pDst, int nDstStep, 
                                        NppiSize oSizeROI, 
                                        const Npp16s nThreshold, const Npp16s lwalue, NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx); 
...
NppStatus nppiThreshold_Val_32f_C1R_Ctx(const Npp32f * pSrc, int nSrcStep,
                                              Npp32f * pDst, int nDstStep, 
                                        NppiSize oSizeROI, 
                                        const Npp32f nThreshold, const Npp32f lwalue, NppCmpOp eComparisonOperation, NppStreamContext nppStreamCtx); 
 ...
 *
 * <h3><a name="CommonThresholdGreaterThalwalueParameters">Common parameters for nppiThreshold_GTVal non-inplace and inplace functions include:</a></h3>
 *
 * \param pSrcDst \ref in_place_image_pointer for inplace functions.
 * \param nSrcDstStep \ref in_place_image_line_step for inplace functions.
 * \param pSrc \ref source_image_pointer for non-inplace functions.
 ...
 * to lwalue, otherwise it is set to sourcePixel.
 * 
 * For common parameter descriptions, see <a href="#CommonThresholdGreaterThalwalueParameters">Common parameters for nppiThreshold_GTVal functions</a>.
 *
 */
NppStatus nppiThreshold_GTVal_8u_C1R_Ctx(const Npp8u * pSrc, int nSrcStep,
                                               Npp8u * pDst, int nDstStep, 
                                         NppiSize oSizeROI, 
                                         const Npp8u nThreshold, const Npp8u lwalue, NppStreamContext nppStreamCtx); 
...
NppStatus nppiThreshold_GTVal_16u_C1R_Ctx(const Npp16u * pSrc, int nSrcStep,
                                                Npp16u * pDst, int nDstStep, 
                                          NppiSize oSizeROI, 
                                          const Npp16u nThreshold, const Npp16u lwalue, NppStreamContext nppStreamCtx); 
...
NppStatus nppiThreshold_GTVal_16s_C1R_Ctx(const Npp16s * pSrc, int nSrcStep,
                                                Npp16s * pDst, int nDstStep, 
                                          NppiSize oSizeROI, 
                                          const Npp16s nThreshold, const Npp16s lwalue, NppStreamContext nppStreamCtx); 
...
NppStatus nppiThreshold_GTVal_32f_C1R_Ctx(const Npp32f * pSrc, int nSrcStep,
                                                Npp32f * pDst, int nDstStep, 
                                          NppiSize oSizeROI, 
                                          const Npp32f nThreshold, const Npp32f lwalue, NppStreamContext nppStreamCtx); 
 ...
 *
 * <h3><a name="CommonThresholdLessThalwalueParameters">Common parameters for nppiThreshold_LTVal non-inplace and inplace functions include:</a></h3>
 *
 * \param pSrcDst \ref in_place_image_pointer for inplace functions.
 * \param nSrcDstStep \ref in_place_image_line_step for inplace functions.
 * \param pSrc \ref source_image_pointer for non-inplace functions.
 ...
 * to lwalue, otherwise it is set to sourcePixel.
 * 
 * For common parameter descriptions, see <a href="#CommonThresholdLessThalwalueParameters">Common parameters for nppiThreshold_LTVal functions</a>.
 *
 */
 ...
 *
 * <h3><a name="CommonThresholdLessThalwalueGreaterThalwalueParameters">Common parameters for nppiThreshold_LTValGTVal non-inplace and inplace functions include:</a></h3>
 *
 * \param pSrcDst \ref in_place_image_pointer for inplace functions.
 * \param nSrcDstStep \ref in_place_image_line_step for inplace functions.
 * \param pSrc \ref source_image_pointer for non-inplace functions.
 ...
 * 
 * For common parameter descriptions, see <a href="#CommonThresholdLessThalwalueGreaterThalwalueParameters">Common parameters for nppiThreshold_LTValGTVal functions</a>.
 *
 */
NppStatus nppiThreshold_LTValGTVal_8u_C1R_Ctx(const Npp8u * pSrc, int nSrcStep,
                                                    Npp8u * pDst, int nDstStep, 
                                              NppiSize oSizeROI, 
                                              const Npp8u nThresholdLT, const Npp8u lwalueLT, const Npp8u nThresholdGT, const Npp8u lwalueGT, NppStreamContext nppStreamCtx); 
...
NppStatus nppiThreshold_LTValGTVal_16u_C1R_Ctx(const Npp16u * pSrc, int nSrcStep,
                                                     Npp16u * pDst, int nDstStep, 
                                               NppiSize oSizeROI, 
                                               const Npp16u nThresholdLT, const Npp16u lwalueLT, const Npp16u nThresholdGT, const Npp16u lwalueGT, NppStreamContext nppStreamCtx); 
...
NppStatus nppiThreshold_LTValGTVal_16s_C1R_Ctx(const Npp16s * pSrc, int nSrcStep,
                                                     Npp16s * pDst, int nDstStep, 
                                               NppiSize oSizeROI, 
                                               const Npp16s nThresholdLT, const Npp16s lwalueLT, const Npp16s nThresholdGT, const Npp16s lwalueGT, NppStreamContext nppStreamCtx); 
...
NppStatus nppiThreshold_LTValGTVal_32f_C1R_Ctx(const Npp32f * pSrc, int nSrcStep,
                                                     Npp32f * pDst, int nDstStep, 
                                               NppiSize oSizeROI, 
                                               const Npp32f nThresholdLT, const Npp32f lwalueLT, const Npp32f nThresholdGT, const Npp32f lwalueGT, NppStreamContext nppStreamCtx); 
