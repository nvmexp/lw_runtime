...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__  typename __lw_tex_rmet_ret<T>::type tex1Dfetch(texture<T, lwdaTextureType1D, lwdaReadModeElementType> t, int x)
{
#ifdef __LWDA_ARCH__
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex1Dfetch(texture<T, lwdaTextureType1D, lwdaReadModeNormalizedFloat> t, int x) 
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
...
// tex1D
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex1D(texture<T, lwdaTextureType1D, lwdaReadModeElementType> t, float x)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex1D(texture<T, lwdaTextureType1D, lwdaReadModeNormalizedFloat> t, float x)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
//tex2D
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex2D(texture<T, lwdaTextureType2D, lwdaReadModeElementType> t, float x, float y)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex2D(texture<T, lwdaTextureType2D, lwdaReadModeNormalizedFloat> t, float x, float y)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
//tex1DLayered
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex1DLayered(texture<T, lwdaTextureType1DLayered, lwdaReadModeElementType> t, float x, int layer)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex1DLayered(texture<T, lwdaTextureType1DLayered, lwdaReadModeNormalizedFloat> t, float x, int layer)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
//tex2DLayered
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex2DLayered(texture<T, lwdaTextureType2DLayered, lwdaReadModeElementType> t, float x, float y, int layer)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex2DLayered(texture<T, lwdaTextureType2DLayered, lwdaReadModeNormalizedFloat> t, float x, float y, int layer)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex3D
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex3D(texture<T, lwdaTextureType3D, lwdaReadModeElementType> t, float x, float y, float z)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex3D(texture<T, lwdaTextureType3D, lwdaReadModeNormalizedFloat> t, float x, float y, float z)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// texLwbemap
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type texLwbemap(texture<T, lwdaTextureTypeLwbemap, lwdaReadModeElementType> t, float x, float y, float z)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type texLwbemap(texture<T, lwdaTextureTypeLwbemap, lwdaReadModeNormalizedFloat> t, float x, float y, float z)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex1DLod
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex1DLod(texture<T, lwdaTextureType1D, lwdaReadModeElementType> t, float x, float level)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex1DLod(texture<T, lwdaTextureType1D, lwdaReadModeNormalizedFloat> t, float x, float level)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex2DLod
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex2DLod(texture<T, lwdaTextureType2D, lwdaReadModeElementType> t, float x, float y, float level)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex2DLod(texture<T, lwdaTextureType2D, lwdaReadModeNormalizedFloat> t, float x, float y, float level)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex1DLayeredLod
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex1DLayeredLod(texture<T, lwdaTextureType1DLayered, lwdaReadModeElementType> t, float x, int layer, float level)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex1DLayeredLod(texture<T, lwdaTextureType1DLayered, lwdaReadModeNormalizedFloat> t, float x, int layer, float level)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex2DLayeredLod
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex2DLayeredLod(texture<T, lwdaTextureType2DLayered, lwdaReadModeElementType> t, float x, float y, int layer, float level)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex2DLayeredLod(texture<T, lwdaTextureType2DLayered, lwdaReadModeNormalizedFloat> t, float x, float y, int layer, float level)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex3DLod
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex3DLod(texture<T, lwdaTextureType3D, lwdaReadModeElementType> t, float x, float y, float z, float level)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex3DLod(texture<T, lwdaTextureType3D, lwdaReadModeNormalizedFloat> t, float x, float y, float z, float level)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// texLwbemapLod
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type texLwbemapLod(texture<T, lwdaTextureTypeLwbemap, lwdaReadModeElementType> t, float x, float y, float z, float level)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type texLwbemapLod(texture<T, lwdaTextureTypeLwbemap, lwdaReadModeNormalizedFloat> t, float x, float y, float z, float level)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// texLwbemapLayered
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type texLwbemapLayered(texture<T, lwdaTextureTypeLwbemapLayered, lwdaReadModeElementType> t, float x, float y, float z, int layer)
{
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type texLwbemapLayered(texture<T, lwdaTextureTypeLwbemapLayered, lwdaReadModeNormalizedFloat> t, float x, float y, float z, int layer)
{
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type texLwbemapLayeredLod(texture<T, lwdaTextureTypeLwbemapLayered, lwdaReadModeElementType> t, float x, float y, float z, int layer, float level)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type texLwbemapLayeredLod(texture<T, lwdaTextureTypeLwbemapLayered, lwdaReadModeNormalizedFloat> t, float x, float y, float z, int layer, float level)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// texLwbemapGrad
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type texLwbemapGrad(texture<T, lwdaTextureTypeLwbemap, lwdaReadModeElementType> t, float x, float y, float z, float4 dPdx, float4 dPdy)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type texLwbemapGrad(texture<T, lwdaTextureTypeLwbemap, lwdaReadModeNormalizedFloat> t, float x, float y, float z, float4 dPdx, float4 dPdy)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type texLwbemapLayeredGrad(texture<T, lwdaTextureTypeLwbemapLayered, lwdaReadModeElementType> t, float x, float y, float z, int layer, float4 dPdx, float4 dPdy)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type texLwbemapLayeredGrad(texture<T, lwdaTextureTypeLwbemapLayered, lwdaReadModeNormalizedFloat> t, float x, float y, float z, int layer, float4 dPdx, float4 dPdy) 
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex1DGrad
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex1DGrad(texture<T, lwdaTextureType1D, lwdaReadModeElementType> t, float x, float dPdx, float dPdy)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex1DGrad(texture<T, lwdaTextureType1D, lwdaReadModeNormalizedFloat> t, float x, float dPdx, float dPdy)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex2DGrad
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex2DGrad(texture<T, lwdaTextureType2D, lwdaReadModeElementType> t, float x, float y, float2 dPdx, float2 dPdy)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex2DGrad(texture<T, lwdaTextureType2D, lwdaReadModeNormalizedFloat> t, float x, float y, float2 dPdx, float2 dPdy)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex1DLayeredGrad
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex1DLayeredGrad(texture<T, lwdaTextureType1DLayered, lwdaReadModeElementType> t, float x, int layer, float dPdx, float dPdy)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex1DLayeredGrad(texture<T, lwdaTextureType1DLayered, lwdaReadModeNormalizedFloat> t, float x, int layer, float dPdx, float dPdy)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex2DLayeredGrad
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex2DLayeredGrad(texture<T, lwdaTextureType2DLayered, lwdaReadModeElementType> t, float x, float y, int layer, float2 dPdx, float2 dPdy)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex2DLayeredGrad(texture<T, lwdaTextureType2DLayered, lwdaReadModeNormalizedFloat> t, float x, float y, int layer, float2 dPdx, float2 dPdy)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
...
// tex3DGrad
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmet_ret<T>::type tex3DGrad(texture<T, lwdaTextureType3D, lwdaReadModeElementType> t, float x, float y, float z, float4 dPdx, float4 dPdy)
{ 
#ifdef __LWDA_ARCH__
  typename __lw_tex_rmet_ret<T>::type temp;
...
template <typename T>
static __DEPRECATED__ __forceinline__ __device__ typename __lw_tex_rmnf_ret<T>::type tex3DGrad(texture<T, lwdaTextureType3D, lwdaReadModeNormalizedFloat> t, float x, float y, float z, float4 dPdx, float4 dPdy)
{ 
#ifdef __LWDA_ARCH__
  T type_dummy;
  typename __lw_tex_rmnf_ret<T>::type retval;
