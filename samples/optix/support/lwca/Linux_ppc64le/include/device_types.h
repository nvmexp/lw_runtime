...
#define __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_DEVICE_TYPES_H__
#endif
...
enum __device_builtin__ lwdaRoundMode
{
    lwdaRoundNearest,
    lwdaRoundZero,
    lwdaRoundPosInf,
...
#if defined(__UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_DEVICE_TYPES_H__)
#undef __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#undef __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_DEVICE_TYPES_H__
#endif
