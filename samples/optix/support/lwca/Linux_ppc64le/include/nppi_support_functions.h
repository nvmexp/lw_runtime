  ...
  * Users Notice. 
  */ 
#ifndef LW_NPPI_SUPPORT_FUNCTIONS_H
#define LW_NPPI_SUPPORT_FUNCTIONS_H
 ...
 * are provided for colwenience. They allocate memory that may contain additional
 ...
 * beneficial for performance. It is not mandatory to use these allocators. Any valid LWCA device-memory
...
#endif /* LW_NPPI_SUPPORT_FUNCTIONS_H */
