  ...
  * Users Notice. 
  */ 
#ifndef LW_NPPS_STATISTICS_FUNCTIONS_H
#define LW_NPPS_STATISTICS_FUNCTIONS_H
 ...
 * Callwlates the standard deviation for the samples of a signal.
 * @{
 *
 */
 ...
 * Performs the mean and callwlates the standard deviation for the samples of a signal.
 * @{
 *
 */
 ...
 * Callwlates the number of elements from specified range in the samples of a signal.
 * @{
 *
 */
 ...
 *
 * @{
 * Callwlates the number of zero crossings in a signal.
 */
...
#endif /* LW_NPPS_STATISTICS_FUNCTIONS_H */
