...
/*! \file thrust/system/omp/exelwtion_policy.h
 *  \brief Exelwtion policies for Thrust's OpenMP system.
 */

#include <thrust/detail/config.h>

// get the exelwtion policies definitions first
#include <thrust/system/omp/detail/exelwtion_policy.h>
...
/*! \p thrust::omp::exelwtion_policy is the base class for all Thrust parallel exelwtion
 ...
 *  Iterators "tagged" with a type which is colwertible to \p omp::tag assert that they may be
 *  "dispatched" to algorithm implementations in the \p omp system.
 */
struct tag : thrust::system::omp::exelwtion_policy<tag> { unspecified };


/*! \p thrust::omp::par is the parallel exelwtion policy associated with Thrust's OpenMP
 *  backend system.
 *
 ...
 *  #include <thrust/system/omp/exelwtion_policy.h>
 *  #include <cstdio>
 *
