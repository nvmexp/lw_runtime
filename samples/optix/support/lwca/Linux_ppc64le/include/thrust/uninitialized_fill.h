 ...
 *  uninitialized memory using the \p thrust::device exelwtion policy for parallelization:
 *
 *  \code
...
__host__ __device__
  void uninitialized_fill(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
...
__host__ __device__
  ForwardIterator uninitialized_fill_n(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                       ForwardIterator first,
                                       Size n,
                                       const T &x);
