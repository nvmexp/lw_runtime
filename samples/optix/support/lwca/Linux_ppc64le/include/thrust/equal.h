 ...
 *  two ranges for equality using the \p thrust::host exelwtion policy:
 *
 *  \code
...
__host__ __device__
bool equal(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec, InputIterator1 first1, InputIterator1 last1, InputIterator2 first2);
 ...
 *  \tparam DerivedPolicy The name of the derived exelwtion policy.
 *  \tparam InputIterator1 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          and \p InputIterator1's \c value_type is colwertible to \p BinaryPredicate's \c first_argument_type.
 *  \tparam InputIterator2 is a model of <a href="http://www.sgi.com/tech/stl/InputIterator.html">Input Iterator</a>,
 *          and \p InputIterator2's \c value_type is colwertible to \p BinaryPredicate's \c second_argument_type.
 ...
 *  elements in two ranges modulo 2 using the \p thrust::host exelwtion policy.
 *
 *  \code
 *  #include <thrust/equal.h>
 *  #include <thrust/exelwtion_policy.h>
...
__host__ __device__
bool equal(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec, InputIterator1 first1, InputIterator1 last1, InputIterator2 first2, BinaryPredicate binary_pred);
