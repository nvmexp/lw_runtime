 ...
 *         until lwcc can compile tr1::type_traits.
 */
...
template<typename From, typename To>
  struct is_colwertible_needs_simple_test
{
...
}; // end is_colwertible_needs_simple_test


template<typename From, typename To,
         bool = is_colwertible_needs_simple_test<From,To>::value>
...
template<typename From, typename To>
  struct is_colwertible<From, To, false>
{
  static const bool value = (is_colwertible_sfinae<typename
...
template<typename From, typename To>
  struct is_colwertible
    : public integral_constant<bool, tt_detail::is_colwertible<From, To>::value>
{
}; // end is_colwertible
...
template<typename T1, typename T2>
  struct is_one_colwertible_to_the_other
    : public integral_constant<
        bool,
        is_colwertible<T1,T2>::value || is_colwertible<T2,T1>::value
      >
{};
...
template<typename T>
//  struct identity
//  XXX WAR lwcc's confusion with thrust::identity
  struct identity_
{
  typedef T type;
}; // end identity
...
template<typename T1, typename T2, typename T = void>
  struct enable_if_colwertible
    : enable_if< is_colwertible<T1,T2>::value, T >
{};


template<typename T1, typename T2, typename T = void>
  struct disable_if_colwertible
    : disable_if< is_colwertible<T1,T2>::value, T >
{};
...
template<typename T>
  struct is_numeric
    : and_<
        is_colwertible<int,T>,
        is_colwertible<T,int>
      >
{
}; // end is_numeric
