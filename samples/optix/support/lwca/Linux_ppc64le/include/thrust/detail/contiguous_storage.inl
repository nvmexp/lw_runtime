...
template<typename T, typename Alloc>
  ...
  __host__ __device__
    typename contiguous_storage<T,Alloc>::iterator
      contiguous_storage<T,Alloc>
        ::uninitialized_copy(thrust::exelwtion_policy<System> &from_system, InputIterator first, InputIterator last, iterator result)
{
...
template<typename T, typename Alloc>
  ...
  __host__ __device__
    typename contiguous_storage<T,Alloc>::iterator
      contiguous_storage<T,Alloc>
        ::uninitialized_copy_n(thrust::exelwtion_policy<System> &from_system, InputIterator first, Size n, iterator result)
{
