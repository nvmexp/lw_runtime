...
struct exelwte_with_dependencies
    : BaseSystem<exelwte_with_dependencies<BaseSystem, Dependencies...>>
{
private:
    using super_t = BaseSystem<exelwte_with_dependencies<BaseSystem, Dependencies...>>;

    std::tuple<remove_cvref_t<Dependencies>...> dependencies;

public:
    __host__
    exelwte_with_dependencies(super_t const &super, Dependencies && ...dependencies)
    ...
    __host__
    exelwte_with_dependencies(super_t const &super, UDependencies && ...deps)
    ...
    template <typename... UDependencies>
    __host__
    exelwte_with_dependencies(UDependencies && ...deps)
    ...
    template <typename... UDependencies>
    __host__
    exelwte_with_dependencies(super_t const &super, std::tuple<UDependencies...>&& deps)
    ...
    template <typename... UDependencies>
    __host__
    exelwte_with_dependencies(std::tuple<UDependencies...>&& deps)
    ...
    template<typename ...UDependencies>
    __host__
    exelwte_with_dependencies<BaseSystem, UDependencies...>
...
>
struct exelwte_with_allocator_and_dependencies
    : BaseSystem<
        exelwte_with_allocator_and_dependencies<
            Allocator,
            BaseSystem,
            Dependencies...
        >
...
public:
    template <typename... UDependencies>
    __host__
    exelwte_with_allocator_and_dependencies(super_t const &super, Allocator a, UDependencies && ...deps)
    ...
    template <typename... UDependencies>
    __host__
    exelwte_with_allocator_and_dependencies(Allocator a, UDependencies && ...deps)
    ...
    template <typename... UDependencies>
    __host__
    exelwte_with_allocator_and_dependencies(super_t const &super, Allocator a, std::tuple<UDependencies...>&& deps)
    ...
    template <typename... UDependencies>
    __host__
    exelwte_with_allocator_and_dependencies(Allocator a, std::tuple<UDependencies...>&& deps)
    ...
    template<typename ...UDependencies>
    __host__
    exelwte_with_allocator_and_dependencies<Allocator, BaseSystem, UDependencies...>
    rebind_after(UDependencies&& ...udependencies) const
    {
...
__host__
std::tuple<remove_cvref_t<Dependencies>...>
extract_dependencies(thrust::detail::exelwte_with_dependencies<BaseSystem, Dependencies...>&& system)
{
...
__host__
std::tuple<remove_cvref_t<Dependencies>...>
extract_dependencies(thrust::detail::exelwte_with_allocator_and_dependencies<Allocator, BaseSystem, Dependencies...>&& system)
{
    return std::move(system).extract_dependencies();
}
template<typename Allocator, template<typename> class BaseSystem, typename ...Dependencies>
