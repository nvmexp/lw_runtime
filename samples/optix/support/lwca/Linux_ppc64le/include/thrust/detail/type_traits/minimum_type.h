...
struct primitive_minimum_type
  : minimum_type_detail::minimum_type_impl<
      T1,
      T2,
      ::thrust::detail::is_colwertible<T1,T2>::value,
      ::thrust::detail::is_colwertible<T2,T1>::value
    >
{
}; // end primitive_minimum_type

// because some types are not colwertible (even to themselves)
