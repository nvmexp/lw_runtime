...
/// \def THRUST_RETOF(ilwocable, ...)
/// \brief Expands to the type returned by ilwoking an instance of the ilwocable
///        type \a ilwocable with parameters of type \c __VA_ARGS__. Must
///        be called with 1 or fewer parameters to the ilwocable.
///
