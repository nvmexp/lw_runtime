 ...
 *                               and \c InputIterator's \c value_type is colwertible to \c unary_op's input type.
 ...
 *                               is colwertable to \c OutputIterator's \c value_type.
...
__host__ __device__
  OutputIterator transform_inclusive_scan(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                          InputIterator first,
                                          InputIterator last,
...
template<typename DerivedPolicy,
         ...
         typename AssociativeOperator>
__host__ __device__
  OutputIterator transform_exclusive_scan(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
                                          InputIterator first,
                                          InputIterator last,
                                          OutputIterator result,
                                          UnaryFunction unary_op,
