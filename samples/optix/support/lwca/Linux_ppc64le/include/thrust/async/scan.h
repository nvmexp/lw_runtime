...
template <typename DerivedPolicy,
          ...
          typename BinaryOp>
event<DerivedPolicy>
async_inclusive_scan(thrust::exelwtion_policy<DerivedPolicy>&,
                     ForwardIt,
                     Sentinel,
                     OutputIt,
                     BinaryOp)
...
template <typename DerivedPolicy,
          ...
          typename BinaryOp>
event<DerivedPolicy>
async_exclusive_scan(thrust::exelwtion_policy<DerivedPolicy>&,
                     ForwardIt,
                     Sentinel,
                     OutputIt,
                     InitialValueType,
...
struct inclusive_scan_fn final
{
  template <typename DerivedPolicy,
            ...
            typename BinaryOp>
  auto
  operator()(thrust::detail::exelwtion_policy_base<DerivedPolicy> const& exec,
             ForwardIt&& first,
             Sentinel&& last,
             OutputIt&& out,
             BinaryOp&& op) const
  ...
  template <typename ForwardIt,
            ...
            typename OutputIt,
            typename BinaryOp,
            typename = std::enable_if_t<!is_exelwtion_policy_v<remove_cvref_t<ForwardIt>>>>
