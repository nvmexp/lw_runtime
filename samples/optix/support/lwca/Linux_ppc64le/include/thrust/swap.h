 ...
 *          and \p ForwardIterator1's \c value_type must be colwertible to \p ForwardIterator2's \c value_type.
 *  \tparam ForwardIterator2 is a model of <a href="http://www.sgi.com/tech/stl/ForwardIterator.html">Forward Iterator</a>,
 *          and \p ForwardIterator2's \c value_type must be colwertible to \p ForwardIterator1's \c value_type.
 *
 ...
 *  swap the contents of two \c thrust::device_vectors using the \p thrust::device exelwtion
...
__host__ __device__
  ForwardIterator2 swap_ranges(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &exec,
