  ...
  class pointer
{
  public:
     ...
     *  \tparam OtherElement \p OtherElement shall be colwertible to \p Element.
     */
     ...
     *
     *  \tparam OtherPointer The tag associated with \p OtherPointer shall be colwertible to \p Tag,
     *                       and its element type shall be colwertible to \p Element.
     */
    template<typename OtherPointer>
    __host__ __device__
    pointer(const OtherPointer &other,
            typename thrust::detail::enable_if_pointer_is_colwertible<
              OtherPointer,
  ...
  class reference
{
  public:
    ...
    /*! Colwersion operator colwerts this \p reference to \p value_type by
 ...
 *
 *  \pre \p DerivedPolicy must be publically derived from <code>thrust::exelwtion_policy<DerivedPolicy></code>.
 *
...
__host__ __device__
pointer<void,DerivedPolicy> malloc(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &system, std::size_t n);
...
__host__ __device__
pointer<T,DerivedPolicy> malloc(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &system, std::size_t n);
...
get_temporary_buffer(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &system, typename thrust::pointer<T,DerivedPolicy>::difference_type n);
...
__host__ __device__
void free(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &system, Pointer ptr);
...
template<typename DerivedPolicy, typename Pointer>
__host__ __device__
void return_temporary_buffer(const thrust::detail::exelwtion_policy_base<DerivedPolicy> &system, Pointer p, std::ptrdiff_t n);
