      ...
      >::type
{
  ...
  public:
    ...
    , typename detail::enable_if_colwertible<OtherElementIterator, ElementIterator>::type* = 0
    , typename detail::enable_if_colwertible<OtherIndexIterator, IndexIterator>::type* = 0
    )
