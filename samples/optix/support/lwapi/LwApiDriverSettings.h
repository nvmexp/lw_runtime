...
|*   NOTICE TO USER:                                                         *|
|*                                                                           *|
|*   This source code is subject to LWPU ownership rights under U.S.       *|
...
#ifndef _LWAPI_DRIVER_SETTINGS_H_
#define _LWAPI_DRIVER_SETTINGS_H_
...
#define LWDA_EXCLUDED_GPUS_STRING                  L"List of Universal GPU ids"
...
#define FXAA_ALLOW_STRING                          L"LWPU Predefined FXAA Usage"
...
#define SLI_PREDEFINED_GPU_COUNT_STRING            L"LWPU predefined number of GPUs to use on SLI rendering mode"
#define SLI_PREDEFINED_GPU_COUNT_DX10_STRING       L"LWPU predefined number of GPUs to use on SLI rendering mode on DirectX 10"
#define SLI_PREDEFINED_MODE_STRING                 L"LWPU predefined SLI mode"
#define SLI_PREDEFINED_MODE_DX10_STRING            L"LWPU predefined SLI mode on DirectX 10"
...
#define AO_MODE_ACTIVE_STRING                      L"LWPU Predefined Ambient Occlusion Usage"
...
enum ESetting {
    ...
    LWDA_EXCLUDED_GPUS_ID                         = 0x10354FF8,
...
#define    OGL_IMPLICIT_GPU_AFFINITY_ELW_VAR                    L"OGL_DEFAULT_RENDERING_GPU"
...
enum EValues_AA_MODE_METHOD {
    ...
    AA_MODE_METHOD_MULTISAMPLE_2X_QUINLWNX               = 0xF,
...
#define    LWDA_EXCLUDED_GPUS_NONE                              L"none"
#define    LWDA_EXCLUDED_GPUS_NUM_VALUES 1
#define    LWDA_EXCLUDED_GPUS_DEFAULT LWDA_EXCLUDED_GPUS_NONE
...
enum EValues_PS_FRAMERATE_LIMITER {
    ...
    PS_FRAMERATE_LIMITER_ACLWRATE                        = 0x10000000,
...
enum EValues_WKS_API_STEREO_MODE {
    ...
    WKS_API_STEREO_MODE_TWILWIEW                         = 2,
    WKS_API_STEREO_MODE_LW17_SHUTTER_GLASSES_AUTO        = 3,
    WKS_API_STEREO_MODE_LW17_SHUTTER_GLASSES_DAC0        = 4,
    WKS_API_STEREO_MODE_LW17_SHUTTER_GLASSES_DAC1        = 5,
    ...
    WKS_API_STEREO_MODE_ILWERSE_CHECKERBOARD             = 13,
...
#endif // _LWAPI_DRIVER_SETTINGS_H_
