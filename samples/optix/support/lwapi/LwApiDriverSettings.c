...
EValues_AA_MODE_METHOD g_valuesAA_MODE_METHOD[AA_MODE_METHOD_NUM_VALUES] = 
{
    ...
    AA_MODE_METHOD_MULTISAMPLE_2X_QUINLWNX,
...
const wchar_t * g_valuesLWDA_EXCLUDED_GPUS[LWDA_EXCLUDED_GPUS_NUM_VALUES] = 
{
    LWDA_EXCLUDED_GPUS_NONE
};
...
EValues_WKS_API_STEREO_MODE g_valuesWKS_API_STEREO_MODE[WKS_API_STEREO_MODE_NUM_VALUES] = 
{
    ...
    WKS_API_STEREO_MODE_TWILWIEW,
    WKS_API_STEREO_MODE_LW17_SHUTTER_GLASSES_AUTO,
    WKS_API_STEREO_MODE_LW17_SHUTTER_GLASSES_DAC0,
    WKS_API_STEREO_MODE_LW17_SHUTTER_GLASSES_DAC1,
    ...
    WKS_API_STEREO_MODE_ILWERSE_CHECKERBOARD,
...
{
    {OGL_AA_LINE_GAMMA_ID,                 OGL_AA_LINE_GAMMA_STRING,                  4, (LwU32 *)g_valuesOGL_AA_LINE_GAMMA,       OGL_AA_LINE_GAMMA_DISABLED},
    {OGL_DEEP_COLOR_SCANOUT_ID,            OGL_DEEP_COLOR_SCANOUT_STRING,             2, (LwU32 *)g_valuesOGL_DEEP_COLOR_SCANOUT,  OGL_DEEP_COLOR_SCANOUT_ENABLE},
    {OGL_DEFAULT_SWAP_INTERVAL_ID,         OGL_DEFAULT_SWAP_INTERVAL_STRING,          9, (LwU32 *)g_valuesOGL_DEFAULT_SWAP_INTERVAL, OGL_DEFAULT_SWAP_INTERVAL_VSYNC_ONE},
    {OGL_DEFAULT_SWAP_INTERVAL_FRACTIONAL_ID, OGL_DEFAULT_SWAP_INTERVAL_FRACTIONAL_STRING,  2, (LwU32 *)g_valuesOGL_DEFAULT_SWAP_INTERVAL_FRACTIONAL, 0x00000000},
    {OGL_DEFAULT_SWAP_INTERVAL_SIGN_ID,    OGL_DEFAULT_SWAP_INTERVAL_SIGN_STRING,     2, (LwU32 *)g_valuesOGL_DEFAULT_SWAP_INTERVAL_SIGN, OGL_DEFAULT_SWAP_INTERVAL_SIGN_POSITIVE},
    {OGL_EVENT_LOG_SEVERITY_THRESHOLD_ID,  OGL_EVENT_LOG_SEVERITY_THRESHOLD_STRING,   5, (LwU32 *)g_valuesOGL_EVENT_LOG_SEVERITY_THRESHOLD, OGL_EVENT_LOG_SEVERITY_THRESHOLD_CRITICAL},
    {OGL_EXTENSION_STRING_VERSION_ID,      OGL_EXTENSION_STRING_VERSION_STRING,       0, NULL,                                     0x00000000},
    {OGL_FORCE_BLIT_ID,                    OGL_FORCE_BLIT_STRING,                     2, (LwU32 *)g_valuesOGL_FORCE_BLIT,          OGL_FORCE_BLIT_OFF},
    {OGL_FORCE_STEREO_ID,                  OGL_FORCE_STEREO_STRING,                   2, (LwU32 *)g_valuesOGL_FORCE_STEREO,        OGL_FORCE_STEREO_OFF},
    {OGL_MAX_FRAMES_ALLOWED_ID,            OGL_MAX_FRAMES_ALLOWED_STRING,             0, NULL,                                     0x00000002},
    {OGL_MULTIMON_ID,                      OGL_MULTIMON_STRING,                       8, (LwU32 *)g_valuesOGL_MULTIMON,            OGL_MULTIMON_PERFORMANCE_LCD},
    {OGL_OVERLAY_PIXEL_TYPE_ID,            OGL_OVERLAY_PIXEL_TYPE_STRING,             4, (LwU32 *)g_valuesOGL_OVERLAY_PIXEL_TYPE,  OGL_OVERLAY_PIXEL_TYPE_CI},
    {OGL_OVERLAY_SUPPORT_ID,               OGL_OVERLAY_SUPPORT_STRING,                3, (LwU32 *)g_valuesOGL_OVERLAY_SUPPORT,     OGL_OVERLAY_SUPPORT_OFF},
    {OGL_QUALITY_ENHANCEMENTS_ID,          OGL_QUALITY_ENHANCEMENTS_STRING,           4, (LwU32 *)g_valuesOGL_QUALITY_ENHANCEMENTS, OGL_QUALITY_ENHANCEMENTS_QUAL},
    {OGL_SINGLE_BACKDEPTH_BUFFER_ID,       OGL_SINGLE_BACKDEPTH_BUFFER_STRING,        3, (LwU32 *)g_valuesOGL_SINGLE_BACKDEPTH_BUFFER, OGL_SINGLE_BACKDEPTH_BUFFER_DISABLE},
    {OGL_THREAD_CONTROL_ID,                OGL_THREAD_CONTROL_STRING,                 4, (LwU32 *)g_valuesOGL_THREAD_CONTROL,      0x00000000},
    {OGL_TRIPLE_BUFFER_ID,                 OGL_TRIPLE_BUFFER_STRING,                  2, (LwU32 *)g_valuesOGL_TRIPLE_BUFFER,       OGL_TRIPLE_BUFFER_DISABLED},
    {OGL_VIDEO_EDITING_MODE_ID,            OGL_VIDEO_EDITING_MODE_STRING,             2, (LwU32 *)g_valuesOGL_VIDEO_EDITING_MODE,  OGL_VIDEO_EDITING_MODE_DISABLE},
    {AA_BEHAVIOR_FLAGS_ID,                 AA_BEHAVIOR_FLAGS_STRING,                 18, (LwU32 *)g_valuesAA_BEHAVIOR_FLAGS,       AA_BEHAVIOR_FLAGS_DEFAULT},
    {AA_MODE_ALPHATOCOVERAGE_ID,           AA_MODE_ALPHATOCOVERAGE_STRING,            4, (LwU32 *)g_valuesAA_MODE_ALPHATOCOVERAGE, 0x00000000},
    {AA_MODE_GAMMACORRECTION_ID,           AA_MODE_GAMMACORRECTION_STRING,            8, (LwU32 *)g_valuesAA_MODE_GAMMACORRECTION, 0x00000000},
    {AA_MODE_METHOD_ID,                    AA_MODE_METHOD_STRING,                    50, (LwU32 *)g_valuesAA_MODE_METHOD,          AA_MODE_METHOD_NONE},
    {AA_MODE_REPLAY_ID,                    AA_MODE_REPLAY_STRING,                    19, (LwU32 *)g_valuesAA_MODE_REPLAY,          0x00000000},
    {AA_MODE_SELECTOR_ID,                  AA_MODE_SELECTOR_STRING,                   5, (LwU32 *)g_valuesAA_MODE_SELECTOR,        AA_MODE_SELECTOR_APP_CONTROL},
    {AA_MODE_SELECTOR_SLIAA_ID,            AA_MODE_SELECTOR_SLIAA_STRING,             2, (LwU32 *)g_valuesAA_MODE_SELECTOR_SLIAA,  AA_MODE_SELECTOR_SLIAA_DISABLED},
    {ANISO_MODE_LEVEL_ID,                  ANISO_MODE_LEVEL_STRING,                   5, (LwU32 *)g_valuesANISO_MODE_LEVEL,        ANISO_MODE_LEVEL_DEFAULT},
    {ANISO_MODE_SELECTOR_ID,               ANISO_MODE_SELECTOR_STRING,                6, (LwU32 *)g_valuesANISO_MODE_SELECTOR,     ANISO_MODE_SELECTOR_DEFAULT},
    {APPLICATION_PROFILE_NOTIFICATION_TIMEOUT_ID, APPLICATION_PROFILE_NOTIFICATION_TIMEOUT_STRING,  6, (LwU32 *)g_valuesAPPLICATION_PROFILE_NOTIFICATION_TIMEOUT, APPLICATION_PROFILE_NOTIFICATION_TIMEOUT_DISABLED},
    {APPLICATION_STEAM_ID_ID,              APPLICATION_STEAM_ID_STRING,               0, NULL,                                     0x00000000},
    {CPL_HIDDEN_PROFILE_ID,                CPL_HIDDEN_PROFILE_STRING,                 2, (LwU32 *)g_valuesCPL_HIDDEN_PROFILE,      CPL_HIDDEN_PROFILE_DISABLED},
    {EXPORT_PERF_COUNTERS_ID,              EXPORT_PERF_COUNTERS_STRING,               2, (LwU32 *)g_valuesEXPORT_PERF_COUNTERS,    EXPORT_PERF_COUNTERS_OFF},
    {FXAA_ALLOW_ID,                        FXAA_ALLOW_STRING,                         2, (LwU32 *)g_valuesFXAA_ALLOW,              FXAA_ALLOW_ALLOWED},
    {FXAA_ENABLE_ID,                       FXAA_ENABLE_STRING,                        2, (LwU32 *)g_valuesFXAA_ENABLE,             FXAA_ENABLE_OFF},
    {FXAA_INDICATOR_ENABLE_ID,             FXAA_INDICATOR_ENABLE_STRING,              2, (LwU32 *)g_valuesFXAA_INDICATOR_ENABLE,   FXAA_INDICATOR_ENABLE_OFF},
    {MCSFRSHOWSPLIT_ID,                    MCSFRSHOWSPLIT_STRING,                     2, (LwU32 *)g_valuesMCSFRSHOWSPLIT,          MCSFRSHOWSPLIT_DISABLED},
    {OPTIMUS_DEBUG_ID,                     OPTIMUS_DEBUG_STRING,                      2, (LwU32 *)g_valuesOPTIMUS_DEBUG,           0x00000000},
    {OPTIMUS_MAXAA_ID,                     OPTIMUS_MAXAA_STRING,                      2, (LwU32 *)g_valuesOPTIMUS_MAXAA,           0x00000000},
    {PHYSXINDICATOR_ID,                    PHYSXINDICATOR_STRING,                     2, (LwU32 *)g_valuesPHYSXINDICATOR,          PHYSXINDICATOR_DISABLED},
    {PREFERRED_PSTATE_ID,                  PREFERRED_PSTATE_STRING,                   5, (LwU32 *)g_valuesPREFERRED_PSTATE,        PREFERRED_PSTATE_ADAPTIVE},
    {PS_FRAMERATE_LIMITER_ID,              PS_FRAMERATE_LIMITER_STRING,              16, (LwU32 *)g_valuesPS_FRAMERATE_LIMITER,    PS_FRAMERATE_LIMITER_DISABLED},
    {SHIM_IGPU_TRANSCODING_ID,             SHIM_IGPU_TRANSCODING_STRING,              2, (LwU32 *)g_valuesSHIM_IGPU_TRANSCODING,   SHIM_IGPU_TRANSCODING_DISABLE},
    {SHIM_MAXRES_ID,                       SHIM_MAXRES_STRING,                        0, NULL,                                     0x00000000},
    {SHIM_MCCOMPAT_ID,                     SHIM_MCCOMPAT_STRING,                      8, (LwU32 *)g_valuesSHIM_MCCOMPAT,           SHIM_MCCOMPAT_AUTO_SELECT},
    {SHIM_RENDERING_MODE_ID,               SHIM_RENDERING_MODE_STRING,                8, (LwU32 *)g_valuesSHIM_RENDERING_MODE,     SHIM_RENDERING_MODE_AUTO_SELECT},
    {SHIM_RENDERING_OPTIONS_ID,            SHIM_RENDERING_OPTIONS_STRING,            19, (LwU32 *)g_valuesSHIM_RENDERING_OPTIONS,  SHIM_RENDERING_OPTIONS_DEFAULT_RENDERING_MODE},
    {SLI_GPU_COUNT_ID,                     SLI_GPU_COUNT_STRING,                      5, (LwU32 *)g_valuesSLI_GPU_COUNT,           SLI_GPU_COUNT_AUTOSELECT},
    {SLI_PREDEFINED_GPU_COUNT_ID,          SLI_PREDEFINED_GPU_COUNT_STRING,           5, (LwU32 *)g_valuesSLI_PREDEFINED_GPU_COUNT, SLI_PREDEFINED_GPU_COUNT_AUTOSELECT},
    {SLI_PREDEFINED_GPU_COUNT_DX10_ID,     SLI_PREDEFINED_GPU_COUNT_DX10_STRING,      5, (LwU32 *)g_valuesSLI_PREDEFINED_GPU_COUNT_DX10, SLI_PREDEFINED_GPU_COUNT_DX10_AUTOSELECT},
    {SLI_PREDEFINED_MODE_ID,               SLI_PREDEFINED_MODE_STRING,                6, (LwU32 *)g_valuesSLI_PREDEFINED_MODE,     SLI_PREDEFINED_MODE_AUTOSELECT},
    {SLI_PREDEFINED_MODE_DX10_ID,          SLI_PREDEFINED_MODE_DX10_STRING,           6, (LwU32 *)g_valuesSLI_PREDEFINED_MODE_DX10, SLI_PREDEFINED_MODE_DX10_AUTOSELECT},
    {SLI_RENDERING_MODE_ID,                SLI_RENDERING_MODE_STRING,                 6, (LwU32 *)g_valuesSLI_RENDERING_MODE,      SLI_RENDERING_MODE_AUTOSELECT},
    {VSYNC_BEHAVIOR_FLAGS_ID,              VSYNC_BEHAVIOR_FLAGS_STRING,               3, (LwU32 *)g_valuesVSYNC_BEHAVIOR_FLAGS,    VSYNC_BEHAVIOR_FLAGS_DEFAULT},
    {WKS_API_STEREO_EYES_EXCHANGE_ID,      WKS_API_STEREO_EYES_EXCHANGE_STRING,       2, (LwU32 *)g_valuesWKS_API_STEREO_EYES_EXCHANGE, WKS_API_STEREO_EYES_EXCHANGE_OFF},
    {WKS_API_STEREO_MODE_ID,               WKS_API_STEREO_MODE_STRING,               24, (LwU32 *)g_valuesWKS_API_STEREO_MODE,     WKS_API_STEREO_MODE_SHUTTER_GLASSES},
    {WKS_FEATURE_SUPPORT_CONTROL_ID,       WKS_FEATURE_SUPPORT_CONTROL_STRING,        2, (LwU32 *)g_valuesWKS_FEATURE_SUPPORT_CONTROL, WKS_FEATURE_SUPPORT_CONTROL_OFF},
    {WKS_STEREO_DONGLE_SUPPORT_ID,         WKS_STEREO_DONGLE_SUPPORT_STRING,          3, (LwU32 *)g_valuesWKS_STEREO_DONGLE_SUPPORT, WKS_STEREO_DONGLE_SUPPORT_OFF},
    {WKS_STEREO_SUPPORT_ID,                WKS_STEREO_SUPPORT_STRING,                 2, (LwU32 *)g_valuesWKS_STEREO_SUPPORT,      WKS_STEREO_SUPPORT_OFF},
    {AO_MODE_ID,                           AO_MODE_STRING,                            4, (LwU32 *)g_valuesAO_MODE,                 AO_MODE_OFF},
    {AO_MODE_ACTIVE_ID,                    AO_MODE_ACTIVE_STRING,                     2, (LwU32 *)g_valuesAO_MODE_ACTIVE,          AO_MODE_ACTIVE_DISABLED},
    {PRERENDERLIMIT_ID,                    PRERENDERLIMIT_STRING,                     3, (LwU32 *)g_valuesPRERENDERLIMIT,          PRERENDERLIMIT_APP_CONTROLLED},
    {PS_DYNAMIC_TILING_ID,                 PS_DYNAMIC_TILING_STRING,                  2, (LwU32 *)g_valuesPS_DYNAMIC_TILING,       PS_DYNAMIC_TILING_OFF},
    {PS_TEXFILTER_ANISO_OPTS2_ID,          PS_TEXFILTER_ANISO_OPTS2_STRING,           2, (LwU32 *)g_valuesPS_TEXFILTER_ANISO_OPTS2, PS_TEXFILTER_ANISO_OPTS2_OFF},
    {PS_TEXFILTER_BILINEAR_IN_ANISO_ID,    PS_TEXFILTER_BILINEAR_IN_ANISO_STRING,     2, (LwU32 *)g_valuesPS_TEXFILTER_BILINEAR_IN_ANISO, PS_TEXFILTER_BILINEAR_IN_ANISO_OFF},
    {PS_TEXFILTER_DISABLE_TRILIN_SLOPE_ID, PS_TEXFILTER_DISABLE_TRILIN_SLOPE_STRING,  2, (LwU32 *)g_valuesPS_TEXFILTER_DISABLE_TRILIN_SLOPE, PS_TEXFILTER_DISABLE_TRILIN_SLOPE_OFF},
    {PS_TEXFILTER_NO_NEG_LODBIAS_ID,       PS_TEXFILTER_NO_NEG_LODBIAS_STRING,        2, (LwU32 *)g_valuesPS_TEXFILTER_NO_NEG_LODBIAS, PS_TEXFILTER_NO_NEG_LODBIAS_OFF},
    {QUALITY_ENHANCEMENTS_ID,              QUALITY_ENHANCEMENTS_STRING,               4, (LwU32 *)g_valuesQUALITY_ENHANCEMENTS,    QUALITY_ENHANCEMENTS_QUALITY},
    {REFRESH_RATE_OVERRIDE_ID,             REFRESH_RATE_OVERRIDE_STRING,              2, (LwU32 *)g_valuesREFRESH_RATE_OVERRIDE,   REFRESH_RATE_OVERRIDE_APPLICATION_CONTROLLED},
    {SET_POWER_THROTTLE_FOR_PCIe_COMPLIANCE_ID, SET_POWER_THROTTLE_FOR_PCIe_COMPLIANCE_STRING,  2, (LwU32 *)g_valuesSET_POWER_THROTTLE_FOR_PCIe_COMPLIANCE, SET_POWER_THROTTLE_FOR_PCIe_COMPLIANCE_OFF},
    {SET_VAB_DATA_ID,                      SET_VAB_DATA_STRING,                       6, (LwU32 *)g_valuesSET_VAB_DATA,            SET_VAB_DATA_USE_API_DEFAULTS},
    {VSYNCMODE_ID,                         VSYNCMODE_STRING,                          6, (LwU32 *)g_valuesVSYNCMODE,               VSYNCMODE_PASSIVE},
    {VSYNCTEARCONTROL_ID,                  VSYNCTEARCONTROL_STRING,                   2, (LwU32 *)g_valuesVSYNCTEARCONTROL,        VSYNCTEARCONTROL_DISABLE},
};
...
SettingWSTRINGNameString mapSettingWSTRING[TOTAL_WSTRING_SETTING_NUM] = 
{
    ...
    {LWDA_EXCLUDED_GPUS_ID,                LWDA_EXCLUDED_GPUS_STRING,                 1, (const wchar_t **)g_valuesLWDA_EXCLUDED_GPUS, L"none"},
