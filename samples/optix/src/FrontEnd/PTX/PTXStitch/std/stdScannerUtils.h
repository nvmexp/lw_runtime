 ...
 *  CORPORATION.
 * 
 *  Module name              : stdScannerUtils.h
 *
 *  Last update              :
 *
 *  Description              :
 *     
 *         This module defines support for flex- based scanners.
 */

#ifndef stdScannerUtils_INCLUDED
#define stdScannerUtils_INCLUDED
 ...
 */
stdUNUSED( static void  yyunput( int c, register char *yy_bp ) );
