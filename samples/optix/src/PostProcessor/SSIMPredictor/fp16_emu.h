...
// Colwersion from/to 16-bit floating point (half-precision).
...
// Necessary to ensure visibility of LWDART_VERSION macro
#include <lwda_runtime_api.h>

// Definition of '__half_raw' was not provided before LWCA 9.0.
// '__half_raw' is our type where the unsigned 16-bit integer
// data member 'x' can be accessed in both LWCA 9.0 and 8.0.
#if LWDART_VERSION < 9000
typedef __half __half_raw;
#endif

// Internally, in LWDNN we use half1 struct as the FP16 type.
