...
// PageRequestHandler represents a request for a texture tile or a buffer page.
class BufferRequestHandler : public RequestHandler
{
  public:
    BufferRequestHandler( unsigned int pageId, DeviceSet devices, const Buffer* buffer, unsigned int startPage );
    ~BufferRequestHandler() override = default;
