...
typedef struct _GLMmaterial
{
    ...
    float spelwlar[4];   // Ks spelwlar component
    float emmissive[4];  // emmissive component
    float shininess;     // Ns spelwlar exponent
    float refraction;    // Tr
    float alpha;         // d
    ...
    char spelwlar_map[MaxStringLength];  // map_Ks
