 ...
 *
 * Copyright 1993-2018 by LWPU Corporation.  All rights reserved.  All
...
#define GPU_REG_RD_DRF_IDX(d,r,f,i)       (((GPU_REG_RD32(LW ## d ## r))>>DRF_SHIFT(LW ## d ## r ## f(i)))&DRF_MASK(LW ## d ## r ## f(i)))
...
#define SF_INDEX_VAL(s,f,i,v)   (((v)>>SF_SHIFT(LW ## s ## f(i)))&SF_MASK(LW ## s ## f(i)))
...
// 64 bit operations
//
#define LO_DW64(r)               ((LwU32)((((LwU64)(r))<<32)>>32))
#define HI_DW64(r)               ((LwU32)(((LwU64)(r))>>32))
#define DW64(hi,lo)              ((((LwU64)(hi))<<32)|lo)

//
// Frame Buffer read functions
//
LwU32 FB_RD_FIELD32    (LwU32 address, LwU32 x, LwU32 y);
LwU32 FB_RD_FIELD32_64 (LwU64 address, LwU32 x, LwU32 y);
...
#define PACK_XY(x,y)    ((LwV32)((((LwU32)(x))<<16)|(((LwU32)(y))&0x0000FFFF)) )

/* Pack two Unsigned 16-bit dimensions */
#define PACK_WH(w,h)    ((LwV32)((((LwU32)(w))<<16)|(((LwU32)(h))&0x0000FFFF)) )
...
#define PACK_ARGB15(a,r,g,b)                                    \
            ((LwV32)((((a)?(1<<15):0))|(((LwU32)(r)&0x1F)<<10)|   \
            (((LwU32)(g)&0x1F)<<5)|((LwU32)(b)&0x1F)))
...
// Utility functions
//
void DeviceIDToString(LwU32 devid, char *name);
