...
#ifndef _DISP_DISP0402_H_
#define _DISP_DISP0402_H_
...
static const char * const * dChanStateWords_v04_02[] = {
    dCoreState,
...
#define DCHN_GET_DESC_V04_02(x,y) (dChanStateWords_v04_02[x][y])
...
#define DCHN_GET_CHNSTATUS_STATE_V04_02(_chnNum,_chnstatus) \
    (((_chnstatus) >> dispChanState_v04_02[_chnNum].shift) & \
     dispChanState_v04_02[_chnNum].mask)

static ChanDesc_t_Lwdisplay dispChanState_v04_02[] = {
...
#define DISP_PRINT_SC_NON_IDX_V04_02(r, chanNum)                                \
...
#define DISP_PRINT_SC_SINGLE_IDX_COMP_V04_02(r, idx, chanNum)                   \
...
#define DISP_PRINT_SC_DOUBLE_IDX_COMP_V04_02(r, surf, offset, chanNum)               \
