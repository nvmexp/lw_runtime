...
//*****************************************************
//
// clktu116.c - TU116 Clock lwwatch routines 
// 
//*****************************************************
#include "os.h"
#include "hal.h"
#include "clk.h"
#include "print.h"
#include "turing/tu116/dev_trim.h"
#include "turing/tu116/dev_trim_addendum.h"
        ...
        case LW2080_CTRL_CLK_DOMAIN_GPCCLK:
        {
            switch (srcIdx)
            {
                case 0:
                    ...
                    GPU_REG_WR32(LW_PTRIM_SYS_TCLKOUT_CTRL_XBAR, 0x01060501);
                    GPU_REG_WR32(LW_PTRIM_SYS_TCLKOUT_CTRL_SYS, 0x010a0101);
                    break;
                case 1:
                    GPU_REG_WR32(LW_PTRIM_GPC_TCLKOUT_CTRL_GPC(srcIdx), 0x01030101);
