...
#include "blackwell/gb100/dev_top.h"
#include "blackwell/gb100/dev_ce.h"
...
//-----------------------------------------------------
// ceDumpPriv_GB100 - Dumps CE priv reg space
//-----------------------------------------------------
LwU32 ceDumpPriv_GB100(LwU32 indexGpu, LwU32 indexCe)
{
    LwU32 u;
    LwU32 pcemap;
    char m_tag[256];
...
/*!
 *  Read the PCE_PIPESTATUS register (the offset changed for
 *  Blackwell, but otherwise the definitions are the same).
 *  @param[in] pce - physical copy engine index
 *
 *  @return LW_CE_PCE_PIPESTATUS value
 */
LwU32 ceReadPcePipestatus_GB100(LwU32 pce)
{
