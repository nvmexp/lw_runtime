...
void sigInitInstanceInfo_GK106(InstanceInfo* pInfo, LwU32 ngpc, LwU32 ntpc, LwU32 nfbp, LwU32 option)
{
...
void sigPrintLegend_GK106(FILE* fp)
{
   dprintf("lw: This function needs to be built with SIGDUMP enabled\n");
   dprintf("lw: Add /DSIGDUMP_ENABLE to the C_DEFINES in sources\n");
}
    ...
    for (i = 0; i < NUMINSTANCES; i++)
    {
        ...
        switch(i)
        {
            case gpc:
                ...
                pInfo[i].instanceLimit = 2;       //Three instances
                pInfo[i].bValid = TRUE;
                break;
            ...
            case sys_mxbar_cs_daisy:
                ...
                pInfo[i].instanceLimit = 6;       // 7 instances
                pInfo[i].bValid = TRUE;
                break;
...
void sigPrintLegend_GK106(FILE* fp)
{
    fprintf(fp, " ****** GK106 Sigdump LEGEND ****** \n");
    ...
    fprintf(fp, "           sys_mxbar_cs_daisy => 0..7 (numGPC + numFBP + numSYS), independent of floorsweeping, not virtualized.\n");
