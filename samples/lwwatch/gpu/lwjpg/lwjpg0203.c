...
//-----------------------------------------------------
//
// lwjpg0203.c - LWJPG v2.3 routines
// 
//-----------------------------------------------------

#include "ada/ad102/dev_pri_ringstation_sys.h"
// #include "ada/ad102/dev_pri_ringstation_sysb.h"
#include "ada/ad102/dev_pri_ringstation_sysc.h"
#include "ada/ad102/dev_lwjpg_pri_sw.h"
...
// TODO: Use LW_FALCON_LWJPG0_BASE when available in drivers/common/inc/hwref/ada/ad102/dev_falcon_*.h
#define FALCON_LWJPG_BASE(id)  (/*LW_FALCON_LWJPG0_BASE*/ 0x828000 + (id * 0x4000))

#define LW_C9D1_NOP                                      (0x00000100)
#define LW_C9D1_PM_TRIGGER                               (0x00000140)
#define LW_C9D1_SET_APPLICATION_ID                       (0x00000200)
#define LW_C9D1_SET_WATCHDOG_TIMER                       (0x00000204)
#define LW_C9D1_SEMAPHORE_A                              (0x00000240)
#define LW_C9D1_SEMAPHORE_B                              (0x00000244)
#define LW_C9D1_SEMAPHORE_C                              (0x00000248)
#define LW_C9D1_CTX_SAVE_AREA                            (0x0000024C)
#define LW_C9D1_CTX_SWITCH                               (0x00000250)
#define LW_C9D1_EXELWTE                                  (0x00000300)
#define LW_C9D1_SEMAPHORE_D                              (0x00000304)
#define LW_C9D1_SET_CONTROL_PARAMS                       (0x00000700)
#define LW_C9D1_SET_TOTAL_CORE_NUM                       (0x00000704)
#define LW_C9D1_SET_IN_DRV_PIC_SETUP                     (0x00000708)
#define LW_C9D1_SET_PER_CORE_SET_OUT_STATUS              (0x0000070C)
#define LW_C9D1_SET_PER_CORE_SET_CORE_INDEX(i)           (0x00000710+(i)*0x20)
#define LW_C9D1_SET_PER_CORE_SET_BITSTREAM(i)            (0x00000714+(i)*0x20)
#define LW_C9D1_SET_PER_CORE_SET_LWR_PIC(i)              (0x00000718+(i)*0x20)
#define LW_C9D1_SET_PER_CORE_SET_LWR_PIC_CHROMA_U(i)     (0x0000071C+(i)*0x20)
#define LW_C9D1_SET_PER_CORE_SET_LWR_PIC_CHROMA_V(i)     (0x00000720+(i)*0x20)
#define LW_C9D1_PM_TRIGGER_END                           (0x00001114)


dbg_lwjpg_v02_00 lwjpgMethodTable_v02_03[] =
{
    privInfo_lwjpg_v02_00(LW_C9D1_NOP),
    privInfo_lwjpg_v02_00(LW_C9D1_PM_TRIGGER),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_APPLICATION_ID),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_WATCHDOG_TIMER),
    privInfo_lwjpg_v02_00(LW_C9D1_SEMAPHORE_A),
    privInfo_lwjpg_v02_00(LW_C9D1_SEMAPHORE_B),
    privInfo_lwjpg_v02_00(LW_C9D1_SEMAPHORE_C),
    privInfo_lwjpg_v02_00(LW_C9D1_EXELWTE),
    privInfo_lwjpg_v02_00(LW_C9D1_SEMAPHORE_D),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_CONTROL_PARAMS),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_TOTAL_CORE_NUM),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_IN_DRV_PIC_SETUP),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_PER_CORE_SET_OUT_STATUS),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_PER_CORE_SET_CORE_INDEX(0)),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_PER_CORE_SET_BITSTREAM(0)),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_PER_CORE_SET_LWR_PIC(0)),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_PER_CORE_SET_LWR_PIC_CHROMA_U(0)),
    privInfo_lwjpg_v02_00(LW_C9D1_SET_PER_CORE_SET_LWR_PIC_CHROMA_V(0)),
    privInfo_lwjpg_v02_00(LW_C9D1_PM_TRIGGER_END),
    privInfo_lwjpg_v02_00(0),
};

dbg_lwjpg_v02_00 lwjpgFuseReg_v02_03[] =
{
    // revocation
...
dbg_lwjpg_v02_00 lwjpgPrivReg_v02_03_eng0[] = LWJPG_PRIV_ACCESS(0);
dbg_lwjpg_v02_00 lwjpgPrivReg_v02_03_eng1[] = LWJPG_PRIV_ACCESS(1);
dbg_lwjpg_v02_00 lwjpgPrivReg_v02_03_eng2[] = LWJPG_PRIV_ACCESS(2);
dbg_lwjpg_v02_00 lwjpgPrivReg_v02_03_eng3[] = LWJPG_PRIV_ACCESS(3);

//-----------------------------------------------------
// lwjpgIsValidEngineId_v02_03
//-----------------------------------------------------
BOOL lwjpgIsValidEngineId_v02_03(LwU32 indexGpu, LwU32 engineId)
{
    switch (engineId)
    {
    ...
    case LWWATCH_LWJPG_3:
        break;
    default:
        dprintf("AD10x supports upto 4 lwjpg instances only\n");
        return FALSE;
    }
...
//-----------------------------------------------------
// lwjpgIsSupported_v02_03
//-----------------------------------------------------
BOOL lwjpgIsSupported_v02_03( LwU32 indexGpu, LwU32 engineId )
{
    ...
    {
    case LWWATCH_LWJPG_0:
        pLwjpgPrivReg[LWWATCH_LWJPG_0] = lwjpgPrivReg_v02_03_eng0;
        break;
    case LWWATCH_LWJPG_1:
        pLwjpgPrivReg[LWWATCH_LWJPG_1] = lwjpgPrivReg_v02_03_eng1;
        break;
    case LWWATCH_LWJPG_2:
        pLwjpgPrivReg[LWWATCH_LWJPG_2] = lwjpgPrivReg_v02_03_eng2;
        break;
    case LWWATCH_LWJPG_3:
        pLwjpgPrivReg[LWWATCH_LWJPG_3] = lwjpgPrivReg_v02_03_eng3;
        break;
    default:
        return FALSE;
    }

    pLwjpgFuseReg     = lwjpgFuseReg_v02_03;
    pLwjpgMethodTable = lwjpgMethodTable_v02_03;

    return TRUE;
}

//-----------------------------------------------------
// lwjpgIsPrivBlocked_v02_03
//-----------------------------------------------------
BOOL lwjpgIsPrivBlocked_v02_03( LwU32 indexGpu, LwU32 engineId )
{
    LwU32 idx;
    LwU32 bitmask;
    ...
    {
    case LWWATCH_LWJPG_0:
        idx = LW_PPRIV_SYS_PRI_MASTER_sys_pri_hub2lwjpg_pri0 >> 5;
        regSysPrivFsConfig = GPU_REG_RD32(LW_PPRIV_SYS_PRIV_FS_CONFIG(idx));
        bitmask = BIT(LW_PPRIV_SYS_PRI_MASTER_sys_pri_hub2lwjpg_pri0 - (idx << 5));
        break;
    case LWWATCH_LWJPG_1:
        idx = LW_PPRIV_SYS_PRI_MASTER_sys_pri_hub2lwjpg_pri1 >> 5;
        regSysPrivFsConfig = GPU_REG_RD32(LW_PPRIV_SYS_PRIV_FS_CONFIG(idx));
        bitmask = BIT(LW_PPRIV_SYS_PRI_MASTER_sys_pri_hub2lwjpg_pri1 - (idx << 5));
        break;
    case LWWATCH_LWJPG_2:
        idx = LW_PPRIV_SYS_PRI_MASTER_sys_pri_hub2lwjpg_pri2 >> 5;
        regSysPrivFsConfig = GPU_REG_RD32(LW_PPRIV_SYS_PRIV_FS_CONFIG(idx));
        bitmask = BIT(LW_PPRIV_SYS_PRI_MASTER_sys_pri_hub2lwjpg_pri2 - (idx << 5));
        break;
    case LWWATCH_LWJPG_3:
        idx = LW_PPRIV_SYS_PRI_MASTER_sys_pri_hub2lwjpg_pri3 >> 5;
        regSysPrivFsConfig = GPU_REG_RD32(LW_PPRIV_SYS_PRIV_FS_CONFIG(idx));
        bitmask = BIT(LW_PPRIV_SYS_PRI_MASTER_sys_pri_hub2lwjpg_pri3 - (idx << 5));
        break;
    default:
        return TRUE;
    }
...
//-----------------------------------------------------
// lwjpgTestState_v02_03 - Test basic lwjpg state
//-----------------------------------------------------
LW_STATUS lwjpgTestState_v02_03( LwU32 indexGpu, LwU32 engineId )
{
...
//-----------------------------------------------------
// lwjpgPrintPriv_v02_03
//-----------------------------------------------------
void lwjpgPrintPriv_v02_03(LwU32 clmn, char *tag, LwU32 id)
{
...
//-----------------------------------------------------
// lwjpgDumpPriv_v02_03 - Dumps LWJPG priv reg space
//-----------------------------------------------------
LW_STATUS lwjpgDumpPriv_v02_03(LwU32 indexGpu, LwU32 engineId)
{
    LwU32 u;
...
//-----------------------------------------------------------
// lwjpgDumpFuse_v02_03 - Dumps LWJPG related fuse registers
//-----------------------------------------------------------
LW_STATUS lwjpgDumpFuse_v02_03(LwU32 indexGpu, LwU32 engineId)
{
    LwU32 u;
...
//-----------------------------------------------------
// lwjpgGetClassId_v02_03
//-----------------------------------------------------
LwU32
lwjpgGetClassId_v02_03(void)
{
    return 0x0000C9D1;/*LWC9D1_VIDEO_LWJPG*/
}
