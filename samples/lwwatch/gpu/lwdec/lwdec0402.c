...
//-----------------------------------------------------
//
// lwdec0402.c - LWDEC 4.2 routines
//
//-----------------------------------------------------
...
//-----------------------------------------------------
// lwdecIsValidEngineId_v04_02
//-----------------------------------------------------
BOOL lwdecIsValidEngineId_v04_02(LwU32 indexGpu, LwU32 engineId)
{
    switch(engineId)
    {
        ...
        case LWWATCH_LWDEC_4:
             break;
        default:
             dprintf("GA100 supports upto 5 lwdec instances only\n");
             return FALSE;
    }
...
//-----------------------------------------------------
// lwdecIsSupported_v04_02
//-----------------------------------------------------
BOOL lwdecIsSupported_v04_02(LwU32 indexGpu, LwU32 engineId)
{
    ...
    {
        case LWWATCH_LWDEC_0:
             pLwdecPrivReg[LWWATCH_LWDEC_0] = lwdecPrivReg_v04_02_eng0;
             break;
        case LWWATCH_LWDEC_1:
             pLwdecPrivReg[LWWATCH_LWDEC_1] = lwdecPrivReg_v04_02_eng1;
             break;
        case LWWATCH_LWDEC_2:
             pLwdecPrivReg[LWWATCH_LWDEC_2] = lwdecPrivReg_v04_02_eng2; 
             break;
        case LWWATCH_LWDEC_3:
             pLwdecPrivReg[LWWATCH_LWDEC_3] = lwdecPrivReg_v04_02_eng3;
             break;
        case LWWATCH_LWDEC_4:
             pLwdecPrivReg[LWWATCH_LWDEC_4] = lwdecPrivReg_v04_02_eng4;
             break;
        default:
             return FALSE;
             break;
    ...
    pLwdecMethodTable = lwdecMethodTable_v04_02;

    return TRUE;
}

//-----------------------------------------------------
// lwdecIsPrivBlocked_v04_02
//-----------------------------------------------------
BOOL lwdecIsPrivBlocked_v04_02(LwU32 indexGpu, LwU32 engineId)
{
    LwU32 idx;
    LwU32 bitmask;
    ...
    switch(engineId)
    {
        ...
        case LWWATCH_LWDEC_3:
             ...
             break;
        case LWWATCH_LWDEC_4:
             idx = LW_PPRIV_SYS_PRI_MASTER_fecs2lwdec_pri4 >> 5;
             regSysPrivFsConfig = GPU_REG_RD32(LW_PPRIV_SYS_PRIV_FS_CONFIG(idx));
             bitmask = BIT(LW_PPRIV_SYS_PRI_MASTER_fecs2lwdec_pri4 - (idx << 5));
             break;
        default:
             return TRUE;
    }
...
//-----------------------------------------------------
// lwdecGetClassId_v04_02
//-----------------------------------------------------
LwU32
lwdecGetClassId_v04_02 (void)
{
    return LWC6B0_VIDEO_DECODER;
}

//-----------------------------------------------------
// lwdecDumpImem_v04_02 - Dumps LWDEC instruction memory
//-----------------------------------------------------
LW_STATUS lwdecDumpImem_v04_02(LwU32 indexGpu, LwU32 engineId, LwU32 imemSize)
{
...
//-----------------------------------------------------
// lwdecDumpDmem_v04_02 - Dumps LWDEC data memory
//-----------------------------------------------------
LW_STATUS lwdecDumpDmem_v04_02(LwU32 indexGpu, LwU32 engineId, LwU32 dmemSize)
{
    LW_STATUS status = LW_OK;
    LwU32 dmemSizeMax;
    ...
    switch (appId)
    {
    case LWC6B0_SET_APPLICATION_ID_ID_H264:
        appMthdBase = APPMETHODBASE_LWDEC_v03_H264;
        cmnMthdBase = CMNMETHODBASE_LWDEC_v03_CODECS;
        break;
    case LWC6B0_SET_APPLICATION_ID_ID_VP8:
        appMthdBase = APPMETHODBASE_LWDEC_v03_VP8;
        cmnMthdBase = CMNMETHODBASE_LWDEC_v03_CODECS;
        break;
    case LWC6B0_SET_APPLICATION_ID_ID_HEVC:
    case LWC6B0_SET_APPLICATION_ID_ID_HEVC_PARSER:
        appMthdBase = APPMETHODBASE_LWDEC_v03_HEVC;
        cmnMthdBase = CMNMETHODBASE_LWDEC_v03_CODECS;
        break;
    case LWC6B0_SET_APPLICATION_ID_ID_VP9:
...
//-----------------------------------------------------
// lwdecTestState_v04_02 - Test basic lwdec state
//-----------------------------------------------------
LW_STATUS lwdecTestState_v04_02(LwU32 indexGpu, LwU32 engineId)
{
    LW_STATUS    status = LW_OK;
    LwU32   regIntr;
    LwU32   regIntrEn;
...
//--------------------------------------------------------
// lwdecDisplayHwcfg_v04_02 - Display LWDEC HW config
//--------------------------------------------------------
LW_STATUS lwdecDisplayHwcfg_v04_02(LwU32 indexGpu, LwU32 engineId)
{
    LwU32 hwcfg, hwcfg1;
...
LW_STATUS  lwdecDisplayFlcnSPR_v04_02(LwU32 indexGpu, LwU32 engineId)
{
    if (!pLwdec[indexGpu].lwdecIsValidEngineId(indexGpu, engineId))
        return LW_ERR_NOT_SUPPORTED;
 ...
 */
LwBool
lwdecIsDebugMode_v04_02(LwU32 engineId)
{
