...
//-----------------------------------------------------
//
// lwdec0301.c - LWDEC 3.1 routines
//
//-----------------------------------------------------
...
//-----------------------------------------------------
// lwdecIsSupported_v03_01
//-----------------------------------------------------
BOOL lwdecIsSupported_v03_01(LwU32 indexGpu, LwU32 engineId)
{
    if (engineId != LWWATCH_LWDEC_0)
        return FALSE;

    pLwdecPrivReg[engineId] = lwdecPrivReg_v03_01;
    pLwdecMethodTable = lwdecMethodTable_v03_01;
    return TRUE;
}

LwU32
lwdecGetClassId_v03_01 ()
{
    return LWC2B0_VIDEO_DECODER;
}

//-----------------------------------------------------
// lwdecDumpDmem_v03_01 - Dumps LWDEC data memory
//-----------------------------------------------------
LW_STATUS lwdecDumpDmem_v03_01(LwU32 indexGpu, LwU32 engineId, LwU32 dmemSize)
{
    ...
    switch (appId)
    {
    case LWC2B0_SET_APPLICATION_ID_ID_H264:
        appMthdBase = APPMETHODBASE_LWDEC_v03_H264;
        cmnMthdBase = CMNMETHODBASE_LWDEC_v03_CODECS;
        break;
    case LWC2B0_SET_APPLICATION_ID_ID_VP8:
        appMthdBase = APPMETHODBASE_LWDEC_v03_VP8;
        cmnMthdBase = CMNMETHODBASE_LWDEC_v03_CODECS;
        break;
    case LWC2B0_SET_APPLICATION_ID_ID_HEVC:
    case LWC2B0_SET_APPLICATION_ID_ID_HEVC_PARSER:
        appMthdBase = APPMETHODBASE_LWDEC_v03_HEVC;
        cmnMthdBase = CMNMETHODBASE_LWDEC_v03_CODECS;
        break;
    case LWC2B0_SET_APPLICATION_ID_ID_VP9:
        appMthdBase = APPMETHODBASE_LWDEC_v03_VP9;
        cmnMthdBase = CMNMETHODBASE_LWDEC_v03_CODECS;
        break;
    case LWC2B0_SET_APPLICATION_ID_ID_CTR64:
