...
LW_STATUS riscvTraceEnable_GA10X(TRACE_MODE mode)
{
...
LW_STATUS riscvTraceDisable_GA10X(void)
{
    bar0Write(LW_PRISCV_RISCV_TRACECTL, 0);
    return LW_OK;
}

LW_STATUS riscvTraceFlush_GA10X(void)
{
...
LW_STATUS riscvTraceDump_GA10X(void)
{
