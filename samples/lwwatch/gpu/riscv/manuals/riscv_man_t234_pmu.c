...
// T234's PMU is from GA10B
#include "ampere/ga10b/lw_pmu_riscv_address_map.h"

#include "riscv_man.h"
#include "riscv_man_t234_pmu.h"

LwU64 getRiscvDef_T234_PMU(const char *macro)
{
    ...
    GETRISCVDEF_ADDDEF(LW_RISCV_AMAP_EMEM_SIZE);
