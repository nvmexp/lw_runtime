...
#include "t23x/t234/dev_ofa_pri.h"
#include "g_ofa_private.h"     // (rmconfig)  implementation prototypes

#include <class/clc8fa.h>

dbg_ofa_v01_00 ofaMethodTable_v01_02[] =
{
    privInfo_ofa_v01_00(LWC8FA_NOP),
    privInfo_ofa_v01_00(LWC8FA_PM_TRIGGER),
    privInfo_ofa_v01_00(LWC8FA_SET_APPLICATION_ID),
    privInfo_ofa_v01_00(LWC8FA_SET_WATCHDOG_TIMER),
    privInfo_ofa_v01_00(LWC8FA_SEMAPHORE_A),
    privInfo_ofa_v01_00(LWC8FA_SEMAPHORE_B),
    privInfo_ofa_v01_00(LWC8FA_SEMAPHORE_C),
    privInfo_ofa_v01_00(LWC8FA_CTX_SAVE_AREA),
    privInfo_ofa_v01_00(LWC8FA_CTX_SWITCH),
    privInfo_ofa_v01_00(LWC8FA_SET_SEMAPHORE_PAYLOAD_LOWER),
    privInfo_ofa_v01_00(LWC8FA_SET_SEMAPHORE_PAYLOAD_UPPER),
    privInfo_ofa_v01_00(LWC8FA_SET_MONITORED_FENCE_SIGNAL_ADDRESS_BASE_A),
    privInfo_ofa_v01_00(LWC8FA_SET_MONITORED_FENCE_SIGNAL_ADDRESS_BASE_B),
    privInfo_ofa_v01_00(LWC8FA_EXELWTE),
    privInfo_ofa_v01_00(LWC8FA_SEMAPHORE_D),
    privInfo_ofa_v01_00(LWC8FA_SET_PREDICATION_OFFSET_UPPER),
    privInfo_ofa_v01_00(LWC8FA_SET_PREDICATION_OFFSET_LOWER),
    privInfo_ofa_v01_00(LWC8FA_SET_AUXILIARY_DATA_BUFFER),
    privInfo_ofa_v01_00(LWC8FA_SET_PICTURE_INDEX),
    privInfo_ofa_v01_00(LWC8FA_SET_CONTROL_PARAMS),
    privInfo_ofa_v01_00(LWC8FA_SET_TOTAL_LEVEL_NUM),
    privInfo_ofa_v01_00(LWC8FA_SET_GP_TIMER),
    privInfo_ofa_v01_00(LWC8FA_SET_STATUS_ADDR),
    privInfo_ofa_v01_00(LWC8FA_PM_TRIGGER_END),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LEVEL_INDEX(0)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LEVEL_INDEX(1)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LEVEL_INDEX(2)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LEVEL_INDEX(3)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LEVEL_INDEX(4)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_DRV_SET_UP_ADDR(0)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_DRV_SET_UP_ADDR(1)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_DRV_SET_UP_ADDR(2)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_DRV_SET_UP_ADDR(3)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_DRV_SET_UP_ADDR(4)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LWRR_PIC_ADDR(0)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LWRR_PIC_ADDR(1)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LWRR_PIC_ADDR(2)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LWRR_PIC_ADDR(3)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_LWRR_PIC_ADDR(4)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_REF_PIC_ADDR(0)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_REF_PIC_ADDR(1)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_REF_PIC_ADDR(2)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_REF_PIC_ADDR(3)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_REF_PIC_ADDR(4)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HINT_MV_ADDR(0)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HINT_MV_ADDR(1)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HINT_MV_ADDR(2)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HINT_MV_ADDR(3)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HINT_MV_ADDR(4)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_COST_ADDR(0)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_COST_ADDR(1)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_COST_ADDR(2)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_COST_ADDR(3)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_COST_ADDR(4)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_FLOW_ADDR(0)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_FLOW_ADDR(1)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_FLOW_ADDR(2)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_FLOW_ADDR(3)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_WINNER_FLOW_ADDR(4)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HISTORY_BUF_ADDR(0)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HISTORY_BUF_ADDR(1)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HISTORY_BUF_ADDR(2)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HISTORY_BUF_ADDR(3)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_HISTORY_BUF_ADDR(4)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_TEMPORARY_BUF_ADDR(0)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_TEMPORARY_BUF_ADDR(1)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_TEMPORARY_BUF_ADDR(2)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_TEMPORARY_BUF_ADDR(3)),
    privInfo_ofa_v01_00(LWC8FA_SET_MULTI_LEVELS_SET_TEMPORARY_BUF_ADDR(4)),
    privInfo_ofa_v01_00(0),
};

dbg_ofa_v01_00 ofaPrivReg_v01_02[] =
{
    ...
    privInfo_ofa_v01_00(LW_POFA_CG_SLCG),
...
extern void ofaPrintMethodData(LwU32 clmn, char *tag, LwU32 method, LwU32 data);

#define OFA_REG_RD32(reg) DEV_REG_RD32(reg, "OFA",0)
#define OFA_REG_WR32(reg, val) DEV_REG_WR32(reg, val, "OFA",0)
#define OFA_REG_RD_DRF(d,r,f)  (((OFA_REG_RD32(LW ## d ## r))>>DRF_SHIFT(LW ## d ## r ## f))&DRF_MASK(LW ## d ## r ## f)) 

//-----------------------------------------------------
// ofaIsGpuSupported_v01_02
//-----------------------------------------------------
BOOL ofaIsGpuSupported_v01_02(LwU32 indexGpu)
{
    ...
    pOfaPrivReg[0]  = ofaPrivReg_v01_02;
    pOfaMethodTable = ofaMethodTable_v01_02;
    return TRUE;
}

//-----------------------------------------------------
// ofaGetClassId_v01_02
//-----------------------------------------------------
LwU32
ofaGetClassId_v01_02(void)
{
    return LWC8FA_VIDEO_OFA;
}

//--------------------------------------------------------
// ofaDisplayHwcfg_v01_02 - Display OFA HW config
//--------------------------------------------------------
LW_STATUS ofaDisplayHwcfg_v01_02(LwU32 indexGpu)
{
    LwU32 hwcfg, hwcfg1;
    ...
    hwcfg = OFA_REG_RD32(LW_POFA_FALCON_HWCFG);
    ...
    hwcfg1 = OFA_REG_RD32(LW_POFA_FALCON_HWCFG1);
...
//-----------------------------------------------------
// ofaDumpImem_v01_02 - Dumps OFA instruction memory
//-----------------------------------------------------
LW_STATUS ofaDumpImem_v01_02(LwU32 indexGpu, LwU32 imemSize)
{
    ...
    LwU32 blk = 0;
    LwU32 classNum;
    imemSizeMax = (OFA_REG_RD_DRF(_POFA_FALCON, _HWCFG, _IMEM_SIZE) << 8);
    if (imemSize > 0)
    ...
    for (u = 0; u<(imemSize + 3) / 4; u++)
    {
        LwU32 i;
        if ((u % 64) == 0) {
            OFA_REG_WR32(address2Imemt, blk++);
        }
        i = (u << (0 ? LW_POFA_FALCON_IMEMC_OFFS));
        OFA_REG_WR32(address2Imem, i);
        if ((u % 8 == 0))
        {
            dprintf("\n%04X: ", 4 * u);
        }
        dprintf("%08X ", OFA_REG_RD32(addressImem));
    }
    dprintf("\n");
    return status;
}
...
//-----------------------------------------------------
LW_STATUS ofaDumpDmem_v01_02(LwU32 indexGpu, LwU32 dmemSize, LwU32 offs2MthdOffs)
{
    LW_STATUS status = LW_OK;
    LwU32 dmemSizeMax;
    ...
    dmemSizeMax = (OFA_REG_RD_DRF(_POFA_FALCON, _HWCFG, _DMEM_SIZE) << 8);
    ...
    for (u = 0; u<(dmemSize + 3) / 4; u++)
    {
        ...
        OFA_REG_WR32(address2, i);
        if ((u % 8 == 0))
        {
            dprintf("\n%04X: ", 4 * u);
        }
        dprintf("%08X ", OFA_REG_RD32(address));
    }
    dprintf("\n\n");
    ...
    OFA_REG_WR32(address2, u);
    mthdOffs = (OFA_REG_RD32(address)) >> 2;
...
//-----------------------------------------------------
// ofaTestState_v01_02 - Test basic ofa state
//-----------------------------------------------------
LW_STATUS ofaTestState_v01_02(LwU32 indexGpu)
{
    LW_STATUS    status = LW_OK;
    LwU32   regIntr;
    LwU32   regIntrEn;
    ...
    regIntr = OFA_REG_RD32(LW_POFA_FALCON_IRQSTAT);
    regIntrEn = OFA_REG_RD32(LW_POFA_FALCON_IRQMASK);
    regIntr &= regIntrEn;
    ...
    if (DRF_VAL(_POFA, _FALCON_IRQSTAT, _GPTMR, regIntr))
    {
        ...
        dprintf("lw: LW_POFA_FALCON_GPTMRINT:    0x%08x\n",
            OFA_REG_RD32(LW_POFA_FALCON_GPTMRINT));
        dprintf("lw: LW_POFA_FALCON_GPTMRVAL:    0x%08x\n",
            OFA_REG_RD32(LW_POFA_FALCON_GPTMRVAL));
    ...
    if (DRF_VAL(_POFA, _FALCON_IRQSTAT, _MTHD, regIntr))
    {
        ...
        dprintf("lw: LW_POFA_FALCON_MTHDDATA_DATA:    0x%08x\n",
            OFA_REG_RD32(LW_POFA_FALCON_MTHDDATA));

        data32 = OFA_REG_RD32(LW_POFA_FALCON_MTHDID);
    ...
    data32 = OFA_REG_RD32(LW_POFA_FALCON_IDLESTATE);
    ...
    data32 = OFA_REG_RD32(LW_POFA_FALCON_FHSTATE);
    ...
    data32 = OFA_REG_RD32(LW_POFA_FALCON_ENGCTL);
    ...
    data32 = OFA_REG_RD32(LW_POFA_FALCON_CPUCTL);
    ...
    data32 = OFA_REG_RD32(LW_POFA_FALCON_ITFEN);
...
LW_STATUS  ofaDisplayFlcnSPR_v01_02(LwU32 indexGpu)
{
    dprintf("lw:\n");
    dprintf("lw: -- Gpu %u OFA %X Special Purpose Registers -- \n", indexGpu, pOfa[indexGpu].ofaGetClassId());
    dprintf("lw:\n");

    OFA_REG_WR32(LW_POFA_FALCON_ICD_CMD, (LW_POFA_FALCON_ICD_CMD_IDX_IV0 << 8) | LW_POFA_FALCON_ICD_CMD_OPC_RREG);
    dprintf("lw: OFA IV0 :    0x%08x\n", OFA_REG_RD32(LW_POFA_FALCON_ICD_RDATA));
    OFA_REG_WR32(LW_POFA_FALCON_ICD_CMD, (LW_POFA_FALCON_ICD_CMD_IDX_IV1 << 8) | LW_POFA_FALCON_ICD_CMD_OPC_RREG);
    dprintf("lw: OFA IV1 :    0x%08x\n", OFA_REG_RD32(LW_POFA_FALCON_ICD_RDATA));
    OFA_REG_WR32(LW_POFA_FALCON_ICD_CMD, (LW_POFA_FALCON_ICD_CMD_IDX_EV << 8) | LW_POFA_FALCON_ICD_CMD_OPC_RREG);
    dprintf("lw: OFA EV  :    0x%08x\n", OFA_REG_RD32(LW_POFA_FALCON_ICD_RDATA));
    OFA_REG_WR32(LW_POFA_FALCON_ICD_CMD, (LW_POFA_FALCON_ICD_CMD_IDX_SP << 8) | LW_POFA_FALCON_ICD_CMD_OPC_RREG);
    dprintf("lw: OFA SP  :    0x%08x\n", OFA_REG_RD32(LW_POFA_FALCON_ICD_RDATA));
    OFA_REG_WR32(LW_POFA_FALCON_ICD_CMD, (LW_POFA_FALCON_ICD_CMD_IDX_PC << 8) | LW_POFA_FALCON_ICD_CMD_OPC_RREG);
    dprintf("lw: OFA PC  :    0x%08x\n", OFA_REG_RD32(LW_POFA_FALCON_ICD_RDATA));
    OFA_REG_WR32(LW_POFA_FALCON_ICD_CMD, (LW_POFA_FALCON_ICD_CMD_IDX_IMB << 8) | LW_POFA_FALCON_ICD_CMD_OPC_RREG);
    dprintf("lw: OFA IMB :    0x%08x\n", OFA_REG_RD32(LW_POFA_FALCON_ICD_RDATA));
    OFA_REG_WR32(LW_POFA_FALCON_ICD_CMD, (LW_POFA_FALCON_ICD_CMD_IDX_DMB << 8) | LW_POFA_FALCON_ICD_CMD_OPC_RREG);
    dprintf("lw: OFA DMB :    0x%08x\n", OFA_REG_RD32(LW_POFA_FALCON_ICD_RDATA));
    OFA_REG_WR32(LW_POFA_FALCON_ICD_CMD, (LW_POFA_FALCON_ICD_CMD_IDX_CSW << 8) | LW_POFA_FALCON_ICD_CMD_OPC_RREG);
...
// ofaPrintPriv_v01_00
//-----------------------------------------------------
void ofaPrintPriv_v01_02(LwU32 clmn, char *tag, LwU32 id)
{
 ...
 */
LwU32
ofaGetFalconBase_v01_02()
{
    LwU32 base = 0x1000;//DEVICE_BASE(LW_POFA); //TODO: DEVICE_BASE(LW_POFA) returns wrong offset 0
    return base;
}
