...
//*****************************************************
//
// disp0205.c - Disp V02_05 display routines 
// 
//*****************************************************
 ...
 * @returns  aux port
 */
LwU32 dispGetAuxPortByLink_v02_05(LwU32 index)
{
...
LwU32
dispGetNumAuxPorts_v02_05(void)
{
...
void
dispPrintChanMethodState_v02_05
(
    LwU32 chanNum,
    BOOL printHeadless,
...
#ifndef LW957D_HEAD_SET_DISPLAY_ID__SIZE_1
#define LW957D_HEAD_SET_DISPLAY_ID__SIZE_1                          2
#endif

    switch(chanId)
    {
        case CHNTYPE_CORE: // Core channel - 957D
            for (head = 0; head < pDisp[indexGpu].dispGetNumHeads(); ++head)
            {
                ...
                dprintf("----------------------------------------------------------------------------------------------\n");
                //
                // The following list is based off of //sw/dev/gpu_drv/chips_a/sdk/lwpu/inc/class/cl957d.h#13
                // Note that it's implicit that the above comment applies only to core channel (d in 957d implies core)
                //
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_PRESENT_CONTROL, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CONTROL_OUTPUT_RESOURCE, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CONTROL, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_LOCK_OFFSET, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_OVERSCAN_COLOR, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_RASTER_SIZE, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_RASTER_SYNC_END, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_RASTER_BLANK_END, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_RASTER_BLANK_START, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_RASTER_VERT_BLANK2, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_LOCK_CHAIN, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_DEFAULT_BASE_COLOR, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CRC_CONTROL, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_LEGACY_CRC_CONTROL, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CONTEXT_DMA_CRC, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_BASE_LUT_LO, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_BASE_LUT_HI, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_OUTPUT_LUT_LO, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_OUTPUT_LUT_HI, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_PIXEL_CLOCK_FREQUENCY, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_PIXEL_CLOCK_CONFIGURATION, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CONTEXT_DMA_LUT, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_OFFSET, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_SIZE, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_STORAGE, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_PARAMS, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CONTEXT_DMAS_ISO, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CONTROL_LWRSOR, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_PRESENT_CONTROL_LWRSOR, head, chanNum);
                DISP_PRINT_SC_DOUBLE_IDX_V02_01(LW957D_HEAD_SET_OFFSETS_LWRSOR, head, 0, chanNum);
                DISP_PRINT_SC_DOUBLE_IDX_V02_01(LW957D_HEAD_SET_OFFSETS_LWRSOR, head, 1, chanNum);
                DISP_PRINT_SC_DOUBLE_IDX_V02_01(LW957D_HEAD_SET_CONTEXT_DMAS_LWRSOR, head, 0, chanNum);
                DISP_PRINT_SC_DOUBLE_IDX_V02_01(LW957D_HEAD_SET_CONTEXT_DMAS_LWRSOR, head, 1, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_DITHER_CONTROL, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CONTROL_OUTPUT_SCALER, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_PROCAMP, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_VIEWPORT_POINT_IN, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_VIEWPORT_SIZE_IN, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_VIEWPORT_POINT_OUT_ADJUST, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_VIEWPORT_SIZE_OUT, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_VIEWPORT_SIZE_OUT_MIN, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_VIEWPORT_SIZE_OUT_MAX, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_BASE_CHANNEL_USAGE_BOUNDS, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_OVERLAY_USAGE_BOUNDS, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_PROCESSING, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_COLWERSION_RED, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_COLWERSION_GRN, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_COLWERSION_BLU, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_RED2RED, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_GRN2RED, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_BLU2RED, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_CONSTANT2RED, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_RED2GRN, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_GRN2GRN, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_BLU2GRN, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_CONSTANT2GRN, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_RED2BLU, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_GRN2BLU, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_BLU2BLU, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CSC_CONSTANT2BLU, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_HDMI_CTRL, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_VACTIVE_SPACE_COLOR, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_PIXEL_REORDER_CONTROL, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_GET_BLANKING_CTRL, head, chanNum);
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_CONTROL_COMPRESSION, head, chanNum);
#ifdef LW957D_HEAD_SET_STALL_LOCK
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_STALL_LOCK, head, chanNum);
#endif
                for (k = 0; k < LW957D_HEAD_SET_DISPLAY_ID__SIZE_1; ++k)
                {
                    DISP_PRINT_SC_DOUBLE_IDX_V02_01(LW957D_HEAD_SET_DISPLAY_ID, head, k, chanNum);
                }

                // It seems the following registers need not be printed
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_SW_METHOD_PLACEHOLDER_A, head, chanNum); 
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_SW_METHOD_PLACEHOLDER_B, head, chanNum); 
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_SW_METHOD_PLACEHOLDER_C, head, chanNum); 
                DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_HEAD_SET_SW_METHOD_PLACEHOLDER_D, head, chanNum); 
            }
            ...
            if (printHeadless == TRUE)
            {
                ...
                for (k = 0; k < numDacs; ++k)
                {
                    DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_DAC_SET_CONTROL,           k, chanNum);
                    DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_DAC_SET_LWSTOM_REASON,     k, chanNum);
                }
                for (k = 0; k < numSors; ++k)
                {
                    DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_SOR_SET_CONTROL,           k, chanNum);
                    DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_SOR_SET_LWSTOM_REASON,     k, chanNum);
                }
                for (k = 0; k < numPiors; ++k)
                {
                    DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_PIOR_SET_CONTROL,          k, chanNum);
                    DISP_PRINT_SC_SINGLE_IDX_V02_01(LW957D_PIOR_SET_LWSTOM_REASON,    k, chanNum);
                }
                DISP_PRINT_SC_NON_IDX_V02_01(LW957D_SET_CONTEXT_DMA_NOTIFIER, chanNum);
                DISP_PRINT_SC_NON_IDX_V02_01(LW957D_SET_NOTIFIER_CONTROL, chanNum);
            }
        ...
        case CHNTYPE_BASE: // Base channel - 957C
        case CHNTYPE_OVLY: // Ovly channel - 957E
            dispPrintChanMethodState_v02_01(chanNum, printHeadless, printRegsWithoutEquivMethod, coreHead, coreWin);
            break;

        case CHNTYPE_OVIM: // Ovim channel - 957B
            // Nothing to print.
            break;

        case CHNTYPE_LWRS: // Lwrs channel - 957A
            // Nothing to print.
            break;
...
void dispOrPadlinkConnection_v02_05(void)
{
    LwU32       data32, sor;
    PADLINK     link, sorStatus[LW_PDISP_CLK_REM_SYS_CAP_SOR_EXISTS__SIZE_1][LW_MAX_SUBLINK];
    SOR_SUBLINK sub;

    // Initialization.
    for (sor = 0; sor < LW_PDISP_CLK_REM_SYS_CAP_SOR_EXISTS__SIZE_1; sor++)
    {
    ...
    for (link = PADLINK_A; link <  LW_PDISP_CLK_REM_LINK_CTRL__SIZE_1; link++)
    {
        data32 = GPU_REG_RD32(LW_PDISP_CLK_REM_LINK_CTRL(link));
        if (DRF_VAL(_PDISP, _CLK_REM_LINK_CTRL, _FRONTEND, data32) != LW_PDISP_CLK_REM_LINK_CTRL_FRONTEND_NONE)
        {
            switch(DRF_VAL(_PDISP, _CLK_REM_LINK_CTRL, _FRONTEND, data32))
            {
                case LW_PDISP_CLK_REM_LINK_CTRL_FRONTEND_SOR0:
                    sor = 0;
                    break;
                case LW_PDISP_CLK_REM_LINK_CTRL_FRONTEND_SOR1:
                    sor = 1;
                    break;
                case LW_PDISP_CLK_REM_LINK_CTRL_FRONTEND_SOR2:
                    sor = 2;
                    break;
                case LW_PDISP_CLK_REM_LINK_CTRL_FRONTEND_SOR3:
                    sor = 3;
                    break;
            }
            switch(DRF_VAL(_PDISP, _CLK_REM_LINK_CTRL, _FRONTEND_SOR, data32))
            {
                case LW_PDISP_CLK_REM_LINK_CTRL_FRONTEND_SOR_PRIMARY:
                    sorStatus[sor][PRIMARY] = link;
                    break;
                case LW_PDISP_CLK_REM_LINK_CTRL_FRONTEND_SOR_SECONDARY:
    ...
    {
        dprintf("   SOR%d", sor);
        data32 = GPU_REG_RD32(LW_PDISP_CLK_REM_SYS_CAP);
        if (FLD_IDX_TEST_DRF(_PDISP, _CLK_REM_SYS_CAP_SOR, _EXISTS, sor, _YES, data32))
            dprintf("       |      Yes      |     ");
        else
            dprintf("       |      No       |     ");
...
)
{
    ...
    LwU32 reg;
    LwU8 subLink, i;
    BOOL bSorFullXarEnabled = FALSE;

    if (sorIndx >= LW_PDISP_MAX_SOR || pLinks == NULL)
        return FALSE;

    // Reset first
    pLinks[PRIMARY]   = PADLINK_NONE;
    pLinks[SECONDARY] = PADLINK_NONE;

    // Check if SOR full xbar is deployed.
    for (i = 0; i < LW_PDISP_CLK_REM_LINK_CTRL__SIZE_1; i++)
    {
        reg = GPU_REG_RD32(LW_PDISP_CLK_REM_LINK_CTRL(i));
        if (FLD_TEST_DRF_NUM(_PDISP, _CLK_REM_LINK_CTRL, _FRONTEND, sorIndx + 1, reg))
        {
            subLink = DRF_VAL(_PDISP, _CLK_REM_LINK_CTRL, _FRONTEND_SOR, reg);
            pLinks[subLink] = i;
            bSorFullXarEnabled = TRUE;
        }
    }

    if (!bSorFullXarEnabled)
    {
 ...
 */
void dispDisplayPortInfo_v02_05
(
    LwU32 port,
    LwU32 sorIndex,
    LwU32 dpIndex
    ...
    if (headMask)
    {
        ...
        for (i = 0; i < pDisp[indexGpu].dispGetNumSfs(); i++)
        {
            ...
            if (DRF_VAL(_PDISP, _SF_TEST, _OWNER_MASK, reg) & headMask)
            {
                ...
                dprintf("%-55s: %s\n",
                    "LW_PDISP_SF_DP_LINKCTL_SINGLE_HEAD_MST",
                    DRF_VAL(_PDISP, _SF_DP_LINKCTL, _SINGLE_HEAD_MST, reg) ?
                    "ENABLED" : "DISABLED");
                ...
                dprintf("%-55s: %d\n", "LW_PDISP_SF_DP_2ND_STREAM_CTL_START",
                    DRF_VAL(_PDISP, _SF_DP_2ND_STREAM_CTL, _START, reg));

                dprintf("%-55s: %d\n", "LW_PDISP_SF_DP_2ND_STREAM_CTL_LENGTH",
                    DRF_VAL(_PDISP, _SF_DP_2ND_STREAM_CTL, _LENGTH, reg));

                dprintf("%-55s: %d\n",
                    "LW_PDISP_SF_DP_2ND_STREAM_CTL_START_ACTIVE",
                    DRF_VAL(_PDISP, _SF_DP_2ND_STREAM_CTL, _START_ACTIVE, reg)
                    );

                dprintf("%-55s: %d\n",
                    "LW_PDISP_SF_DP_2ND_STREAM_CTL_LENGTH_ACTIVE",
                    DRF_VAL(_PDISP, _SF_DP_2ND_STREAM_CTL, _LENGTH_ACTIVE, reg)
                    );

                reg = GPU_REG_RD32(LW_PDISP_SF_DP_2ND_STREAM_BW(i));

                dprintf("%-55s: %d\n",
                    "LW_PDISP_SF_DP_2ND_STREAM_BW_ALLOCATED",
                    DRF_VAL(_PDISP, _SF_DP_2ND_STREAM_BW, _ALLOCATED, reg));

                dprintf("%-55s: %d\n",
                    "LW_PDISP_SF_DP_2ND_STREAM_BW_TIMESLICE",
                    DRF_VAL(_PDISP, _SF_DP_2ND_STREAM_BW, _TIMESLICE, reg));
            }
        }
    }
...
void
dispDisplayPortEnum_v02_05(void)
{
    DPINFO_SF  *sf = 0;
    DPINFO_SOR *sor = 0;
    ...
    for (i = 0; i < numHead; i++)
    {
        headDisplayId[i] = GPU_REG_RD32(LW_UDISP_DSI_CHN_ARMED_BASEADR(0) +
                                        LW957D_HEAD_SET_DISPLAY_ID(i, 0));
    }
    ...
    for (i = 0; i < numSor; i++)
    {
        ...
        reg = GPU_REG_RD32(LW_UDISP_DSI_CHN_ARMED_BASEADR(0) +
                           LW957D_SOR_SET_CONTROL(i));
        sor[i].protocol = DRF_VAL(957D, _SOR_SET_CONTROL, _PROTOCOL, reg);
