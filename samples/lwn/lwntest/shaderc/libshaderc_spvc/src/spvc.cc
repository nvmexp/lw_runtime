  ...
  do {                                                                    \
    if (!context) {                                                       \
      shaderc_spvc::ErrorLog(nullptr)                                     \
          << "Ilwoked " << __func__ << " without an initialized context"; \
...
#define CHECK_OPTIONS(context, options)                                   \
  do {                                                                    \
    if (!options) {                                                       \
      shaderc_spvc::ErrorLog(context)                                     \
          << "Ilwoked " << __func__ << " without an initialized options"; \
...
#define CHECK_RESULT(context, result)                                    \
  do {                                                                   \
    if (!result) {                                                       \
      shaderc_spvc::ErrorLog(context)                                    \
          << "Ilwoked " << __func__ << " without an initialized result"; \
...
#define CHECK_OUT_PARAM(context, param, param_str)                 \
  do {                                                             \
    if (!param) {                                                  \
      shaderc_spvc::ErrorLog(context)                              \
          << "Ilwoked " << __func__ << " with invalid out param, " \
          << param_str;                                            \
      return shaderc_spvc_status_ilwalid_out_param;                \
    }                                                              \
  } while (0)
...
#define CHECK_IN_PARAM(context, param, param_str)                 \
  do {                                                            \
    if (!param) {                                                 \
      shaderc_spvc::ErrorLog(context)                             \
          << "Ilwoked " << __func__ << " with invalid in param, " \
          << param_str;                                           \
      return shaderc_spvc_status_ilwalid_in_param;                \
    }                                                             \
  } while (0)

namespace {

spv::ExelwtionModel spvc_model_to_spv_model(
    shaderc_spvc_exelwtion_model model) {
  switch (model) {
    case shaderc_spvc_exelwtion_model_vertex:
      return spv::ExelwtionModel::ExelwtionModelVertex;
    case shaderc_spvc_exelwtion_model_fragment:
      return spv::ExelwtionModel::ExelwtionModelFragment;
    case shaderc_spvc_exelwtion_model_glcompute:
      return spv::ExelwtionModel::ExelwtionModelGLCompute;
    case shaderc_spvc_exelwtion_model_ilwalid:
      return spv::ExelwtionModel::ExelwtionModelMax;
  }
...
shaderc_spvc_exelwtion_model spv_model_to_spvc_model(
    spv::ExelwtionModel model) {
  switch (model) {
    case spv::ExelwtionModel::ExelwtionModelVertex:
      return shaderc_spvc_exelwtion_model_vertex;
    case spv::ExelwtionModel::ExelwtionModelFragment:
      return shaderc_spvc_exelwtion_model_fragment;
    case spv::ExelwtionModel::ExelwtionModelGLCompute:
      return shaderc_spvc_exelwtion_model_glcompute;
    default:
      return shaderc_spvc_exelwtion_model_ilwalid;
  }
}
...
shaderc_spvc_texture_view_dimension spirv_dim_to_texture_view_dimension(
  ...
  switch (dim) {
    ...
    case spv::Dim::DimLwbe:
      if (arrayed) {
        return shaderc_spvc_texture_view_dimension_lwbe_array;
      } else {
        return shaderc_spvc_texture_view_dimension_lwbe;
      }
    default:
...
spv_target_elw shaderc_spvc_spv_elw_to_spv_target_elw(
    shaderc_spvc_spv_elw elw) {
  switch (elw) {
    case shaderc_spvc_spv_elw_universal_1_0:
      return SPV_ELW_UNIVERSAL_1_0;
    case shaderc_spvc_spv_elw_vulkan_1_0:
      return SPV_ELW_VULKAN_1_0;
    case shaderc_spvc_spv_elw_universal_1_1:
      return SPV_ELW_UNIVERSAL_1_1;
    case shaderc_spvc_spv_elw_opencl_2_1:
      return SPV_ELW_OPENCL_2_1;
    case shaderc_spvc_spv_elw_opencl_2_2:
      return SPV_ELW_OPENCL_2_2;
    case shaderc_spvc_spv_elw_opengl_4_0:
      return SPV_ELW_OPENGL_4_0;
    case shaderc_spvc_spv_elw_opengl_4_1:
      return SPV_ELW_OPENGL_4_1;
    case shaderc_spvc_spv_elw_opengl_4_2:
      return SPV_ELW_OPENGL_4_2;
    case shaderc_spvc_spv_elw_opengl_4_3:
      return SPV_ELW_OPENGL_4_3;
    case shaderc_spvc_spv_elw_opengl_4_5:
      return SPV_ELW_OPENGL_4_5;
    case shaderc_spvc_spv_elw_universal_1_2:
      return SPV_ELW_UNIVERSAL_1_2;
    case shaderc_spvc_spv_elw_opencl_1_2:
      return SPV_ELW_OPENCL_1_2;
    case shaderc_spvc_spv_elw_opencl_embedded_1_2:
      return SPV_ELW_OPENCL_EMBEDDED_1_2;
    case shaderc_spvc_spv_elw_opencl_2_0:
      return SPV_ELW_OPENCL_2_0;
    case shaderc_spvc_spv_elw_opencl_embedded_2_0:
      return SPV_ELW_OPENCL_EMBEDDED_2_0;
    case shaderc_spvc_spv_elw_opencl_embedded_2_1:
      return SPV_ELW_OPENCL_EMBEDDED_2_1;
    case shaderc_spvc_spv_elw_opencl_embedded_2_2:
      return SPV_ELW_OPENCL_EMBEDDED_2_2;
    case shaderc_spvc_spv_elw_universal_1_3:
      return SPV_ELW_UNIVERSAL_1_3;
    case shaderc_spvc_spv_elw_vulkan_1_1:
      return SPV_ELW_VULKAN_1_1;
    case shaderc_spvc_spv_elw_webgpu_0:
      return SPV_ELW_WEBGPU_0;
    case shaderc_spvc_spv_elw_universal_1_4:
      return SPV_ELW_UNIVERSAL_1_4;
    case shaderc_spvc_spv_elw_vulkan_1_1_spirv_1_4:
      return SPV_ELW_VULKAN_1_1_SPIRV_1_4;
    case shaderc_spvc_spv_elw_universal_1_5:
      return SPV_ELW_UNIVERSAL_1_5;
    case shaderc_spvc_spv_elw_vulkan_1_2:
      return SPV_ELW_VULKAN_1_2;
  }
  shaderc_spvc::ErrorLog(nullptr)
      << "Attempted to colwert unknown shaderc_spvc_spv_elw value, " << elw;
  assert(false);
  return SPV_ELW_UNIVERSAL_1_0;
}
...
shaderc_spvc_compile_options_t shaderc_spvc_compile_options_create(
    shaderc_spvc_spv_elw source_elw, shaderc_spvc_spv_elw target_elw) {
  shaderc_spvc_compile_options_t options =
      new (std::nothrow) shaderc_spvc_compile_options;
  if (options) {
    options->glsl.version = 0;
    options->source_elw = shaderc_spvc_spv_elw_to_spv_target_elw(source_elw);
    options->target_elw = shaderc_spvc_spv_elw_to_spv_target_elw(target_elw);
  }
  return options;
}
...
// DEPRECATED
shaderc_spvc_status shaderc_spvc_compile_options_set_source_elw(
    shaderc_spvc_compile_options_t options, shaderc_target_elw elw,
    shaderc_elw_version version) {
  CHECK_OPTIONS(nullptr, options);

  options->source_elw = spvc_private::get_spv_target_elw(elw, version);
  return shaderc_spvc_status_success;
}

// DEPRECATED
shaderc_spvc_status shaderc_spvc_compile_options_set_target_elw(
    shaderc_spvc_compile_options_t options, shaderc_target_elw elw,
    shaderc_elw_version version) {
  CHECK_OPTIONS(nullptr, options);

  options->target_elw = spvc_private::get_spv_target_elw(elw, version);
  return shaderc_spvc_status_success;
}
...
shaderc_spvc_status shaderc_spvc_compile_shader(
  ...
  if (context->target_lang == SPVC_TARGET_LANG_UNKNOWN) {
    shaderc_spvc::ErrorLog(context)
        << "Ilwoked compile_shader with unknown language";
...
shaderc_spvc_status shaderc_spvc_set_decoration(
  ...
  if (status == shaderc_spvc_status_success) {
    ...
    shaderc_spvc::ErrorLog(context) << "Decoration Colwersion failed. "
...
shaderc_spvc_status shaderc_spvc_add_msl_resource_binding(
  ...
  if (context->target_lang != SPVC_TARGET_LANG_MSL) {
    shaderc_spvc::ErrorLog(context)
        << "Ilwoked add_msl_resource_binding when target language was not MSL";
    return shaderc_spvc_status_configuration_error;
  }
...
shaderc_spvc_status shaderc_spvc_get_workgroup_size(
    ...
    shaderc_spvc_exelwtion_model exelwtion_model,
  ...
  const auto& cross_size =
      context->cross_compiler
          ->get_entry_point(function_name,
                            spvc_model_to_spv_model(exelwtion_model))
          .workgroup_size;
...
shaderc_spvc_status shaderc_spvc_needs_buffer_size_buffer(
  ...
  if (context->target_lang != SPVC_TARGET_LANG_MSL) {
    shaderc_spvc::ErrorLog(context)
        << "Ilwoked needs_buffer_size_buffer when target language was not MSL";
    return shaderc_spvc_status_configuration_error;
  }
...
shaderc_spvc_status shaderc_spvc_get_exelwtion_model(
    const shaderc_spvc_context_t context,
    shaderc_spvc_exelwtion_model* exelwtion_model) {
  CHECK_CONTEXT(context);
  CHECK_CROSS_COMPILER(context, context->cross_compiler);
  CHECK_OUT_PARAM(context, exelwtion_model, "exelwtion_model");

  auto spirv_model = context->cross_compiler->get_exelwtion_model();
  *exelwtion_model = spv_model_to_spvc_model(spirv_model);
  if (*exelwtion_model == shaderc_spvc_exelwtion_model_ilwalid) {
    shaderc_spvc::ErrorLog(context)
        << "Shader exelwtion model appears to be of an unsupported type";
    return shaderc_spvc_status_internal_error;
  }
