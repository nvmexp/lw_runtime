...
typedef enum {
  ...
  shaderc_spvc_status_ilwalid_out_param,
  shaderc_spvc_status_missing_options_error,
  shaderc_spvc_status_ilwalid_in_param,
  shaderc_spvc_status_missing_result_error,
} shaderc_spvc_status;

typedef enum {
  shaderc_spvc_exelwtion_model_vertex,
  shaderc_spvc_exelwtion_model_fragment,
  shaderc_spvc_exelwtion_model_glcompute,
  shaderc_spvc_exelwtion_model_ilwalid,
} shaderc_spvc_exelwtion_model;
...
typedef enum {
  ...
  shaderc_spvc_texture_view_dimension_lwbe = 0x00000004,
  shaderc_spvc_texture_view_dimension_lwbe_array = 0x00000005,
...
typedef enum {
  shaderc_spvc_spv_elw_universal_1_0,
  shaderc_spvc_spv_elw_vulkan_1_0,
  shaderc_spvc_spv_elw_universal_1_1,
  shaderc_spvc_spv_elw_opencl_2_1,
  shaderc_spvc_spv_elw_opencl_2_2,
  shaderc_spvc_spv_elw_opengl_4_0,
  shaderc_spvc_spv_elw_opengl_4_1,
  shaderc_spvc_spv_elw_opengl_4_2,
  shaderc_spvc_spv_elw_opengl_4_3,
  shaderc_spvc_spv_elw_opengl_4_5,
  shaderc_spvc_spv_elw_universal_1_2,
  shaderc_spvc_spv_elw_opencl_1_2,
  shaderc_spvc_spv_elw_opencl_embedded_1_2,
  shaderc_spvc_spv_elw_opencl_2_0,
  shaderc_spvc_spv_elw_opencl_embedded_2_0,
  shaderc_spvc_spv_elw_opencl_embedded_2_1,
  shaderc_spvc_spv_elw_opencl_embedded_2_2,
  shaderc_spvc_spv_elw_universal_1_3,
  shaderc_spvc_spv_elw_vulkan_1_1,
  shaderc_spvc_spv_elw_webgpu_0,
  shaderc_spvc_spv_elw_universal_1_4,
  shaderc_spvc_spv_elw_vulkan_1_1_spirv_1_4,
  shaderc_spvc_spv_elw_universal_1_5,
  shaderc_spvc_spv_elw_vulkan_1_2,
} shaderc_spvc_spv_elw;
...
typedef struct {
  shaderc_spvc_exelwtion_model stage;
  uint32_t desc_set;
  uint32_t binding;
  uint32_t msl_buffer;
...
// That is: conlwrrent invocation of these functions on DIFFERENT objects needs
// no synchronization; conlwrrent invocation of these functions on the SAME
...
shaderc_spvc_compile_options_create(shaderc_spvc_spv_elw source_elw,
                                    shaderc_spvc_spv_elw target_elw);
...
SHADERC_EXPORT shaderc_spvc_status shaderc_spvc_compile_options_set_source_elw(
...
// environment, then a transform between the elwironments will be performed if
// possible. Lwrrently only WebGPU <-> Vulkan 1.1 are defined.
// Default value for environment is Vulkan 1.0.
SHADERC_EXPORT shaderc_spvc_status shaderc_spvc_compile_options_set_target_elw(
    shaderc_spvc_compile_options_t options, shaderc_target_elw elw,
    shaderc_elw_version version);
...
// If true ilwert gl_Position.y or equivalent.  Default is false.
...
// spirv-cross comment:
// Analyzes all separate image and samplers used from the lwrrently selected
...
// Gets workgroup size for an entry point defined by a given exelwtion model and
// function name.
...
// Gets the exelwtion model for the shader parsed by the compiler.
SHADERC_EXPORT shaderc_spvc_status
shaderc_spvc_get_exelwtion_model(const shaderc_spvc_context_t context,
                                 shaderc_spvc_exelwtion_model* exelwtion_model);
