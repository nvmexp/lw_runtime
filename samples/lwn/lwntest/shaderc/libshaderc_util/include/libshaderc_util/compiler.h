...
// To break relwrsive including. This header is already included in
...
class Compiler {
 public:
  ...
  enum class TargetElwVersion : uint32_t {
...
#undef RESOURCE
  ...
  Compiler()
      ...
      : default_version_(110),
        ...
        enabled_opt_passes_(),
        target_elw_(TargetElw::Vulkan),
        target_elw_version_(TargetElwVersion::Default),
  ...
  // Enables or disables ilwert position.Y output in vertex shader.
  void EnableIlwertY(bool enable);
  ...
  // be 0 or one of the values from TargetElwVersion.  The default value maps
  // to Vulkan 1.0 if the target environment is Vulkan, and it maps to OpenGL
  // 4.5 if the target environment is OpenGL.
  void SetTargetElw(TargetElw elw,
                    TargetElwVersion version = TargetElwVersion::Default);
 ...
 protected:
  ...
  // for those defaults.
  TargetElwVersion target_elw_version_;
  ...
  // True if the compiler should ilwert position.Y output in vertex shader.
  bool ilwert_y_enabled_;
...
// Colwerts a valid Glslang shader stage value to a Compiler::Stage value.
inline Compiler::Stage ColwertToStage(EShLanguage stage) {
  switch (stage) {
    case EShLangVertex:
    ...
    case EShLangRayGenLW:
      return Compiler::Stage::RayGenLW;
    case EShLangIntersectLW:
      return Compiler::Stage::IntersectLW;
    case EShLangAnyHitLW:
      return Compiler::Stage::AnyHitLW;
    case EShLangClosestHitLW:
      return Compiler::Stage::ClosestHitLW;
    case EShLangMissLW:
      return Compiler::Stage::MissLW;
    case EShLangCallableLW:
      return Compiler::Stage::CallableLW;
    case EShLangTaskLW:
      return Compiler::Stage::TaskLW;
    case EShLangMeshLW:
      return Compiler::Stage::MeshLW;
    default:
      break;
  }
...
GlslangClientInfo GetGlslangClientInfo(
    ...
    shaderc_util::Compiler::TargetElw elw,
