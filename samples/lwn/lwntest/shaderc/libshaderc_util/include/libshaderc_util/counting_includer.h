...
class CountingIncluder : public glslang::TShader::Includer {
 ...
 private:
  ...
  // Ilwoked by this class to provide results to
  ...
  // A mutex to protect against conlwrrent inclusions.  We can't trust
  // our delegates to be safe for conlwrrent inclusions.
