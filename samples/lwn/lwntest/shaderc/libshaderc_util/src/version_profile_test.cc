...
using shaderc_util::IsKnowlwersion;
using shaderc_util::ParseVersionProfile;
using ::testing::Eq;
using ::testing::ValuesIn;


TEST(IsKnowlwersionTest, Samples) {
  EXPECT_TRUE(IsKnowlwersion(100));
  EXPECT_TRUE(IsKnowlwersion(110));
  EXPECT_TRUE(IsKnowlwersion(120));
  EXPECT_TRUE(IsKnowlwersion(130));
  EXPECT_TRUE(IsKnowlwersion(140));
  EXPECT_TRUE(IsKnowlwersion(150));
  EXPECT_TRUE(IsKnowlwersion(300));
  EXPECT_TRUE(IsKnowlwersion(330));
  EXPECT_TRUE(IsKnowlwersion(310));
  EXPECT_TRUE(IsKnowlwersion(400));
  EXPECT_TRUE(IsKnowlwersion(410));
  EXPECT_TRUE(IsKnowlwersion(420));
  EXPECT_TRUE(IsKnowlwersion(430));
  EXPECT_TRUE(IsKnowlwersion(440));
  EXPECT_TRUE(IsKnowlwersion(450));
  EXPECT_TRUE(IsKnowlwersion(460));
  EXPECT_FALSE(IsKnowlwersion(101));
  EXPECT_FALSE(IsKnowlwersion(470));
}
