...
if version < 600
  syntax clear
elseif exists("b:lwrrent_syntax")
  finish
endif
...
SPEC_CONSTANT_OP_OPCODES = """
        ...
        OpColwertFToS, OpColwertSToF
        OpColwertFToU, OpColwertUToF
        OpUColwert
        OpColwertPtrToU, OpColwertUToPtr
