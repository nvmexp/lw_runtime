...
class Context {
 public:
  // Constructs a context targeting the given environment |elw|.
  //
  ...
  explicit Context(spv_target_elw elw);
...
class ValidatorOptions {
 public:
  ...
  // Allow implicit colwersion to the underlying object.
...
class OptimizerOptions {
 public:
  ...
  void set_run_validator(bool run) {
    spvOptimizerOptionsSetRulwalidator(options_, run);
  }
...
class ReducerOptions {
 public:
  ...
  // See spvReducerOptionsSetFailOlwalidationError.
  void set_fail_on_validation_error(bool fail_on_validation_error) {
    spvReducerOptionsSetFailOlwalidationError(options_,
...
class SpirvTools {
 public:
  ...
  // Constructs an instance targeting the given environment |elw|.
  //
  // The constructed instance will have an empty message consumer, which just
  // ignores all messages from the library. Use SetMessageConsumer() to supply
  // one if messages are of concern.
  explicit SpirvTools(spv_target_elw elw);
