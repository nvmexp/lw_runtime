...
// error. The format of the records is dolwmented below.
...
static const int kInstCompOutGlobalIlwocationIdX = kInstCommonOutCnt;
static const int kInstCompOutGlobalIlwocationIdY = kInstCommonOutCnt + 1;
static const int kInstCompOutGlobalIlwocationIdZ = kInstCommonOutCnt + 2;

// Compute Shader Output Record Offsets - Version 1 (DEPRECATED)
static const int kInstCompOutGlobalIlwocationId = kInstCommonOutCnt;
static const int kInstCompOutUnused = kInstCommonOutCnt + 1;

// Tessellation Control Shader Output Record Offsets
static const int kInstTessCtlOutIlwocationId = kInstCommonOutCnt;
...
static const int kInstTessOutIlwocationId = kInstCommonOutCnt;
...
static const int kInstGeomOutIlwocationId = kInstCommonOutCnt + 1;
