...
std::string LogStringForDecoration(uint32_t decoration) {
  switch (decoration) {
    ...
    case SpvDecorationUniform:
      return "Uniform";
    case SpvDecorationSaturatedColwersion:
      return "SaturatedColwersion";
    ...
    case SpvDecorationOverrideCoverageLW:
      return "OverrideCoverageLW";
    case SpvDecorationPassthroughLW:
      return "PassthroughLW";
    case SpvDecoratiolwiewportRelativeLW:
      return "ViewportRelativeLW";
    case SpvDecorationSecondaryViewportRelativeLW:
      return "SecondaryViewportRelativeLW";
    case SpvDecorationPerPrimitiveLW:
      return "PerPrimitiveLW";
    case SpvDecorationPerViewLW:
      return "PerViewLW";
    case SpvDecorationPerTaskLW:
      return "PerTaskLW";
    case SpvDecorationPerVertexLW:
      return "PerVertexLW";
...
spv_result_t ValidateDecorate(ValidationState_t& _, const Instruction* inst) {
  ...
  if (spvIsWebGPUElw(_.context()->target_elw) &&
    ...
    return _.diag(SPV_ERROR_ILWALID_ID, inst)
           ...
           << "' is not valid for the WebGPU exelwtion environment.";
  }
...
spv_result_t ValidateDecorationGroup(ValidationState_t& _,
  ...
  if (spvIsWebGPUElw(_.context()->target_elw)) {
    return _.diag(SPV_ERROR_ILWALID_BINARY, inst)
           << "OpDecorationGroup is not allowed in the WebGPU exelwtion "
           << "environment.";
  }
...
spv_result_t ValidateGroupDecorate(ValidationState_t& _,
  ...
  if (spvIsWebGPUElw(_.context()->target_elw)) {
    return _.diag(SPV_ERROR_ILWALID_BINARY, inst)
           << "OpGroupDecorate is not allowed in the WebGPU exelwtion "
           << "environment.";
  }
...
spv_result_t ValidateGroupMemberDecorate(ValidationState_t& _,
  ...
  if (spvIsWebGPUElw(_.context()->target_elw)) {
    return _.diag(SPV_ERROR_ILWALID_BINARY, inst)
           << "OpGroupMemberDecorate is not allowed in the WebGPU exelwtion "
           << "environment.";
  }
