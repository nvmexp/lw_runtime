...
///
/// @return SPV_SUCCESS if no errors are found. SPV_ERROR_ILWALID_CFG otherwise
...
/// @param[in] _ the validation state of the module
///
/// @return SPV_SUCCESS if no errors are found. SPV_ERROR_ILWALID_ID otherwise
spv_result_t CheckIdDefinitionDominateUse(ValidationState_t& _);

/// @brief This function checks for preconditions ilwolving the adjacent
/// instructions.
///
...
/// @param[in] _ the validation state of the module
///
/// @return SPV_SUCCESS if no errors are found. SPV_ERROR_ILWALID_DATA otherwise
...
/// Validates correctness of colwersion instructions.
spv_result_t ColwersionPass(ValidationState_t& _, const Instruction* inst);
...
/// Validates exelwtion limitations.
///
/// Verifies exelwtion models are allowed for all functionality they contain.
spv_result_t ValidateExelwtionLimitations(ValidationState_t& _,
