...
// to a struct member, then the index is kIlwalidIndex. A Decoration object does
...
// struct_member_index_ = kIlwalidMember
//
...
class Decoration {
 ...
 private:
  ...
  // of the member is stored here. Otherwise, this is kIlwalidIndex.
