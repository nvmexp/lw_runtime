...
bool IsSupportOptionalVulkan_1_0(uint32_t capability) {
  switch (capability) {
    ...
    case SpvCapabilityLwllDistance:
    case SpvCapabilityImageLwbeArray:
    case SpvCapabilitySampleRateShading:
    case SpvCapabilitySparseResidency:
    case SpvCapabilityMinLod:
    case SpvCapabilitySampledLwbeArray:
...
spv_result_t CapabilityPass(ValidationState_t& _, const Instruction* inst) {
  ...
  const auto elw = _.context()->target_elw;
  const bool opencl_embedded = elw == SPV_ELW_OPENCL_EMBEDDED_1_2 ||
                               elw == SPV_ELW_OPENCL_EMBEDDED_2_0 ||
                               elw == SPV_ELW_OPENCL_EMBEDDED_2_1 ||
                               elw == SPV_ELW_OPENCL_EMBEDDED_2_2;
  ...
  } else if (elw == SPV_ELW_VULKAN_1_1) {
  ...
  } else if (elw == SPV_ELW_VULKAN_1_2) {
  ...
  } else if (elw == SPV_ELW_OPENCL_1_2 || elw == SPV_ELW_OPENCL_EMBEDDED_1_2) {
  ...
  } else if (elw == SPV_ELW_OPENCL_2_0 || elw == SPV_ELW_OPENCL_EMBEDDED_2_0 ||
             elw == SPV_ELW_OPENCL_2_1 || elw == SPV_ELW_OPENCL_EMBEDDED_2_1) {
  ...
  } else if (elw == SPV_ELW_OPENCL_2_2 || elw == SPV_ELW_OPENCL_EMBEDDED_2_2) {
