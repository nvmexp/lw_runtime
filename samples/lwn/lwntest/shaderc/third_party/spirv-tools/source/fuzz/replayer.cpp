...
struct Replayer::Impl {
  Impl(spv_target_elw elw, bool validate, spv_validator_options options)
      : target_elw(elw),
...
Replayer::Replayer(spv_target_elw elw, bool validate_during_replay,
                   spv_validator_options validator_options)
    : impl_(MakeUnique<Impl>(elw, validate_during_replay, validator_options)) {}
...
Replayer::ReplayerResultStatus Replayer::Run(
  ...
  if (!tools.Validate(&binary_in[0], binary_in.size(),
    ...
    return Replayer::ReplayerResultStatus::kInitialBinaryIlwalid;
  }
