...
void FuzzerPassAddFunctionCalls::Apply() {
  ForEachInstructionWithInstructionDescriptor(
      [this](opt::Function* function, opt::BasicBlock* block,
        ...
        // instruction.  We ignore this function to avoid direct relwrsion.
        ...
        while (!candidate_functions.empty()) {
          ...
          if (!GetTransformationContext()->GetFactManager()->BlockIsDead(
            ...
            // Unless in a dead block, only livesafe functions can be ilwoked
            continue;
          }
          if (call_graph.GetIndirectCallees(candidate_function->result_id())
                  .count(function->result_id())) {
            // Calling this function could lead to indirect relwrsion
            continue;
          }
