...
class TransformatiolwectorShuffle : public Transformation {
 public:
  explicit TransformatiolwectorShuffle(
      const protobufs::TransformatiolwectorShuffle& message);

  TransformatiolwectorShuffle(
 ...
 private:
  ...
  protobufs::TransformatiolwectorShuffle message_;
};
