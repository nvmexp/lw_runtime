...
TransformatiolwectorShuffle::TransformatiolwectorShuffle(
    const spvtools::fuzz::protobufs::TransformatiolwectorShuffle& message)
    : message_(message) {}
...
bool TransformatiolwectorShuffle::IsApplicable(
...
void TransformatiolwectorShuffle::Apply(
...
protobufs::Transformation TransformatiolwectorShuffle::ToMessage() const {
  protobufs::Transformation result;
  *result.mutable_vector_shuffle() = message_;
  return result;
}

uint32_t TransformatiolwectorShuffle::GetResultTypeId(
...
opt::analysis::Vector* TransformatiolwectorShuffle::GetVectorType(
