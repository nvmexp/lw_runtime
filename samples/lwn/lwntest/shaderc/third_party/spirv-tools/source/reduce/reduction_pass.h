...
// ilwoked to find and apply particular reduction opportunities to a SPIR-V
...
class ReductionPass {
 public:
  // Constructs a reduction pass with a given target environment, |target_elw|,
  // and a given finder of reduction opportunities, |finder|.
  explicit ReductionPass(const spv_target_elw target_elw,
                         std::unique_ptr<ReductionOpportunityFinder> finder)
      : target_elw_(target_elw),
  ...
  // this case, before the next call the caller must ilwoke
