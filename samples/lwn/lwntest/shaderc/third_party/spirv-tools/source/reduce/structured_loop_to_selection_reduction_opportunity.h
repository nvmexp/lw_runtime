...
#ifndef SOURCE_REDUCE_LWT_LOOP_REDUCTION_OPPORTUNITY_H_
#define SOURCE_REDUCE_LWT_LOOP_REDUCTION_OPPORTUNITY_H_
...
class StructuredLoopToSelectionReductionOpportunity
 ...
 private:
  ...
  // TODO(2184): This will likely be used by other reduction passes, so should
  // be factored out in due course.
  uint32_t FindOrCreateFunctiolwariable(uint32_t pointer_type_id);
...
#endif  // SOURCE_REDUCE_LWT_LOOP_REDUCTION_OPPORTUNITY_H_
