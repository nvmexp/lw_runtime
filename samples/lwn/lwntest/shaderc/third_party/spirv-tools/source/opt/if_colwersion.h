...
#ifndef SOURCE_OPT_IF_COLWERSION_H_
#define SOURCE_OPT_IF_COLWERSION_H_
...
class IfColwersion : public Pass {
 public:
  const char* name() const override { return "if-colwersion"; }
...
#endif  //  SOURCE_OPT_IF_COLWERSION_H_
