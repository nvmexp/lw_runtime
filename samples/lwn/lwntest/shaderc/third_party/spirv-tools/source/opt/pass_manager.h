...
// to run on a module. Passes are exelwted in the exact order of addition.
class PassManager {
 public:
  ...
  PassManager()
      : consumer_(nullptr),
        ...
        target_elw_(SPV_ELW_UNIVERSAL_1_2),
  ...
  PassManager& SetTargetElw(spv_target_elw elw) {
    target_elw_ = elw;
    return *this;
  }
