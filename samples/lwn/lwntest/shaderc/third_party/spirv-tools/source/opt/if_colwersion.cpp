...
#include "source/opt/if_colwersion.h"
...
Pass::Status IfColwersion::Process() {
...
bool IfColwersion::CheckBlock(BasicBlock* block, DominatorAnalysis* dominators,
                              BasicBlock** common) {
...
bool IfColwersion::CheckPhiUsers(Instruction* phi, BasicBlock* block) {
...
uint32_t IfColwersion::SplatCondition(analysis::Vector* vec_data_ty,
                                      uint32_t cond,
                                      InstructionBuilder* builder) {
...
bool IfColwersion::CheckType(uint32_t id) {
...
bool IfColwersion::CanHoistInstruction(Instruction* inst,
