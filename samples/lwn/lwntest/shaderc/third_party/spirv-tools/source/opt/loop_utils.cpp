...
class LCSSARewriter {
 public:
  ...
  struct UseRewriter {
    ...
    // |operand_index| in terms of phi instruction. This relwrsively builds new
    ...
    // In-place update of some managers (avoid full ilwalidation).
    ...
    for (Instruction& inst : *bb) {
      ...
      def_use_manager->ForEachUse(
          &inst, [&blocks, &rewriter, &exit_bb, context](
            ...
            // Rewrite the use. Note that this call does not ilwalidate the
