...
#ifndef SOURCE_OPT_SPLIT_ILWALID_UNREACHABLE_PASS_H_
#define SOURCE_OPT_SPLIT_ILWALID_UNREACHABLE_PASS_H_
...
class SplitIlwalidUnreachablePass : public Pass {
 public:
...
#endif  // SOURCE_OPT_SPLIT_ILWALID_UNREACHABLE_PASS_H_
