...
class InstBindlessCheckPass : public InstrumentPass {
 ...
 private:
  ...
  //
  // TODO(greg-lunarg): Add support for buffers. Lwrrently only does
  ...
  // |ref_block_itr|.  The validation code first exelwtes a check for the
  // specific condition called for. If the check passes, it exelwtes
  ...
  // The format of the debug input buffer is dolwmented in instrument.hpp.
  //
