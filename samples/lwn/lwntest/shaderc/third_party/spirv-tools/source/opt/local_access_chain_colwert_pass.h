...
#ifndef SOURCE_OPT_LOCAL_ACCESS_CHAIN_COLWERT_PASS_H_
#define SOURCE_OPT_LOCAL_ACCESS_CHAIN_COLWERT_PASS_H_
...
class LocalAccessChainColwertPass : public MemPass {
 public:
  LocalAccessChainColwertPass();

  const char* name() const override { return "colwert-local-access-chains"; }
 ...
 private:
  ...
  // indices. Colwert all loads and stores of such variables into equivalent
  ...
  //
  // Nested access chains and pointer access chains are not lwrrently
  // colwerted.
  //
  // Returns a status to indicate success or failure, and change or no change.
  Status ColwertLocalAccessChains(Function* func);
...
#endif  // SOURCE_OPT_LOCAL_ACCESS_CHAIN_COLWERT_PASS_H_
