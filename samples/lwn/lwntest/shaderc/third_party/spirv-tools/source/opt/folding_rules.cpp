...
// Elides conselwtive negate instructions.
...
// Merges conselwtive multiplies where each contains one constant operand.
// Cases:
// 2 * (x * 2) = x * 4
// 2 * (2 * x) = x * 4
// (x * 2) * 2 = x * 4
...
// Merges conselwtive divides if each instruction contains one constant operand.
