...
class GraphicsRobustAccessPass : public Pass {
 ...
 private:
  ...
  spv_result_t ProcessLwrrentModule();
  ...
  // Colwerts an integer value to an unsigned wider integer type, using either
  ...
  // Returns a new instruction that ilwokes the UMin GLSL.std.450 extended
  ...
  // Returns a new instruction that ilwokes the SClamp GLSL.std.450 extended
