...
class LoopUtils {
 public:
  ...
  // The colwerts the current loop to loop closed SSA form.
  ...
  //  colwerted into LCSAA form and has a single entry and exit we can rewrite
  //  the other phis.
  ...
  // called, otherwise the analysis should be ilwalidated.
  void Finalize();
