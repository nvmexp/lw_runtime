...
spv_result_t spvDiagnosticPrint(const spv_diagnostic diagnostic) {
  if (!diagnostic) return SPV_ERROR_ILWALID_DIAGNOSTIC;
...
std::string spvResultToString(spv_result_t res) {
  ...
  switch (res) {
    ...
    case SPV_ERROR_OUT_OF_MEMORY:
      ...
      break;
    case SPV_ERROR_ILWALID_POINTER:
      out = "SPV_ERROR_ILWALID_POINTER";
      break;
    case SPV_ERROR_ILWALID_BINARY:
      out = "SPV_ERROR_ILWALID_BINARY";
      break;
    case SPV_ERROR_ILWALID_TEXT:
      out = "SPV_ERROR_ILWALID_TEXT";
      break;
    case SPV_ERROR_ILWALID_TABLE:
      out = "SPV_ERROR_ILWALID_TABLE";
      break;
    case SPV_ERROR_ILWALID_VALUE:
      out = "SPV_ERROR_ILWALID_VALUE";
      break;
    case SPV_ERROR_ILWALID_DIAGNOSTIC:
      out = "SPV_ERROR_ILWALID_DIAGNOSTIC";
      break;
    case SPV_ERROR_ILWALID_LOOKUP:
      out = "SPV_ERROR_ILWALID_LOOKUP";
      break;
    case SPV_ERROR_ILWALID_ID:
      out = "SPV_ERROR_ILWALID_ID";
      break;
    case SPV_ERROR_ILWALID_CFG:
      out = "SPV_ERROR_ILWALID_CFG";
      break;
    case SPV_ERROR_ILWALID_LAYOUT:
      out = "SPV_ERROR_ILWALID_LAYOUT";
      break;
    default:
      out = "Unknown Error";
  }
