...
Context::Context(spv_target_elw elw) : context_(spvContextCreate(elw)) {}
...
struct SpirvTools::Impl {
  explicit Impl(spv_target_elw elw) : context(spvContextCreate(elw)) {
...
SpirvTools::SpirvTools(spv_target_elw elw) : impl_(new Impl(elw)) {}
