...
spv_result_t spvOperandTableNameLookup(spv_target_elw,
...
// operand's group. A handle of the operand table entry for this operand will
// be written into *entry.
spv_result_t spvOperandTableValueLookup(spv_target_elw,
                                        const spv_operand_table table,
                                        const spv_operand_type_t type,
...
void spvPushOperandTypesForMask(spv_target_elw,
...
// Callwlates the corresponding post-immediate alternate pattern, which allows
