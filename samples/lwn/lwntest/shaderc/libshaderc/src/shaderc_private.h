...
// Colwerts a shader stage from shaderc_shader_kind into a shaderc_util::Compiler::Stage.
// This is only valid for a specifically named shader stage, e.g. vertex through fragment,
// or compute.
inline shaderc_util::Compiler::Stage shaderc_colwert_specific_stage(
  ...
  switch (kind) {
    ...
    case shaderc_raygen_shader:
      return shaderc_util::Compiler::Stage::RayGenLW;
    case shaderc_intersection_shader:
      return shaderc_util::Compiler::Stage::IntersectLW;
    case shaderc_anyhit_shader:
      return shaderc_util::Compiler::Stage::AnyHitLW;
    case shaderc_closesthit_shader:
      return shaderc_util::Compiler::Stage::ClosestHitLW;
    case shaderc_miss_shader:
      return shaderc_util::Compiler::Stage::MissLW;
    case shaderc_callable_shader:
      return shaderc_util::Compiler::Stage::CallableLW;
    case shaderc_task_shader:
      return shaderc_util::Compiler::Stage::TaskLW;
    case shaderc_mesh_shader:
      return shaderc_util::Compiler::Stage::MeshLW;
    default:
