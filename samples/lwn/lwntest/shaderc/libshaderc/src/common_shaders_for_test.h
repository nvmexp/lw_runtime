...
// version.
const char kMinimalUnknowlwersionShader[] =
    "#version 550\n"
    "void main() {}\n";
...
// LW mesh shader without #pragma.
const char kLWMeshShader[] =
    "#version 450\n"
    "#extension GL_LW_mesh_shader : enable\n"
    "layout(local_size_x=8) in;\n"
    "layout(max_vertices=5) out;\n"
    "layout(max_primitives=10) out;\n"
    "layout(triangles) out;\n"
    "void main() {\n"
    "  gl_MeshVerticesLW[gl_LocalIlwocationID.x].gl_Position = vec4(0.0);\n"
    "}\n";

// LW mesh shader with #pragma annotation.
const char kLWMeshShaderWithPragma[] =
    "#version 450\n"
    "#extension GL_LW_mesh_shader : enable\n"
...
// LW task shader without #pragma annotation.
const char kLWTaskShader[] =
    "#version 450\n"
    "#extension GL_LW_mesh_shader : enable\n"
    "layout(local_size_x=8) in;\n"
    "void main() {\n"
...
// LW task shader with #pragma annotation.
const char kLWTaskShaderWithPragma[] =
    "#version 450\n"
    "#extension GL_LW_mesh_shader : enable\n"
...
const char kVertexOnlyShaderWithIlwalidPragma[] =
    "#version 310 es\n"
    "#pragma shader_stage(fragment)\n"
    "void main() {\n"
    "    gl_Position = vec4(1.);\n"
...
const char kGlslMultipleFnShader[] =
    R"(#version 450
       layout(location=0) flat in  int ilwal;
       layout(location=0)      out int outVal;
       int foo(int a) { return a; }
       void main() { outVal = foo(ilwal); })";
