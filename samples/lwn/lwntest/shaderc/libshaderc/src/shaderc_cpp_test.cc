...
TEST_F(CppInterface, AssembleTargetElw) {
  options_.SetTargetElwironment(shaderc_target_elw_opengl, 0);
...
TEST_F(CppInterface, MacroCompileOptions) {
  ...
  const std::string kMinimalExpandedShader = "#version 150\lwoid E(){}";
...
TEST_F(CppInterface, ForcedVersionProfileIlwalidModule) {
...
TEST_F(CppInterface, ForcedVersionProfileUnknowlwersionStd) {
...
TEST_F(CppInterface, CompileAndOptimizeForVulkan10Failure) {
  ...
  options_.SetTargetElwironment(shaderc_target_elw_vulkan,
...
TEST_F(CppInterface, TargetElwCompileOptionsOpenGLCompatibilityShadersFail) {
  // Glslang does not support SPIR-V code generation for OpenGL compatibility
  // profile.
  options_.SetTargetElwironment(shaderc_target_elw_opengl_compat, 0);
...
TEST_F(CppInterface, TargetElwCompileOptionsVulkanElwVulkan1_0ShaderSucceeds) {
  options_.SetTargetElwironment(shaderc_target_elw_vulkan, 0);
  EXPECT_TRUE(CompilationSuccess(BarrierComputeShader(),
                                 shaderc_glsl_compute_shader, options_));
}

TEST_F(CppInterface, TargetElwCompileOptionsVulkanElwVulkan1_0ShaderFails) {
  options_.SetTargetElwironment(shaderc_target_elw_vulkan, 0);
...
TEST_F(CppInterface,
       TargetElwCompileOptionsVulkan1_0ElwVulkan1_0ShaderSucceeds) {
  options_.SetTargetElwironment(shaderc_target_elw_vulkan,
                                shaderc_elw_version_vulkan_1_0);
  EXPECT_TRUE(CompilationSuccess(BarrierComputeShader(),
                                 shaderc_glsl_compute_shader, options_));
...
TEST_F(CppInterface, TargetElwCompileOptionsVulkan1_0ElwVulkan1_1ShaderFails) {
  options_.SetTargetElwironment(shaderc_target_elw_vulkan,
                                shaderc_elw_version_vulkan_1_0);
  EXPECT_FALSE(CompilationSuccess(SubgroupBarrierComputeShader(),
                                  shaderc_glsl_compute_shader, options_));
...
TEST_F(CppInterface,
       TargetElwCompileOptionsVulkan1_1ElwVulkan1_0ShaderSucceeds) {
  options_.SetTargetElwironment(shaderc_target_elw_vulkan,
                                shaderc_elw_version_vulkan_1_1);
  EXPECT_TRUE(CompilationSuccess(BarrierComputeShader(),
                                 shaderc_glsl_compute_shader, options_));
...
TEST_F(CppInterface,
       TargetElwCompileOptionsVulkan1_1ElwVulkan1_1ShaderSucceeds) {
  options_.SetTargetElwironment(shaderc_target_elw_vulkan,
                                shaderc_elw_version_vulkan_1_1);
...
TEST(
  ...
  std::string assembly;
  spvtools::SpirvTools(SPV_ELW_UNIVERSAL_1_0).Disassemble(binary, &assembly);
