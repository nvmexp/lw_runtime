...
typedef enum {
  shaderc_target_elw_vulkan,        // create SPIR-V under Vulkan semantics
  shaderc_target_elw_opengl,        // create SPIR-V under OpenGL semantics
  shaderc_target_elw_opengl_compat, // create SPIR-V under OpenGL semantics, including compatibility profile functions
...
void shaderc_compile_options_set_target_elw(
    shaderc_compile_options_t options, shaderc_target_elw target, uint32_t version);
