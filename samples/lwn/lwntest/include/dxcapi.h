...
/// <remarks>
/// While this function is similar to CoCreateInstance, there is no COM ilwolvement.
/// </remarks>
...
// For colwenience, equivalent definitions to CP_UTF8 and CP_UTF16.
...
// NOTE: IDxlwtils replaces IDxcLibrary
...
IDxlwtils : public IUnknown {
  ...
  // Colwert or return matching encoded text blobs
  virtual HRESULT STDMETHODCALLTYPE GetBlobAsUtf8(
  ...
  DECLARE_CROSS_PLATFORM_UUIDOF(IDxlwtils)
};
...
CLSID_SCOPE const GUID CLSID_Dxlwtils = CLSID_DxcLibrary;
