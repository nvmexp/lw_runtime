 ...
 * (colwerted from the libspnav lwbe example)
 *
 * Use the spaceball to move and rotate the colored lwbe.
 * Pressing any button will reset the lwbe at its original location.
 *
