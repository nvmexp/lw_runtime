...
void SampleKeyboard( unsigned char cChar, int nMouseX, int nMouseY )
{
    ...
    case 'P':
        ...
        {
            glutSetWindow(nChildWindow);
            if (glutGet(GLUT_WINDOW_LWRSOR)==GLUT_LWRSOR_TOP_SIDE)
                glutSetLwrsor(GLUT_LWRSOR_RIGHT_ARROW);
            else
                glutSetLwrsor(GLUT_LWRSOR_TOP_SIDE);
        }
        else
        {
            glutSetWindow(nWindow);
            if (glutGet(GLUT_WINDOW_LWRSOR)==GLUT_LWRSOR_CYCLE)
                glutSetLwrsor(GLUT_LWRSOR_RIGHT_ARROW);
            else
