#ifndef LWPERF_COMMON_H
#define LWPERF_COMMON_H
...
#define LWPERF_LWPA_STATUS_DEFINED
    ...
    typedef enum LWPA_Status
    {
        ...
        /// LWPW_InitializeTarget() has not been called yet.
        LWPA_STATUS_NOT_INITIALIZED = 3,
        /// The LwPerf DLL/DSO could not be loaded during LWPW_Initialize*.
        LWPA_STATUS_NOT_LOADED = 4,
        /// The function was not found in this version of the LwPerf DLL/DSO.
        ...
        /// No driver has been loaded via LWPW_*_LoadDriver().
        ...
        /// Profiling permission not granted; see https://developer.lwpu.com/lwpu-development-tools-solutions-
        /// ERR_LWGPUCTRPERM-permission-issue-performance-counters
        ...
        LWPA_STATUS_PROFILING_NOT_ALLOWED = 25,
        LWPA_STATUS__COUNT
    } LWPA_Status;
...
typedef LWPA_Status (*LWPA_GenericFn)(void);
    ...
    /// 
    /// Gets the address of an LwPerf API function.
    /// 
...
#define LWPW_SetLibraryLoadPaths_Params_STRUCT_SIZE LWPA_STRUCT_SIZE(LWPW_SetLibraryLoadPaths_Params, ppPaths)
    ...
    /// Sets library search path for \ref LWPW_InitializeHost() and \ref LWPW_InitializeTarget().
    /// \ref LWPW_InitializeHost() and \ref LWPW_InitializeTarget load the LwPerf DLL/DSO.  This function sets
