...
class BenchmarkWarpLwllingLWN : public BenchmarkCaseLWN
{
private:
    LWNprogram*                m_pgm;
...
public:
    ...
    BenchmarkWarpLwllingLWN(LWNdevice* dev, LWNqueue* q, LwnUtil::Pools* pools, int w, int h);
    ~BenchmarkWarpLwllingLWN();
