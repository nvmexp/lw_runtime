...
enum __MIDL___MIDL_itf_dxva2api_0000_0000_0003
	...
	DXVA2_DeinterlaceTech_MotiolwectorSteered	= 0x80,
	DXVA2_DeinterlaceTech_IlwerseTelecine	= 0x100,
...
enum __MIDL___MIDL_itf_dxva2api_0000_0000_0012
	...
	DXVA2_IlwerseQuantizationMatrixBufferType	= 4,
	DXVA2_SliceControlBufferType	= 5,
	DXVA2_BitStreamDateBufferType	= 6,
	DXVA2_MotiolwectorBuffer	= 7,
...
typedef struct _DXVA2_DecodeExelwteParams
    {
    UINT NumCompBuffers;
    DXVA2_DecodeBufferDesc *pCompressedBuffers;
    DXVA2_DecodeExtensionData *pExtensionData;
    } 	DXVA2_DecodeExelwteParams;
...
EXTERN_C const IID IID_IDirectXVideoDecoder;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE Execute( 
            /* [in] */ 
            __in  const DXVA2_DecodeExelwteParams *pExelwteParams) = 0;
    ...
    typedef struct IDirectXVideoDecoderVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *Execute )( 
            IDirectXVideoDecoder * This,
            /* [in] */ 
            __in  const DXVA2_DecodeExelwteParams *pExelwteParams);
...
#define IDirectXVideoDecoder_Exelwte(This,pExelwteParams)	\
    ( (This)->lpVtbl -> Execute(This,pExelwteParams) ) 
...
EXTERN_C const IID IID_IDirectXVideoMemoryConfiguration;
    ...
    typedef struct IDirectXVideoMemoryConfiguratiolwtbl
    {
        BEGIN_INTERFACE
        ...
        END_INTERFACE
    } IDirectXVideoMemoryConfiguratiolwtbl;

    interface IDirectXVideoMemoryConfiguration
    {
        CONST_VTBL struct IDirectXVideoMemoryConfiguratiolwtbl *lpVtbl;
    };
