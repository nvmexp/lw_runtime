...
#define DW_LW_VERSION2 2
#define DW_LW_VERSION3 3
#define DW_LW_VERSION4 4
...
#define DW_DLA_LW_CONTEXT	DW_DLA_RANGES + 3
...
#ifdef WIN32 
    typedef unsigned __int32 Dwarf_ufixed;
    typedef __int32 Dwarf_sfixed;
#else
...
*/
#ifdef WIN32
    typedef unsigned __int64 Dwarf_ufixed64;
    typedef __int64 Dwarf_sfixed64;
#else
...
typedef struct Dwarf_LW_Context_s *Dwarf_LW_Context;
