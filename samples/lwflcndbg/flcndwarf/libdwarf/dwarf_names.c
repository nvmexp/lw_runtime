...
/* Generated on Mar 28 2013  03:53:22 */
...
dwarf_get_AT_name (unsigned int val,const char ** s_out)
{
    ...
    case DW_AT_calling_colwention:
        *s_out = "DW_AT_calling_colwention";
        return DW_DLV_OK;
    case DW_AT_count:
        *s_out = "DW_AT_count";
        return DW_DLV_OK;
    ...
    case DW_AT_pure:
        *s_out = "DW_AT_pure";
        return DW_DLV_OK;
    case DW_AT_relwrsive:
        *s_out = "DW_AT_relwrsive";
        return DW_DLV_OK;
...
dwarf_get_ATE_name (unsigned int val,const char ** s_out)
{
    ...
    case DW_ATE_ALTIUM_fract:
        *s_out = "DW_ATE_ALTIUM_fract";
        return DW_DLV_OK;
    case DW_ATE_ALTIUM_aclwm:
        *s_out = "DW_ATE_ALTIUM_aclwm";
        return DW_DLV_OK;
