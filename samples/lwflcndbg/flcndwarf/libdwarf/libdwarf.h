...
/* Special case for MIPS, so -64 (LP64) build gets simple -long-.
   Non-MIPS LP64 or ILP64 elwironments should probably ensure
...
typedef struct {
    ...
    Dwarf_Unsigned  bl_section_offset; /* Section (not LW) offset
...
typedef struct {
    ...
    Dwarf_Unsigned  ld_section_offset; /* Section (not LW) offset
...
typedef struct Dwarf_Regtable_Entry_s {
    /*  For each index i (naming a hardware register with dwarf number
        ...
        Otherwise: the register number is a DWARF register number
            (see ABI dolwments for how this translates to hardware/
...
/*  For DW_DLC_SYMBOLIC_RELOCATIONS output to caller 
    ...
    some dwarf elwironments. (MIPS relocations are all one
...
struct Dwarf_Obj_Access_Section_s {
    ...
    /*  Elf sections that are tables have a non-zero entrysize so
        the count of entries can be callwlated even without
...
struct Dwarf_Obj_Access_Methods_s {
    /*
        ...
        DW_DLV_ERROR - Error oclwrred. Use 'error' to determine the 
    ...
    /*
        ...
        libdwarf lwrrently supports * 4 and 8 byte sizes, but may 
    ...
    /* 
        ...
        libdwarf lwrrently supports  4 and 8 byte sizes.
        Perhaps the return type should be an enumeration?
...
#define DW_DLE_LW_LENGTH_ERROR                  47
...
#define DW_DLE_DBG_NO_LW_CONTEXT               103
#define DW_DLE_DIE_NO_LW_CONTEXT               104
#define DW_DLE_FIRST_DIE_NOT_LW                105
...
#define DW_DLE_ATTR_NO_LW_CONTEXT              115
...
#define DW_DLE_MAKE_LW_CONTEXT_FAIL            132
...
#define DW_DLE_LW_ADDRESS_SIZE_BAD             142
...
/* Undolwmented function for memory allocator. */
...
/*  Die traversal operations.  
    dwarf_next_lw_header_b() traverses debug_info LW headers.
    */
int dwarf_next_lw_header_b(Dwarf_Debug /*dbg*/, 
    ...
    Dwarf_Unsigned* /*next_lw_header_offset*/,
    Dwarf_Error*    /*error*/);

/*  dwarf_next_lw_header_types() traverses debug_types LW headers.
    New in October, 2011
    */
int dwarf_next_lw_header_c(Dwarf_Debug /*dbg*/, 
    Dwarf_Bool      /*is_info*/,
    Dwarf_Unsigned* /*lw_header_length*/, 
    Dwarf_Half*     /*version_stamp*/, 
    Dwarf_Off*      /*abbrev_offset*/, 
...
int dwarf_next_lw_header(Dwarf_Debug /*dbg*/, 
    Dwarf_Unsigned* /*lw_header_length*/, 
    Dwarf_Half*     /*version_stamp*/, 
    Dwarf_Off*      /*abbrev_offset*/, 
    Dwarf_Half*     /*address_size*/, 
...
/*  Finding die given global (not LW-relative) offset.
...
/* dwarf_dieoffset returns the global debug_info
   section offset, not the LW relative offset. */
int dwarf_dieoffset(Dwarf_Die /*die*/, 
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);

/* dwarf_LW_dieoffset_given_die returns
   the global debug_info section offset of the LW die
   that is the LW containing the given_die
   (the passed in DIE can be any DIE). 
   This information makes it possible for a consumer to
   find and print LW context information for any die. 
   See also dwarf_get_lw_die_offset_given_lw_header_offset(). */
int dwarf_LW_dieoffset_given_die(Dwarf_Die /*given_die*/, 
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);

/* dwarf_die_LW_offset returns the LW relative offset
   not the global debug_info section offset, given
   any DIE in the LW.  See also dwarf_LW_dieoffset_given_die().
   */
int dwarf_die_LW_offset(Dwarf_Die /*die*/,
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);

int dwarf_die_LW_offset_range(Dwarf_Die /*die*/,
    Dwarf_Off*       /*return_LW_header_offset*/,
    Dwarf_Off*       /*return_LW_length_bytes*/,
    Dwarf_Error*     /*error*/);
...
/* colwenience functions, alternative to using dwarf_attrlist() */
...
/* end of colwenience function list */
...
*/
/*  dwarf_formref returns, thru return_offset, a LW-relative offset
...
/* This returns the LW die global offset if one knows the
   LW header global offset.
   See also dwarf_LW_dieoffset_given_die(). */ 
int dwarf_get_lw_die_offset_given_lw_header_offset(
    Dwarf_Debug      /*dbg*/,
    Dwarf_Off        /*in_lw_header_offset*/,
    Dwarf_Off *  /*out_lw_die_offset*/, 
    Dwarf_Error *    /*err*/);

/*  The _b form is new October 2011. */
int dwarf_get_lw_die_offset_given_lw_header_offset_b(
    Dwarf_Debug      /*dbg*/,
    Dwarf_Off        /*in_lw_header_offset*/,
...
#pragma optional dwarf_get_lw_die_offset_given_lw_header_offset
#endif

int dwarf_global_lw_offset(Dwarf_Global /*global*/, 
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);
...
int dwarf_func_lw_offset(Dwarf_Func /*func*/,
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);
...
int dwarf_type_lw_offset(Dwarf_Type /*type*/,
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);
...
int dwarf_pubtype_lw_offset(Dwarf_Type /*type*/,
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);
...
int dwarf_var_lw_offset(Dwarf_Var /*var*/,
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);
...
int dwarf_weak_lw_offset(Dwarf_Weak /*weak*/,
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);
...
/* See dislwssion of dw_value_type, libdwarf.h. 
...
int dwarf_get_lw_die_offset(
    Dwarf_Arange     /*arange*/, 
    Dwarf_Off*       /*return_offset*/,
    Dwarf_Error*     /*error*/);

int dwarf_get_arange_lw_header_offset(
    Dwarf_Arange     /*arange*/, 
    Dwarf_Off*       /*return_lw_header_offset*/,
    Dwarf_Error*     /*error*/);
#ifdef __sgi /* pragma is sgi MIPS only */
#pragma optional dwarf_get_arange_lw_header_offset
#endif
...
*/
int _dwarf_print_lines(Dwarf_Die /*lw_die*/,Dwarf_Error * /*error*/);
int dwarf_print_lines(Dwarf_Die /*lw_die*/,Dwarf_Error * /*error*/,
   int * /*error_count_out */);
...
/*  dwarf_check_lineheader lets dwarfdump get detailed messages
    ...
    pointer.
*/
void dwarf_check_lineheader(Dwarf_Die /*lw_die*/,int *errcount_out);
...
/*  'apply' defaults to 1 and means do all
    ...
    do not exist in exelwtables and shared objects (.so), the
...
Dwarf_P_Attribute dwarf_add_AT_comp_dir(Dwarf_P_Die /*ownerdie*/, 
    char*           /*lwrrent_working_directory*/, 
    Dwarf_Error*    /*error*/);
...
Dwarf_Unsigned dwarf_expr_lwrrent_offset(
    Dwarf_P_Expr      /*expr*/, 
    Dwarf_Error*      /*error*/);
...
/*  This is a hack so clients can verify offsets.
    ...
    (which happened in an IRIX exelwtable larger than 2GB
...
/* The harmless error list is a cirlwlar buffer of
...
#define DW_HARMLESS_ERROR_CIRLWLAR_LIST_DEFAULT_SIZE 4
...
/* User code supplies size of array of pointers errmsg_ptrs_array
    ...
    are ilwalidated by ANY call to libdwarf.
    ...
    (some may have been discarded or not returned, it is a cirlwlar
    list...).
...
/*  The size of the cirlwlar list of strings may be set
...
/* Colwert local offset into global offset */
int dwarf_colwert_to_global_offset(Dwarf_Attribute  /*attr*/,
    Dwarf_Off        /*offset*/,
...
/*  Get the version and offset size of a LW context. 
...
/*  Record some application command line options in libdwarf.  
    ...
    to the libdwarf the exelwtable is using.
*/
typedef struct {
