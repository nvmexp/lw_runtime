...
struct Dwarf_Global_Context_s {
    ...
    /*  For this LW, size of the extension 0 except for dwarf2 extension 
    ...
    Dwarf_Off pu_offset_of_lw_header;
...
struct Dwarf_Global_s {
    ...
    /*  Offset from the start of the corresponding compilation-unit of
        the DIE for the given pubname LW. */
    Dwarf_Off gl_named_die_offset_within_lw;
