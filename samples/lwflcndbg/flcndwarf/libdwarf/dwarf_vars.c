...
int
dwarf_var_lw_offset(Dwarf_Var var_in,
    Dwarf_Off * returned_offset, Dwarf_Error * error)
{
    Dwarf_Global var = (Dwarf_Global) var_in;

    return dwarf_global_lw_offset(var, returned_offset, error);
}
...
dwarf_var_name_offsets(Dwarf_Var var_in,
    ...
    Dwarf_Off * lw_offset, Dwarf_Error * error)
{
    Dwarf_Global var = (Dwarf_Global) var_in;

    return
        dwarf_global_name_offsets(var,
            returned_name, die_offset, lw_offset,
            error);
}
