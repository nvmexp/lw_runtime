...
struct Dwarf_Line_Context_s {
    ...
    /*  Count of the number of lines for this lw. */
...
struct Line_Table_Prefix_s {
    ...
    /*  pf_total_length is the value of the length field for the line
        table of this LW. So it does not count the length of itself (the 
    ...
    /*  Start and end of this LW line area. pf_line_ptr_start +
