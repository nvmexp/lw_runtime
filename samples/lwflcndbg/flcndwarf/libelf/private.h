...
extern const size_t _elf_fmsize[2][EV_LWRRENT - EV_NONE][ELF_T_NUM][2];
...
#define valid_version(v)	((v) > EV_NONE && (v) <= EV_LWRRENT)
...
#include <elferrors.h>		/* include constants from errors.h */
#undef __err__
ERROR_NUM
};
