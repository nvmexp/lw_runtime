...
extern "C"
{
    LRESULT CALLBACK flcngdbUiWndProcFlcngdb(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
    {
        ...
        case WM_CREATE:
            ...
            SetWindowPos(hWnd, HWND_TOP, 0, 0, 1, 1, SWP_NOSIZE | SWP_DRAWFRAME | SWP_NOACTIVATE);
    ...
    void flcngdbUiLoadFileFlcngdbWindow(const char* filename)
    {
        ...
        int topVisibleLine = (int) SendMessage(flcngdbUiRichEdit, EM_GETFIRSTVISIBLELINE, 0, 0);       
        if(topVisibleLine == 0 || (strcmp(filename, flcngdbUiFileToLoad) != 0))
        {
