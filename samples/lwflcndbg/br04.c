 ...
 *
 * Copyright 2001 by LWPU Corporation.  All rights reserved.  All
...
{
    U032 reg = GPU_REG_RD32(Address);
    U032 Header = DRF_VAL(_BR04_XVU, _INT_FLOW_CTL, _DP0_TOO_CPL_H_SIGMA, reg);
    U032 Data = DRF_VAL(_BR04_XVU, _INT_FLOW_CTL, _DP0_TOO_CPL_D_SIGMA, reg);
