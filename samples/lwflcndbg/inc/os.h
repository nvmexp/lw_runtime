...
#if LWWATCHCFG_IS_PLATFORM(UNIX) && LWWATCHCFG_FEATURE_ENABLED(UNIX_USERMODE)
#include <assert.h>
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
#endif
#define INC_DIR_FRAGMENT        DIR_SLASH "drivers" DIR_SLASH "common" DIR_SLASH "inc" DIR_SLASH "hwref"
...
#define INC_DIR_EXAMPLE         DIR_EXAMPLE_BASE INC_DIR_FRAGMENT
...
#define MGPU_LOOP_START                                     \
    {                                                       \
    LwU32 orig_Verb = verboseLevel;                          \
    PhysAddr orig_Bar0 = lwBar0;                            \
    PhysAddr orig_Bar1 = lwBar1;                            \
    LwU32 m_Count = 0;                                       \
    do                                                      \
    {                                                       \
        ...
        {                                                   \
            ...
            verboseLevel = 0;                               \
            initLwWatchHal(pmc_boot0);                      \
            verboseLevel = orig_Verb;                       \
...
//
#ifndef LW_VAR
#define LW_VAR(NAME)    "@@(lw4_mini!" NAME ")"
#endif
...
LW_STATUS    osReadMemByType(PhysAddr address, void* buf, ULONG size, LwU32 *pSizer, MEM_TYPE memoryType);
...
LW_STATUS    osGetSystemTime(LwU64 *dt);
...
#define GPU_REG_RD08(a)     REG_RD08((a))
#define GPU_REG_WR08(a, b)  REG_WR08((a), (b))
