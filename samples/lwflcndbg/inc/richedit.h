...
#define EM_COLWPOSITION         (WM_USER + 108)
...
// RE3.0 FE messages
#define EM_RECOLWERSION            (WM_USER + 125)
...
#define SES_SCROLLONKILLFOLWS    8192
...
#define SES_LWSTOMLOOK            0x0080000
...
#define TO_DISABLELWSTOMTEXTOUT    4
...
#define CTFMODEBIAS_COLWERSATION            0x0005
...
typedef struct _imecomptext {
    ...
    DWORD    flags;        // value specifying the composition string type.
                        //    Lwrrently only support ICT_RESULTREADSTR
} IMECOMPTEXT;
...
#define EMO_EXPAND              3       // HIWORD(lparam) = EMO_EXPANDSELECTION
                                        ...
                                        //  HIWORD(lparam) = EMO_EXPANDDOLWMENT
...
#if (_WIN32_WINNT > 0x0400) || (WILWER > 0x0400)
...
#define CFU_ILWERT            0xFE    // For IME composition fake a selection
