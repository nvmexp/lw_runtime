...
public:
    /*************************************************************************/
    /* Constructors */
    DcgmFieldGroup(unsigned int fieldGroupId, std::vector<unsigned short>&fieldIds,
...
private:
    ...
    LWOSCriticalSection m_lock; /* Lock used for accessing table of groups
...
public:
     ...
     *
     */
    dcgmReturn_t AddFieldGroup(std::string name, std::vector<unsigned short>&fieldIds,
                               dcgmFieldGrp_t *fieldGrp, DcgmWatcher watcher);
     ...
     *
     */
    dcgmReturn_t GetFieldGroupFields(dcgmFieldGrp_t fieldGrp,
