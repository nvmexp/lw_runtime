...
#ifdef DEBUG
    NA_CMD_REQ_ENTRY,       // Set a request table entry specified by switch:port:dest_gpu:valid:egress_port
    NA_CMD_RES_ENTRY,       // Set a response table entry specified by switch:port:req_link_id:valid:egress_port
