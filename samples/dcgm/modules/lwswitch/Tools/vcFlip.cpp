...
vcFlip::vcFlip( fabricTopologyEnum topo ) : fabricConfig( topo )
{
...
void vcFlip::makeIngressReqTable( int nodeIndex, int willowIndex )
{
        ...
        for ( portIndex = 0; portIndex <= 5; portIndex++ )
        {
            ...
            for ( i = 0; i < NUM_INGR_REQ_ENTRIES_PER_GPU; i++, index++)
            {
                ...
                makeOneIngressReqEntry( nodeIndex,     // nodeIndex
                                        ...
                                        mappedAddr,    // 64 bits fabric address
                                        0,             // routePolicy
                                        0x33000000,    // vcModeValid7_0, port 6 and 7
                                        0x33000000,    // vcModeValid15_8, port 14 and 15
                                        0x00000000,    // vcModeValid17_16
                                        1);            // entryValid
            }
        ...
        for ( portIndex = 6; portIndex <= 7; portIndex++ )
        {
            ...
            for ( i = 0; i < NUM_INGR_REQ_ENTRIES_PER_GPU; i++, index++)
            {
                ...
                makeOneIngressReqEntry( nodeIndex,     // nodeIndex
                                        ...
                                        mappedAddr,    // 64 bits fabric address
                                        0,             // routePolicy
                                        0x00333333,    // vcModeValid7_0, port 0 to 5
                                        0x00000000,    // vcModeValid15_8
                                        0x00000000,    // vcModeValid17_16
                                        1);            // entryValid
            }
            ...
            for ( i = 0; i < NUM_INGR_REQ_ENTRIES_PER_GPU; i++, index++)
            {
                ...
                makeOneIngressReqEntry( nodeIndex,     // nodeIndex
                                        ...
                                        0,             // routePolicy
                                        0x00000000,    // vcModeValid7_0
                                        0x00333333,    // vcModeValid15_8, port 8 to 13
                                        0x00000000,    // vcModeValid17_16
                                        1);            // entryValid
            }
        }
...
void vcFlip::makeIngressRespTable( int nodeIndex, int willowIndex )
{
...
void vcFlip::makeGangedLinkTable( int nodeIndex, int willowIndex )
{
    int32_t portIndex, i;
...
void vcFlip::makeAccessPorts( int nodeIndex, int willowIndex )
{
    if ( (nodeIndex == 0) && (willowIndex == 0) )
    {
...
void vcFlip::makeTrunkPorts( int nodeIndex, int willowIndex )
{
    if ( (nodeIndex == 0) && (willowIndex == 0) )
    {
...
void vcFlip::makeOneWillow( int nodeIndex, int willowIndex )
{
...
void vcFlip::makeOneNode( int nodeIndex, int gpuNum, int willowNum )
{
    int i, j;
...
void
vcFlip::makeOneLwswitch( int nodeIndex, int swIndex )
{
    return;
}

void
vcFlip::makeRemapTable( int nodeIndex, int swIndex )
{
    return;
}

void
vcFlip::makeRIDRouteTable( int nodeIndex, int swIndex )
{
    return;
}

void
vcFlip::makeRLANRouteTable( int nodeIndex, int swIndex )
{
    return;
}
#endif
