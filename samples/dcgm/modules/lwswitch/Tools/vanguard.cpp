...
void
vanguardConfig::makeOneLwswitch( int nodeIndex, int swIndex )
{
    return;
}

void
vanguardConfig::makeRemapTable( int nodeIndex, int swIndex )
{
    return;
}

void
vanguardConfig::makeRIDRouteTable( int nodeIndex, int swIndex )
{
    return;
}

void
vanguardConfig::makeRLANRouteTable( int nodeIndex, int swIndex )
{
    return;
}
#endif
