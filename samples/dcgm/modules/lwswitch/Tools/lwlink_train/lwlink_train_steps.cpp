...
void list_steps()
{
    ...
    std::cout <<" 9. Do Link Initialization \n";
    std::cout <<" 10. Do all the Initialization in Single Step \n";
    std::cout <<" 11. Discover Connections - Intra-Node \n";
    std::cout <<" 12. Train an Intra-Node Connection to High Speed \n";
    std::cout <<" 13. Train an Intra-Node Connection to OFF \n";
    std::cout <<" 14. Train an Intra-Node Connection to SAFE \n";
    std::cout <<" 15. Train ALL Intra-Node Connections to High Speed \n";
    std::cout <<" 16. Train ALL Intra-Node Connections to OFF \n";
    std::cout <<" 17. Train ALL Intra-Node Connections to SAFE \n";
    std::cout <<" 18. Show multi-node training options \n";
    std::cout <<" 19. Get device information \n";
    std::cout <<" 20. Do Initnegotiate \n";
