...
void
basicE3600Config1::makeOneLwswitch( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config1::makeRemapTable( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config1::makeRIDRouteTable( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config1::makeRLANRouteTable( int nodeIndex, int swIndex )
{
    return;
}
#endif
