...
#ifndef EXPLORER_SKYLAKE_CONFIG_H
#define EXPLORER_SKYLAKE_CONFIG_H
...
class explorerSkylakeConfig : public fabricConfig
{
public:
      explorerSkylakeConfig( fabricTopologyEnum topo );
      virtual ~explorerSkylakeConfig();
      ...
      virtual int getHwWillowIndex ( int willowIndex );
