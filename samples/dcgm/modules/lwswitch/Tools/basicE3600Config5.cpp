...
void
basicE3600Config5::makeOneLwswitch( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config5::makeRemapTable( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config5::makeRIDRouteTable( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config5::makeRLANRouteTable( int nodeIndex, int swIndex )
{
    return;
}
#endif
