...
void
explorer16KTConfig::makeOneLwswitch( int nodeIndex, int swIndex )
{
    return;
}

void
explorer16KTConfig::makeRemapTable( int nodeIndex, int swIndex )
{
    return;
}

void
explorer16KTConfig::makeRIDRouteTable( int nodeIndex, int swIndex )
{
    return;
}

void
explorer16KTConfig::makeRLANRouteTable( int nodeIndex, int swIndex )
{
    return;
}
#endif
