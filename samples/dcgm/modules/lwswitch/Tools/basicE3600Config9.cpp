...
basicE3600Config9::basicE3600Config9( fabricTopologyEnum topo ) : fabricConfig( topo )
{
...
basicE3600Config9::~basicE3600Config9()
{
    if ( mFabric )
    {
        delete( mFabric );
...
void basicE3600Config9::makeIngressReqTable( int nodeIndex, int willowIndex )
{
...
void basicE3600Config9::makeIngressRespTable( int nodeIndex, int willowIndex )
{
...
void basicE3600Config9::makeGangedLinkTable( int nodeIndex, int willowIndex )
{
    int32_t portIndex, i;
...
void basicE3600Config9::makeAccessPorts( int nodeIndex, int willowIndex )
{
    if ( (nodeIndex == 0) && (willowIndex == 0) )
    {
...
void basicE3600Config9::makeTrunkPorts( int nodeIndex, int willowIndex )
{
    if ( (nodeIndex == 0) && (willowIndex == 0) )
    {
...
void basicE3600Config9::makeOneWillow( int nodeIndex, int willowIndex )
{
...
void basicE3600Config9::makeOneNode( int nodeIndex, int gpuNum, int willowNum )
{
    int i, j;
...
void basicE3600Config9::makeNodes()
{
    int i, nodeIndex = 0;
...
void
basicE3600Config9::makeOneLwswitch( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config9::makeRemapTable( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config9::makeRIDRouteTable( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config9::makeRLANRouteTable( int nodeIndex, int swIndex )
{
    return;
}
#endif
