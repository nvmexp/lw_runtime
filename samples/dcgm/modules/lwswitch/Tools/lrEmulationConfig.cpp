    ...
    if ( (nodeIndex == 0) && (swIndex == 0) )
    {
        ...
        for ( portIndex = 32; portIndex <= 32; portIndex++ )
        {
            ...
            makeOneRemapEntry( nodeIndex,           // nodeIndex
                               ...
                               0,                   // do not remap FLA address. skip context and range checks
                               0,                   // irl select
                               0,                   // FAM swizzle
                               0,                   // FAM mult2
                               0);                  // FAM plane select
...
void lrEmulationConfig::makeAccessPorts( int nodeIndex, int swIndex )
{
    ...
    if ( (nodeIndex == 0) && (swIndex == 0) )
    {
        ...
        //                nodeIndex swIndex     portIndex farNodeID farPeerID farPortNum portMode    farPeerTargetID
        makeOneAccessPort(0,        0,          32,       0,        farPeerID,  0,       DC_COUPLED, farPeerTargetID);
    }
    else
    {
