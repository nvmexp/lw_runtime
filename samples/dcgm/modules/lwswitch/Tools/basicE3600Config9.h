...
#ifndef BASIC_E3600_CONFIG9_H
#define BASIC_E3600_CONFIG9_H
...
class basicE3600Config9 : public fabricConfig
{
public:
      basicE3600Config9( fabricTopologyEnum topo );
      virtual ~basicE3600Config9();
