...
#ifndef EXPLORER16_TRUNK_SPRAY_CONFIG_H
#define EXPLORER16_TRUNK_SPRAY_CONFIG_H
...
class explorer16TrunkSprayConfig : public fabricConfig
{
public:
      explorer16TrunkSprayConfig( fabricTopologyEnum topo );
      virtual ~explorer16TrunkSprayConfig();
