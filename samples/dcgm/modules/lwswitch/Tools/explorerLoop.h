...
#ifndef EXPLORER_LOOP_H
#define EXPLORER_LOOP_H
...
//
//   This is the generator for Explorer, in loop back mode, where each switch port is looped back to itself.
//   This is a fall-back for early bringup, and may be useful in diagonosing individual link failures.
//
//   GPU Configuration
//
...
/* $$$HACK This is already defined in explorerConfig.h Probably need to move to explorerCommon.h
...
class explorerLoop : public fabricConfig
{
public:
      explorerLoop( fabricTopologyEnum topo );
      virtual ~explorerLoop();
