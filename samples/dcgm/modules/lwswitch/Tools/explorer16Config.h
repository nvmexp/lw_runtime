...
#ifndef EXPLORER16_CONFIG_H
#define EXPLORER16_CONFIG_H
...
class explorer16Config : public fabricConfig
{
public:
      explorer16Config( fabricTopologyEnum topo );
      virtual ~explorer16Config();
