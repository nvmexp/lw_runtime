...
#ifndef EXPLORER2_CONFIG_H
#define EXPLORER2_CONFIG_H
...
class explorer2Config : public fabricConfig
{
public:
      explorer2Config( fabricTopologyEnum topo );
      virtual ~explorer2Config();
