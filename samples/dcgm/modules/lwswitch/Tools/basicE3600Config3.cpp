...
void
basicE3600Config3::makeOneLwswitch( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config3::makeRemapTable( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config3::makeRIDRouteTable( int nodeIndex, int swIndex )
{
    return;
}

void
basicE3600Config3::makeRLANRouteTable( int nodeIndex, int swIndex )
{
    return;
}
#endif
