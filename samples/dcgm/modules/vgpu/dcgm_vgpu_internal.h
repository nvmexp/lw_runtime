#ifndef DCGM_VGPU_INTERNAL_H
#define DCGM_VGPU_INTERNAL_H
...
DCGM_DEFINE_UUID(ETID_DCGMVgpuInternal,
                 0x59c938fd, 0x674e, 0x42cf, 0xaf, 0xd5, 0x83, 0x3e, 0x61, 0xb8, 0xaa, 0x3b);

typedef struct etblDCGMVgpuInternal_st {
    ...
    // 1
    /**
     * This method is used to start the vGPU module within the host engine
     *
     * @param pLwcmHandle. Handle to the host engine
     * @param startMsg Parameter struct for this message
     * @return
     */
    dcgmReturn_t(*fpVgpuStart)(dcgmHandle_t pLwcmHandle, dcgm_vgpu_msg_start_t *startMsg);

    // 2
    /**
     * This method is used shut down the vGPU module within the host engine
     *
     * @param pLwcmHandle Handle to the host engine
     * @param shutdownMsg Parameter struct for this message
     * @return
     */
    dcgmReturn_t(*fpVgpuShutdown)(dcgmHandle_t pLwcmHandle, dcgm_vgpu_msg_shutdown_t *shutdownMsg);
} etblDCGMVgpuInternal;
