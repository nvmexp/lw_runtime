...
class c_dcgmCreateFakeEntities_v1(dcgm_structs._PrintableStructure):
    _fields_ = [
        ('version', c_uint32),
        ('entityGroupId', c_uint32),
        ('numToCreate', c_uint32),
        ('unused', c_uint32),
        ('entityId', c_uint32 * dcgm_structs.DCGM_MAX_NUM_DEVICES)
    ]

dcgmCreateFakeEntities_version1 = dcgm_structs.make_dcgm_version(c_dcgmCreateFakeEntities_v1, 1)


class c_dcgmSetLwLinkLinkState_v1(dcgm_structs._PrintableStructure):
    _fields_ = [
        ('version', c_uint32),       # Version. Should be dcgmSetLwLinkLinkState_version1 
...
dcgmSetLwLinkLinkState_version1 = dcgm_structs.make_dcgm_version(c_dcgmSetLwLinkLinkState_v1, 1)
