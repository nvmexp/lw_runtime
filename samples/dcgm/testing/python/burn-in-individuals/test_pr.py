...
newPolicy = dcgm_client_internal.dcgmPolicy_t()
...
config_values.mPerfState.milwPState.memClk =  dcgmvalue.DCGM_INT32_BLANK
config_values.mPerfState.milwPState.procClk = dcgmvalue.DCGM_INT32_BLANK
