...
class ProcessStatsStress:
    ...
    def GetGpus(self):
        ...
        groupInfo = dcgm_agent.dcgmGroupGetInfo(self.heHandle, self.groupId, dcgm_structs.c_dcgmGroupInfo_version1)
    ...
    def LoopOneIteration(self):
        ...
        while len(self.addedPids) > pidBuffer:
            ...
            try:
                ...
                self.Log("Pid %d hasn't finished yet. Sleeping to allow lwca to catch up" % pidObj.pid)
                time.sleep(1.0)
                break
...
def main():
    ...
    try:
        ...
        if g_embeddedMode:
            ...
            #Start host engine
            heAppRunner = apps.LwHostEngineApp()
