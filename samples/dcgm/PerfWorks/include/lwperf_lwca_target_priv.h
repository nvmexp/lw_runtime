 ...
 */
    ...
    typedef struct LWPW_LWDA_PcSampling_BeginSession_Params
    {
        ...
        size_t timespan;
        /// [in] max number of PC to decode. Minimal = 6
        size_t maxNumPcs;
        ...
        /// [in] size of scratch buffer. It should be at least maxNumPcs * AlignUp(numCounterIds * 4B + 32B_PADDING, 8)
...
#define LWPW_LWDA_PcSampling_GetSampleStats_Params_STRUCT_SIZE LWPA_STRUCT_SIZE(LWPW_LWDA_PcSampling_GetSampleStats_Params, perfmonBufferFull)
    ...
    typedef struct LWPW_LWDA_PcSampling_GatherData_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
        ...
        /// [in] if NULL, the default stream is used
        struct LWstream_st* stream;
        /// number of bytes available in perfmon buffer to decode
        size_t bytesToDecode;
        /// [in] Event stream's varDataBufferSizeInBytes must be at least: sizeof(LWPW_LWDA_PcSampling_DecodeStats) +
    ...
    } LWPW_LWDA_PcSampling_GatherData_Params;
#define LWPW_LWDA_PcSampling_GatherData_Params_STRUCT_SIZE LWPA_STRUCT_SIZE(LWPW_LWDA_PcSampling_GatherData_Params, counterDataGroup)
