#ifndef LWPERF_DCGM_HOST_PRIV_H
#define LWPERF_DCGM_HOST_PRIV_H
 ...
 ******************************************************************************/
    ...
    typedef struct LWPW_DCGM_MetricsContext_Create_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
    ...
    } LWPW_DCGM_MetricsContext_Create_Params;
#define LWPW_DCGM_MetricsContext_Create_Params_STRUCT_SIZE LWPA_STRUCT_SIZE(LWPW_DCGM_MetricsContext_Create_Params, pMetricsContext)

    LWPW_LOCAL
    LWPA_Status LWPW_DCGM_MetricsContext_Create(LWPW_DCGM_MetricsContext_Create_Params* pParams);

    typedef struct LWPW_DCGM_RawMetricsConfig_Create_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
    ...
    } LWPW_DCGM_RawMetricsConfig_Create_Params;
#define LWPW_DCGM_RawMetricsConfig_Create_Params_STRUCT_SIZE LWPA_STRUCT_SIZE(LWPW_DCGM_RawMetricsConfig_Create_Params, pRawMetricsConfig)
