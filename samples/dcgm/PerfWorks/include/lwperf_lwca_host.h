#ifndef LWPERF_LWDA_HOST_H
#define LWPERF_LWDA_HOST_H
 ...
 ******************************************************************************/
    ...
    typedef struct LWPW_LWDA_MetricsContext_Create_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
    ...
    } LWPW_LWDA_MetricsContext_Create_Params;
#define LWPW_LWDA_MetricsContext_Create_Params_STRUCT_SIZE LWPA_STRUCT_SIZE(LWPW_LWDA_MetricsContext_Create_Params, pMetricsContext)

    LWPA_Status LWPW_LWDA_MetricsContext_Create(LWPW_LWDA_MetricsContext_Create_Params* pParams);

    typedef struct LWPW_LWDA_RawMetricsConfig_Create_Params
    {
        /// [in]
        size_t structSize;
        /// [in] assign to NULL
    ...
    } LWPW_LWDA_RawMetricsConfig_Create_Params;
#define LWPW_LWDA_RawMetricsConfig_Create_Params_STRUCT_SIZE LWPA_STRUCT_SIZE(LWPW_LWDA_RawMetricsConfig_Create_Params, pRawMetricsConfig)
