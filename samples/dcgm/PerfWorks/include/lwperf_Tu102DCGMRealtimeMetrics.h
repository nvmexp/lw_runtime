...
namespace lw { namespace metrics { namespace tu102 {
    ...
    namespace RawMetricIdx
    {
        enum Enum
        {
            ...
            sm__cycles_active                                               , //      2
            smsp__inst_exelwted_pipe_fp16                                   , //      3
            sys__cycles_elapsed                                             , //      4
            smsp__pipe_shared_cycles_active                                 , //      5
            COUNT // = 6
        };
    }
    ...
    struct RawMetricsStorage : public RawMetricsContext
    {
        ...
        static const uint64_t* GetRawMetricIds()
        {
            static const uint64_t s_rawMetricIds[] = {
                ...
                0x9f4e8d01ae3d4260, // smsp__pipe_shared_cycles_active
                0
            };
        ...
        static const char* const* GetRawMetricNames()
        {
            static const char* const s_rawMetricNames[] = {
                ...
                "sys__cycles_elapsed",
                "smsp__pipe_shared_cycles_active",
                0
            };
    ...
    struct RawMetrics : public RawMetricsStorage
    {
        ...
        {
            return GetValue(RawMetricIdx::sm__warps_active, 32.0, tpc__cycles_elapsed().avg);
        }
        ...
        {
            return GetValue(RawMetricIdx::smsp__inst_exelwted_pipe_fp16, 0.5, tpc__cycles_elapsed().avg);
        }
        ...
        MetricValue smsp__pipe_shared_cycles_active()
        {
            return GetValue(RawMetricIdx::smsp__pipe_shared_cycles_active, 1.0, tpc__cycles_elapsed().avg);
        }
...
#define LW_TU102_RAW_METRIC_DESCS(f_) \
    f_(sm__cycles_active, "# of cycles with at least one warp in flight") \
    f_(sm__warps_active, "sum of per-cycle # of warps in flight") \
    f_(smsp__inst_exelwted_pipe_fp16, "# of warp instructions exelwted by fp16 pipe") \
    f_(smsp__pipe_shared_cycles_active, "# of cycles where the 'shared pipe' fp16+tensor was active") \
    f_(sys__cycles_elapsed, "# of cycles elapsed on SYS") \
    f_(tpc__cycles_elapsed, "# of cycles elapsed on TPC") \

#define LW_TU102_ALL_METRIC_DESCS(f_) \
    LW_TU102_RAW_METRIC_DESCS(f_) \
