...
typedef LWPA_Status (*LWPA_RawMetricsConfig_GetMetricNameFromCounterId_Fn)(const LWPA_RawMetricsConfig* pRawMetricsConfig, uint64_t counterId, const char** pMetricName);
typedef LWPA_Status (*LWPW_RawMetricsConfig_GetMetricNameFromCounterId_Fn)(LWPW_RawMetricsConfig_GetMetricNameFromCounterId_Params* pParams);
...
typedef LWPA_Status (*LWPA_MetricsContext_EvaluateToInstanceValues_Fn)(LWPA_MetricsContext* pMetricsContext, const char* pMetricName, const char* pUnitName, size_t numInstances, double* pInstanceValues, size_t* pNumInstances);
typedef LWPA_Status (*LWPW_MetricsContext_EvaluateToInstanceValues_Fn)(LWPW_MetricsContext_EvaluateToInstanceValues_Params* pParams);
typedef LWPA_Status (*LWPW_RawMetricsConfig_SetCounterProviderMask_Fn)(LWPW_RawMetricsConfig_SetCounterProviderMask_Params* pParams);
typedef LWPA_Status (*LWPW_RawMetricsConfig_GetSmpcSchedulerState_Fn)(LWPW_RawMetricsConfig_GetSmpcSchedulerState_Params* pParams);
typedef LWPA_Status (*LWPW_PcSampling_IsPcSamplingSupported_Fn)(LWPW_PcSampling_IsPcSamplingSupported_Params* pParams);
typedef LWPA_Status (*LWPW_PcSampling_GetNumCounters_Fn)(LWPW_PcSampling_GetNumCounters_Params* pParams);
typedef LWPA_Status (*LWPW_PcSampling_GetCounterProperties_Fn)(LWPW_PcSampling_GetCounterProperties_Params* pParams);
...
typedef LWPA_Status (*LWPW_DCGM_MetricsContext_Create_Fn)(LWPW_DCGM_MetricsContext_Create_Params* pParams);
typedef LWPA_Status (*LWPW_DCGM_RawMetricsConfig_Create_Fn)(LWPW_DCGM_RawMetricsConfig_Create_Params* pParams);
...
static LWPA_Status LWPA_RawMetricsConfig_GetMetricNameFromCounterId_Default(const LWPA_RawMetricsConfig* pRawMetricsConfig, uint64_t counterId, const char** pMetricName)
{
    (void)pRawMetricsConfig;
    (void)counterId;
    (void)pMetricName;
...
static LWPA_Status LWPW_RawMetricsConfig_GetMetricNameFromCounterId_Default(LWPW_RawMetricsConfig_GetMetricNameFromCounterId_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
...
static LWPA_Status LWPA_MetricsContext_EvaluateToInstanceValues_Default(LWPA_MetricsContext* pMetricsContext, const char* pMetricName, const char* pUnitName, size_t numInstances, double* pInstanceValues, size_t* pNumInstances)
{
    (void)pMetricsContext;
    (void)pMetricName;
    (void)pUnitName;
    (void)numInstances;
    (void)pInstanceValues;
    (void)pNumInstances;
    return g_defaultStatus;
}
static LWPA_Status LWPW_MetricsContext_EvaluateToInstanceValues_Default(LWPW_MetricsContext_EvaluateToInstanceValues_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
static LWPA_Status LWPW_RawMetricsConfig_SetCounterProviderMask_Default(LWPW_RawMetricsConfig_SetCounterProviderMask_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
static LWPA_Status LWPW_RawMetricsConfig_GetSmpcSchedulerState_Default(LWPW_RawMetricsConfig_GetSmpcSchedulerState_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
static LWPA_Status LWPW_PcSampling_IsPcSamplingSupported_Default(LWPW_PcSampling_IsPcSamplingSupported_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
static LWPA_Status LWPW_PcSampling_GetNumCounters_Default(LWPW_PcSampling_GetNumCounters_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
static LWPA_Status LWPW_PcSampling_GetCounterProperties_Default(LWPW_PcSampling_GetCounterProperties_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
...
static LWPA_Status LWPW_DCGM_MetricsContext_Create_Default(LWPW_DCGM_MetricsContext_Create_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
static LWPA_Status LWPW_DCGM_RawMetricsConfig_Create_Default(LWPW_DCGM_RawMetricsConfig_Create_Params* pParams)
{
    (void)pParams;
    return g_defaultStatus;
}
...
typedef struct PerfworksApi {
    ...
    LWPA_RawMetricsConfig_GetMetricNameFromCounterId_Fn          LWPA_RawMetricsConfig_GetMetricNameFromCounterId;
    LWPW_RawMetricsConfig_GetMetricNameFromCounterId_Fn          LWPW_RawMetricsConfig_GetMetricNameFromCounterId;
    ...
    LWPA_MetricsContext_EvaluateToInstanceValues_Fn              LWPA_MetricsContext_EvaluateToInstanceValues;
    LWPW_MetricsContext_EvaluateToInstanceValues_Fn              LWPW_MetricsContext_EvaluateToInstanceValues;
    LWPW_RawMetricsConfig_SetCounterProviderMask_Fn              LWPW_RawMetricsConfig_SetCounterProviderMask;
    LWPW_RawMetricsConfig_GetSmpcSchedulerState_Fn               LWPW_RawMetricsConfig_GetSmpcSchedulerState;
    LWPW_PcSampling_IsPcSamplingSupported_Fn                     LWPW_PcSampling_IsPcSamplingSupported;
    LWPW_PcSampling_GetNumCounters_Fn                            LWPW_PcSampling_GetNumCounters;
    LWPW_PcSampling_GetCounterProperties_Fn                      LWPW_PcSampling_GetCounterProperties;
    ...
    LWPW_DCGM_MetricsContext_Create_Fn                           LWPW_DCGM_MetricsContext_Create;
    LWPW_DCGM_RawMetricsConfig_Create_Fn                         LWPW_DCGM_RawMetricsConfig_Create;
...
static LWPW_User_Api g_api = {
    ...
    , {
        ...
        , &LWPA_RawMetricsConfig_GetMetricNameFromCounterId_Default
        , &LWPW_RawMetricsConfig_GetMetricNameFromCounterId_Default
        ...
        , &LWPA_MetricsContext_EvaluateToInstanceValues_Default
        , &LWPW_MetricsContext_EvaluateToInstanceValues_Default
        , &LWPW_RawMetricsConfig_SetCounterProviderMask_Default
        , &LWPW_RawMetricsConfig_GetSmpcSchedulerState_Default
        , &LWPW_PcSampling_IsPcSamplingSupported_Default
        , &LWPW_PcSampling_GetNumCounters_Default
        , &LWPW_PcSampling_GetCounterProperties_Default
        ...
        , &LWPW_DCGM_MetricsContext_Create_Default
        , &LWPW_DCGM_RawMetricsConfig_Create_Default
...
static void InitPerfworksProcs(void)
{
    ...
    g_api.fn.LWPA_RawMetricsConfig_GetMetricNameFromCounterId = (LWPA_RawMetricsConfig_GetMetricNameFromCounterId_Fn)GetPerfworksProc("LWPA_RawMetricsConfig_GetMetricNameFromCounterId", (LWPA_GenericFn)g_api.fn.LWPA_RawMetricsConfig_GetMetricNameFromCounterId);
    g_api.fn.LWPW_RawMetricsConfig_GetMetricNameFromCounterId = (LWPW_RawMetricsConfig_GetMetricNameFromCounterId_Fn)GetPerfworksProc("LWPW_RawMetricsConfig_GetMetricNameFromCounterId", (LWPA_GenericFn)g_api.fn.LWPW_RawMetricsConfig_GetMetricNameFromCounterId);
    ...
    g_api.fn.LWPA_MetricsContext_EvaluateToInstanceValues = (LWPA_MetricsContext_EvaluateToInstanceValues_Fn)GetPerfworksProc("LWPA_MetricsContext_EvaluateToInstanceValues", (LWPA_GenericFn)g_api.fn.LWPA_MetricsContext_EvaluateToInstanceValues);
    g_api.fn.LWPW_MetricsContext_EvaluateToInstanceValues = (LWPW_MetricsContext_EvaluateToInstanceValues_Fn)GetPerfworksProc("LWPW_MetricsContext_EvaluateToInstanceValues", (LWPA_GenericFn)g_api.fn.LWPW_MetricsContext_EvaluateToInstanceValues);
    g_api.fn.LWPW_RawMetricsConfig_SetCounterProviderMask = (LWPW_RawMetricsConfig_SetCounterProviderMask_Fn)GetPerfworksProc("LWPW_RawMetricsConfig_SetCounterProviderMask", (LWPA_GenericFn)g_api.fn.LWPW_RawMetricsConfig_SetCounterProviderMask);
    g_api.fn.LWPW_RawMetricsConfig_GetSmpcSchedulerState = (LWPW_RawMetricsConfig_GetSmpcSchedulerState_Fn)GetPerfworksProc("LWPW_RawMetricsConfig_GetSmpcSchedulerState", (LWPA_GenericFn)g_api.fn.LWPW_RawMetricsConfig_GetSmpcSchedulerState);
    g_api.fn.LWPW_PcSampling_IsPcSamplingSupported = (LWPW_PcSampling_IsPcSamplingSupported_Fn)GetPerfworksProc("LWPW_PcSampling_IsPcSamplingSupported", (LWPA_GenericFn)g_api.fn.LWPW_PcSampling_IsPcSamplingSupported);
    g_api.fn.LWPW_PcSampling_GetNumCounters = (LWPW_PcSampling_GetNumCounters_Fn)GetPerfworksProc("LWPW_PcSampling_GetNumCounters", (LWPA_GenericFn)g_api.fn.LWPW_PcSampling_GetNumCounters);
    g_api.fn.LWPW_PcSampling_GetCounterProperties = (LWPW_PcSampling_GetCounterProperties_Fn)GetPerfworksProc("LWPW_PcSampling_GetCounterProperties", (LWPA_GenericFn)g_api.fn.LWPW_PcSampling_GetCounterProperties);
    ...
    g_api.fn.LWPW_DCGM_MetricsContext_Create = (LWPW_DCGM_MetricsContext_Create_Fn)GetPerfworksProc("LWPW_DCGM_MetricsContext_Create", (LWPA_GenericFn)g_api.fn.LWPW_DCGM_MetricsContext_Create);
    g_api.fn.LWPW_DCGM_RawMetricsConfig_Create = (LWPW_DCGM_RawMetricsConfig_Create_Fn)GetPerfworksProc("LWPW_DCGM_RawMetricsConfig_Create", (LWPA_GenericFn)g_api.fn.LWPW_DCGM_RawMetricsConfig_Create);
...
LWPA_Status LWPA_RawMetricsConfig_GetMetricNameFromCounterId(const LWPA_RawMetricsConfig* pRawMetricsConfig, uint64_t counterId, const char** pMetricName)
{
    return g_api.fn.LWPA_RawMetricsConfig_GetMetricNameFromCounterId(pRawMetricsConfig, counterId, pMetricName);
}
...
{
    return g_api.fn.LWPW_RawMetricsConfig_GetMetricNameFromCounterId(pParams);
}
...
LWPA_Status LWPA_MetricsContext_EvaluateToInstanceValues(LWPA_MetricsContext* pMetricsContext, const char* pMetricName, const char* pUnitName, size_t numInstances, double* pInstanceValues, size_t* pNumInstances)
{
    return g_api.fn.LWPA_MetricsContext_EvaluateToInstanceValues(pMetricsContext, pMetricName, pUnitName, numInstances, pInstanceValues, pNumInstances);
}
LWPA_Status LWPW_MetricsContext_EvaluateToInstanceValues(LWPW_MetricsContext_EvaluateToInstanceValues_Params* pParams)
{
    return g_api.fn.LWPW_MetricsContext_EvaluateToInstanceValues(pParams);
}
LWPA_Status LWPW_RawMetricsConfig_SetCounterProviderMask(LWPW_RawMetricsConfig_SetCounterProviderMask_Params* pParams)
{
    return g_api.fn.LWPW_RawMetricsConfig_SetCounterProviderMask(pParams);
}
LWPA_Status LWPW_RawMetricsConfig_GetSmpcSchedulerState(LWPW_RawMetricsConfig_GetSmpcSchedulerState_Params* pParams)
{
    return g_api.fn.LWPW_RawMetricsConfig_GetSmpcSchedulerState(pParams);
}
LWPA_Status LWPW_PcSampling_IsPcSamplingSupported(LWPW_PcSampling_IsPcSamplingSupported_Params* pParams)
{
    return g_api.fn.LWPW_PcSampling_IsPcSamplingSupported(pParams);
}
LWPA_Status LWPW_PcSampling_GetNumCounters(LWPW_PcSampling_GetNumCounters_Params* pParams)
{
    return g_api.fn.LWPW_PcSampling_GetNumCounters(pParams);
}
LWPA_Status LWPW_PcSampling_GetCounterProperties(LWPW_PcSampling_GetCounterProperties_Params* pParams)
{
    return g_api.fn.LWPW_PcSampling_GetCounterProperties(pParams);
}
...
LWPA_Status LWPW_DCGM_MetricsContext_Create(LWPW_DCGM_MetricsContext_Create_Params* pParams)
{
    return g_api.fn.LWPW_DCGM_MetricsContext_Create(pParams);
}
LWPA_Status LWPW_DCGM_RawMetricsConfig_Create(LWPW_DCGM_RawMetricsConfig_Create_Params* pParams)
{
    return g_api.fn.LWPW_DCGM_RawMetricsConfig_Create(pParams);
}
...
static void* LibOpen(char const* name)
{
    ...
    flags |= RTLD_DEEPBIND;
#endif
    ret = dlopen(name, flags);
    if (!ret)
    {
        PRINT_ERROR("%s %u %s", "dlopen of %s with flags %u failed with dlerror %s", 
                    name, flags, dlerror());
    }
    return ret;
}
