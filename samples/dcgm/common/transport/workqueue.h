...
typedef struct worker {
	pthread_t thread; /* Our thread handle */
} worker_t;
...
typedef struct workqueue {
	...
	pthread_mutex_t jobs_mutex;    /* Mutex to control access to jobs_queue and jobs_cond */
	pthread_cond_t jobs_cond;      /* Condition to signal to wake up workers */
