...
private:
    ...
    /* Per-gpu collections indexed by lwml device index */ 
...
public:
     ...
     *      Gpu  - Two levels of key space of lwmlGpuIndex=>key=>value
     *
    ...
    int SetGpuStat(unsigned int lwmlGpuIdx, std::string key, double value);
    int SetGpuStat(unsigned int lwmlGpuIdx, std::string key, long long value);
    int SetGpuStat(unsigned int lwmlGpuIdx, std::string key, std::string value);
    int AppendGpuStat(unsigned int lwmlGpuIdx, std::string key, double value1, double value2, timelib64_t timestamp);
    int AppendGpuStat(unsigned int lwmlGpuIdx, std::string key, long long value1, long long value2, timelib64_t timestamp);
    int AppendGpuStat(unsigned int lwmlGpuIdx, std::string key, std::string value, timelib64_t timestamp = 0);
    int AppendGpuStat(unsigned int lwmlGpuIdx, std::string key, void *value, int valueSize, timelib64_t timestamp = 0);
    ...
    int AppendEntityStat(sc_entity_group_t entityGroupId, sc_entity_id_t entityId, std::string key, double value1, double value2, timelib64_t timestamp);
    int AppendEntityStat(sc_entity_group_t entityGroupId, sc_entity_id_t entityId, std::string key, long long value1, long long value2, timelib64_t timestamp);
    int AppendEntityStat(sc_entity_group_t entityGroupId, sc_entity_id_t entityId, std::string key, std::string value, timelib64_t timestamp = 0);
    int AppendEntityStat(sc_entity_group_t entityGroupId, sc_entity_id_t entityId, std::string key, void *value, int valueSize, timelib64_t timestamp = 0);
    ...
    /*************************************************************************/
    /*
     * Get a vector of LWML GPU indexes that have stats
     */
    ...
    mcollect_value_p GetGpuStat(unsigned int lwmlGpuIdx, std::string key); /* Deprecated */
     ...
     *          <0 on failure
     */
    int GetEntityFieldBytesUsed(sc_entity_group_t entityGroupId, sc_entity_id_t entityId, std::string key, long long *bytesUsed);
    ...
    /*************************************************************************/
    /*
     * Colwert this object to a standard string for debugging purposes
     *
     */
    ...
    /*************************************************************************/
    /*
     * Colwert this object to a JSON string for external parsing
     *
     */
     ...
     *
     * Note that this does not lwrrently record the merged records to the
     * packet logger
     *
     ...
     *
     */
    int EnforceGlobalStatQuota(std::string key, timelib64_t oldestKeepTimestamp,
                               int maxKeepEntries) const;
    int EnforceGroupedStatQuote(std::string group, std::string key,
                                timelib64_t oldestKeepTimestamp,
                                int maxKeepEntries);
    int EnforceEntityStatQuota(sc_entity_group_t entityGroupId, sc_entity_id_t entityId,
