...
#define LWDART_INF_F            __int_as_float(0x7f800000)
#define LWDART_NAN_F            __int_as_float(0x7fffffff)
#define LWDART_MIN_DENORM_F     __int_as_float(0x00000001)
#define LWDART_MAX_NORMAL_F     __int_as_float(0x7f7fffff)
#define LWDART_NEG_ZERO_F       __int_as_float(0x80000000)
...
#define LWDART_REMQUO_BITS_F    3
#define LWDART_REMQUO_MASK_F    (~((~0)<<LWDART_REMQUO_BITS_F))
