 ...
 * the compiler's -ftz flag setting. These are supported for LWPU internal 
 * library work only.
 */
 ...
 *
 * Colwert the signed 64-bit integer value \p x to a double-precision floating
 ...
 *
 * Colwert the unsigned 64-bit integer value \p x to a double-precision floating
 * point value in round-to-nearest-even mode.
 * \return Returns colwerted value.
 */
