 ...
 */
static __OCC_INLINE lwdaOccError lwdaOccAlignUpShmemSizeVolta(size_t *shMemSize, const lwdaOccDeviceProp *properties)
{
 ...
 */
static __OCC_INLINE lwdaOccError lwdaOccSMemPreferenceVolta(size_t *limit, const lwdaOccDeviceProp *properties, const lwdaOccDeviceState *state)
{
    ...
    status = lwdaOccAlignUpShmemSizeVolta(&preferenceShmemSize, properties);
...
static __OCC_INLINE lwdaOccError lwdaOccSMemPerMultiprocessor(size_t *limit, const lwdaOccDeviceProp *properties, const lwdaOccDeviceState *state)
{
    ...
    if (properties->computeMajor == 7) {
        return lwdaOccSMemPreferenceVolta(limit, properties, state);
    }
