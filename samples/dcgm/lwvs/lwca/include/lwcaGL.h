 ...
 * ::lwWGLGetDevice
 */
LWresult LWDAAPI lwGLInit(void);
 ...
 */
LWresult LWDAAPI lwGLRegisterBufferObject(GLuint buffer);
 ...
 */
LWresult LWDAAPI lwGLMapBufferObject(LWdeviceptr *dptr, size_t *size,  GLuint buffer);  
#endif /* __LWDA_API_VERSION >= 3020 */
 ...
 */
LWresult LWDAAPI lwGLUnmapBufferObject(GLuint buffer);
 ...
 */
LWresult LWDAAPI lwGLUnregisterBufferObject(GLuint buffer);
 ...
 */
LWresult LWDAAPI lwGLSetBufferObjectMapFlags(GLuint buffer, unsigned int Flags);
 ...
 * \sa ::lwGraphicsMapResources
 */
LWresult LWDAAPI lwGLMapBufferObjectAsync(LWdeviceptr *dptr, size_t *size,  GLuint buffer, LWstream hStream);
#endif /* __LWDA_API_VERSION >= 3020 */
 ...
 * \sa ::lwGraphicsUnmapResources
 */
LWresult LWDAAPI lwGLUnmapBufferObjectAsync(GLuint buffer, LWstream hStream);
...
#if defined(__LWDA_API_VERSION_INTERNAL) || __LWDA_API_VERSION < 3020
LWresult LWDAAPI lwGLCtxCreate(LWcontext *pCtx, unsigned int Flags, LWdevice device );
LWresult LWDAAPI lwGLMapBufferObject(LWdeviceptr *dptr, unsigned int *size,  GLuint buffer);  
LWresult LWDAAPI lwGLMapBufferObjectAsync(LWdeviceptr *dptr, unsigned int *size,  GLuint buffer, LWstream hStream);
#endif /* __LWDA_API_VERSION_INTERNAL || __LWDA_API_VERSION < 3020 */ 
