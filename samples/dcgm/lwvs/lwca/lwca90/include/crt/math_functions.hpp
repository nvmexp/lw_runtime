...
__host__ __device__ __lwdart_builtin__ int signbit(float x) { return __signbitf(x); }
__host__ __device__ __lwdart_builtin__ int signbit(double x) { return __signbit(x); }
__host__ __device__ __lwdart_builtin__ int signbit(long double x) { return __signbitl((double)x);}

__host__ __device__ __lwdart_builtin__ int isfinite(float x) { return __finitef(x); } 
__host__ __device__ __lwdart_builtin__ int isfinite(double x) { return __finite(x); }
__host__ __device__ __lwdart_builtin__ int isfinite(long double x) { return __finitel((double)x); }

__host__ __device__ __lwdart_builtin__ int isnan(float x) { return __isnanf(x); }
__host__ __device__ __lwdart_builtin__ int isnan(double x) { return __isnan(x); }
__host__ __device__ __lwdart_builtin__ int isnan(long double x) { return __isnanl((double)x); }

__host__ __device__ __lwdart_builtin__ int isinf(float x) { return __isinff(x); }
__host__ __device__ __lwdart_builtin__ int isinf(double x) { return __isinf(x); }
__host__ __device__ __lwdart_builtin__ int isinf(long double x) { return __isinfl((double)x); }

__host__ __device__ __lwdart_builtin__ long long int abs(long long int a) { return llabs(a); }

__host__ __device__ __lwdart_builtin__ long int  abs(long int in)        { return llabs(in); }
__host__ __device__ __lwdart_builtin__ float     abs(float in)           { return fabsf(in); }
__host__ __device__ __lwdart_builtin__ double    abs(double in)          { return fabs(in); }
__host__ __device__ __lwdart_builtin__ float     fabs(float in)          { return fabsf(in); }
__host__ __device__ __lwdart_builtin__ float     ceil(float in)          { return ceilf(in); }
__host__ __device__ __lwdart_builtin__ float     floor(float in)         { return floorf(in); }
__host__ __device__ __lwdart_builtin__ float     sqrt(float in)          { return sqrtf(in); }
__host__ __device__ __lwdart_builtin__ float     pow(float a, float b)   { return powf(a, b); }
__device__ float powif(float, int); 
__host__ __device__ __lwdart_builtin__ float     pow(float a, int b)     { return powif(a, b); }
__device__ double powi(double, int);
__host__ __device__ __lwdart_builtin__ double    pow(double a, int b)    { return powi(a, b); }
__host__ __device__ __lwdart_builtin__ float     log(float in)           { return logf(in); }
__host__ __device__ __lwdart_builtin__ float     log10(float in)         { return log10f(in); }
__host__ __device__ __lwdart_builtin__ float     fmod(float a, float b)  { return fmodf(a, b); }
__host__ __device__ __lwdart_builtin__ float     modf(float a, float*b)  { return modff(a, b); }
__host__ __device__ __lwdart_builtin__ float     exp(float in)           { return expf(in); }
__host__ __device__ __lwdart_builtin__ float     frexp(float a, int*b)   { return frexpf(a, b); }
__host__ __device__ __lwdart_builtin__ float     ldexp(float a, int b)   { return ldexpf(a, b); }
__host__ __device__ __lwdart_builtin__ float     asin(float in)          { return asinf(in); }
__host__ __device__ __lwdart_builtin__ float     sin(float in)           { return sinf(in); }
__host__ __device__ __lwdart_builtin__ float     sinh(float in)          { return sinhf(in); }
__host__ __device__ __lwdart_builtin__ float     acos(float in)          { return acosf(in); }
__host__ __device__ __lwdart_builtin__ float     cos(float in)           { return cosf(in); }
__host__ __device__ __lwdart_builtin__ float     cosh(float in)          { return coshf(in); }
__host__ __device__ __lwdart_builtin__ float     atan(float in)          { return atanf(in); }
__host__ __device__ __lwdart_builtin__ float     atan2(float a, float b) { return atan2f(a, b); }
__host__ __device__ __lwdart_builtin__ float     tan(float in)           { return tanf(in); }
__host__ __device__ __lwdart_builtin__ float     tanh(float in)          { return tanhf(in); }
...
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(float x) { return __signbitf(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(double x) { return __signbitd(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(long double x) { return __signbitl(x);}

__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(float x) { return __isfinitef(x); } 
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(double x) { return __isfinited(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(long double x) { return __isfinite(x); }

__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(float x) { return __isnanf(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(double x) throw()  { return __isnand(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(long double x) { return __isnan(x); }

__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(float x) { return __isinff(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(double x) throw()  { return __isinfd(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(long double x) { return __isinf(x); }
#else /* __APPLE__ */
...
__LW_BUILTIN_FUNC_DECL__ int  isnan(double a) throw() { return __isnan(a); }
__LW_BUILTIN_FUNC_DECL__ int  isinf(double x) throw() { return __isinf(x); }
...
#if defined(__LWDA_ARCH__)
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(float x) { return __signbitf(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(double x) { return __signbit(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(long double x) { return __signbitl(x);}

__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(float x) { return __finitef(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(double x) { return __finite(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(long double x) { return __finitel(x); }

__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(float x) { return __isnanf(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(double x)  { return __isnan(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(long double x) { return __isnanl(x); }

__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(float x) { return __isinff(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(double x) { return __isinf(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(long double x) { return __isinfl(x); }
#else /* !defined(__LWDA_ARCH__) */
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(float x) { return signbit<float>(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(double x) { return signbit<double>(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(long double x) { return signbit<long double>(x);}

__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(float x) { return isfinite<float>(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(double x) { return isfinite<double>(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(long double x) { return isfinite<long double>(x); }

__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(float x) { return isnan<float>(x); }
/* int isnan(double) provided by math.h */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(long double x) { return isnan<long double>(x); }

__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(float x) { return isinf<float>(x); }
/* int isinf(double) provided by math.h */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(long double x) { return isinf<long double>(x); }
#endif  /* defined(__LWDA_ARCH__) */

#else /* !(__QNX__ || __HORIZON__) */
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(float x) { return __signbitf(x); }
#if defined(__ICC)
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(double x) throw() { return __signbit(x); }
#else /* !__ICC */
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(double x) { return __signbit(x); }
#endif /* __ICC */
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(long double x) { return __signbitl(x);}
...
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(float x) {
#if defined(__LWDA_ARCH__)
  return __finitef(x);
#else	/* !__LWDA_ARCH__ */
...
#if defined(__ANDROID__)
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(double x)
{
#ifdef __LWDA_ARCH__
  return __finite(x);
#else  /* !__LWDA_ARCH__ */
...
#elif defined(__ICC)
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(double x) throw() { return __finite(x); }
#else
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(double x) { return __finite(x); }
#endif /* __ANDROID__ */

#if defined(__ANDROID__)
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(long double x) 
{
#ifdef __LWDA_ARCH__
   return __finitel(x);
#else /* !__LWDA_ARCH__ */
...
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(double x) { return __isnan(x); }
#else /* !__ANDROID__ */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(double x) throw()  { return __isnan(x); }
#endif /* __ANDROID__ */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(long double x) { return __isnanl(x); }
...
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(double x) { return __isinf(x); }
#else /* !__ANDROID__ */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(double x) throw()  { return __isinf(x); }
#endif /* __ANDROID__ */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(long double x) { return __isinfl(x); }
...
#if !defined(__QNX__) && !defined(__HORIZON__)
static __inline__ __host__ __device__ __lwdart_builtin__ long long int abs(long long int a)
{
  return llabs(a);
}
#endif /* !__QNX__ && !__HORIZON__*/
...
__MATH_FUNCTIONS_DECL__ float erfilw(float a)
{
  return erfilwf(a);
}

__MATH_FUNCTIONS_DECL__ float erfcilw(float a)
{
  return erfcilwf(a);
}

__MATH_FUNCTIONS_DECL__ float normcdfilw(float a)
{
...
{
  return (float)erfilw((double)a);
}

__func__(float erfcilwf(float a))
{
  return (float)erfcilw((double)a);
}

__func__(float normcdfilwf(float a))
{
  return (float)normcdfilw((double)a);
}
