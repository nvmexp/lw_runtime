...
namespace std {
#endif
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ int            __cdecl abs(int) __THROW;
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ long int       __cdecl labs(long int) __THROW;
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ long long int          llabs(long long int) __THROW;
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
}
#endif
#endif /* __ANDROID__ */
 ...
 *
 * Callwlate the base 2 exponential of the input argument \p x.
 *
 * \return Returns 
 ...
 *
 * Callwlate the base 10 exponential of the input argument \p x.
 *
 * \return Returns 
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the nonnegative arc hyperbolic cosine of the input argument.
 *
 * Callwlate the nonnegative arc hyperbolic cosine of the input argument \p x.
 *
 * \return 
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the arc hyperbolic sine of the input argument.
 *
 * Callwlate the arc hyperbolic sine of the input argument \p x.
 *
 * \return 
 * - asinh(0) returns 1.
 *
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the arc hyperbolic tangent of the input argument.
 *
 * Callwlate the arc hyperbolic tangent of the input argument \p x.
 *
 * \return 
 * - atanh(
 * \latexonly $\pm 0$ \endlatexonly
 ...
 * </d4p_MathML>
 * \endxmlonly
 *  if the correctly callwlated value is outside the double floating point range.
 *
 * \note_aclwracy_double
 */
 ...
 * </d4p_MathML>
 * \endxmlonly
 *  if the correctly callwlated value is outside the single floating point range.
 *
 * \note_aclwracy_single
 */
 ...
 *
 * Callwlate the length of three dimensional vector \p p in euclidean space without undue overflow or underflow.
 *
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl norm3d(double a, double b, double c) __THROW;

/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate one over the square root of the sum of squares of three coordinates of the argument.
 *
 * Callwlate one over the length of three dimensional vector \p p in euclidean space undue overflow or underflow.
 *
 ...
 *
 * Callwlate the length of four dimensional vector \p p in euclidean space without undue overflow or underflow.
 *
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl norm4d(double a, double b, double c, double d) __THROW;

/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate one over the square root of the sum of squares of four coordinates of the argument.
 *
 * Callwlate one over the length of four dimensional vector \p p in euclidean space undue overflow or underflow.
 *
 * \return Returns one over the length of the 3D vetor 
 ...
 *
 * Callwlates one over the length of vector \p p, dimension of which is passed as an agument, in euclidean space without undue overflow or underflow.
 *
 ...
 * \brief Callwlate the square root of the sum of squares of any number of coordinates.
 *
 * Callwlates the length of a vector \p p, dimension of which is passed as an agument without undue overflow or underflow.
 *
 ...
 * \brief Callwlate the square root of the sum of squares of three coordinates of the argument.
 *
 * Callwlates the length of three dimensional vector \p p in euclidean space without undue overflow or underflow.
 *
 ...
 * \brief Callwlate one over the square root of the sum of squares of three coordinates of the argument.
 *
 * Callwlates one over the length of three dimension vector \p p in euclidean space without undue overflow or underflow.
 *
 ...
 * \brief Callwlate the square root of the sum of squares of four coordinates of the argument.
 *
 * Callwlates the length of four dimensional vector \p p in euclidean space without undue overflow or underflow.
 *
 ...
 * \brief Callwlate one over the square root of the sum of squares of four coordinates of the argument.
 *
 * Callwlates one over the length of four dimension vector \p p in euclidean space without undue overflow or underflow.
 *
 * \return Returns one over the length of the 3D vector
 * \latexonly $\frac{1}{\sqrt{p.x^2+p.y^2+p.z^2+p.t^2}}$ \endlatexonly
 * \xmlonly
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl cyl_bessel_i0(double x) __THROW;
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the value of the regular modified cylindrical Bessel function of order 0 for the input argument.
 *
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl cyl_bessel_i1(double x) __THROW;
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the value of the regular modified cylindrical Bessel function of order 1 for the input argument.
 *
 ...
 *
 * Callwlate the ilwerse error function of the input argument \p y, for \p y in the interval [-1, 1].
 * The ilwerse error function finds the value \p x that satisfies the equation \p y = erf(\p x),
 * for 
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ double                 erfilw(double y);
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the ilwerse error function of the input argument.
 *
 ...
 * \note_aclwracy_single
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float                  erfilwf(float y);
 ...
 *
 * Callwlate the ilwerse complementary error function of the input argument \p y, for \p y in the interval [0, 2].
 * The ilwerse complementary error function find the value \p x that satisfies the equation \p y = erfc(\p x),
 * for 
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ double                 erfcilw(double y);
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the ilwerse complementary error function of the input argument.
 *
 ...
 * \note_aclwracy_single
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float                  erfcilwf(float y);
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the ilwerse of the standard normal cumulative distribution function.
 *
 * Callwlate the ilwerse of the standard normal cumulative distribution function for input argument \p y,
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ double                 normcdfilw(double y);
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the ilwerse of the standard normal cumulative distribution function.
 *
 ...
 * \note_aclwracy_single
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float                  normcdfilwf(float y);
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the standard normal cumulative distribution function.
 *
 * Callwlate the cumulative distribution function of the standard normal distribution for input argument \p y,
...
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(float x);
#if defined(__ICC)
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(double x) throw();
#else /* !__ICC */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(double x);
#endif /* __ICC */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(long double x);
...
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(float x); 
#if defined(__ICC)
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(double x) throw();
#else /* !__ICC */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(double x);
#endif /* __ICC */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(long double x);
...
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(double x);
#else /* !__ANDROID__ */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(double x) throw();
#endif /* __ANDROID__ */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(long double x);
...
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(float x);
#if defined(__ANDROID__)
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(double x);
#else /* !__ANDROID__ */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(double x) throw();
#endif /* __ANDROID__ */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(long double x);
...
__host__ __device__ __lwdart_builtin__ float norm3d(float a, float b, float c) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float norm4d(float a, float b, float c, float d) __LW_NOEXCEPT;
...
__host__ __device__ __lwdart_builtin__ constexpr float norm3d(float a, float b, float c);
__host__ __device__ __lwdart_builtin__ constexpr float norm4d(float a, float b, float c, float d);
...
extern __host__ __device__ __lwdart_builtin__ float __cdecl norm3d(float, float, float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl norm4d(float, float, float, float) throw();
