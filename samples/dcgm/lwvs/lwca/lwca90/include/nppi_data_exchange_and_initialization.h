 ...
 *  @ingroup nppi
 *
 * Primitives for initializting, copying and colwerting image data.
 *
 * @{
 *
...
/** 
 * @defgroup image_colwert Colwert
 *
 * @{
 *
 */
...
/** 
 * @name Colwert to Increase Bit-Depth
 *
 ...
 * - When colwerting integers (e.g. Npp32u) to float (e.g. Npp32f) integervalue not aclwrately representable 
...
/** @} Colwert to Increase Bit-Depth */


/** 
 * @name Colwert to Decrease Bit-Depth
 *
...
/**
 * @name Scaled Bit-Depth Colwersion
 ...
 * \param lwalue The pixel value to be set for border pixels.
 * \return \ref image_data_error_codes, \ref roi_error_codes
 */
