...
lwsparseStatus_t LWSPARSEAPI lwsparseCcsr2csr_compress(lwsparseHandle_t handle,
                                                        ...
                                                        int n,
                                                        const lwsparseMatDescr_t descra,
                                                        const lwComplex *csrValA, //csr values array-the elements which are below a certain tolerance will be remvoed
                                                        const int *csrColIndA,
                                                        const int * csrRowPtrA,  //corresponding input noncompressed row pointer
                                                        int nnzA,
                                                        const int *nnzPerRow,  
...
lwsparseStatus_t LWSPARSEAPI lwsparseZcsr2csr_compress(lwsparseHandle_t handle,
                                                      ...
                                                      int n,
                                                      const lwsparseMatDescr_t descra,
                                                      const lwDoubleComplex *csrValA, //csr values array-the elements which are below a certain tolerance will be remvoed
                                                      const int *csrColIndA,
                                                      const int * csrRowPtrA,  //corresponding input noncompressed row pointer
                                                      int  nnzA,
                                                      const int *nnzPerRow, 
                                                      lwDoubleComplex *csrValC,
                                                      int *csrColIndC,
                                                      int *csrRowPtrC,
                                                      lwDoubleComplex tol);                        
