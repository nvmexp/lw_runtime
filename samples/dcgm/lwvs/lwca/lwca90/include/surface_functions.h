...
template <typename T>
static __device__  __forceinline__ void surf1Dread(T *res, surface<void, lwdaSurfaceType1D> surf, int x, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__  T surf1Dread(surface<void, lwdaSurfaceType1D> surf, int x, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
  T temp;
...
template<class T>
static __device__ __forceinline__ void surf1Dread(T *res, surface<void, lwdaSurfaceType1D> surf, int x, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template <typename T>
static __device__  __forceinline__ void surf2Dread(T *res, surface<void, lwdaSurfaceType2D> surf, int x, int y, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__  T surf2Dread(surface<void, lwdaSurfaceType2D> surf, int x, int y, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
  T temp;
...
template<class T>
static __device__ __forceinline__ void surf2Dread(T *res, surface<void, lwdaSurfaceType2D> surf, int x, int y, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
template <typename T>
static __device__  __forceinline__ void surf3Dread(T *res, surface<void, lwdaSurfaceType3D> surf, int x, int y, int z, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__  T surf3Dread(surface<void, lwdaSurfaceType3D> surf, int x, int y, int z, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
  T temp;
...
template<class T>
static __device__ __forceinline__ void surf3Dread(T *res, surface<void, lwdaSurfaceType3D> surf, int x, int y, int z, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
template <typename T>
static __device__  __forceinline__ void surf1DLayeredread(T *res, surface<void, lwdaSurfaceType1DLayered> surf, int x, int  layer, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__  T surf1DLayeredread(surface<void, lwdaSurfaceType1DLayered> surf, int x, int layer, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
  T temp;
...
template<class T>
static __device__ __forceinline__ void surf1DLayeredread(T *res, surface<void, lwdaSurfaceType1DLayered> surf, int x, int layer, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
template <typename T>
static __device__  __forceinline__ void surf2DLayeredread(T *res, surface<void, lwdaSurfaceType2DLayered> surf, int x,  int y, int  layer, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__  T surf2DLayeredread(surface<void, lwdaSurfaceType2DLayered> surf, int x, int y, int layer, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
  T temp;
...
template<class T>
static __device__ __forceinline__ void surf2DLayeredread(T *res, surface<void, lwdaSurfaceType2DLayered> surf, int x, int y, int layer, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
template<class T>
static __device__ __forceinline__  T surfLwbemapread(surface<void, lwdaSurfaceTypeLwbemap> surf, int x, int y, int face, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
  T temp;
...
template<class T>
static __device__ __forceinline__ void surfLwbemapread(T *res, surface<void, lwdaSurfaceTypeLwbemap> surf, int x, int y, int face, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__  
...
template <typename T>
static __device__  __forceinline__ void surfLwbemapLayeredread(T *res, surface<void, lwdaSurfaceTypeLwbemapLayered> surf, int x,  int y, int  layerFace, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__  T surfLwbemapLayeredread(surface<void, lwdaSurfaceTypeLwbemapLayered> surf, int x, int y, int layerFace, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
  T temp;
...
template<class T>
static __device__ __forceinline__ void surfLwbemapLayeredread(T *res, surface<void, lwdaSurfaceTypeLwbemapLayered> surf, int x, int y, int layerFace, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__  
...
//surf1Dwrite
template<class T>
static __device__ __forceinline__ void surf1Dwrite(T val, surface<void, lwdaSurfaceType1D> surf, int x, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__ void surf1Dwrite(T val, surface<void, lwdaSurfaceType1D> surf, int x, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
//surf2Dwrite
template<class T>
static __device__ __forceinline__ void surf2Dwrite(T val, surface<void, lwdaSurfaceType2D> surf, int x, int y, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__ void surf2Dwrite(T val, surface<void, lwdaSurfaceType2D> surf, int x, int y, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
//surf3Dwrite
template<class T>
static __device__ __forceinline__ void surf3Dwrite(T val, surface<void, lwdaSurfaceType3D> surf, int x, int y, int z, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__ void surf3Dwrite(T val, surface<void, lwdaSurfaceType3D> surf, int x, int y, int z, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
//surf1DLayeredwrite
template<class T>
static __device__ __forceinline__ void surf1DLayeredwrite(T val, surface<void, lwdaSurfaceType1DLayered> surf, int x, int layer, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__ void surf1DLayeredwrite(T val, surface<void, lwdaSurfaceType1DLayered> surf, int x, int layer, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
//surf2DLayeredwrite
template<class T>
static __device__ __forceinline__ void surf2DLayeredwrite(T val, surface<void, lwdaSurfaceType2DLayered> surf, int x, int y, int layer, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__ void surf2DLayeredwrite(T val, surface<void, lwdaSurfaceType2DLayered> surf, int x, int y, int layer, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
//surfLwbemapwrite
template<class T>
static __device__ __forceinline__ void surfLwbemapwrite(T val, surface<void, lwdaSurfaceTypeLwbemap> surf, int x, int y, int face, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__ void surfLwbemapwrite(T val, surface<void, lwdaSurfaceTypeLwbemap> surf, int x, int y, int face, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
...
template<class T>
static __device__ __forceinline__ void surfLwbemapLayeredwrite(T val, surface<void, lwdaSurfaceTypeLwbemapLayered> surf, int x, int y, int layerFace, int s, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__
...
template<class T>
static __device__ __forceinline__ void surfLwbemapLayeredwrite(T val, surface<void, lwdaSurfaceTypeLwbemapLayered> surf, int x, int y, int layerFace, enum lwdaSurfaceBoundaryMode mode = lwdaBoundaryModeTrap)
{
#ifdef __LWDA_ARCH__ 
