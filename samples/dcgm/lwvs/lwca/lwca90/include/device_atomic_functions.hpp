...
#if !defined(__LWDA_ARCH__) || __LWDA_ARCH__ >= 110
...
#endif /* !__LWDA_ARCH__ || __LWDA_ARCH__ >= 110 */
#if !defined(__LWDA_ARCH__) || __LWDA_ARCH__ >= 120
...
#endif /* !__LWDA_ARCH__ || __LWDA_ARCH__ >= 120 */
