...
#define __LWDA_DEPRECATED
    ...
    #define lwStreamBeginCapture                __LWDA_API_PTSZ(lwStreamBeginCapture)
...
typedef enum LWdevice_attribute_enum {
    ...
    LW_DEVICE_ATTRIBUTE_CAN_FLUSH_REMOTE_WRITES = 98,           /**< Both the ::LW_STREAM_WAIT_VALUE_FLUSH flag and the ::LW_STREAM_MEM_OP_FLUSH_REMOTE_WRITES MemOp are supported on the device. See \ref LWDA_MEMOP for additional details. */
...
#endif /* __LWDA_API_VERSION >= 10000 */
...
typedef enum LWdevice_P2PAttribute_enum {
    ...
    LW_DEVICE_P2P_ATTRIBUTE_ARRAY_ACCESS_ACCESS_SUPPORTED        = 0x04,  /**< \deprecated use LW_DEVICE_P2P_ATTRIBUTE_LWDA_ARRAY_ACCESS_SUPPORTED instead */
...
typedef struct LWDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS_st {
    ...
    unsigned int flags;
    unsigned int reserved[16];
} LWDA_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS;
...
typedef struct LWDA_EXTERNAL_SEMAPHORE_WAIT_PARAMS_st {
    ...
    unsigned int flags;
    unsigned int reserved[16];
} LWDA_EXTERNAL_SEMAPHORE_WAIT_PARAMS;
...
#if defined(_WIN32) && __LWDA_API_VERSION >= 10000
/**
 ...
 * IPC functionality is not supported on CheetAh platforms.
 *
 ...
 * for the device attribute ::LW_DEVICE_ATTRIBUTE_HOST_REGISTER_SUPPORTED.
 *
 * The \p Flags parameter enables different options to be specified that
 * affect the allocation, as follows.
 *
 ...
 * mode. The capture mode may be queried via ::lwStreamIsCapturing.
 *
 ...
 * object.
 *
 * Frees all buffers and LWCA mipmapped arrays that were
 ...
 * ::LW_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE, then the
 ...
 *
 * If the semaphore object is of the type
 * ::LW_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE, then waiting on
 ...
 * ::lwGraphAddMemsetNode
 */
LWresult LWDAAPI lwGraphAddKernelNode(LWgraphNode *phGraphNode, LWgraph hGraph, LWgraphNode *dependencies, size_t numDependencies, const LWDA_KERNEL_NODE_PARAMS *nodeParams);
 ...
 * ::lwGraphAddMemsetNode
 */
LWresult LWDAAPI lwGraphAddMemcpyNode(LWgraphNode *phGraphNode, LWgraph hGraph, LWgraphNode *dependencies, size_t numDependencies, const LWDA_MEMCPY3D *copyParams, LWcontext ctx);
 ...
 * ::lwGraphAddMemcpyNode
 */
LWresult LWDAAPI lwGraphAddMemsetNode(LWgraphNode *phGraphNode, LWgraph hGraph, LWgraphNode *dependencies, size_t numDependencies, const LWDA_MEMSET_NODE_PARAMS *memsetParams, LWcontext ctx);
 ...
 * ::lwGraphAddMemsetNode
 */
LWresult LWDAAPI lwGraphAddHostNode(LWgraphNode *phGraphNode, LWgraph hGraph, LWgraphNode *dependencies, size_t numDependencies, const LWDA_HOST_NODE_PARAMS *nodeParams);
 ...
 * ::lwGraphClone
 */
LWresult LWDAAPI lwGraphAddChildGraphNode(LWgraphNode *phGraphNode, LWgraph hGraph, LWgraphNode *dependencies, size_t numDependencies, LWgraph childGraph);
 ...
 * ::lwGraphAddMemsetNode
 */
LWresult LWDAAPI lwGraphAddEmptyNode(LWgraphNode *phGraphNode, LWgraph hGraph, LWgraphNode *dependencies, size_t numDependencies);
 ...
 * ::lwGraphNodeGetDependentNodes
 */
LWresult LWDAAPI lwGraphAddDependencies(LWgraph hGraph, LWgraphNode *from, LWgraphNode *to, size_t numDependencies);
 ...
 * ::lwGraphNodeGetDependentNodes
 */
LWresult LWDAAPI lwGraphRemoveDependencies(LWgraph hGraph, LWgraphNode *from, LWgraphNode *to, size_t numDependencies);
