...
__DEVICE_FUNCTIONS_STATIC_DECL__ int float2int(float a, enum lwdaRoundMode mode = lwdaRoundZero);

__DEVICE_FUNCTIONS_STATIC_DECL__ unsigned int float2uint(float a, enum lwdaRoundMode mode = lwdaRoundZero);

__DEVICE_FUNCTIONS_STATIC_DECL__ float int2float(int a, enum lwdaRoundMode mode = lwdaRoundNearest);

__DEVICE_FUNCTIONS_STATIC_DECL__ float uint2float(unsigned int a, enum lwdaRoundMode mode = lwdaRoundNearest);
