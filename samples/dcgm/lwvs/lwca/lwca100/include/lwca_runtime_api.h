...
#include "lwda_device_runtime_api.h"
    ...
    #define lwdaSignalExternalSemaphoresAsync  __LWDART_API_PTSZ(lwdaSignalExternalSemaphoresAsync)
    #define lwdaWaitExternalSemaphoresAsync    __LWDART_API_PTSZ(lwdaWaitExternalSemaphoresAsync)
#endif
 ...
 * \sa ::lwdaDeviceReset
 */
extern __LWDA_DEPRECATED __host__ lwdaError_t LWDARTAPI lwdaThreadExit(void);
 ...
 * \sa ::lwdaDeviceSynchronize
 */
extern __LWDA_DEPRECATED __host__ lwdaError_t LWDARTAPI lwdaThreadSynchronize(void);
 ...
 *   system call, otherwise ::lwdaErrorIlwalidValue will be returned.
 *
 ...
 */
extern __LWDA_DEPRECATED __host__ lwdaError_t LWDARTAPI lwdaThreadSetLimit(enum lwdaLimit limit, size_t value);
 ...
 */
extern __LWDA_DEPRECATED __host__ lwdaError_t LWDARTAPI lwdaThreadGetLimit(size_t *pValue, enum lwdaLimit limit);
 ...
 * \sa ::lwdaDeviceGetCacheConfig
 */
extern __LWDA_DEPRECATED __host__ lwdaError_t LWDARTAPI lwdaThreadGetCacheConfig(enum lwdaFuncCache *pCacheConfig);
 ...
 * \sa ::lwdaDeviceSetCacheConfig
 */
extern __LWDA_DEPRECATED __host__ lwdaError_t LWDARTAPI lwdaThreadSetCacheConfig(enum lwdaFuncCache cacheConfig);
 ...
 * mode. The capture mode may be queried via ::lwdaStreamIsCapturing.
 *
 ...
 */
extern __host__ lwdaError_t LWDARTAPI lwdaStreamBeginCapture(lwdaStream_t stream);
 ...
 * object.
 *
 * Frees all buffers, LWCA arrays and LWCA mipmapped arrays that were
 ...
 * ::lwdaExternalSemaphoreHandleTypeD3D12Fence, then the
 ...
 *
 * If the semaphore object is of the type
 * ::lwdaExternalSemaphoreHandleTypeD3D12Fence, then waiting on
 ...
 * \ref ::lwdaSetupArgument(const void*, size_t, size_t) "lwdaSetupArgument (C API)"
 */
extern __LWDA_DEPRECATED __host__ lwdaError_t LWDARTAPI lwdaSetDoubleForDevice(double *d);
 ...
 * \ref ::lwdaSetupArgument(const void*, size_t, size_t) "lwdaSetupArgument (C API)"
 */
extern __LWDA_DEPRECATED  __host__ lwdaError_t LWDARTAPI lwdaSetDoubleForHost(double *d);
 ...
 *
 * - \ref ::lwdaPointerAttributes::memoryType identifies the
 ...
 *   and managed memory. It has been deprecated in favour of ::lwdaPointerAttributes::type.
 *
 ...
 *   in favour of ::lwdaPointerAttributes::type.
 *
 ...
 * ::lwdaGraphAddMemsetNode
 */
extern __host__ lwdaError_t LWDARTAPI lwdaGraphAddKernelNode(lwdaGraphNode_t *pGraphNode, lwdaGraph_t graph, lwdaGraphNode_t *pDependencies, size_t numDependencies, const struct lwdaKernelNodeParams *pNodeParams);
 ...
 * ::lwdaGraphAddMemsetNode
 */
extern __host__ lwdaError_t LWDARTAPI lwdaGraphAddMemcpyNode(lwdaGraphNode_t *pGraphNode, lwdaGraph_t graph, lwdaGraphNode_t *pDependencies, size_t numDependencies, const struct lwdaMemcpy3DParms *pCopyParams);
 ...
 * ::lwdaGraphAddMemcpyNode
 */
extern __host__ lwdaError_t LWDARTAPI lwdaGraphAddMemsetNode(lwdaGraphNode_t *pGraphNode, lwdaGraph_t graph, lwdaGraphNode_t *pDependencies, size_t numDependencies, const struct lwdaMemsetParams *pMemsetParams);
 ...
 * ::lwdaGraphAddMemsetNode
 */
extern __host__ lwdaError_t LWDARTAPI lwdaGraphAddHostNode(lwdaGraphNode_t *pGraphNode, lwdaGraph_t graph, lwdaGraphNode_t *pDependencies, size_t numDependencies, const struct lwdaHostNodeParams *pNodeParams);
 ...
 * ::lwdaGraphClone
 */
extern __host__ lwdaError_t LWDARTAPI lwdaGraphAddChildGraphNode(lwdaGraphNode_t *pGraphNode, lwdaGraph_t graph, lwdaGraphNode_t *pDependencies, size_t numDependencies, lwdaGraph_t childGraph);
 ...
 * ::lwdaGraphAddMemsetNode
 */
extern __host__ lwdaError_t LWDARTAPI lwdaGraphAddEmptyNode(lwdaGraphNode_t *pGraphNode, lwdaGraph_t graph, lwdaGraphNode_t *pDependencies, size_t numDependencies);
 ...
 * ::lwdaGraphNodeGetDependentNodes
 */
extern __host__ lwdaError_t LWDARTAPI lwdaGraphAddDependencies(lwdaGraph_t graph, lwdaGraphNode_t *from, lwdaGraphNode_t *to, size_t numDependencies);
 ...
 * ::lwdaGraphNodeGetDependentNodes
 */
extern __host__ lwdaError_t LWDARTAPI lwdaGraphRemoveDependencies(lwdaGraph_t graph, lwdaGraphNode_t *from, lwdaGraphNode_t *to, size_t numDependencies);
