  ...
  * Users Notice. 
  */ 
#ifndef LW_NPPIDEFS_H
#define LW_NPPIDEFS_H
...
#endif /* !__LWDACC__ && _WIN32 && !_WIN64 */
...
typedef enum 
{
    ...
    NPPI_INTER_LWBIC             = 4,        /**<  Cubic interpolation. */
    NPPI_INTER_LWBIC2P_BSPLINE,              /**<  Two-parameter cubic filter (B=1, C=0) */
    NPPI_INTER_LWBIC2P_CATMULLROM,           /**<  Two-parameter cubic filter (B=0, C=1/2) */
    NPPI_INTER_LWBIC2P_B05C03,               /**<  Two-parameter cubic filter (B=1/2, C=3/10) */
...
typedef enum 
{
    ...
    NPP_ILWALID_HOST_POINTER_ERROR          = -1032,
    NPP_ILWALID_DEVICE_POINTER_ERROR        = -1031,
    ...
    NPP_LWDA_KERNEL_EXELWTION_ERROR         = -1000,
    ...
    NPP_QUADRANGLE_ERROR                    = -58,      /**< The quadrangle is noncolwex or degenerates into triangle, line or point */
    ...
    NPP_DIVIDE_BY_ZERO_WARNING              = 6,        /**<  Divisor is zero however does not terminate the exelwtion */
...
typedef enum
{
    NPP_LWDA_UNKNOWN_VERSION = -1,  /**<  Indicates that the compute-capability query failed */
    NPP_LWDA_NOT_CAPABLE     = 0,   /**<  Indicates that no LWCA capable device was found */
    NPP_LWDA_1_0             = 100, /**<  Indicates that LWCA 1.0 capable device is machine's default device */
    NPP_LWDA_1_1             = 110, /**<  Indicates that LWCA 1.1 capable device is machine's default device */
    NPP_LWDA_1_2             = 120, /**<  Indicates that LWCA 1.2 capable device is machine's default device */
    NPP_LWDA_1_3             = 130, /**<  Indicates that LWCA 1.3 capable device is machine's default device */
    NPP_LWDA_2_0             = 200, /**<  Indicates that LWCA 2.0 capable device is machine's default device */
    NPP_LWDA_2_1             = 210, /**<  Indicates that LWCA 2.1 capable device is machine's default device */
    NPP_LWDA_3_0             = 300, /**<  Indicates that LWCA 3.0 capable device is machine's default device */
    NPP_LWDA_3_2             = 320, /**<  Indicates that LWCA 3.2 capable device is machine's default device */
    NPP_LWDA_3_5             = 350, /**<  Indicates that LWCA 3.5 capable device is machine's default device */
    NPP_LWDA_3_7             = 370, /**<  Indicates that LWCA 3.7 capable device is machine's default device */
    NPP_LWDA_5_0             = 500, /**<  Indicates that LWCA 5.0 capable device is machine's default device */
    NPP_LWDA_5_2             = 520, /**<  Indicates that LWCA 5.2 capable device is machine's default device */
    NPP_LWDA_5_3             = 530, /**<  Indicates that LWCA 5.3 capable device is machine's default device */
    NPP_LWDA_6_0             = 600, /**<  Indicates that LWCA 6.0 capable device is machine's default device */
    NPP_LWDA_6_1             = 610, /**<  Indicates that LWCA 6.1 capable device is machine's default device */
    NPP_LWDA_6_2             = 620, /**<  Indicates that LWCA 6.2 capable device is machine's default device */
    NPP_LWDA_6_3             = 630, /**<  Indicates that LWCA 6.3 capable device is machine's default device */
    NPP_LWDA_7_0             = 700, /**<  Indicates that LWCA 7.0 capable device is machine's default device */
    NPP_LWDA_7_2             = 720, /**<  Indicates that LWCA 7.2 capable device is machine's default device */
    NPP_LWDA_7_3             = 730, /**<  Indicates that LWCA 7.3 capable device is machine's default device */
    NPP_LWDA_7_5             = 750  /**<  Indicates that LWCA 7.5 or better is machine's default device */
 ...
 * to allow the user to specify the method by which fractional values are colwerted
 ...
 * based on the naming colwentions for rounding modes set forth in the IEEE-754
