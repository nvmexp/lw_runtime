...
typedef enum {
    ...
    LWBLAS_GEMM_ALGO18              =  18, //sliced 32x32    
    LWBLAS_GEMM_ALGO19              =  19, //sliced 64x32     
    LWBLAS_GEMM_ALGO20              =  20, //sliced 128x32     
    LWBLAS_GEMM_ALGO21              =  21, //sliced 32x32  -splitK      
    LWBLAS_GEMM_ALGO22              =  22, //sliced 64x32  -splitK      
    LWBLAS_GEMM_ALGO23              =  23, //sliced 128x32 -splitK      
    ...
    LWBLAS_GEMM_ALGO5_TENSOR_OP     =  105,        
    LWBLAS_GEMM_ALGO6_TENSOR_OP     =  106,        
    LWBLAS_GEMM_ALGO7_TENSOR_OP     =  107,        
    LWBLAS_GEMM_ALGO8_TENSOR_OP     =  108,        
    LWBLAS_GEMM_ALGO9_TENSOR_OP     =  109,        
    LWBLAS_GEMM_ALGO10_TENSOR_OP     =  110,        
    LWBLAS_GEMM_ALGO11_TENSOR_OP     =  111,        
    LWBLAS_GEMM_ALGO12_TENSOR_OP     =  112,        
    LWBLAS_GEMM_ALGO13_TENSOR_OP     =  113,        
    LWBLAS_GEMM_ALGO14_TENSOR_OP     =  114,        
    LWBLAS_GEMM_ALGO15_TENSOR_OP     =  115        
} lwblasGemmAlgo_t;
...
/* Lwblas logging */
typedef void (*lwblasLogCallback)(const char *msg);

LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasLoggerConfigure(int logIsOn, int logToStdOut, int logToStdErr, const char* logFileName);
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasSetLoggerCallback(lwblasLogCallback userCallback);
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasGetLoggerCallback(lwblasLogCallback* userCallback);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasCgemmBatched (lwblasHandle_t handle,
                                                          ...
                                                          int k,
                                                          const lwComplex *alpha, /* host or device pointer */ 
                                                          const lwComplex *const Aarray[], 
                                                          int lda,
                                                          const lwComplex *const Barray[],
                                                          int ldb, 
                                                          const lwComplex *beta, /* host or device pointer */ 
                                                          lwComplex *const Carray[],
                                                          int ldc,
                                                          int batchCount);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasZgemmBatched (lwblasHandle_t handle,
                                                          ...
                                                          int k,
                                                          const lwDoubleComplex *alpha, /* host or device pointer */ 
                                                          const lwDoubleComplex *const Aarray[], 
                                                          int lda,
                                                          const lwDoubleComplex *const Barray[],
                                                          int ldb, 
                                                          const lwDoubleComplex *beta, /* host or device pointer */ 
                                                          lwDoubleComplex *const Carray[],
                                                          int ldc,
                                                          int batchCount);

LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasGemmBatchedEx  (lwblasHandle_t handle, 
                                                      lwblasOperation_t transa,
                                                      lwblasOperation_t transb, 
                                                      int m,
                                                      int n,
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasGemmStridedBatchedEx (lwblasHandle_t handle,
                                                                 lwblasOperation_t transa,
                                                                 lwblasOperation_t transb, 
                                                                 int m,
                                                                 int n,
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasCgetrfBatched(lwblasHandle_t handle,
                                                  int n, 
                                                  lwComplex *const A[],           /*Device pointer*/
                                                  int lda, 
                                                  int *P,                         /*Device Pointer*/
                                                  int *info,                      /*Device Pointer*/
                                                  int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasZgetrfBatched(lwblasHandle_t handle,
                                                  int n, 
                                                  lwDoubleComplex *const A[],     /*Device pointer*/
                                                  int lda, 
                                                  int *P,                         /*Device Pointer*/
                                                  int *info,                      /*Device Pointer*/
                                                  int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasCgetriBatched(lwblasHandle_t handle,
                                                  int n,
                                                  const lwComplex *const A[],     /*Device pointer*/
                                                  int lda,
                                                  const int *P,                   /*Device pointer*/
                                                  lwComplex *const C[],           /*Device pointer*/
                                                  int ldc,
                                                  int *info,
                                                  int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasZgetriBatched(lwblasHandle_t handle,
                                                  int n,
                                                  const lwDoubleComplex *const A[], /*Device pointer*/
                                                  int lda,
                                                  const int *P,                     /*Device pointer*/
                                                  lwDoubleComplex *const C[],       /*Device pointer*/
                                                  int ldc,
                                                  int *info,
                                                  int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasZtrsmBatched( lwblasHandle_t    handle, 
                                                          ...
                                                          int n, 
                                                          const lwDoubleComplex *alpha, /*Host or Device Pointer*/
                                                          const lwDoubleComplex *const A[], 
                                                          int lda,
                                                          lwDoubleComplex *const B[], 
                                                          int ldb,
                                                          int batchCount);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasSmatilwBatched(lwblasHandle_t handle,
                                                          ...
                                                          const float *const A[],      /*Device pointer*/
                                                          int lda, 
                                                          float *const Ailw[],         /*Device pointer*/
                                                          int lda_ilw, 
                                                          int *info,                   /*Device Pointer*/
                                                          int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasDmatilwBatched(lwblasHandle_t handle,
                                                          ...
                                                          const double *const A[],     /*Device pointer*/
                                                          int lda, 
                                                          double *const Ailw[],        /*Device pointer*/
                                                          int lda_ilw, 
                                                          int *info,                   /*Device Pointer*/
                                                          int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasCmatilwBatched(lwblasHandle_t handle,
                                                          ...
                                                          const lwComplex *const A[],  /*Device pointer*/
                                                          int lda, 
                                                          lwComplex *const Ailw[],     /*Device pointer*/
                                                          int lda_ilw, 
                                                          int *info,                   /*Device Pointer*/
                                                          int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI lwblasZmatilwBatched(lwblasHandle_t handle,
                                                          ...
                                                          const lwDoubleComplex *const A[], /*Device pointer*/
                                                          int lda, 
                                                          lwDoubleComplex *const Ailw[],    /*Device pointer*/
                                                          int lda_ilw, 
                                                          int *info,                        /*Device Pointer*/
                                                          int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI  lwblasCgeqrfBatched( lwblasHandle_t handle, 
                                                            int m, 
                                                            int n,
                                                            lwComplex *const Aarray[],          /*Device pointer*/
                                                            int lda, 
                                                            lwComplex *const TauArray[],        /*Device pointer*/                                                            
                                                            int *info,
                                                            int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI  lwblasZgeqrfBatched( lwblasHandle_t handle, 
                                                            int m, 
                                                            int n,
                                                            lwDoubleComplex *const Aarray[],    /*Device pointer*/
                                                            int lda,
                                                            lwDoubleComplex *const TauArray[],  /*Device pointer*/
                                                            int *info,
                                                            int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI  lwblasCgelsBatched( lwblasHandle_t handle,
                                                           ...
                                                           lwComplex *const Aarray[],  /*Device pointer*/
                                                           int lda,
                                                           lwComplex *const Carray[],  /*Device pointer*/
                                                           int ldc,
                                                           int *info,
                                                           int *devInfoArray,
                                                           int batchSize);
...
LWBLASAPI lwblasStatus_t LWBLASWINAPI  lwblasZgelsBatched( lwblasHandle_t handle,
                                                           ...
                                                           lwDoubleComplex *const Aarray[],  /*Device pointer*/
                                                           int lda,
                                                           lwDoubleComplex *const Carray[],  /*Device pointer*/
                                                           int ldc,
                                                           int *info,
                                                           int *devInfoArray,
                                                           int batchSize);
