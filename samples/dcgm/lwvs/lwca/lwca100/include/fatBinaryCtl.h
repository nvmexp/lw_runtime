 ...
 *
 * Copyright (c) 2010-2016, LWPU CORPORATION.  All rights reserved.
 *
...
#ifndef __LWDA_INTERNAL_COMPILATION__
...
#define FBCTL_SET_TARGETSM      2  /* int (use values from lwelf.h) */
...
#define FATBIN_DATA_SECTION_NAME        "__lw_fatbin"
/* only need segment name for mach-o */
#define FATBIN_SEGMENT_NAME             "__LW_LWDA"
#else
#define FATBIN_CONTROL_SECTION_NAME     ".lwFatBinSegment"
/*
 * The section that contains the fatbin data itself
 * (put in separate section so easy to find)
 */
#define FATBIN_DATA_SECTION_NAME        ".lw_fatbin"
#endif
/* section for pre-linked relocatable fatbin data */
#define FATBIN_PRELINK_DATA_SECTION_NAME "__lw_relfatbin"
