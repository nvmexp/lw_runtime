...
#include "EGL/eglext.h"
    ...
    #endif
#else
    #define __LWDA_API_VERSION 10000
 ...
 * \endcode
 *
 * For ::LWeglFrame frame of type ::LW_EGL_FRAME_TYPE_PITCH, the pitched pointer passed in ::LWeglFrame
 * must point to the start address of the memory allocated through ::lwMemAlloc or acquired from another
