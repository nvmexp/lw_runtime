...
namespace YAML
{
	...
	public:
		...
		EMITTER_STATE GetLwrState() const { return m_stateStack.top(); }
		...
		GROUP_TYPE GetLwrGroupType() const;
		FLOW_TYPE GetLwrGroupFlowType() const;
		int GetLwrIndent() const { return m_lwrIndent; }
		
		bool LwrrentlyInLongKey();
		void StartLongKey();
		void StartSimpleKey();
