...
namespace YAML
{
	...
	namespace ErrorMsg
	{
		...
		const char * const ILWALID_HEX            = "bad character found while scanning hex number";
		const char * const ILWALID_UNICODE        = "invalid unicode: ";
		const char * const ILWALID_ESCAPE         = "unknown escape character: ";
		...
		const char * const ILWALID_SCALAR         = "invalid scalar";
		...
		const char * const ILWALID_ANCHOR         = "invalid anchor";
		const char * const ILWALID_ALIAS          = "invalid alias";
		const char * const ILWALID_TAG            = "invalid tag";
	...
	class IlwalidScalar: public RepresentationException {
	public:
		IlwalidScalar(const Mark& mark_)
			: RepresentationException(mark_, ErrorMsg::ILWALID_SCALAR) {}
	};
