...
_FACTORY2MESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cirlwlar_message', full_name='google.protobuf.python.internal.Factory2Message.cirlwlar_message', index=8,
...
_FACTORY2MESSAGE.fields_by_name['cirlwlar_message'].message_type = _FACTORY2MESSAGE
