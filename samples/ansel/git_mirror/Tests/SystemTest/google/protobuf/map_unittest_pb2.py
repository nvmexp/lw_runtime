...
_TESTRELWRSIVEMAPMESSAGE_AENTRY = _descriptor.Descriptor(
  name='AEntry',
  full_name='protobuf_unittest.TestRelwrsiveMapMessage.AEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='protobuf_unittest.TestRelwrsiveMapMessage.AEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='protobuf_unittest.TestRelwrsiveMapMessage.AEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TESTRELWRSIVEMAPMESSAGE = _descriptor.Descriptor(
  name='TestRelwrsiveMapMessage',
  full_name='protobuf_unittest.TestRelwrsiveMapMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='a', full_name='protobuf_unittest.TestRelwrsiveMapMessage.a', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_TESTRELWRSIVEMAPMESSAGE_AENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_TESTRELWRSIVEMAPMESSAGE_AENTRY.fields_by_name['value'].message_type = _TESTRELWRSIVEMAPMESSAGE
_TESTRELWRSIVEMAPMESSAGE_AENTRY.containing_type = _TESTRELWRSIVEMAPMESSAGE
_TESTRELWRSIVEMAPMESSAGE.fields_by_name['a'].message_type = _TESTRELWRSIVEMAPMESSAGE_AENTRY
...
DESCRIPTOR.message_types_by_name['TestRelwrsiveMapMessage'] = _TESTRELWRSIVEMAPMESSAGE
...
TestRelwrsiveMapMessage = _reflection.GeneratedProtocolMessageType('TestRelwrsiveMapMessage', (_message.Message,), dict(

  AEntry = _reflection.GeneratedProtocolMessageType('AEntry', (_message.Message,), dict(
    DESCRIPTOR = _TESTRELWRSIVEMAPMESSAGE_AENTRY,
    __module__ = 'google.protobuf.map_unittest_pb2'
    # @@protoc_insertion_point(class_scope:protobuf_unittest.TestRelwrsiveMapMessage.AEntry)
    ))
  ,
  DESCRIPTOR = _TESTRELWRSIVEMAPMESSAGE,
  __module__ = 'google.protobuf.map_unittest_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.TestRelwrsiveMapMessage)
  ))
_sym_db.RegisterMessage(TestRelwrsiveMapMessage)
_sym_db.RegisterMessage(TestRelwrsiveMapMessage.AEntry)
...
_TESTRELWRSIVEMAPMESSAGE_AENTRY.has_options = True
_TESTRELWRSIVEMAPMESSAGE_AENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
