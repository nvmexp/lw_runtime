...
_TESTRELWRSIVEMESSAGE = _descriptor.Descriptor(
  name='TestRelwrsiveMessage',
  full_name='protobuf_unittest.TestRelwrsiveMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='a', full_name='protobuf_unittest.TestRelwrsiveMessage.a', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='i', full_name='protobuf_unittest.TestRelwrsiveMessage.i', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TESTMUTUALRELWRSIONA_SUBMESSAGE = _descriptor.Descriptor(
  name='SubMessage',
  full_name='protobuf_unittest.TestMutualRelwrsionA.SubMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='b', full_name='protobuf_unittest.TestMutualRelwrsionA.SubMessage.b', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TESTMUTUALRELWRSIONA_SUBGROUP = _descriptor.Descriptor(
  name='SubGroup',
  full_name='protobuf_unittest.TestMutualRelwrsionA.SubGroup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sub_message', full_name='protobuf_unittest.TestMutualRelwrsionA.SubGroup.sub_message', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='not_in_this_scc', full_name='protobuf_unittest.TestMutualRelwrsionA.SubGroup.not_in_this_scc', index=1,
...
_TESTMUTUALRELWRSIONA = _descriptor.Descriptor(
  name='TestMutualRelwrsionA',
  full_name='protobuf_unittest.TestMutualRelwrsionA',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bb', full_name='protobuf_unittest.TestMutualRelwrsionA.bb', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subgroup', full_name='protobuf_unittest.TestMutualRelwrsionA.subgroup', index=1,
  ...
  nested_types=[_TESTMUTUALRELWRSIONA_SUBMESSAGE, _TESTMUTUALRELWRSIONA_SUBGROUP, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_TESTMUTUALRELWRSIONB = _descriptor.Descriptor(
  name='TestMutualRelwrsionB',
  full_name='protobuf_unittest.TestMutualRelwrsionB',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='a', full_name='protobuf_unittest.TestMutualRelwrsionB.a', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='optional_int32', full_name='protobuf_unittest.TestMutualRelwrsionB.optional_int32', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TESTRELWRSIVEMESSAGE.fields_by_name['a'].message_type = _TESTRELWRSIVEMESSAGE
_TESTMUTUALRELWRSIONA_SUBMESSAGE.fields_by_name['b'].message_type = _TESTMUTUALRELWRSIONB
_TESTMUTUALRELWRSIONA_SUBMESSAGE.containing_type = _TESTMUTUALRELWRSIONA
_TESTMUTUALRELWRSIONA_SUBGROUP.fields_by_name['sub_message'].message_type = _TESTMUTUALRELWRSIONA_SUBMESSAGE
_TESTMUTUALRELWRSIONA_SUBGROUP.fields_by_name['not_in_this_scc'].message_type = _TESTALLTYPES
_TESTMUTUALRELWRSIONA_SUBGROUP.containing_type = _TESTMUTUALRELWRSIONA
_TESTMUTUALRELWRSIONA.fields_by_name['bb'].message_type = _TESTMUTUALRELWRSIONB
_TESTMUTUALRELWRSIONA.fields_by_name['subgroup'].message_type = _TESTMUTUALRELWRSIONA_SUBGROUP
_TESTMUTUALRELWRSIONB.fields_by_name['a'].message_type = _TESTMUTUALRELWRSIONA
...
DESCRIPTOR.message_types_by_name['TestRelwrsiveMessage'] = _TESTRELWRSIVEMESSAGE
DESCRIPTOR.message_types_by_name['TestMutualRelwrsionA'] = _TESTMUTUALRELWRSIONA
DESCRIPTOR.message_types_by_name['TestMutualRelwrsionB'] = _TESTMUTUALRELWRSIONB
...
TestRelwrsiveMessage = _reflection.GeneratedProtocolMessageType('TestRelwrsiveMessage', (_message.Message,), dict(
  DESCRIPTOR = _TESTRELWRSIVEMESSAGE,
  __module__ = 'google.protobuf.unittest_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.TestRelwrsiveMessage)
  ))
_sym_db.RegisterMessage(TestRelwrsiveMessage)

TestMutualRelwrsionA = _reflection.GeneratedProtocolMessageType('TestMutualRelwrsionA', (_message.Message,), dict(

  SubMessage = _reflection.GeneratedProtocolMessageType('SubMessage', (_message.Message,), dict(
    DESCRIPTOR = _TESTMUTUALRELWRSIONA_SUBMESSAGE,
    __module__ = 'google.protobuf.unittest_pb2'
    # @@protoc_insertion_point(class_scope:protobuf_unittest.TestMutualRelwrsionA.SubMessage)
    ))
  ,

  SubGroup = _reflection.GeneratedProtocolMessageType('SubGroup', (_message.Message,), dict(
    DESCRIPTOR = _TESTMUTUALRELWRSIONA_SUBGROUP,
    __module__ = 'google.protobuf.unittest_pb2'
    # @@protoc_insertion_point(class_scope:protobuf_unittest.TestMutualRelwrsionA.SubGroup)
    ))
  ,
  DESCRIPTOR = _TESTMUTUALRELWRSIONA,
  __module__ = 'google.protobuf.unittest_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.TestMutualRelwrsionA)
  ))
_sym_db.RegisterMessage(TestMutualRelwrsionA)
_sym_db.RegisterMessage(TestMutualRelwrsionA.SubMessage)
_sym_db.RegisterMessage(TestMutualRelwrsionA.SubGroup)

TestMutualRelwrsionB = _reflection.GeneratedProtocolMessageType('TestMutualRelwrsionB', (_message.Message,), dict(
  DESCRIPTOR = _TESTMUTUALRELWRSIONB,
  __module__ = 'google.protobuf.unittest_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.TestMutualRelwrsionB)
  ))
_sym_db.RegisterMessage(TestMutualRelwrsionB)
