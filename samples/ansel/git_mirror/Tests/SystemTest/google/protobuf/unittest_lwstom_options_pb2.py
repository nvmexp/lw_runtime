...
# source: google/protobuf/unittest_lwstom_options.proto
...
_TESTMESSAGEWITHLWSTOMOPTIONS_ANENUM = _descriptor.EnumDescriptor(
  name='AnEnum',
  full_name='protobuf_unittest.TestMessageWithLwstomOptions.AnEnum',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_TESTMESSAGEWITHLWSTOMOPTIONS_ANENUM)
...
_TESTMESSAGEWITHLWSTOMOPTIONS = _descriptor.Descriptor(
  name='TestMessageWithLwstomOptions',
  full_name='protobuf_unittest.TestMessageWithLwstomOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='field1', full_name='protobuf_unittest.TestMessageWithLwstomOptions.field1', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='oneof_field', full_name='protobuf_unittest.TestMessageWithLwstomOptions.oneof_field', index=1,
  ...
  nested_types=[],
  enum_types=[
    _TESTMESSAGEWITHLWSTOMOPTIONS_ANENUM,
  ],
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='AnOneof', full_name='protobuf_unittest.TestMessageWithLwstomOptions.AnOneof',
...
_LWSTOMOPTIONFOOREQUEST = _descriptor.Descriptor(
  name='LwstomOptionFooRequest',
  full_name='protobuf_unittest.LwstomOptionFooRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LWSTOMOPTIONFOORESPONSE = _descriptor.Descriptor(
  name='LwstomOptionFooResponse',
  full_name='protobuf_unittest.LwstomOptionFooResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LWSTOMOPTIONFOOCLIENTMESSAGE = _descriptor.Descriptor(
  name='LwstomOptionFooClientMessage',
  full_name='protobuf_unittest.LwstomOptionFooClientMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LWSTOMOPTIONFOOSERVERMESSAGE = _descriptor.Descriptor(
  name='LwstomOptionFooServerMessage',
  full_name='protobuf_unittest.LwstomOptionFooServerMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_DUMMYMESSAGEILWALIDASOPTIONTYPE = _descriptor.Descriptor(
  name='DummyMessageIlwalidAsOptionType',
  full_name='protobuf_unittest.DummyMessageIlwalidAsOptionType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LWSTOMOPTIONMININTEGERVALUES = _descriptor.Descriptor(
  name='LwstomOptionMinIntegerValues',
  full_name='protobuf_unittest.LwstomOptionMinIntegerValues',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LWSTOMOPTIONMAXINTEGERVALUES = _descriptor.Descriptor(
  name='LwstomOptionMaxIntegerValues',
  full_name='protobuf_unittest.LwstomOptionMaxIntegerValues',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_LWSTOMOPTIONOTHERVALUES = _descriptor.Descriptor(
  name='LwstomOptionOtherValues',
  full_name='protobuf_unittest.LwstomOptionOtherValues',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_TESTMESSAGEWITHLWSTOMOPTIONS_ANENUM.containing_type = _TESTMESSAGEWITHLWSTOMOPTIONS
_TESTMESSAGEWITHLWSTOMOPTIONS.oneofs_by_name['AnOneof'].fields.append(
  _TESTMESSAGEWITHLWSTOMOPTIONS.fields_by_name['oneof_field'])
_TESTMESSAGEWITHLWSTOMOPTIONS.fields_by_name['oneof_field'].containing_oneof = _TESTMESSAGEWITHLWSTOMOPTIONS.oneofs_by_name['AnOneof']
...
DESCRIPTOR.message_types_by_name['TestMessageWithLwstomOptions'] = _TESTMESSAGEWITHLWSTOMOPTIONS
DESCRIPTOR.message_types_by_name['LwstomOptionFooRequest'] = _LWSTOMOPTIONFOOREQUEST
DESCRIPTOR.message_types_by_name['LwstomOptionFooResponse'] = _LWSTOMOPTIONFOORESPONSE
DESCRIPTOR.message_types_by_name['LwstomOptionFooClientMessage'] = _LWSTOMOPTIONFOOCLIENTMESSAGE
DESCRIPTOR.message_types_by_name['LwstomOptionFooServerMessage'] = _LWSTOMOPTIONFOOSERVERMESSAGE
DESCRIPTOR.message_types_by_name['DummyMessageContainingEnum'] = _DUMMYMESSAGECONTAININGENUM
DESCRIPTOR.message_types_by_name['DummyMessageIlwalidAsOptionType'] = _DUMMYMESSAGEILWALIDASOPTIONTYPE
DESCRIPTOR.message_types_by_name['LwstomOptionMinIntegerValues'] = _LWSTOMOPTIONMININTEGERVALUES
DESCRIPTOR.message_types_by_name['LwstomOptionMaxIntegerValues'] = _LWSTOMOPTIONMAXINTEGERVALUES
DESCRIPTOR.message_types_by_name['LwstomOptionOtherValues'] = _LWSTOMOPTIONOTHERVALUES
...
TestMessageWithLwstomOptions = _reflection.GeneratedProtocolMessageType('TestMessageWithLwstomOptions', (_message.Message,), dict(
  DESCRIPTOR = _TESTMESSAGEWITHLWSTOMOPTIONS,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.TestMessageWithLwstomOptions)
  ))
_sym_db.RegisterMessage(TestMessageWithLwstomOptions)

LwstomOptionFooRequest = _reflection.GeneratedProtocolMessageType('LwstomOptionFooRequest', (_message.Message,), dict(
  DESCRIPTOR = _LWSTOMOPTIONFOOREQUEST,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.LwstomOptionFooRequest)
  ))
_sym_db.RegisterMessage(LwstomOptionFooRequest)

LwstomOptionFooResponse = _reflection.GeneratedProtocolMessageType('LwstomOptionFooResponse', (_message.Message,), dict(
  DESCRIPTOR = _LWSTOMOPTIONFOORESPONSE,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.LwstomOptionFooResponse)
  ))
_sym_db.RegisterMessage(LwstomOptionFooResponse)

LwstomOptionFooClientMessage = _reflection.GeneratedProtocolMessageType('LwstomOptionFooClientMessage', (_message.Message,), dict(
  DESCRIPTOR = _LWSTOMOPTIONFOOCLIENTMESSAGE,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.LwstomOptionFooClientMessage)
  ))
_sym_db.RegisterMessage(LwstomOptionFooClientMessage)

LwstomOptionFooServerMessage = _reflection.GeneratedProtocolMessageType('LwstomOptionFooServerMessage', (_message.Message,), dict(
  DESCRIPTOR = _LWSTOMOPTIONFOOSERVERMESSAGE,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.LwstomOptionFooServerMessage)
  ))
_sym_db.RegisterMessage(LwstomOptionFooServerMessage)
...
DummyMessageIlwalidAsOptionType = _reflection.GeneratedProtocolMessageType('DummyMessageIlwalidAsOptionType', (_message.Message,), dict(
  DESCRIPTOR = _DUMMYMESSAGEILWALIDASOPTIONTYPE,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.DummyMessageIlwalidAsOptionType)
  ))
_sym_db.RegisterMessage(DummyMessageIlwalidAsOptionType)

LwstomOptionMinIntegerValues = _reflection.GeneratedProtocolMessageType('LwstomOptionMinIntegerValues', (_message.Message,), dict(
  DESCRIPTOR = _LWSTOMOPTIONMININTEGERVALUES,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.LwstomOptionMinIntegerValues)
  ))
_sym_db.RegisterMessage(LwstomOptionMinIntegerValues)

LwstomOptionMaxIntegerValues = _reflection.GeneratedProtocolMessageType('LwstomOptionMaxIntegerValues', (_message.Message,), dict(
  DESCRIPTOR = _LWSTOMOPTIONMAXINTEGERVALUES,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.LwstomOptionMaxIntegerValues)
  ))
_sym_db.RegisterMessage(LwstomOptionMaxIntegerValues)

LwstomOptionOtherValues = _reflection.GeneratedProtocolMessageType('LwstomOptionOtherValues', (_message.Message,), dict(
  DESCRIPTOR = _LWSTOMOPTIONOTHERVALUES,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  # @@protoc_insertion_point(class_scope:protobuf_unittest.LwstomOptionOtherValues)
  ))
_sym_db.RegisterMessage(LwstomOptionOtherValues)
...
message_type_opt.message_type = _DUMMYMESSAGEILWALIDASOPTIONTYPE
...
_TESTMESSAGEWITHLWSTOMOPTIONS.oneofs_by_name['AnOneof'].has_options = True
_TESTMESSAGEWITHLWSTOMOPTIONS.oneofs_by_name['AnOneof']._options = _descriptor._ParseOptions(descriptor_pb2.OneofOptions(), _b('\370\254\303\035\235\377\377\377\377\377\377\377\377\001'))
_TESTMESSAGEWITHLWSTOMOPTIONS_ANENUM.has_options = True
_TESTMESSAGEWITHLWSTOMOPTIONS_ANENUM._options = _descriptor._ParseOptions(descriptor_pb2.EnumOptions(), _b('\305\366\311\035\353\374\377\377'))
_TESTMESSAGEWITHLWSTOMOPTIONS_ANENUM.values_by_name["ANENUM_VAL2"].has_options = True
_TESTMESSAGEWITHLWSTOMOPTIONS_ANENUM.values_by_name["ANENUM_VAL2"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\260\206\372\005{'))
_TESTMESSAGEWITHLWSTOMOPTIONS.fields_by_name['field1'].has_options = True
_TESTMESSAGEWITHLWSTOMOPTIONS.fields_by_name['field1']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\010\001\301\340\303\035-\341u\n\002\000\000\000'))
_TESTMESSAGEWITHLWSTOMOPTIONS.has_options = True
_TESTMESSAGEWITHLWSTOMOPTIONS._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\010\000\340\351\302\035\310\377\377\377\377\377\377\377\377\001'))
_LWSTOMOPTIONMININTEGERVALUES.has_options = True
_LWSTOMOPTIONMININTEGERVALUES._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\320\336\262\035\000\350\306\262\035\200\200\200\200\370\377\377\377\377\001\260\274\262\035\200\200\200\200\200\200\200\200\200\001\200\223\262\035\000\370\365\260\035\000\200\304\260\035\377\377\377\377\017\370\227\260\035\377\377\377\377\377\377\377\377\377\001\235\365\257\035\000\000\000\000\221\356\257\035\000\000\000\000\000\000\000\000\255\215\257\035\000\000\000\200\231\326\250\035\000\000\000\000\000\000\000\200'))
_LWSTOMOPTIONMAXINTEGERVALUES.has_options = True
_LWSTOMOPTIONMAXINTEGERVALUES._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\320\336\262\035\001\350\306\262\035\377\377\377\377\007\260\274\262\035\377\377\377\377\377\377\377\377\177\200\223\262\035\377\377\377\377\017\370\365\260\035\377\377\377\377\377\377\377\377\377\001\200\304\260\035\376\377\377\377\017\370\227\260\035\376\377\377\377\377\377\377\377\377\001\235\365\257\035\377\377\377\377\221\356\257\035\377\377\377\377\377\377\377\377\255\215\257\035\377\377\377\177\231\326\250\035\377\377\377\377\377\377\377\177'))
_LWSTOMOPTIONOTHERVALUES.has_options = True
_LWSTOMOPTIONOTHERVALUES._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\350\306\262\035\234\377\377\377\377\377\377\377\377\001\365\337\243\035\347\207EA\351\334\242\035\373Y\214B\312\300\363?\252\334\242\035\016Hello, \"World\"\262\331\242\035\013Hello\000World\210\331\242\035\351\377\377\377\377\377\377\377\377\001'))
...
_TESTSERVICEWITHLWSTOMOPTIONS = _descriptor.ServiceDescriptor(
  name='TestServiceWithLwstomOptions',
  full_name='protobuf_unittest.TestServiceWithLwstomOptions',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Foo',
    full_name='protobuf_unittest.TestServiceWithLwstomOptions.Foo',
    index=0,
    containing_service=None,
    input_type=_LWSTOMOPTIONFOOREQUEST,
    output_type=_LWSTOMOPTIONFOORESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\340\372\214\036\002')),
  ),
])
_sym_db.RegisterServiceDescriptor(_TESTSERVICEWITHLWSTOMOPTIONS)

DESCRIPTOR.services_by_name['TestServiceWithLwstomOptions'] = _TESTSERVICEWITHLWSTOMOPTIONS
...
TestServiceWithLwstomOptions = service_reflection.GeneratedServiceType('TestServiceWithLwstomOptions', (_service.Service,), dict(
  DESCRIPTOR = _TESTSERVICEWITHLWSTOMOPTIONS,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  ))

TestServiceWithLwstomOptions_Stub = service_reflection.GeneratedServiceStubType('TestServiceWithLwstomOptions_Stub', (TestServiceWithLwstomOptions,), dict(
  DESCRIPTOR = _TESTSERVICEWITHLWSTOMOPTIONS,
  __module__ = 'google.protobuf.unittest_lwstom_options_pb2'
  ))
