...
_TESTLWSTOMJSONNAME = _descriptor.Descriptor(
  name='TestLwstomJsonName',
  full_name='proto3.TestLwstomJsonName',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='proto3.TestLwstomJsonName.value', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['TestLwstomJsonName'] = _TESTLWSTOMJSONNAME
...
TestLwstomJsonName = _reflection.GeneratedProtocolMessageType('TestLwstomJsonName', (_message.Message,), dict(
  DESCRIPTOR = _TESTLWSTOMJSONNAME,
  __module__ = 'google.protobuf.util.json_format_proto3_pb2'
  # @@protoc_insertion_point(class_scope:proto3.TestLwstomJsonName)
  ))
_sym_db.RegisterMessage(TestLwstomJsonName)
