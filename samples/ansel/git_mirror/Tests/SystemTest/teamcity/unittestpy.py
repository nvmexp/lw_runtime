...
from teamcity.common import is_string, get_class_fullname, colwert_error_to_string
...
class TeamcityTestResult(TestResult):
    ...
    def addExpectedFailure(self, test, err):
        ...
        err = colwert_error_to_string(err)
    ...
    def add_subtest_failure(self, test_id, subtest_id, err):
        ...
        fail_array.append("%s:\n%s" % (subtest_id, colwert_error_to_string(err)))
