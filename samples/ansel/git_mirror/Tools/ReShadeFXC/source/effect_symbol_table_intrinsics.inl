...
IMPLEMENT_INTRINSIC_SPIRV(abs, 0, {
    return add_instruction(spv::OpExtInst, colwert_type(res_type))
        .add(_glsl_ext)
...
IMPLEMENT_INTRINSIC_SPIRV(all, 1, {
    return add_instruction(spv::OpAll, colwert_type(res_type))
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(any, 1, {
    return add_instruction(spv::OpAny, colwert_type(res_type))
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(sincos, 0, {
    const spv::Id sin_result = add_instruction(spv::OpExtInst, colwert_type(args[0].type))
        .add(_glsl_ext)
        .add(spv::GLSLstd450Sin)
        .add(args[0].base)
        .result;
    const spv::Id cos_result = add_instruction(spv::OpExtInst, colwert_type(args[0].type))
        .add(_glsl_ext)
        .add(spv::GLSLstd450Cos)
        .add(args[0].base)
        .result;
...
IMPLEMENT_INTRINSIC_SPIRV(asint, 0, {
    return add_instruction(spv::OpBitcast, colwert_type(res_type))
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(rcp, 0, {
    ...
    return add_instruction(spv::OpFDiv, colwert_type(res_type))
        .add(constant_one)
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(log10, 0, {
    const spv::Id log2 = add_instruction(spv::OpExtInst, colwert_type(res_type))
        .add(_glsl_ext)
        .add(spv::GLSLstd450Log2)
        .add(args[0].base)
        .result;
...
IMPLEMENT_INTRINSIC_GLSL(rsqrt, 0, {
    code += "ilwersesqrt(" + id_to_name(args[0].base) + ')';
    })
...
IMPLEMENT_INTRINSIC_SPIRV(smoothstep, 0, {
    return add_instruction(spv::OpExtInst, colwert_type(args[2].type))
        .add(_glsl_ext)
...
IMPLEMENT_INTRINSIC_SPIRV(ddx, 0, {
    return add_instruction(spv::OpDPdx, colwert_type(res_type))
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(ddy, 0, {
    return add_instruction(spv::OpDPdy, colwert_type(res_type))
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(fwidth, 0, {
    return add_instruction(spv::OpFwidth, colwert_type(res_type))
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(dot, 0, {
    return add_instruction(spv::OpDot, colwert_type(res_type))
        .add(args[0].base)
        .add(args[1].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(transpose, 0, {
    return add_instruction(spv::OpTranspose, colwert_type(res_type))
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(mul, 0, {
    return add_instruction(spv::OpVectorTimesScalar, colwert_type(res_type))
        .add(args[1].base)
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(mul, 2, {
    return add_instruction(spv::OpMatrixTimesScalar, colwert_type(res_type))
        .add(args[1].base)
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(mul, 4, {
    return add_instruction(spv::OpMatrixTimesVector, colwert_type(res_type))
...
IMPLEMENT_INTRINSIC_SPIRV(mul, 5, {
    return add_instruction(spv::OpVectorTimesMatrix, colwert_type(res_type))
        .add(args[1].base)
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(mul, 6, {
    return add_instruction(spv::OpMatrixTimesMatrix, colwert_type(res_type))
        .add(args[1].base)
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(isinf, 0, {
    return add_instruction(spv::OpIsInf, colwert_type(res_type))
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(isnan, 0, {
    return add_instruction(spv::OpIsNan, colwert_type(res_type))
        .add(args[0].base)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(tex2D, 0, {
    return add_instruction(spv::OpImageSampleImplicitLod, colwert_type(res_type))
        .add(args[0].base)
        .add(args[1].base)
...
IMPLEMENT_INTRINSIC_SPIRV(tex2Dlod, 0, {
    const spv::Id xy = add_instruction(spv::OpVectorShuffle, colwert_type({ type::t_float, 2, 1 }))
        .add(args[1].base)
        .add(args[1].base)
        .add(0) // .x
        .add(1) // .y
        .result;
    const spv::Id lod = add_instruction(spv::OpCompositeExtract, colwert_type({ type::t_float, 1, 1 }))
        .add(args[1].base)
        .add(3) // .w
        .result;

    return add_instruction(spv::OpImageSampleExplicitLod, colwert_type(res_type))
        .add(args[0].base)
        .add(xy)
...
IMPLEMENT_INTRINSIC_SPIRV(tex2Dsize, 0, {
    ...
    const spv::Id image = add_instruction(spv::OpImage, colwert_type({ type::t_texture }))
        .add(args[0].base).result;
    const spv::Id level = emit_constant(0u);

    return add_instruction(spv::OpImageQuerySizeLod, colwert_type(res_type))
        .add(image)
        .add(level)
        .result;
    })
...
IMPLEMENT_INTRINSIC_SPIRV(tex2Dfetch, 0, {
    const spv::Id xy = add_instruction(spv::OpVectorShuffle, colwert_type({ type::t_int, 2, 1 }))
        .add(args[1].base)
        .add(args[1].base)
        .add(0) // .x
        .add(1) // .y
        .result;
    const spv::Id lod = add_instruction(spv::OpCompositeExtract, colwert_type({ type::t_int, 1, 1 }))
        .add(args[1].base)
        .add(3) // .w
        .result;
    ...
    return add_instruction(spv::OpImageFetch, colwert_type(res_type))
        .add(image)
        .add(xy)
        .add(spv::ImageOperandsLodMask)
        .add(lod)
...
IMPLEMENT_INTRINSIC_SPIRV(tex2Dgather, 0, {
    return add_instruction(spv::OpImageGather, colwert_type(res_type))
        .add(args[0].base)
        .add(args[1].base)
        .add(args[2].base)
        .add(spv::ImageOperandsMaskNone)
