...
namespace reshadefx
{
    ...
    public:
        ...
        {
            _input = lexer._input;
            _lwr_location = lexer._lwr_location;
            _lwr = _input.data() + (lexer._lwr - lexer._input.data());
    ...
    private:
        ...
        std::string _input;
        location _lwr_location;
        const std::string::value_type *_lwr, *_end;
