...
namespace reshadefx
{
    ...
    public:
        ...
        /// <param name="data">The actual constant data to colwert into a SSA ID.</param>
        ...
        /// <summary>
        /// Returns true if code is lwrrently added to a basic block.
        /// </summary>
        bool is_in_block() const { return _lwrrent_block != 0; }
        /// <summary>
        /// Returns true if code is lwrrently added to a function.
        /// </summary>
    ...
    /// <param name="uniforms_to_spec_constants">Whether to colwert uniform variables to specialization constants.</param>
    ...
    /// <param name="debug_info">Whether to append debug information like line directives to the generated code.</param>
    /// <param name="uniforms_to_spec_constants">Whether to colwert uniform variables to specialization constants.</param>
    /// <param name="ilwert_y">Insert code to ilwert the Y component of the output position in vertex shaders.</param>
    codegen *create_codegen_spirv(bool vulkan_semantics, bool debug_info, bool uniforms_to_spec_constants, bool ilwert_y = false);
}
