...
namespace ansel
{
    ...
    inline std::string GetBufferTypeName(BufferType bufferType)
    {
        switch (bufferType)
        {
        case kBufferTypeHDR: return "HDR";
        case kBufferTypeDepth: return "Depth";
        case kBufferTypeHUDless: return "HUDless";
        case kBufferTypeFinalColor: return "Final Color";
