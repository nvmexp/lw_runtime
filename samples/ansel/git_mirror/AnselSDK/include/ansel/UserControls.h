...
namespace ansel
{
    enum UserControlStatus
    {
        ...
        kUserControlIlwalidId,
        kUserControlIlwalidType,
        kUserControlIlwalidLabel,
        kUserControlNameTooLong,
        kUserControlIlwalidValue,
        kUserControlIlwalidLocale,
        kUserControlIlwalidCallback
    };
    ...
    //
    // The lifetime of value pointer is only limited to the UserControlCallback callback or addUserControl exelwtion
    //
