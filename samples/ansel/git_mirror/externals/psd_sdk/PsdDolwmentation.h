...
/// overview of each. Browsing individual modules will give a detailed description of its purpose, and dolwments all the
...
/// During that period, please feel free to ask questions, give feedback and report bugs by writing to evaluation@molelwlar-matters.com.
...
/// \defgroup Allocators
/// \brief Contains allocator interfaces and implementations that provide hooks for lwstomized memory management.


/// \defgroup Files
/// \brief Contains file interfaces and implementations that provide hooks for lwstomized file I/O.
...
/// \defgroup Util
/// \brief Colwenience classes and functions dealing with bit manipulation, endian colwersion, casts, etc.
