...
/// a call to \ref PSD_ASSERT will not generate any instructions, reducing the exelwtable's size and generally improving
...
/// \details This macro is a colwenience macro that asserts that a given pointer is not null, and uses the assertion
/// facility internally.
/// \remark Code generation is enabled/disabled via the preprocessor option \ref PSD_ENABLE_ASSERTIONS. If disabled,
/// a call to \ref PSD_ASSERT_NOT_NULL will not generate any instructions, reducing the exelwtable's size and generally
