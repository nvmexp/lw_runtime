...
/// a call to \ref PSD_WARNING will not generate any instructions, reducing the exelwtable's size and generally improving
...
/// \remark Code generation is enabled/disabled via the preprocessor option \ref PSD_ENABLE_LOGGING. If disabled,
/// a call to \ref PSD_ERROR will not generate any instructions, reducing the exelwtable's size and generally improving
/// performance. It is recommended to disable logging in retail builds.
