...
#define ANSEL_CONTROL_SDK_PRODUCT_VERSION_MAJOR 1
#define ANSEL_CONTROL_SDK_PRODUCT_VERSION_MINOR 0
#define ANSEL_CONTROL_SDK_MINIMUM_DRIVER_VERSION "387.00"
...
#define ANSEL_CONTROL_SDK_BUILD_NUMBER 0
#define ANSEL_CONTROL_SDK_COMMIT_HASH 0xdeadbeef

#define ANSEL_CONTROL_SDK_VERSION ( uint64_t(ANSEL_CONTROL_SDK_PRODUCT_VERSION_MAJOR) << 48 | uint64_t(ANSEL_CONTROL_SDK_PRODUCT_VERSION_MINOR) << 32 \
                           | ANSEL_CONTROL_SDK_COMMIT_HASH )
