...
// Colwerts a DWrite text layout to vertices
class CFW1TextRenderer : public CFW1Object<IFW1TextRenderer> {
    ...
    private:
        ...
        HRESULT GetLwrrentTransform(void *clientDrawingContext, DWRITE_MATRIX *transform);
    ...
    private:
        class CDWriteTextRendererProxy : public IDWriteTextRenderer {
            public:
                ...
                virtual HRESULT STDMETHODCALLTYPE GetLwrrentTransform(void *clientDrawingContext, DWRITE_MATRIX *transform) {
                    return m_realObject->GetLwrrentTransform(clientDrawingContext, transform);
                }
