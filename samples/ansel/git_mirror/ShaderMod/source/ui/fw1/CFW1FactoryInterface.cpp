...
HRESULT STDMETHODCALLTYPE CFW1Factory::CreateFontWrapper(
    ...
    createParams.DefaultFontParams.FontWeight = isBold ? DWRITE_FONT_WEIGHT_BOLD : DWRITE_FONT_WEIGHT_NORMAL;
    ...
    return CreateFontWrapper(pDevice, NULL, &createParams, ppFontWrapper, d3dCreateBlob);
}
