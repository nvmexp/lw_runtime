...
struct FW1_GLYPHSHEETDESC {
    /// <summary>The number of glyphs lwrrently stored in this sheet.</summary>
    UINT GlyphCount;
...
/// <remarks>When an IFW1TextRenderer draws a string, each output glyph is colwerted to an FW1_GLYPHVERTEX entry in an IFW1TextGeometry object.</remarks>
...
MIDL_INTERFACE("F8360043-329D-4EC9-B0F8-ACB00FA77420") IFW1GlyphProvider : public IFW1Object {
    ...
    /// <remarks>If FW1_NONEWGLYPHS is not specified, any glyph not lwrrently in the atlas will be inserted before the method returns.</remarks>
...
MIDL_INTERFACE("51E05736-6AFF-44A8-9745-77605C99E8F2") IFW1TextGeometry : public IFW1Object {
    /// <summary>Clear any vertices lwrrently contained in the geometry object.</summary>
...
/// <summary>A text-renderer colwerts DirectWrite text layouts into glyph-vertices.</summary>
/// <remarks></remarks>
MIDL_INTERFACE("51E05736-6AFF-44A8-9745-77605C99E8F2") IFW1TextRenderer : public IFW1Object {
    ...
    /// <summary>Colwert a text layout to vertices.</summary>
    /// <remarks>This method internally calls the IDWriteTextLayout::Draw method, and handles callbacks to colwert the formatted text into vertices, which will be stored in the passed IFW1TextGeometry object.
    /// This method is not thread-safe.</remarks>
    /// <returns>Standard HRESULT error code.</returns>
...
MIDL_INTERFACE("E6CD7A32-5B59-463c-9B1B-D44074FF655B") IFW1GlyphVertexDrawer : public IFW1Object {
    ...
    /// <param name="Flags">Can include zero or more of the following values, ORd together. Any additional values are ignored.<br/>
    /// FW1_NOGEOMETRYSHADER - Vertices are colwerted to quads on the fly on the CPU, instead of being sent directly to the device for the geometry shader.<br/>
...
/// It holds references to all objects needed to format and colwert text to vertices, as well as the D3D11 states and buffers needed to draw them.</summary>
...
MIDL_INTERFACE("8004DB2B-B5F9-4420-A6A2-E17E15E4C336") IFW1Factory : public IUnknown {
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE CreateFontWrapper(
            ...
            __inout FW1FontWrapper::PFND3DCREATEBLOBFUNC d3dCreateBlob
        ) = 0;
        ...
        static void initDWrite();
        static void deinitDWrite();
};
