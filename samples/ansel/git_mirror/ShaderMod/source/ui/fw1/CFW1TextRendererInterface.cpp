...
// IDWritePixelSnapping method
HRESULT CFW1TextRenderer::GetLwrrentTransform(
    void *clientDrawingContext,
...
// Colwert a run of glyphs to vertices
HRESULT CFW1TextRenderer::DrawGlyphRun(
    ...
    const UINT flags = m_lwrrentFlags;
    ...
    if((flags & FW1_CACHEONLY) != 0) {
        ...
        glyphVertex.GlyphColor = m_lwrrentColor;
...
HRESULT STDMETHODCALLTYPE CFW1TextRenderer::DrawTextLayout(
    ...
    m_lwrrentFlags = Flags;
    m_lwrrentColor = Color;
