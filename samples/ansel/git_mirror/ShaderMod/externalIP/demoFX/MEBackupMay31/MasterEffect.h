...
#define USE_ANSELCOLOR			1	//[0 or 1] Ansel Color Enhancer 
#define USE_ANSELSKETCH			1	//[0 or 1] Ansel Sketch Filter
...
#define USE_COLORMOD			1	//[0 or 1] Colormod: Contrast, Saturation and Brightness ported from colormod.asi.
...
#define USE_HEATHAZE 			0	//[0 or 1] Heat Haze: Colwection in heated air causes the temperature of the air to vary and causes a shimmery effect that distorts whatever is behind.
#define USE_LED_SHADER			0	//[0 or 1] LED: Simulates the look of a LED panel.

//OVERLAYS
#define USE_HD6_VIGNETTE		1	//[0 or 1] HeliosDoubleSix Vignette: Adds some advanced vignette (darkening shader) to lead focus to screen center
