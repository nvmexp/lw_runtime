...
DP3R R5.w, R1, R1;
MOVR R0.yzw, f[TEX3].wxyz;
LG2R R0.x, |R5.w|;
MULR R0.x, R0, C0.w;
EX2R R5.w, R0.x;
MULR R6.xyz, R5.w, R0.yzwy;
MADR R2.xy, R3, C1, R2;
MOVR R0, f[TEX0];
DP4R R0.x, R0, C1;
DP4R R4.w, R2, C1;
...
DP3R R2.w, R3, R6;
MADR_SAT R2.w, -R2, C0.y, C0.z;
TXP R0, R0, TEX2, 2D;
ADDR R0.xyz, R0, -R2;
MADR R2.xyz, R0, R0.w, R2;
MOVR R0.w, C0.z;
MADR R2.xyz, R2, C0.w, -R5;
MADR R0.xyz, R2, R2.w, R5;
MOVR o[COLR], R0; 
END
