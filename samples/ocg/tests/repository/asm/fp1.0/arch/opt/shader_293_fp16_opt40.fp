...
MULH H0.w, H0, {0.561372, 0.505235, 0.454712, 0.409240}.x;
ADDH H1.xyz, H1, -H1.w;
MULH H1.xyz, {0.368316, 0.331485, 0.298336, 0.268503}, H1;
ADDH H2.xyz, H1.w, H1;
MULH H1.xyz, f[COL0], {0.241652, 0.217487, 0.195738, 0.176165};
MULH H0.xyz, H0, H1;
MULH H0.xyz, H0, {0.158548, 0.142693, 0.128424, 0.115582};
MADH H0.xyz, {0.104023, 0.093621, 0.084259, 0.075833}.x, H0, H2;
END
