...
TEX H0.xyz, f[TEX2], TEX2, 2D;
DP3H H0.w, H0, H0;
LG2H H0.w, |H0.w|;
MULH H0.w, H0, C0.w;
EX2H H0.w, H0.w;
MULH H0.xyz, H0, H0.w;
MADH H0.xyz, H0, C0.y, f[TEX1];
DP3H H0.w, H0, H0;
LG2H H0.w, |H0.w|;
MULH H0.w, H0, C0.w;
EX2H H0.w, H0.w;
...
DP3H H2.w, H3, H6;
MADH_SAT H5.w, -H2, C0.y, C0.z;
TXP H0, H0, TEX2, 2D;
ADDH H0.xyz, H0, -H2;
MADH H2.xyz, H0, H0.w, H2;
MOVH H0.w, C0.z;
MADH H0.xyz, H2, C0.w, -H5;
MADH H0.xyz, H0, H5.w, H5;
END
