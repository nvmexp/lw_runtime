...
MADR R0.xyz, {1.987654, 1.788889, 1.610000, 1.449000}.x, R0, {1.987654, 1.788889, 1.610000, 1.449000}.y;
MOVR R0, R0.x;
MULR R1.xyz, R0.y, R1;
...
EX2R R5.w, R1.w;
DP3R_SAT R1.w, R0, {0.855620, 0.770058, 0.693052, 0.623747};
MULR R6.xyz, R2, R1.w;
MOVR R1.w, {0.561372, 0.505235, 0.454712, 0.409240}.x;
MULR R2.xyz, R5.w, R4;
DP3R R1.z, R1, R2;
ADDR R3.w, -R1.z, {0.368316, 0.331485, 0.298336, 0.268503}.x;
DP3R_SAT R1.z, R0, {0.241652, 0.217487, 0.195738, 0.176165};
MADR R2.yzw, R1.z, R3.xxyz, R6.xxyz;
MULR R5.w, R3, R3;
DP3R_SAT R2.x, R0, {0.158548, 0.142693, 0.128424, 0.115582};
MULR R5.w, R5, R5;
MOVR R0.xy, f[TEX4];
MADR R0.xy, R4.w, R1, -R0;
MULR R5.w, R3, R5;
