...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1014-lw40.s -o allprogs-new32//v1014-lw50.s
#vendor LWPU
...
# 101 inst, (51 mov, 0 mvi, 0 tex, 1 complex, 49 math)
#    45 64-bit, 56 32-bit, 0 32-bit-const
