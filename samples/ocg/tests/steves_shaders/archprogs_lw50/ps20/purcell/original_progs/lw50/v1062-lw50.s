...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1062-lw40.s -o allprogs-new32//v1062-lw50.s
#vendor LWPU
...
MOV32    o[35], R11;
MOV32    o[36], R11;
FMUL32   R14, R13, c[A0 + 92];
FSET     R11, R2, c[0], LT;
FMUL32   R15, R13, c[A0 + 93];
FMUL32   R13, R13, c[A0 + 94];
R2A      A0, R11;
FMAD     R11, R12, c[A1 + 84], R14;
FMAD     R14, R12, c[A1 + 85], R15;
FMAD     R12, R12, c[A1 + 86], R13;
FMAD     o[4], R10, c[A0 + 100], R11;
FMAD     o[5], R10, c[A0 + 101], R14;
FMAD     o[6], R10, c[A0 + 102], R12;
FMUL32   R11, R7, c[33];
MOV32    R10, c[35];
FMUL32   R12, R7, c[37];
FMAD     R11, R6, c[32], R11;
FMAD     R12, R6, c[36], R12;
FMAD     R11, R8, c[34], R11;
MOV32    o[2], R9;
FMAD     R9, R8, c[38], R12;
FMAD     o[0], R10, c[1], R11;
MOV32    R10, c[39];
FMUL32   R12, R7, c[45];
MOV32    R11, c[47];
...
MOV32    o[7], R0;
END
# 119 instructions, 16 R-regs
# 119 inst, (40 mov, 0 mvi, 0 tex, 0 complex, 79 math)
#    67 64-bit, 52 32-bit, 0 32-bit-const
