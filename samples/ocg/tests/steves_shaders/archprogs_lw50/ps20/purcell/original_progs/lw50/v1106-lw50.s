...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1106-lw40.s -o allprogs-new32//v1106-lw50.s
#vendor LWPU
...
MOV32    R2, c[47];
FMUL     R0, v[9], c[361];
FMAD     R0, v[8], c[360], R0;
FMAD     o[1], R1, c[1], R3;
FMAD     o[3], R2, c[1], R4;
FMAD     R0, v[10], c[362], R0;
FMUL     R1, v[9], c[365];
FMAD     R0, v[11], c[363], R0;
FMAD     R1, v[8], c[364], R1;
FADD32   o[16], R0, -c[372];
FMAD     R1, v[10], c[366], R1;
FADD32   o[14], R0, c[372];
FADD32   o[12], R0, -c[368];
FMAD     R1, v[11], c[367], R1;
FADD32   o[10], R0, c[368];
MOV32    o[8], R0;
FADD32   o[17], R1, -c[373];
FADD32   o[15], R1, c[373];
FADD32   o[13], R1, -c[369];
FADD32   o[11], R1, c[369];
MOV32    o[9], R1;
MOV      o[4], v[4];
MOV      o[5], v[5];
MOV      o[6], v[6];
MOV      o[7], v[7];
END
# 61 instructions, 8 R-regs
# 61 inst, (16 mov, 0 mvi, 0 tex, 0 complex, 45 math)
#    37 64-bit, 24 32-bit, 0 32-bit-const
