...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v965-lw40.s -o allprogs-new32//v965-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 250 instructions, 28 R-regs
# 250 inst, (37 mov, 0 mvi, 0 tex, 11 complex, 202 math)
#    170 64-bit, 80 32-bit, 0 32-bit-const
