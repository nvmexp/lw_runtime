...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1102-lw40.s -o allprogs-new32//v1102-lw50.s
#vendor LWPU
...
# 93 inst, (43 mov, 0 mvi, 0 tex, 0 complex, 50 math)
#    50 64-bit, 43 32-bit, 0 32-bit-const
