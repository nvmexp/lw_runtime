...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1149-lw40.s -o allprogs-new32//v1149-lw50.s
#vendor LWPU
...
FMAD     R3, c[A0 + 168], R2, R3;
FMAD     R4, c[A0 + 169], R2, R1;
FMAD     R1, c[A0 + 170], R2, R0;
...
FMAD     R0, c[A0 + 171], R2, R0;
FMAD     R3, v[2], R1, R3;
FMAD     R4, c[A0 + 172], R2, R4;
FMUL     R1, v[5], c[A2 + 173];
FMAD     R0, v[3], R0, R3;
FMUL     R3, v[5], c[A2 + 174];
FMAD     R5, v[4], c[A1 + 173], R1;
FMUL     R1, v[5], c[A2 + 175];
FMAD     R3, v[4], c[A1 + 174], R3;
FMAD     R5, c[A0 + 173], R2, R5;
FMAD     R1, v[4], c[A1 + 175], R1;
FMAD     R3, c[A0 + 174], R2, R3;
FMUL     R5, v[1], R5;
FMAD     R1, c[A0 + 175], R2, R1;
...
FMAD     R5, c[A0 + 176], R2, R6;
FMAD     R1, v[3], R1, R3;
FMAD     R6, c[A0 + 177], R2, R4;
...
FMAD     R5, v[0], R5, R6;
FMAD     R4, c[A0 + 178], R2, R4;
FMAD     R2, c[A0 + 179], R2, R3;
FMUL32   R3, R1, c[41];
FMAD     R5, v[2], R4, R5;
MOV32    R4, c[43];
FMAD     R3, R0, c[40], R3;
...
# 137 inst, (54 mov, 0 mvi, 0 tex, 1 complex, 82 math)
#    75 64-bit, 62 32-bit, 0 32-bit-const
