...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v924-lw40.s -o allprogs-new32//v924-lw50.s
#vendor LWPU
...
FMAD     R1, v[14], c[172], R1;
FMAD     R0, v[4], c[172], R0;
FMAD     R2, v[6], c[178], R2;
FMAD     R4, v[16], c[174], R1;
FMAD     R1, v[6], c[174], R0;
FMUL     R3, v[15], c[177];
FMUL32   R6, R2, R4;
FMUL     R0, v[5], c[169];
FMAD     R3, v[14], c[176], R3;
FMUL     R5, v[15], c[169];
FMAD     R0, v[4], c[168], R0;
FMAD     R3, v[16], c[178], R3;
FMAD     R5, v[14], c[168], R5;
FMAD     R0, v[6], c[170], R0;
FMAD     R7, R1, R3, -R6;
FMAD     R5, v[16], c[170], R5;
FMUL32   R6, R0, R3;
FMUL     o[23], v[17], R7;
FMUL32   R7, R1, R5;
FMAD     R6, R2, R5, -R6;
...
FMUL32   R11, R7, c[33];
FMUL32   R10, R9, R10;
FMAD     R12, R6, c[32], R11;
MOV32    R11, c[35];
FMAD     R10, -R10, R13, c[65];
FMAD     R12, R8, c[34], R12;
MOV32    o[32], R10;
MOV32    o[33], R10;
FMAD     o[0], R11, c[4], R12;
MOV32    o[34], R10;
MOV32    o[35], R10;
MOV32    o[2], R9;
FMUL32   R10, R7, c[37];
MOV32    R9, c[39];
FMUL32   R11, R7, c[45];
FMAD     R10, R6, c[36], R10;
FMAD     R12, R6, c[44], R11;
FMAD     R10, R8, c[38], R10;
MOV32    R11, c[47];
FMAD     R12, R8, c[46], R12;
FMAD     o[1], R9, c[4], R10;
MOV32    R9, R11;
MOV32    o[26], R0;
MOV32    o[27], R1;
...
MOV32    o[7], R0;
END
# 121 instructions, 16 R-regs
# 121 inst, (32 mov, 0 mvi, 0 tex, 1 complex, 88 math)
#    78 64-bit, 43 32-bit, 0 32-bit-const
