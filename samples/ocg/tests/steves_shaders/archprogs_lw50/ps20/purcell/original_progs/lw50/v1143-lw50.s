...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1143-lw40.s -o allprogs-new32//v1143-lw50.s
#vendor LWPU
...
FADD     R1, v[7], R0;
MOV32    o[16], R0;
FMAD     o[12], v[4], c[369], R2;
FADD     o[22], v[7], R1;
MOV32    o[18], R1;
FMUL     R0, v[3], c[372];
FMUL     R1, v[3], c[380];
FMUL     R2, v[3], c[376];
FMAD     o[13], v[4], c[373], R0;
FMAD     o[14], v[4], c[381], R1;
FMAD     o[15], v[4], c[377], R2;
FMUL     R0, v[3], c[360];
FMUL     R1, v[3], c[364];
FMUL     R2, v[3], c[384];
FMAD     o[8], v[4], c[361], R0;
FMAD     o[9], v[4], c[365], R1;
FMAD     o[10], v[4], c[385], R2;
FMUL     R0, v[3], c[388];
MOV32    o[4], c[152];
MOV32    o[5], c[153];
FMAD     o[11], v[4], c[389], R0;
MOV32    o[6], c[154];
MOV32    o[7], c[155];
END
# 93 instructions, 8 R-regs
# 93 inst, (39 mov, 0 mvi, 0 tex, 0 complex, 54 math)
#    54 64-bit, 39 32-bit, 0 32-bit-const
