...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1141-lw40.s -o allprogs-new32//v1141-lw50.s
#vendor LWPU
...
FMAD     R1, v[3], R1, R5;
FMAD     R3, v[4], c[A0 + 177], R3;
FMAD     R5, v[4], c[A0 + 178], R2;
...
# 114 inst, (52 mov, 0 mvi, 0 tex, 0 complex, 62 math)
#    57 64-bit, 57 32-bit, 0 32-bit-const
