...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1105-lw40.s -o allprogs-new32//v1105-lw50.s
#vendor LWPU
...
# 107 inst, (36 mov, 0 mvi, 0 tex, 0 complex, 71 math)
#    70 64-bit, 37 32-bit, 0 32-bit-const
