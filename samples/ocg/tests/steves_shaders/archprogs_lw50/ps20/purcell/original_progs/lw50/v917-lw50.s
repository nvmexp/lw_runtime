...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v917-lw40.s -o allprogs-new32//v917-lw50.s
#vendor LWPU
...
MOV      R0, v[8];
FMUL32   R2, R1, R2;
FMAD     o[10], v[10], c[156], R0;
MOV      R1, v[9];
FMUL32   R2, R2, R3;
FMAD     o[8], v[10], c[2], R0;
FADD     o[6], v[10], R0;
FMAD     R0, -R2, R4, c[65];
FMAD     o[11], v[11], c[156], R1;
FMAD     o[9], v[11], c[2], R1;
FADD     o[7], v[11], R1;
MOV32    o[12], R0;
MOV32    o[13], R0;
MOV32    o[14], R0;
...
# 49 inst, (8 mov, 0 mvi, 0 tex, 1 complex, 40 math)
#    39 64-bit, 10 32-bit, 0 32-bit-const
