...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1043-lw40.s -o allprogs-new32//v1043-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 211 instructions, 20 R-regs
# 211 inst, (43 mov, 0 mvi, 0 tex, 8 complex, 160 math)
#    111 64-bit, 100 32-bit, 0 32-bit-const
