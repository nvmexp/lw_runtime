...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v837-lw40.s -o allprogs-new32//v837-lw50.s
#vendor LWPU
...
FMAD     R20, R26, c[A1 + 85], R15;
FMUL32   R15, R18, R18;
FMAD     R20, R25, c[A0 + 101], R20;
...
FMUL32   R17, R18, R17;
FMUL32   R18, R22, c[108];
FMUL32   R19, R27, c[A2 + 92];
FMAD     R15, R15, R17, R28;
FMUL32   R18, R18, R23;
FMAD     R19, R26, c[A1 + 84], R19;
LG2      R20, |R15|;
FMUL32   R15, R16, c[128];
FMAD     R19, R25, c[A0 + 100], R19;
FMUL32   R20, R20, c[4];
FMAD     R18, R18, R24, R19;
RRO      R19, R20, 1;
FMAD     R15, R15, R17, R18;
EX2      R18, R19;
...
MOV32    o[7], R0;
END
# 256 instructions, 32 R-regs
# 256 inst, (37 mov, 0 mvi, 0 tex, 13 complex, 206 math)
#    163 64-bit, 93 32-bit, 0 32-bit-const
