...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1118-lw40.s -o allprogs-new32//v1118-lw50.s
#vendor LWPU
...
FMUL32   R23, R16, c[109];
FMAD     R22, R20, c[A1 + 84], R22;
FMAD     R15, R11, -c[134], R15;
FMUL32   R24, R21, c[A2 + 93];
FMAD     R22, R19, c[A0 + 100], R22;
FMAX     R15, R15, c[0];
FMUL32   R21, R21, c[A2 + 94];
FMAD     R17, R17, R18, R22;
FMAD     R22, R20, c[A1 + 85], R24;
FMAD     R20, R20, c[A1 + 86], R21;
FMAD     o[4], R15, c[128], R17;
FMAD     R17, R19, c[A0 + 101], R22;
FMAD     R19, R19, c[A0 + 102], R20;
FMUL32   R16, R16, c[110];
FMAD     R17, R23, R18, R17;
FMUL     R6, v[15], R6;
FMAD     R16, R16, R18, R19;
FMAD     o[5], R15, c[129], R17;
FMAD     R5, v[14], R5, R6;
...
MOV32    o[7], R0;
END
# 200 instructions, 28 R-regs
# 200 inst, (46 mov, 0 mvi, 0 tex, 2 complex, 152 math)
#    130 64-bit, 70 32-bit, 0 32-bit-const
