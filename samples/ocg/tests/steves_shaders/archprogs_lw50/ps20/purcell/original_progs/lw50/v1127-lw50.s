...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1127-lw40.s -o allprogs-new32//v1127-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 210 instructions, 28 R-regs
# 210 inst, (46 mov, 0 mvi, 0 tex, 4 complex, 160 math)
#    131 64-bit, 79 32-bit, 0 32-bit-const
