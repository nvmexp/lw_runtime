...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v836-lw40.s -o allprogs-new32//v836-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 272 instructions, 32 R-regs
# 272 inst, (38 mov, 0 mvi, 0 tex, 13 complex, 221 math)
#    179 64-bit, 93 32-bit, 0 32-bit-const
