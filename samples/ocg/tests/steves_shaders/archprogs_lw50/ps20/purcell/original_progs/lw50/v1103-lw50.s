...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1103-lw40.s -o allprogs-new32//v1103-lw50.s
#vendor LWPU
...
# 95 inst, (51 mov, 0 mvi, 0 tex, 0 complex, 44 math)
#    43 64-bit, 52 32-bit, 0 32-bit-const
