...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v843-lw40.s -o allprogs-new32//v843-lw50.s
#vendor LWPU
...
FMAD     R6, R0, -c[132], R6;
FMAD     R8, R11, c[A2 + 85], R8;
FMAD     R6, R2, -c[134], R6;
FMAD     R14, R10, c[A1 + 101], R8;
FMAX     R6, R6, c[0];
FMUL32   R8, R7, c[108];
FMAD     R14, R13, R9, R14;
FMUL32   R13, R12, c[A3 + 92];
FMAD     R14, R6, c[129], R14;
...
# 194 inst, (38 mov, 0 mvi, 0 tex, 9 complex, 147 math)
#    121 64-bit, 73 32-bit, 0 32-bit-const
