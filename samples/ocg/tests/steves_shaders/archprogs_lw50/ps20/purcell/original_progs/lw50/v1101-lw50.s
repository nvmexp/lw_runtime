...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1101-lw40.s -o allprogs-new32//v1101-lw50.s
#vendor LWPU
...
# 105 inst, (28 mov, 0 mvi, 0 tex, 0 complex, 77 math)
#    77 64-bit, 28 32-bit, 0 32-bit-const
