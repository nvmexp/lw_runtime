...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p558-lw40.s -o allprogs-new32//p558-lw50.s
#vendor LWPU
...
FMUL32   R3, R3, c[7];
END
# 56 instructions, 16 R-regs, 14 interpolants
# 56 inst, (0 mov, 0 mvi, 3 tex, 14 ipa, 2 complex, 37 math)
#    31 64-bit, 22 32-bit, 3 32-bit-const
