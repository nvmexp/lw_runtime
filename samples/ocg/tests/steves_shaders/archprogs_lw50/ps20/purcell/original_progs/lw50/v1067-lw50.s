...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1067-lw40.s -o allprogs-new32//v1067-lw50.s
#vendor LWPU
...
FADD32   R15, c[A1 + 8], -R7;
FADD32   R16, c[A1 + 9], -R8;
FADD32   R14, c[A1 + 10], -R6;
FMUL32   R13, R16, R16;
FMAD     R13, R15, R15, R13;
FMAD     R13, R14, R14, R13;
RSQ      R17, |R13|;
FMUL32   R16, R16, R17;
FMUL32   R15, R15, R17;
FMUL32   R14, R14, R17;
...
FMUL32   R17, R13, R17;
MOV32    R18, c[A1 + 16];
FMAD     R16, R15, R10, R16;
MOV32    R15, c[13];
FMAD     R17, R17, c[A1 + 17], R18;
FMAD     R14, R14, R9, R16;
F2I.FLOOR R15, R15;
FMAD     R13, R13, c[A1 + 18], R17;
FMAX     R14, R14, c[0];
I2I.M4   R15, R15;
RCP      R13, R13;
R2A      A0, R15;
FMUL32   R13, R14, R13;
FMUL32   R12, -c[A0 + 5], R12;
FMAD     R4, c[A1 + 1], R13, R4;
FMAD     R10, -c[A0 + 4], R10, R12;
MVI      R12, -127.996;
FMAD     R9, -c[A0 + 6], R9, R10;
MOV32    R10, R12;
FMAX     R9, R9, c[0];
FMAX     R10, R10, c[4];
...
MOV32    o[7], R0;
END
# 181 instructions, 20 R-regs
# 181 inst, (23 mov, 1 mvi, 0 tex, 10 complex, 147 math)
#    119 64-bit, 62 32-bit, 0 32-bit-const
