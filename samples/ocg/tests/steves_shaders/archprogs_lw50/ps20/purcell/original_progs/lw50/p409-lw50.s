...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p409-lw40.s -o allprogs-new32//p409-lw50.s
#vendor LWPU
...
FMAD     R2, R2, c[0], R5;
END
# 70 instructions, 16 R-regs, 14 interpolants
# 70 inst, (0 mov, 0 mvi, 3 tex, 14 ipa, 3 complex, 50 math)
#    44 64-bit, 25 32-bit, 1 32-bit-const
