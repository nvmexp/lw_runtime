...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v976-lw40.s -o allprogs-new32//v976-lw50.s
#vendor LWPU
...
FMAD     R14, v[4], c[A1 + 179], R11;
FMAD     R11, R17, R17, R3;
FMUL     R3, v[1], R10;
FMAD     R7, c[A0 + 179], R7, R14;
FMAD     R14, v[0], R9, R3;
FMUL     R3, v[10], R6;
FMAD     R14, v[2], R8, R14;
FMAD     R3, v[9], R5, R3;
...
FMAD     R7, v[11], R4, R3;
FMUL     R3, v[10], R2;
FADD32   R15, -R14, c[118];
FMAD     R3, v[9], R1, R3;
FMAD     R16, R15, R15, R11;
FMUL     R11, v[10], R10;
FMAD     R3, v[11], R0, R3;
RSQ      R19, |R16|;
FMAD     R11, v[9], R9, R11;
...
FMAD     R15, R11, R15, R17;
MOV32    R17, R18;
FMAD     R18, R16, c[126], R19;
FMAX     R15, R15, c[0];
FMAD     R17, R16, -c[127], R17;
RCP      R16, R18;
FMUL32   R22, R15, c[109];
FMAX     R17, R17, c[14];
FMUL32   R19, R3, R3;
FSET     R18, R3, c[14], LT;
FMIN     R17, R17, c[13];
...
R2A      A2, R21;
R2A      A0, R16;
FMUL32   R16, R20, c[A2 + 93];
FMAD     R23, R19, c[A1 + 85], R16;
FMUL32   R16, R15, c[108];
FMUL32   R21, R20, c[A2 + 92];
FMAD     R23, R18, c[A0 + 101], R23;
FMAD     R21, R19, c[A1 + 84], R21;
FMAD     R22, R22, R17, R23;
FMAD     R21, R18, c[A0 + 100], R21;
LG2      R22, |R22|;
FMAD     R16, R16, R17, R21;
FMUL32   R21, R22, c[4];
LG2      R16, |R16|;
RRO      R21, R21, 1;
FMUL32   R15, R15, c[110];
FMUL32   R20, R20, c[A2 + 94];
EX2      R21, R21;
FMUL32   R16, R16, c[4];
FMAD     R19, R19, c[A1 + 86], R20;
FMUL32   R20, R21, c[7];
RRO      R16, R16, 1;
FMAD     R18, R18, c[A0 + 102], R19;
EX2      R16, R16;
FMAD     R17, R15, R17, R18;
FMUL32   R15, R16, c[7];
LG2      R17, |R17|;
FMAX     R16, R20, R15;
FMUL32   R17, R17, c[4];
...
MOV32    o[7], R0;
END
# 226 instructions, 24 R-regs
# 226 inst, (37 mov, 0 mvi, 0 tex, 9 complex, 180 math)
#    157 64-bit, 69 32-bit, 0 32-bit-const
