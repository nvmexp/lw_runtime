...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v909-lw40.s -o allprogs-new32//v909-lw50.s
#vendor LWPU
...
LG2      R1, |R1|;
FADD32   R11, -R5, c[118];
FMAD     R10, R14, R14, R10;
FMUL32   R1, R1, c[140];
FMAD     R15, R11, R11, R10;
RRO      R1, R1, 1;
RSQ      R13, |R15|;
EX2      R10, R1;
FMUL32   R1, R15, c[12];
FMAD     R0, R15, -c[127], R0;
FMIN     R10, R10, c[1];
FMUL32   R15, R15, R13;
FMAX     R0, R0, c[13];
FMUL32   R18, R16, R10;
...
FMIN     R0, R0, c[12];
FMUL32   R14, R14, R13;
FMAD     R2, R2, c[124], R15;
FMUL32   R12, R12, R13;
FMUL32   R13, R11, R13;
FMAD     R2, R1, c[126], R2;
FMUL32   R1, -R12, c[113];
RCP      R2, R2;
FMAD     R1, -R14, c[112], R1;
FMUL32   R11, R0, R2;
FMAD     R0, -R13, c[114], R1;
FMUL32   R16, R11, c[109];
FADD32   R0, R0, -c[122];
FMUL32   R1, R0, c[123];
FMUL     R0, v[5], c[173];
FMAX     R1, R1, c[0];
...
FSET     R17, R2, c[13], LT;
FMAD     R8, R0, R8, R9;
FMUL32   R9, R16, c[A2 + 93];
R2A      A0, R17;
FMAD     R7, R2, R7, R8;
FMAD     R9, R15, c[A1 + 85], R9;
FMAX     R8, R7, c[0];
FMAD     R9, R14, c[A0 + 101], R9;
FMUL32   R7, R6, c[128];
FMAD     R9, R19, R13, R9;
FMUL32   R7, R7, R10;
FMUL32   R17, R11, c[108];
FMAD     R18, R18, R8, R9;
FMUL32   R9, R16, c[A2 + 92];
FMUL32   R17, R17, R12;
LG2      R18, |R18|;
FMAD     R9, R15, c[A1 + 84], R9;
FMUL32   R18, R18, c[4];
FMAD     R9, R14, c[A0 + 100], R9;
RRO      R18, R18, 1;
FMAD     R9, R17, R13, R9;
EX2      R17, R18;
FMAD     R7, R7, R8, R9;
...
LG2      R7, |R7|;
FMUL32   R6, R6, R10;
FMUL32   R10, R16, c[A2 + 94];
FMUL32   R7, R7, c[4];
FMUL32   R11, R11, c[110];
FMAD     R10, R15, c[A1 + 86], R10;
RRO      R7, R7, 1;
FMUL32   R11, R11, R12;
FMAD     R10, R14, c[A0 + 102], R10;
EX2      R7, R7;
FMAD     R10, R11, R13, R10;
FMUL32   R7, R7, c[7];
FMAD     R6, R6, R8, R10;
FMAX     R10, R9, R7;
LG2      R6, |R6|;
...
FMUL32   o[6], R12, R13;
FMAD     R7, R1, R6, -R10;
FMAD     R9, v[11], c[168], R11;
FMUL32   R10, R6, R0;
FMUL     o[23], v[14], R7;
FMAD     R7, v[13], c[170], R9;
FMUL32   R11, R4, c[41];
MOV32    R9, c[43];
FMAD     R10, R2, R7, -R10;
...
FMAD     R10, -R10, R12, c[65];
FMUL32   R12, R4, c[37];
FMAD     o[0], R11, c[12], R13;
MOV32    o[32], R10;
...
MOV32    o[7], R1;
END
# 248 instructions, 20 R-regs
# 248 inst, (33 mov, 0 mvi, 0 tex, 16 complex, 199 math)
#    144 64-bit, 104 32-bit, 0 32-bit-const
