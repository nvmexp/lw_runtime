...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1029-lw40.s -o allprogs-new32//v1029-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 237 instructions, 32 R-regs
# 237 inst, (44 mov, 0 mvi, 0 tex, 8 complex, 185 math)
#    137 64-bit, 100 32-bit, 0 32-bit-const
