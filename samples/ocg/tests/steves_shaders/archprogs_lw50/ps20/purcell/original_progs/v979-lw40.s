...
rcp r0.w, r7.x
dp3 r7.x, -r1, c[28]
add r2.w, r7.x, -c[30].z
mul r2.w, r2.w, c[30].w
max r1.w, r2.w, c[0].x
pow r2.w, r1.w, c[30].x
min r2.w, r2.w, c[0].y
mul r7.xyz, r2.w, c[27]
mul r6.xyz, r0.w, r7
dp3 r5.y, v5, c[a0.w+43]
dp3 r5.z, v5, c[a0.w+44]
mul r7.xy, r5.yzzw, c[4]
add r4.x, r7.y, r7.x
dp3 r5.x, v5, c[a0.w+42]
dp3 r7.x, v2, c[a0.w+42]
dp3 r7.y, v2, c[a0.w+43]
dp3 r7.z, v2, c[a0.w+44]
mul r0.xyz, r5.yzxw, r7.zxyw
mad r0.xyz, r7.yzxw, r5.zxyw, -r0
mul r9.xyz, r0, v5.w
...
mova a0.xyz, r0
mul r0.xyz, r3, r3
mul r9.xyz, r0.y, c[a0.y+23]
mad r9.xyz, r0.x, c[a0.x+21], r9
mad r0.xyz, r0.z, c[a0.z+25], r9
mad r9.xyz, r6, r1.x, r0
dp3 r0.z, r2, r2
rsq r0.w, r0.z
dst r0.xy, r0.z, r0.w
dp4 r2.w, c[36], r0
