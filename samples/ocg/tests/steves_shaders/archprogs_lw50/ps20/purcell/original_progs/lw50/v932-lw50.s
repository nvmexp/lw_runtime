...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v932-lw40.s -o allprogs-new32//v932-lw50.s
#vendor LWPU
...
FMUL     R2, v[5], c[381];
MOV32    o[22], R0;
FMAD     R0, v[4], c[376], R1;
FMAD     R1, v[4], c[380], R2;
FMUL     R2, v[5], c[369];
FMAD     R0, v[6], c[378], R0;
FMAD     R1, v[6], c[382], R1;
FMAD     R2, v[4], c[368], R2;
FMAD     o[15], v[7], c[379], R0;
FMAD     o[16], v[7], c[383], R1;
FMAD     R0, v[6], c[370], R2;
FMUL     R1, v[5], c[373];
FMUL     R2, v[5], c[361];
FMAD     o[13], v[7], c[371], R0;
FMAD     R0, v[4], c[372], R1;
FMAD     R1, v[4], c[360], R2;
FMUL     R2, v[5], c[365];
FMAD     R0, v[6], c[374], R0;
FMAD     R1, v[6], c[362], R1;
FMAD     R2, v[4], c[364], R2;
FMAD     o[14], v[7], c[375], R0;
FMAD     o[11], v[7], c[363], R1;
FMAD     R0, v[6], c[366], R2;
MOV32    R1, c[5];
MOV32    o[9], c[5];
FMAD     o[12], v[7], c[367], R0;
MOV32    o[8], R1;
MOV32    R0, c[5];
MOV32    R1, c[5];
MOV32    o[5], c[5];
...
# 105 inst, (43 mov, 0 mvi, 0 tex, 1 complex, 61 math)
#    51 64-bit, 54 32-bit, 0 32-bit-const
