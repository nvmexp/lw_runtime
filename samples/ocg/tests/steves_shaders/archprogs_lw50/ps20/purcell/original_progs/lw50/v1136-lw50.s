...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1136-lw40.s -o allprogs-new32//v1136-lw50.s
#vendor LWPU
...
FMUL     R4, v[5], c[177];
LG2      R3, |R3|;
FMAD     R5, v[4], c[176], R4;
FMUL     R4, v[10], c[173];
FMUL32   R3, R3, c[120];
FMAD     R10, v[6], c[178], R5;
FMAD     R5, v[9], c[172], R4;
RRO      R4, R3, 1;
FMUL     R3, v[5], c[173];
FMAD     R16, v[11], c[174], R5;
EX2      R5, R4;
FMAD     R3, v[4], c[172], R3;
FMUL32   R4, R10, R16;
FMIN     R26, R5, c[1];
FMAD     R12, v[6], c[174], R3;
FMUL     R3, v[10], c[177];
FMUL32   R6, R26, c[108];
FMUL     R5, v[5], c[169];
FMAD     R3, v[9], c[176], R3;
FMUL32   R27, R22, R6;
FMAD     R5, v[4], c[168], R5;
FMAD     R14, v[11], c[178], R3;
FMUL     R3, v[10], c[169];
FMAD     R11, v[6], c[170], R5;
FMAD     R5, R12, R14, -R4;
FMAD     R4, v[9], c[168], R3;
FMUL32   R3, R11, R14;
FMUL     R19, v[12], R5;
FMAD     R15, v[11], c[170], R4;
FMAD     R5, R10, R15, -R3;
FMUL32   R4, R12, R15;
FMUL32   R3, R16, c[12];
FMUL     R20, v[12], R5;
...
FMUL32   R3, R20, c[12];
FMUL     R18, v[12], R5;
FMAD     R17, R14, c[12], R4;
FMAD     R4, R19, c[12], R3;
FMUL32   R3, R12, c[12];
FMAD     R21, R18, c[12], R4;
FMAD     R4, R11, c[12], R3;
FMUL32   R3, R21, R25;
FMAD     R13, R10, c[12], R4;
FMUL32   R31, R21, R21;
FMAD     R3, R17, R24, R3;
FSET     R4, R21, c[0], LT;
FMUL32   R30, R17, R17;
...
FMAD     o[31], R4, R9, R17;
FMAD     o[32], R3, R9, R28;
FMAD     R26, R18, c[7], R22;
FMUL32   R17, R16, c[6];
FMUL32   R9, R12, c[6];
FMUL32   R22, R26, R25;
FMAD     R17, R14, c[7], R17;
FMAD     R9, R10, c[7], R9;
FMUL32   R30, R26, R26;
...
FMUL32   R17, R12, c[5];
FMAD     R9, R18, c[5], R9;
FMAD     R22, R15, c[4], R22;
FMAD     R17, R11, c[4], R17;
FMUL32   R26, R9, R25;
FMAD     R22, R14, c[5], R22;
FMAD     R17, R10, c[5], R17;
FMUL32   R25, R9, R9;
...
MOV32    o[7], R1;
END
# 276 instructions, 36 R-regs
# 276 inst, (40 mov, 0 mvi, 0 tex, 8 complex, 228 math)
#    166 64-bit, 110 32-bit, 0 32-bit-const
