...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1112-lw40.s -o allprogs-new32//v1112-lw50.s
#vendor LWPU
...
FSET     R19, R2, c[0], LT;
FMAD     R8, R0, R8, R9;
FMUL32   R9, R18, c[A2 + 92];
R2A      A0, R19;
FMAD     R7, R2, R7, R8;
FMAD     R8, R17, c[A1 + 84], R9;
FMUL32   R9, R6, c[129];
FMAX     R7, R7, c[0];
FMAD     R8, R16, c[A0 + 100], R8;
FMUL32   R9, R9, R10;
...
FMUL32   R8, R18, c[A2 + 93];
FMUL32   R11, R18, c[A2 + 94];
FMUL32   R10, R10, R13;
FMAD     R8, R17, c[A1 + 85], R8;
FMAD     R12, R17, c[A1 + 86], R11;
FMUL     R11, v[10], c[173];
FMAD     R8, R16, c[A0 + 101], R8;
FMAD     R12, R16, c[A0 + 102], R12;
FMAD     R11, v[9], c[172], R11;
FMAD     R8, R14, R15, R8;
FMAD     R12, R10, R15, R12;
FMAD     R10, v[11], c[174], R11;
FMAD     o[5], R9, R7, R8;
FMAD     o[6], R6, R7, R12;
FMUL32   R8, R10, R2;
FMUL     R6, v[10], c[177];
...
FMAD     R7, v[9], c[168], R7;
FMAD     R6, v[11], c[178], R6;
FMAD     R7, v[11], c[170], R7;
FMAD     R8, R1, R6, -R8;
FMUL32   R9, R6, R0;
FMUL32   R11, R7, R1;
FMUL     o[24], v[12], R8;
...
MOV32    o[7], R0;
END
# 209 instructions, 20 R-regs
# 209 inst, (42 mov, 0 mvi, 0 tex, 8 complex, 159 math)
#    109 64-bit, 100 32-bit, 0 32-bit-const
