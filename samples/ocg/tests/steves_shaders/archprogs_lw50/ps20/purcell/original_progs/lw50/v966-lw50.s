...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v966-lw40.s -o allprogs-new32//v966-lw50.s
#vendor LWPU
...
FMUL32   R3, -R18, c[113];
RCP      R7, R7;
FMAD     R3, -R17, c[112], R3;
FMUL32   R16, R7, R19;
FMAD     R3, -R15, c[114], R3;
FMUL32   R19, R16, c[109];
FADD32   R3, R3, -c[122];
FMUL32   R7, R3, c[123];
FMUL     R3, v[9], R6;
FMAX     R7, R7, c[0];
...
FMUL32   R15, R7, -c[133];
R2A      A0, R17;
FMUL32   R17, R22, c[A2 + 93];
FMAD     R15, R3, -c[132], R15;
FMAD     R17, R21, c[A1 + 85], R17;
FMAD     R15, R11, -c[134], R15;
FMAD     R24, R20, c[A0 + 101], R17;
FMAX     R15, R15, c[0];
FMUL32   R17, R16, c[108];
FMAD     R24, R23, R19, R24;
FMUL32   R23, R22, c[A2 + 92];
FMUL32   R17, R17, R18;
FMAD     R24, R15, c[129], R24;
FMAD     R23, R21, c[A1 + 84], R23;
LG2      R24, |R24|;
FMAD     R23, R20, c[A0 + 100], R23;
FMUL32   R24, R24, c[4];
FMAD     R17, R17, R19, R23;
RRO      R23, R24, 1;
FMAD     R17, R15, c[128], R17;
EX2      R23, R23;
LG2      R17, |R17|;
...
FMUL32   R23, R23, c[7];
FMUL32   R16, R16, R18;
FMAD     R18, R21, c[A1 + 86], R22;
FMUL32   R17, R17, c[4];
FMAD     R18, R20, c[A0 + 102], R18;
RRO      R17, R17, 1;
FMAD     R16, R16, R19, R18;
EX2      R17, R17;
FMAD     R16, R15, c[130], R16;
FMUL32   R15, R17, c[7];
LG2      R17, |R16|;
FMAX     R16, R23, R15;
FMUL32   R17, R17, c[4];
...
# 234 inst, (36 mov, 0 mvi, 0 tex, 11 complex, 187 math)
#    154 64-bit, 80 32-bit, 0 32-bit-const
