...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1076-lw40.s -o allprogs-new32//v1076-lw50.s
#vendor LWPU
...
FMUL     R1, v[11], c[A0 + 173];
FMUL     R0, v[6], c[A0 + 173];
FMAD     R2, v[5], c[A0 + 176], R2;
FMAD     R1, v[10], c[A0 + 172], R1;
FMAD     R0, v[5], c[A0 + 172], R0;
FMAD     R7, v[7], c[A0 + 178], R2;
FMAD     R13, v[12], c[A0 + 174], R1;
FMAD     R9, v[7], c[A0 + 174], R0;
FMUL     R0, v[11], c[A0 + 177];
FMUL32   R1, R7, R13;
FMUL     R2, v[6], c[A0 + 169];
FMAD     R3, v[10], c[A0 + 176], R0;
FMUL     R0, v[11], c[A0 + 169];
FMAD     R2, v[5], c[A0 + 168], R2;
FMAD     R11, v[12], c[A0 + 178], R3;
FMAD     R0, v[10], c[A0 + 168], R0;
FMAD     R8, v[7], c[A0 + 170], R2;
FMAD     R1, R9, R11, -R1;
FMAD     R12, v[12], c[A0 + 170], R0;
FMUL32   R0, R8, R11;
FMUL     R16, v[13], R1;
FMUL32   R1, R9, R12;
FMAD     R2, R7, R12, -R0;
...
FMAD     R19, R5, R10, R19;
FSET     R20, R6, c[0], LT;
FMUL32   R6, R22, c[A2 + 92];
FMAX     R19, R19, c[0];
R2A      A1, R20;
FMUL32   R20, R5, R5;
FSET     R5, R5, c[0], LT;
FMAD     R23, R21, c[A1 + 84], R6;
FMUL32   R6, R3, R4;
R2A      A0, R5;
MOV32    R5, c[125];
...
FMAD     R5, R5, R6, c[124];
FMAD     R6, R21, c[A1 + 85], R24;
FMAD     R3, R3, c[126], R5;
FMUL32   R5, R22, c[A2 + 94];
FMAD     R6, R20, c[A0 + 101], R6;
FMAD     R3, R4, c[127], R3;
FMAD     R4, R21, c[A1 + 86], R5;
RCP      R5, R3;
...
FMUL32   R4, R5, c[109];
FMUL32   R5, R5, c[110];
FMAD     o[30], R3, R19, R23;
FMAD     o[31], R4, R19, R6;
FMAD     o[32], R5, R19, R20;
FMAD     R21, R15, c[13], R21;
FMUL32   R19, R13, c[12];
FMUL32   R20, R9, c[12];
FMUL32   R6, R21, R18;
...
MOV32    o[7], R1;
END
# 212 instructions, 28 R-regs
# 212 inst, (40 mov, 0 mvi, 0 tex, 2 complex, 170 math)
#    131 64-bit, 81 32-bit, 0 32-bit-const
