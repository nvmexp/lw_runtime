...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v878-lw40.s -o allprogs-new32//v878-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 114 instructions, 16 R-regs
# 114 inst, (31 mov, 0 mvi, 0 tex, 0 complex, 83 math)
#    76 64-bit, 38 32-bit, 0 32-bit-const
