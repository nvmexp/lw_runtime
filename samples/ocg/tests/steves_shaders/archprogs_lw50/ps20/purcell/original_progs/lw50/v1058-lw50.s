...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1058-lw40.s -o allprogs-new32//v1058-lw50.s
#vendor LWPU
...
FMUL32   R7, R7, c[110];
FMAD     R9, R9, R10, R14;
FMUL32   R14, R13, c[A3 + 93];
FMUL32   R7, R7, R8;
FMUL32   R8, R13, c[A3 + 94];
FMAD     o[4], R6, c[128], R9;
FMAD     R9, R12, c[A2 + 85], R14;
FMAD     R12, R12, c[A2 + 86], R8;
FMUL     R8, v[11], c[A0 + 173];
FMAD     R9, R11, c[A1 + 101], R9;
FMAD     R11, R11, c[A1 + 102], R12;
...
MOV32    o[7], R0;
END
# 175 instructions, 16 R-regs
# 175 inst, (44 mov, 0 mvi, 0 tex, 4 complex, 127 math)
#    95 64-bit, 80 32-bit, 0 32-bit-const
