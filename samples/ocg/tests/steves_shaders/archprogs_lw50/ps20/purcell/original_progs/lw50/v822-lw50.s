...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v822-lw40.s -o allprogs-new32//v822-lw50.s
#vendor LWPU
...
FMAD     R5, v[11], c[168], R5;
FMAD     R0, v[6], c[170], R0;
FMAD     R7, R1, R3, -R6;
FMAD     R5, v[13], c[170], R5;
FMUL32   R6, R3, R0;
FMUL     o[23], v[14], R7;
FMUL32   R7, R5, R1;
FMAD     R6, R2, R5, -R6;
...
R2A      A2, R10;
R2A      A0, R7;
FMUL32   R10, R9, c[A2 + 93];
FMUL32   R7, R9, c[A2 + 92];
FMAD     R10, R8, c[A1 + 85], R10;
FMAD     R7, R8, c[A1 + 84], R7;
FMAD     R10, R6, c[A0 + 101], R10;
FMAD     R7, R6, c[A0 + 100], R7;
LG2      R10, |R10|;
LG2      R7, |R7|;
FMUL32   R10, R10, c[4];
FMUL32   R7, R7, c[4];
FMUL32   R9, R9, c[A2 + 94];
RRO      R10, R10, 1;
RRO      R7, R7, 1;
FMAD     R8, R8, c[A1 + 86], R9;
EX2      R9, R10;
EX2      R7, R7;
FMAD     R6, R6, c[A0 + 102], R8;
FMUL32   R10, R9, c[7];
FMUL32   R9, R7, c[7];
LG2      R6, |R6|;
FMAX     R8, R10, R9;
...
# 151 inst, (31 mov, 0 mvi, 0 tex, 7 complex, 113 math)
#    98 64-bit, 53 32-bit, 0 32-bit-const
