...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p526-lw40.s -o allprogs-new32//p526-lw50.s
#vendor LWPU
...
END
# 55 instructions, 12 R-regs, 12 interpolants
# 55 inst, (2 mov, 0 mvi, 2 tex, 12 ipa, 2 complex, 37 math)
#    30 64-bit, 20 32-bit, 5 32-bit-const
