...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1111-lw40.s -o allprogs-new32//v1111-lw50.s
#vendor LWPU
...
R2A      A0, R11;
FMUL32   R11, R10, c[A2 + 92];
FMUL32   R14, R13, c[110];
FMUL32   R13, R10, c[A2 + 93];
FMUL32   R10, R10, c[A2 + 94];
FMAD     R11, R9, c[A1 + 84], R11;
FMAD     R13, R9, c[A1 + 85], R13;
FMAD     R9, R9, c[A1 + 86], R10;
FMAD     R10, R8, c[A0 + 100], R11;
FMAD     R11, R8, c[A0 + 101], R13;
FMAD     R8, R8, c[A0 + 102], R9;
FMAD     o[4], R6, R7, R10;
FMAD     o[5], R12, R7, R11;
FMAD     o[6], R14, R7, R8;
FMUL     R7, v[10], c[173];
FMUL     R6, v[10], c[177];
FMAD     R7, v[9], c[172], R7;
...
MOV32    o[7], R0;
END
# 149 instructions, 16 R-regs
# 149 inst, (43 mov, 0 mvi, 0 tex, 2 complex, 104 math)
#    80 64-bit, 69 32-bit, 0 32-bit-const
