...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p513-lw40.s -o allprogs-new32//p513-lw50.s
#vendor LWPU
...
FMUL32I  R5, R5, 16.0;
FMUL32I  R4, R4, 16.0;
FMUL32I  R7, R10, 0.57735;
FMUL32I  R11, R9, 0.707107;
FMUL32I  R9, R9, -0.707107;
...
#    68 64-bit, 28 32-bit, 8 32-bit-const
