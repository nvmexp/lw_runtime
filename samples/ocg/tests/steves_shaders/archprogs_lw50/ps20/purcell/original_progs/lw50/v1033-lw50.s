...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1033-lw40.s -o allprogs-new32//v1033-lw50.s
#vendor LWPU
...
# 83 inst, (47 mov, 0 mvi, 0 tex, 0 complex, 36 math)
#    33 64-bit, 50 32-bit, 0 32-bit-const
