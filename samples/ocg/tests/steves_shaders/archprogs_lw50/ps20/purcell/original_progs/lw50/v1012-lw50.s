...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1012-lw40.s -o allprogs-new32//v1012-lw50.s
#vendor LWPU
...
FMAD     R3, v[2], c[30], R3;
FMAD     o[1], R4, c[1], R1;
FMAD     R0, v[11], c[176], R0;
FMAD     o[3], R2, c[1], R3;
FMUL     R1, v[15], c[177];
FMAD     o[33], v[13], c[178], R0;
FMUL     R0, v[4], c[177];
FMAD     R1, v[14], c[176], R1;
FMUL     R2, v[12], c[173];
FMAD     R0, v[3], c[176], R0;
FMAD     o[34], v[16], c[178], R1;
FMAD     R1, v[11], c[172], R2;
FMAD     o[35], v[5], c[178], R0;
FMUL     R0, v[15], c[173];
FMAD     o[30], v[13], c[174], R1;
FMUL     R1, v[4], c[173];
FMAD     R0, v[14], c[172], R0;
FMUL     R2, v[12], c[169];
FMAD     R1, v[3], c[172], R1;
FMAD     o[31], v[16], c[174], R0;
FMAD     R0, v[11], c[168], R2;
FMAD     o[32], v[5], c[174], R1;
FMUL     R1, v[15], c[169];
FMAD     o[27], v[13], c[170], R0;
FMUL     R0, v[4], c[169];
FMAD     R1, v[14], c[168], R1;
MOV      o[20], v[8];
FMAD     R0, v[3], c[168], R0;
FMAD     o[28], v[16], c[170], R1;
MOV      o[21], v[9];
FMAD     o[29], v[5], c[170], R0;
MOV      R0, v[8];
FADD     o[23], v[9], c[0];
FADD     o[17], v[9], c[0];
FADD     R0, v[10], R0;
...
FADD     R1, v[10], R0;
MOV32    o[16], R0;
FMAD     o[12], v[7], c[369], R2;
FADD     o[22], v[10], R1;
MOV32    o[18], R1;
FMUL     R0, v[6], c[372];
MOV32    R1, c[0];
MOV32    R2, c[0];
FMAD     o[13], v[7], c[373], R0;
MOV32    o[14], R1;
MOV32    o[15], R2;
FMUL     R0, v[6], c[360];
FMUL     R1, v[6], c[364];
FMUL     R2, v[6], c[384];
FMAD     o[8], v[7], c[361], R0;
FMAD     o[9], v[7], c[365], R1;
FMAD     o[10], v[7], c[385], R2;
FMUL     R0, v[6], c[388];
MOV32    o[4], c[152];
MOV32    o[5], c[153];
FMAD     o[11], v[7], c[389], R0;
MOV32    o[6], c[154];
MOV32    o[7], c[155];
END
# 111 instructions, 8 R-regs
# 111 inst, (28 mov, 0 mvi, 0 tex, 1 complex, 82 math)
#    79 64-bit, 32 32-bit, 0 32-bit-const
