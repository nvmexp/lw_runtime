...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v860-lw40.s -o allprogs-new32//v860-lw50.s
#vendor LWPU
...
MOV32    o[7], R1;
END
# 116 instructions, 16 R-regs
# 116 inst, (33 mov, 0 mvi, 0 tex, 0 complex, 83 math)
#    73 64-bit, 43 32-bit, 0 32-bit-const
