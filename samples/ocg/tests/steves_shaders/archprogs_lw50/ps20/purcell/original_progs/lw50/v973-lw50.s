...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v973-lw40.s -o allprogs-new32//v973-lw50.s
#vendor LWPU
...
MOV32    o[14], R0;
MOV32    o[15], R1;
FMAD     o[10], v[4], c[369], R2;
FMUL     R0, v[3], c[372];
FMUL     R1, v[3], c[360];
FMUL     R2, v[3], c[364];
FMAD     o[11], v[4], c[373], R0;
...
# 78 inst, (38 mov, 0 mvi, 0 tex, 0 complex, 40 math)
#    32 64-bit, 46 32-bit, 0 32-bit-const
