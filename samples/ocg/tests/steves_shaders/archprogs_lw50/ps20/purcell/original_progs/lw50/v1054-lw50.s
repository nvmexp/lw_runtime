...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1054-lw40.s -o allprogs-new32//v1054-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 223 instructions, 32 R-regs
# 223 inst, (46 mov, 0 mvi, 0 tex, 6 complex, 171 math)
#    130 64-bit, 93 32-bit, 0 32-bit-const
