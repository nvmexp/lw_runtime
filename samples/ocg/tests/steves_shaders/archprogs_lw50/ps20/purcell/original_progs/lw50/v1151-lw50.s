...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1151-lw40.s -o allprogs-new32//v1151-lw50.s
#vendor LWPU
...
# 95 inst, (52 mov, 0 mvi, 0 tex, 1 complex, 42 math)
#    33 64-bit, 62 32-bit, 0 32-bit-const
