...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1108-lw40.s -o allprogs-new32//v1108-lw50.s
#vendor LWPU
...
MOV32    R12, c[35];
FMUL32   R10, R11, R10;
FMAD     R11, R8, c[34], R13;
RRO      R10, R10, 1;
FMUL32   R13, R7, c[37];
FMAD     o[0], R12, c[1], R11;
EX2      o[6], R10;
...
# 117 inst, (38 mov, 0 mvi, 0 tex, 7 complex, 72 math)
#    66 64-bit, 51 32-bit, 0 32-bit-const
