...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1070-lw40.s -o allprogs-new32//v1070-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 184 instructions, 28 R-regs
# 184 inst, (45 mov, 0 mvi, 0 tex, 2 complex, 137 math)
#    114 64-bit, 70 32-bit, 0 32-bit-const
