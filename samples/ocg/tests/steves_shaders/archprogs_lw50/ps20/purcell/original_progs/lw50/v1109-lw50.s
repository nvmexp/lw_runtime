...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1109-lw40.s -o allprogs-new32//v1109-lw50.s
#vendor LWPU
...
# 156 inst, (43 mov, 0 mvi, 0 tex, 2 complex, 111 math)
#    86 64-bit, 70 32-bit, 0 32-bit-const
