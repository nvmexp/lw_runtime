...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1135-lw40.s -o allprogs-new32//v1135-lw50.s
#vendor LWPU
...
# 101 inst, (47 mov, 0 mvi, 0 tex, 1 complex, 53 math)
#    49 64-bit, 52 32-bit, 0 32-bit-const
