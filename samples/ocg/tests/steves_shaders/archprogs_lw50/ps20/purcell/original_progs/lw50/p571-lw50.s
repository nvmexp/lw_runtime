...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p571-lw40.s -o allprogs-new32//p571-lw50.s
#vendor LWPU
...
FMAD     R2, R2, R5, R4;
END
# 54 instructions, 12 R-regs, 12 interpolants
# 54 inst, (1 mov, 0 mvi, 2 tex, 12 ipa, 2 complex, 37 math)
#    28 64-bit, 22 32-bit, 4 32-bit-const
