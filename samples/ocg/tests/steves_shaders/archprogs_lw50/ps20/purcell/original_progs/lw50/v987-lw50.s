...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v987-lw40.s -o allprogs-new32//v987-lw50.s
#vendor LWPU
...
FSET     R8, R2, c[13], LT;
FADD32   R7, -R3, c[136];
FMUL32   R6, R16, c[A2 + 93];
R2A      A0, R8;
FADD32   R8, -R4, c[137];
FMAD     R19, R15, c[A1 + 85], R6;
FADD32   R6, -R5, c[138];
FMUL32   R9, R8, R8;
FMAD     R19, R14, c[A0 + 101], R19;
FMAD     R9, R7, R7, R9;
FADD32   R18, R18, R19;
FMAD     R9, R6, R6, R9;
FMAD     R18, R17, R12, R18;
RSQ      R17, |R9|;
FMUL32   R7, R7, R17;
FMUL32   R8, R8, R17;
FMUL32   R6, R6, R17;
...
LG2      R10, |R10|;
LG2      R9, |R9|;
FMUL32   R17, R16, c[A2 + 92];
FMUL32   R10, R10, R13;
FMUL32   R9, R9, c[4];
FMAD     R17, R15, c[A1 + 84], R17;
RRO      R10, R10, 1;
RRO      R9, R9, 1;
FMAD     R17, R14, c[A0 + 100], R17;
EX2      R10, R10;
EX2      R18, R9;
FMUL32   R9, R6, c[128];
FADD32   R10, R10, R17;
FMUL32   R17, R18, c[7];
FMAD     R8, R8, R12, R10;
FMUL32   R10, R11, c[110];
FMUL     R11, v[9], c[5];
FMAD     R8, R9, R7, R8;
LG2      R9, |R11|;
LG2      R8, |R8|;
FMUL32   R9, R9, R13;
FMUL32   R11, R16, c[A2 + 94];
FMUL32   R8, R8, c[4];
RRO      R9, R9, 1;
FMAD     R11, R15, c[A1 + 86], R11;
RRO      R8, R8, 1;
EX2      R9, R9;
FMAD     R11, R14, c[A0 + 102], R11;
EX2      R8, R8;
FMUL32   R6, R6, c[130];
FADD32   R9, R9, R11;
FMUL32   R8, R8, c[7];
...
MOV32    o[7], R1;
END
# 234 instructions, 20 R-regs
# 234 inst, (39 mov, 0 mvi, 0 tex, 18 complex, 177 math)
#    141 64-bit, 93 32-bit, 0 32-bit-const
