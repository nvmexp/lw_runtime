...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1121-lw40.s -o allprogs-new32//v1121-lw50.s
#vendor LWPU
...
FADD32   R9, -R4, c[137];
FADD32   R7, -R5, c[138];
FMAD     R11, R17, c[A1 + 84], R6;
FMUL32   R6, R9, R9;
FMAD     R11, R16, c[A0 + 100], R11;
FMAD     R6, R8, R8, R6;
...
FMAD     o[5], R6, R8, R12;
FMAD     R6, v[9], c[172], R9;
FMAD     o[6], R7, R8, R10;
FMUL     R9, v[10], c[177];
FMAD     R7, v[11], c[174], R6;
FMUL     R8, v[10], c[169];
FMAD     R6, v[9], c[176], R9;
FMUL32   R9, R7, R2;
...
MOV32    o[7], R0;
END
# 195 instructions, 20 R-regs
# 195 inst, (44 mov, 0 mvi, 0 tex, 6 complex, 145 math)
#    102 64-bit, 93 32-bit, 0 32-bit-const
