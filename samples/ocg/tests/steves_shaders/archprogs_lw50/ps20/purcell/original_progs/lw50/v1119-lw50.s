...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1119-lw40.s -o allprogs-new32//v1119-lw50.s
#vendor LWPU
...
FMUL32   R16, R11, c[A2 + 93];
FMUL32   R14, R14, R13;
FMUL     R17, v[8], c[5];
FMAD     R16, R10, c[A1 + 85], R16;
RRO      R14, R14, 1;
LG2      R17, |R17|;
FMAD     R16, R9, c[A0 + 101], R16;
EX2      R14, R14;
FMUL32   R17, R17, R13;
...
FMAD     o[5], R15, R8, R10;
LG2      R10, |R11|;
FMAD     R11, v[12], c[172], R7;
FMUL     R7, v[13], c[177];
FMUL32   R12, R10, R13;
FMAD     R10, v[14], c[174], R11;
FMAD     R7, v[12], c[176], R7;
RRO      R12, R12, 1;
FMUL32   R11, R10, R2;
FMAD     R7, v[14], c[178], R7;
EX2      R13, R12;
FMUL     R12, v[13], c[169];
FMAD     R11, R1, R7, -R11;
FADD32   R9, R9, R13;
FMAD     R12, v[12], c[168], R12;
FMUL     o[24], v[15], R11;
FMAD     o[6], R6, R8, R9;
FMAD     R6, v[14], c[170], R12;
FMUL32   R9, R7, R0;
FMUL32   R11, R4, c[41];
FMUL32   R8, R6, R1;
FMAD     R9, R2, R6, -R9;
...
MOV32    o[7], R0;
END
# 168 instructions, 20 R-regs
# 168 inst, (43 mov, 0 mvi, 0 tex, 9 complex, 116 math)
#    93 64-bit, 75 32-bit, 0 32-bit-const
