...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1013-lw40.s -o allprogs-new32//v1013-lw50.s
#vendor LWPU
...
# 99 inst, (43 mov, 0 mvi, 0 tex, 1 complex, 55 math)
#    52 64-bit, 47 32-bit, 0 32-bit-const
