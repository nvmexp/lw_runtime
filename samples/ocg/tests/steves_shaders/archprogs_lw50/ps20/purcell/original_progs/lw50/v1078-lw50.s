...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1078-lw40.s -o allprogs-new32//v1078-lw50.s
#vendor LWPU
...
FMUL     R4, v[10], c[173];
FMUL32   R3, R3, c[120];
FMAD     R7, v[6], c[178], R5;
FMAD     R5, v[9], c[172], R4;
RRO      R4, R3, 1;
FMUL     R3, v[5], c[173];
FMAD     R14, v[11], c[174], R5;
EX2      R5, R4;
FMAD     R3, v[4], c[172], R3;
FMUL32   R4, R7, R14;
FMIN     R26, R5, c[1];
FMAD     R9, v[6], c[174], R3;
FMUL     R3, v[10], c[177];
FMUL32   R6, R26, c[108];
FMUL     R5, v[5], c[169];
...
FMAD     R12, v[11], c[178], R3;
FMUL     R3, v[10], c[169];
FMAD     R8, v[6], c[170], R5;
FMAD     R5, R9, R12, -R4;
FMAD     R4, v[9], c[168], R3;
FMUL32   R3, R8, R12;
FMUL     R18, v[12], R5;
FMAD     R13, v[11], c[170], R4;
FMAD     R5, R7, R13, -R3;
FMUL32   R4, R9, R13;
FMUL32   R3, R14, c[12];
FMUL     R19, v[12], R5;
...
FMAD     R26, R17, c[7], R26;
FMAD     R21, R12, c[7], R21;
FMUL32   R3, R9, c[6];
FMUL32   R22, R26, R25;
FMUL32   R30, R26, R26;
FMAD     R3, R7, c[7], R3;
...
FMUL32   R21, R9, c[5];
FMAD     R3, R17, c[5], R3;
FMAD     R22, R13, c[4], R22;
FMAD     R21, R8, c[4], R21;
FMUL32   R26, R3, R25;
FMAD     R22, R12, c[5], R22;
FMAD     R21, R7, c[5], R21;
FMUL32   R25, R3, R3;
...
MOV32    o[7], R1;
END
# 263 instructions, 36 R-regs
# 263 inst, (40 mov, 0 mvi, 0 tex, 6 complex, 217 math)
#    160 64-bit, 103 32-bit, 0 32-bit-const
