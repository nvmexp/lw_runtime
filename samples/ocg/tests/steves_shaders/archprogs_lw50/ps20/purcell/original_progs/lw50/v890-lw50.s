...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v890-lw40.s -o allprogs-new32//v890-lw50.s
#vendor LWPU
...
R2A      A3, R13;
R2A      A1, R8;
FMUL32   R8, R12, c[A3 + 93];
FMAD     R13, R11, c[A2 + 85], R8;
FMUL32   R8, R6, c[108];
FMAD     R15, R10, c[A1 + 101], R13;
FMUL32   R8, R8, R7;
...
FMUL32   R13, R13, c[7];
FMUL32   R6, R6, R7;
FMAD     R7, R11, c[A2 + 86], R12;
FMUL32   R8, R8, c[4];
FMAD     R7, R10, c[A1 + 102], R7;
RRO      R8, R8, 1;
FMAD     R6, R6, R9, R7;
EX2      R7, R8;
LG2      R6, |R6|;
...
RCP      R12, R9;
FMUL     R9, v[13], c[A0 + 169];
FMAD     R6, v[14], c[A0 + 178], R6;
FMUL32   o[4], R10, R12;
FMUL32   o[5], R13, R12;
FMUL32   o[6], R11, R12;
FMAD     R8, R1, R6, -R8;
FMAD     R10, v[12], c[A0 + 168], R9;
FMUL32   R9, R6, R0;
FMUL     o[23], v[15], R8;
...
MOV32    o[7], R0;
END
# 204 instructions, 16 R-regs
# 204 inst, (38 mov, 0 mvi, 0 tex, 11 complex, 155 math)
#    122 64-bit, 82 32-bit, 0 32-bit-const
