...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v318-lw40.s -o allprogs-new32//v318-lw50.s
#vendor LWPU
...
FMUL32   R11, R6, c[53];
FMUL32   R10, R9, R9;
FMAD     R11, R4, c[52], R11;
FMAD     R10, R7, R7, R10;
FMUL32   R12, R6, c[57];
FMAD     R11, R5, c[54], R11;
FMAD     R10, R8, R8, R10;
FMAD     R12, R4, c[56], R12;
FMAD     o[12], v[3], c[55], R11;
RSQ      R10, |R10|;
FMAD     R11, R5, c[58], R12;
FMUL32   R12, R6, c[61];
FMUL32   o[27], R7, R10;
FMUL32   o[28], R9, R10;
FMUL32   o[29], R8, R10;
FMAD     o[13], v[3], c[59], R11;
FMAD     R7, R4, c[60], R12;
FMUL32   R8, R6, c[1];
FMUL32   R9, R6, c[5];
FMAD     R7, R5, c[62], R7;
...
# 123 inst, (17 mov, 0 mvi, 0 tex, 3 complex, 103 math)
#    97 64-bit, 26 32-bit, 0 32-bit-const
