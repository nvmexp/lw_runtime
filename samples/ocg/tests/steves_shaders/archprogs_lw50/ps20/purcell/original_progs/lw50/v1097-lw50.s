...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1097-lw40.s -o allprogs-new32//v1097-lw50.s
#vendor LWPU
...
FMAD     R10, R3, c[12], R9;
FMUL32   R9, R2, c[12];
FMAD     R11, R7, c[12], R11;
FMAD     R9, R1, c[12], R9;
FMAD     R12, R6, c[12], R11;
FMAD     R11, R0, c[12], R9;
FMUL32   R9, R12, -c[113];
FMUL32   R13, R12, R12;
FSET     R14, R12, c[0], LT;
...
FMUL32   R15, R13, c[A2 + 93];
R2A      A0, R11;
FMUL32   R11, R13, c[A2 + 94];
FMAD     R13, R12, c[A1 + 85], R15;
FMAD     R14, R10, c[A0 + 100], R14;
FMAD     R11, R12, c[A1 + 86], R11;
FMAD     R12, R10, c[A0 + 101], R13;
FMAD     o[30], R9, c[108], R14;
FMAD     R10, R10, c[A0 + 102], R11;
...
MOV32    o[7], R1;
END
# 192 instructions, 16 R-regs
# 192 inst, (39 mov, 0 mvi, 0 tex, 0 complex, 153 math)
#    122 64-bit, 70 32-bit, 0 32-bit-const
