...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v977-lw40.s -o allprogs-new32//v977-lw50.s
#vendor LWPU
...
FMAD     R0, v[3], c[172], R1;
FMAD     R2, -R3, R2, c[64];
FMUL     R1, v[4], c[177];
FMAD     o[30], v[5], c[174], R0;
MOV32    o[32], R2;
FMAD     R0, v[3], c[176], R1;
MOV32    o[33], R2;
MOV32    o[34], R2;
MOV32    o[35], R2;
FMAD     o[31], v[5], c[178], R0;
FMUL     R0, v[14], c[169];
FMUL     R1, v[14], c[173];
FMUL     R2, v[14], c[177];
FMAD     R0, v[13], c[168], R0;
FMAD     R1, v[13], c[172], R1;
FMAD     R2, v[13], c[176], R2;
FMAD     o[26], v[15], c[170], R0;
FMAD     o[27], v[15], c[174], R1;
FMAD     o[28], v[15], c[178], R2;
FMUL     R0, v[11], c[169];
FMUL     R1, v[11], c[173];
FMUL     R2, v[11], c[177];
FMAD     R0, v[10], c[168], R0;
FMAD     R1, v[10], c[172], R1;
FMAD     R2, v[10], c[176], R2;
FMAD     o[23], v[12], c[170], R0;
FMAD     o[24], v[12], c[174], R1;
FMAD     o[25], v[12], c[178], R2;
FMUL     R0, v[1], c[169];
FMUL     R1, v[1], c[173];
...
FMUL     R2, v[6], c[380];
FADD32   o[22], -R0, c[10];
FMAD     o[16], v[7], c[377], R1;
FMAD     o[17], v[7], c[381], R2;
MOV32    R0, c[0];
MOV32    R1, c[0];
MOV      o[12], v[8];
MOV32    o[18], R0;
...
MOV32    o[14], R0;
MOV32    o[15], R1;
FMAD     o[10], v[7], c[369], R2;
FMUL     R0, v[6], c[372];
FMUL     R1, v[6], c[360];
FMUL     R2, v[6], c[364];
FMAD     o[11], v[7], c[373], R0;
...
# 91 inst, (20 mov, 0 mvi, 0 tex, 0 complex, 71 math)
#    63 64-bit, 28 32-bit, 0 32-bit-const
