...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v879-lw40.s -o allprogs-new32//v879-lw50.s
#vendor LWPU
...
R2A      A2, R12;
R2A      A0, R7;
FMUL32   R7, R11, c[A2 + 93];
FMAD     R14, R10, c[A1 + 85], R7;
FMUL32   R7, R6, c[108];
FMUL32   R12, R11, c[A2 + 92];
FMAD     R14, R9, c[A0 + 101], R14;
...
RRO      R12, R12, 1;
FMUL32   R13, R6, c[110];
FMUL32   R6, R11, c[A2 + 94];
EX2      R11, R12;
FMUL32   R7, R7, c[4];
FMAD     R10, R10, c[A1 + 86], R6;
FMUL32   R6, R11, c[7];
RRO      R7, R7, 1;
...
FMUL     R7, v[12], c[173];
FMUL32   R12, R8, c[7];
FMAD     R7, v[11], c[172], R7;
FMAX     R10, R12, c[12];
FMAD     R8, v[13], c[174], R7;
FMUL     R7, v[12], c[177];
FMAX     R10, R9, R10;
FMUL32   R9, R8, R2;
FMAD     R7, v[11], c[176], R7;
RCP      R13, R10;
FMUL     R10, v[12], c[169];
FMAD     R7, v[13], c[178], R7;
FMUL32   o[4], R11, R13;
FMUL32   o[5], R6, R13;
FMUL32   o[6], R12, R13;
FMAD     R6, R1, R7, -R9;
...
MOV32    o[7], R1;
END
# 185 instructions, 16 R-regs
# 185 inst, (37 mov, 0 mvi, 0 tex, 9 complex, 139 math)
#    113 64-bit, 72 32-bit, 0 32-bit-const
