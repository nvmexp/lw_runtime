...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1144-lw40.s -o allprogs-new32//v1144-lw50.s
#vendor LWPU
...
FMUL     R1, v[3], c[372];
FMUL     R2, v[3], c[380];
FMAD     o[12], v[4], c[369], R0;
FMAD     o[13], v[4], c[373], R1;
FMAD     o[14], v[4], c[381], R2;
FMUL     R0, v[3], c[376];
FMUL     R1, v[3], c[360];
FMUL     R2, v[3], c[364];
FMAD     o[15], v[4], c[377], R0;
FMAD     o[8], v[4], c[361], R1;
FMAD     o[9], v[4], c[365], R2;
FMUL     R0, v[3], c[384];
FMUL     R1, v[3], c[388];
MOV32    o[4], c[152];
FMAD     o[10], v[4], c[385], R0;
FMAD     o[11], v[4], c[389], R1;
MOV32    o[5], c[153];
MOV32    o[6], c[154];
MOV32    o[7], c[155];
END
# 95 instructions, 8 R-regs
# 95 inst, (47 mov, 0 mvi, 0 tex, 0 complex, 48 math)
#    47 64-bit, 48 32-bit, 0 32-bit-const
