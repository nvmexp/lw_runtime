...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1034-lw40.s -o allprogs-new32//v1034-lw50.s
#vendor LWPU
...
FMAD     R10, v[10], R6, R10;
FMAD     R14, v[13], R11, R14;
RRO      R12, R12, 1;
FMUL     R13, v[9], R13;
FMAD     R16, v[15], R9, R14;
EX2      R12, R12;
FMAD     R11, v[8], R11, R13;
FMUL     R8, v[14], R8;
FMIN     R26, R12, c[1];
FMAD     R12, v[10], R9, R11;
FMAD     R9, v[13], R7, R8;
FMUL32   R8, R26, c[108];
FMUL32   R7, R10, R16;
FMAD     R14, v[15], R6, R9;
...
MOV32    o[7], R1;
END
# 304 instructions, 36 R-regs
# 304 inst, (42 mov, 0 mvi, 0 tex, 8 complex, 254 math)
#    194 64-bit, 110 32-bit, 0 32-bit-const
