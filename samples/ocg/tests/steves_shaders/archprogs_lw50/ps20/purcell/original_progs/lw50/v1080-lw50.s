...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1080-lw40.s -o allprogs-new32//v1080-lw50.s
#vendor LWPU
...
FMAD     R3, v[8], R1, R3;
FMAD     R14, v[13], R1, R14;
FMAD     R3, v[10], R0, R3;
FMAD     R14, v[15], R0, R14;
FMUL32   R17, R7, -c[113];
FMUL32   R15, R12, R3;
FMUL32   R16, R14, R7;
FMAD     R17, R3, -c[112], R17;
FMAD     R15, R11, R14, -R15;
FMAD     R16, R3, R13, -R16;
FMAD     R17, R11, -c[114], R17;
FMUL     o[25], v[16], R15;
FMUL     o[26], v[16], R16;
FMAX     R15, R17, c[0];
FMUL32   R18, R3, R3;
...
R2A      A4, R17;
FSET     R17, R11, c[0], LT;
FMUL32   R20, R19, c[A4 + 92];
R2A      A2, R17;
FMUL32   R17, R19, c[A4 + 93];
FMUL32   R19, R19, c[A4 + 94];
FMAD     R20, R18, c[A3 + 84], R20;
FMAD     R17, R18, c[A3 + 85], R17;
FMAD     R18, R18, c[A3 + 86], R19;
FMAD     R19, R16, c[A2 + 100], R20;
FMAD     R17, R16, c[A2 + 101], R17;
FMAD     R16, R16, c[A2 + 102], R18;
FMAD     o[4], R15, c[108], R19;
FMAD     o[5], R15, c[109], R17;
FMAD     o[6], R15, c[110], R16;
FMUL     R2, v[1], R2;
FMUL     R15, v[1], R6;
...
MOV32    o[7], R0;
END
# 154 instructions, 24 R-regs
# 154 inst, (43 mov, 0 mvi, 0 tex, 0 complex, 111 math)
#    99 64-bit, 55 32-bit, 0 32-bit-const
