...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v957-lw40.s -o allprogs-new32//v957-lw50.s
#vendor LWPU
...
FMUL     R1, v[16], c[173];
FMUL     R2, v[16], c[177];
FMAD     R0, v[15], c[168], R0;
FMAD     R1, v[15], c[172], R1;
FMAD     R2, v[15], c[176], R2;
FMAD     o[26], v[17], c[170], R0;
FMAD     o[27], v[17], c[174], R1;
FMAD     o[28], v[17], c[178], R2;
FMUL     R0, v[13], c[169];
FMUL     R1, v[13], c[173];
FMUL     R2, v[13], c[177];
...
FMAD     o[23], v[14], c[170], R0;
FMAD     o[24], v[14], c[174], R1;
FMAD     o[25], v[14], c[178], R2;
FMUL     R0, v[1], c[169];
FMUL     R1, v[1], c[173];
...
FMUL     R1, v[6], c[372];
FMUL     R2, v[6], c[360];
FMAD     o[10], v[7], c[369], R0;
FMAD     o[11], v[7], c[373], R1;
FMAD     o[8], v[7], c[361], R2;
FMUL     R0, v[6], c[364];
MOV32    o[4], c[152];
MOV32    o[5], c[153];
FMAD     o[9], v[7], c[365], R0;
MOV32    o[6], c[154];
MOV32    o[7], c[155];
FMUL     R0, v[1], c[17];
MOV32    o[2], R3;
...
# 92 inst, (19 mov, 0 mvi, 0 tex, 0 complex, 73 math)
#    65 64-bit, 27 32-bit, 0 32-bit-const
