...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v899-lw40.s -o allprogs-new32//v899-lw50.s
#vendor LWPU
...
# 39 inst, (8 mov, 0 mvi, 0 tex, 0 complex, 31 math)
#    33 64-bit, 6 32-bit, 0 32-bit-const
