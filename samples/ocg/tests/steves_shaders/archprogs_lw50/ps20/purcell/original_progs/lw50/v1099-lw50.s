...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1099-lw40.s -o allprogs-new32//v1099-lw50.s
#vendor LWPU
...
FMAD     R5, v[4], c[A0 + 169], R2;
FMAD     R3, v[4], c[A0 + 170], R0;
FMUL     R2, v[5], c[A1 + 171];
FMUL     R0, v[1], R5;
FMUL     R4, v[5], c[A1 + 172];
FMAD     R2, v[4], c[A0 + 171], R2;
FMAD     R0, v[0], R1, R0;
FMAD     R9, v[4], c[A0 + 172], R4;
FMUL     R6, v[5], c[A1 + 173];
FMAD     R4, v[2], R3, R0;
FMUL     R0, v[5], c[A1 + 174];
FMAD     R18, v[4], c[A0 + 173], R6;
FMAD     R12, v[3], R2, R4;
FMAD     R2, v[4], c[A0 + 174], R0;
FMUL     R0, v[1], R18;
...
FMAD     R6, v[2], R2, R6;
FMAD     R7, v[4], c[A0 + 176], R0;
FMUL     R0, v[5], c[A1 + 177];
FMAD     R13, v[3], R4, R6;
FMUL     R4, v[5], c[A1 + 178];
FMAD     R8, v[4], c[A0 + 177], R0;
FMUL     R0, v[5], c[A1 + 179];
FMAD     R4, v[4], c[A0 + 178], R4;
FADD32   R15, -R13, c[117];
FMAD     R10, v[4], c[A0 + 179], R0;
FMUL     R6, v[1], R8;
FMUL32   R0, R15, R15;
FMAD     R11, v[0], R7, R6;
FMAD     R0, R16, R16, R0;
...
MOV32    o[7], R1;
END
# 273 instructions, 28 R-regs
# 273 inst, (42 mov, 0 mvi, 0 tex, 4 complex, 227 math)
#    181 64-bit, 92 32-bit, 0 32-bit-const
