...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1052-lw40.s -o allprogs-new32//v1052-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 193 instructions, 24 R-regs
# 193 inst, (46 mov, 0 mvi, 0 tex, 2 complex, 145 math)
#    124 64-bit, 69 32-bit, 0 32-bit-const
