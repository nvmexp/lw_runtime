...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1022-lw40.s -o allprogs-new32//v1022-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 117 instructions, 16 R-regs
# 117 inst, (39 mov, 0 mvi, 0 tex, 0 complex, 78 math)
#    65 64-bit, 52 32-bit, 0 32-bit-const
