...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p514-lw40.s -o allprogs-new32//p514-lw50.s
#vendor LWPU
...
END
# 51 instructions, 16 R-regs, 14 interpolants
# 51 inst, (1 mov, 3 mvi, 2 tex, 14 ipa, 1 complex, 30 math)
#    36 64-bit, 10 32-bit, 5 32-bit-const
