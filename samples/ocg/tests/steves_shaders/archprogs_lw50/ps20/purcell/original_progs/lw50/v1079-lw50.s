...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1079-lw40.s -o allprogs-new32//v1079-lw50.s
#vendor LWPU
...
FMUL     R15, v[15], R3;
FMAD     R4, v[9], R2, R4;
FMAD     R15, v[14], R2, R15;
FMAD     R4, v[11], R1, R4;
FMUL32   R17, R8, -c[113];
FMAD     R15, v[16], R1, R15;
FMUL32   R16, R13, R4;
FMAD     R18, R4, -c[112], R17;
FMUL32   R17, R15, R8;
FMAD     R16, R12, R15, -R16;
FMAD     R18, R12, -c[114], R18;
FMAD     R17, R4, R14, -R17;
FMUL     o[25], v[17], R16;
FMAX     R16, R18, c[0];
FMUL     o[26], v[17], R17;
...
R2A      A5, R18;
FSET     R18, R12, c[0], LT;
FMUL32   R21, R20, c[A5 + 92];
R2A      A3, R18;
FMUL32   R18, R20, c[A5 + 93];
FMUL32   R20, R20, c[A5 + 94];
FMAD     R21, R19, c[A4 + 84], R21;
FMAD     R18, R19, c[A4 + 85], R18;
FMAD     R19, R19, c[A4 + 86], R20;
FMAD     R20, R17, c[A3 + 100], R21;
FMAD     R18, R17, c[A3 + 101], R18;
FMAD     R17, R17, c[A3 + 102], R19;
FMAD     o[4], R16, c[108], R20;
FMAD     o[5], R16, c[109], R18;
FMAD     o[6], R16, c[110], R17;
FMUL     R3, v[1], R3;
FMUL     R16, v[1], R7;
...
MOV32    o[7], R0;
END
# 171 instructions, 24 R-regs
# 171 inst, (45 mov, 0 mvi, 0 tex, 0 complex, 126 math)
#    115 64-bit, 56 32-bit, 0 32-bit-const
