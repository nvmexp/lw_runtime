...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1028-lw40.s -o allprogs-new32//v1028-lw50.s
#vendor LWPU
...
# 113 inst, (36 mov, 0 mvi, 0 tex, 1 complex, 76 math)
#    72 64-bit, 41 32-bit, 0 32-bit-const
