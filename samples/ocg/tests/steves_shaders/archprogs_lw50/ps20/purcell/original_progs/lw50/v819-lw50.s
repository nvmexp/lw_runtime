...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v819-lw40.s -o allprogs-new32//v819-lw50.s
#vendor LWPU
...
FMAD     R13, R11, c[A1 + 85], R8;
FMUL32   R8, R6, c[108];
FMAD     R15, R10, c[A0 + 101], R13;
FMUL32   R8, R8, R7;
...
FMUL32   R13, R13, c[7];
FMUL32   R6, R6, R7;
FMAD     R7, R11, c[A1 + 86], R12;
FMUL32   R8, R8, c[4];
FMAD     R7, R10, c[A0 + 102], R7;
RRO      R8, R8, 1;
FMAD     R6, R6, R9, R7;
EX2      R7, R8;
LG2      R6, |R6|;
...
MOV32    o[7], R1;
END
# 202 instructions, 16 R-regs
# 202 inst, (37 mov, 0 mvi, 0 tex, 11 complex, 154 math)
#    120 64-bit, 82 32-bit, 0 32-bit-const
