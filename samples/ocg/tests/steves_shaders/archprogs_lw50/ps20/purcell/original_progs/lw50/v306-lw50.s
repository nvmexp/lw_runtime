...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v306-lw40.s -o allprogs-new32//v306-lw50.s
#vendor LWPU
...
FMAD     R5, R0, c[42], R5;
FMAD     R6, R0, c[46], R6;
FMAD     o[20], v[3], c[39], R4;
FMAD     o[21], v[3], c[43], R5;
FMAD     o[22], v[3], c[47], R6;
FMAD     R1, R2, c[48], R1;
FMUL32   R4, R3, c[53];
FMUL32   R5, R3, c[57];
FMAD     R1, R0, c[50], R1;
FMAD     R4, R2, c[52], R4;
FMAD     R5, R2, c[56], R5;
FMAD     o[23], v[3], c[51], R1;
FMAD     R1, R0, c[54], R4;
FMAD     R4, R0, c[58], R5;
FMUL32   R5, R3, c[61];
FMAD     o[12], v[3], c[55], R1;
FMAD     o[13], v[3], c[59], R4;
FMAD     R1, R2, c[60], R5;
FMUL32   R4, R3, c[1];
FMUL32   R5, R3, c[5];
FMAD     R1, R0, c[62], R1;
...
# 109 inst, (13 mov, 0 mvi, 0 tex, 1 complex, 95 math)
#    90 64-bit, 19 32-bit, 0 32-bit-const
