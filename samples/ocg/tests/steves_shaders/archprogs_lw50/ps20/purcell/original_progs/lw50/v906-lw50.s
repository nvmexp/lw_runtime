...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v906-lw40.s -o allprogs-new32//v906-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 227 instructions, 28 R-regs
# 227 inst, (36 mov, 0 mvi, 0 tex, 11 complex, 180 math)
#    148 64-bit, 79 32-bit, 0 32-bit-const
