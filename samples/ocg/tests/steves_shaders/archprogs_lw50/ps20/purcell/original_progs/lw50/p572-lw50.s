...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p572-lw40.s -o allprogs-new32//p572-lw50.s
#vendor LWPU
...
END
# 58 instructions, 12 R-regs, 12 interpolants
# 58 inst, (0 mov, 0 mvi, 2 tex, 12 ipa, 2 complex, 42 math)
#    30 64-bit, 22 32-bit, 6 32-bit-const
