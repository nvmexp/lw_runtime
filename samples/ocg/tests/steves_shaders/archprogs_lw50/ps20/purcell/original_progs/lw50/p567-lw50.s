...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p567-lw40.s -o allprogs-new32//p567-lw50.s
#vendor LWPU
...
FMAD     R2, R6, R2, c[2];
END
# 75 instructions, 16 R-regs, 15 interpolants
# 75 inst, (1 mov, 7 mvi, 3 tex, 15 ipa, 3 complex, 46 math)
#    55 64-bit, 19 32-bit, 1 32-bit-const
