...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v975-lw40.s -o allprogs-new32//v975-lw50.s
#vendor LWPU
...
# 90 inst, (23 mov, 0 mvi, 0 tex, 0 complex, 67 math)
#    59 64-bit, 31 32-bit, 0 32-bit-const
