...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1041-lw40.s -o allprogs-new32//v1041-lw50.s
#vendor LWPU
...
MOV32    R7, c[1];
FMAD     R8, R2, R8, R9;
FMAD     R9, R10, R11, c[124];
MOV32    R10, R7;
FMAX     R11, R8, c[0];
FMAD     R7, R6, c[126], R9;
FMAD     R6, R6, -c[127], R10;
FMUL32   R12, R11, c[108];
RCP      R7, R7;
FMAX     R8, R6, c[0];
FMUL     R6, v[7], c[5];
MOV32    R9, c[4];
...
FSET     R8, R2, c[0], LT;
FADD32   R7, -R3, c[136];
FMUL32   R6, R18, c[A2 + 92];
R2A      A0, R8;
FADD32   R8, -R4, c[137];
FMAD     R19, R17, c[A1 + 84], R6;
FADD32   R6, -R5, c[138];
FMUL32   R9, R8, R8;
FMAD     R19, R16, c[A0 + 100], R19;
FMAD     R9, R7, R7, R9;
FADD32   R15, R15, R19;
FMAD     R9, R6, R6, R9;
FMAD     R15, R12, R13, R15;
RSQ      R12, |R9|;
FMUL32   R7, R7, R12;
FMUL32   R8, R8, R12;
FMUL32   R6, R6, R12;
...
FMUL32   R8, R1, R8;
MOV32    R19, c[145];
FMAD     R10, R9, -c[147], R10;
FMAD     R7, R0, R7, R8;
FMAD     R8, R19, R12, c[144];
FMAX     R10, R10, c[0];
FMAD     R6, R2, R6, R7;
FMAD     R8, R9, c[146], R8;
FMIN     R7, R10, c[1];
...
FMUL32   R7, R10, R7;
FMUL     R10, v[8], c[5];
FMUL32   R12, R18, c[A2 + 93];
FMAD     o[4], R9, R7, R15;
LG2      R10, |R10|;
FMAD     R12, R17, c[A1 + 85], R12;
FMUL32   R9, R6, c[129];
FMUL32   R10, R10, R14;
FMAD     R12, R16, c[A0 + 101], R12;
FMUL32   R11, R11, c[110];
RRO      R10, R10, 1;
FMUL     R15, v[9], c[5];
EX2      R10, R10;
FMUL32   R18, R18, c[A2 + 94];
LG2      R15, |R15|;
FADD32   R10, R10, R12;
FMAD     R12, R17, c[A1 + 86], R18;
FMUL32   R14, R15, R14;
FMAD     R8, R8, R13, R10;
FMAD     R10, R16, c[A0 + 102], R12;
RRO      R12, R14, 1;
FMAD     o[5], R9, R7, R8;
FMUL32   R6, R6, c[130];
EX2      R12, R12;
...
FMUL     R8, v[13], c[177];
FADD32   R10, R12, R10;
FMAD     R9, v[12], c[172], R9;
FMAD     R8, v[12], c[176], R8;
FMAD     R10, R11, R13, R10;
FMAD     R9, v[14], c[174], R9;
FMAD     R8, v[14], c[178], R8;
FMAD     o[6], R6, R7, R10;
FMUL32   R10, R9, R2;
FMUL32   R7, R8, R0;
FMUL     R6, v[13], c[169];
FMAD     R10, R1, R8, -R10;
FMAD     R6, v[12], c[168], R6;
FMUL     o[24], v[15], R10;
FMUL32   R11, R4, c[41];
FMAD     R6, v[14], c[170], R6;
MOV32    R10, c[43];
...
MOV32    o[31], R0;
MOV32    o[32], R1;
FMAD     R0, v[11], c[361], R2;
FMUL     R1, v[10], c[364];
MOV32    o[8], c[0];
MOV32    o[16], R0;
FMAD     R1, v[11], c[365], R1;
MOV32    o[14], R0;
MOV32    o[12], R0;
MOV32    o[17], R1;
MOV32    o[15], R1;
...
MOV32    o[7], R0;
END
# 200 instructions, 20 R-regs
# 200 inst, (47 mov, 0 mvi, 0 tex, 11 complex, 142 math)
#    108 64-bit, 92 32-bit, 0 32-bit-const
