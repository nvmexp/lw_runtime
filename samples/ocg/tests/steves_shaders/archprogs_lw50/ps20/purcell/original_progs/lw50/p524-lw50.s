...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p524-lw40.s -o allprogs-new32//p524-lw50.s
#vendor LWPU
...
# 57 inst, (2 mov, 0 mvi, 2 tex, 12 ipa, 2 complex, 39 math)
#    30 64-bit, 22 32-bit, 5 32-bit-const
