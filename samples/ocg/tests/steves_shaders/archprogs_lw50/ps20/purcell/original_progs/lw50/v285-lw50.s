...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v285-lw40.s -o allprogs-new32//v285-lw50.s
#vendor LWPU
...
# 66 inst, (18 mov, 0 mvi, 0 tex, 2 complex, 46 math)
#    50 64-bit, 16 32-bit, 0 32-bit-const
