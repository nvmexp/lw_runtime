...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1134-lw40.s -o allprogs-new32//v1134-lw50.s
#vendor LWPU
...
FMAD     R3, v[12], c[A0 + 178], R3;
FMAD     R4, v[10], c[A0 + 168], R4;
FMAD     R1, v[7], c[A0 + 170], R1;
FMAD     R6, R2, R3, -R6;
FMAD     R4, v[12], c[A0 + 170], R4;
FMUL32   R8, R1, R3;
FMUL     R7, v[13], R6;
FMUL32   R6, R2, R4;
FMAD     R8, R0, R4, -R8;
...
FMUL32   R13, R12, R12;
FSET     R14, R12, c[0], LT;
FMAD     R9, R10, -c[112], R9;
FMUL32   R12, R10, R10;
R2A      A3, R14;
FMAD     R9, R11, -c[114], R9;
FSET     R10, R10, c[0], LT;
FMUL32   R14, R13, c[A3 + 92];
FMAX     R9, R9, c[0];
R2A      A2, R10;
FMUL32   R10, R11, R11;
FSET     R11, R11, c[0], LT;
FMAD     R14, R12, c[A2 + 84], R14;
FMUL32   R15, R13, c[A3 + 93];
R2A      A1, R11;
FMUL32   R11, R13, c[A3 + 94];
FMAD     R13, R12, c[A2 + 85], R15;
FMAD     R14, R10, c[A1 + 100], R14;
FMAD     R11, R12, c[A2 + 86], R11;
FMAD     R12, R10, c[A1 + 101], R13;
FMAD     o[30], R9, c[108], R14;
FMAD     R10, R10, c[A1 + 102], R11;
FMAD     o[31], R9, c[109], R12;
FMUL32   R11, R8, c[12];
FMAD     o[32], R9, c[110], R10;
FMUL32   R9, R5, c[12];
FMAD     R12, R6, c[13], R11;
FMUL32   R11, R2, c[12];
FMAD     R10, R3, c[13], R9;
FMUL32   R9, R12, -c[113];
FMAD     R11, R0, c[13], R11;
FMUL32   R13, R12, R12;
FMAD     R9, R10, -c[112], R9;
FSET     R14, R12, c[0], LT;
FMUL32   R12, R10, R10;
...
FMAD     R11, R12, c[A2 + 86], R11;
FMAD     R12, R10, c[A1 + 101], R13;
FMAD     o[8], R9, c[108], R14;
FMAD     R10, R10, c[A1 + 102], R11;
FMAD     o[9], R9, c[109], R12;
FMUL32   R11, R8, c[6];
FMAD     o[10], R9, c[110], R10;
FMUL32   R9, R5, c[6];
FMAD     R11, R7, c[5], R11;
FMUL32   R10, R2, c[6];
FMAD     R9, R4, c[5], R9;
...
FMAD     R11, R12, c[A2 + 86], R11;
FMAD     R12, R10, c[A1 + 101], R13;
FMAD     o[4], R9, c[108], R14;
FMAD     R10, R10, c[A1 + 102], R11;
FMAD     o[5], R9, c[109], R12;
MOV32    o[28], R6;
FMAD     o[6], R9, c[110], R10;
MOV32    o[25], R8;
MOV32    o[22], R7;
...
MOV32    o[7], R1;
END
# 194 instructions, 16 R-regs
# 194 inst, (40 mov, 0 mvi, 0 tex, 0 complex, 154 math)
#    124 64-bit, 70 32-bit, 0 32-bit-const
