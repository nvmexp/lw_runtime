...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v992-lw40.s -o allprogs-new32//v992-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 243 instructions, 28 R-regs
# 243 inst, (37 mov, 0 mvi, 0 tex, 11 complex, 195 math)
#    164 64-bit, 79 32-bit, 0 32-bit-const
