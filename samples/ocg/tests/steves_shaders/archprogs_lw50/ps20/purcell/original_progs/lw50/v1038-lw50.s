...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1038-lw40.s -o allprogs-new32//v1038-lw50.s
#vendor LWPU
...
FMAD     R7, v[8], R5, R7;
FMAD     R12, v[13], R5, R12;
FMAD     R7, v[10], R4, R7;
FMAD     R15, v[15], R4, R12;
FMUL32   R13, R7, R14;
FMUL32   R12, R11, R15;
FMAD     R13, R3, R15, -R13;
FMAD     R12, R7, R16, -R12;
...
FMUL32   R13, R16, c[7];
FMUL32   R12, R19, c[7];
FMAD     R13, R15, c[7], R13;
FMAD     R12, R18, c[7], R12;
FMAD     R13, R14, c[7], R13;
FMAD     R20, R17, c[7], R12;
FMUL32   R12, R13, R13;
FSET     R13, R13, c[0], LT;
FMUL32   R22, R20, R20;
FSET     R20, R20, c[0], LT;
...
R2A      A3, R20;
FMAD     R13, R7, c[7], R13;
FMUL32   R20, R22, c[A3 + 92];
FMUL32   R21, R22, c[A3 + 93];
FMAD     R13, R3, c[7], R13;
FMUL32   R22, R22, c[A3 + 94];
FMAD     R20, R12, c[A2 + 84], R20;
FMAD     R21, R12, c[A2 + 85], R21;
FMAD     R22, R12, c[A2 + 86], R22;
FMUL32   R12, R13, R13;
FSET     R13, R13, c[0], LT;
FMUL32   R23, R19, c[12];
R2A      A2, R13;
FMAD     R23, R17, c[13], R23;
FMUL32   R13, R16, c[12];
FMAD     o[30], R12, c[A2 + 100], R20;
FMAD     o[31], R12, c[A2 + 101], R21;
FMAD     o[32], R12, c[A2 + 102], R22;
FMAD     R13, R14, c[13], R13;
FMUL32   R12, R23, R23;
FSET     R22, R23, c[0], LT;
FMUL32   R20, R13, R13;
FSET     R21, R13, c[0], LT;
...
FMUL32   R13, R11, c[12];
R2A      A2, R21;
FMUL32   R21, R12, c[A3 + 92];
FMAD     R13, R3, c[13], R13;
FMUL32   R22, R12, c[A3 + 93];
FMUL32   R12, R12, c[A3 + 94];
FMAD     R21, R20, c[A2 + 84], R21;
FMAD     R22, R20, c[A2 + 85], R22;
FMAD     R20, R20, c[A2 + 86], R12;
FMUL32   R12, R13, R13;
FSET     R13, R13, c[0], LT;
FMUL32   R23, R19, c[6];
R2A      A2, R13;
FMAD     R13, R18, c[5], R23;
FMAD     o[8], R12, c[A2 + 100], R21;
FMAD     o[9], R12, c[A2 + 101], R22;
FMAD     o[10], R12, c[A2 + 102], R20;
FMAD     R13, R17, c[6], R13;
FMUL32   R12, R16, c[6];
FMUL32   R23, R13, R13;
FSET     R20, R13, c[0], LT;
FMAD     R13, R15, c[5], R12;
FMUL32   R12, R11, c[6];
R2A      A3, R20;
FMAD     R13, R14, c[6], R13;
FMAD     R12, R7, c[5], R12;
FMUL32   R21, R23, c[A3 + 92];
FMUL32   R20, R13, R13;
FSET     R13, R13, c[0], LT;
FMAD     R12, R3, c[6], R12;
FMUL32   R22, R23, c[A3 + 93];
R2A      A2, R13;
FMUL32   R23, R23, c[A3 + 94];
FMUL32   R13, R12, R12;
FMAD     R21, R20, c[A2 + 84], R21;
FSET     R12, R12, c[0], LT;
FMAD     R22, R20, c[A2 + 85], R22;
FMAD     R20, R20, c[A2 + 86], R23;
R2A      A2, R12;
MOV32    o[28], R17;
MOV32    o[25], R19;
FMAD     o[4], R13, c[A2 + 100], R21;
FMAD     o[5], R13, c[A2 + 101], R22;
FMAD     o[6], R13, c[A2 + 102], R20;
MOV32    o[22], R18;
FMUL     R6, v[1], R6;
FMUL     R12, v[1], R10;
...
MOV32    o[7], R1;
END
# 198 instructions, 24 R-regs
# 198 inst, (40 mov, 0 mvi, 0 tex, 0 complex, 158 math)
#    132 64-bit, 66 32-bit, 0 32-bit-const
