...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v910-lw40.s -o allprogs-new32//v910-lw50.s
#vendor LWPU
...
# 102 inst, (40 mov, 0 mvi, 0 tex, 1 complex, 61 math)
#    55 64-bit, 47 32-bit, 0 32-bit-const
