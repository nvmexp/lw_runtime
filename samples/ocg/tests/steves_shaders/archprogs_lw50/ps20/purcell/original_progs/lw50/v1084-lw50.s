...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1084-lw40.s -o allprogs-new32//v1084-lw50.s
#vendor LWPU
...
FMUL32   R1, R9, c[1];
FMUL32   R10, R9, R2;
FMAD     R9, R9, -c[127], R11;
FMUL32   R10, R10, c[125];
FMAX     R11, R9, c[0];
FMUL32   R9, R8, R2;
FMAD     R7, R7, c[124], R10;
FMIN     R10, R11, c[1];
FMUL32   R6, R6, R2;
FMAD     R1, R1, c[126], R7;
FMUL32   R8, R0, R2;
...
FSET     R12, R2, c[0], LT;
R2A      A3, R13;
FMUL32   R13, R14, c[109];
R2A      A1, R12;
FMUL32   R12, R11, c[A3 + 92];
FMUL32   R13, R13, R6;
FMUL32   R15, R14, c[110];
FMAD     R12, R10, c[A2 + 84], R12;
FMUL32   R14, R11, c[A3 + 93];
FMUL32   R6, R15, R6;
FMUL32   R11, R11, c[A3 + 94];
FMAD     R12, R9, c[A1 + 100], R12;
FMAD     R14, R10, c[A2 + 85], R14;
FMAD     R10, R10, c[A2 + 86], R11;
FMAD     o[4], R7, R8, R12;
FMAD     R7, R9, c[A1 + 101], R14;
FMAD     R10, R9, c[A1 + 102], R10;
FMUL     R9, v[11], c[A0 + 173];
FMAD     o[5], R13, R8, R7;
FMAD     o[6], R6, R8, R10;
FMAD     R7, v[10], c[A0 + 172], R9;
...
MOV32    o[7], R0;
END
# 168 instructions, 16 R-regs
# 168 inst, (44 mov, 0 mvi, 0 tex, 4 complex, 120 math)
#    89 64-bit, 79 32-bit, 0 32-bit-const
