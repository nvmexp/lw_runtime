...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1146-lw40.s -o allprogs-new32//v1146-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 260 instructions, 32 R-regs
# 260 inst, (46 mov, 0 mvi, 0 tex, 9 complex, 205 math)
#    155 64-bit, 105 32-bit, 0 32-bit-const
