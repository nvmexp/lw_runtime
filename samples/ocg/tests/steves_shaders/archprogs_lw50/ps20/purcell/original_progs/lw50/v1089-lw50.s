...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1089-lw40.s -o allprogs-new32//v1089-lw50.s
#vendor LWPU
...
FMUL     R14, v[15], R7;
FMAD     R8, v[9], R6, R8;
FMAD     R14, v[14], R6, R14;
FMAD     R8, v[11], R5, R8;
FMAD     R14, v[16], R5, R14;
FMUL32   R18, R13, R8;
FMUL32   R16, R14, R12;
FMAD     R18, R4, R14, -R18;
FMUL32   R19, R15, c[7];
FMAD     R16, R8, R15, -R16;
FMUL     R18, v[17], R18;
FMAD     R19, R14, c[7], R19;
FMUL     R16, v[17], R16;
FMUL32   R21, R18, c[7];
FMAD     R20, R13, c[7], R19;
FMUL32   R19, R12, c[7];
FMAD     R21, R17, c[7], R21;
FMAD     R19, R8, c[7], R19;
FMAD     R22, R16, c[7], R21;
FMAD     R21, R4, c[7], R19;
FMUL32   R19, R22, -c[113];
FMUL32   R23, R22, R22;
FSET     R24, R22, c[0], LT;
FMAD     R19, R20, -c[112], R19;
FMUL32   R22, R20, R20;
R2A      A5, R24;
FMAD     R19, R21, -c[114], R19;
FSET     R20, R20, c[0], LT;
FMUL32   R24, R23, c[A5 + 92];
FMAX     R19, R19, c[0];
R2A      A4, R20;
FMUL32   R20, R21, R21;
FSET     R21, R21, c[0], LT;
FMAD     R24, R22, c[A4 + 84], R24;
FMUL32   R25, R23, c[A5 + 93];
R2A      A3, R21;
FMUL32   R21, R23, c[A5 + 94];
FMAD     R23, R22, c[A4 + 85], R25;
FMAD     R24, R20, c[A3 + 100], R24;
FMAD     R21, R22, c[A4 + 86], R21;
FMAD     R22, R20, c[A3 + 101], R23;
FMAD     o[30], R19, c[108], R24;
FMAD     R20, R20, c[A3 + 102], R21;
FMAD     o[31], R19, c[109], R22;
FMUL32   R21, R18, c[12];
FMAD     o[32], R19, c[110], R20;
FMUL32   R19, R15, c[12];
FMAD     R22, R16, c[13], R21;
FMUL32   R21, R12, c[12];
FMAD     R20, R13, c[13], R19;
FMUL32   R19, R22, -c[113];
FMAD     R21, R4, c[13], R21;
FMUL32   R23, R22, R22;
FMAD     R19, R20, -c[112], R19;
FSET     R24, R22, c[0], LT;
FMUL32   R22, R20, R20;
...
FMAD     R21, R22, c[A4 + 86], R21;
FMAD     R22, R20, c[A3 + 101], R23;
FMAD     o[8], R19, c[108], R24;
FMAD     R20, R20, c[A3 + 102], R21;
FMAD     o[9], R19, c[109], R22;
FMUL32   R21, R18, c[6];
FMAD     o[10], R19, c[110], R20;
FMUL32   R19, R15, c[6];
FMAD     R21, R17, c[5], R21;
FMUL32   R20, R12, c[6];
FMAD     R19, R14, c[5], R19;
FMAD     R22, R16, c[6], R21;
FMAD     R21, R8, c[5], R20;
FMAD     R20, R13, c[6], R19;
FMUL32   R19, R22, -c[113];
FMAD     R21, R4, c[6], R21;
FMUL32   R23, R22, R22;
FMAD     R19, R20, -c[112], R19;
...
FMAD     R21, R22, c[A4 + 86], R21;
FMAD     R22, R20, c[A3 + 101], R23;
FMAD     o[4], R19, c[108], R24;
FMAD     R20, R20, c[A3 + 102], R21;
FMAD     o[5], R19, c[109], R22;
MOV32    o[28], R16;
FMAD     o[6], R19, c[110], R20;
MOV32    o[25], R18;
MOV32    o[22], R17;
FMUL     R7, v[1], R7;
FMUL     R16, v[1], R11;
...
MOV32    o[7], R1;
END
# 236 instructions, 28 R-regs
# 236 inst, (42 mov, 0 mvi, 0 tex, 0 complex, 194 math)
#    166 64-bit, 70 32-bit, 0 32-bit-const
