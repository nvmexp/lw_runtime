...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1086-lw40.s -o allprogs-new32//v1086-lw50.s
#vendor LWPU
...
FMUL32   R4, R0, R0;
R2A      A0, R15;
FMAD     R16, R4, c[A2 + 100], R16;
FMUL32   R15, R11, c[361];
FMUL32   R11, -c[A0 + 5], R11;
FMAD     R3, R3, R9, R16;
FMAD     R15, R2, c[360], R15;
FMAD     R2, -c[A0 + 4], R2, R11;
FMAD     R11, R0, c[362], R15;
FMAD     R0, -c[A0 + 6], R0, R2;
FMAX     R11, R11, c[0];
FMAX     R15, R0, c[0];
FMAX     R1, R1, c[4];
FMAD     R0, c[A0], R15, R3;
...
# 180 inst, (21 mov, 1 mvi, 0 tex, 10 complex, 148 math)
#    122 64-bit, 58 32-bit, 0 32-bit-const
