...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v834-lw40.s -o allprogs-new32//v834-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 210 instructions, 24 R-regs
# 210 inst, (36 mov, 0 mvi, 0 tex, 9 complex, 165 math)
#    141 64-bit, 69 32-bit, 0 32-bit-const
