...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v863-lw40.s -o allprogs-new32//v863-lw50.s
#vendor LWPU
...
FMUL32   o[6], R12, R13;
FMAD     R7, R1, R6, -R10;
FMAD     R10, v[11], c[168], R11;
FMUL32   R9, R6, R0;
FMUL     o[23], v[14], R7;
FMAD     R7, v[13], c[170], R10;
FMUL32   R11, R4, c[41];
MOV32    R10, c[43];
FMAD     R9, R2, R7, -R9;
...
MOV32    o[7], R1;
END
# 245 instructions, 20 R-regs
# 245 inst, (36 mov, 0 mvi, 0 tex, 15 complex, 194 math)
#    142 64-bit, 103 32-bit, 0 32-bit-const
