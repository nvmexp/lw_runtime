...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1098-lw40.s -o allprogs-new32//v1098-lw50.s
#vendor LWPU
...
MOV32    o[7], R2;
END
# 106 instructions, 16 R-regs
# 106 inst, (42 mov, 0 mvi, 0 tex, 0 complex, 64 math)
#    55 64-bit, 51 32-bit, 0 32-bit-const
