...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1123-lw40.s -o allprogs-new32//v1123-lw50.s
#vendor LWPU
...
FMAD     o[3], R2, c[1], R3;
FMUL     R1, v[4], c[173];
FMAD     o[19], v[5], c[170], R0;
FMUL     R0, v[4], c[177];
FMAD     R1, v[3], c[172], R1;
FMUL     R2, v[6], c[376];
FMAD     R0, v[3], c[176], R0;
FMAD     o[20], v[5], c[174], R1;
FMAD     o[14], v[7], c[377], R2;
FMAD     o[21], v[5], c[178], R0;
FMUL     R0, v[6], c[380];
MOV      o[12], v[8];
MOV      o[13], v[9];
FMAD     o[15], v[7], c[381], R0;
FMUL     R0, v[10], c[368];
FMUL     R1, v[10], c[372];
FMUL     R2, v[6], c[360];
FMAD     o[10], v[11], c[369], R0;
FMAD     o[11], v[11], c[373], R1;
...
# 74 inst, (21 mov, 0 mvi, 0 tex, 0 complex, 53 math)
#    52 64-bit, 22 32-bit, 0 32-bit-const
