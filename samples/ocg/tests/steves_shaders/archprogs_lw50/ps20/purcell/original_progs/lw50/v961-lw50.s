...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v961-lw40.s -o allprogs-new32//v961-lw50.s
#vendor LWPU
...
FADD32   R8, -R3, c[136];
R2A      A1, R6;
FMUL32   R6, R17, c[A3 + 93];
FADD32   R9, -R4, c[137];
FADD32   R7, -R5, c[138];
FMAD     R11, R16, c[A2 + 85], R6;
FMUL32   R6, R9, R9;
FMAD     R11, R15, c[A1 + 101], R11;
FMAD     R6, R8, R8, R6;
...
FMUL32   R8, R9, R8;
FMUL32   R9, R13, c[108];
FMUL32   R10, R17, c[A3 + 92];
FMAD     R6, R6, R8, R18;
FMAD     R10, R16, c[A2 + 84], R10;
LG2      R11, |R6|;
FMUL32   R6, R7, c[128];
FMAD     R10, R15, c[A1 + 100], R10;
FMUL32   R11, R11, c[4];
FMAD     R9, R9, R14, R10;
RRO      R10, R11, 1;
FMAD     R6, R6, R8, R9;
...
FMUL32   R11, R17, c[A3 + 94];
FMUL32   R9, R9, c[7];
LG2      R6, |R6|;
FMAD     R11, R16, c[A2 + 86], R11;
FMUL32   R7, R7, c[130];
FMUL32   R6, R6, c[4];
FMAD     R11, R15, c[A1 + 102], R11;
RRO      R6, R6, 1;
FMAD     R10, R10, R14, R11;
EX2      R6, R6;
FMAD     R7, R7, R8, R10;
FMUL32   R11, R6, c[7];
LG2      R6, |R7|;
...
# 216 inst, (39 mov, 0 mvi, 0 tex, 11 complex, 166 math)
#    130 64-bit, 86 32-bit, 0 32-bit-const
