...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1049-lw40.s -o allprogs-new32//v1049-lw50.s
#vendor LWPU
...
MOV32    o[22], R0;
MOV32    o[23], R1;
FMAD     R0, v[5], c[361], R2;
FMUL     R1, v[4], c[364];
MOV32    o[8], c[0];
MOV32    o[16], R0;
FMAD     R1, v[5], c[365], R1;
MOV32    o[14], R0;
MOV32    o[12], R0;
MOV32    o[17], R1;
MOV32    o[15], R1;
...
# 86 inst, (50 mov, 0 mvi, 0 tex, 0 complex, 36 math)
#    29 64-bit, 57 32-bit, 0 32-bit-const
