...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v981-lw40.s -o allprogs-new32//v981-lw50.s
#vendor LWPU
...
# 96 inst, (23 mov, 0 mvi, 0 tex, 1 complex, 72 math)
#    61 64-bit, 35 32-bit, 0 32-bit-const
