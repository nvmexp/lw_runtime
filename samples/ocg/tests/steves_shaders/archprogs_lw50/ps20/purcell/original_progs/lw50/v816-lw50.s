...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v816-lw40.s -o allprogs-new32//v816-lw50.s
#vendor LWPU
...
MOV32    o[7], R0;
END
# 286 instructions, 32 R-regs
# 286 inst, (36 mov, 0 mvi, 0 tex, 15 complex, 235 math)
#    186 64-bit, 100 32-bit, 0 32-bit-const
