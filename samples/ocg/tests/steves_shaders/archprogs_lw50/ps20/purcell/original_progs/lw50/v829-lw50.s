...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v829-lw40.s -o allprogs-new32//v829-lw50.s
#vendor LWPU
...
# 98 inst, (42 mov, 0 mvi, 0 tex, 0 complex, 56 math)
#    49 64-bit, 49 32-bit, 0 32-bit-const
