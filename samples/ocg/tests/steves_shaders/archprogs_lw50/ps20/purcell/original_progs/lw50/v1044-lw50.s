...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1044-lw40.s -o allprogs-new32//v1044-lw50.s
#vendor LWPU
...
FMUL32   R11, R3, c[1];
FMUL32   R19, R3, R15;
FMAD     R3, R3, -c[127], R21;
FMUL32   R19, R19, c[125];
FMAX     R3, R3, c[0];
FMUL32   R16, R16, R15;
FMAD     R17, R17, c[124], R19;
FMIN     R3, R3, c[1];
FMUL32   R18, R18, R15;
FMAD     R11, R11, c[126], R17;
FMUL32   R15, R7, R15;
FMUL32   R7, -R18, c[113];
RCP      R11, R11;
FMAD     R7, -R16, c[112], R7;
FMUL32   R22, R11, R3;
FMAD     R3, -R15, c[114], R7;
FMUL32   R17, R22, c[108];
FADD32   R3, R3, -c[122];
FMUL32   R7, R3, c[123];
FMUL     R3, v[10], R6;
FMAX     R7, R7, c[0];
...
R2A      A0, R15;
FMUL32   R15, R27, c[A2 + 92];
FADD32   R18, -R13, c[137];
FADD32   R16, -R14, c[138];
FMAD     R20, R26, c[A1 + 84], R15;
FMUL32   R15, R18, R18;
FMAD     R20, R25, c[A0 + 100], R20;
FMAD     R15, R17, R17, R15;
FMAD     R28, R19, R24, R20;
...
FMUL32   R18, R7, R18;
MOV32    R19, c[145];
FMAD     R21, R15, -c[147], R21;
FMAD     R17, R3, R17, R18;
FMAD     R18, R19, R20, c[144];
FMAX     R19, R21, c[0];
FMAD     R16, R11, R16, R17;
FMAD     R15, R15, c[146], R18;
FMIN     R17, R19, c[1];
FMAX     R16, R16, c[0];
RCP      R18, R15;
FMUL32   R19, R22, c[109];
FMUL32   R15, R16, c[128];
FMUL32   R17, R18, R17;
FMUL32   R18, R19, R23;
FMUL32   R19, R22, c[110];
FMAD     o[4], R15, R17, R28;
FMUL32   R15, R27, c[A2 + 93];
FMUL32   R19, R19, R23;
FMUL32   R20, R27, c[A2 + 94];
FMAD     R21, R26, c[A1 + 85], R15;
FMUL32   R15, R16, c[129];
FMAD     R20, R26, c[A1 + 86], R20;
FMAD     R21, R25, c[A0 + 101], R21;
FMUL32   R16, R16, c[130];
FMAD     R20, R25, c[A0 + 102], R20;
FMAD     R18, R18, R24, R21;
FMUL     R6, v[15], R6;
FMAD     R19, R19, R24, R20;
FMAD     o[5], R15, R17, R18;
FMAD     R5, v[14], R5, R6;
FMAD     o[6], R16, R17, R19;
FMUL     R6, v[15], R10;
FMAD     R4, v[16], R4, R5;
FMUL     R2, v[15], R2;
FMAD     R5, v[14], R9, R6;
...
MOV32    o[7], R0;
END
# 239 instructions, 32 R-regs
# 239 inst, (47 mov, 0 mvi, 0 tex, 6 complex, 186 math)
#    146 64-bit, 93 32-bit, 0 32-bit-const
