...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1132-lw40.s -o allprogs-new32//v1132-lw50.s
#vendor LWPU
...
FMUL     R0, v[10], c[177];
FMAD     R3, v[2], c[26], R1;
FMAD     R0, v[9], c[176], R0;
FMUL     R1, v[13], c[177];
FMAD     R3, v[3], c[27], R3;
FMAD     o[15], v[11], c[178], R0;
FMAD     R0, v[12], c[176], R1;
FMAD     R2, -R3, R2, c[64];
FMUL     R1, v[5], c[177];
FMAD     o[16], v[14], c[178], R0;
MOV32    o[18], R2;
...
FMUL     R1, v[13], c[173];
FMUL     R2, v[5], c[173];
FMAD     R0, v[9], c[172], R0;
FMAD     R1, v[12], c[172], R1;
FMAD     R2, v[4], c[172], R2;
FMAD     o[12], v[11], c[174], R0;
FMAD     o[13], v[14], c[174], R1;
FMAD     o[14], v[6], c[174], R2;
FMUL     R0, v[10], c[169];
FMUL     R1, v[13], c[169];
FMUL     R2, v[5], c[169];
FMAD     R0, v[9], c[168], R0;
FMAD     R1, v[12], c[168], R1;
FMAD     R2, v[4], c[168], R2;
FMAD     o[9], v[11], c[170], R0;
FMAD     o[10], v[14], c[170], R1;
FMAD     o[11], v[6], c[170], R2;
FMUL     R0, v[1], c[169];
FMUL     R1, v[1], c[173];
