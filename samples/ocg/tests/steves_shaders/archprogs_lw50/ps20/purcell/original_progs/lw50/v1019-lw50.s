...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1019-lw40.s -o allprogs-new32//v1019-lw50.s
#vendor LWPU
...
FMUL32   R14, R11, c[A2 + 93];
FMUL32   R6, R15, R6;
FMUL32   R11, R11, c[A2 + 94];
FMAD     R12, R9, c[A0 + 100], R12;
FMAD     R14, R10, c[A1 + 85], R14;
FMAD     R10, R10, c[A1 + 86], R11;
FMAD     o[4], R7, R8, R12;
FMAD     R7, R9, c[A0 + 101], R14;
FMAD     R10, R9, c[A0 + 102], R10;
FMUL     R9, v[10], c[173];
FMAD     o[5], R13, R8, R7;
FMAD     o[6], R6, R8, R10;
FMAD     R7, v[9], c[172], R9;
FMUL     R6, v[10], c[177];
FMUL     R8, v[10], c[169];
FMAD     R7, v[11], c[174], R7;
...
MOV32    o[7], R0;
END
# 166 instructions, 16 R-regs
# 166 inst, (43 mov, 0 mvi, 0 tex, 4 complex, 119 math)
#    87 64-bit, 79 32-bit, 0 32-bit-const
