...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i allprogs-new32//p401-lw40.s -o allprogs-new32//p401-lw50.s
#vendor LWPU
...
FADD32   R0, R0, R4;
END
# 73 instructions, 12 R-regs, 12 interpolants
# 73 inst, (1 mov, 0 mvi, 2 tex, 12 ipa, 3 complex, 55 math)
#    47 64-bit, 25 32-bit, 1 32-bit-const
