...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v865-lw40.s -o allprogs-new32//v865-lw50.s
#vendor LWPU
...
FMAD     R1, v[11], c[172], R1;
FMAD     R0, v[4], c[172], R0;
FMAD     R2, v[6], c[178], R2;
FMAD     R4, v[13], c[174], R1;
...
FMAD     R9, R6, c[44], R9;
FMAD     R10, R10, c[4], R12;
FMAD     R13, R8, c[46], R9;
FMUL32   R9, R7, c[33];
MOV32    R12, c[35];
FMAD     R11, R11, c[4], R13;
FMAD     R9, R6, c[32], R9;
MOV32    R13, R12;
...
END
# 122 instructions, 16 R-regs
# 122 inst, (26 mov, 0 mvi, 0 tex, 0 complex, 96 math)
#    72 64-bit, 50 32-bit, 0 32-bit-const
