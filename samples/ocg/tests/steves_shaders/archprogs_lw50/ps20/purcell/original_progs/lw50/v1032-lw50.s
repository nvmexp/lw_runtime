...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1032-lw40.s -o allprogs-new32//v1032-lw50.s
#vendor LWPU
...
# 113 inst, (32 mov, 0 mvi, 0 tex, 1 complex, 80 math)
#    76 64-bit, 37 32-bit, 0 32-bit-const
