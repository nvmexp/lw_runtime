...
# -profile vp50 -po tbat3 -po lat3 -if vs2x -i allprogs-new32//v1088-lw40.s -o allprogs-new32//v1088-lw50.s
#vendor LWPU
...
FMUL32   R7, R7, c[123];
FMAX     R7, R7, c[0];
FMUL     R8, v[6], c[A0 + 177];
LG2      R7, |R7|;
FMAD     R9, v[5], c[A0 + 176], R8;
FMUL     R8, v[11], c[A0 + 173];
FMUL32   R7, R7, c[120];
FMAD     R9, v[7], c[A0 + 178], R9;
FMAD     R10, v[10], c[A0 + 172], R8;
RRO      R7, R7, 1;
FMUL     R8, v[6], c[A0 + 173];
FMAD     R14, v[12], c[A0 + 174], R10;
EX2      R7, R7;
FMAD     R8, v[5], c[A0 + 172], R8;
FMUL32   R15, R9, R14;
FMIN     R7, R7, c[1];
FMAD     R11, v[7], c[A0 + 174], R8;
FMUL     R12, v[11], c[A0 + 177];
FMUL32   R8, R7, c[108];
FMUL     R10, v[6], c[A0 + 169];
FMAD     R12, v[10], c[A0 + 176], R12;
FMUL32   R8, R3, R8;
FMAD     R10, v[5], c[A0 + 168], R10;
FMAD     R12, v[12], c[A0 + 178], R12;
FMUL     R13, v[11], c[A0 + 169];
FMAD     R10, v[7], c[A0 + 170], R10;
FMAD     R16, R11, R12, -R15;
FMAD     R13, v[10], c[A0 + 168], R13;
FMUL32   R15, R10, R12;
FMUL     R16, v[13], R16;
FMAD     R13, v[12], c[A0 + 170], R13;
FMAD     R17, R9, R13, -R15;
FMUL32   R15, R11, R13;
FMUL32   R18, R14, c[7];
FMUL     R17, v[13], R17;
...
FMAD     R20, R16, c[7], R18;
FMUL32   R18, R11, c[7];
FMAD     R21, R15, c[7], R20;
FMAD     R20, R10, c[7], R18;
FMUL32   R18, R21, R6;
FMAD     R20, R9, c[7], R20;
FMUL32   R22, R21, R21;
FMAD     R18, R19, R5, R18;
...
MOV32    o[7], R1;
END
# 225 instructions, 28 R-regs
# 225 inst, (40 mov, 0 mvi, 0 tex, 4 complex, 181 math)
#    137 64-bit, 88 32-bit, 0 32-bit-const
