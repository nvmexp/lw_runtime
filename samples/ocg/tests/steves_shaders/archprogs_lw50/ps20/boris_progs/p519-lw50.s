...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i progs//p519-lw40.s -o progs//p519-lw50.s
#vendor LWPU
...
FMAD     R3, R16, c[0], R3;
END
# 93 instructions, 32 R-regs, 27 interpolants
# 93 inst, (0 mov, 0 mvi, 13 tex, 27 ipa, 1 complex, 52 math)
#    89 64-bit, 0 32-bit, 4 32-bit-const
