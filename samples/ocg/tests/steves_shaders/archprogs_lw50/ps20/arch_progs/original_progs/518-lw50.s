...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i progs/518-lw40.s -o progs/518-lw50.s
#vendor LWPU
...
FADD     R5, R1, R5;
FADD     R6, R2, R6;
FADD.SAT R1, R11, -0.062745;
FADD.SAT R8, R3, -0.062745;
IPA      R0, 7, R12;
FMUL     R2, R1, 0.25;
IPA      R1, 8, R12;
FMAD     R7, R7, c[0], R2;
