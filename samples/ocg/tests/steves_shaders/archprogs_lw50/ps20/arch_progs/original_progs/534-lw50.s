...
# -profile fp50 -po tbat3 -po lat3 -if ps2x -i progs/534-lw40.s -o progs/534-lw50.s
#vendor LWPU
...
FMAD     R10, R3, R7, -R12;
FMAD     R6, R3, R6, -R8;
FADD     R12, R4, -0.000977;
FMAX     R3, |R11|, |R10|;
FADD     R13, R5, 0.001953;
FADD     R8, R4, 0.001953;
FMAX     R3, |R6|, R3;
FADD     R4, R4, -0.000977;
FADD     R9, R5, -0.000977;
...
#    71 64-bit, 38 32-bit, 15 32-bit-const
