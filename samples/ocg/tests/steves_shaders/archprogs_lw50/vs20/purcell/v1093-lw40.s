...
mad r4, c[a0.x+42], v1.x, r0
mov r1.w, c[0].y
dp4 r1.x, v0, r4
mul r2, v1.y, c[a0.y+43]
mul r0, v1.y, c[a0.y+44]
mad r3, c[a0.x+43], v1.x, r2
mad r2, c[a0.x+44], v1.x, r0
dp4 r1.y, v0, r3
dp4 r1.z, v0, r2
dp4 oPos.x, r1, c[8]
dp4 oPos.y, r1, c[9]
...
dp3 r10.z, v6, r2
add r8.xyz, -r1, c[34]
mul r1.xyz, r6.zxyw, r10.yzxw
dp3 r0.z, r5, r5
mad r1.xyz, r6.yzxw, r10.zxyw, -r1
rsq r0.w, r0.z
mul r1.xyz, r1, v6.w
dst r0.xy, r0.z, r0.w
...
mul r0.xyz, r2, r2
mul r9.xyz, r5, r0.w
mul r3.xyz, r0.y, c[a0.y+23]
rcp r0.w, r1.w
mad r4.xyz, r0.x, c[a0.x+21], r3
